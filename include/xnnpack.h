...
/// Define a Depth To Space 2D Node and add it to a Subgraph.
///
...
///
/// The Space To Depth 2D Node rearranges blocks of spatial data into blocks (a reverse transform to

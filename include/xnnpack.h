...
/// Define a Remainder Node and add it to a Subgraph.
///
/// The Remainder Node gives the element-wise remainder of 2 input.
///
/// @param subgraph - a Subgraph object that will own the created Node.
/// @param input1_id - Value ID for the first input tensor. The input tensor must be defined in the @a subgraph.
/// @param input2_id - Value ID for the second input tensor. The input tensor must be defined in the @a subgraph.
/// @param output_id - Value ID for the output tensor.
/// @param flags - binary features of the Remainder Node. No supported flags are currently defined.
enum xnn_status xnn_define_remainder(
  xnn_subgraph_t subgraph,
  float output_min,
  float output_max,
  uint32_t input1_id,

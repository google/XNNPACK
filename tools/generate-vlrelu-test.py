...
parser = argparse.ArgumentParser(
  description='Vector Leaky ReLU operation microkernel test generator')
...
def generate_test_cases(ukernel, init_fn, datatype, batch_tile, isa):
  """Generates all tests cases for a Vector Leaky ReLU micro-kernel.
  ...
  return xngen.preprocess(LRELU_TEST_TEMPLATE, {

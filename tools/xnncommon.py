...
_ISA_TO_MACRO_MAP = {
    ...
    "neoni8mmbf16": "XNN_ENABLE_ARM_I8MM && XNN_ENABLE_ARM_BF16",
    ...
    "sse": "XNN_ENABLE_SSE",
    "sse2": "XNN_ENABLE_SSE2",
    "ssse3": "XNN_ENABLE_SSSE3",
...
_ISA_TO_ARCH_MAP = {
    ...
    "wasmrelaxedsimdfp16": ["wasmrelaxedsimdfp16"],
...
_ISA_TO_ARCH_FLAGS_MAP = {
    ...
    "neoni8mmbf16": "xnn_arch_arm_neon_i8mm | xnn_arch_arm_neon_bf16",
    "neonsme": "xnn_arch_arm_sme",
    "neonsme2": "xnn_arch_arm_sme2",
    "sse": "xnn_arch_x86_sse",
    "sse2": "xnn_arch_x86_sse2",

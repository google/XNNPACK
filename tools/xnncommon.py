...
_ISA_TO_UTILCHECK_MAP = {
    ...
    "neonsme": "CheckNEONSME",
    "neonsme2": "CheckNEONSME2",
    "ssse3": "CheckSSSE3",
    "sse41": "CheckSSE41",
    "avx": "CheckAVX",
    "f16c": "CheckF16C",
...
_ISA_TO_CHECK_MAP = {
    ...
    "neonsme": "TEST_REQUIRES_ARM_NEON_SME",
    "neonsme2": "TEST_REQUIRES_ARM_NEON_SME2",
    ...
    "avx512bf16": "TEST_REQUIRES_X86_AVX512BF16",

...
_ASM_ARCH_LIST = _ARCH_LIST #.union({'fma3'}, {'avx512f'}, {'avx512vnni'})
...
def main(args):
  ...
  print("QQQARCH ", asm_microkernels_per_arch)
      ...
      if ext == '.c':
        ...
        for component in basename.split('-'):
          ...
          if component in _ISA_LIST:
            ...
            if 'amd64' in basename:
              print("basename ", basename, " component ", component, " isa ", isa, " arch ", arch)
        ...
        for component in basename.split('-'):
          if 'amd64' in basename:
            print("YES", basename, component)
          if component in _ASM_ARCH_LIST:
            if 'amd64' in basename:
              print("YYYYYYYYES", basename, component)

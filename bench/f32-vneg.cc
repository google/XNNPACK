...
void f32_vneg(benchmark::State& state, xnn_f32_vneg_ukernel_fn ukernel,
  ...
  BENCHMARK_CAPTURE(f32_vneg, avx_u24,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vneg, fma3_u8,
                    xnn_f32_vneg_ukernel__fma3_u8,
                    xnn_init_f32_neg_fma3_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vneg, fma3_u16,
                    xnn_f32_vneg_ukernel__fma3_u16,
                    xnn_init_f32_neg_fma3_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vneg, fma3_u24,
                    xnn_f32_vneg_ukernel__fma3_u24,
                    xnn_init_f32_neg_fma3_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();

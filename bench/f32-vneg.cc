...
void f32_vneg(benchmark::State& state, uint64_t arch_flags, xnn_f32_vneg_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vneg, ukernel, arch_flags, ukernel, init_params)                     \

...
void f32_vsqrt(benchmark::State& state, uint64_t arch_flags, xnn_f32_vsqrt_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vsqrt, ukernel, arch_flags, ukernel, init_params)                    \

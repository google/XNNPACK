...
void f32_vsqrt(benchmark::State& state, xnn_f32_vsqrt_ukernel_fn ukernel,
  ...
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u32,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u40,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u40,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u48,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u48,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u56,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u56,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u64,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u64,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();

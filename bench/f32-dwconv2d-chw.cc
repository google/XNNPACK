  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  static void dwconv2d_chw_3x3p1__wasmsimd_arm__1x4_acc3(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_3x3p1__wasmsimd_arm_1x4_acc3, 3, 3, 1, 1);
  }
  static void dwconv2d_chw_3x3s2p1__wasmsimd_arm__1x4_acc3(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__wasmsimd_arm_1x4_acc3, 3, 3, 1, 2);
  }
  static void dwconv2d_chw_5x5p2__wasmsimd_arm__3x4(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_5x5p2__wasmsimd_arm_3x4, 5, 5, 2, 1);
  }
  static void dwconv2d_chw_5x5s2p2__wasmsimd_arm__1x4_acc2(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_5x5s2p2__wasmsimd_arm_1x4_acc2, 5, 5, 2, 2);
  }
  static void dwconv2d_chw_3x3p1__wasmsimd_x86__1x4_acc3(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_3x3p1__wasmsimd_x86_1x4_acc3, 3, 3, 1, 1);
  }
  static void dwconv2d_chw_3x3s2p1__wasmsimd_x86__1x4_acc3(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__wasmsimd_x86_1x4_acc3, 3, 3, 1, 2);
  }
  static void dwconv2d_chw_5x5p2__wasmsimd_x86__3x4(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_5x5p2__wasmsimd_x86_3x4, 5, 5, 2, 1);
  }
  static void dwconv2d_chw_5x5s2p2__wasmsimd_x86__1x4_acc2(benchmark::State& state, const char* net) {
    DWConv2DBenchmark(state, xnn_f32_dwconv2d_chw_ukernel_5x5s2p2__wasmsimd_x86_1x4_acc2, 5, 5, 2, 2);
  }

  BENCHMARK_DWCONV(dwconv2d_chw_3x3p1__wasmsimd_arm__1x4_acc3)
  BENCHMARK_DWCONV(dwconv2d_chw_3x3s2p1__wasmsimd_arm__1x4_acc3)
  BENCHMARK_DWCONV(dwconv2d_chw_5x5p2__wasmsimd_arm__3x4)
  BENCHMARK_DWCONV(dwconv2d_chw_5x5s2p2__wasmsimd_arm__1x4_acc2)
  BENCHMARK_DWCONV(dwconv2d_chw_3x3p1__wasmsimd_x86__1x4_acc3)
  BENCHMARK_DWCONV(dwconv2d_chw_3x3s2p1__wasmsimd_x86__1x4_acc3)
  BENCHMARK_DWCONV(dwconv2d_chw_5x5p2__wasmsimd_x86__3x4)
  BENCHMARK_DWCONV(dwconv2d_chw_5x5s2p2__wasmsimd_x86__1x4_acc2)

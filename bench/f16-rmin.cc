...
static void f16_rmin(benchmark::State& state, xnn_f16_reduce_ukernel_fn rmin,
...
BENCHMARK_CAPTURE(f16_rmin, avx512skx_u16, xnn_f16_rmin_ukernel__avx512skx_u16,
...
BENCHMARK_CAPTURE(f16_rmin, scalar_u1, xnn_f16_rmin_ukernel__scalar_u1)
    ->Apply(benchmark::utils::ReductionParameters<xnn_float16>)
    ->UseRealTime();

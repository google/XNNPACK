...
void f32_vtanh(benchmark::State& state, uint64_t arch_flags, xnn_f32_vtanh_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vtanh, ukernel, arch_flags, ukernel, init_params)                    \

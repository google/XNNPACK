...
static void f32_rmax(benchmark::State& state, xnn_f32_reduce_ukernel_fn rmax,
...
BENCHMARK_CAPTURE(f32_rmax, avx512f_u16, xnn_f32_rmax_ukernel__avx512f_u16,
...
BENCHMARK_CAPTURE(f32_rmax, avx_u8, xnn_f32_rmax_ukernel__avx_u8,
                  /*init_params=*/nullptr, benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, avx_u16_acc2, xnn_f32_rmax_ukernel__avx_u16_acc2,
                  /*init_params=*/nullptr, benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, avx_u24_acc3, xnn_f32_rmax_ukernel__avx_u24_acc3,
                  /*init_params=*/nullptr, benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, avx_u32_acc2, xnn_f32_rmax_ukernel__avx_u32_acc2,
                  /*init_params=*/nullptr, benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, avx_u32_acc4, xnn_f32_rmax_ukernel__avx_u32_acc4,
                  /*init_params=*/nullptr, benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();

BENCHMARK_CAPTURE(f32_rmax, sse_u4, xnn_f32_rmax_ukernel__sse_u4)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, sse_u8_acc2, xnn_f32_rmax_ukernel__sse_u8_acc2)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, sse_u12_acc3, xnn_f32_rmax_ukernel__sse_u12_acc3)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, sse_u16_acc2, xnn_f32_rmax_ukernel__sse_u16_acc2)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, sse_u16_acc4, xnn_f32_rmax_ukernel__sse_u16_acc4)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64

#if XNN_ARCH_ARM || XNN_ARCH_ARM64
BENCHMARK_CAPTURE(f32_rmax, neon_u4, xnn_f32_rmax_ukernel__neon_u4,
                  /*init_params=*/nullptr, benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, neon_u8_acc2, xnn_f32_rmax_ukernel__neon_u8_acc2,
                  /*init_params=*/nullptr, benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, neon_u12_acc3, xnn_f32_rmax_ukernel__neon_u12_acc3,
                  /*init_params=*/nullptr, benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, neon_u16_acc2, xnn_f32_rmax_ukernel__neon_u16_acc2,
                  /*init_params=*/nullptr, benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, neon_u16_acc4, xnn_f32_rmax_ukernel__neon_u16_acc4,
                  /*init_params=*/nullptr, benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
...
BENCHMARK_CAPTURE(f32_rmax, wasm_u1, xnn_f32_rmax_ukernel__wasm_u1)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, wasm_u2_acc2, xnn_f32_rmax_ukernel__wasm_u2_acc2)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, wasm_u3_acc3, xnn_f32_rmax_ukernel__wasm_u3_acc3)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, wasm_u4_acc2, xnn_f32_rmax_ukernel__wasm_u4_acc2)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, wasm_u4_acc4, xnn_f32_rmax_ukernel__wasm_u4_acc4)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
#endif  // XNN_ARCH_WASM || XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD

#if XNN_ARCH_RISCV && XNN_ENABLE_RISCV_VECTOR
BENCHMARK_CAPTURE(f32_rmax, rvv_u1v, xnn_f32_rmax_ukernel__rvv_u1v,
                  /*init_params=*/nullptr, benchmark::utils::CheckRVV)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, rvv_u2v, xnn_f32_rmax_ukernel__rvv_u2v,
                  /*init_params=*/nullptr, benchmark::utils::CheckRVV)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, rvv_u4v, xnn_f32_rmax_ukernel__rvv_u4v,
                  /*init_params=*/nullptr, benchmark::utils::CheckRVV)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, rvv_u8v, xnn_f32_rmax_ukernel__rvv_u8v,
                  /*init_params=*/nullptr, benchmark::utils::CheckRVV)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
...
BENCHMARK_CAPTURE(f32_rmax, hvx_u32, xnn_f32_rmax_ukernel__hvx_u32,
                  /*init_params=*/nullptr, benchmark::utils::CheckHVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, hvx_u64_acc2, xnn_f32_rmax_ukernel__hvx_u64_acc2,
                  /*init_params=*/nullptr, benchmark::utils::CheckHVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, hvx_u96_acc3, xnn_f32_rmax_ukernel__hvx_u96_acc3,
                  /*init_params=*/nullptr, benchmark::utils::CheckHVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, hvx_u128_acc2, xnn_f32_rmax_ukernel__hvx_u128_acc2,
                  /*init_params=*/nullptr, benchmark::utils::CheckHVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
BENCHMARK_CAPTURE(f32_rmax, hvx_u128_acc4, xnn_f32_rmax_ukernel__hvx_u128_acc4,
                  /*init_params=*/nullptr, benchmark::utils::CheckHVX)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();
#endif  // XNN_ARCH_HEXAGON && XNN_ENABLE_HVX

BENCHMARK_CAPTURE(f32_rmax, scalar_u1, xnn_f32_rmax_ukernel__scalar_u1)
    ->Apply(benchmark::utils::ReductionParameters<float>)
    ->UseRealTime();

...
static void ruy_st(benchmark::State& state, const char* net)
{
  ...
  static void qs8_gemm_2x8c8__neon_mull_addlv(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_2x8c8__neon_mull_addlv, 2, 8, 8, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_3x8c8__neon_mull_addlv(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_3x8c8__neon_mull_addlv, 3, 8, 8, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_4x8c8__neon_mull_addlv(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_4x8c8__neon_mull_addlv, 4, 8, 8, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_2x16c8__neon_mull_addlv(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_2x16c8__neon_mull_addlv, 8, 16, 8, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_3x16c8__neon_mull_addlv(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_3x16c8__neon_mull_addlv, 3, 16, 8, 1, benchmark::utils::CheckNEON);
  }
  static void qs8_gemm_4x16c8__neon_mull_addlv(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_4x16c8__neon_mull_addlv, 4, 16, 8, 1, benchmark::utils::CheckNEON);
  }
  ...
  BENCHMARK_GEMM(qs8_gemm_2x8c8__neon_mull_addlv)
  BENCHMARK_GEMM(qs8_gemm_3x8c8__neon_mull_addlv)
  BENCHMARK_GEMM(qs8_gemm_4x8c8__neon_mull_addlv)
  BENCHMARK_GEMM(qs8_gemm_2x16c8__neon_mull_addlv)
  BENCHMARK_GEMM(qs8_gemm_3x16c8__neon_mull_addlv)
  BENCHMARK_GEMM(qs8_gemm_4x16c8__neon_mull_addlv)

...
static void ruy_st(benchmark::State& state, const char* net)
{
  ...
  static void qs8_gemm_2x8c4__neondot(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_2x8c4__neondot, 2, 8, 4, 1, benchmark::utils::CheckNEONDOT);
  }
  static void qs8_gemm_3x8c4__neondot(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_3x8c4__neondot, 3, 8, 4, 1, benchmark::utils::CheckNEONDOT);
  }
  ...
  static void qs8_gemm_2x16c4__neondot(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_2x16c4__neondot, 2, 16, 4, 1, benchmark::utils::CheckNEONDOT);
  }
  static void qs8_gemm_3x16c4__neondot(benchmark::State& state, const char* net) {
    GEMMBenchmark(state, xnn_qs8_gemm_minmax_ukernel_3x16c4__neondot, 3, 16, 4, 1, benchmark::utils::CheckNEONDOT);
  }
  ...
  BENCHMARK_GEMM(qs8_gemm_2x8c4__neondot)
  BENCHMARK_GEMM(qs8_gemm_3x8c4__neondot)
  BENCHMARK_GEMM(qs8_gemm_4x8c4__neondot)
  BENCHMARK_GEMM(qs8_gemm_1x16c4__neondot)
  BENCHMARK_GEMM(qs8_gemm_2x16c4__neondot)
  BENCHMARK_GEMM(qs8_gemm_3x16c4__neondot)

...
void f32_vrndd(benchmark::State& state, uint64_t arch_flags, xnn_f32_vround_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vrndd, ukernel, arch_flags, ukernel, init_params)                    \

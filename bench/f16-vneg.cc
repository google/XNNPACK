...
void f16_vneg(benchmark::State& state, uint64_t arch_flags, xnn_f16_vneg_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f16_vneg, ukernel, arch_flags, ukernel, init_params)                     \

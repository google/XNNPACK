...
namespace {
  ...
  BENCHMARK_GEMM(qp8_f32_qc4w_gemm_minmax_ukernel_16x64c4__neonsme2)
  #endif  // XNN_ENABLE_KLEIDIAI
  ...
  #if XNN_ENABLE_KLEIDIAI
  static void qp8_f32_qc4w_gemm_minmax_ukernel_1x64c4__neonsme(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void qp8_f32_qc4w_gemm_minmax_ukernel_16x64c4__neonsme(benchmark::State& state) {
    GEMMBenchmark(state,

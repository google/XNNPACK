...
#include "xnnpack/pack.h"
  ...
  static void qp8_f32_qc4w_gemm_minmax_ukernel_4x4c16s2__aarch64_neoni8mm_mstep2(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
      xnn_qp8_f32_qc4w_gemm_minmax_ukernel_4x4c16s2__aarch64_neoni8mm_mstep2,
      xnn_init_f32_minmax_scalar_params,
      xnn_pack_kai_qs8_weights_and_biases,
      xnn_packed_stride_kai_qs8_weights_and_biases,
      /*mr=*/4, /*nr=*/4, /*kr=*/16, /*sr=*/2,
  ...
  BENCHMARK_GEMM(qp8_f32_qc4w_gemm_minmax_ukernel_4x4c16s2__aarch64_neoni8mm_mstep2)
  ...
  static void qp8_f32_qc4w_gemm_minmax_ukernel_4x8c16s2__aarch64_neoni8mm_mstep2(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(qp8_f32_qc4w_gemm_minmax_ukernel_4x8c16s2__aarch64_neoni8mm_mstep2)

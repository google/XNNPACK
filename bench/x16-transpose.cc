...
static void x16_transpose(
  ...
  BENCHMARK_CAPTURE(x16_transpose, sse2_1024, xnn_x16_transpose_ukernel__4x8_sse2, 1024)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x16_transpose, sse2_7, xnn_x16_transpose_ukernel__8x8_sse2, 7)
      ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(x16_transpose, sse2_117, xnn_x16_transpose_ukernel__8x8_sse2, 117)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x16_transpose, sse2_1024, xnn_x16_transpose_ukernel__8x8_sse2, 1024)
      ->UseRealTime();

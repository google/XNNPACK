...
void f32_vclamp(benchmark::State& state, uint64_t arch_flags, xnn_f32_vclamp_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vclamp, ukernel, arch_flags, ukernel, init_params)                   \

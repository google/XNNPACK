  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  static void x32_packw_x8s4__avx2_x4(benchmark::State& state, const char* net) {
    x32_packw(state,
      xnn_x32_packw_gemm_goi_ukernel_x8s4__avx2_x4,
      /*nr=*/8, /*kr=*/1, /*sr=*/4,
      benchmark::utils::CheckAVX2);
  }
  static void x32_packw_x16s4__avx2_x4(benchmark::State& state, const char* net) {
    x32_packw(state,
      xnn_x32_packw_gemm_goi_ukernel_x16s4__avx2_x4,
      /*nr=*/16, /*kr=*/1, /*sr=*/4,
      benchmark::utils::CheckAVX2);
  }
  ...
  BENCHMARK_BGEMM(x32_packw_x8s4__avx2_x4)
  BENCHMARK_BGEMM(x32_packw_x16s4__avx2_x4)

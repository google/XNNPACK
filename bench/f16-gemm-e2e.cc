  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  static void f16_gemm_6x8__aarch64_neonfp16arith_ld64(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
  ...
  static void f16_gemm_8x8__aarch64_neonfp16arith_ld64(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
      xnn_f16_gemm_minmax_ukernel_8x8__aarch64_neonfp16arith_ld64,
  ...
  static void f16_gemm_4x16__aarch64_neonfp16arith_ld32(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
  ...
  static void f16_gemm_4x16__aarch64_neonfp16arith_ld64(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
      xnn_f16_gemm_minmax_ukernel_4x16__aarch64_neonfp16arith_ld64,
      xnn_f16_igemm_minmax_ukernel_4x16__aarch64_neonfp16arith_ld64,
      xnn_f16_gemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_f16_igemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_init_f16_minmax_fp16arith_params,
      4 /* mr */, 16 /* nr */, 0 /* log2_kr */, 0 /* log2_sr */,
      benchmark::utils::CheckNEONFP16ARITH);
  }

  static void f16_gemm_6x16__aarch64_neonfp16arith_ld32(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
      xnn_f16_gemm_minmax_ukernel_6x16__aarch64_neonfp16arith_ld32,
      xnn_f16_igemm_minmax_ukernel_6x16__aarch64_neonfp16arith_ld32,
      xnn_f16_gemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld32,
      xnn_f16_igemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld32,
      xnn_init_f16_minmax_fp16arith_params,
  ...
  static void f16_gemm_6x16__aarch64_neonfp16arith_ld64(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
      xnn_f16_gemm_minmax_ukernel_6x16__aarch64_neonfp16arith_ld64,
      xnn_f16_igemm_minmax_ukernel_6x16__aarch64_neonfp16arith_ld64,
      xnn_f16_gemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_f16_igemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_init_f16_minmax_fp16arith_params,
      6 /* mr */, 16 /* nr */, 0 /* log2_kr */, 0 /* log2_sr */,
  ...
  static void f16_gemm_6x16__aarch64_neonfp16arith_cortex_a55(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
      xnn_f16_gemm_minmax_ukernel_6x16__aarch64_neonfp16arith_cortex_a55,
      xnn_f16_igemm_minmax_ukernel_6x16__aarch64_neonfp16arith_cortex_a55,
      xnn_f16_gemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_f16_igemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_init_f16_minmax_fp16arith_params,
      6 /* mr */, 16 /* nr */, 0 /* log2_kr */, 0 /* log2_sr */,
  ...
  static void f16_gemm_6x16__aarch64_neonfp16arith_cortex_a55r0(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
  ...
  static void f16_gemm_6x16__aarch64_neonfp16arith_cortex_a75(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
      xnn_f16_gemm_minmax_ukernel_6x16__aarch64_neonfp16arith_cortex_a75,
      xnn_f16_igemm_minmax_ukernel_6x16__aarch64_neonfp16arith_cortex_a75,
      xnn_f16_gemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_f16_igemm_minmax_ukernel_1x16__aarch64_neonfp16arith_ld64,
      xnn_init_f16_minmax_fp16arith_params,
      6 /* mr */, 16 /* nr */, 0 /* log2_kr */, 0 /* log2_sr */,
  ...
  BENCHMARK_FP16_END2END(f16_gemm_4x8__aarch64_neonfp16arith_ld64);
  BENCHMARK_FP16_END2END(f16_gemm_6x8__aarch64_neonfp16arith_ld64);
  BENCHMARK_FP16_END2END(f16_gemm_8x8__aarch64_neonfp16arith_ld64);
  BENCHMARK_FP16_END2END(f16_gemm_4x16__aarch64_neonfp16arith_ld32);
  BENCHMARK_FP16_END2END(f16_gemm_4x16__aarch64_neonfp16arith_ld64);
  BENCHMARK_FP16_END2END(f16_gemm_6x16__aarch64_neonfp16arith_ld32);
  BENCHMARK_FP16_END2END(f16_gemm_6x16__aarch64_neonfp16arith_ld64);

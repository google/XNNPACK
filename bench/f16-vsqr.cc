...
void f16_vsqr(benchmark::State& state, uint64_t arch_flags, xnn_f16_vsqr_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f16_vsqr, ukernel, arch_flags, ukernel, init_params)                     \

...
void f32_vrndne(benchmark::State& state, uint64_t arch_flags, xnn_f32_vround_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vrndne, ukernel, arch_flags, ukernel, init_params)                   \

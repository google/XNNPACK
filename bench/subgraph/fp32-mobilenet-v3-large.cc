...
xnn_subgraph_t FP32MobileNetV3Large() {
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v111_dims.size(), v111_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v112_dims.size(), v112_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v113_dims.size(), v113_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v114_dims.size(), v114_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v115_dims.size(), v115_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v116_dims.size(), v116_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v117_dims.size(), v117_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v118_dims.size(), v118_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v119_dims.size(), v119_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v120_dims.size(), v120_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v121_dims.size(), v121_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v122_dims.size(), v122_dims.data(),
  ...
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, v123_dims.size(), v123_dims.data(),
  ...
  w150_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  ...
  w161_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  ...
  w172_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  ...
  w207_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  ...
  w218_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  ...
  static std::vector<float> w228_data;
  w228_data.resize(XNN_PAD_EXTRA_BYTES(672, float));
  ...
  static std::vector<float> w229_data;
  w229_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  uint32_t w229 = XNN_INVALID_VALUE_ID;
  std::array<size_t, 1> w229_dims = {{1}};
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, w229_dims.size(), w229_dims.data(),
  ...
  static std::vector<float> w240_data;
  w240_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  uint32_t w240 = XNN_INVALID_VALUE_ID;
  std::array<size_t, 1> w240_dims = {{1}};
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, w240_dims.size(), w240_dims.data(),
  ...
  static std::vector<float> w251_data;
  w251_data.resize(XNN_PAD_EXTRA_BYTES(1, float));
  uint32_t w251 = XNN_INVALID_VALUE_ID;
  std::array<size_t, 1> w251_dims = {{1}};
  status = xnn_define_tensor_value(
      subgraph, xnn_datatype_fp32, w251_dims.size(), w251_dims.data(),

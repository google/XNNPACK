...
void f32_vrndu(benchmark::State& state, uint64_t arch_flags, xnn_f32_vround_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vrndu, ukernel, arch_flags, ukernel, init_params)                    \

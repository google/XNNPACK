...
void f32_velu(benchmark::State& state, uint64_t arch_flags, xnn_f32_velu_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_velu, ukernel, arch_flags, ukernel, init_params)                     \

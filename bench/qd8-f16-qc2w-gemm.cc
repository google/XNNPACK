...
namespace {
  ...
  static void qd8_f16_qc2w_gemm_minmax_ukernel_1x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_1x8c8__avxvnni,
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_1x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_2x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_2x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/2, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_2x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_3x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_3x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/3, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_3x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_4x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_4x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/4, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_4x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_5x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_5x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/5, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_5x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_6x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_6x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/6, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_6x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_7x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_7x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/7, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_7x8c8__avxvnni)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_8x8c8__avxvnni(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_8x8c8__avxvnni,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/8, /*nr=*/8, /*kr=*/8, /*sr=*/1,
      /*arch_flags=*/xnn_arch_x86_avxvnni);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_8x8c8__avxvnni)
...
static void qd8_f16_qc2w_gemm_minmax_ukernel_1x1__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_1x1__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/1, /*nr=*/1, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_1x1__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_1x2__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_1x2__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/1, /*nr=*/2, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_1x2__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_1x4__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_1x4__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/1, /*nr=*/4, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_1x4__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_1x8__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_1x8__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/1, /*nr=*/8, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_1x8__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_2x2__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_2x2__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/2, /*nr=*/2, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_2x2__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_2x4__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_2x4__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/2, /*nr=*/4, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_2x4__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_2x8__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_2x8__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/2, /*nr=*/8, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_2x8__scalar)

static void qd8_f16_qc2w_gemm_minmax_ukernel_4x4__scalar(benchmark::State& state) {
  GEMMBenchmark(state,
    xnn_qd8_f16_qc2w_gemm_minmax_ukernel_4x4__scalar,
    xnn_init_f16_minmax_scalar_params,
    xnn_pack_qd8_qc2w_gemm_goi_w,
    /*mr=*/4, /*nr=*/4, /*kr=*/1, /*sr=*/1,
    /*arch_flags=*/0);
...
BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_4x4__scalar)
  ...
  static void qd8_f16_qc2w_gemm_minmax_ukernel_7x8c4__neondotfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_7x8c4__neondotfp16arith,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/7, /*nr=*/8, /*kr=*/4, /*sr=*/1,
      /*arch_flags=*/xnn_arch_arm_neon_dot | xnn_arch_arm_neon_fp16_arith);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_7x8c4__neondotfp16arith)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_8x8c4__neondotfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_8x8c4__neondotfp16arith,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
      /*mr=*/8, /*nr=*/8, /*kr=*/4, /*sr=*/1,
      /*arch_flags=*/xnn_arch_arm_neon_dot | xnn_arch_arm_neon_fp16_arith);
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_8x8c4__neondotfp16arith)
  ...
  static void qd8_f16_qc2w_gemm_minmax_ukernel_7x16c4__neondotfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_7x16c4__neondotfp16arith,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_7x16c4__neondotfp16arith)

  static void qd8_f16_qc2w_gemm_minmax_ukernel_8x16c4__neondotfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_qd8_f16_qc2w_gemm_minmax_ukernel_8x16c4__neondotfp16arith,
      xnn_init_f16_minmax_scalar_params,
      xnn_pack_qd8_qc2w_gemm_goi_w,
  ...
  BENCHMARK_GEMM(qd8_f16_qc2w_gemm_minmax_ukernel_8x16c4__neondotfp16arith)

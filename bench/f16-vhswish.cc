...
void f16_vhswish(benchmark::State& state, uint64_t arch_flags, xnn_f16_vhswish_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f16_vhswish, ukernel, arch_flags, ukernel, init_params)                  \

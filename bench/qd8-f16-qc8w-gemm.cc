...
namespace {
  ...
  static void qd8_f16_qc8w_gemm_minmax_ukernel_1x4v__rvvfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void qd8_f16_qc8w_gemm_minmax_ukernel_4x4v__rvvfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void qd8_f16_qc8w_gemm_minmax_ukernel_7x4v__rvvfp16arith(benchmark::State& state) {
    GEMMBenchmark(state,

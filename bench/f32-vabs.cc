...
void f32_vabs(benchmark::State& state, uint64_t arch_flags, xnn_f32_vabs_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vabs, ukernel, arch_flags, ukernel, init_params)                     \

...
namespace {
  ...
  static void f16_gemm_minmax_ukernel_1x32__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x32__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_5x32__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x32__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_7x32__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_8x32__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x64__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x64__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_5x64__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x64__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_7x64__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_8x64__avx512fp16_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x16__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_1x16__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_4x16__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_4x16__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_5x16__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_5x16__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_6x16__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_6x16__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_7x16__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_7x16__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_8x16__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_8x16__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_1x32__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_1x32__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_4x32__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_4x32__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_5x32__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_5x32__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_6x32__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_6x32__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_7x32__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_7x32__avx512skx_broadcast)

  static void f16_gemm_minmax_ukernel_8x32__avx512skx_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_8x32__avx512skx_broadcast)
#endif  // XNN_ENABLE_AVX512SKX && (XNN_ARCH_X86 || XNN_ARCH_X86_64)


#if XNN_ENABLE_AVX2 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  static void f16_gemm_minmax_ukernel_1x8__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x8__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_5x8__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x8__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_7x8__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x16__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_3x16__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x16__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_5x16__avx2_broadcast(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x8__asm_aarch64_neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x8__asm_aarch64_neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x8__asm_aarch64_neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_8x8__asm_aarch64_neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x16__asm_aarch64_neonfp16arith_cortex_a55(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x16__asm_aarch64_neonfp16arith_cortex_a55r0(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x16__asm_aarch64_neonfp16arith_cortex_a75(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x8__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x8__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x8__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_8x8__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x16__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_4x16__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_6x16__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_8x16__neonfp16arith_ld64(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  static void f16_gemm_minmax_ukernel_1x8__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_1x8__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_1x8__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_4x8__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_4x8__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
      xnn_x16_packw_gemm_goi_ukernel_x8__scalar_int_u4,
      /*mr=*/4, /*nr=*/8, /*kr=*/1, /*sr=*/1,
      /*arch_flags=*/0);
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_4x8__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_6x8__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_6x8__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
      xnn_x16_packw_gemm_goi_ukernel_x8__scalar_int_u4,
      /*mr=*/6, /*nr=*/8, /*kr=*/1, /*sr=*/1,
      /*arch_flags=*/0);
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_6x8__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_8x8__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_8x8__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
      xnn_x16_packw_gemm_goi_ukernel_x8__scalar_int_u4,
      /*mr=*/8, /*nr=*/8, /*kr=*/1, /*sr=*/1,
      /*arch_flags=*/0);
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_8x8__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_1x16__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_1x16__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_1x16__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_4x16__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_4x16__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
      xnn_x16_packw_gemm_goi_ukernel_x16__scalar_int_u4,
      /*mr=*/4, /*nr=*/16, /*kr=*/1, /*sr=*/1,
      /*arch_flags=*/0);
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_4x16__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_6x16__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
      xnn_f16_gemm_minmax_ukernel_6x16__wasmrelaxedsimdfp16_splat,
      xnn_init_f16_minmax_scalar_params,
      xnn_x16_packw_gemm_goi_ukernel_x16__scalar_int_u4,
      /*mr=*/6, /*nr=*/16, /*kr=*/1, /*sr=*/1,
      /*arch_flags=*/0);
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_6x16__wasmrelaxedsimdfp16_splat)

  static void f16_gemm_minmax_ukernel_8x16__wasmrelaxedsimdfp16_splat(benchmark::State& state) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f16_gemm_minmax_ukernel_8x16__wasmrelaxedsimdfp16_splat)

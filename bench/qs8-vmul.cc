  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  BENCHMARK_CAPTURE(qs8_vmul, fp32__neonv8_ld64_x8,
    ...
    ->UseRealTime();
  BENCHMARK_CAPTURE(qs8_vmul, fp32__neonv8_ld64_x16,
  ...
  BENCHMARK_CAPTURE(qs8_vmul, fp32__neonv8_ld128_x16,
  ...
  BENCHMARK_CAPTURE(qs8_vmul, fp32__neon_ld64_x8,
                    xnn_qs8_vmul_minmax_fp32_ukernel__neon_ld64_x8,
                    xnn_init_qs8_mul_minmax_fp32_neon_params,
                    benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::BinaryElementwiseParameters<int8_t, int8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qs8_vmul, fp32__neon_ld64_x16,
  ...
  BENCHMARK_CAPTURE(qs8_vmul, fp32__neon_ld128_x16,
  ...
  BENCHMARK_CAPTURE(qs8_vmul, rndnu__neon_ld64_x8,
                    xnn_qs8_vmul_minmax_rndnu_ukernel__neon_ld64_x8,
                    xnn_init_qs8_mul_minmax_rndnu_neon_params,
                    benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::BinaryElementwiseParameters<int8_t, int8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qs8_vmul, rndnu__neon_ld64_x16,
  ...
  BENCHMARK_CAPTURE(qs8_vmul, rndnu__neon_ld128_x16,
                    xnn_qs8_vmul_minmax_rndnu_ukernel__neon_ld128_x16,
                    xnn_init_qs8_mul_minmax_rndnu_neon_params,
                    benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::BinaryElementwiseParameters<int8_t, int8_t>)
    ->UseRealTime();

...
void f32_vrelu(benchmark::State& state, uint64_t arch_flags, xnn_f32_vrelu_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vrelu, ukernel, arch_flags, ukernel, init_params)                    \

...
void f32_vlog(benchmark::State& state, uint64_t arch_flags, xnn_f32_vlog_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vlog, ukernel, arch_flags, ukernel, init_params)                     \

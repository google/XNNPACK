...
static void x16_x32_packw(benchmark::State& state, const char* net,
  ...
  x16_x32_packw(state, ukernel, nr, kr, sr);
}

#define XNN_UKERNEL(arch_flags, ukernel, nr, kr, sr, kblock, nr_scale)        \
  BENCHMARK_CAPTURE_BGEMM(x16_x32_packw, ukernel##_, ukernel, arch_flags, nr, \
                          kr, sr);

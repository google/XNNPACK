...
static void ruy_st(benchmark::State& state, const char* net)
{
...
#if XNN_ARCH_ARM64
  static void qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_cortex_a53(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  static void qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_prfm_cortex_a53(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  static void qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_cortex_a75(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  static void qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_prfm_cortex_a75(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_cortex_a53)
  BENCHMARK_GEMM(qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_prfm_cortex_a53)
  BENCHMARK_GEMM(qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_cortex_a75)
  BENCHMARK_GEMM(qu8_gemm_4x16_rndnu__aarch64_neon_mlal_lane_prfm_cortex_a75)

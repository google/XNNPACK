...
void f32_vsigmoid(benchmark::State& state, uint64_t arch_flags, xnn_f32_vsigmoid_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vsigmoid, ukernel, arch_flags, ukernel, init_params)                 \

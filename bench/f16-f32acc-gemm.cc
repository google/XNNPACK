...
BENCHMARK_GEMM(f16_f32acc_gemm_1x16__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_4x16__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_5x16__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_6x16__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_7x16__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_8x16__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_1x32__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_4x32__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_5x32__avx512skx_broadcast)
BENCHMARK_GEMM(f16_f32acc_gemm_6x32__avx512skx_broadcast)

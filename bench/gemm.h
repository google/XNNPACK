...
#define BENCHMARK_GEMM_BASE(gemm_fn, blockwise) \
  BENCHMARK_CAPTURE(gemm_fn, mobilenet_v1, "MobileNet v1")->Apply(MobileNetV1GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, mobilenet_v2, "MobileNet v2")->Apply(MobileNetV2GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, mobilenet_v3_small, "MobileNet v3 Small")->Apply(MobileNetV3SmallGemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, mobilenet_v3_large, "MobileNet v3 Large")->Apply(MobileNetV3LargeGemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v1_g1, "ShuffleNet v1 (1 group)")->Apply(ShuffleNetV1G1GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v1_g2, "ShuffleNet v1 (2 groups)")->Apply(ShuffleNetV1G2GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v1_g3, "ShuffleNet v1 (3 groups)")->Apply(ShuffleNetV1G3GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v1_g4, "ShuffleNet v1 (4 groups)")->Apply(ShuffleNetV1G4GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v1_g8, "ShuffleNet v1 (8 groups)")->Apply(ShuffleNetV1G8GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v2_x05, "ShuffleNet v2 0.5X")->Apply(ShuffleNetV2X05GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v2_x10, "ShuffleNet v2 1.0X")->Apply(ShuffleNetV2X10GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v2_x15, "ShuffleNet v2 1.5X")->Apply(ShuffleNetV2X15GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, shufflenet_v2_x20, "ShuffleNet v2 2.0X")->Apply(ShuffleNetV2X20GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, inception_v3, "Inception v3")->Apply(InceptionV3GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, resnet18, "ResNet-18")->Apply(ResNet18GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, resnet50, "ResNet-50")->Apply(ResNet50GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, squeezenet_v10, "SqueezeNet 1.0")->Apply(SqueezeNetV10GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, squeezenet_v11, "SqueezeNet 1.1")->Apply(SqueezeNetV11GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, vgg, "VGG")->Apply(VGGGemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, srcnn915, "SRCNN (9-1-5)")->Apply(SRCNN915GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, srcnn935, "SRCNN (9-3-5)")->Apply(SRCNN935GemmArguments<blockwise>)->UseRealTime(); \
  BENCHMARK_CAPTURE(gemm_fn, llm, "LLM")->Apply(LLMGemmArguments<blockwise>)->UseRealTime();
...
//static void ShuffleNetV1G1GemmArguments(benchmark::internal::Benchmark* b_ptr) {
template <bool Blockwise>
static void ShuffleNetV1G1GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV1G2GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV1G3GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV1G4GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV1G8GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV2X05GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV2X10GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV2X15GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ShuffleNetV2X20GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void MobileNetV1GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void MobileNetV2GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void MobileNetV3SmallGemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void MobileNetV3LargeGemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
// SqueezeNet 1.0
template <bool Blockwise>
static void SqueezeNetV10GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
// SqueezeNet 1.1
template <bool Blockwise>
static void SqueezeNetV11GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void InceptionV3GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ResNet18GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void ResNet50GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void VGGGemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
// SRCNN (9-1-5)
template <bool Blockwise>
static void SRCNN915GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
// SRCNN (9-3-5)
template <bool Blockwise>
static void SRCNN935GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
// SRCNN (9-5-5)
template <bool Blockwise>
static void SRCNN955GemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);
...
template <bool Blockwise>
static void LLMGemmArguments(benchmark::internal::Benchmark* b_ptr) {
  BenchmarkWrapper b(b_ptr, Blockwise);

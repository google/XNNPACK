  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  static void f32_gemm_4x8__jit_aarch32_neon_prfm_cortex_a75(benchmark::State& state, const char* net)
  {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f32_gemm_4x8__jit_aarch32_neon_prfm_cortex_a75)
  ...
  static void f32_gemm_1x8__jit_aarch64_neonfma_prfm_cortex_a75(benchmark::State& state, const char* net)
  {
    GEMMBenchmark(state,
  ...
  static void f32_gemm_4x8__jit_aarch64_neonfma_prfm_cortex_a75(benchmark::State& state, const char* net)
  {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f32_gemm_1x8__jit_aarch64_neonfma_prfm_cortex_a75)
  BENCHMARK_GEMM(f32_gemm_4x8__jit_aarch64_neonfma_cortex_a75)
  BENCHMARK_GEMM(f32_gemm_4x8__jit_aarch64_neonfma_prfm_cortex_a75)
...
#define BENCHMARK_UPTO_MR_GEMM(name, max_mr, nr)                              \
  ...
  BENCHMARK_GEMM(name)
  BENCHMARK_UPTO_MR_GEMM(f32_gemm_6x8_1x8__jit_aarch64_neonfma_prfm_cortex_a75, 1, 8);
  BENCHMARK_UPTO_MR_GEMM(f32_gemm_6x8_2x8__jit_aarch64_neonfma_prfm_cortex_a75, 2, 8);
  BENCHMARK_UPTO_MR_GEMM(f32_gemm_6x8_3x8__jit_aarch64_neonfma_prfm_cortex_a75, 3, 8);
  BENCHMARK_UPTO_MR_GEMM(f32_gemm_6x8_4x8__jit_aarch64_neonfma_prfm_cortex_a75, 4, 8);
  BENCHMARK_UPTO_MR_GEMM(f32_gemm_6x8_5x8__jit_aarch64_neonfma_prfm_cortex_a75, 5, 8);
  BENCHMARK_UPTO_MR_GEMM(f32_gemm_6x8_6x8__jit_aarch64_neonfma_prfm_cortex_a75, 6, 8);

...
static void GEMMBenchmark(
    ...
    size_t sr, benchmark::utils::IsaCheckFunction isa_check = nullptr) {
...
static void f32_gemm_goi_1x8__asm_aarch64_neonfma_ld128(benchmark::State& state,
                                                        const char* net) {
  GEMMGoiBenchmark(
      state, xnn_f32_gemm_goi_minmax_ukernel_1x8__asm_aarch64_neonfma_ld128,
      xnn_init_f32_minmax_scalar_params,
      /*mr=*/1, /*nr=*/8, /*kr=*/1, /*sr=*/1);
}
static void f32_gemm_goi_1x8__asm_aarch64_neonfma_ld128_prfm(
    benchmark::State& state, const char* net) {
  GEMMGoiBenchmark(
      state,
...
static void f32_gemm_goi_4x8__asm_aarch64_neonfma_ld128(benchmark::State& state,
                                                        const char* net) {
  GEMMGoiBenchmark(
      state, xnn_f32_gemm_goi_minmax_ukernel_4x8__asm_aarch64_neonfma_ld128,
      xnn_init_f32_minmax_scalar_params,
      /*mr=*/4, /*nr=*/8, /*kr=*/1, /*sr=*/1);
}
...
static void f32_gemm_1x32__hvx_broadcast(benchmark::State& state,
                                         const char* net) {
...
static void f32_gemm_1x64__hvx_broadcast(benchmark::State& state,
                                         const char* net) {
...
static void f32_gemm_1x128__hvx_broadcast(benchmark::State& state,
                                          const char* net) {
...
static void f32_gemm_2x128__hvx_broadcast(benchmark::State& state,
                                          const char* net) {
...
static void f32_gemm_4x64__hvx_broadcast(benchmark::State& state,
                                         const char* net) {
...
static void f32_gemm_7x64__hvx_broadcast(benchmark::State& state,
                                         const char* net) {
...
static void f32_gemm_7x32__hvx_broadcast(benchmark::State& state,
                                         const char* net) {
...
static void f32_gemm_8x32__hvx_broadcast(benchmark::State& state,
                                         const char* net) {
...
static void f32_gemm_16x32__hvx_broadcast(benchmark::State& state,
                                          const char* net) {
  GEMMBenchmark(state, xnn_f32_gemm_minmax_ukernel_16x32__hvx_broadcast,
                xnn_init_f32_minmax_scalar_params,
                /*mr=*/16, /*nr=*/32, /*kr=*/1, /*sr=*/1,
                benchmark::utils::CheckHVX);
}

BENCHMARK_GEMM(f32_gemm_1x32__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_1x64__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_1x128__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_2x128__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_4x64__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_7x64__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_7x32__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_8x32__hvx_broadcast)
BENCHMARK_GEMM(f32_gemm_16x32__hvx_broadcast)

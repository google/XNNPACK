...
void f32_vsqr(benchmark::State& state, uint64_t arch_flags, xnn_f32_vsqr_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f32_vsqr, ukernel, arch_flags, ukernel, init_params)                     \

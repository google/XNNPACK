...
#include "xnnpack/packw.h"
  ...
  static void f32_gemm_minmax_ukernel_asm_4x8__fma3_broadcast(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f32_gemm_minmax_ukernel_asm_4x8__fma3_broadcast)

...
void f16_vrndu(benchmark::State& state, uint64_t arch_flags, xnn_f16_vround_ukernel_fn ukernel,
...
BENCHMARK_CAPTURE(f16_vrndu, ukernel, arch_flags, ukernel, init_params)                    \

...
static void x32_transpose(
  ...
  BENCHMARK_CAPTURE(x32_transpose, neon_32_tbl, xnn_x32_transpose_ukernel__4x4_neon_tbl, 32)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x32_transpose, neon_117_tbl, xnn_x32_transpose_ukernel__4x4_neon_tbl, 117)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x32_transpose, neon_1024_tbl, xnn_x32_transpose_ukernel__4x4_neon_tbl, 1024)
      ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(x32_transpose, neon_117_zip, xnn_x32_transpose_ukernel__4x4_neon_zip, 117)
      ->UseRealTime();
  BENCHMARK_CAPTURE(x32_transpose, neon_1024_zip, xnn_x32_transpose_ukernel__4x4_neon_zip, 1024)
      ->UseRealTime();

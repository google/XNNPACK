...
#include <xnnpack/isa-checks.h>
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(TANH__NEON_EXPM1MINUS_RR1_LUT8_P4H3_NR2RECPS, positive_saturation) {
    TEST_REQUIRES_ARM_NEON;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__neon_expm1minus_rr1_lut8_p4h3_nr2recps, 1.0f);
  }

  TEST(TANH__NEON_EXPM1MINUS_RR1_LUT8_P4H3_NR2RECPS, negative_saturation) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(TANH__NEON_EXPM1MINUS_RR1_LUT8_P4H3_NR2RECPS, nan) {
    TEST_REQUIRES_ARM_NEON;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__neon_expm1minus_rr1_lut8_p4h3_nr2recps);
  }
#endif  // XNN_ARCH_ARM || XNN_ARCH_ARM64
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__AVX512F_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, positive_saturation) {
    TEST_REQUIRES_X86_AVX512F;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__avx512f_expm1minus_rr1_lut4_p4h3_perm_nr1, 1.0f);
  }

  TEST(TANH__AVX512F_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, negative_saturation) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(TANH__AVX512F_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, nan) {
    TEST_REQUIRES_X86_AVX512F;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__avx512f_expm1minus_rr1_lut4_p4h3_perm_nr1);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__AVX2_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, positive_saturation) {
    TEST_REQUIRES_X86_AVX2;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__avx2_expm1minus_rr1_lut4_p4h3_perm_nr1, 1.0f);
  }

  TEST(TANH__AVX2_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, negative_saturation) {
    TEST_REQUIRES_X86_AVX2;
  ...
  TEST(TANH__AVX2_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, nan) {
    TEST_REQUIRES_X86_AVX2;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__avx2_expm1minus_rr1_lut4_p4h3_perm_nr1);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__FMA3_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, positive_saturation) {
    TEST_REQUIRES_X86_FMA3;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__fma3_expm1minus_rr1_lut4_p4h3_perm_nr1, 1.0f);
  }

  TEST(TANH__FMA3_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, negative_saturation) {
    TEST_REQUIRES_X86_FMA3;
  ...
  TEST(TANH__FMA3_EXPM1MINUS_RR1_LUT4_P4H3_PERM_NR1, nan) {
    TEST_REQUIRES_X86_FMA3;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__fma3_expm1minus_rr1_lut4_p4h3_perm_nr1);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H2_PERM_NR1, positive_saturation) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__avx_expm1minus_rr1_lut4_p4h2_perm_nr1, 1.0f);
  }

  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H2_PERM_NR1, negative_saturation) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H2_PERM_NR1, nan) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__avx_expm1minus_rr1_lut4_p4h2_perm_nr1);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64


#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H2_PERM_NR2, positive_saturation) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__avx_expm1minus_rr1_lut4_p4h2_perm_nr2, 1.0f);
  }

  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H2_PERM_NR2, negative_saturation) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H2_PERM_NR2, nan) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__avx_expm1minus_rr1_lut4_p4h2_perm_nr2);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64


#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H3_PERM_DIV, positive_saturation) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__avx_expm1minus_rr1_lut4_p4h3_perm_div, 1.0f);
  }

  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H3_PERM_DIV, negative_saturation) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(TANH__AVX_EXPM1MINUS_RR1_LUT4_P4H3_PERM_DIV, nan) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__avx_expm1minus_rr1_lut4_p4h3_perm_div);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__SSE2_EXPM1MINUS_RR1_LUT8_P4H3_NR1, positive_saturation) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__sse2_expm1minus_rr1_lut8_p4h3_nr1, 1.0f);
  }

  TEST(TANH__SSE2_EXPM1MINUS_RR1_LUT8_P4H3_NR1, negative_saturation) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(TANH__SSE2_EXPM1MINUS_RR1_LUT8_P4H3_NR1, nan) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__sse2_expm1minus_rr1_lut8_p4h3_nr1);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64


#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(TANH__SSE2_EXPM1MINUS_RR1_LUT8_P4H3_NR2, positive_saturation) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .input_range(0x1.205968p+3f, std::numeric_limits<float>::infinity())
      .TestOutputMatchReference(xnn_math_f32_tanh__sse2_expm1minus_rr1_lut8_p4h3_nr2, 1.0f);
  }

  TEST(TANH__SSE2_EXPM1MINUS_RR1_LUT8_P4H3_NR2, negative_saturation) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(TANH__SSE2_EXPM1MINUS_RR1_LUT8_P4H3_NR2, nan) {
    TEST_REQUIRES_X86_AVX;

    MathEvaluationTester()
      .TestNaN(xnn_math_f32_tanh__sse2_expm1minus_rr1_lut8_p4h3_nr2);
  }
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64

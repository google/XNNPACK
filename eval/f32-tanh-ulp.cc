  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  BENCHMARK_CAPTURE(TanhError, neonfma_rr1_p6_nr1recps1fma,
                    xnn_math_f32_tanh__neonfma_rr1_p6_nr1recps1fma,
                    benchmark::utils::CheckNEONFMA)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);
  BENCHMARK_CAPTURE(TanhError, neonfma_rr1_p6_nr2fma,
                    xnn_math_f32_tanh__neonfma_rr1_p6_nr2fma,
                    benchmark::utils::CheckNEONFMA)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);
  BENCHMARK_CAPTURE(TanhError, neonfma_rr1_p6_nr2recps,
                    xnn_math_f32_tanh__neonfma_rr1_p6_nr2recps,
                    benchmark::utils::CheckNEONFMA)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);

  BENCHMARK_CAPTURE(TanhError, neon_rr1_p6_nr2recps,
                    xnn_math_f32_tanh__neon_rr1_p6_nr2recps,
                    benchmark::utils::CheckNEON)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);
  BENCHMARK_CAPTURE(TanhError, neon_rr2_p6_nr2recps,
                    xnn_math_f32_tanh__neon_rr2_p6_nr2recps,
                    benchmark::utils::CheckNEON)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);
#endif  // XNN_ARCH_ARM || XNN_ARCH_ARM64
  ...
  BENCHMARK_CAPTURE(TanhError, avx512f_rr1_p6_div,
    ...
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);
  BENCHMARK_CAPTURE(TanhError, avx512f_rr1_lut4_p4_perm_div,
                    xnn_math_f32_tanh__avx512f_rr1_lut4_p4_perm_div,
                    benchmark::utils::CheckAVX512F)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);
  BENCHMARK_CAPTURE(TanhError, avx512f_rr1_lut16_p4_perm_div,
                    xnn_math_f32_tanh__avx512f_rr1_lut16_p4_perm_div,
                    benchmark::utils::CheckAVX512F)
    ->Unit(benchmark::kMillisecond)
    ->Iterations(1);

  BENCHMARK_CAPTURE(TanhError, avx2_rr1_lut4_p4_perm_div,
                    xnn_math_f32_tanh__avx2_rr1_lut4_p4_perm_div,
  ...
  BENCHMARK_CAPTURE(TanhError, fma3_rr1_lut4_p4_perm_div,
                    xnn_math_f32_tanh__fma3_rr1_lut4_p4_perm_div,
  ...
  BENCHMARK_CAPTURE(TanhError, avx_rr1_lut4_p4_perm_div,
                    xnn_math_f32_tanh__avx_rr1_lut4_p4_perm_div,
...
BENCHMARK_CAPTURE(TanhError, scalar_rr1_lut8_p4_div,
  ...
  ->Unit(benchmark::kMillisecond)
  ->Iterations(1);
BENCHMARK_CAPTURE(TanhError, scalar_rr1_lut16_p3_div,
                  xnn_math_f32_tanh__scalar_rr1_lut16_p3_div)
  ->Unit(benchmark::kMillisecond)
  ->Iterations(1);
BENCHMARK_CAPTURE(TanhError, scalar_rr1_lut16_p4_div,
                  xnn_math_f32_tanh__scalar_rr1_lut16_p4_div)
  ->Unit(benchmark::kMillisecond)
  ->Iterations(1);

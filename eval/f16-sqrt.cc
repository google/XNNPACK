...
constexpr int kBlockSize = 1024;
  ...
  TEST(F16_SQRT__NEONFP16ARITH_SQRT, negative_normal) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_SQRT__NEONFP16ARITH_SQRT, negative_infinity) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_SQRT__NEONFP16ARITH_SQRT, negative_nan) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_SQRT__NEONFP16ARITH_SQRT, positive_normal) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_SQRT__NEONFP16ARITH_SQRT, positive_infinity) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_SQRT__NEONFP16ARITH_SQRT, positive_nan) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;

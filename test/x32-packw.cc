...
#include "packw-microkernel-tester.h"
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, k_eq_4) {
    TEST_REQUIRES_X86_AVX2;
    PackWMicrokernelTester()
      .n(8)
      .k(4)
      ...
      .kr(1)
      .sr(4)
      .Test(xnn_x32_packw_gemm_goi_ukernel_x8s4__avx2_x4);
  }

  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, k_div_4) {
    TEST_REQUIRES_X86_AVX2;
    PackWMicrokernelTester()
      .n(8)
      .k(20)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, k_lt_4) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 4; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, k_gt_4) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 5; k < 8; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, n_eq_8) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, n_div_8) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, n_lt_8) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      for (size_t n = 1; n < 8; n++) {
        PackWMicrokernelTester()
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, n_gt_8) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      for (size_t n = 9; n < 16; n++) {
        PackWMicrokernelTester()
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, g_gt_1) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t k = 1; k < 8; k++) {
        for (size_t n = 9; n < 16; n++) {
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__AVX2_X4, null_bias) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t k = 1; k < 8; k++) {
        for (size_t n = 9; n < 16; n++) {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, k_eq_4) {
    TEST_REQUIRES_X86_AVX2;
    PackWMicrokernelTester()
      .n(16)
      .k(4)
      ...
      .kr(1)
      .sr(4)
      .Test(xnn_x32_packw_gemm_goi_ukernel_x16s4__avx2_x4);
  }

  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, k_div_4) {
    TEST_REQUIRES_X86_AVX2;
    PackWMicrokernelTester()
      .n(16)
      .k(20)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, k_lt_4) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 4; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, k_gt_4) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 5; k < 8; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, n_eq_16) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, n_div_16) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(32)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, n_lt_16) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      for (size_t n = 1; n < 16; n++) {
        PackWMicrokernelTester()
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, n_gt_16) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t k = 1; k < 8; k++) {
      for (size_t n = 17; n < 32; n++) {
        PackWMicrokernelTester()
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, g_gt_1) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t k = 1; k < 8; k++) {
        for (size_t n = 17; n < 32; n++) {
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__AVX2_X4, null_bias) {
    TEST_REQUIRES_X86_AVX2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t k = 1; k < 8; k++) {
        for (size_t n = 17; n < 32; n++) {

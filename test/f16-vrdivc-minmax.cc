...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F16_VRDIVC_MINMAX__AARCH64_NEONFP16ARITH_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__aarch64_neonfp16arith_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__AARCH64_NEONFP16ARITH_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__aarch64_neonfp16arith_u16, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__FP16ARITH_U1, batch_eq_1) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(1)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__fp16arith_u1, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__FP16ARITH_U2, batch_eq_2) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(2)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__fp16arith_u2, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__FP16ARITH_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__fp16arith_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__AVX512FP16_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__avx512fp16_u32, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__AVX512FP16_U64, batch_eq_64) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(64)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__avx512fp16_u64, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__F16C_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__f16c_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_scalar_params);
  }
  ...
  TEST(F16_VRDIVC_MINMAX__F16C_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f16_vrdivc_minmax_ukernel__f16c_u16, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f16_minmax_scalar_params);
  }

...
INSTANTIATE_TEST_SUITE_P(
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  INSTANTIATE_TEST_SUITE_P(
      QU8_GEMM_MINMAX_FP32_1X4V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qu8_gemm_minmax_fp32_ukernel_1x4v__rvv,
                        xnn_init_qu8_conv_minmax_fp32_scalar_params,
                        xnn_pack_qu8_gemm_goi_w,
                        xnn_qu8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QU8_GEMM_MINMAX_FP32_7X4V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/7, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qu8_gemm_minmax_fp32_ukernel_7x4v__rvv,
                        xnn_init_qu8_conv_minmax_fp32_scalar_params,
                        xnn_pack_qu8_gemm_goi_w,
                        xnn_qu8_requantize_fp32);
          },

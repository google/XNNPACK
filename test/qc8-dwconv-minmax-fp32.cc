...
#include "dwconv-microkernel-tester.h"
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(9)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x9__neon_mul8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_div_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON;
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(9)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x9__neon_mul8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_div_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(9)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x9__neonv8_mul8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_div_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(9)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x9__neonv8_mul8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_div_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(9)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x9__neon_mla8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEON_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(9)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x9__neon_mla8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_div_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEON_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(9)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x9__neonv8_mla8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_div_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X9__NEONV8_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(9)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x9__neonv8_mla8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_div_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X9__NEONV8_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
TEST(QC8_DWCONV_MINMAX_FP32_UP4X9__SCALAR_MAGIC, zero) {
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(25)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x25__neon_mul8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON;
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(25)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x25__neon_mul8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_div_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(25)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x25__neonv8_mul8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_div_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(25)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x25__neonv8_mul8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_div_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MUL8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(25)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x25__neon_mla8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEON_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(25)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x25__neon_mla8, xnn_init_qs8_minmax_neon_fp32_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_div_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEON_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_eq_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(8)
      .kr(25)
      .channels(8)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up8x25__neonv8_mla8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_div_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_div_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_div_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_lt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_gt_8) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_gt_8_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, c_gt_8_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP8X25__NEONV8_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_eq_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    DWConvMicrokernelTester()
      .cr(16)
      .kr(25)
      .channels(16)
      .Test(xnn_qc8_dwconv_minmax_fp32_ukernel_up16x25__neonv8_mla8, xnn_init_qs8_minmax_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }

  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_div_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_div_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_div_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_lt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 1; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_gt_16) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_gt_16_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, c_gt_16_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, multipixel) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (size_t channels = 1; channels <= 80; channels += 15) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, input_offset) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 32; channels < 256; channels += 48) {
      DWConvMicrokernelTester()
        .cr(16)
  ...
  TEST(QC8_DWCONV_MINMAX_FP32_UP16X25__NEONV8_MLA8, zero) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 32; channels < 256; channels += 48) {
        DWConvMicrokernelTester()

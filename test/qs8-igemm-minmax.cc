...
#include "gemm-microkernel-tester.h"
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_eq_4) {
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_eq_4_subtile_m) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t m = 1; m <= 8; m++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_eq_4_subtile_n) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_lt_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 4; k++) {
      for (uint32_t m = 1; m <= 8; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_gt_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 5; k < 8; k++) {
      for (uint32_t m = 1; m <= 8; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_div_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_IGEMM_MINMAX_8X8C4__NEONDOT, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 8; k <= 40; k += 4) {
      for (uint32_t m = 1; m <= 8; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_eq_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(12)
      .nr(8)
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_eq_4_subtile_m) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t m = 1; m <= 12; m++) {
      GemmMicrokernelTester()
        .mr(12)
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_eq_4_subtile_n) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(12)
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_lt_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(12)
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 4; k++) {
      for (uint32_t m = 1; m <= 12; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_gt_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 5; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(12)
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 5; k < 8; k++) {
      for (uint32_t m = 1; m <= 12; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_div_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 8; k <= 40; k += 4) {
      GemmMicrokernelTester()
        .mr(12)
  ...
  TEST(QS8_IGEMM_MINMAX_12X8C4__NEONDOT, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 8; k <= 40; k += 4) {
      for (uint32_t m = 1; m <= 12; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_eq_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(4)
      .nr(16)
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t m = 1; m <= 4; m++) {
      for (uint32_t n = 1; n <= 16; n++) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_eq_4_subtile_m) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t m = 1; m <= 4; m++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_eq_4_subtile_n) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 1; n <= 16; n++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_lt_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 4; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 16; n++) {
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_gt_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 5; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 5; k < 8; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 16; n++) {
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_div_4) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 8; k <= 40; k += 4) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(QS8_IGEMM_MINMAX_4X16C4__NEONDOT, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 8; k <= 40; k += 4) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 16; n++) {

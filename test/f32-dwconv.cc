...
#include "dwconv-microkernel-tester.h"
  ...
  TEST(F32_DWCONV_UP4X3__WASMSIMD, kernel_size_lt_3) {
  ...
  TEST(F32_DWCONV_UP4X4__WASMSIMD, kernel_size_lt_4) {
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD, kernel_size_lt_9) {
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, c_eq_4) {
    DWConvMicrokernelTester()
      .cr(4)
      .kr(9)
      .kh(9)
      .channels(4)
      .Test(xnn_f32_dwconv_ukernel_up4x9__wasmsimd_acc2);
  }

  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, c_div_4) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, c_lt_4) {
    for (uint32_t channels = 1; channels < 4; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, c_gt_4) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, multipixel) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, multipixel_with_step) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, input_offset) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, zero) {
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 8; channels < 64; channels += 12) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X9__WASMSIMD_ACC2, kernel_size_lt_9) {
    for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X25__WASMSIMD, kernel_size_lt_25) {
  ...
  TEST(F32_DWCONV_UP8X3__WASMSIMD, kernel_size_lt_3) {
    for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X4__WASMSIMD, kernel_size_lt_4) {
    for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD, kernel_size_lt_9) {
    for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, c_eq_8) {
    DWConvMicrokernelTester()
      .cr(8)
      .kr(9)
      .kh(9)
      .channels(8)
      .Test(xnn_f32_dwconv_ukernel_up8x9__wasmsimd_acc2);
  }

  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, c_div_8) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, c_lt_8) {
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, c_gt_8) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, multipixel) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, multipixel_with_step) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, input_offset) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, zero) {
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X9__WASMSIMD_ACC2, kernel_size_lt_9) {
    for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X25__WASMSIMD, kernel_size_lt_25) {
    for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, c_eq_4) {
    DWConvMicrokernelTester()
      .cr(4)
      .kr(3)
      .kh(3)
      .channels(4)
      .Test(xnn_f32_dwconv_ukernel_up4x3__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, c_div_4) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, c_lt_4) {
    for (uint32_t channels = 1; channels < 4; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, c_gt_4) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      for (size_t step = 2; step <= 3; step++) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 3; mz++) {
      for (uint32_t channels = 8; channels < 64; channels += 12) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X3__WASMRELAXEDSIMD_FMA, kernel_size_lt_3) {
    for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(3)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, c_eq_4) {
    DWConvMicrokernelTester()
      .cr(4)
      .kr(4)
      .kh(4)
      .channels(4)
      .Test(xnn_f32_dwconv_ukernel_up4x4__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, c_div_4) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, c_lt_4) {
    for (uint32_t channels = 1; channels < 4; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, c_gt_4) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      for (size_t step = 2; step <= 4; step++) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 4; mz++) {
      for (uint32_t channels = 8; channels < 64; channels += 12) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X4__WASMRELAXEDSIMD_FMA, kernel_size_lt_4) {
    for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(4)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, c_eq_4) {
    DWConvMicrokernelTester()
      .cr(4)
      .kr(9)
      .kh(9)
      .channels(4)
      .Test(xnn_f32_dwconv_ukernel_up4x9__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, c_div_4) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, c_lt_4) {
    for (uint32_t channels = 1; channels < 4; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, c_gt_4) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 8; channels < 64; channels += 12) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X9__WASMRELAXEDSIMD_FMA, kernel_size_lt_9) {
    for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(9)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, c_eq_4) {
    DWConvMicrokernelTester()
      .cr(4)
      .kr(25)
      .kh(25)
      .channels(4)
      .Test(xnn_f32_dwconv_ukernel_up4x25__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, c_div_4) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, c_lt_4) {
    for (uint32_t channels = 1; channels < 4; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, c_gt_4) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 20; channels += 3) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 8; channels < 64; channels += 12) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 8; channels < 64; channels += 12) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(F32_DWCONV_UP4X25__WASMRELAXEDSIMD_FMA, kernel_size_lt_25) {
    for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(4)
        .kr(25)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, c_eq_8) {
    DWConvMicrokernelTester()
      .cr(8)
      .kr(3)
      .kh(3)
      .channels(8)
      .Test(xnn_f32_dwconv_ukernel_up8x3__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, c_div_8) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, c_lt_8) {
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, c_gt_8) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 3; step++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 3; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X3__WASMRELAXEDSIMD_FMA, kernel_size_lt_3) {
    for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(3)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, c_eq_8) {
    DWConvMicrokernelTester()
      .cr(8)
      .kr(4)
      .kh(4)
      .channels(8)
      .Test(xnn_f32_dwconv_ukernel_up8x4__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, c_div_8) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, c_lt_8) {
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, c_gt_8) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 4; step++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 4; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X4__WASMRELAXEDSIMD_FMA, kernel_size_lt_4) {
    for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(4)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, c_eq_8) {
    DWConvMicrokernelTester()
      .cr(8)
      .kr(9)
      .kh(9)
      .channels(8)
      .Test(xnn_f32_dwconv_ukernel_up8x9__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, c_div_8) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, c_lt_8) {
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, c_gt_8) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X9__WASMRELAXEDSIMD_FMA, kernel_size_lt_9) {
    for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(9)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, c_eq_8) {
    DWConvMicrokernelTester()
      .cr(8)
      .kr(25)
      .kh(25)
      .channels(8)
      .Test(xnn_f32_dwconv_ukernel_up8x25__wasmrelaxedsimd_fma);
  }

  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, c_div_8) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, c_lt_8) {
    for (uint32_t channels = 1; channels < 8; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, c_gt_8) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, multipixel) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, multipixel_with_step) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, multipixel_with_output_stride) {
    for (size_t channels = 1; channels <= 40; channels += 7) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, input_offset) {
    for (uint32_t channels = 16; channels < 128; channels += 24) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, zero) {
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 16; channels < 128; channels += 24) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(F32_DWCONV_UP8X25__WASMRELAXEDSIMD_FMA, kernel_size_lt_25) {
    for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
      DWConvMicrokernelTester()
        .cr(8)
        .kr(25)
...
TEST(F32_DWCONV_UP1X3__SCALAR, kernel_size_lt_3) {
  for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(3)
...
TEST(F32_DWCONV_UP1X3__SCALAR_ACC2, kernel_size_lt_3) {
  for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(3)
...
TEST(F32_DWCONV_UP1X4__SCALAR, kernel_size_lt_4) {
  for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(4)
...
TEST(F32_DWCONV_UP1X4__SCALAR_ACC2, kernel_size_lt_4) {
  for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(4)
...
TEST(F32_DWCONV_UP1X9__SCALAR, kernel_size_lt_9) {
  for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(9)
...
TEST(F32_DWCONV_UP1X9__SCALAR_ACC2, kernel_size_lt_9) {
  for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(9)
...
TEST(F32_DWCONV_UP1X25__SCALAR, kernel_size_lt_25) {
  for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(25)
...
TEST(F32_DWCONV_UP1X25__SCALAR_ACC2, kernel_size_lt_25) {
  for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(1)
      .kr(25)
...
TEST(F32_DWCONV_UP2X3__SCALAR, kernel_size_lt_3) {
  for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(3)
...
TEST(F32_DWCONV_UP2X3__SCALAR_ACC2, kernel_size_lt_3) {
  for (int32_t kernel_height = 2; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(3)
...
TEST(F32_DWCONV_UP2X4__SCALAR, kernel_size_lt_4) {
  for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(4)
...
TEST(F32_DWCONV_UP2X4__SCALAR_ACC2, kernel_size_lt_4) {
  for (int32_t kernel_height = 3; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(4)
...
TEST(F32_DWCONV_UP2X9__SCALAR, kernel_size_lt_9) {
  for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(9)
...
TEST(F32_DWCONV_UP2X9__SCALAR_ACC2, kernel_size_lt_9) {
  for (int32_t kernel_height = 8; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(9)
...
TEST(F32_DWCONV_UP2X25__SCALAR, kernel_size_lt_25) {
  for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(25)
...
TEST(F32_DWCONV_UP2X25__SCALAR_ACC2, kernel_size_lt_25) {
  for (int32_t kernel_height = 24; kernel_height > 0; kernel_height -= 2) {
    DWConvMicrokernelTester()
      .cr(2)
      .kr(25)

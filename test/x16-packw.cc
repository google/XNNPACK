...
TEST(X16_PACKW_GEMM_GOI_X16__SCALAR_INT, null_bias) {
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(8)
      .k(8)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(8)
      .k(40)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE_PRFM, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(8)
      .k(8)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE_PRFM, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(8)
      .k(40)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE_PRFM, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X16_PACKW_GEMM_GOI_X8__NEON_LD4LANE_PRFM, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE, k_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(16)
      .k(16)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE, k_div_16) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(16)
      .k(80)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE, k_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE, k_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE_PRFM, k_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(16)
      .k(16)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE_PRFM, k_div_16) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(16)
      .k(80)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE_PRFM, k_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X16_PACKW_GEMM_GOI_X16__NEON_LD4LANE_PRFM, k_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      PackWMicrokernelTester()
        .n(16)

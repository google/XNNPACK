...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      PQS8_QC4W_GEMM_MINMAX_FP32_1X64C4__NEONSME2, GemmTest,
  ...
  ,
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test_PQS8QC4W(xnn_pqs8_qc4w_gemm_minmax_fp32_ukernel_1x64c4__neonsme2,
  ...
  INSTANTIATE_TEST_SUITE_P(
      PQS8_QC4W_GEMM_MINMAX_FP32_32X32C4__NEONSME2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/[]() -> size_t {
  ...
  ,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_PQS8QC4W(xnn_pqs8_qc4w_gemm_minmax_fp32_ukernel_32x32c4__neonsme2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_kai_qs8_qc4w_weights_and_biases_sme2,
                        xnn_packed_stride_kai_qs8_qc4w_weights_and_biases_sme2,
                        xnn_qs8_requantize_fp32);

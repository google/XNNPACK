...
TEST(AND_ND_S32, and_0d_x_0d) {
  BinaryElementwiseOperatorTester()
    .operation_type(BinaryElementwiseOperatorTester::OperationType::AND)
    .TestS32();
}

TEST(AND_ND_S32, and_1d_x_0d) {

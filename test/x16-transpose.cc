...
TEST(X16_TRANSPOSE__4X4_SCALAR_INT, bh_4_bw_4_is_8_os_8) {
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_8_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_1_16_bw_1_16) {
    for(size_t i = 1; i <= 16; ++i){
      for(size_t j = 1; j <= 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_8_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(16)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_8_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(16)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_16_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_9_16_bw_8){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_9_16_bw_16){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(16)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_9_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      for(size_t j = 9; j < 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_8_bw_8_is_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_8_bw_8_os_16) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_MOV_WASMSIMD, bh_8_bw_8_is_16_os_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(16)
      .block_width(8)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_8_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_1_16_bw_1_16) {
    for(size_t i = 1; i <= 16; ++i){
      for(size_t j = 1; j <= 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_8_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(16)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_8_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(16)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_16_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_9_16_bw_8){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_9_16_bw_16){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(16)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_9_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      for(size_t j = 9; j < 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_8_bw_8_is_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_8_bw_8_os_16) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_MULTI_SWITCH_WASMSIMD, bh_8_bw_8_is_16_os_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(16)
      .block_width(8)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_8_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_1_16_bw_1_16) {
    for(size_t i = 1; i <= 16; ++i){
      for(size_t j = 1; j <= 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_8_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(16)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_8_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(16)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_16_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_9_16_bw_8){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_9_16_bw_16){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(16)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_9_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      for(size_t j = 9; j < 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_8_bw_8_is_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_8_bw_8_os_16) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MOV_WASMSIMD, bh_8_bw_8_is_16_os_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(16)
      .block_width(8)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_8_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_1_16_bw_1_16) {
    for(size_t i = 1; i <= 16; ++i){
      for(size_t j = 1; j <= 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_8_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(16)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_8_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(16)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_16_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_9_16_bw_8){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_9_16_bw_16){
    for(size_t i = 9; i < 16; ++i){
      TransposeMicrokernelTester()
        .input_stride(16)
        .output_stride(i)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_9_16_bw_9_16) {
    for(size_t i = 9; i < 16; ++i){
      for(size_t j = 9; j < 16; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_8_bw_8_is_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(8)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_8_bw_8_os_16) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(16)
      .block_width(8)
  ...
  TEST(X16_TRANSPOSE__8X8_REUSE_MULTI_WASMSIMD, bh_8_bw_8_is_16_os_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(16)
      .block_width(8)

...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VSQRDIFF__AVX_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiff_ukernel__avx_x8, VBinaryMicrokernelTester::OpType::SqrDiff, xnn_init_f32_default_avx_params);
  }
  ...
  TEST(F32_VSQRDIFF__AVX_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiff_ukernel__avx_x16, VBinaryMicrokernelTester::OpType::SqrDiff, xnn_init_f32_default_avx_params);
  }
...
TEST(F32_VSQRDIFF__SCALAR_X1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x1, VBinaryMicrokernelTester::OpType::SqrDiff);
}
...
TEST(F32_VSQRDIFF__SCALAR_X2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x2, VBinaryMicrokernelTester::OpType::SqrDiff);
}
...
TEST(F32_VSQRDIFF__SCALAR_X4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
}
...
TEST(F32_VSQRDIFF__SCALAR_X8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
}

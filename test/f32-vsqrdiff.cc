...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VSQRDIFF__NEON_X4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiff_ukernel__neon_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__NEON_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiff_ukernel__neon_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__SSE_X4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiff_ukernel__sse_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__SSE_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiff_ukernel__sse_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__AVX_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiff_ukernel__avx_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__AVX_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiff_ukernel__avx_x16, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__AVX512F_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiff_ukernel__avx512f_x16, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__AVX512F_X32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vsqrdiff_ukernel__avx512f_x32, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
  }

  TEST(F32_VSQRDIFF__WASMSIMD_X4, batch_div_4) {
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, batch_lt_4) {
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, batch_gt_4) {
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x4, VBinaryMicrokernelTester::OpType::SqrDiff);
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, inplace_a) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, inplace_b) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_b(true)
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, inplace_a_and_b) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
...
#if XNN_ARCH_WASMSIMD
  TEST(F32_VSQRDIFF__WASMSIMD_X8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  }

  TEST(F32_VSQRDIFF__WASMSIMD_X8, batch_div_8) {
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X8, batch_lt_8) {
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X8, batch_gt_8) {
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x8, VBinaryMicrokernelTester::OpType::SqrDiff);
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X8, inplace_a) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X8, inplace_b) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_b(true)
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X8, inplace_a_and_b) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x16, VBinaryMicrokernelTester::OpType::SqrDiff);
  }
...
TEST(F32_VSQRDIFF__SCALAR_X1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x1, VBinaryMicrokernelTester::OpType::SqrDiff, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSQRDIFF__SCALAR_X2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x2, VBinaryMicrokernelTester::OpType::SqrDiff, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSQRDIFF__SCALAR_X4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x4, VBinaryMicrokernelTester::OpType::SqrDiff, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSQRDIFF__SCALAR_X8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vsqrdiff_ukernel__scalar_x8, VBinaryMicrokernelTester::OpType::SqrDiff, VBinaryMicrokernelTester::Variant::Scalar);
}

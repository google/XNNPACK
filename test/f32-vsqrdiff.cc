...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x4, VBinOpMicrokernelTester::OpType::SqrDiff);
  }
  ...
  TEST(F32_VSQRDIFF__WASMSIMD_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiff_ukernel__wasmsimd_x8, VBinOpMicrokernelTester::OpType::SqrDiff);
  }

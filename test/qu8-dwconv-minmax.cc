...
#include "dwconv-microkernel-tester.h"
  ...
  TEST(QU8_DWCONV_MINMAX_UP8X9__NEON, c_eq_8) {
    ...
    DWConvMicrokernelTester()
      ...
      .kr(9)
      .channels(8)
      .Test(xnn_qu8_dwconv_minmax_ukernel_up8x9__neon, xnn_init_qu8_gemm_neon_params);
  }
  ...
  TEST(QU8_DWCONV_MINMAX_UP8X9__SSE2, c_eq_8) {
    ...
    DWConvMicrokernelTester()
      ...
      .kr(9)
      .channels(8)
      .Test(xnn_qu8_dwconv_minmax_ukernel_up8x9__sse2, xnn_init_qu8_gemm_sse2_params);
  }
...
TEST(QU8_DWCONV_MINMAX_UP1X9__SCALAR, c_eq_1) {
  DWConvMicrokernelTester()
    ...
    .kr(9)
    .channels(1)
    .Test(xnn_qu8_dwconv_minmax_ukernel_up1x9__scalar, xnn_init_qu8_gemm_scalar_params);
}

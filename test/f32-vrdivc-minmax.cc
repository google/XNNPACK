...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VRDIVC_MINMAX__SSE_U4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrdivc_minmax_ukernel__sse_u4, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__SSE_U8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrdivc_minmax_ukernel__sse_u8, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AVX_U8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrdivc_minmax_ukernel__avx_u8, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AVX_U16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vrdivc_minmax_ukernel__avx_u16, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_ARM_U4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_arm_u4, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_ARM_U8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_arm_u8, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_ARM_U16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_arm_u16, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_X86_U4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_x86_u4, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_X86_U8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_x86_u8, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_X86_U16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_x86_u16, VBinaryCMicrokernelTester::OpType::RDivC, xnn_init_f32_minmax_scalar_params);
  }

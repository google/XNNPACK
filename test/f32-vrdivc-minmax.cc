...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VRDIVC_MINMAX__AARCH64_NEON_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__aarch64_neon_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AARCH64_NEON_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__aarch64_neon_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__RVV_U4V, batch_eq_4v) {
    ...
    VBinaryMicrokernelTester()
      ...
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__rvv_u4v, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__RVV_U8V, batch_eq_8v) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__rvv_u8v, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__SSE_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__sse_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__SSE_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__sse_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AVX_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__avx_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AVX_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__avx_u16, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AVX512F_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__avx512f_u16, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__AVX512F_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__avx512f_u32, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_ARM_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_arm_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_ARM_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_arm_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_ARM_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_arm_u16, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_X86_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_x86_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_X86_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_x86_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASMSIMD_X86_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasmsimd_x86_u16, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASM_U1, batch_eq_1) {
    VBinaryMicrokernelTester()
      .batch_size(1)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasm_u1, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASM_U2, batch_eq_2) {
    VBinaryMicrokernelTester()
      .batch_size(2)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasm_u2, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASM_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasm_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VRDIVC_MINMAX__WASM_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__wasm_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
  }
...
TEST(F32_VRDIVC_MINMAX__SCALAR_U1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__scalar_u1, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
}
...
TEST(F32_VRDIVC_MINMAX__SCALAR_U2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__scalar_u2, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
}
...
TEST(F32_VRDIVC_MINMAX__SCALAR_U4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__scalar_u4, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
}
...
TEST(F32_VRDIVC_MINMAX__SCALAR_U8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .broadcast_b(true).Test(xnn_f32_vrdivc_minmax_ukernel__scalar_u8, VBinaryMicrokernelTester::OpType::RDiv, xnn_init_f32_minmax_scalar_params);
}

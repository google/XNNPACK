...
#include "gavgpool-cw-microkernel-tester.h"
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, elements_div_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t elements = 8; elements < 32; elements += 4) {
      GAvgPoolCWMicrokernelTester()
        .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, elements_lt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t elements = 1; elements < 4; elements++) {
      GAvgPoolCWMicrokernelTester()
        .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, elements_gt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t elements = 5; elements < 8; elements++) {
      GAvgPoolCWMicrokernelTester()
        .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, channels_lt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, channels_gt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, channels_div_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels <= 16; channels += 4) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t elements = 1; elements < 16; elements += 3) {
      GAvgPoolCWMicrokernelTester()
        .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__PSIMD_X4, qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t elements = 1; elements < 16; elements += 3) {
      GAvgPoolCWMicrokernelTester()
        .elements(elements)

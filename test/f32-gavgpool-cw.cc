...
#include "gavgpool-cw-microkernel-tester.h"
  ...
  TEST(F32_GAVGPOOL_CW__NEON_U4, elements_eq_4) {
    ...
    GAvgPoolCWMicrokernelTester()
      .elements(4)
      .channels(4)
      .Test(xnn_f32_gavgpool_cw_ukernel__neon_u4);
  }
  ...
  TEST(F32_GAVGPOOL_CW__NEON_U4, channels_lt_4) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_GAVGPOOL_CW__NEON_U4, channels_gt_4) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_GAVGPOOL_CW__NEON_U4, channels_div_4) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_GAVGPOOL_CW__SSE_U4, elements_eq_4) {
    ...
    GAvgPoolCWMicrokernelTester()
      .elements(4)
      .channels(4)
      .Test(xnn_f32_gavgpool_cw_ukernel__sse_u4);
  }
  ...
  TEST(F32_GAVGPOOL_CW__SSE_U4, channels_lt_4) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 4; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
  ...
  TEST(F32_GAVGPOOL_CW__SSE_U4, channels_gt_4) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 5; channels < 8; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
  ...
  TEST(F32_GAVGPOOL_CW__SSE_U4, channels_div_4) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 8; channels <= 16; channels += 4) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_ARM_U4, elements_eq_4) {
    GAvgPoolCWMicrokernelTester()
      .elements(4)
      .channels(4)
      .Test(xnn_f32_gavgpool_cw_ukernel__wasmsimd_arm_u4);
  }
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_ARM_U4, channels_lt_4) {
    for (size_t channels = 1; channels < 4; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
          .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_ARM_U4, channels_gt_4) {
    for (size_t channels = 5; channels < 8; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
          .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_ARM_U4, channels_div_4) {
    for (size_t channels = 8; channels <= 16; channels += 4) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
          .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_X86_U4, elements_eq_4) {
    GAvgPoolCWMicrokernelTester()
      .elements(4)
      .channels(4)
      .Test(xnn_f32_gavgpool_cw_ukernel__wasmsimd_x86_u4);
  }
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_X86_U4, channels_lt_4) {
    for (size_t channels = 1; channels < 4; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
          .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_X86_U4, channels_gt_4) {
    for (size_t channels = 5; channels < 8; channels++) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
          .elements(elements)
  ...
  TEST(F32_GAVGPOOL_CW__WASMSIMD_X86_U4, channels_div_4) {
    for (size_t channels = 8; channels <= 16; channels += 4) {
      for (size_t elements = 1; elements < 16; elements += 3) {
        GAvgPoolCWMicrokernelTester()
          .elements(elements)
...
TEST(F32_GAVGPOOL_CW__SCALAR_U1, elements_eq_4) {
  GAvgPoolCWMicrokernelTester()
    .elements(4)
    .channels(1)
    .Test(xnn_f32_gavgpool_cw_ukernel__scalar_u1, GAvgPoolCWMicrokernelTester::Variant::Scalar);
}

TEST(F32_GAVGPOOL_CW__SCALAR_U1, elements_div_4) {
  for (size_t elements = 8; elements < 32; elements += 4) {
    GAvgPoolCWMicrokernelTester()
      .elements(elements)
      .channels(1)
...
TEST(F32_GAVGPOOL_CW__SCALAR_U1, elements_lt_4) {
  for (size_t elements = 1; elements < 4; elements++) {
    GAvgPoolCWMicrokernelTester()
      .elements(elements)
      .channels(1)
...
TEST(F32_GAVGPOOL_CW__SCALAR_U1, elements_gt_4) {
  for (size_t elements = 5; elements < 8; elements++) {
    GAvgPoolCWMicrokernelTester()
      .elements(elements)
      .channels(1)

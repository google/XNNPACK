...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
    ...
    .n(2)
    .k(1)
    .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_1x2__scalar_u1, xnn_init_qs8_conv_minmax_rndnu_scalar_params, xnn_qs8_requantize_rndnu);
}

TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, strided_cn) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_strided_a) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_subtile) {
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_subtile_m) {
  for (uint32_t m = 1; m <= 1; m++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_subtile_n) {
  for (uint32_t n = 1; n <= 2; n++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_gt_1) {
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_gt_1_strided_a) {
  for (size_t k = 2; k < 10; k++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_gt_1_subtile) {
  for (size_t k = 2; k < 10; k++) {
    for (uint32_t n = 1; n <= 2; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2) {
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2_strided_cn) {
  for (uint32_t n = 3; n < 4; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2_strided_a) {
  for (uint32_t n = 3; n < 4; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2_subtile) {
  for (uint32_t n = 3; n < 4; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2) {
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2_strided_cn) {
  for (uint32_t n = 4; n <= 6; n += 2) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2_strided_a) {
  for (uint32_t n = 4; n <= 6; n += 2) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2_subtile) {
  for (uint32_t n = 4; n <= 6; n += 2) {
    for (size_t k = 1; k <= 5; k += 2) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, strided_cm_subtile) {
  for (size_t k = 1; k <= 5; k += 2) {
    for (uint32_t n = 1; n <= 2; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, qmin) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, qmax) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QS8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, strided_cm) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)

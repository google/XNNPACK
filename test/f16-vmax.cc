...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F16_VMAX__AVX512FP16_U32, batch_eq_32) {
    TEST_REQUIRES_X86_AVX512FP16;
    VBinaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f16_vmax_ukernel__avx512fp16_u32, VBinaryMicrokernelTester::OpType::Max);
  }

  TEST(F16_VMAX__AVX512FP16_U32, batch_div_32) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U32, batch_lt_32) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U32, batch_gt_32) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U32, inplace_a) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U32, inplace_b) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_VMAX__AVX512FP16_U32, inplace_a_and_b) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_AVX512FP16 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  TEST(F16_VMAX__AVX512FP16_U64, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512FP16;
    VBinaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_vmax_ukernel__avx512fp16_u64, VBinaryMicrokernelTester::OpType::Max);
  }

  TEST(F16_VMAX__AVX512FP16_U64, batch_div_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U64, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U64, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U64, inplace_a) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMAX__AVX512FP16_U64, inplace_b) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 1; batch_size <= 320; batch_size += 63) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_VMAX__AVX512FP16_U64, inplace_a_and_b) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 1; batch_size <= 320; batch_size += 63) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)

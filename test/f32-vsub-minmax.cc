...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VSUB_MINMAX__SSE_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsub_minmax_ukernel__sse_u4, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__SSE_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsub_minmax_ukernel__sse_u8, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__AVX_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsub_minmax_ukernel__avx_u8, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__AVX_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsub_minmax_ukernel__avx_u16, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__WASMSIMD_ARM_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsub_minmax_ukernel__wasmsimd_arm_u4, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__WASMSIMD_ARM_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsub_minmax_ukernel__wasmsimd_arm_u8, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__WASMSIMD_ARM_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsub_minmax_ukernel__wasmsimd_arm_u16, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__WASMSIMD_X86_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsub_minmax_ukernel__wasmsimd_x86_u4, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__WASMSIMD_X86_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsub_minmax_ukernel__wasmsimd_x86_u8, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VSUB_MINMAX__WASMSIMD_X86_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsub_minmax_ukernel__wasmsimd_x86_u16, VBinaryMicrokernelTester::OpType::Sub, xnn_init_f32_minmax_scalar_params);
  }

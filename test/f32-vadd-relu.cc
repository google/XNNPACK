...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VADD_RELU__WASMSIMD_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_relu_ukernel__wasmsimd_x4, VBinOpMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_RELU__WASMSIMD_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_relu_ukernel__wasmsimd_x8, VBinOpMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_RELU__WASM_X1, batch_eq_1) {
    VBinOpMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vadd_relu_ukernel__wasm_x1, VBinOpMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_RELU__WASM_X2, batch_eq_2) {
    VBinOpMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vadd_relu_ukernel__wasm_x2, VBinOpMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_RELU__WASM_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_relu_ukernel__wasm_x4, VBinOpMicrokernelTester::OpType::Add);
  }
...
TEST(F32_VADD_RELU__SCALAR_X1, batch_eq_1) {
  VBinOpMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vadd_relu_ukernel__scalar_x1, VBinOpMicrokernelTester::OpType::Add, VBinOpMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VADD_RELU__SCALAR_X2, batch_eq_2) {
  VBinOpMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vadd_relu_ukernel__scalar_x2, VBinOpMicrokernelTester::OpType::Add, VBinOpMicrokernelTester::Variant::Scalar);
}

...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F16_VRSUBC_MINMAX__F16C_U8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f16_vrsubc_minmax_ukernel__f16c_u8, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_avx_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__F16C_U16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_vrsubc_minmax_ukernel__f16c_u16, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_avx_params);
  }

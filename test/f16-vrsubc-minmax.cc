...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F16_VRSUBC_MINMAX__NEONFP16ARITH_U8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f16_vrsubc_minmax_ukernel__neonfp16arith_u8, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__NEONFP16ARITH_U16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_vrsubc_minmax_ukernel__neonfp16arith_u16, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__FP16ARITH_U1, batch_eq_1) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f16_vrsubc_minmax_ukernel__fp16arith_u1, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__FP16ARITH_U2, batch_eq_2) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f16_vrsubc_minmax_ukernel__fp16arith_u2, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__FP16ARITH_U4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f16_vrsubc_minmax_ukernel__fp16arith_u4, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__AVX512FP16_U32, batch_eq_32) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f16_vrsubc_minmax_ukernel__avx512fp16_u32, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__AVX512FP16_U64, batch_eq_64) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_vrsubc_minmax_ukernel__avx512fp16_u64, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__F16C_U8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f16_vrsubc_minmax_ukernel__f16c_u8, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_scalar_params);
  }
  ...
  TEST(F16_VRSUBC_MINMAX__F16C_U16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_vrsubc_minmax_ukernel__f16c_u16, VBinaryCMicrokernelTester::OpType::RSubC, xnn_init_f16_minmax_scalar_params);
  }

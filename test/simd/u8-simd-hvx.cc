...
#include "src/xnnpack/simd/u8-hvx.h"
#include "test/replicable_random_device.h"

namespace xnnpack {

class U8SimdHVXTest : public ::testing::Test {
 protected:
  void SetUp() override {
    TEST_REQUIRES_HVX;
...
TEST_F(U8SimdHVXTest, StoreTail) {
  const xnn_simd_u8_t a = xnn_loadu_u8(inputs_.data());

...
class U8SimdSCALARTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(U8SimdSCALARTest, StoreTail) {
  const xnn_simd_u8_t a = xnn_loadu_u8(inputs_.data());

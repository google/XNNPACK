...
class F16SimdWASMRELAXEDSIMDTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, ConstF16FromFloat) {
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, SetZero) {
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Add) {
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Mul) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Fmadd) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Fnmadd) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
  const xnn_simd_f16_t c =
      xnn_loadu_f16(inputs_.data() + 2 * xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Sub) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Div) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Max) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Min) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Abs) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Neg) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Round) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, And) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Or) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, Xor) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  const xnn_simd_f16_t b = xnn_loadu_f16(inputs_.data() + xnn_simd_size_f16);
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, ShiftLeft) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, ShiftRight) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  // Not using a loop since the `bits` parameter needs to be a compile-time
  // constant, e.g. for `neon`.
  {
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, CmpEq) {
  for (size_t k = 0; k < xnn_simd_size_f16; k++) {
    if (rng_() & 1) {
...
TEST_F(F16SimdWASMRELAXEDSIMDTest, StoreTail) {
  const xnn_simd_f16_t a = xnn_loadu_f16(inputs_.data());
  std::vector<float> inputs_f32 = ToFloat32(inputs_);

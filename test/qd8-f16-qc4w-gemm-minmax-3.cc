...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC4W_GEMM_MINMAX_7X8C4__NEONDOTFP16ARITH, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/7, /*nr=*/8, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc4w_gemm_minmax_ukernel_7x8c4__neondotfp16arith,
                        xnn_init_f16_qc4w_minmax_scalar_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w);
          },
          xnn_arch_arm_neon_dot | xnn_arch_arm_neon_fp16_arith)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC4W_GEMM_MINMAX_8X8C4__NEONDOTFP16ARITH, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/8, /*nr=*/8, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc4w_gemm_minmax_ukernel_8x8c4__neondotfp16arith,
                        xnn_init_f16_qc4w_minmax_scalar_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w);
          },
          xnn_arch_arm_neon_dot | xnn_arch_arm_neon_fp16_arith)),
      ...
      testing::ValuesIn(CreateTests1(
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc4w_gemm_minmax_ukernel_1x8c8__avxvnni,
                        xnn_init_f16_qc4w_minmax_scalar_params,
                        xnn_qs8_qc4w_packw_gemm_goi_ukernel_x8c8__avxvnni);
          },
      ...
      testing::ValuesIn(CreateTests1(
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc4w_gemm_minmax_ukernel_1x8c8__avxvnni_prfm,
                        xnn_init_f16_qc4w_minmax_scalar_params,
                        xnn_qs8_qc4w_packw_gemm_goi_ukernel_x8c8__avxvnni_prfm);
          },
          xnn_arch_x86_avxvnni)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
        return info.param.test_name;
...
#if XNN_ENABLE_RISCV_FP16_VECTOR && XNN_ARCH_RISCV
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC4W_GEMM_MINMAX_7X2V__RVVFP16ARITH, GemmTest,
      testing::ValuesIn(CreateTests2(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc4w_gemm_minmax_ukernel_7x2v__rvvfp16arith,
                        xnn_init_f16_qc4w_minmax_scalar_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w);
          },

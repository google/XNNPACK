...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QU8_VMULC_MINMAX_RNDNU__NEON_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qu8_vmulc_minmax_rndnu_ukernel__neon_ld64_u8, xnn_init_qu8_mul_minmax_rndnu_neon_params);
  }
  ...
  TEST(QU8_VMULC_MINMAX_RNDNU__NEON_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qu8_vmulc_minmax_rndnu_ukernel__neon_ld64_u16, xnn_init_qu8_mul_minmax_rndnu_neon_params);
  }
  ...
  TEST(QU8_VMULC_MINMAX_RNDNU__NEON_LD128_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qu8_vmulc_minmax_rndnu_ukernel__neon_ld128_u16, xnn_init_qu8_mul_minmax_rndnu_neon_params);
  }

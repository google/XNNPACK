...
#include "vmulc-microkernel-tester.h"
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD64_X8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld64_x8, xnn_init_qs8_mul_minmax_fp32_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD64_X16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld64_x16, xnn_init_qs8_mul_minmax_fp32_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD128_X16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld128_x16, xnn_init_qs8_mul_minmax_fp32_neon_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD64_X8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld64_x8, xnn_init_qs8_mul_minmax_fp32_neonv8_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD64_X16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld64_x16, xnn_init_qs8_mul_minmax_fp32_neonv8_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD128_X16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld128_x16, xnn_init_qs8_mul_minmax_fp32_neonv8_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__WASMSIMD_MUL32_LD64_X8, batch_eq_8) {
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__wasmsimd_mul32_ld64_x8, xnn_init_qs8_mul_minmax_fp32_wasmsimd_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__WASMSIMD_MUL32_LD64_X16, batch_eq_16) {
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__wasmsimd_mul32_ld64_x16, xnn_init_qs8_mul_minmax_fp32_wasmsimd_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
  }
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_X1, batch_eq_1) {
  VMulCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_x1, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
}
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_X2, batch_eq_2) {
  VMulCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_x2, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
}
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_X4, batch_eq_4) {
  VMulCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_x4, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_init_qs8_requantization_fp32_params, xnn_qs8_requantize_fp32);
}

...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld64_u8, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld64_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD128_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld128_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld64_u8, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld64_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD128_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld128_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE2_MUL16_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse2_mul16_ld64_u8, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE2_MUL16_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse2_mul16_ld64_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE41_MUL16_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse41_mul16_ld64_u8, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE41_MUL16_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse41_mul16_ld64_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__AVX_MUL16_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__avx_mul16_ld64_u8, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__AVX_MUL16_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__avx_mul16_ld64_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__WASMSIMD_MUL32_LD64_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__wasmsimd_mul32_ld64_u8, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__WASMSIMD_MUL32_LD64_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__wasmsimd_mul32_ld64_u16, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U1V, batch_eq_1v) {
    ...
    VBinaryMicrokernelTester()
      ...
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__rvv_u1v, xnn_init_qs8_mul_minmax_scalar_params);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U2V, batch_eq_2v) {
    ...
    VBinaryMicrokernelTester()
      ...
      .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__rvv_u2v, xnn_init_qs8_mul_minmax_scalar_params);
  }
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_U1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_u1, xnn_init_qs8_mul_minmax_scalar_params);
}
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_U2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_u2, xnn_init_qs8_mul_minmax_scalar_params);
}
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_U4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .broadcast_b(true).Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_u4, xnn_init_qs8_mul_minmax_scalar_params);
}

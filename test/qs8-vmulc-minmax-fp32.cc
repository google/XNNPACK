...
#include "vmulc-microkernel-tester.h"
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD64_U8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld64_u8, xnn_init_qs8_mul_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD64_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld64_u16, xnn_init_qs8_mul_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEON_LD128_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neon_ld128_u16, xnn_init_qs8_mul_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD64_U8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld64_u8, xnn_init_qs8_mul_minmax_fp32_neonv8_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD64_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld64_u16, xnn_init_qs8_mul_minmax_fp32_neonv8_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__NEONV8_LD128_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__neonv8_ld128_u16, xnn_init_qs8_mul_minmax_fp32_neonv8_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE2_MUL16_LD64_U8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse2_mul16_ld64_u8, xnn_init_qs8_mul_minmax_fp32_sse2_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE2_MUL16_LD64_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse2_mul16_ld64_u16, xnn_init_qs8_mul_minmax_fp32_sse2_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE41_MUL16_LD64_U8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse41_mul16_ld64_u8, xnn_init_qs8_mul_minmax_fp32_sse4_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__SSE41_MUL16_LD64_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__sse41_mul16_ld64_u16, xnn_init_qs8_mul_minmax_fp32_sse4_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__AVX_MUL16_LD64_U8, batch_eq_8) {
    ...
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__avx_mul16_ld64_u8, xnn_init_qs8_mul_minmax_fp32_sse4_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__AVX_MUL16_LD64_U16, batch_eq_16) {
    ...
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__avx_mul16_ld64_u16, xnn_init_qs8_mul_minmax_fp32_sse4_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__WASMSIMD_MUL32_LD64_U8, batch_eq_8) {
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__wasmsimd_mul32_ld64_u8, xnn_init_qs8_mul_minmax_fp32_wasmsimd_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__WASMSIMD_MUL32_LD64_U16, batch_eq_16) {
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__wasmsimd_mul32_ld64_u16, xnn_init_qs8_mul_minmax_fp32_wasmsimd_params, xnn_qs8_requantize_fp32);
  }
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, batch_eq_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    VMulCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__rvv_u8, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, batch_div_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, batch_lt_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, batch_gt_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U8, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, batch_eq_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    VMulCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__rvv_u16, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, batch_div_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, batch_lt_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, batch_gt_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U16, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, batch_eq_32) {
    TEST_REQUIRES_RISCV_VECTOR;
    VMulCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__rvv_u32, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, batch_div_32) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, batch_lt_32) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, batch_gt_32) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VMulCMicrokernelTester()
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_VMULC_MINMAX_FP32__RVV_U32, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VMulCMicrokernelTester()
        .batch_size(batch_size)
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_U1, batch_eq_1) {
  VMulCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_u1, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_qs8_requantize_fp32);
}
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_U2, batch_eq_2) {
  VMulCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_u2, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_qs8_requantize_fp32);
}
...
TEST(QS8_VMULC_MINMAX_FP32__SCALAR_U4, batch_eq_4) {
  VMulCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qs8_vmulc_minmax_fp32_ukernel__scalar_u4, xnn_init_qs8_mul_minmax_fp32_scalar_params, xnn_qs8_requantize_fp32);
}

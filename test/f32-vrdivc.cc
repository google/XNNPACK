...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VRDIVC__WASMSIMD_U4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrdivc_ukernel__wasmsimd_u4, VBinaryCMicrokernelTester::OpType::RDivC);
  }
  ...
  TEST(F32_VRDIVC__WASMSIMD_U8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrdivc_ukernel__wasmsimd_u8, VBinaryCMicrokernelTester::OpType::RDivC);
  }
  ...
  TEST(F32_VRDIVC__WASMSIMD_U16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vrdivc_ukernel__wasmsimd_u16, VBinaryCMicrokernelTester::OpType::RDivC);
  }
...
TEST(F32_VRDIVC__SCALAR_U1, batch_eq_1) {
  VBinaryCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vrdivc_ukernel__scalar_u1, VBinaryCMicrokernelTester::OpType::RDivC);
}
...
TEST(F32_VRDIVC__SCALAR_U2, batch_eq_2) {
  VBinaryCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vrdivc_ukernel__scalar_u2, VBinaryCMicrokernelTester::OpType::RDivC);
}
...
TEST(F32_VRDIVC__SCALAR_U4, batch_eq_4) {
  VBinaryCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vrdivc_ukernel__scalar_u4, VBinaryCMicrokernelTester::OpType::RDivC);
}
...
TEST(F32_VRDIVC__SCALAR_U8, batch_eq_8) {
  VBinaryCMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vrdivc_ukernel__scalar_u8, VBinaryCMicrokernelTester::OpType::RDivC);
}

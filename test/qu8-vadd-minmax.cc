...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, batch_eq_1v) {
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, batch_gt_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_eq_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_div_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_lt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_gt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;

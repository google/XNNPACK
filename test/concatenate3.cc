...
template <typename T>
class Concatenate3Test : public ::testing::Test {
 protected:
  Concatenate3Test() {
...
using Concatenate3TestF16 = Concatenate3Test<xnn_float16>;
...
TEST_F(Concatenate3TestQS8, define) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                subgraph, xnn_datatype_qint8, signed_zero_point, scale,
                output_dims.size(), output_dims.data(), nullptr, 3,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output_id));
  ASSERT_NE(output_id, XNN_INVALID_NODE_ID);

  ASSERT_EQ(xnn_status_success,
            xnn_define_concatenate3(subgraph, axis, input1_id, input2_id,
                                    input3_id, output_id, /*flags=*/0));

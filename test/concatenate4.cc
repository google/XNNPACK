...
template <typename T>
class Concatenate4Test : public ::testing::Test {
 protected:
  Concatenate4Test() {
...
using Concatenate4TestF16 = Concatenate4Test<xnn_float16>;
...
TEST_F(Concatenate4TestQS8, define) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                subgraph, xnn_datatype_qint8, signed_zero_point, scale,
                output_dims.size(), output_dims.data(), nullptr, 4,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output_id));
  ASSERT_NE(output_id, XNN_INVALID_NODE_ID);

  ASSERT_EQ(
      xnn_status_success,
      xnn_define_concatenate4(subgraph, axis, input1_id, input2_id, input3_id,
                              input4_id, output_id, /*flags=*/0));

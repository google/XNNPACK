...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC8W_GEMM_MINMAX_7X16C4__NEONDOTFP16ARITH, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc8w_gemm_minmax_ukernel_7x16c4__neondotfp16arith,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_pack_qs8_gemm_goi_w);
          },
          xnn_arch_arm_neon_dot | xnn_arch_arm_neon_fp16_arith)),
...
#if XNN_ENABLE_RISCV_FP16_VECTOR && XNN_ARCH_RISCV
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC8W_GEMM_MINMAX_4X2V__RVVFP16ARITH, GemmTest,
      testing::ValuesIn(CreateTests2(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc8w_gemm_minmax_ukernel_4x2v__rvvfp16arith,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_pack_qs8_gemm_goi_w);
          },

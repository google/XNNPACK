...
#include "vlrelu-microkernel-tester.h"
  ...
  TEST(QS8_VLRELU__NEON_U8, batch_eq_8) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vlrelu_ukernel__neon_u8, xnn_init_qs8_lrelu_neon_params);
  }
  ...
  TEST(QS8_VLRELU__NEON_U16, batch_eq_16) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__neon_u16, xnn_init_qs8_lrelu_neon_params);
  }
  ...
  TEST(QS8_VLRELU__NEON_U32, batch_eq_32) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__neon_u32, xnn_init_qs8_lrelu_neon_params);
  }
  ...
  TEST(QS8_VLRELU__SSE2_U16, batch_eq_16) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__sse2_u16, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__SSE2_U32, batch_eq_32) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__sse2_u32, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__SSSE3_U16, batch_eq_16) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__ssse3_u16, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__SSSE3_U32, batch_eq_32) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__ssse3_u32, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__SSE41_U8, batch_eq_8) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vlrelu_ukernel__sse41_u8, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__SSE41_U16, batch_eq_16) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__sse41_u16, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__SSE41_U32, batch_eq_32) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__sse41_u32, xnn_init_qs8_lrelu_sse2_params);
  }
  ...
  TEST(QS8_VLRELU__AVX_U8, batch_eq_8) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vlrelu_ukernel__avx_u8, xnn_init_qs8_lrelu_avx_params);
  }
  ...
  TEST(QS8_VLRELU__AVX_U16, batch_eq_16) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__avx_u16, xnn_init_qs8_lrelu_avx_params);
  }
  ...
  TEST(QS8_VLRELU__AVX_U32, batch_eq_32) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__avx_u32, xnn_init_qs8_lrelu_avx_params);
  }
  ...
  TEST(QS8_VLRELU__AVX2_U16, batch_eq_16) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__avx2_u16, xnn_init_qs8_lrelu_avx2_params);
  }
  ...
  TEST(QS8_VLRELU__AVX2_U32, batch_eq_32) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__avx2_u32, xnn_init_qs8_lrelu_avx2_params);
  }
  ...
  TEST(QS8_VLRELU__AVX2_U64, batch_eq_64) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs8_vlrelu_ukernel__avx2_u64, xnn_init_qs8_lrelu_avx2_params);
  }
  ...
  TEST(QS8_VLRELU__WASMSIMD_ARM_U16, batch_eq_16) {
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__wasmsimd_arm_u16, xnn_init_qs8_lrelu_wasmsimd_arm_params);
  }
  ...
  TEST(QS8_VLRELU__WASMSIMD_ARM_U32, batch_eq_32) {
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__wasmsimd_arm_u32, xnn_init_qs8_lrelu_wasmsimd_arm_params);
  }
  ...
  TEST(QS8_VLRELU__WASMSIMD_X86_U8, batch_eq_8) {
    VLReLUMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vlrelu_ukernel__wasmsimd_x86_u8, xnn_init_qs8_lrelu_wasmsimd_x86_params);
  }
  ...
  TEST(QS8_VLRELU__WASMSIMD_X86_U16, batch_eq_16) {
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__wasmsimd_x86_u16, xnn_init_qs8_lrelu_wasmsimd_x86_params);
  }
  ...
  TEST(QS8_VLRELU__WASMSIMD_X86_U32, batch_eq_32) {
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__wasmsimd_x86_u32, xnn_init_qs8_lrelu_wasmsimd_x86_params);
  }
  ...
  TEST(QS8_VLRELU__WASMRELAXEDSIMD_ARM_U16, batch_eq_16) {
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__wasmrelaxedsimd_arm_u16, xnn_init_qs8_lrelu_wasmsimd_arm_params);
  }
  ...
  TEST(QS8_VLRELU__WASMRELAXEDSIMD_ARM_U32, batch_eq_32) {
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__wasmrelaxedsimd_arm_u32, xnn_init_qs8_lrelu_wasmsimd_arm_params);
  }
  ...
  TEST(QS8_VLRELU__WASMRELAXEDSIMD_X86_U8, batch_eq_8) {
    VLReLUMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vlrelu_ukernel__wasmrelaxedsimd_x86_u8, xnn_init_qs8_lrelu_wasmsimd_x86_params);
  }
  ...
  TEST(QS8_VLRELU__WASMRELAXEDSIMD_X86_U16, batch_eq_16) {
    VLReLUMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vlrelu_ukernel__wasmrelaxedsimd_x86_u16, xnn_init_qs8_lrelu_wasmsimd_x86_params);
  }
  ...
  TEST(QS8_VLRELU__WASMRELAXEDSIMD_X86_U32, batch_eq_32) {
    VLReLUMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vlrelu_ukernel__wasmrelaxedsimd_x86_u32, xnn_init_qs8_lrelu_wasmsimd_x86_params);
  }
  ...
  TEST(QS8_VLRELU__ARMSIMD32_U4, batch_eq_4) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(4)
      .Test(xnn_qs8_vlrelu_ukernel__armsimd32_u4, xnn_init_qs8_lrelu_armsimd32_params);
  }
  ...
  TEST(QS8_VLRELU__ARMSIMD32_U8, batch_eq_8) {
    ...
    VLReLUMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vlrelu_ukernel__armsimd32_u8, xnn_init_qs8_lrelu_armsimd32_params);
  }
...
TEST(QS8_VLRELU__SCALAR_SELECT_U1, batch_eq_1) {
  VLReLUMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qs8_vlrelu_ukernel__scalar_select_u1, xnn_init_qs8_lrelu_scalar_select_params);
}
...
TEST(QS8_VLRELU__SCALAR_SELECT_U2, batch_eq_2) {
  VLReLUMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qs8_vlrelu_ukernel__scalar_select_u2, xnn_init_qs8_lrelu_scalar_select_params);
}
...
TEST(QS8_VLRELU__SCALAR_SELECT_U4, batch_eq_4) {
  VLReLUMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qs8_vlrelu_ukernel__scalar_select_u4, xnn_init_qs8_lrelu_scalar_select_params);
}
...
TEST(QS8_VLRELU__SCALAR_ANDXOR_U1, batch_eq_1) {
  VLReLUMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qs8_vlrelu_ukernel__scalar_andxor_u1, xnn_init_qs8_lrelu_scalar_andxor_params);
}
...
TEST(QS8_VLRELU__SCALAR_ANDXOR_U2, batch_eq_2) {
  VLReLUMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qs8_vlrelu_ukernel__scalar_andxor_u2, xnn_init_qs8_lrelu_scalar_andxor_params);
}
...
TEST(QS8_VLRELU__SCALAR_ANDXOR_U4, batch_eq_4) {
  VLReLUMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qs8_vlrelu_ukernel__scalar_andxor_u4, xnn_init_qs8_lrelu_scalar_andxor_params);
}

...
#include "test/reduce-microkernel-tester.h"
  ...
  TEST(F32_RMIN__AVX_U8, batch_eq_8) {
    ...
    ReduceMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_rmin_ukernel__avx_u8, ReduceMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F32_RMIN__AVX_U16_ACC2, batch_eq_16) {
    ...
    ReduceMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_rmin_ukernel__avx_u16_acc2, ReduceMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F32_RMIN__AVX_U24_ACC3, batch_eq_24) {
    ...
    ReduceMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_rmin_ukernel__avx_u24_acc3, ReduceMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F32_RMIN__AVX_U32_ACC2, batch_eq_32) {
    ...
    ReduceMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_rmin_ukernel__avx_u32_acc2, ReduceMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F32_RMIN__AVX_U32_ACC4, batch_eq_32) {
    ...
    ReduceMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_rmin_ukernel__avx_u32_acc4, ReduceMicrokernelTester::OpType::Min);
  }
...
TEST(F32_RMIN__SCALAR_U4_ACC4, batch_gt_4) {
  ...
  TEST(F32_RMIN__HVX_U32, batch_eq_32) {
    TEST_REQUIRES_HVX;
    ReduceMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_rmin_ukernel__hvx_u32, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F32_RMIN__HVX_U32, batch_div_32) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RMIN__HVX_U32, batch_lt_32) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RMIN__HVX_U32, batch_gt_32) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_HVX && XNN_ARCH_HEXAGON
  TEST(F32_RMIN__HVX_U64_ACC2, batch_eq_64) {
    TEST_REQUIRES_HVX;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_rmin_ukernel__hvx_u64_acc2, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F32_RMIN__HVX_U64_ACC2, batch_div_64) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RMIN__HVX_U64_ACC2, batch_lt_64) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RMIN__HVX_U64_ACC2, batch_gt_64) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_HVX && XNN_ARCH_HEXAGON
  TEST(F32_RMIN__HVX_U96_ACC3, batch_eq_96) {
    TEST_REQUIRES_HVX;
    ReduceMicrokernelTester()
      .batch_size(96)
      .Test(xnn_f32_rmin_ukernel__hvx_u96_acc3, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F32_RMIN__HVX_U96_ACC3, batch_div_96) {
    TEST_REQUIRES_HVX;
  ...
  TEST(F32_RMIN__HVX_U96_ACC3, batch_lt_96) {
    TEST_REQUIRES_HVX;
  ...
  TEST(F32_RMIN__HVX_U96_ACC3, batch_gt_96) {
    TEST_REQUIRES_HVX;
...
#if XNN_ENABLE_HVX && XNN_ARCH_HEXAGON
  TEST(F32_RMIN__HVX_U128_ACC2, batch_eq_128) {
    TEST_REQUIRES_HVX;
    ReduceMicrokernelTester()
      .batch_size(128)
      .Test(xnn_f32_rmin_ukernel__hvx_u128_acc2, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F32_RMIN__HVX_U128_ACC2, batch_div_128) {
    TEST_REQUIRES_HVX;
  ...
  TEST(F32_RMIN__HVX_U128_ACC2, batch_lt_128) {
    TEST_REQUIRES_HVX;
  ...
  TEST(F32_RMIN__HVX_U128_ACC2, batch_gt_128) {
    TEST_REQUIRES_HVX;
...
#if XNN_ENABLE_HVX && XNN_ARCH_HEXAGON
  TEST(F32_RMIN__HVX_U128_ACC4, batch_eq_128) {
    TEST_REQUIRES_HVX;
    ReduceMicrokernelTester()
      .batch_size(128)
      .Test(xnn_f32_rmin_ukernel__hvx_u128_acc4, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F32_RMIN__HVX_U128_ACC4, batch_div_128) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 256; batch_size < 1280; batch_size += 128) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RMIN__HVX_U128_ACC4, batch_lt_128) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 1; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RMIN__HVX_U128_ACC4, batch_gt_128) {
    TEST_REQUIRES_HVX;
    for (size_t batch_size = 129; batch_size < 256; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)

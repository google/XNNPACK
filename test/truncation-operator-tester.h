...
class TruncationOperatorTester {
 public:
  inline TruncationOperatorTester& channels(size_t channels) {
    assert(channels != 0);
  ...
  inline TruncationOperatorTester& input_stride(size_t input_stride) {
  ...
  inline TruncationOperatorTester& output_stride(size_t output_stride) {
  ...
  inline TruncationOperatorTester& batch_size(size_t batch_size) {
    assert(batch_size != 0);
  ...
  inline TruncationOperatorTester& iterations(size_t iterations) {

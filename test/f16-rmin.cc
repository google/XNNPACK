...
#include "reduce-microkernel-tester.h"
  ...
  TEST(F16_RMIN__AVX512FP16_U32, batch_eq_32) {
    TEST_REQUIRES_X86_AVX512FP16;
    ReduceMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f16_rmin_ukernel__avx512fp16_u32, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512FP16_U32, batch_div_32) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512FP16_U32, batch_lt_32) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512FP16_U32, batch_gt_32) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_AVX512FP16 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  TEST(F16_RMIN__AVX512FP16_U64_ACC2, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512FP16;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_rmin_ukernel__avx512fp16_u64_acc2, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512FP16_U64_ACC2, batch_div_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_RMIN__AVX512FP16_U64_ACC2, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_RMIN__AVX512FP16_U64_ACC2, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512FP16;
...
#if XNN_ENABLE_AVX512FP16 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  TEST(F16_RMIN__AVX512FP16_U96_ACC3, batch_eq_96) {
    TEST_REQUIRES_X86_AVX512FP16;
    ReduceMicrokernelTester()
      .batch_size(96)
      .Test(xnn_f16_rmin_ukernel__avx512fp16_u96_acc3, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512FP16_U96_ACC3, batch_div_96) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_RMIN__AVX512FP16_U96_ACC3, batch_lt_96) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_RMIN__AVX512FP16_U96_ACC3, batch_gt_96) {
    TEST_REQUIRES_X86_AVX512FP16;
...
#if XNN_ENABLE_AVX512FP16 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  TEST(F16_RMIN__AVX512FP16_U128_ACC2, batch_eq_128) {
    TEST_REQUIRES_X86_AVX512FP16;
    ReduceMicrokernelTester()
      .batch_size(128)
      .Test(xnn_f16_rmin_ukernel__avx512fp16_u128_acc2, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512FP16_U128_ACC2, batch_div_128) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_RMIN__AVX512FP16_U128_ACC2, batch_lt_128) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_RMIN__AVX512FP16_U128_ACC2, batch_gt_128) {
    TEST_REQUIRES_X86_AVX512FP16;
...
#if XNN_ENABLE_AVX512FP16 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  TEST(F16_RMIN__AVX512FP16_U128_ACC4, batch_eq_128) {
    TEST_REQUIRES_X86_AVX512FP16;
    ReduceMicrokernelTester()
      .batch_size(128)
      .Test(xnn_f16_rmin_ukernel__avx512fp16_u128_acc4, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512FP16_U128_ACC4, batch_div_128) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 256; batch_size < 1280; batch_size += 128) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512FP16_U128_ACC4, batch_lt_128) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 1; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512FP16_U128_ACC4, batch_gt_128) {
    TEST_REQUIRES_X86_AVX512FP16;
    for (size_t batch_size = 129; batch_size < 256; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U16, batch_eq_16) {
    TEST_REQUIRES_X86_AVX512SKX;
    ReduceMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_rmin_ukernel__avx512skx_u16, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512SKX_U16, batch_div_16) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U16, batch_lt_16) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U16, batch_gt_16) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F16_RMIN__AVX512SKX_U32_ACC2, batch_eq_32) {
    TEST_REQUIRES_X86_AVX512SKX;
    ReduceMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f16_rmin_ukernel__avx512skx_u32_acc2, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512SKX_U32_ACC2, batch_div_32) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U32_ACC2, batch_lt_32) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U32_ACC2, batch_gt_32) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F16_RMIN__AVX512SKX_U48_ACC3, batch_eq_48) {
    TEST_REQUIRES_X86_AVX512SKX;
    ReduceMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f16_rmin_ukernel__avx512skx_u48_acc3, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512SKX_U48_ACC3, batch_div_48) {
    TEST_REQUIRES_X86_AVX512SKX;
  ...
  TEST(F16_RMIN__AVX512SKX_U48_ACC3, batch_lt_48) {
    TEST_REQUIRES_X86_AVX512SKX;
  ...
  TEST(F16_RMIN__AVX512SKX_U48_ACC3, batch_gt_48) {
    TEST_REQUIRES_X86_AVX512SKX;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F16_RMIN__AVX512SKX_U64_ACC2, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_rmin_ukernel__avx512skx_u64_acc2, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512SKX_U64_ACC2, batch_div_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U64_ACC2, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U64_ACC2, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F16_RMIN__AVX512SKX_U64_ACC4, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_rmin_ukernel__avx512skx_u64_acc4, ReduceMicrokernelTester::OpType::Min);
  }

  TEST(F16_RMIN__AVX512SKX_U64_ACC4, batch_div_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U64_ACC4, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMIN__AVX512SKX_U64_ACC4, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)

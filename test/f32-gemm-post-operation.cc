...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_1X8__AARCH64_NEONFMA_A75, hardswish) {
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_1X8__AARCH64_NEONFMA_PRFM_A75, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(1)
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_4X8__AARCH64_NEONFMA_CORTEX_A75, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_4X8__AARCH64_NEONFMA_PRFM_CORTEX_A75, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_6X8__AARCH64_NEONFMA_A75, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(6)
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_4X8__AARCH32_NEON_LD64, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_4X8__AARCH32_NEON_CORTEX_A7, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)
...
TEST(XNN_GENERATE_F32_GEMM_UKERNEL_4X8__AARCH32_NEON_CORTEX_A53, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)

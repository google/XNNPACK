...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F16_VSUBC_MINMAX__NEONFP16ARITH_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f16_vsubc_minmax_ukernel__neonfp16arith_x8, VBinaryCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F16_VSUBC_MINMAX__NEONFP16ARITH_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_vsubc_minmax_ukernel__neonfp16arith_x16, VBinaryCMicrokernelTester::OpType::SubC);
  }

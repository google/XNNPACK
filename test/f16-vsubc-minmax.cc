...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F16_VSUBC_MINMAX__NEONFP16ARITH_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f16_vsubc_minmax_ukernel__neonfp16arith_x8, VBinaryCMicrokernelTester::OpType::SubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VSUBC_MINMAX__NEONFP16ARITH_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_vsubc_minmax_ukernel__neonfp16arith_x16, VBinaryCMicrokernelTester::OpType::SubC, xnn_init_f16_minmax_fp16arith_params);
  }
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X1, batch_eq_1) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    VBinaryCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f16_vsubc_minmax_ukernel__fp16arith_x1, VBinaryCMicrokernelTester::OpType::SubC, xnn_init_f16_minmax_fp16arith_params);
  }

  TEST(F16_VSUBC_MINMAX__FP16ARITH_X1, batch_gt_1) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X1, inplace) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X1, qmin) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X1, qmax) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_ARM_FP16_SCALAR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, batch_eq_2) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    VBinaryCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f16_vsubc_minmax_ukernel__fp16arith_x2, VBinaryCMicrokernelTester::OpType::SubC, xnn_init_f16_minmax_fp16arith_params);
  }

  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, batch_div_2) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, batch_lt_2) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, batch_gt_2) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, inplace) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, qmin) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X2, qmax) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_ARM_FP16_SCALAR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, batch_eq_4) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f16_vsubc_minmax_ukernel__fp16arith_x4, VBinaryCMicrokernelTester::OpType::SubC, xnn_init_f16_minmax_fp16arith_params);
  }

  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, batch_div_4) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, batch_lt_4) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, batch_gt_4) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, inplace) {
    TEST_REQUIRES_ARM_FP16_ARITH;
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, qmin) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_VSUBC_MINMAX__FP16ARITH_X4, qmax) {
    TEST_REQUIRES_ARM_FP16_ARITH;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)

...
#include "avgpool-microkernel-tester.h"
  ...
  TEST(QU8_AVGPOOL_MINMAX_9P8X__NEON_C8, channels_eq_8_twopass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(8)
      .Test(xnn_qu8_avgpool_minmax_ukernel_9p8x__neon_c8, xnn_init_qu8_avgpool_minmax_params);
  }
  ...
  TEST(QU8_AVGPOOL_MINMAX_9P8X__SSE2_C8, channels_eq_8_twopass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(8)
      .Test(xnn_qu8_avgpool_minmax_ukernel_9p8x__sse2_c8, xnn_init_qu8_avgpool_minmax_params);
  }
...
TEST(QU8_AVGPOOL_MINMAX_9P8X__SCALAR_C1, channels_eq_1_twopass_fulltile) {
  AvgPoolMicrokernelTester()
    ...
    .pooling_tile(9, 8)
    .channels(1)
    .Test(xnn_qu8_avgpool_minmax_ukernel_9p8x__scalar_c1, xnn_init_qu8_avgpool_minmax_scalar_params);
}
...
TEST(QU8_AVGPOOL_MINMAX_9P8X__SCALAR_C1, few_output_pixels_with_step) {
  ...
  TEST(QU8_AVGPOOL_MINMAX_9X__NEON_C8, channels_eq_8_unipass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(8)
      .Test(xnn_qu8_avgpool_minmax_ukernel_9x__neon_c8, xnn_init_qu8_avgpool_minmax_params);
  }
  ...
  TEST(QU8_AVGPOOL_MINMAX_9X__SSE2_C8, channels_eq_8_unipass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(8)
      .Test(xnn_qu8_avgpool_minmax_ukernel_9x__sse2_c8, xnn_init_qu8_avgpool_minmax_params);
  }
...
TEST(QU8_AVGPOOL_MINMAX_9X__SCALAR_C1, channels_eq_1_unipass_fulltile) {
  AvgPoolMicrokernelTester()
    ...
    .pooling_tile(9)
    .channels(1)
    .Test(xnn_qu8_avgpool_minmax_ukernel_9x__scalar_c1, xnn_init_qu8_avgpool_minmax_scalar_params);
}

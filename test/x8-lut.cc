...
TEST(X8_LUT__SCALAR_X16, inplace) {
...
#if XNN_ARCH_ARM64
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X16, batch_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    LUTMicrokernelTester()
      .batch_size(16)
      .Test(xnn_x8_lut_ukernel__aarch64_neon_tbx128x4_x16);
  }

  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X16, batch_div_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X16, batch_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X16, batch_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X16, inplace) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_ARM64
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X32, batch_eq_32) {
    TEST_REQUIRES_ARM_NEON;
    LUTMicrokernelTester()
      .batch_size(32)
      .Test(xnn_x8_lut_ukernel__aarch64_neon_tbx128x4_x32);
  }

  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X32, batch_div_32) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X32, batch_lt_32) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X32, batch_gt_32) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X32, inplace) {
    TEST_REQUIRES_ARM_NEON;
...
#if XNN_ARCH_ARM64
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X48, batch_eq_48) {
    TEST_REQUIRES_ARM_NEON;
    LUTMicrokernelTester()
      .batch_size(48)
      .Test(xnn_x8_lut_ukernel__aarch64_neon_tbx128x4_x48);
  }

  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X48, batch_div_48) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X48, batch_lt_48) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X48, batch_gt_48) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X48, inplace) {
    TEST_REQUIRES_ARM_NEON;
...
#if XNN_ARCH_ARM64
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X64, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON;
    LUTMicrokernelTester()
      .batch_size(64)
      .Test(xnn_x8_lut_ukernel__aarch64_neon_tbx128x4_x64);
  }

  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X64, batch_div_64) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X64, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X64, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X8_LUT__AARCH64_NEON_TBX128X4_X64, inplace) {
    TEST_REQUIRES_ARM_NEON;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X64, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512VBMI;
    LUTMicrokernelTester()
      .batch_size(64)
      .Test(xnn_x8_lut_ukernel__avx512vbmi_vpermx2b_x64);
  }

  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X64, batch_div_64) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X64, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X64, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X64, inplace) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size <= 320; batch_size += 63) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X128, batch_eq_128) {
    TEST_REQUIRES_X86_AVX512VBMI;
    LUTMicrokernelTester()
      .batch_size(128)
      .Test(xnn_x8_lut_ukernel__avx512vbmi_vpermx2b_x128);
  }

  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X128, batch_div_128) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 256; batch_size < 1280; batch_size += 128) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X128, batch_lt_128) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size < 128; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X128, batch_gt_128) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 129; batch_size < 256; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X128, inplace) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size <= 640; batch_size += 127) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X192, batch_eq_192) {
    TEST_REQUIRES_X86_AVX512VBMI;
    LUTMicrokernelTester()
      .batch_size(192)
      .Test(xnn_x8_lut_ukernel__avx512vbmi_vpermx2b_x192);
  }

  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X192, batch_div_192) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 384; batch_size < 1920; batch_size += 192) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X192, batch_lt_192) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size < 192; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X192, batch_gt_192) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 193; batch_size < 384; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X192, inplace) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size <= 960; batch_size += 191) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X256, batch_eq_256) {
    TEST_REQUIRES_X86_AVX512VBMI;
    LUTMicrokernelTester()
      .batch_size(256)
      .Test(xnn_x8_lut_ukernel__avx512vbmi_vpermx2b_x256);
  }

  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X256, batch_div_256) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 512; batch_size < 2560; batch_size += 256) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X256, batch_lt_256) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size < 256; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X256, batch_gt_256) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 257; batch_size < 512; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__AVX512VBMI_VPERMX2B_X256, inplace) {
    TEST_REQUIRES_X86_AVX512VBMI;
    for (size_t batch_size = 1; batch_size <= 1280; batch_size += 255) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X16, batch_eq_16) {
    TEST_REQUIRES_WASM_PSHUFB;
    LUTMicrokernelTester()
      .batch_size(16)
      .Test(xnn_x8_lut_ukernel__wasmpshufb_x16);
  }

  TEST(X8_LUT__WASMPSHUFB_X16, batch_div_16) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X16, batch_lt_16) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X16, batch_gt_16) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X16, inplace) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(X8_LUT__WASMPSHUFB_X32, batch_eq_32) {
    TEST_REQUIRES_WASM_PSHUFB;
    LUTMicrokernelTester()
      .batch_size(32)
      .Test(xnn_x8_lut_ukernel__wasmpshufb_x32);
  }

  TEST(X8_LUT__WASMPSHUFB_X32, batch_div_32) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X32, batch_lt_32) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X32, batch_gt_32) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X32, inplace) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(X8_LUT__WASMPSHUFB_X48, batch_eq_48) {
    TEST_REQUIRES_WASM_PSHUFB;
    LUTMicrokernelTester()
      .batch_size(48)
      .Test(xnn_x8_lut_ukernel__wasmpshufb_x48);
  }

  TEST(X8_LUT__WASMPSHUFB_X48, batch_div_48) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 96; batch_size < 480; batch_size += 48) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X48, batch_lt_48) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size < 48; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X48, batch_gt_48) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 49; batch_size < 96; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X48, inplace) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size <= 240; batch_size += 47) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(X8_LUT__WASMPSHUFB_X64, batch_eq_64) {
    TEST_REQUIRES_WASM_PSHUFB;
    LUTMicrokernelTester()
      .batch_size(64)
      .Test(xnn_x8_lut_ukernel__wasmpshufb_x64);
  }

  TEST(X8_LUT__WASMPSHUFB_X64, batch_div_64) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X64, batch_lt_64) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X64, batch_gt_64) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      LUTMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(X8_LUT__WASMPSHUFB_X64, inplace) {
    TEST_REQUIRES_WASM_PSHUFB;
    for (size_t batch_size = 1; batch_size <= 320; batch_size += 63) {
      LUTMicrokernelTester()
        .batch_size(batch_size)

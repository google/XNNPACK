...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VNEG__PSIMD_X4, batch_eq_4) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__psimd_x4), VUnOpMicrokernelTester::OpType::Negate, VUnOpMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VNEG__PSIMD_X8, batch_eq_8) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__psimd_x8), VUnOpMicrokernelTester::OpType::Negate, VUnOpMicrokernelTester::Variant::Scalar);
  }

...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VNEG__NEON_X4, batch_eq_4) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__neon_x4), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__NEON_X8, batch_eq_8) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__neon_x8), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__SSE_X4, batch_eq_4) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__sse_x4), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__SSE_X8, batch_eq_8) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__sse_x8), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__AVX_X8, batch_eq_8) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__avx_x8), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__AVX_X16, batch_eq_16) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__avx_x16), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__AVX512F_X16, batch_eq_16) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__avx512f_x16), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__AVX512F_X32, batch_eq_32) {
    ...
    VUnOpMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__avx512f_x32), VUnOpMicrokernelTester::OpType::Neg);
  }
  ...
  TEST(F32_VNEG__PSIMD_X4, batch_eq_4) {
    TEST_REQUIRES_PSIMD;
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__psimd_x4), VUnOpMicrokernelTester::OpType::Neg, VUnOpMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VNEG__PSIMD_X4, batch_div_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VNEG__PSIMD_X4, batch_lt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VNEG__PSIMD_X4, batch_gt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VNEG__PSIMD_X4, inplace) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
...
#if !XNN_ARCH_ASMJS && !XNN_ARCH_WASM && !XNN_COMPILER_MSVC && !XNN_COMPILER_ICC
  TEST(F32_VNEG__PSIMD_X8, batch_eq_8) {
    TEST_REQUIRES_PSIMD;
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__psimd_x8), VUnOpMicrokernelTester::OpType::Neg, VUnOpMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VNEG__PSIMD_X8, batch_div_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VNEG__PSIMD_X8, batch_lt_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VNEG__PSIMD_X8, batch_gt_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VNEG__PSIMD_X8, inplace) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
...
TEST(F32_VNEG__SCALAR_X1, batch_eq_1) {
  VUnOpMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__scalar_x1), VUnOpMicrokernelTester::OpType::Neg, VUnOpMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VNEG__SCALAR_X2, batch_eq_2) {
  VUnOpMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__scalar_x2), VUnOpMicrokernelTester::OpType::Neg, VUnOpMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VNEG__SCALAR_X4, batch_eq_4) {
  VUnOpMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vneg_ukernel__scalar_x4), VUnOpMicrokernelTester::OpType::Neg, VUnOpMicrokernelTester::Variant::Scalar);
}

...
TEST(XNN_GENERATE_F32_IGEMM_UKERNEL_4X8__AARCH32_NEON_LD64, hardswish) {
...
TEST(XNN_GENERATE_F32_IGEMM_UKERNEL_4X8__AARCH32_NEON_CORTEX_A7, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)
...
TEST(XNN_GENERATE_F32_IGEMM_UKERNEL_4X8__AARCH32_NEON_CORTEX_A55, hardswish) {
  TEST_REQUIRES_ARM_NEON_FMA;
  std::vector<xnn_post_operation> fused_operators = { {xnn_post_operation_type_hardswish} };
  GemmMicrokernelTester()
    .mr(4)

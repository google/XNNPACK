...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, unit_batch_bl_lt_ic) {
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, unit_batch_bl_eq_256) {
  for (size_t ic=256; ic<=4096; ic*=2){
    FullyConnectedOperatorTester()
      .batch_size(1)
      .output_channels(1)
      .input_channels(ic)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, unit_batch_bl_eq_kr) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .batch_size(1)
      .output_channels(21)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, unit_batch_bl_eq_kc) {
  for (size_t ic=16; ic<=1024; ic*=2){
    FullyConnectedOperatorTester()
      .batch_size(1)
      .output_channels(31)
      .input_channels(ic)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, unit_batch_bl_eq_kr_no_bias) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .has_bias(false)
      .batch_size(1)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, small_batch_bl_lt_ic) {
  for (size_t ic=8; ic<=32; ic+=8){
    for (size_t bs=ic; bs<=ic; bs+=ic/2) {
      if (bs % 8 /*MAX_KR*/ != 0) {
        continue;
      }
      FullyConnectedOperatorTester()
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, small_batch_bl_eq_kr) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .batch_size(12)
      .output_channels(21)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, small_batch_bl_eq_kr_no_bias) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .has_bias(false)
      .batch_size(13)
...
// TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, small_batch_bl_eq_kr_odd_ic_no_bias) {
//   for (size_t ic=17; ic<=60; ic+=9){
//     FullyConnectedOperatorTester()
//       .has_bias(false)
//       .batch_size(13)
//       .output_channels(23)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, unit_batch_bl_lt_ic) {
  for (size_t ic=16; ic<=32; ic+=8){
    for (size_t bs=ic/2; bs<=ic; bs+=ic/2) {
      if (bs % 8 /*MAX_KR*/ != 0) {
        continue;
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, unit_batch_bl_eq_kr) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .batch_size(1)
      .output_channels(21)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, unit_batch_bl_eq_kr_no_bias) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .has_bias(false)
      .batch_size(1)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, small_batch_bl_lt_ic) {
  for (size_t ic=8; ic<=32; ic+=8){
    for (size_t bs=ic; bs<=ic; bs+=ic/2) {
      if (bs % 8 /*MAX_KR*/ != 0) {
        continue;
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, small_batch_bl_eq_kr) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .batch_size(12)
      .output_channels(21)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, small_batch_bl_eq_kr_no_bias) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .has_bias(false)
      .batch_size(13)
...
// TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, small_batch_bl_eq_kr_odd_ic_no_bias) {
//   for (size_t ic=17; ic<=60; ic+=9){
//     FullyConnectedOperatorTester()
//       .has_bias(false)
//       .batch_size(13)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, small_batch_bl_eq_kr_no_bias_opt_packing) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .has_bias(false)
      .batch_size(13)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, small_batch_bl_eq_kr_with_bias_opt_packing) {
  for (size_t ic=16; ic<=32; ic+=8){
    FullyConnectedOperatorTester()
      .has_bias(true)
      .batch_size(14)

...
#include "gemm-microkernel-tester.h"
...
#if XNN_ARCH_ARM64 && XNN_ENABLE_ASSEMBLY
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_eq_4) {
    TEST_REQUIRES_ARM_NEON_FMA;
    GemmMicrokernelTester()
      .mr(6)
      .nr(8)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_eq_4_strided_a) {
    TEST_REQUIRES_ARM_NEON_FMA;
    GemmMicrokernelTester()
      .mr(6)
      .nr(8)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (uint32_t m = 1; m <= 6; m++) {
      for (uint32_t n = 1; n <= 8; n++) {
        GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_eq_4_subtile_m) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (uint32_t m = 1; m <= 6; m++) {
      GemmMicrokernelTester()
        .mr(6)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_eq_4_subtile_n) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(6)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_lt_4) {
    TEST_REQUIRES_ARM_NEON_FMA;
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_lt_4_strided_a) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(6)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (size_t k = 1; k < 4; k++) {
      for (uint32_t m = 1; m <= 6; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_gt_4) {
    TEST_REQUIRES_ARM_NEON_FMA;
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_gt_4_strided_a) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (size_t k = 5; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(6)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (size_t k = 5; k < 8; k++) {
      for (uint32_t m = 1; m <= 6; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_div_4) {
    TEST_REQUIRES_ARM_NEON_FMA;
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_div_4_strided_a) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (size_t k = 8; k <= 40; k += 4) {
      GemmMicrokernelTester()
        .mr(6)
  ...
  TEST(F32_GEMM_6X8__AARCH64_NEONFMA_CORTEX_A57, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON_FMA;
    for (size_t k = 8; k <= 40; k += 4) {
      for (uint32_t m = 1; m <= 6; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A53, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A53, k_lt_4_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A53, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A53, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A75, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A75, k_lt_4_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A75, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(F32_GEMM_4X8__AARCH32_NEON_CORTEX_A75, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(4)

...
TEST(X32_TRANSPOSE__4X4_SCALAR_FLOAT, bh_4_bw_4_is_8_os_8) {
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_4_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_1_8_bw_1_8) {
    for(size_t i = 1; i <= 8; ++i){
      for(size_t j = 1; j <= 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_4_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(8)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_4_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_8_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_5_8_bw_4){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(4)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_5_8_bw_8){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_5_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      for(size_t j = 5; j < 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_4_bw_4_is_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_4_bw_4_os_8) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MOV_WASMSIMD, bh_4_bw_4_is_8_os_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(4)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_4_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_1_8_bw_1_8) {
    for(size_t i = 1; i <= 8; ++i){
      for(size_t j = 1; j <= 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_4_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(8)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_4_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_8_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_5_8_bw_4){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(4)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_5_8_bw_8){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_5_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      for(size_t j = 5; j < 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_4_bw_4_is_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_4_bw_4_os_8) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_MULTI_WASMSIMD, bh_4_bw_4_is_8_os_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(4)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_4_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_1_8_bw_1_8) {
    for(size_t i = 1; i <= 8; ++i){
      for(size_t j = 1; j <= 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_4_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(8)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_4_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_8_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_5_8_bw_4){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(4)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_5_8_bw_8){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_5_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      for(size_t j = 5; j < 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_4_bw_4_is_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_4_bw_4_os_8) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_MULTI_SWITCH_WASMSIMD, bh_4_bw_4_is_8_os_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(4)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_4_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_1_8_bw_1_8) {
    for(size_t i = 1; i <= 8; ++i){
      for(size_t j = 1; j <= 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_4_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(8)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_4_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_8_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_5_8_bw_4){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(4)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_5_8_bw_8){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_5_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      for(size_t j = 5; j < 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_4_bw_4_is_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_4_bw_4_os_8) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MOV_WASMSIMD, bh_4_bw_4_is_8_os_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(4)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_4_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_1_8_bw_1_8) {
    for(size_t i = 1; i <= 8; ++i){
      for(size_t j = 1; j <= 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_4_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(8)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_4_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_8_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_5_8_bw_4){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(4)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_5_8_bw_8){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_5_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      for(size_t j = 5; j < 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_4_bw_4_is_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_4_bw_4_os_8) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_MULTI_WASMSIMD, bh_4_bw_4_is_8_os_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(4)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_4_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_1_8_bw_1_8) {
    for(size_t i = 1; i <= 8; ++i){
      for(size_t j = 1; j <= 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_4_bw_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(8)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_4_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(8)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_8_bw_4) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_5_8_bw_4){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(4)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_5_8_bw_8){
    for(size_t i = 5; i < 8; ++i){
      TransposeMicrokernelTester()
        .input_stride(8)
        .output_stride(i)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_5_8_bw_5_8) {
    for(size_t i = 5; i < 8; ++i){
      for(size_t j = 5; j < 8; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_4_bw_4_is_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(4)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_4_bw_4_os_8) {
    TransposeMicrokernelTester()
      .input_stride(4)
      .output_stride(8)
      .block_width(4)
  ...
  TEST(X32_TRANSPOSE__4X4_REUSE_SWITCH_WASMSIMD, bh_4_bw_4_is_8_os_8) {
    TransposeMicrokernelTester()
      .input_stride(8)
      .output_stride(8)
      .block_width(4)

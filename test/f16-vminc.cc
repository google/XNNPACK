...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F16_VMINC__AVX512FP16_U32, batch_eq_32) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f16_vminc_ukernel__avx512fp16_u32, VBinaryCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F16_VMINC__AVX512FP16_U64, batch_eq_64) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_vminc_ukernel__avx512fp16_u64, VBinaryCMicrokernelTester::OpType::MinC);
  }

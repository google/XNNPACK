...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F16_VMINC__NEONFP16ARITH_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__neonfp16arith_u8, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F16_VMINC__NEONFP16ARITH_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__neonfp16arith_u16, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F16_VMINC__FP16ARITH_U1, batch_eq_1) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(1)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__fp16arith_u1, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F16_VMINC__FP16ARITH_U2, batch_eq_2) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(2)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__fp16arith_u2, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F16_VMINC__FP16ARITH_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__fp16arith_u4, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F16_VMINC__AVX512FP16_U32, batch_eq_32) {
    TEST_REQUIRES_X86_AVX512FP16;
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__avx512fp16_u32, VBinaryMicrokernelTester::OpType::Min);
  }

  TEST(F16_VMINC__AVX512FP16_U32, batch_div_32) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__AVX512FP16_U32, batch_lt_32) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__AVX512FP16_U32, batch_gt_32) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__AVX512FP16_U32, inplace) {
    TEST_REQUIRES_X86_AVX512FP16;
...
#if XNN_ENABLE_AVX512FP16 && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  TEST(F16_VMINC__AVX512FP16_U64, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512FP16;
    VBinaryMicrokernelTester()
      .batch_size(64)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__avx512fp16_u64, VBinaryMicrokernelTester::OpType::Min);
  }

  TEST(F16_VMINC__AVX512FP16_U64, batch_div_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__AVX512FP16_U64, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__AVX512FP16_U64, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__AVX512FP16_U64, inplace) {
    TEST_REQUIRES_X86_AVX512FP16;
  ...
  TEST(F16_VMINC__F16C_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__f16c_u8, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F16_VMINC__F16C_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f16_vminc_ukernel__f16c_u16, VBinaryMicrokernelTester::OpType::Min);
  }

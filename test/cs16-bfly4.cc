...
#include "bfly4-microkernel-tester.h"
  ...
  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X1, batch_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(4)
      .samples(1)
  ...
  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X2, samples_eq_1) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(1)
      .samples(1)
      .stride(64)
      .Test(xnn_cs16_bfly4_samples1_ukernel__aarch32_neon_x2);
  }

  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X2, batch_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(4)
      .samples(1)
  ...
  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X2, batch_gt_1) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch = 2; batch <= 16; batch++) {
      BFly4MicrokernelTester()
        .batch(batch)
  ...
  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X4, samples_eq_1) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(1)
      .samples(1)
      .stride(64)
      .Test(xnn_cs16_bfly4_samples1_ukernel__aarch32_neon_x4);
  }

  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X4, batch_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(4)
      .samples(1)
  ...
  TEST(CS16_BFLY4_SAMPLES1__AARCH32_NEON_X4, batch_gt_1) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch = 2; batch <= 16; batch++) {
      BFly4MicrokernelTester()
        .batch(batch)
  ...
  TEST(CS16_BFLY4__NEON, samples_eq_1) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(1)
      .samples(1)
      .stride(64)
      .Test(xnn_cs16_bfly4_ukernel__neon);
  }

  TEST(CS16_BFLY4__NEON, batch_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .batch(4)
      .samples(1)
  ...
  TEST(CS16_BFLY4__NEON, batch_gt_1) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch = 2; batch <= 16; batch++) {
      BFly4MicrokernelTester()
        .batch(batch)
  ...
  TEST(CS16_BFLY4__NEON, samples_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .samples(4)
      .stride(16)
  ...
  TEST(CS16_BFLY4__NEON, samples_eq_4_batch_gt_1) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(CS16_BFLY4__NEON, samples_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .samples(16)
      .stride(4)
  ...
  TEST(CS16_BFLY4__NEON, samples_eq_64) {
    TEST_REQUIRES_ARM_NEON;
    BFly4MicrokernelTester()
      .samples(64)
      .stride(1)
...
TEST(CS16_BFLY4__SCALAR_X1, batch_gt_1) {
  for (size_t batch = 2; batch <= 16; batch++) {
    BFly4MicrokernelTester()
      .batch(batch)
      .samples(1)
...
TEST(CS16_BFLY4__SCALAR_X2, batch_gt_1) {
  for (size_t batch = 2; batch <= 16; batch++) {
    BFly4MicrokernelTester()
      .batch(batch)
      .samples(1)
...
TEST(CS16_BFLY4__SCALAR_X4, batch_gt_1) {
  for (size_t batch = 2; batch <= 16; batch++) {
    BFly4MicrokernelTester()
      .batch(batch)
      .samples(1)

...
#include "gemm-microkernel-tester.h"
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_eq_16) {
    ...
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(16)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_1x8s4c2__neon_mlal_padal, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_init_qs8_requantization_rndnu_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_eq_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_eq_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_eq_16_subtile_m) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t m = 1; m <= 1; m++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_eq_16_subtile_n) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_lt_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_lt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_lt_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_gt_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_gt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_gt_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_div_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_div_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 32; k <= 160; k += 16) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, k_div_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 32; k <= 160; k += 16) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_gt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_gt_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_div_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_div_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, n_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, strided_cm_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 80; k += 17) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, qmin) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, qmax) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MLAL_PADAL, strided_cm) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
      ...
      .n(8)
      .k(16)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_2x8s4c2__neon_mlal_padal, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_init_qs8_requantization_rndnu_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_eq_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_eq_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_eq_16_subtile_m) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t m = 1; m <= 2; m++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_eq_16_subtile_n) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_lt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_lt_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 16; k++) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_gt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_gt_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 17; k < 32; k++) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_div_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 32; k <= 160; k += 16) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_div_16_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 32; k <= 160; k += 16) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, k_div_16_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 32; k <= 160; k += 16) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_gt_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 2; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_div_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, n_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 2; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, strided_cm_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 80; k += 17) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, qmin) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, qmax) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MLAL_PADAL, strided_cm) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
      ...
      .n(8)
      .k(8)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_1x8s4c2__neon_mull_padal, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_init_qs8_requantization_rndnu_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_eq_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t m = 1; m <= 1; m++) {
      for (uint32_t n = 1; n <= 8; n++) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_eq_8_subtile_m) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t m = 1; m <= 1; m++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_eq_8_subtile_n) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_lt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k <= 80; k += 8) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k <= 80; k += 8) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_gt_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_div_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, n_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, strided_cm_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 40; k += 9) {
      for (uint32_t m = 1; m <= 1; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, qmin) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, qmax) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X8S4C2__NEON_MULL_PADAL, strided_cm) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(1)
      .nr(8)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
      ...
      .n(8)
      .k(8)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_2x8s4c2__neon_mull_padal, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_init_qs8_requantization_rndnu_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_eq_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t m = 1; m <= 2; m++) {
      for (uint32_t n = 1; n <= 8; n++) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_eq_8_subtile_m) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t m = 1; m <= 2; m++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_eq_8_subtile_n) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_lt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k <= 80; k += 8) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k <= 80; k += 8) {
      GemmMicrokernelTester()
        .mr(2)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k <= 80; k += 8) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_gt_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 40; k += 9) {
        for (uint32_t m = 1; m <= 2; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_div_8_strided_cn) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, n_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 40; k += 9) {
        for (uint32_t m = 1; m <= 2; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, strided_cm_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 40; k += 9) {
      for (uint32_t m = 1; m <= 2; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, qmin) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, qmax) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_2X8S4C2__NEON_MULL_PADAL, strided_cm) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(2)
      .nr(8)

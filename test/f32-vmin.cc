...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VMIN__AVX_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmin_ukernel__avx_x8, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F32_VMIN__AVX_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vmin_ukernel__avx_x16, VBinaryMicrokernelTester::OpType::Min);
  }
  ...
  TEST(F32_VMIN__WASM_X1, batch_eq_1) {
    VBinaryMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vmin_ukernel__wasm_x1, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMIN__WASM_X2, batch_eq_2) {
    VBinaryMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vmin_ukernel__wasm_x2, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMIN__WASM_X4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmin_ukernel__wasm_x4, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMIN__WASM_X8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmin_ukernel__wasm_x8, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
  }
...
TEST(F32_VMIN__SCALAR_X1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vmin_ukernel__scalar_x1, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VMIN__SCALAR_X2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vmin_ukernel__scalar_x2, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VMIN__SCALAR_X4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vmin_ukernel__scalar_x4, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VMIN__SCALAR_X8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vmin_ukernel__scalar_x8, VBinaryMicrokernelTester::OpType::Min, VBinaryMicrokernelTester::Variant::Scalar);
}

...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VRNDZ__WASMSIMD_X4, batch_eq_4) {
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndz_ukernel__wasmsimd_x4), VUnOpMicrokernelTester::OpType::RoundTowardsZero);
  }
  ...
  TEST(F32_VRNDZ__WASMSIMD_X8, batch_eq_8) {
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndz_ukernel__wasmsimd_x8), VUnOpMicrokernelTester::OpType::RoundTowardsZero);
  }

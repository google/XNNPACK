...
#include "vunary-microkernel-tester.h"
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x4, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  }

  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X4, batch_div_4) {
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x4, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  ...
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X4, batch_lt_4) {
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x4, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  ...
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X4, batch_gt_4) {
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x4, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  ...
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X4, inplace) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace(true)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X8, batch_eq_8) {
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x8, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  }

  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X8, batch_div_8) {
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x8, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  ...
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X8, batch_lt_8) {
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x8, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  ...
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X8, batch_gt_8) {
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vrndz_ukernel__wasmsimd_native_x8, VUnaryMicrokernelTester::OpType::RoundTowardsZero);
  ...
  TEST(F32_VRNDZ__WASMSIMD_NATIVE_X8, inplace) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace(true)

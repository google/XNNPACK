...
TEST(X32_ZEROB_GEMM_4C4S1R__SCALAR_INT, groups_gt_1) {
  ...
  TEST(X32_ZEROB_GEMM_4C4S4R__SSE2, n_eq_4) {
    ...
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        ...
        .channel_subtile(4)
        .channel_round(4)
        .Test(xnn_x32_zerob_gemm_ukernel_4c4s4r__sse2);
    }
  }

  TEST(X32_ZEROB_GEMM_4C4S4R__SSE2, n_div_4) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(8)
  ...
  TEST(X32_ZEROB_GEMM_4C4S4R__SSE2, n_lt_4) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      for (size_t n = 1; n < 4; n++) {
        PackBMicrokernelTester()
  ...
  TEST(X32_ZEROB_GEMM_4C4S4R__SSE2, n_gt_4) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      for (size_t n = 5; n < 8; n++) {
        PackBMicrokernelTester()
  ...
  TEST(X32_ZEROB_GEMM_4C4S4R__SSE2, groups_gt_1) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t kernel_tile = 1; kernel_tile < 4; kernel_tile++) {
        for (size_t n = 5; n < 8; n++) {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X32_ZEROB_GEMM_8C4S4R__SSE2, n_eq_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(8)
        ...
        .channel_subtile(4)
        .channel_round(4)
        .Test(xnn_x32_zerob_gemm_ukernel_8c4s4r__sse2);
    }
  }

  TEST(X32_ZEROB_GEMM_8C4S4R__SSE2, n_div_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(16)
  ...
  TEST(X32_ZEROB_GEMM_8C4S4R__SSE2, n_lt_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
  ...
  TEST(X32_ZEROB_GEMM_8C4S4R__SSE2, n_gt_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
  ...
  TEST(X32_ZEROB_GEMM_8C4S4R__SSE2, groups_gt_1) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t kernel_tile = 1; kernel_tile < 4; kernel_tile++) {
        for (size_t n = 9; n < 16; n++) {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X32_ZEROB_GEMM_8C8S4R__SSE2, n_eq_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(8)
        ...
        .channel_subtile(8)
        .channel_round(4)
        .Test(xnn_x32_zerob_gemm_ukernel_8c8s4r__sse2);
    }
  }

  TEST(X32_ZEROB_GEMM_8C8S4R__SSE2, n_div_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(16)
  ...
  TEST(X32_ZEROB_GEMM_8C8S4R__SSE2, n_lt_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      for (size_t n = 1; n < 8; n++) {
        PackBMicrokernelTester()
  ...
  TEST(X32_ZEROB_GEMM_8C8S4R__SSE2, n_gt_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      for (size_t n = 9; n < 16; n++) {
        PackBMicrokernelTester()
  ...
  TEST(X32_ZEROB_GEMM_8C8S4R__SSE2, groups_gt_1) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t kernel_tile = 1; kernel_tile < 4; kernel_tile++) {
        for (size_t n = 9; n < 16; n++) {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X32_ZEROB_GEMM_16C4S4R__SSE2, n_eq_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(16)
        ...
        .channel_subtile(4)
        .channel_round(4)
        .Test(xnn_x32_zerob_gemm_ukernel_16c4s4r__sse2);
    }
  }

  TEST(X32_ZEROB_GEMM_16C4S4R__SSE2, n_div_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(32)
  ...
  TEST(X32_ZEROB_GEMM_16C4S4R__SSE2, n_lt_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
  ...
  TEST(X32_ZEROB_GEMM_16C4S4R__SSE2, n_gt_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
  ...
  TEST(X32_ZEROB_GEMM_16C4S4R__SSE2, groups_gt_1) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t kernel_tile = 1; kernel_tile < 4; kernel_tile++) {
        for (size_t n = 17; n < 32; n++) {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(X32_ZEROB_GEMM_16C16S4R__SSE2, n_eq_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(16)
        ...
        .channel_subtile(16)
        .channel_round(4)
        .Test(xnn_x32_zerob_gemm_ukernel_16c16s4r__sse2);
    }
  }

  TEST(X32_ZEROB_GEMM_16C16S4R__SSE2, n_div_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      PackBMicrokernelTester()
        .channels(32)
  ...
  TEST(X32_ZEROB_GEMM_16C16S4R__SSE2, n_lt_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      for (size_t n = 1; n < 16; n++) {
        PackBMicrokernelTester()
  ...
  TEST(X32_ZEROB_GEMM_16C16S4R__SSE2, n_gt_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 4; k++) {
      for (size_t n = 17; n < 32; n++) {
        PackBMicrokernelTester()
  ...
  TEST(X32_ZEROB_GEMM_16C16S4R__SSE2, groups_gt_1) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t g = 2; g <= 3; g++) {
      for (size_t kernel_tile = 1; kernel_tile < 4; kernel_tile++) {
        for (size_t n = 17; n < 32; n++) {

...
#include "next_prime.h"
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__SSE_C4, channels_eq_4_unipass_fulltile) {
    ...
    MaxPoolMicrokernelTester()
      ...
      .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__sse_c4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__WASMSIMD_ARM_C4, channels_eq_4_unipass_fulltile) {
    ...
    MaxPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(channel_tile)
      .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__wasmsimd_arm_c4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__WASMSIMD_X86_C4, channels_eq_4_unipass_fulltile) {
    ...
    MaxPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(channel_tile)
      .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__wasmsimd_x86_c4, xnn_init_f32_minmax_scalar_params);
  }

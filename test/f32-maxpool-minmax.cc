...
using XnnTest = XnnMaxpoolTest<xnn_f32_maxpool_ukernel_fn, xnn_init_f32_minmax_params_fn, float>;
using XnnTestParam = XnnMaxpoolTestParam<xnn_f32_maxpool_ukernel_fn, xnn_init_f32_minmax_params_fn>;

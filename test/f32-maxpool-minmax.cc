...
#include "maxpool-microkernel-tester.h"
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__SSE_C4, channels_eq_4_unipass_fulltile) {
    ...
    MaxPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__sse_c4);
  }
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__NEON_C4, channels_eq_4_unipass_fulltile) {
    ...
    MaxPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__neon_c4);
  }
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_unipass_fulltile) {
    ...
    MaxPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__psimd_c4, MaxPoolMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    MaxPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      MaxPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      MaxPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        MaxPoolMicrokernelTester()
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 9, 16}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 9, 16}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 9, 16}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 9, 16}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_output_stride) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 9, 16}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_MAXPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_step) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 9, 16}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
...
TEST(F32_MAXPOOL_MINMAX_9P8X__SCALAR_C1, channels_eq_1_unipass_fulltile) {
  MaxPoolMicrokernelTester()
    ...
    .pooling_tile(9, 8)
    .channels(1)
    .Test(xnn_f32_maxpool_minmax_ukernel_9p8x__scalar_c1, MaxPoolMicrokernelTester::Variant::Scalar);
}

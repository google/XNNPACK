...
struct XnnTestParam {
  const char *name;
  bool (*isa_check)();
  xnn_f16_maxpool_ukernel_fn kernel_fn;
  xnn_init_f16_minmax_params_fn params_fn;
...
const XnnTestParam xnn_test_params[] = {
  ...
  { "F16_MAXPOOL_MINMAX_9P8X__NEONFP16ARITH_C8", []() { return TEST_REQUIRES_ARM_NEON_FP16_ARITH_VALUE; },
    xnn_f16_maxpool_minmax_ukernel_9p8x__neonfp16arith_c8, xnn_init_f16_minmax_fp16arith_params,
    /*channel_tile=*/8, /*channel_scaled_tile=*/8,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-16384, /*qmax=*/16384 },
#endif  // XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  { "F16_MAXPOOL_MINMAX_9P8X__F16C_C8", []() { return TEST_REQUIRES_X86_F16C_VALUE; },
    xnn_f16_maxpool_minmax_ukernel_9p8x__f16c_c8, xnn_init_f16_minmax_avx_params,
    /*channel_tile=*/8, /*channel_scaled_tile=*/8,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-16384, /*qmax=*/16384 },
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
  // ValuesIn() won't compile if the array is empty, so add a dummy suite
  // here that is always skipped for architectures that aren't handled
  { "dummy", []() { return false; }, nullptr, nullptr, 0, 0, 0, 0 },
};

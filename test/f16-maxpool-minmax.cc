...
#include "maxpool-microkernel-test-p.h"

namespace {

using XnnTestParam = XnnMaxpoolTestParam<xnn_f16_maxpool_ukernel_fn, xnn_init_f16_minmax_params_fn, uint16_t>;  // TODO: use native float16 type when it lands

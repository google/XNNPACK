...
const XnnTestParam xnn_test_params[] = {
  ...
  // // ValuesIn() won't compile if the array is empty, so add a dummy always-skipped entry
  // XNN_UKERNEL_WITH_PARAMS(xnn_arch_impossible, nullptr, 0, 0, 0, 0, 0, 0, xnn_init_f16_minmax_params_fn, nullptr)
};

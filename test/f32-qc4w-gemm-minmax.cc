...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_QC4W_GEMM_MINMAX_1X8__SSE2_DUP, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/1, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_qc4w_gemm_minmax_ukernel_1x8__sse2_dup,
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  INSTANTIATE_TEST_SUITE_P(
      F32_QC4W_GEMM_MINMAX_3X8__SSE2_DUP, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/3, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_qc4w_gemm_minmax_ukernel_3x8__sse2_dup,
                        xnn_init_f32_qc4w_minmax_sse_params,
                        xnn_pack_f32_qc4w_gemm_goi_w);
          },
          []() {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  INSTANTIATE_TEST_SUITE_P(
      F32_QC4W_GEMM_MINMAX_4X8__SSE2_DUP, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/4, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_qc4w_gemm_minmax_ukernel_4x8__sse2_dup,
                        xnn_init_f32_qc4w_minmax_sse_params,
                        xnn_pack_f32_qc4w_gemm_goi_w);
          },
          []() {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  INSTANTIATE_TEST_SUITE_P(
      F32_QC4W_GEMM_MINMAX_5X8__SSE2_DUP, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/5, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_qc4w_gemm_minmax_ukernel_5x8__sse2_dup,
                        xnn_init_f32_qc4w_minmax_sse_params,
                        xnn_pack_f32_qc4w_gemm_goi_w);
          },
          []() {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  INSTANTIATE_TEST_SUITE_P(
      F32_QC4W_GEMM_MINMAX_6X8__SSE2_DUP, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/6, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_qc4w_gemm_minmax_ukernel_6x8__sse2_dup,
                        xnn_init_f32_qc4w_minmax_sse_params,
                        xnn_pack_f32_qc4w_gemm_goi_w);
          },
          []() {

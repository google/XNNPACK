...
#include "vaddc-microkernel-tester.h"
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL16_LD64_X8, batch_eq_8) {
    ...
    VAddCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul16_ld64_x8);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL16_LD64_X16, batch_eq_16) {
    ...
    VAddCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul16_ld64_x16);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL16_LD64_X24, batch_eq_24) {
    ...
    VAddCMicrokernelTester()
      .batch_size(24)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul16_ld64_x24);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL16_LD64_X32, batch_eq_32) {
    ...
    VAddCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul16_ld64_x32);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL32_LD32_X8, batch_eq_8) {
    ...
    VAddCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul32_ld32_x8);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL32_LD32_X16, batch_eq_16) {
    ...
    VAddCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul32_ld32_x16);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL32_LD32_X24, batch_eq_24) {
    ...
    VAddCMicrokernelTester()
      .batch_size(24)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul32_ld32_x24);
  }
  ...
  TEST(QS8_VADDC_MINMAX__AVX_MUL32_LD32_X32, batch_eq_32) {
    ...
    VAddCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_vaddc_minmax_ukernel__avx_mul32_ld32_x32);
  }
...
TEST(QS8_VADDC_MINMAX__SCALAR_X1, batch_eq_1) {
  VAddCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qs8_vaddc_minmax_ukernel__scalar_x1, VAddCMicrokernelTester::Variant::Scalar);
}
...
TEST(QS8_VADDC_MINMAX__SCALAR_X2, batch_eq_2) {
  VAddCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qs8_vaddc_minmax_ukernel__scalar_x2, VAddCMicrokernelTester::Variant::Scalar);
}
...
TEST(QS8_VADDC_MINMAX__SCALAR_X4, batch_eq_4) {
  VAddCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qs8_vaddc_minmax_ukernel__scalar_x4, VAddCMicrokernelTester::Variant::Scalar);
}

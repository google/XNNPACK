...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, input_width_eq_1) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, input_width_gt_1) {
  TEST_REQUIRES_X86_SSE;
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, output_channels_lt_4) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 1; output_channels < 4; output_channels++) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, output_channels_div_4) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 8; output_channels <= 16; output_channels += 4) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, output_channels_gt_4) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 5; output_channels < 8; output_channels++) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, input_height_lt_3) {
  TEST_REQUIRES_X86_SSE;
  for (size_t input_height = 1; input_height < 3; input_height++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, input_height_gt_3) {
  TEST_REQUIRES_X86_SSE;
  for (size_t input_height = 4; input_height <= 9; input_height++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, padding_top) {
  TEST_REQUIRES_X86_SSE;
  for (size_t padding_top = 0; padding_top <= 1; padding_top++) {
    for (size_t output_channels = 1; output_channels < 16; output_channels += 7) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, padding_bottom) {
  TEST_REQUIRES_X86_SSE;
  for (size_t padding_bottom = 0; padding_bottom <= 1; padding_bottom++) {
    for (size_t output_channels = 1; output_channels < 16; output_channels += 7) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, output_y_start) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_y_start = 1; output_y_start <= 3; output_y_start++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, output_y_end) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_y_end = 2; output_y_end < 5; output_y_end++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, qmin) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_1X1, qmax) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, input_width_eq_1) {
  TEST_REQUIRES_X86_SSE;
  ConvHWC2CHWMicrokernelTester()
    .kernel_size(3)
    .subsampling(2)
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, input_width_gt_1) {
  TEST_REQUIRES_X86_SSE;
  for (size_t input_width = 2; input_width < 33; input_width++) {
    ConvHWC2CHWMicrokernelTester()
      .kernel_size(3)
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, output_channels_lt_4) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 1; output_channels < 4; output_channels++) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, output_channels_div_4) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 8; output_channels <= 16; output_channels += 4) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, output_channels_gt_4) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 5; output_channels < 8; output_channels++) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, input_height_lt_3) {
  TEST_REQUIRES_X86_SSE;
  for (size_t input_height = 1; input_height < 3; input_height++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, input_height_gt_3) {
  TEST_REQUIRES_X86_SSE;
  for (size_t input_height = 4; input_height <= 9; input_height++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, padding_top) {
  TEST_REQUIRES_X86_SSE;
  for (size_t padding_top = 0; padding_top <= 1; padding_top++) {
    for (size_t output_channels = 1; output_channels < 16; output_channels += 7) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, padding_bottom) {
  TEST_REQUIRES_X86_SSE;
  for (size_t padding_bottom = 0; padding_bottom <= 1; padding_bottom++) {
    for (size_t output_channels = 1; output_channels < 16; output_channels += 7) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, output_y_start) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_y_start = 1; output_y_start <= 3; output_y_start++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, output_y_end) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_y_end = 2; output_y_end < 5; output_y_end++) {
    for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
      for (size_t input_width = 1; input_width < 32; input_width += 7) {
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, qmin) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()
...
TEST(F16_CONV_HWC2CHW_3X3S2P1C3X4__SSE_2X2, qmax) {
  TEST_REQUIRES_X86_SSE;
  for (size_t output_channels = 1; output_channels < 8; output_channels += 3) {
    for (size_t input_width = 1; input_width < 32; input_width += 7) {
      ConvHWC2CHWMicrokernelTester()

...
#include "dwconv-microkernel-tester.h"
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__NEON_MUL16, c_eq_8_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__NEONV8_MUL16, c_eq_8_k_lt_9) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__NEON_MUL16, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__NEONV8_MUL16, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P24C__NEON_MUL16, c_eq_24_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P24C__NEONV8_MUL16, c_eq_24_k_lt_9) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P32C__NEON_MUL16, c_eq_32_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P32C__NEONV8_MUL16, c_eq_32_k_lt_9) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__NEON_MUL16, c_eq_8_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__NEONV8_MUL16, c_eq_8_k_lt_25) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__NEON_MUL16, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__NEONV8_MUL16, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P24C__NEON_MUL16, c_eq_24_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P24C__NEONV8_MUL16, c_eq_24_k_lt_25) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P32C__NEON_MUL16, c_eq_32_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P32C__NEONV8_MUL16, c_eq_32_k_lt_25) {
    TEST_REQUIRES_ARM_NEON_V8;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__SSE2_MUL16, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_SSE2;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__SSE41_MUL16, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__SSE41_MUL32, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__SSE2_MUL16, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_SSE2;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__SSE41_MUL16, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__SSE41_MUL32, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__SSE2_MUL16, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_SSE2;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__SSE41_MUL16, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__SSE41_MUL32, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__SSE2_MUL16, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_SSE2;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__SSE41_MUL16, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__SSE41_MUL32, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_SSE41;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__AVX_MUL16, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__AVX_MUL32, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__AVX2_MUL32, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_AVX2;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__XOP_MUL32, c_eq_8_k_lt_9) {
    TEST_REQUIRES_X86_XOP;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__AVX_MUL16, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__AVX_MUL32, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__AVX2_MUL32, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_AVX2;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__XOP_MUL32, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_XOP;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P32C__AVX2_MUL32, c_eq_32_k_lt_9) {
    TEST_REQUIRES_X86_AVX2;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__AVX_MUL16, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__AVX_MUL32, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__AVX2_MUL32, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_AVX2;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__XOP_MUL32, c_eq_8_k_lt_25) {
    TEST_REQUIRES_X86_XOP;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__AVX_MUL16, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__AVX_MUL32, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_AVX;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__AVX2_MUL32, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_AVX2;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__XOP_MUL32, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_XOP;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P32C__AVX2_MUL32, c_eq_32_k_lt_25) {
    TEST_REQUIRES_X86_AVX2;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__AVX512SKX_MUL32, c_eq_16_k_lt_9) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P32C__AVX512SKX_MUL32, c_eq_32_k_lt_9) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__AVX512SKX_MUL32, c_eq_16_k_lt_25) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P32C__AVX512SKX_MUL32, c_eq_32_k_lt_25) {
    TEST_REQUIRES_X86_AVX512SKX;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P8C__WASMSIMD_MUL16, c_eq_8_k_lt_9) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P16C__WASMSIMD_MUL16, c_eq_16_k_lt_9) {
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(16)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P24C__WASMSIMD_MUL16, c_eq_24_k_lt_9) {
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(24)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P8C__WASMSIMD_MUL16, c_eq_8_k_lt_25) {
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(8)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P16C__WASMSIMD_MUL16, c_eq_16_k_lt_25) {
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(16)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P24C__WASMSIMD_MUL16, c_eq_24_k_lt_25) {
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(24)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P1C__WASM_FMAGIC, c_eq_1_k_lt_9) {
    for (uint32_t channels = 2; channels < 10; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(1)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P2C__WASM_FMAGIC, c_eq_2_k_lt_9) {
    for (uint32_t channels = 3; channels < 4; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(2)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_9P4C__WASM_FMAGIC, c_eq_4_k_lt_9) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(4)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P1C__WASM_FMAGIC, c_eq_1_k_lt_25) {
    for (uint32_t channels = 2; channels < 10; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(1)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P2C__WASM_FMAGIC, c_eq_2_k_lt_25) {
    for (uint32_t channels = 3; channels < 4; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(2)
  ...
  TEST(QU8_DWCONV_MINMAX_FP32_25P4C__WASM_FMAGIC, c_eq_4_k_lt_25) {
    for (uint32_t channels = 5; channels < 8; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
          .cr(4)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P1C__SCALAR_FMAGIC, c_eq_1_k_lt_9) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P1C__SCALAR_IMAGIC, c_eq_1_k_lt_9) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P1C__SCALAR_LRINTF, c_eq_1_k_lt_9) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P2C__SCALAR_FMAGIC, c_eq_2_k_lt_9) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P2C__SCALAR_IMAGIC, c_eq_2_k_lt_9) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P2C__SCALAR_LRINTF, c_eq_2_k_lt_9) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P4C__SCALAR_FMAGIC, c_eq_4_k_lt_9) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P4C__SCALAR_IMAGIC, c_eq_4_k_lt_9) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)
...
TEST(QU8_DWCONV_MINMAX_FP32_9P4C__SCALAR_LRINTF, c_eq_4_k_lt_9) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P1C__SCALAR_FMAGIC, c_eq_1_k_lt_25) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P1C__SCALAR_IMAGIC, c_eq_1_k_lt_25) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P1C__SCALAR_LRINTF, c_eq_1_k_lt_25) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P2C__SCALAR_FMAGIC, c_eq_2_k_lt_25) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P2C__SCALAR_IMAGIC, c_eq_2_k_lt_25) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P2C__SCALAR_LRINTF, c_eq_2_k_lt_25) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P4C__SCALAR_FMAGIC, c_eq_4_k_lt_25) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P4C__SCALAR_IMAGIC, c_eq_4_k_lt_25) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)
...
TEST(QU8_DWCONV_MINMAX_FP32_25P4C__SCALAR_LRINTF, c_eq_4_k_lt_25) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)

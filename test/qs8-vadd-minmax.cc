...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, batch_eq_1) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, batch_gt_1) {
    TEST_REQUIRES_RISCV_VECTOR;
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_eq_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
      .batch_size(2)
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_div_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_lt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_gt_2) {
    TEST_REQUIRES_RISCV_VECTOR;

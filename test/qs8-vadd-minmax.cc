...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, batch_eq_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
      .batch_size(1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t))
      .Test(xnn_qs8_vadd_minmax_ukernel__rvv_u1v, xnn_init_qs8_add_minmax_rvv_params);
  }

  TEST(QS8_VADD_MINMAX__RVV_U1V, batch_gt_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, inplace_a) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, inplace_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, inplace_a_and_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U1V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 5 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_eq_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
      .batch_size(2 * xnn_init_hardware_config()->vlenb / sizeof(int8_t))
      .Test(xnn_qs8_vadd_minmax_ukernel__rvv_u2v, xnn_init_qs8_add_minmax_rvv_params);
  }

  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_div_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_lt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, batch_gt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, inplace_a) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, inplace_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, inplace_a_and_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {
  ...
  TEST(QS8_VADD_MINMAX__RVV_U2V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size <= 10 * xnn_init_hardware_config()->vlenb / sizeof(int8_t);
                batch_size += 1 * xnn_init_hardware_config()->vlenb / sizeof(int8_t)) {

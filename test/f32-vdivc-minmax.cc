...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X1, batch_eq_1) {
    VBinOpCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x1, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X2, batch_eq_2) {
    VBinOpCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x2, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x4, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
  }

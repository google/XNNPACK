...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VDIVC_MINMAX__NEON_X4, batch_eq_4) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__neon_x4, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__NEON_X8, batch_eq_8) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__neon_x8, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__SSE_X4, batch_eq_4) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__sse_x4, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__SSE_X8, batch_eq_8) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__sse_x8, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX_X8, batch_eq_8) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx_x8, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX_X16, batch_eq_16) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx_x16, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX512F_X16, batch_eq_16) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx512f_x16, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX512F_X32, batch_eq_32) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx512f_x32, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X4, batch_eq_4) {
    TEST_REQUIRES_PSIMD;
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__psimd_x4, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VDIVC_MINMAX__PSIMD_X4, batch_div_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X4, batch_lt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X4, batch_gt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X4, inplace) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X4, qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X4, qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
...
#if !XNN_ARCH_ASMJS && !XNN_ARCH_WASM && !XNN_COMPILER_MSVC && !XNN_COMPILER_ICC
  TEST(F32_VDIVC_MINMAX__PSIMD_X8, batch_eq_8) {
    TEST_REQUIRES_PSIMD;
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__psimd_x8, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VDIVC_MINMAX__PSIMD_X8, batch_div_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X8, batch_lt_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X8, batch_gt_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X8, inplace) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X8, qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__PSIMD_X8, qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_arm_x4, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_arm_x8, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_X86_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_x86_x4, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_X86_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_x86_x8, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X1, batch_eq_1) {
    VBinOpCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x1, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X2, batch_eq_2) {
    VBinOpCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x2, VBinOpCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x4, VBinOpCMicrokernelTester::OpType::DivC);
  }
...
TEST(F32_VDIVC_MINMAX__SCALAR_X1, batch_eq_1) {
  VBinOpCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vdivc_minmax_ukernel__scalar_x1, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VDIVC_MINMAX__SCALAR_X2, batch_eq_2) {
  VBinOpCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vdivc_minmax_ukernel__scalar_x2, VBinOpCMicrokernelTester::OpType::DivC, VBinOpCMicrokernelTester::Variant::Scalar);
}

...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VDIVC_MINMAX__NEON_X4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__neon_x4, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__NEON_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__neon_x8, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__SSE_X4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__sse_x4, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__SSE_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__sse_x8, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx_x8, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx_x16, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX512F_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx512f_x16, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__AVX512F_X32, batch_eq_32) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vdivc_minmax_ukernel__avx512f_x32, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_arm_x4, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_arm_x8, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_ARM_X16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_arm_x16, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_X86_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_x86_x4, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_X86_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_x86_x8, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASMSIMD_X86_X16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasmsimd_x86_x16, VBinaryCMicrokernelTester::OpType::DivC);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X1, batch_eq_1) {
    VBinaryCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x1, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X2, batch_eq_2) {
    VBinaryCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x2, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x4, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VDIVC_MINMAX__WASM_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__wasm_x8, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
...
TEST(F32_VDIVC_MINMAX__SCALAR_X1, batch_eq_1) {
  VBinaryCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vdivc_minmax_ukernel__scalar_x1, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VDIVC_MINMAX__SCALAR_X2, batch_eq_2) {
  VBinaryCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vdivc_minmax_ukernel__scalar_x2, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VDIVC_MINMAX__SCALAR_X4, batch_eq_4) {
  VBinaryCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vdivc_minmax_ukernel__scalar_x4, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VDIVC_MINMAX__SCALAR_X8, batch_eq_8) {
  VBinaryCMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vdivc_minmax_ukernel__scalar_x8, VBinaryCMicrokernelTester::OpType::DivC, VBinaryCMicrokernelTester::Variant::Scalar);
}

...
#include "vbinaryc-microkernel-tester.h"
...
#if XNN_ARCH_ARM64
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, batch_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vdivc_minmax_ukernel__aarch64_neon_x4, VBinaryCMicrokernelTester::OpType::DivC, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, batch_div_4) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, batch_lt_4) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, batch_gt_4) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, inplace) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X4, qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_ARM64
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, batch_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vdivc_minmax_ukernel__aarch64_neon_x8, VBinaryCMicrokernelTester::OpType::DivC, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, batch_div_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, batch_lt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, batch_gt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, inplace) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VDIVC_MINMAX__AARCH64_NEON_X8, qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)

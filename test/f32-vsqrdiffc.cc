...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VSQRDIFFC__AVX_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiffc_ukernel__avx_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC, xnn_init_f32_default_avx_params);
  }
  ...
  TEST(F32_VSQRDIFFC__AVX_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiffc_ukernel__avx_x16, VBinaryCMicrokernelTester::OpType::SqrDiffC, xnn_init_f32_default_avx_params);
  }
...
TEST(F32_VSQRDIFFC__SCALAR_X1, batch_eq_1) {
  VBinaryCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x1, VBinaryCMicrokernelTester::OpType::SqrDiffC);
}
...
TEST(F32_VSQRDIFFC__SCALAR_X2, batch_eq_2) {
  VBinaryCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x2, VBinaryCMicrokernelTester::OpType::SqrDiffC);
}
...
TEST(F32_VSQRDIFFC__SCALAR_X4, batch_eq_4) {
  VBinaryCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x4, VBinaryCMicrokernelTester::OpType::SqrDiffC);
}
...
TEST(F32_VSQRDIFFC__SCALAR_X8, batch_eq_8) {
  VBinaryCMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC);
}

...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VSQRDIFFC__NEON_X4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiffc_ukernel__neon_x4, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__NEON_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiffc_ukernel__neon_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__SSE_X4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiffc_ukernel__sse_x4, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__SSE_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiffc_ukernel__sse_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__AVX_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiffc_ukernel__avx_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__AVX_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiffc_ukernel__avx_x16, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__AVX512F_X16, batch_eq_16) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiffc_ukernel__avx512f_x16, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__AVX512F_X32, batch_eq_32) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vsqrdiffc_ukernel__avx512f_x32, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__WASMSIMD_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsqrdiffc_ukernel__wasmsimd_x4, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__WASMSIMD_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsqrdiffc_ukernel__wasmsimd_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
  ...
  TEST(F32_VSQRDIFFC__WASMSIMD_X16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrdiffc_ukernel__wasmsimd_x16, VBinaryCMicrokernelTester::OpType::SqrDiffC);
  }
...
TEST(F32_VSQRDIFFC__SCALAR_X1, batch_eq_1) {
  VBinaryCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x1, VBinaryCMicrokernelTester::OpType::SqrDiffC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSQRDIFFC__SCALAR_X2, batch_eq_2) {
  VBinaryCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x2, VBinaryCMicrokernelTester::OpType::SqrDiffC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSQRDIFFC__SCALAR_X4, batch_eq_4) {
  VBinaryCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x4, VBinaryCMicrokernelTester::OpType::SqrDiffC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSQRDIFFC__SCALAR_X8, batch_eq_8) {
  VBinaryCMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vsqrdiffc_ukernel__scalar_x8, VBinaryCMicrokernelTester::OpType::SqrDiffC, VBinaryCMicrokernelTester::Variant::Scalar);
}

...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F16_VABS__NEONFP16ARITH_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .TestAbs(xnn_f16_vabs_ukernel__neonfp16arith_u8);
  }
  ...
  TEST(F16_VABS__NEONFP16ARITH_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .TestAbs(xnn_f16_vabs_ukernel__neonfp16arith_u16);
  }
  ...
  TEST(F16_VABS__SSE2_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .TestAbs(xnn_f16_vabs_ukernel__sse2_u8);
  }
  ...
  TEST(F16_VABS__SSE2_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .TestAbs(xnn_f16_vabs_ukernel__sse2_u16);
  }

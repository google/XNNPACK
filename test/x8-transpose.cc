...
TEST(X8_TRANSPOSE__4X4_SCALAR_INT, bh_4_bw_4_is_8_os_8) {
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_16_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(16)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_1_32_bw_1_32) {
    for(size_t i = 1; i <= 32; ++i){
      for(size_t j = 1; j <= 32; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_16_bw_32) {
    TransposeMicrokernelTester()
      .input_stride(32)
      .output_stride(16)
      .block_width(32)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_16_bw_17_32) {
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_32_bw_17_32) {
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(32)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_32_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(32)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_17_32_bw_16){
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(16)
        .output_stride(i)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_17_32_bw_32){
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(32)
        .output_stride(i)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_17_32_bw_17_32) {
    for(size_t i = 17; i < 32; ++i){
      for(size_t j = 17; j < 32; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_16_bw_16_is_32) {
    TransposeMicrokernelTester()
      .input_stride(32)
      .output_stride(16)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_16_bw_16_os_32) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(32)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_MOV_WASMSIMD, bh_16_bw_16_is_32_os_32) {
    TransposeMicrokernelTester()
      .input_stride(32)
      .output_stride(32)
      .block_width(16)
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_16_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(16)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_1_32_bw_1_32) {
    for(size_t i = 1; i <= 32; ++i){
      for(size_t j = 1; j <= 32; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_16_bw_32) {
    TransposeMicrokernelTester()
      .input_stride(32)
      .output_stride(16)
      .block_width(32)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_16_bw_17_32) {
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_32_bw_17_32) {
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(i)
        .output_stride(32)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_32_bw_16) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(32)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_17_32_bw_16){
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(16)
        .output_stride(i)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_17_32_bw_32){
    for(size_t i = 17; i < 32; ++i){
      TransposeMicrokernelTester()
        .input_stride(32)
        .output_stride(i)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_17_32_bw_17_32) {
    for(size_t i = 17; i < 32; ++i){
      for(size_t j = 17; j < 32; ++j){
        TransposeMicrokernelTester()
          .input_stride(j)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_16_bw_16_is_32) {
    TransposeMicrokernelTester()
      .input_stride(32)
      .output_stride(16)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_16_bw_16_os_32) {
    TransposeMicrokernelTester()
      .input_stride(16)
      .output_stride(32)
      .block_width(16)
  ...
  TEST(X8_TRANSPOSE__16X16_REUSE_SWITCH_WASMSIMD, bh_16_bw_16_is_32_os_32) {
    TransposeMicrokernelTester()
      .input_stride(32)
      .output_stride(32)
      .block_width(16)

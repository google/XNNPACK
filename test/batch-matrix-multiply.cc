...
protected:
  BatchMatrixMultiplyTestBase()
  {
    ...
    input2_dims[num_input_dims - 2] = n;
...
TEST(BatchMatrixMultiplyTest, input1_num_dim_less_than_3_fails) {
  ...
  DefineBatchMatrixMultiplySubgraph(input1_dims, input2_dims, output_dims, &status);
...
TEST(BatchMatrixMultiplyTest, input1_last_dim_ne_input2_dim) {
...
TEST(BatchMatrixMultiplyTest, output_n_ne_input_n) {
  std::vector<size_t> input1_dims = {2, 3, 5};
  std::vector<size_t> input2_dims = {2, 7, 5};

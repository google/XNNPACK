...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qu8_vmul_minmax_rndnu_ukernel__neon_ld64_u8, xnn_init_qu8_mul_minmax_rndnu_neon_params);
  }
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, a_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, b_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, y_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, a_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, b_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U8, y_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_vmul_minmax_rndnu_ukernel__neon_ld64_u16, xnn_init_qu8_mul_minmax_rndnu_neon_params);
  }
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, a_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, b_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, y_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, a_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, b_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD64_U16, y_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_vmul_minmax_rndnu_ukernel__neon_ld128_u16, xnn_init_qu8_mul_minmax_rndnu_neon_params);
  }
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, a_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, b_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, y_zero_point) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, a_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, b_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VMUL_MINMAX_RNDNU__NEON_LD128_U16, y_scale) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VBinaryMicrokernelTester()

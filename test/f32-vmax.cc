...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VMAX__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_arm_x4, VBinOpMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAX__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_arm_x8, VBinOpMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAX__WASMSIMD_X86_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_x86_x4, VBinOpMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAX__WASMSIMD_X86_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_x86_x8, VBinOpMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAX__WASM_X1, batch_eq_1) {
    VBinOpMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vmax_ukernel__wasm_x1, VBinOpMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAX__WASM_X2, batch_eq_2) {
    VBinOpMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vmax_ukernel__wasm_x2, VBinOpMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAX__WASM_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmax_ukernel__wasm_x4, VBinOpMicrokernelTester::OpType::Max);
  }

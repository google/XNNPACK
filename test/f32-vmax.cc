...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VMAX__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_arm_x4, VBinOpMicrokernelTester::OpType::Max, VBinOpMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMAX__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_arm_x8, VBinOpMicrokernelTester::OpType::Max, VBinOpMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMAX__WASMSIMD_X86_X4, batch_eq_4) {
    VBinOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_x86_x4, VBinOpMicrokernelTester::OpType::Max, VBinOpMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMAX__WASMSIMD_X86_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_x86_x8, VBinOpMicrokernelTester::OpType::Max, VBinOpMicrokernelTester::Variant::Scalar);
  }

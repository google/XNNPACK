...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VABS__FMA3_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vabs_ukernel__fma3_u8, xnn_init_f32_abs_fma3_params);
  }
  ...
  TEST(F32_VABS__FMA3_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vabs_ukernel__fma3_u16, xnn_init_f32_abs_fma3_params);
  }
  ...
  TEST(F32_VABS__FMA3_U24, batch_eq_24) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vabs_ukernel__fma3_u24, xnn_init_f32_abs_fma3_params);
  }

...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VABS__RVV_X1V, batch_eq_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VUnaryMicrokernelTester()
      .batch_size(1 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_vabs_ukernel__rvv_x1v);
  }

  TEST(F32_VABS__RVV_X1V, batch_gt_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X1V, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
...
#if XNN_ENABLE_RISCV_VECTOR && (XNN_ARCH_RISCV)
  TEST(F32_VABS__RVV_X2V, batch_eq_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VUnaryMicrokernelTester()
      .batch_size(2 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_vabs_ukernel__rvv_x2v);
  }

  TEST(F32_VABS__RVV_X2V, batch_div_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X2V, batch_lt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X2V, batch_gt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X2V, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
...
#if XNN_ENABLE_RISCV_VECTOR && (XNN_ARCH_RISCV)
  TEST(F32_VABS__RVV_X4V, batch_eq_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VUnaryMicrokernelTester()
      .batch_size(4 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_vabs_ukernel__rvv_x4v);
  }

  TEST(F32_VABS__RVV_X4V, batch_div_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X4V, batch_lt_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X4V, batch_gt_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X4V, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
...
#if XNN_ENABLE_RISCV_VECTOR && (XNN_ARCH_RISCV)
  TEST(F32_VABS__RVV_X8V, batch_eq_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    VUnaryMicrokernelTester()
      .batch_size(8 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_vabs_ukernel__rvv_x8v);
  }

  TEST(F32_VABS__RVV_X8V, batch_div_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X8V, batch_lt_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X8V, batch_gt_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_VABS__RVV_X8V, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;

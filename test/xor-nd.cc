...
TEST(XOR_ND_S32, xor_0d_x_0d) {
  BinaryElementwiseOperatorTester()
    .operation_type(BinaryElementwiseOperatorTester::OperationType::XOR)
    .TestS32();
}

TEST(XOR_ND_S32, xor_1d_x_0d) {

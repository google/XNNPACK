...
using XnnTest = XnnMaxpoolTest<xnn_s8_maxpool_ukernel_fn, xnn_init_s8_minmax_params_fn, int8_t>;
using XnnTestParam = XnnMaxpoolTestParam<xnn_s8_maxpool_ukernel_fn, xnn_init_s8_minmax_params_fn>;

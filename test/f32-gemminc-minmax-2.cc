...
std::vector<GemmTestParams> CreateTests2(
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMMINC_MINMAX_1X8__AARCH64_NEONFMA_LANE_LD128, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/2,
          /*adj_k_block=*/2,
          /*mr=*/1, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemminc_minmax_ukernel_1x8__aarch64_neonfma_lane_ld128,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemminc_goi_w);
          },
          xnn_arch_arm_neon_fma)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMMINC_MINMAX_6X8__SSE_DUP, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/6, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemminc_minmax_ukernel_6x8__sse_dup,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemminc_goi_w);
          },
          0)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMMINC_MINMAX_6X16__AVX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemminc_minmax_ukernel_6x16__avx_broadcast,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemminc_goi_w);
          },
          xnn_arch_x86_avx)),

...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VCLAMP__SSE_U4, batch_eq_4) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__sse_u4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__SSE_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__sse_u8, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__AVX_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__avx_u8, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__AVX_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vclamp_ukernel__avx_u16, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_ARM_U4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_arm_u4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_ARM_U8, batch_eq_8) {
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_arm_u8, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_X86_U4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_x86_u4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_X86_U8, batch_eq_8) {
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_x86_u8, xnn_init_f32_minmax_scalar_params);
  }

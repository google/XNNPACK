...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VCLAMP__NEON_X4, batch_eq_4) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__neon_x4, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__NEON_X8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__neon_x8, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__SSE_X4, batch_eq_4) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__sse_x4, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_sse_params);
  }
  ...
  TEST(F32_VCLAMP__SSE_X8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__sse_x8, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_sse_params);
  }
  ...
  TEST(F32_VCLAMP__AVX_X8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__avx_x8, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_avx_params);
  }
  ...
  TEST(F32_VCLAMP__AVX_X16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vclamp_ukernel__avx_x16, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_avx_params);
  }
  ...
  TEST(F32_VCLAMP__AVX512F_X16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vclamp_ukernel__avx512f_x16, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__AVX512F_X32, batch_eq_32) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vclamp_ukernel__avx512f_x32, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_ARM_X4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_arm_x4, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_ARM_X8, batch_eq_8) {
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_arm_x8, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_X86_X4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_x86_x4, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASMSIMD_X86_X8, batch_eq_8) {
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vclamp_ukernel__wasmsimd_x86_x8, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASM_X1, batch_eq_1) {
    VUnaryMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vclamp_ukernel__wasm_x1, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASM_X2, batch_eq_2) {
    VUnaryMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vclamp_ukernel__wasm_x2, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VCLAMP__WASM_X4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vclamp_ukernel__wasm_x4, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
  }
...
TEST(F32_VCLAMP__SCALAR_X1, batch_eq_1) {
  VUnaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vclamp_ukernel__scalar_x1, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
}
...
TEST(F32_VCLAMP__SCALAR_X2, batch_eq_2) {
  VUnaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vclamp_ukernel__scalar_x2, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
}
...
TEST(F32_VCLAMP__SCALAR_X4, batch_eq_4) {
  VUnaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vclamp_ukernel__scalar_x4, VUnaryMicrokernelTester::OpType::Clamp, xnn_init_f32_minmax_scalar_params);
}

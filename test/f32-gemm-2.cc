...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_1X16__WASMRELAXEDSIMD_FMA_LOADSPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_1x16__wasmrelaxedsimd_fma_loadsplat,
                        xnn_pack_f32_gemm_goi_w);
          },
          0)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_1X16__WASMRELAXEDSIMD_FMA_LOADSPLAT_U2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/2,
          /*adj_k_block=*/2,
          /*mr=*/1, /*nr=*/16, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_1x16__wasmrelaxedsimd_fma_loadsplat_u2,
                        xnn_pack_f32_gemm_goi_w);
          },
          0)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_4X16__WASMRELAXEDSIMD_FMA_LOADSPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_4x16__wasmrelaxedsimd_fma_loadsplat,
                        xnn_pack_f32_gemm_goi_w);
          },
          0)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_5X16__WASMRELAXEDSIMD_FMA_LOADSPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_5x16__wasmrelaxedsimd_fma_loadsplat,
                        xnn_pack_f32_gemm_goi_w);
          },
          0)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_6X16__WASMRELAXEDSIMD_FMA_LOADSPLAT_U2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/2,
          /*adj_k_block=*/2,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_6x16__wasmrelaxedsimd_fma_loadsplat_u2,
                        xnn_pack_f32_gemm_goi_w);
          },
          0)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {

...
INSTANTIATE_TEST_SUITE_P(
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_8X32__HVX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_8x32__hvx_broadcast,
                        xnn_pack_f32_gemm_goi_w);
          },
          []() {
            TEST_REQUIRES_HVX;
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_GEMM_7X64__HVX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_gemm_ukernel_7x64__hvx_broadcast,
                        xnn_pack_f32_gemm_goi_w);
          },
          []() {
            TEST_REQUIRES_HVX;

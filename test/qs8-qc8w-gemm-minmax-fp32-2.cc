...
#include "gemm-microkernel-tester.h"
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_eq_8) {
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_eq_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t n = 1; n <= 16; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_eq_8_subtile_m) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t m = 1; m <= 1; m++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_eq_8_subtile_n) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t n = 1; n <= 16; n++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_lt_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_lt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_gt_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_div_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 16; k <= 80; k += 8) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_1X16C8__NEONI8MM, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 16; k <= 80; k += 8) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
...
#if XNN_ENABLE_ARM_I8MM && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_eq_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    GemmMicrokernelTester()
      .mr(8)
      .nr(16)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_eq_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    GemmMicrokernelTester()
      .mr(8)
      .nr(16)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t n = 1; n <= 16; n++) {
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_eq_8_subtile_m) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t m = 1; m <= 8; m++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_eq_8_subtile_n) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t n = 1; n <= 16; n++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_lt_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_lt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_gt_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_div_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 16; k <= 80; k += 8) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_QC8W_GEMM_MINMAX_FP32_8X16C8__NEONI8MM, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 16; k <= 80; k += 8) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 8; m++) {

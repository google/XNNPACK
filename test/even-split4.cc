...
template <typename T>
class EvenSplit4Test : public ::testing::Test {
 protected:
  EvenSplit4Test() {
    ...
    input_dims[axis] = output1_dims[axis] + output2_dims[axis] +
                       output3_dims[axis] + output4_dims[axis];
    ...
    operator_output4 = xnnpack::Buffer<T>(NumElements(output4_dims));
    ...
    subgraph_output4 = xnnpack::Buffer<T>(NumElements(output4_dims));
...
TEST_F(EvenSplit4TestQS8, define) {
  ...
  ASSERT_EQ(xnn_status_success, xnn_create_subgraph(/*external_value_ids=*/5,
                                                    /*flags=*/0, &subgraph));
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                ...
                input_dims.size(), input_dims.data(), nullptr, 0,
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                subgraph, xnn_datatype_qint8, signed_zero_point, scale,
                output1_dims.size(), output1_dims.data(), nullptr, 1,
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                subgraph, xnn_datatype_qint8, signed_zero_point, scale,
                output2_dims.size(), output2_dims.data(), nullptr, 2,
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                subgraph, xnn_datatype_qint8, signed_zero_point, scale,
                output3_dims.size(), output3_dims.data(), nullptr, 3,
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_quantized_tensor_value(
                subgraph, xnn_datatype_qint8, signed_zero_point, scale,
                output4_dims.size(), output4_dims.data(), nullptr, 4,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output4_id));
  ASSERT_NE(output4_id, XNN_INVALID_NODE_ID);

  ASSERT_EQ(
      xnn_status_success,
      xnn_define_even_split4(subgraph, axis, input_id, output1_id, output2_id,
                             output3_id, output4_id, /*flags=*/0));
...
TEST_F(EvenSplit4TestF16, define) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp16, output1_dims.size(),
                output1_dims.data(), nullptr, 1,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output1_id));
  ASSERT_NE(output1_id, XNN_INVALID_NODE_ID);
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp16, output2_dims.size(),
                output2_dims.data(), nullptr, 2,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output2_id));
  ASSERT_NE(output2_id, XNN_INVALID_NODE_ID);
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp16, output3_dims.size(),
                output3_dims.data(), nullptr, 3,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output3_id));
  ASSERT_NE(output3_id, XNN_INVALID_NODE_ID);
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp16, output4_dims.size(),
                output4_dims.data(), nullptr, 4,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output4_id));
  ASSERT_NE(output4_id, XNN_INVALID_NODE_ID);
...
TEST_F(EvenSplit4TestF32, define) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp32, output1_dims.size(),
                output1_dims.data(), nullptr, 1,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output1_id));
  ASSERT_NE(output1_id, XNN_INVALID_NODE_ID);
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp32, output2_dims.size(),
                output2_dims.data(), nullptr, 2,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output2_id));
  ASSERT_NE(output2_id, XNN_INVALID_NODE_ID);
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp32, output3_dims.size(),
                output3_dims.data(), nullptr, 3,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output3_id));
  ASSERT_NE(output3_id, XNN_INVALID_NODE_ID);
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_tensor_value(
                subgraph, xnn_datatype_fp32, output4_dims.size(),
                output4_dims.data(), nullptr, 4,
                /*flags=*/XNN_VALUE_FLAG_EXTERNAL_OUTPUT, &output4_id));
  ASSERT_NE(output4_id, XNN_INVALID_NODE_ID);
...
TEST_F(EvenSplit4TestQS8, matches_operator_api) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x8(op1, batch_size, channels, input_stride,
                                   channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x8(op2, batch_size, channels, input_stride,
                                   channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x8(op3, batch_size, channels, input_stride,
                                   channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x8(op4, batch_size, channels, input_stride,
                                   channels, /*threadpool=*/nullptr));

  ASSERT_EQ(xnn_status_success,
            xnn_setup_copy_nc_x8(op1, input.data(), operator_output1.data()));
  ASSERT_EQ(xnn_status_success,
            xnn_setup_copy_nc_x8(op2, (uint8_t*)input.data() + op1->channels,
                                 operator_output2.data()));
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x8(op3, (uint8_t*)input.data() + op1->channels * 2,
                           operator_output3.data()));
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x8(op4, (uint8_t*)input.data() + op1->channels * 3,
                           operator_output4.data()));
...
TEST_F(EvenSplit4TestF16, matches_operator_api) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x16(op1, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x16(op2, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x16(op3, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x16(op4, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ...
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x16(op2, (xnn_float16*)input.data() + op1->channels,
                            operator_output2.data()));
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x16(op3, (xnn_float16*)input.data() + op1->channels * 2,
                            operator_output3.data()));
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x16(op4, (xnn_float16*)input.data() + op1->channels * 3,
                            operator_output4.data()));
...
TEST_F(EvenSplit4TestF32, matches_operator_api) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x32(op1, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x32(op2, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x32(op3, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));
  ASSERT_EQ(xnn_status_success,
            xnn_reshape_copy_nc_x32(op4, batch_size, channels, input_stride,
                                    channels, /*threadpool=*/nullptr));

  ASSERT_EQ(xnn_status_success,
            xnn_setup_copy_nc_x32(op1, input.data(), operator_output1.data()));
  ASSERT_EQ(xnn_status_success,
            xnn_setup_copy_nc_x32(op2, (uint32_t*)input.data() + op1->channels,
                                  operator_output2.data()));
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x32(op3, (uint32_t*)input.data() + op1->channels * 2,
                            operator_output3.data()));
  ASSERT_EQ(
      xnn_status_success,
      xnn_setup_copy_nc_x32(op4, (uint32_t*)input.data() + op1->channels * 3,
                            operator_output4.data()));

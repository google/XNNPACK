...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VRNDU__PSIMD_X4, batch_eq_4) {
    TEST_REQUIRES_PSIMD;
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__psimd_x4), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VRNDU__PSIMD_X4, batch_div_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__PSIMD_X4, batch_lt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__PSIMD_X4, batch_gt_4) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__PSIMD_X4, inplace) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
...
#if !XNN_ARCH_ASMJS && !XNN_ARCH_WASM && !XNN_COMPILER_MSVC && !XNN_COMPILER_ICC
  TEST(F32_VRNDU__PSIMD_X8, batch_eq_8) {
    TEST_REQUIRES_PSIMD;
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__psimd_x8), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VRNDU__PSIMD_X8, batch_div_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__PSIMD_X8, batch_lt_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__PSIMD_X8, batch_gt_8) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__PSIMD_X8, inplace) {
    TEST_REQUIRES_PSIMD;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VRNDU__WASMSIMD_X4, batch_eq_4) {
    VUnOpMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x4), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VRNDU__WASMSIMD_X4, batch_div_4) {
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x4), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  ...
  TEST(F32_VRNDU__WASMSIMD_X4, batch_lt_4) {
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x4), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  ...
  TEST(F32_VRNDU__WASMSIMD_X4, batch_gt_4) {
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x4), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  ...
  TEST(F32_VRNDU__WASMSIMD_X4, inplace) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .inplace(true)
...
#if XNN_ARCH_WASMSIMD
  TEST(F32_VRNDU__WASMSIMD_X8, batch_eq_8) {
    VUnOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x8), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_VRNDU__WASMSIMD_X8, batch_div_8) {
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x8), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  ...
  TEST(F32_VRNDU__WASMSIMD_X8, batch_lt_8) {
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x8), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  ...
  TEST(F32_VRNDU__WASMSIMD_X8, batch_gt_8) {
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vunary_ukernel_function(xnn_f32_vrndu_ukernel__wasmsimd_x8), VUnOpMicrokernelTester::OpType::RoundUp, VUnOpMicrokernelTester::Variant::Scalar);
  ...
  TEST(F32_VRNDU__WASMSIMD_X8, inplace) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VUnOpMicrokernelTester()
        .batch_size(batch_size)
        .inplace(true)

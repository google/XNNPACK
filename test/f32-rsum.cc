...
#include "rsum-microkernel-tester.h"
  ...
  TEST(F32_RSUM__RVV_U1V, batch_eq_4) {
  ...
  TEST(F32_RSUM__RVV_U1V, batch_div_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RSUM__RVV_U1V, batch_lt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RSUM__RVV_U1V, batch_gt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 5; batch_size < 8; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_RSUM__RVV_U2V, batch_eq_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(8)
  ...
  TEST(F32_RSUM__RVV_U2V, batch_div_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RSUM__RVV_U2V, batch_lt_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RSUM__RVV_U2V, batch_gt_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_RSUM__RVV_U4V, batch_eq_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(16)
  ...
  TEST(F32_RSUM__RVV_U4V, batch_div_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RSUM__RVV_U4V, batch_lt_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_RSUM__RVV_U4V, batch_gt_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)

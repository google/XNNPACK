...
#include "rsum-microkernel-tester.h"
  ...
  TEST(F32_RSUM__AVX_U8, batch_eq_8) {
    ...
    RSumMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_rsum_ukernel__avx_u8, xnn_init_f32_scaleminmax_avx_params);
  }
  ...
  TEST(F32_RSUM__AVX_U16_ACC2, batch_eq_16) {
    ...
    RSumMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_rsum_ukernel__avx_u16_acc2, xnn_init_f32_scaleminmax_avx_params);
  }
  ...
  TEST(F32_RSUM__AVX_U24_ACC3, batch_eq_24) {
    ...
    RSumMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_rsum_ukernel__avx_u24_acc3, xnn_init_f32_scaleminmax_avx_params);
  }
  ...
  TEST(F32_RSUM__AVX_U32_ACC2, batch_eq_32) {
    ...
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_rsum_ukernel__avx_u32_acc2, xnn_init_f32_scaleminmax_avx_params);
  }
  ...
  TEST(F32_RSUM__AVX_U32_ACC4, batch_eq_32) {
    ...
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_rsum_ukernel__avx_u32_acc4, xnn_init_f32_scaleminmax_avx_params);
  }

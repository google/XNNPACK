...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
    ...
    .n(2)
    .k(1)
    .Test(xnn_qu8_gemm_minmax_rndnu_ukernel_1x2__scalar_u1, xnn_init_qu8_conv_minmax_rndnu_scalar_params, xnn_qu8_requantize_rndnu);
}

TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, strided_cn) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_strided_a) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_subtile) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_subtile_m) {
  for (uint32_t m = 1; m <= 1; m++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_eq_1_subtile_n) {
  for (uint32_t n = 1; n <= 2; n++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_gt_1) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_gt_1_strided_a) {
  for (size_t k = 2; k < 10; k++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, k_gt_1_subtile) {
  for (size_t k = 2; k < 10; k++) {
    for (uint32_t n = 1; n <= 2; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2_strided_cn) {
  for (uint32_t n = 3; n < 4; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2_strided_a) {
  for (uint32_t n = 3; n < 4; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_gt_2_subtile) {
  for (uint32_t n = 3; n < 4; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2_strided_cn) {
  for (uint32_t n = 4; n <= 6; n += 2) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2_strided_a) {
  for (uint32_t n = 4; n <= 6; n += 2) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, n_div_2_subtile) {
  for (uint32_t n = 4; n <= 6; n += 2) {
    for (size_t k = 1; k <= 5; k += 2) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, strided_cm_subtile) {
  for (size_t k = 1; k <= 5; k += 2) {
    for (uint32_t n = 1; n <= 2; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, qmin) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, qmax) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, strided_cm) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(2)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, no_a_zero_point) {
  for (size_t k = 1; k <= 5; k += 2) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, no_b_zero_point) {
  for (size_t k = 1; k <= 5; k += 2) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, b_zero_point) {
  for (uint16_t b_zero_point = 0; b_zero_point <= 255; ++b_zero_point) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X2__SCALAR_U1, no_zero_point) {
  for (size_t k = 1; k <= 5; k += 2) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(2)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_eq_1) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(4)
    .kr(1)
    ...
    .n(4)
    .k(1)
    .Test(xnn_qu8_gemm_minmax_rndnu_ukernel_1x4__scalar_u1, xnn_init_qu8_conv_minmax_rndnu_scalar_params, xnn_qu8_requantize_rndnu);
}

TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, strided_cn) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(4)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_eq_1_strided_a) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(4)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_eq_1_subtile) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_eq_1_subtile_m) {
  for (uint32_t m = 1; m <= 1; m++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_eq_1_subtile_n) {
  for (uint32_t n = 1; n <= 4; n++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_gt_1) {
  for (size_t k = 2; k < 10; k++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_gt_1_strided_a) {
  for (size_t k = 2; k < 10; k++) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, k_gt_1_subtile) {
  for (size_t k = 2; k < 10; k++) {
    for (uint32_t n = 1; n <= 4; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_gt_4) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_gt_4_strided_cn) {
  for (uint32_t n = 5; n < 8; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_gt_4_strided_a) {
  for (uint32_t n = 5; n < 8; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_gt_4_subtile) {
  for (uint32_t n = 5; n < 8; n++) {
    for (size_t k = 1; k <= 5; k += 2) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_div_4) {
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_div_4_strided_cn) {
  for (uint32_t n = 8; n <= 12; n += 4) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_div_4_strided_a) {
  for (uint32_t n = 8; n <= 12; n += 4) {
    for (size_t k = 1; k <= 5; k += 2) {
      GemmMicrokernelTester()
        .mr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, n_div_4_subtile) {
  for (uint32_t n = 8; n <= 12; n += 4) {
    for (size_t k = 1; k <= 5; k += 2) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, strided_cm_subtile) {
  for (size_t k = 1; k <= 5; k += 2) {
    for (uint32_t n = 1; n <= 4; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, qmin) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(4)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, qmax) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(4)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, strided_cm) {
  GemmMicrokernelTester()
    .mr(1)
    .nr(4)
    .kr(1)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, no_a_zero_point) {
  for (size_t k = 1; k <= 5; k += 2) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, no_b_zero_point) {
  for (size_t k = 1; k <= 5; k += 2) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, b_zero_point) {
  for (uint16_t b_zero_point = 0; b_zero_point <= 255; ++b_zero_point) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)
...
TEST(QU8_GEMM_MINMAX_RNDNU_1X4__SCALAR_U1, no_zero_point) {
  for (size_t k = 1; k <= 5; k += 2) {
    GemmMicrokernelTester()
      .mr(1)
      .nr(4)

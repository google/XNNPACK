...
#include "gemm-microkernel-tester.h"
  ...
  TEST(QS8_IGEMM_MINMAX_RNDNU_1X8C8__AARCH64_NEONDOT_LD128, k_eq_8) {
    ...
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(8)
      .Test(xnn_qs8_igemm_minmax_rndnu_ukernel_1x8c8__aarch64_neondot_ld128, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_pack_qs8_conv_goki_w, xnn_qs8_requantize_rndnu);
  }

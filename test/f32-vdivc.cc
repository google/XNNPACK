...
TEST(F32_VDIVC__SCALAR_X1, batch_eq_1) {
  VBinaryCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vdivc_ukernel__scalar_x1, VBinaryCMicrokernelTester::OpType::DivC);
}
...
TEST(F32_VDIVC__SCALAR_X2, batch_eq_2) {
  VBinaryCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vdivc_ukernel__scalar_x2, VBinaryCMicrokernelTester::OpType::DivC);
}
...
TEST(F32_VDIVC__SCALAR_X4, batch_eq_4) {
  VBinaryCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vdivc_ukernel__scalar_x4, VBinaryCMicrokernelTester::OpType::DivC);
}
...
TEST(F32_VDIVC__SCALAR_X8, batch_eq_8) {
  VBinaryCMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vdivc_ukernel__scalar_x8, VBinaryCMicrokernelTester::OpType::DivC);
}

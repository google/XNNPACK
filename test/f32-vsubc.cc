...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VSUBC__WASMSIMD_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsubc_ukernel__wasmsimd_x4, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC__WASMSIMD_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsubc_ukernel__wasmsimd_x8, VBinOpCMicrokernelTester::OpType::SubC);
  }

...
TEST(QS8_RDSUM_7P7X__SCALAR_C4, channels_eq_4_2pass_fulltile) {
  RDSumMicrokernelTester()
    .rows(14)
    .channels(4)
    .Test(xnn_qs8_rdsum_ukernel_7p7x__scalar_c4, xnn_init_qs8_rsum_scalar_params);
}
...
TEST(QS8_RDSUM_7P7X__SCALAR_C4, overflow_accumulator) {
  ...
  TEST(QS8_RDSUM_7P7X__NEON_C16, channels_eq_16_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(16)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__neon_c16, xnn_init_qs8_rsum_neon_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__NEON_C32, channels_eq_32_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(32)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__neon_c32, xnn_init_qs8_rsum_neon_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__NEON_C64, channels_eq_64_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(64)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__neon_c64, xnn_init_qs8_rsum_neon_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__SSE41_C16, channels_eq_16_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(16)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__sse41_c16, xnn_init_qs8_rsum_sse4_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__SSE41_C32, channels_eq_32_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(32)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__sse41_c32, xnn_init_qs8_rsum_sse4_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__SSE41_C64, channels_eq_64_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(64)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__sse41_c64, xnn_init_qs8_rsum_sse4_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__AVX2_C32, channels_eq_32_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(32)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__avx2_c32, xnn_init_qs8_rsum_avx2_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__AVX2_C64, channels_eq_64_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(64)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__avx2_c64, xnn_init_qs8_rsum_avx2_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__AVX512SKX_C64, channels_eq_64_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(64)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__avx512skx_c64, xnn_init_qs8_rsum_scalar_params);
  }
  ...
  TEST(QS8_RDSUM_7P7X__AVX512SKX_C128, channels_eq_128_2pass_fulltile) {
    ...
    RDSumMicrokernelTester()
      .rows(14)
      .channels(128)
      .Test(xnn_qs8_rdsum_ukernel_7p7x__avx512skx_c128, xnn_init_qs8_rsum_scalar_params);
  }

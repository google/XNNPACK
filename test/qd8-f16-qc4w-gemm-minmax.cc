...
#include "gemm-microkernel-tester.h"
 ...
 TEST(QD8_F16_QB4W_GEMM_MINMAX_1X8C4__NEONDOT, bl_kc) {
    size_t kr = 4;
    for (size_t kc=16; kc <= 64; kc+=16) {
      for (size_t bl=8; bl<=kc; bl+=8) {
        ...
        GemmMicrokernelTester()
          ...
          .b_zero_point(8)
          .iterations(3)
          .Test(xnn_qd8_f16_qb4w_gemm_minmax_ukernel_1x8c4__neondot, xnn_init_f16_qc4w_minmax_scalar_params, xnn_pack_qs8_qc4w_gemm_bl_goi_w);
      }
    }
  }

  TEST(QD8_F16_QB4W_GEMM_MINMAX_1X8C4__NEONDOT, bl_kc_odd) {
    size_t kr = 4;
    for (size_t kc=16; kc <= 64; kc+=16) {
      for (size_t bl=8; bl<=kc; bl+=8) {
        if (round_up_po2(kc, kr) % bl) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_eq_16) {
    ...
    GemmMicrokernelTester()
      ...
      .k(16)
      .b_zero_point(8)
      .Test(xnn_qd8_f16_qc4w_gemm_minmax_ukernel_8x8c8__avx512vnni, xnn_init_f16_qc4w_minmax_avxvnni_params, xnn_pack_qs8_qc4w_gemm_goi_w);
  }

  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, strided_cn) {
    TEST_REQUIRES_X86_AVX512VNNI;
    GemmMicrokernelTester()
      .mr(8)
      .nr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_eq_16_strided_a) {
    TEST_REQUIRES_X86_AVX512VNNI;
    GemmMicrokernelTester()
      .mr(8)
      .nr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_eq_16_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_eq_16_subtile_m) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t m = 1; m <= 8; m++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_eq_16_subtile_n) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_lt_16) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 1; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_lt_16_strided_a) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 1; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_lt_16_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 1; k < 16; k++) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_gt_16) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 17; k < 32; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_gt_16_strided_a) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 17; k < 32; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_gt_16_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 17; k < 32; k++) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_div_16) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 32; k <= 160; k += 16) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_div_16_strided_a) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 32; k <= 160; k += 16) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, k_div_16_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 32; k <= 160; k += 16) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_gt_8) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_gt_8_strided_cn) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_gt_8_strided_a) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_gt_8_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 9; n < 16; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_div_8) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_div_8_strided_cn) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_div_8_strided_a) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, n_div_8_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (uint32_t n = 16; n <= 24; n += 8) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, strided_cm_subtile) {
    TEST_REQUIRES_X86_AVX512VNNI;
    for (size_t k = 1; k <= 80; k += 17) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, qmin) {
    TEST_REQUIRES_X86_AVX512VNNI;
    GemmMicrokernelTester()
      .mr(8)
      .nr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, qmax) {
    TEST_REQUIRES_X86_AVX512VNNI;
    GemmMicrokernelTester()
      .mr(8)
      .nr(8)
  ...
  TEST(QD8_F16_QC4W_GEMM_MINMAX_8X8C8__AVX512VNNI, strided_cm) {
    TEST_REQUIRES_X86_AVX512VNNI;
    GemmMicrokernelTester()
      .mr(8)
      .nr(8)

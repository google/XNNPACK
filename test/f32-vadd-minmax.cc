...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VADD_MINMAX__NEON_X4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_minmax_ukernel__neon_x4, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__NEON_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_minmax_ukernel__neon_x8, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__SSE_X4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_minmax_ukernel__sse_x4, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__SSE_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_minmax_ukernel__sse_x8, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__AVX_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_minmax_ukernel__avx_x8, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__AVX_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vadd_minmax_ukernel__avx_x16, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__AVX512F_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vadd_minmax_ukernel__avx512f_x16, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__AVX512F_X32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vadd_minmax_ukernel__avx512f_x32, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_minmax_ukernel__wasmsimd_arm_x4, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_minmax_ukernel__wasmsimd_arm_x8, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__WASMSIMD_X86_X4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_minmax_ukernel__wasmsimd_x86_x4, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__WASMSIMD_X86_X8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_minmax_ukernel__wasmsimd_x86_x8, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F32_VADD_MINMAX__WASM_X1, batch_eq_1) {
    VBinaryMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vadd_minmax_ukernel__wasm_x1, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VADD_MINMAX__WASM_X2, batch_eq_2) {
    VBinaryMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vadd_minmax_ukernel__wasm_x2, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VADD_MINMAX__WASM_X4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vadd_minmax_ukernel__wasm_x4, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
  }
...
TEST(F32_VADD_MINMAX__SCALAR_X1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vadd_minmax_ukernel__scalar_x1, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VADD_MINMAX__SCALAR_X2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vadd_minmax_ukernel__scalar_x2, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VADD_MINMAX__SCALAR_X4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vadd_minmax_ukernel__scalar_x4, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}

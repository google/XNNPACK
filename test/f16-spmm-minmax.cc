...
#define XNN_UKERNEL_WITH_PARAMS(arch_flags, ukernel, mr, nr, pipelined, kblock, datatype, params_type, init_params)    \
  XNN_TEST_SPMM_K_EQ(ukernel, arch_flags, mr, nr, pipelined, kblock, init_params);                                     \
  ...
  XNN_TEST_SPMM_ZERO_WEIGHTS(ukernel, arch_flags, mr, nr, pipelined, init_params);
#include "f16-spmm/f16-spmm.h"

...
#include "vcvt-microkernel-tester.h"
  ...
  TEST(F32_QU8_VCVT__NEON_U8, batch_eq_8) {
    ...
    VCvtMicrokernelTester()
      ...
      .Test(xnn_f32_qu8_vcvt_ukernel__neon_u8, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEON_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neon_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEON_U24, batch_eq_24) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neon_u24, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEON_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neon_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEONV8_U8, batch_eq_8) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neonv8_u8, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEONV8_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neonv8_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEONV8_U24, batch_eq_24) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neonv8_u24, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__NEONV8_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__neonv8_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, batch_eq_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
    VCvtMicrokernelTester()
      .batch_size(batch_tile)
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u1v, xnn_init_f32_qu8_cvt_scalar_params);
  }

  TEST(F32_QU8_VCVT__RVV_U1V, batch_div_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile*2; batch_size < batch_tile*10; batch_size += batch_tile) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, batch_lt_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size < batch_tile; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, batch_gt_1v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, output_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t output_zero_point = 0; output_zero_point < 5; output_zero_point += 2) {
      const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, saturation) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, overflow) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmin = 0; qmin < 255; qmin += 51) {
      const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmax = 1; qmax <= 255; qmax += 51) {
      const size_t batch_tile = (1*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_QU8_VCVT__RVV_U2V, batch_eq_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    VCvtMicrokernelTester()
      .batch_size(batch_tile)
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u2v, xnn_init_f32_qu8_cvt_scalar_params);
  }

  TEST(F32_QU8_VCVT__RVV_U2V, batch_div_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile*2; batch_size < batch_tile*10; batch_size += batch_tile) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, batch_lt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size < batch_tile; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, batch_gt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile+1; batch_size < batch_tile*2; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, output_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t output_zero_point = 0; output_zero_point < 5; output_zero_point += 2) {
      const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, saturation) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, overflow) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmin = 0; qmin < 255; qmin += 51) {
      const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmax = 1; qmax <= 255; qmax += 51) {
      const size_t batch_tile = (2*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_QU8_VCVT__RVV_U4V, batch_eq_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    VCvtMicrokernelTester()
      .batch_size(batch_tile)
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u4v, xnn_init_f32_qu8_cvt_scalar_params);
  }

  TEST(F32_QU8_VCVT__RVV_U4V, batch_div_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile*2; batch_size < batch_tile*10; batch_size += batch_tile) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, batch_lt_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size < batch_tile; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, batch_gt_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile+1; batch_size < batch_tile*2; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, output_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t output_zero_point = 0; output_zero_point < 5; output_zero_point += 2) {
      const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, saturation) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, overflow) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmin = 0; qmin < 255; qmin += 51) {
      const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmax = 1; qmax <= 255; qmax += 51) {
      const size_t batch_tile = (4*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_QU8_VCVT__RVV_U8V, batch_eq_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    VCvtMicrokernelTester()
      .batch_size(batch_tile)
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u8v, xnn_init_f32_qu8_cvt_scalar_params);
  }

  TEST(F32_QU8_VCVT__RVV_U8V, batch_div_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile*2; batch_size < batch_tile*10; batch_size += batch_tile) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, batch_lt_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size < batch_tile; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, batch_gt_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = batch_tile+1; batch_size < batch_tile*2; batch_size++) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, output_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t output_zero_point = 0; output_zero_point < 5; output_zero_point += 2) {
      const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, saturation) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, overflow) {
    TEST_REQUIRES_RISCV_VECTOR;
    const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
    for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
      VCvtMicrokernelTester()
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmin = 0; qmin < 255; qmin += 51) {
      const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (int16_t qmax = 1; qmax <= 255; qmax += 51) {
      const size_t batch_tile = (8*xnn_init_hardware_config()->vlenb/sizeof(float));
      for (size_t batch_size = 1; batch_size <= batch_tile*5; batch_size += batch_tile-1) {
  ...
  TEST(F32_QU8_VCVT__SSE2_U8, batch_eq_8) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__sse2_u8, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__SSE2_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__sse2_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__SSE2_U24, batch_eq_24) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__sse2_u24, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__SSE2_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__sse2_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX_U8, batch_eq_8) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx_u8, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX_U24, batch_eq_24) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx_u24, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX2_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx2_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX2_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx2_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX2_U48, batch_eq_48) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx2_u48, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX2_U64, batch_eq_64) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx2_u64, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX512SKX_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx512skx_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX512SKX_U64, batch_eq_64) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx512skx_u64, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX512SKX_U96, batch_eq_96) {
    TEST_REQUIRES_X86_AVX512SKX;
    const size_t batch_tile = 96;
    VCvtMicrokernelTester()
      .batch_size(batch_tile)
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx512skx_u96, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__AVX512SKX_U128, batch_eq_128) {
    TEST_REQUIRES_X86_AVX512SKX;
    const size_t batch_tile = 128;
    VCvtMicrokernelTester()
      .batch_size(batch_tile)
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__avx512skx_u128, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_CVT_U8, batch_eq_8) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_cvt_u8, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_CVT_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_cvt_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_CVT_U24, batch_eq_24) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_cvt_u24, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_CVT_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_cvt_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_MAGIC_U8, batch_eq_8) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_magic_u8, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_MAGIC_U16, batch_eq_16) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_magic_u16, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_MAGIC_U24, batch_eq_24) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_magic_u24, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASMSIMD_MAGIC_U32, batch_eq_32) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasmsimd_magic_u32, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASM_FMAGIC_U1, batch_eq_1) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasm_fmagic_u1, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASM_FMAGIC_U2, batch_eq_2) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasm_fmagic_u2, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASM_FMAGIC_U3, batch_eq_3) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasm_fmagic_u3, xnn_init_f32_qu8_cvt_scalar_params);
  }
  ...
  TEST(F32_QU8_VCVT__WASM_FMAGIC_U4, batch_eq_4) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__wasm_fmagic_u4, xnn_init_f32_qu8_cvt_scalar_params);
  }
...
TEST(F32_QU8_VCVT__SCALAR_FMAGIC_U1, batch_eq_1) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_fmagic_u1, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_FMAGIC_U2, batch_eq_2) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_fmagic_u2, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_FMAGIC_U3, batch_eq_3) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_fmagic_u3, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_FMAGIC_U4, batch_eq_4) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_fmagic_u4, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_IMAGIC_U1, batch_eq_1) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_imagic_u1, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_IMAGIC_U2, batch_eq_2) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_imagic_u2, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_IMAGIC_U3, batch_eq_3) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_imagic_u3, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_IMAGIC_U4, batch_eq_4) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_imagic_u4, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_LRINTF_U1, batch_eq_1) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_lrintf_u1, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_LRINTF_U2, batch_eq_2) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_lrintf_u2, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_LRINTF_U3, batch_eq_3) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_lrintf_u3, xnn_init_f32_qu8_cvt_scalar_params);
}
...
TEST(F32_QU8_VCVT__SCALAR_LRINTF_U4, batch_eq_4) {
  ...
  VCvtMicrokernelTester()
    ...
    .qmin(std::numeric_limits<uint8_t>::min())
    .qmax(std::numeric_limits<uint8_t>::max())
    .Test(xnn_f32_qu8_vcvt_ukernel__scalar_lrintf_u4, xnn_init_f32_qu8_cvt_scalar_params);
}

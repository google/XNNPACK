...
#include "vcvt-microkernel-tester.h"
  ...
  TEST(F32_QU8_VCVT__RVV_U1V, batch_eq_1v) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u1v, xnn_init_f32_qu8_cvt_rvv_params);
  }
  ...
  TEST(F32_QU8_VCVT__RVV_U2V, batch_eq_2v) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u2v, xnn_init_f32_qu8_cvt_rvv_params);
  }
  ...
  TEST(F32_QU8_VCVT__RVV_U4V, batch_eq_4v) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u4v, xnn_init_f32_qu8_cvt_rvv_params);
  }
  ...
  TEST(F32_QU8_VCVT__RVV_U8V, batch_eq_8v) {
    ...
    VCvtMicrokernelTester()
      ...
      .qmin(std::numeric_limits<uint8_t>::min())
      .qmax(std::numeric_limits<uint8_t>::max())
      .Test(xnn_f32_qu8_vcvt_ukernel__rvv_u8v, xnn_init_f32_qu8_cvt_rvv_params);
  }

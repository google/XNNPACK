...
#include "pack-microkernel-tester.h"
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(4)
      .m(4)
      .k(4)
      .Test(xnn_x32_packx_ukernel_4x__neon_st4_prfm);
  }

  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t m = 1; m <= 4; m++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_div_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 20; k += 5) {
      PackMicrokernelTester()
        .mr(4)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_8X__NEON_ST4, k_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(8)
      .m(8)
      .k(4)
      .Test(xnn_x32_packx_ukernel_8x__neon_st4);
  }

  TEST(X32_PACKX_8X__NEON_ST4, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X32_PACKX_8X__NEON_ST4, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4, k_div_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 20; k += 5) {
      PackMicrokernelTester()
        .mr(8)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(8)
      .m(8)
      .k(4)
      .Test(xnn_x32_packx_ukernel_8x__neon_st4_prfm);
  }

  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t m = 1; m <= 8; m++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_div_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 20; k += 5) {
      PackMicrokernelTester()
        .mr(8)

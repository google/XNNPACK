...
#include "pack-microkernel-tester.h"
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(4)
      .m(4)
      .k(4)
      .Test(xnn_x32_packx_ukernel_4x__neon_st4_prfm_x4);
  }

  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t m = 1; m <= 4; m++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_div_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X4, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 20; k += 5) {
      PackMicrokernelTester()
        .mr(4)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_eq_4) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(8)
      .m(8)
      .k(4)
      .Test(xnn_x32_packx_ukernel_8x__neon_st4_prfm_x4);
  }

  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_eq_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t m = 1; m <= 8; m++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_lt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_lt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 4; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_gt_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_gt_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 5; k < 8; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_div_4) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, k_div_4_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 8; k < 40; k += 4) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X4, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 20; k += 5) {
      PackMicrokernelTester()
        .mr(8)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(4)
      .m(4)
      .k(8)
      .Test(xnn_x32_packx_ukernel_4x__neon_st4_prfm_x8);
  }

  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t m = 1; m <= 4; m++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 80; k += 8) {
      PackMicrokernelTester()
        .mr(4)
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 80; k += 8) {
      for (size_t m = 1; m <= 4; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_4X__NEON_ST4_PRFM_X8, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 40; k += 9) {
      PackMicrokernelTester()
        .mr(4)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    PackMicrokernelTester()
      .mr(8)
      .m(8)
      .k(8)
      .Test(xnn_x32_packx_ukernel_8x__neon_st4_prfm_x8);
  }

  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t m = 1; m <= 8; m++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k < 8; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 80; k += 8) {
      PackMicrokernelTester()
        .mr(8)
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 80; k += 8) {
      for (size_t m = 1; m <= 8; m++) {
        PackMicrokernelTester()
  ...
  TEST(X32_PACKX_8X__NEON_ST4_PRFM_X8, strided_x) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 1; k <= 40; k += 9) {
      PackMicrokernelTester()
        .mr(8)

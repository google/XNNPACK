...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VRSUBC__WASMSIMD_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__wasmsimd_u4, VBinaryMicrokernelTester::OpType::RSub);
  }
  ...
  TEST(F32_VRSUBC__WASMSIMD_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__wasmsimd_u8, VBinaryMicrokernelTester::OpType::RSub);
  }
  ...
  TEST(F32_VRSUBC__WASMSIMD_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__wasmsimd_u16, VBinaryMicrokernelTester::OpType::RSub);
  }
...
TEST(F32_VRSUBC__SCALAR_U1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__scalar_u1, VBinaryMicrokernelTester::OpType::RSub);
}
...
TEST(F32_VRSUBC__SCALAR_U2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__scalar_u2, VBinaryMicrokernelTester::OpType::RSub);
}
...
TEST(F32_VRSUBC__SCALAR_U4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__scalar_u4, VBinaryMicrokernelTester::OpType::RSub);
}
...
TEST(F32_VRSUBC__SCALAR_U8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .broadcast_b(true).Test(xnn_f32_vrsubc_ukernel__scalar_u8, VBinaryMicrokernelTester::OpType::RSub);
}

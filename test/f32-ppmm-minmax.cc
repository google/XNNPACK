...
INSTANTIATE_TEST_SUITE_P(
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_1X1V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_1x1v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_1X2V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/2, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_1x2v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_1X4V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_1x4v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_2X1V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/2, /*nr=*/1, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_2x1v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_2X2V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/2, /*nr=*/2, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_2x2v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_2X4V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/2, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_2x4v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_4X1V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/1, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_4x1v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_4X2V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/2, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_4x2v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_PPMM_MINMAX_4X4V__RVV, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_ppmm_minmax_ukernel_4x4v__rvv,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_gemm_goi_w);
          },
          xnn_arch_riscv_vector)),

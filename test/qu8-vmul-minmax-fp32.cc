...
#include "vmul-microkernel-tester.h"
  ...
  TEST(QU8_VMUL_MINMAX_FP32__NEON_LD64_X8, batch_eq_8) {
    ...
    VMulMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__neon_ld64_x8, xnn_init_qu8_mul_minmax_fp32_neon_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
  }
  ...
  TEST(QU8_VMUL_MINMAX_FP32__NEON_LD64_X16, batch_eq_16) {
    ...
    VMulMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__neon_ld64_x16, xnn_init_qu8_mul_minmax_fp32_neon_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
  }
  ...
  TEST(QU8_VMUL_MINMAX_FP32__NEON_LD128_X16, batch_eq_16) {
    ...
    VMulMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__neon_ld128_x16, xnn_init_qu8_mul_minmax_fp32_neon_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
  }
  ...
  TEST(QU8_VMUL_MINMAX_FP32__NEONV8_LD64_X8, batch_eq_8) {
    ...
    VMulMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__neonv8_ld64_x8, xnn_init_qu8_mul_minmax_fp32_neonv8_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
  }
  ...
  TEST(QU8_VMUL_MINMAX_FP32__NEONV8_LD64_X16, batch_eq_16) {
    ...
    VMulMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__neonv8_ld64_x16, xnn_init_qu8_mul_minmax_fp32_neonv8_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
  }
  ...
  TEST(QU8_VMUL_MINMAX_FP32__NEONV8_LD128_X16, batch_eq_16) {
    ...
    VMulMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__neonv8_ld128_x16, xnn_init_qu8_mul_minmax_fp32_neonv8_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
  }
...
TEST(QU8_VMUL_MINMAX_FP32__SCALAR_X1, batch_eq_1) {
  VMulMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qu8_vmul_minmax_fp32_ukernel__scalar_x1, xnn_init_qu8_mul_minmax_fp32_scalar_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
}
...
TEST(QU8_VMUL_MINMAX_FP32__SCALAR_X2, batch_eq_2) {
  VMulMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qu8_vmul_minmax_fp32_ukernel__scalar_x2, xnn_init_qu8_mul_minmax_fp32_scalar_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
}
...
TEST(QU8_VMUL_MINMAX_FP32__SCALAR_X4, batch_eq_4) {
  VMulMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qu8_vmul_minmax_fp32_ukernel__scalar_x4, xnn_init_qu8_mul_minmax_fp32_scalar_params, xnn_init_qu8_requantization_fp32_params, xnn_qu8_requantize_fp32);
}

...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QU8_VMUL_MINMAX_FP32__RVV_U1V, batch_eq_1) {
  ...
  TEST(QU8_VMUL_MINMAX_FP32__RVV_U1V, batch_gt_1) {
    TEST_REQUIRES_RISCV_VECTOR;
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QU8_VMUL_MINMAX_FP32__RVV_U2V, batch_eq_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
      .batch_size(2)
      .Test(xnn_qu8_vmul_minmax_fp32_ukernel__rvv_u2v, xnn_init_qu8_mul_minmax_fp32_scalar_params, xnn_qu8_requantize_fp32);
  }

  TEST(QU8_VMUL_MINMAX_FP32__RVV_U2V, batch_div_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VMUL_MINMAX_FP32__RVV_U2V, batch_lt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VMUL_MINMAX_FP32__RVV_U2V, batch_gt_2) {
    TEST_REQUIRES_RISCV_VECTOR;

...
void compute_convolution_qs8_reference_results(
  ...
  compute_convolution_qs8_reference_results(
      ...
      groups * group_input_channels, input_zero_point, input, filter,
...
void compute_convolution_qu8_reference_results(
  ...
  compute_convolution_qu8_reference_results(
      ...
      subsampling_width, dilation_height, dilation_width, groups,
      group_input_channels, group_output_channels,
      groups * group_input_channels, input_zero_point, kernel_zero_point, input,
      filter, accumulators, has_bias, bias);
}
                  ...
                  for (size_t oc = 0; oc < depth_multiplier; oc++) {
                    accumulators[(((i * output_height + oy) * output_width +
                        ...
                        (int32_t(input[((i * input_height + iy) * input_width +
                         ...
                         int32_t(input_zero_point)) *
                        int32_t(
                            filter[((ky * kernel_width + kx) * input_channels +
                                    g) *
                                       depth_multiplier +
                                   oc]);
                  }
...
void compute_depthwise_convolution_qs8_reference_results(
  ...
  compute_depthwise_convolution_qs8_reference_results(
      ...
      depth_multiplier, input_channels, input_zero_point, input, filter,
      accumulators, has_bias, bias);
}
...
void compute_depthwise_convolution_qu8_reference_results(
  ...
  compute_depthwise_convolution_qu8_reference_results(
      ...
      input_padding_left, kernel_height, kernel_width, subsampling_height,
      subsampling_width, dilation_height, dilation_width, input_channels,
      depth_multiplier, input_channels, input_zero_point, kernel_zero_point,
      input, filter, accumulators, has_bias, bias);
}
}  // namespace xnnpack

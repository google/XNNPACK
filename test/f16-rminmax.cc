...
#include "reduce-microkernel-tester.h"
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U16, batch_eq_16) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u16, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U16, batch_div_16) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U16, batch_lt_16) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U16, batch_gt_16) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U24, batch_eq_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u24, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U24, batch_div_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U24, batch_lt_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U24, batch_gt_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U24_ACC2, batch_eq_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u24_acc2, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U24_ACC2, batch_div_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 48; batch_size < 240; batch_size += 24) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U24_ACC2, batch_lt_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 1; batch_size < 24; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U24_ACC2, batch_gt_24) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 25; batch_size < 48; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U32, batch_eq_32) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u32, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U32, batch_div_32) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U32, batch_lt_32) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U32, batch_gt_32) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U64, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u64, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U64, batch_div_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U64, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U64, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC2, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u64_acc2, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC2, batch_div_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC2, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC2, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC4, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    ReduceMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f16_rminmax_ukernel__neonfp16arith_u64_acc4, ReduceMicrokernelTester::OpType::MinMax);
  }

  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC4, batch_div_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC4, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F16_RMINMAX__NEONFP16ARITH_U64_ACC4, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      ReduceMicrokernelTester()
        .batch_size(batch_size)

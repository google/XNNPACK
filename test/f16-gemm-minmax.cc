...
std::vector<GemmTestParams> CreateTests1(
      ...
      testing::ValuesIn(CreateTests1(
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_1x32__avx512fp16_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
      ...
      testing::ValuesIn(CreateTests1(
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_1x64__avx512fp16_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x64__avx512skx_u16);
          },
          xnn_arch_x86_avx512fp16)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
        return info.param.test_name;
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_1X16__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/16, /*kr=*/1, /*sr=*/1,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_4X16__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/16, /*kr=*/1, /*sr=*/1,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_5X16__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/5, /*nr=*/16, /*kr=*/1, /*sr=*/1,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_6X16__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/6, /*nr=*/16, /*kr=*/1, /*sr=*/1,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_7X16__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_8X16__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/8, /*nr=*/16, /*kr=*/1, /*sr=*/1,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_1X32__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/32, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_1x32__avx512skx_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
          xnn_arch_x86_avx512skx)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_4X32__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/32, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_4x32__avx512skx_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
          xnn_arch_x86_avx512skx)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_5X32__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/5, /*nr=*/32, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_5x32__avx512skx_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
          xnn_arch_x86_avx512skx)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_6X32__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/6, /*nr=*/32, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_6x32__avx512skx_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
          xnn_arch_x86_avx512skx)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_7X32__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/7, /*nr=*/32, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_7x32__avx512skx_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
          xnn_arch_x86_avx512skx)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_8X32__AVX512SKX_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/8, /*nr=*/32, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_8x32__avx512skx_broadcast,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16);
          },
          xnn_arch_x86_avx512skx)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_1X8__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_1x8__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_4X8__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_4x8__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x8__scalar_int_u4);
          },
          0)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_6X8__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/6, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_6x8__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x8__scalar_int_u4);
          },
          0)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_8X8__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/8, /*nr=*/8, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_8x8__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x8__scalar_int_u4);
          },
          0)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_1X16__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/16, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_1x16__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_4X16__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/16, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_4x16__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x16__scalar_int_u4);
          },
          0)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_6X16__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/6, /*nr=*/16, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_6x16__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x16__scalar_int_u4);
          },
          0)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      F16_GEMM_MINMAX_8X16__WASMRELAXEDSIMDFP16_SPLAT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/8, /*nr=*/16, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f16_gemm_minmax_ukernel_8x16__wasmrelaxedsimdfp16_splat,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_x16_packw_gemm_goi_ukernel_x16__scalar_int_u4);
          },
          0)),

...
#include "spmm-microkernel-tester.h"
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, k_eq_1) {
    ...
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x2__rvv, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_SPMM_MINMAX_4X2__RVV, k_eq_1_subtile) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, k_gt_1) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t k = 2; k < 10; k++) {
      SpMMMicrokernelTester()
        .mr(4)
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, k_gt_1_subtile) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t k = 2; k < 10; k++) {
      for (uint32_t n = 1; n <= 2; n++) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, n_gt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, n_div_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, m_lt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 1; m < 4; m++) {
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, m_div_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 8; m <= 12; m += 4) {
      for (uint32_t n = 1; n < 10; n += 3) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, m_gt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 5; m < 8; m++) {
      for (uint32_t n = 1; n < 10; n += 3) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, output_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 10; n += 3) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 10; n += 3) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 10; n += 3) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, half_sparse) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 10; n += 3) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_4X2__RVV, zero_weights) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 10; n += 3) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_SPMM_MINMAX_16X4__RVV, k_eq_1) {
    TEST_REQUIRES_RISCV_VECTOR;
    SpMMMicrokernelTester()
      .mr(16)
      .nr(4)
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_16x4__rvv, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_SPMM_MINMAX_16X4__RVV, k_eq_1_subtile) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n <= 4; n++) {
      SpMMMicrokernelTester()
        .mr(16)
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, k_gt_1) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t k = 2; k < 10; k++) {
      SpMMMicrokernelTester()
        .mr(16)
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, k_gt_1_subtile) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t k = 2; k < 10; k++) {
      for (uint32_t n = 1; n <= 4; n++) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, n_gt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 5; n < 10; n++) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, n_div_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 8; n <= 12; n += 4) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, m_lt_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 1; m < 16; m++) {
      for (uint32_t n = 1; n < 20; n += 5) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, m_div_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 32; m <= 48; m += 16) {
      for (uint32_t n = 1; n < 20; n += 5) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, m_gt_16) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 17; m < 32; m++) {
      for (uint32_t n = 1; n < 20; n += 5) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, output_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, half_sparse) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_16X4__RVV, zero_weights) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_SPMM_MINMAX_32X4__RVV, k_eq_1) {
    TEST_REQUIRES_RISCV_VECTOR;
    SpMMMicrokernelTester()
      .mr(32)
      .nr(4)
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_32x4__rvv, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_SPMM_MINMAX_32X4__RVV, k_eq_1_subtile) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n <= 4; n++) {
      SpMMMicrokernelTester()
        .mr(32)
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, k_gt_1) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t k = 2; k < 10; k++) {
      SpMMMicrokernelTester()
        .mr(32)
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, k_gt_1_subtile) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t k = 2; k < 10; k++) {
      for (uint32_t n = 1; n <= 4; n++) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, n_gt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 5; n < 10; n++) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, n_div_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 8; n <= 12; n += 4) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, m_lt_32) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 1; m < 32; m++) {
      for (uint32_t n = 1; n < 20; n += 5) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, m_div_32) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 64; m <= 96; m += 32) {
      for (uint32_t n = 1; n < 20; n += 5) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, m_gt_32) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t m = 33; m < 64; m++) {
      for (uint32_t n = 1; n < 20; n += 5) {
        for (size_t k = 1; k <= 5; k += 2) {
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, output_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, half_sparse) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_32X4__RVV, zero_weights) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (uint32_t n = 1; n < 20; n += 5) {
      for (size_t k = 1; k <= 5; k += 2) {
        SpMMMicrokernelTester()
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMSIMD_ARM, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmsimd_arm, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMSIMD_ARM_PIPELINED_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmsimd_arm_pipelined_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMSIMD_ARM_X4, k_eq_4) {
    SpMMMicrokernelTester()
      ...
      .k(4)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmsimd_arm_x4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMSIMD_X86, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmsimd_x86, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMSIMD_X86_PIPELINED, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmsimd_x86_pipelined, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMSIMD_X86_X4, k_eq_4) {
    SpMMMicrokernelTester()
      ...
      .k(4)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmsimd_x86_x4, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_8X1__WASMSIMD_ARM_PIPELINED, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_8x1__wasmsimd_arm_pipelined, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_16X1__WASMSIMD_ARM_PIPELINED, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_16x1__wasmsimd_arm_pipelined, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_32X1__WASMSIMD_X86_PIPELINED, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_32x1__wasmsimd_x86_pipelined, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_32X1__WASMSIMD_X86_PIPELINED_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_32x1__wasmsimd_x86_pipelined_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMRELAXEDSIMD_ARM, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmrelaxedsimd_arm, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_4X1__WASMRELAXEDSIMD_X86, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_4x1__wasmrelaxedsimd_x86, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_8X1__WASMRELAXEDSIMD_ARM_PIPELINED_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_8x1__wasmrelaxedsimd_arm_pipelined_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_8X1__WASMRELAXEDSIMD_ARM_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_8x1__wasmrelaxedsimd_arm_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_8X1__WASMRELAXEDSIMD_X86_PIPELINED, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_8x1__wasmrelaxedsimd_x86_pipelined, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_8X1__WASMRELAXEDSIMD_X86_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_8x1__wasmrelaxedsimd_x86_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_16X1__WASMRELAXEDSIMD_ARM_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_16x1__wasmrelaxedsimd_arm_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_16X1__WASMRELAXEDSIMD_X86_PIPELINED_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_16x1__wasmrelaxedsimd_x86_pipelined_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_16X1__WASMRELAXEDSIMD_X86_X2, k_eq_2) {
    SpMMMicrokernelTester()
      ...
      .k(2)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_16x1__wasmrelaxedsimd_x86_x2, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_SPMM_MINMAX_32X1__WASMRELAXEDSIMD_ARM_PIPELINED, k_eq_1) {
    SpMMMicrokernelTester()
      ...
      .k(1)
      .sparsity(0.0f)
      .Test(xnn_f32_spmm_minmax_ukernel_32x1__wasmrelaxedsimd_arm_pipelined, xnn_init_f32_minmax_scalar_params);
  }

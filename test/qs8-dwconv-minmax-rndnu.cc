...
#include "dwconv-microkernel-tester.h"
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P8C__NEON_MLA8_LD64, c_eq_8_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P8C__NEON_MUL8_LD64, c_eq_8_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P8C__NEON_MUL16, c_eq_8_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P16C__NEON_MLA8_LD64, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P16C__NEON_MLA8_LD128, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P16C__NEON_MUL8_LD64, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P16C__NEON_MUL8_LD128, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P16C__NEON_MUL16, c_eq_16_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_eq_24) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(24)
      .primary_tile(9)
      .channels(24)
      .kr(9)
      .Test(xnn_qs8_dwconv_minmax_rndnu_ukernel_9p24c__neon_mul16, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_div_24) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_div_24_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_div_24_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_lt_24) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_gt_24) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_gt_24_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_gt_24_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, multipixel) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      for (size_t step = 2; step <= 9; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 9; mz++) {
      for (uint32_t channels = 48; channels < 384; channels += 72) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P24C__NEON_MUL16, c_eq_24_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_9P32C__NEON_MUL16, c_eq_32_k_lt_9) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P8C__NEON_MLA8_LD64, c_eq_8_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P8C__NEON_MUL8_LD64, c_eq_8_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P8C__NEON_MUL16, c_eq_8_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 9; channels < 16; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P16C__NEON_MLA8_LD64, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P16C__NEON_MLA8_LD128, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P16C__NEON_MUL8_LD64, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P16C__NEON_MUL8_LD128, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P16C__NEON_MUL16, c_eq_16_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 17; channels < 32; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_eq_24) {
    TEST_REQUIRES_ARM_NEON;
    DWConvMicrokernelTester()
      .cr(24)
      .primary_tile(25)
      .channels(24)
      .kr(25)
      .Test(xnn_qs8_dwconv_minmax_rndnu_ukernel_25p24c__neon_mul16, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_div_24) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_div_24_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_div_24_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_lt_24) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 1; channels < 24; channels++) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_gt_24) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_gt_24_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_gt_24_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, multipixel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, multipixel_with_step) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      for (size_t step = 2; step <= 25; step++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, multipixel_with_output_stride) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, multipixel_with_qmin) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, multipixel_with_qmax) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t channels = 1; channels <= 120; channels += 23) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, input_offset) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 48; channels < 384; channels += 72) {
      DWConvMicrokernelTester()
        .cr(24)
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, zero) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t mz = 0; mz < 25; mz++) {
      for (uint32_t channels = 48; channels < 384; channels += 72) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P24C__NEON_MUL16, c_eq_24_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 25; channels < 48; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
  ...
  TEST(QS8_DWCONV_MINMAX_RNDNU_25P32C__NEON_MUL16, c_eq_32_k_lt_25) {
    TEST_REQUIRES_ARM_NEON;
    for (uint32_t channels = 33; channels < 64; channels++) {
      for (size_t kernel_size = 1; kernel_size < 25; kernel_size++) {
        DWConvMicrokernelTester()
...
TEST(QS8_DWCONV_MINMAX_RNDNU_9P1C__SCALAR, c_eq_1_k_lt_9) {
  for (uint32_t channels = 2; channels < 10; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(1)
...
TEST(QS8_DWCONV_MINMAX_RNDNU_9P2C__SCALAR, c_eq_2_k_lt_9) {
  for (uint32_t channels = 3; channels < 4; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(2)
...
TEST(QS8_DWCONV_MINMAX_RNDNU_9P4C__SCALAR, c_eq_4_k_lt_9) {
  for (uint32_t channels = 5; channels < 8; channels++) {
    for (size_t kernel_size = 1; kernel_size < 9; kernel_size++) {
      DWConvMicrokernelTester()
        .cr(4)

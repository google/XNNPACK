...
TEST(QS8_RSUM_MINMAX_FP32__SCALAR_IMAGIC_U4, overflow_accumulator) {
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16, batch_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u16, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16, batch_div_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16, batch_lt_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16, batch_gt_16) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(17)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(2048)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u16, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32, batch_eq_32) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u32, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32, batch_div_32) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32, batch_lt_32) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32, batch_gt_32) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(33)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(4096)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u32, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u64, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64, batch_div_64) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(65)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(8192)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u64, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16_ACC2, batch_eq_16) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u16_acc2, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16_ACC2, batch_div_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16_ACC2, batch_lt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16_ACC2, batch_gt_16) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16_ACC2, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(17)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U16_ACC2, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(2048)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u16_acc2, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC2, batch_eq_32) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u32_acc2, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC2, batch_div_32) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC2, batch_lt_32) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC2, batch_gt_32) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC2, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(33)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC2, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(4096)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u32_acc2, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC2, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u64_acc2, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC2, batch_div_64) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC2, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC2, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC2, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(65)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC2, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(8192)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u64_acc2, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC4, batch_eq_32) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u32_acc4, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC4, batch_div_32) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC4, batch_lt_32) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC4, batch_gt_32) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC4, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(33)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U32_ACC4, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(4096)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u32_acc4, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC4, batch_eq_64) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u64_acc4, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);
  }

  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC4, batch_div_64) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC4, batch_lt_64) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC4, batch_gt_64) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC4, scale) {
    TEST_REQUIRES_ARM_NEON;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(65)
  ...
  TEST(QS8_RSUM_MINMAX_FP32__NEON_ADDW_U64_ACC4, overflow_accumulator) {
    TEST_REQUIRES_ARM_NEON;
    RSumMicrokernelTester()
      .batch_size(8192)
      .Test(xnn_qs8_rsum_minmax_fp32_ukernel__neon_addw_u64_acc4, xnn_init_qs8_avgpool_minmax_fp32_neon_params, xnn_qs8_requantize_fp32);

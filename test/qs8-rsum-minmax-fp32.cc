...
TEST(QS8_RSUM__SCALAR_U4, overflow_accumulator) {
  ...
  TEST(QS8_RSUM__SSSE3_U32, batch_eq_32) {
    ...
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs8_rsum_ukernel__ssse3_u32, xnn_init_qs8_rsum_ssse3_params);
  }
  ...
  TEST(QS8_RSUM__SSSE3_U64, batch_eq_64) {
    ...
    RSumMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs8_rsum_ukernel__ssse3_u64, xnn_init_qs8_rsum_ssse3_params);
  }
  ...
  TEST(QS8_RSUM__SSSE3_U64_ACC2, batch_eq_64) {
    ...
    RSumMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs8_rsum_ukernel__ssse3_u64_acc2, xnn_init_qs8_rsum_ssse3_params);
  }

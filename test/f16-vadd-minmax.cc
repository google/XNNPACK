...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F16_VADD_MINMAX__NEONFP16ARITH_X8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f16_vadd_minmax_ukernel__neonfp16arith_x8, VBinaryMicrokernelTester::OpType::Add);
  }
  ...
  TEST(F16_VADD_MINMAX__NEONFP16ARITH_X16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f16_vadd_minmax_ukernel__neonfp16arith_x16, VBinaryMicrokernelTester::OpType::Add);
  }

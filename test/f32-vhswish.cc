...
#include "vhswish-microkernel-tester.h"
  ...
  TEST(F32_VHSWISH__NEON_X4, batch_eq_4) {
    ...
    HSwishMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vhswish_ukernel__neon_x4);
  }
  ...
  TEST(F32_VHSWISH__NEON_X8, batch_eq_8) {
    ...
    HSwishMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vhswish_ukernel__neon_x8);
  }
  ...
  TEST(F32_VHSWISH__NEON_X16, batch_eq_16) {
    ...
    HSwishMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vhswish_ukernel__neon_x16);
  }
  ...
  TEST(F32_VHSWISH__SSE_X4, batch_eq_4) {
    ...
    HSwishMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vhswish_ukernel__sse_x4);
  }
  ...
  TEST(F32_VHSWISH__SSE_X8, batch_eq_8) {
    ...
    HSwishMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vhswish_ukernel__sse_x8);
  }
  ...
  TEST(F32_VHSWISH__AVX_X8, batch_eq_8) {
    ...
    HSwishMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vhswish_ukernel__avx_x8);
  }
  ...
  TEST(F32_VHSWISH__AVX_X16, batch_eq_16) {
    ...
    HSwishMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vhswish_ukernel__avx_x16);
  }
  ...
  TEST(F32_VHSWISH__FMA3_X8, batch_eq_8) {
    ...
    HSwishMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vhswish_ukernel__fma3_x8);
  }
  ...
  TEST(F32_VHSWISH__FMA3_X16, batch_eq_16) {
    ...
    HSwishMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vhswish_ukernel__fma3_x16);
  }
  ...
  TEST(F32_VHSWISH__AVX512F_X16, batch_eq_16) {
    ...
    HSwishMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vhswish_ukernel__avx512f_x16);
  }
  ...
  TEST(F32_VHSWISH__AVX512F_X32, batch_eq_32) {
    ...
    HSwishMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vhswish_ukernel__avx512f_x32);
  }
  ...
  TEST(F32_VHSWISH__WASMSIMD_X4, batch_eq_4) {
    HSwishMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vhswish_ukernel__wasmsimd_x4);
  }
  ...
  TEST(F32_VHSWISH__WASMSIMD_X8, batch_eq_8) {
    HSwishMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vhswish_ukernel__wasmsimd_x8);
  }
  ...
  TEST(F32_VHSWISH__WASMSIMD_X16, batch_eq_16) {
    HSwishMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vhswish_ukernel__wasmsimd_x16);
  }
  ...
  TEST(F32_VHSWISH__WASM_X1, batch_eq_1) {
    HSwishMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vhswish_ukernel__wasm_x1);
  }
  ...
  TEST(F32_VHSWISH__WASM_X2, batch_eq_2) {
    HSwishMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vhswish_ukernel__wasm_x2);
  }
  ...
  TEST(F32_VHSWISH__WASM_X4, batch_eq_4) {
    HSwishMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vhswish_ukernel__wasm_x4);
  }
...
TEST(F32_VHSWISH__SCALAR_X1, batch_eq_1) {
  HSwishMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vhswish_ukernel__scalar_x1, HSwishMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VHSWISH__SCALAR_X2, batch_eq_2) {
  HSwishMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vhswish_ukernel__scalar_x2, HSwishMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VHSWISH__SCALAR_X4, batch_eq_4) {
  HSwishMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vhswish_ukernel__scalar_x4, HSwishMicrokernelTester::Variant::Scalar);
}

...
#include "vunary-microkernel-tester.h"
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U40, batch_eq_40) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(40)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u40, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U40, batch_div_40) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U40, batch_lt_40) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U40, batch_gt_40) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U40, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U48, batch_eq_48) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u48, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U48, batch_div_48) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U48, batch_lt_48) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U48, batch_gt_48) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U48, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U56, batch_eq_56) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(56)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u56, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U56, batch_div_56) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U56, batch_lt_56) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U56, batch_gt_56) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U56, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U64, batch_eq_64) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u64, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U64, batch_div_64) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U64, batch_lt_64) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U64, batch_gt_64) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U64, inplace) {
    TEST_REQUIRES_X86_SSE;

...
#include "argmaxpool-microkernel-tester.h"
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_eq_4_unipass_fulltile_with_qmin) {
    ArgMaxPoolMicrokernelTester()
      .pooling_elements(4)
      .pooling_tile(4)
      .channels(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_eq_4_unipass_fulltile_with_qmax) {
    ArgMaxPoolMicrokernelTester()
      .pooling_elements(4)
      .pooling_tile(4)
      .channels(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_div_4_unipass_fulltile_with_qmin) {
    for (size_t channels = 8; channels < 32; channels += 4) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(4)
        .pooling_tile(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_div_4_unipass_fulltile_with_qmax) {
    for (size_t channels = 8; channels < 32; channels += 4) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(4)
        .pooling_tile(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_lt_4_unipass_fulltile_with_qmin) {
    for (size_t channels = 1; channels < 4; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(4)
        .pooling_tile(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_lt_4_unipass_fulltile_with_qmax) {
    for (size_t channels = 1; channels < 4; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(4)
        .pooling_tile(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_gt_4_unipass_fulltile_with_qmin) {
    for (size_t channels = 5; channels < 8; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(4)
        .pooling_tile(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, channels_gt_4_unipass_fulltile_with_qmax) {
    for (size_t channels = 5; channels < 8; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(4)
        .pooling_tile(4)
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, few_output_pixels_with_qmin) {
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements = 2; pooling_elements <= 4; pooling_elements++) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
          ArgMaxPoolMicrokernelTester()
  ...
  TEST(F32_ARGMAXPOOL_4X__WASMSIMD_C4, few_output_pixels_with_qmax) {
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements = 2; pooling_elements <= 4; pooling_elements++) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
          ArgMaxPoolMicrokernelTester()
...
TEST(F32_ARGMAXPOOL_4X__SCALAR_C1, few_output_pixels_with_step) {
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_eq_4_unipass_fulltile_with_qmin) {
    ArgMaxPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9)
      .channels(4)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_eq_4_unipass_fulltile_with_qmax) {
    ArgMaxPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9)
      .channels(4)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_div_4_unipass_fulltile_with_qmin) {
    for (size_t channels = 8; channels < 32; channels += 4) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(9)
        .pooling_tile(9)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_div_4_unipass_fulltile_with_qmax) {
    for (size_t channels = 8; channels < 32; channels += 4) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(9)
        .pooling_tile(9)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_lt_4_unipass_fulltile_with_qmin) {
    for (size_t channels = 1; channels < 4; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(9)
        .pooling_tile(9)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_lt_4_unipass_fulltile_with_qmax) {
    for (size_t channels = 1; channels < 4; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(9)
        .pooling_tile(9)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_gt_4_unipass_fulltile_with_qmin) {
    for (size_t channels = 5; channels < 8; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(9)
        .pooling_tile(9)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, channels_gt_4_unipass_fulltile_with_qmax) {
    for (size_t channels = 5; channels < 8; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(9)
        .pooling_tile(9)
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, few_output_pixels_with_qmin) {
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements = 2; pooling_elements <= 9; pooling_elements++) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
          ArgMaxPoolMicrokernelTester()
  ...
  TEST(F32_ARGMAXPOOL_9X__WASMSIMD_C4, few_output_pixels_with_qmax) {
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements = 2; pooling_elements <= 9; pooling_elements++) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
          ArgMaxPoolMicrokernelTester()
...
TEST(F32_ARGMAXPOOL_9X__SCALAR_C1, few_output_pixels_with_step) {
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_eq_4_twopass_fulltile_with_qmin) {
    ArgMaxPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
      .channels(4)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_eq_4_twopass_fulltile_with_qmax) {
    ArgMaxPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
      .channels(4)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_div_4_twopass_fulltile_with_qmin) {
    for (size_t channels = 8; channels < 32; channels += 4) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_div_4_twopass_fulltile_with_qmax) {
    for (size_t channels = 8; channels < 32; channels += 4) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_lt_4_twopass_fulltile_with_qmin) {
    for (size_t channels = 1; channels < 4; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_lt_4_twopass_fulltile_with_qmax) {
    for (size_t channels = 1; channels < 4; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_gt_4_twopass_fulltile_with_qmin) {
    for (size_t channels = 5; channels < 8; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_gt_4_twopass_fulltile_with_qmax) {
    for (size_t channels = 5; channels < 8; channels++) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_eq_4_multipass_with_qmin) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_eq_4_multipass_with_qmax) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      ArgMaxPoolMicrokernelTester()
        .pooling_elements(17)
        .pooling_tile(9, 8)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_div_4_multipass_with_qmin) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        ArgMaxPoolMicrokernelTester()
          .pooling_elements(17)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_div_4_multipass_with_qmax) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        ArgMaxPoolMicrokernelTester()
          .pooling_elements(17)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_lt_4_multipass_with_qmin) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        ArgMaxPoolMicrokernelTester()
          .pooling_elements(17)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_lt_4_multipass_with_qmax) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        ArgMaxPoolMicrokernelTester()
          .pooling_elements(17)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_gt_4_multipass_with_qmin) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        ArgMaxPoolMicrokernelTester()
          .pooling_elements(17)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, channels_gt_4_multipass_with_qmax) {
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        ArgMaxPoolMicrokernelTester()
          .pooling_elements(17)
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, few_output_pixels_with_qmin) {
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements = 10; pooling_elements <= 17; pooling_elements++) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
          ArgMaxPoolMicrokernelTester()
  ...
  TEST(F32_ARGMAXPOOL_9P8X__WASMSIMD_C4, few_output_pixels_with_qmax) {
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements = 10; pooling_elements <= 17; pooling_elements++) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
          ArgMaxPoolMicrokernelTester()

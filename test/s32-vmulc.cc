...
TEST(S32_VMULC__SCALAR_U1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__scalar_u1, VBinaryMicrokernelTester::OpType::Mul);
}
...
TEST(S32_VMULC__SCALAR_U2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__scalar_u2, VBinaryMicrokernelTester::OpType::Mul);
}
...
TEST(S32_VMULC__SCALAR_U4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__scalar_u4, VBinaryMicrokernelTester::OpType::Mul);
}
...
TEST(S32_VMULC__SCALAR_U8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__scalar_u8, VBinaryMicrokernelTester::OpType::Mul);
}
...
TEST(S32_VMULC__SCALAR_U8, inplace) {
  ...
  TEST(S32_VMULC__SSE41_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__sse41_u4, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__SSE41_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__sse41_u8, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__SSE41_U12, batch_eq_12) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(12)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__sse41_u12, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__SSE41_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__sse41_u16, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX2_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx2_u8, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX2_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx2_u16, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX2_U24, batch_eq_24) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(24)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx2_u24, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX2_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx2_u32, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX512F_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx512f_u16, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX512F_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx512f_u32, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX512F_U48, batch_eq_48) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(48)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx512f_u48, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__AVX512F_U64, batch_eq_64) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(64)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__avx512f_u64, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__WASMSIMD_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__wasmsimd_u4, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__WASMSIMD_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__wasmsimd_u8, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__WASMSIMD_U12, batch_eq_12) {
    VBinaryMicrokernelTester()
      .batch_size(12)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__wasmsimd_u12, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__WASMSIMD_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__wasmsimd_u16, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__NEON_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__neon_u4, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__NEON_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__neon_u8, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__NEON_U12, batch_eq_12) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(12)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__neon_u12, VBinaryMicrokernelTester::OpType::Mul);
  }
  ...
  TEST(S32_VMULC__NEON_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_s32_vmulc_ukernel__neon_u16, VBinaryMicrokernelTester::OpType::Mul);
  }

...
#include <gtest/gtest.h>
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__RVV_C1V, channels_lt_1v_twopass_fulltile_with_zero_index) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 1; channels < (1*xnn_init_hardware_config()->vlenb/sizeof(float)); channels++) {
      for (size_t zero_index = 0; zero_index < 17; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__RVV_C2V, channels_lt_2v_twopass_fulltile_with_zero_index) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 1; channels < (2*xnn_init_hardware_config()->vlenb/sizeof(float)); channels++) {
      for (size_t zero_index = 0; zero_index < 17; zero_index++) {
        AvgPoolMicrokernelTester()

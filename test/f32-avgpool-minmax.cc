...
#include "avgpool-microkernel-tester.h"
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__NEON_C4, channels_eq_4_twopass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__neon_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__SSE_C4, channels_eq_4_twopass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__sse_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__psimd_c4, AvgPoolMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t zero_index = 0; zero_index < 17; zero_index++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(17)
      .pooling_tile(9, 8)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_twopass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      for (size_t zero_index = 0; zero_index < 17; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_twopass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_zero_index) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      for (size_t zero_index = 0; zero_index < 17; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_twopass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      for (size_t zero_index = 0; zero_index < 17; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(17)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_twopass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 10; pooling_elements < 17; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_eq_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_div_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_lt_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, channels_gt_4_multipass_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 18; pooling_elements <= 33; pooling_elements += 3) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_output_stride) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__PSIMD_C4, few_output_pixels_with_step) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{10, 16, 18}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__WASMSIMD_ARM_C4, channels_eq_4_twopass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__wasmsimd_arm_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__WASMSIMD_X86_C4, channels_eq_4_twopass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__wasmsimd_x86_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__WASM_C1, channels_eq_1_twopass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(1)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__wasm_c1);
  }
...
TEST(F32_AVGPOOL_MINMAX_9P8X__SCALAR_C1, channels_eq_1_twopass_fulltile) {
  AvgPoolMicrokernelTester()
    ...
    .pooling_tile(9, 8)
    .channels(1)
    .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__scalar_c1, AvgPoolMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_AVGPOOL_MINMAX_9P8X__SCALAR_C1, few_output_pixels_with_step) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__NEON_C4, channels_eq_4_unipass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__neon_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__SSE_C4, channels_eq_4_unipass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__sse_c4);
  }
...
#if !XNN_ARCH_ASMJS && !XNN_ARCH_WASM && !XNN_COMPILER_MSVC && !XNN_COMPILER_ICC
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__psimd_c4, AvgPoolMicrokernelTester::Variant::Scalar);
  }

  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t zero_index = 0; zero_index < 9; zero_index++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    AvgPoolMicrokernelTester()
      .pooling_elements(9)
      .pooling_tile(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(pooling_elements)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_eq_4_unipass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      for (size_t zero_index = 0; zero_index < 9; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 8; channels < 32; channels += 4) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_div_4_unipass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 8; channels < 32; channels += 4) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      for (size_t zero_index = 0; zero_index < 9; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 1; channels < 4; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_lt_4_unipass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 1; channels < 4; channels++) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_fulltile) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      for (size_t zero_index = 0; zero_index < 9; zero_index++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_fulltile_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t channels = 5; channels < 8; channels++) {
      AvgPoolMicrokernelTester()
        .pooling_elements(9)
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_subtile) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_subtile_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        AvgPoolMicrokernelTester()
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, channels_gt_4_unipass_subtile_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t pooling_elements = 2; pooling_elements < 9; pooling_elements++) {
      for (size_t channels = 5; channels < 8; channels++) {
        for (size_t zero_index = 0; zero_index < pooling_elements; zero_index++) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels_with_input_offset) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels_with_zero) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels_with_qmin) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels_with_qmax) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels_with_output_stride) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__PSIMD_C4, few_output_pixels_with_step) {
    TEST_REQUIRES_PSIMD;
    for (size_t output_pixels = 2; output_pixels <= 5; output_pixels++) {
      for (size_t pooling_elements : std::vector<size_t>{{2, 8, 9}}) {
        for (size_t channels = 1; channels <= 20; channels += 3) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__WASMSIMD_ARM_C4, channels_eq_4_unipass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__wasmsimd_arm_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__WASMSIMD_X86_C4, channels_eq_4_unipass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__wasmsimd_x86_c4);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__WASM_C1, channels_eq_1_unipass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(1)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__wasm_c1);
  }
...
TEST(F32_AVGPOOL_MINMAX_9X__SCALAR_C1, channels_eq_1_unipass_fulltile) {
  AvgPoolMicrokernelTester()
    ...
    .pooling_tile(9)
    .channels(1)
    .Test(xnn_f32_avgpool_minmax_ukernel_9x__scalar_c1, AvgPoolMicrokernelTester::Variant::Scalar);
}

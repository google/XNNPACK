...
#include "avgpool-microkernel-tester.h"
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__NEON_C4, channels_eq_4_twopass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__neon_c4, xnn_init_f32_scaleminmax_params);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__SSE_C4, channels_eq_4_twopass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__sse_c4, xnn_init_f32_scaleminmax_params);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__WASMSIMD_ARM_C4, channels_eq_4_twopass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__wasmsimd_arm_c4, xnn_init_f32_scaleminmax_params);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9P8X__WASMSIMD_X86_C4, channels_eq_4_twopass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9, 8)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9p8x__wasmsimd_x86_c4, xnn_init_f32_scaleminmax_params);
  }
...
TEST(F32_AVGPOOL_MINMAX_9P8X__SCALAR_C1, few_output_pixels_with_step) {
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__NEON_C4, channels_eq_4_unipass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__neon_c4, xnn_init_f32_scaleminmax_params);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__SSE_C4, channels_eq_4_unipass_fulltile) {
    ...
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__sse_c4, xnn_init_f32_scaleminmax_params);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__WASMSIMD_ARM_C4, channels_eq_4_unipass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__wasmsimd_arm_c4, xnn_init_f32_scaleminmax_params);
  }
  ...
  TEST(F32_AVGPOOL_MINMAX_9X__WASMSIMD_X86_C4, channels_eq_4_unipass_fulltile) {
    AvgPoolMicrokernelTester()
      ...
      .pooling_tile(9)
      .channels(4)
      .Test(xnn_f32_avgpool_minmax_ukernel_9x__wasmsimd_x86_c4, xnn_init_f32_scaleminmax_params);
  }

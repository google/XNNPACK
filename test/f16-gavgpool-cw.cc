...
#include "gavgpool-cw-microkernel-tester.h"
  ...
  TEST(F16_GAVGPOOL_CW__NEONFP16ARITH_U8, channels_eq_8) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
    GAvgPoolCWMicrokernelTester()
      .elements(8)
      .channels(8)
  ...
  TEST(F16_GAVGPOOL_CW__NEONFP16ARITH_U8, channels_lt_4) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_GAVGPOOL_CW__NEONFP16ARITH_U8, channels_gt_4) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;
  ...
  TEST(F16_GAVGPOOL_CW__NEONFP16ARITH_U8, channels_div_4) {
    TEST_REQUIRES_ARM_NEON_FP16_ARITH;

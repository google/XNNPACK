...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VMAXC__NEON_X4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmaxc_ukernel__neon_x4, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__NEON_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmaxc_ukernel__neon_x8, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__SSE_X4, batch_eq_4) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmaxc_ukernel__sse_x4, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__SSE_X8, batch_eq_8) {
    ...
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmaxc_ukernel__sse_x8, VBinaryCMicrokernelTester::OpType::MaxC);
  }
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VMAXC__AVX_X8, batch_eq_8) {
    TEST_REQUIRES_X86_AVX;
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmaxc_ukernel__avx_x8, VBinaryCMicrokernelTester::OpType::MaxC);
  }

  TEST(F32_VMAXC__AVX_X8, batch_div_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VMAXC__AVX_X8, batch_lt_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VMAXC__AVX_X8, batch_gt_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VMAXC__AVX_X8, inplace) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VMAXC__AVX_X16, batch_eq_16) {
    TEST_REQUIRES_X86_AVX;
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vmaxc_ukernel__avx_x16, VBinaryCMicrokernelTester::OpType::MaxC);
  }

  TEST(F32_VMAXC__AVX_X16, batch_div_16) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VMAXC__AVX_X16, batch_lt_16) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VMAXC__AVX_X16, batch_gt_16) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VMAXC__AVX_X16, inplace) {
    TEST_REQUIRES_X86_AVX;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VMAXC__AVX512F_X16, batch_eq_16) {
    TEST_REQUIRES_X86_AVX512F;
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vmaxc_ukernel__avx512f_x16, VBinaryCMicrokernelTester::OpType::MaxC);
  }

  TEST(F32_VMAXC__AVX512F_X16, batch_div_16) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VMAXC__AVX512F_X16, batch_lt_16) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VMAXC__AVX512F_X16, batch_gt_16) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VMAXC__AVX512F_X16, inplace) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinaryCMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VMAXC__AVX512F_X32, batch_eq_32) {
    TEST_REQUIRES_X86_AVX512F;
    VBinaryCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vmaxc_ukernel__avx512f_x32, VBinaryCMicrokernelTester::OpType::MaxC);
  }

  TEST(F32_VMAXC__AVX512F_X32, batch_div_32) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VMAXC__AVX512F_X32, batch_lt_32) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VMAXC__AVX512F_X32, batch_gt_32) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VMAXC__AVX512F_X32, inplace) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VMAXC__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmaxc_ukernel__wasmsimd_arm_x4, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmaxc_ukernel__wasmsimd_arm_x8, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_ARM_X16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vmaxc_ukernel__wasmsimd_arm_x16, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_X86_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmaxc_ukernel__wasmsimd_x86_x4, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_X86_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmaxc_ukernel__wasmsimd_x86_x8, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_X86_X16, batch_eq_16) {
    VBinaryCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vmaxc_ukernel__wasmsimd_x86_x16, VBinaryCMicrokernelTester::OpType::MaxC);
  }
  ...
  TEST(F32_VMAXC__WASM_X1, batch_eq_1) {
    VBinaryCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vmaxc_ukernel__wasm_x1, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMAXC__WASM_X2, batch_eq_2) {
    VBinaryCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vmaxc_ukernel__wasm_x2, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMAXC__WASM_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vmaxc_ukernel__wasm_x4, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
  ...
  TEST(F32_VMAXC__WASM_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmaxc_ukernel__wasm_x8, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
  }
...
TEST(F32_VMAXC__SCALAR_X1, batch_eq_1) {
  VBinaryCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vmaxc_ukernel__scalar_x1, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VMAXC__SCALAR_X2, batch_eq_2) {
  VBinaryCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vmaxc_ukernel__scalar_x2, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VMAXC__SCALAR_X4, batch_eq_4) {
  VBinaryCMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vmaxc_ukernel__scalar_x4, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VMAXC__SCALAR_X8, batch_eq_8) {
  VBinaryCMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vmaxc_ukernel__scalar_x8, VBinaryCMicrokernelTester::OpType::MaxC, VBinaryCMicrokernelTester::Variant::Scalar);
}

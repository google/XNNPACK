...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VMAXC__NEON_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__neon_u4, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__NEON_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__neon_u8, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__RVV_U4V, batch_eq_4v) {
    ...
    VBinaryMicrokernelTester()
      ...
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__rvv_u4v, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__RVV_U8V, batch_eq_8v) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__rvv_u8v, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__SSE_U4, batch_eq_4) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__sse_u4, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__SSE_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__sse_u8, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__AVX_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__avx_u8, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__AVX_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__avx_u16, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__AVX512F_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__avx512f_u16, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__AVX512F_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__avx512f_u32, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_ARM_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasmsimd_arm_u4, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_ARM_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasmsimd_arm_u8, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_ARM_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasmsimd_arm_u16, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_X86_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasmsimd_x86_u4, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_X86_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasmsimd_x86_u8, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASMSIMD_X86_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasmsimd_x86_u16, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASM_U1, batch_eq_1) {
    VBinaryMicrokernelTester()
      .batch_size(1)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasm_u1, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASM_U2, batch_eq_2) {
    VBinaryMicrokernelTester()
      .batch_size(2)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasm_u2, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASM_U4, batch_eq_4) {
    VBinaryMicrokernelTester()
      .batch_size(4)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasm_u4, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__WASM_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__wasm_u8, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__HVX_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__hvx_u32, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__HVX_U64, batch_eq_64) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(64)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__hvx_u64, VBinaryMicrokernelTester::OpType::Max);
  }
  ...
  TEST(F32_VMAXC__HVX_U128, batch_eq_128) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(128)
      .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__hvx_u128, VBinaryMicrokernelTester::OpType::Max);
  }
...
TEST(F32_VMAXC__SCALAR_U1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__scalar_u1, VBinaryMicrokernelTester::OpType::Max);
}
...
TEST(F32_VMAXC__SCALAR_U2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__scalar_u2, VBinaryMicrokernelTester::OpType::Max);
}
...
TEST(F32_VMAXC__SCALAR_U4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__scalar_u4, VBinaryMicrokernelTester::OpType::Max);
}
...
TEST(F32_VMAXC__SCALAR_U8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .broadcast_b(true).Test(xnn_f32_vmaxc_ukernel__scalar_u8, VBinaryMicrokernelTester::OpType::Max);
}

...
template <typename T>
class EvenSplit3Test : public ::testing::Test {
 protected:
  EvenSplit3Test() {
    ...
    input_dims[axis] =
        output1_dims[axis] + output2_dims[axis] + output3_dims[axis];
...
using EvenSplit3TestF16 = EvenSplit3Test<xnn_float16>;
...
TEST_F(EvenSplit3TestQS8, define) {
  ...
  ASSERT_EQ(xnn_status_success,
            xnn_define_even_split3(subgraph, axis, input_id, output1_id,
                                   output2_id, output3_id, /*flags=*/0));

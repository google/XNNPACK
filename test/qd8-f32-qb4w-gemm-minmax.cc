...
INSTANTIATE_TEST_SUITE_P(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QB4W_GEMM_MINMAX_1X8C8__AVX512SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          /*mr=*/1, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qb4w_gemm_minmax_ukernel_1x8c8__avx512skx,
                        xnn_init_f32_qb4w_minmax_avx_params,
                        xnn_pack_qs8_qb4w_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QB4W_GEMM_MINMAX_5X8C8__AVX512SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          /*mr=*/5, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qb4w_gemm_minmax_ukernel_5x8c8__avx512skx,
                        xnn_init_f32_qb4w_minmax_avx_params,
                        xnn_pack_qs8_qb4w_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QB4W_GEMM_MINMAX_7X8C8__AVX512SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          /*mr=*/7, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qb4w_gemm_minmax_ukernel_7x8c8__avx512skx,
                        xnn_init_f32_qb4w_minmax_avx_params,
                        xnn_pack_qs8_qb4w_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QB4W_GEMM_MINMAX_8X8C8__AVX512SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          /*mr=*/8, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qb4w_gemm_minmax_ukernel_8x8c8__avx512skx,
                        xnn_init_f32_qb4w_minmax_avx_params,
                        xnn_pack_qs8_qb4w_gemm_goi_w);
          },
          []() {

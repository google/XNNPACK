...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      ...
      testing::ValuesIn(CreateTests1(
        ...
        if (hardware_config != nullptr && (hardware_config->arch_flags & xnn_arch_arm_sme2) == xnn_arch_arm_sme2) {
          return xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme2_get_mr();
        } else {
          return 0;
        }
      }
  , /*nr=*/[]() -> size_t {
        const struct xnn_hardware_config* hardware_config =
              xnn_init_hardware_config();
        if (hardware_config != nullptr && (hardware_config->arch_flags & xnn_arch_arm_sme2) == xnn_arch_arm_sme2) {
          return xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme2_get_nr();
        } else {
          return 0;
        }
      }
  ...
  #if XNN_ENABLE_KLEIDIAI
  INSTANTIATE_TEST_SUITE_P(
      QP8_F32_QC8W_GEMM_MINMAX_1X64C4__NEONSME, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/[]() -> size_t {
  ...
  ,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_kai_qs8_weights_and_biases,
                        xnn_packed_stride_kai_qs8_weights_and_biases);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QP8_F32_QC8W_GEMM_MINMAX_16X64C4__NEONSME, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/[]() -> size_t {
  ...
  ,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_kai_qs8_weights_and_biases,
                        xnn_packed_stride_kai_qs8_weights_and_biases);
          },

...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      ...
      testing::ValuesIn(CreateTests1(
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x4c4__aarch64_neondot,
  ...
  INSTANTIATE_TEST_SUITE_P(
      ...
      testing::ValuesIn(CreateTests1(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x4c8__aarch64_neondot,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_kai_qs8_weights_and_biases,
                        xnn_packed_stride_kai_qs8_weights_and_biases);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      ...
      testing::ValuesIn(CreateTests1(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x4c4__aarch64_neondot_mstep4,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_kai_qs8_weights_and_biases,
                        xnn_packed_stride_kai_qs8_weights_and_biases);
          },
  ...
  #if XNN_ENABLE_KLEIDIAI
  INSTANTIATE_TEST_SUITE_P(
      QP8_F32_QC8W_GEMM_MINMAX_1X64C4__NEONSME2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme2_get_mr(), /*nr=*/xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme2_get_nr(), /*kr=*/4, /*sr=*/1,
          /*mr_packed=*/xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme2_get_mr(),
          /*is_igemm=*/false,
          /*unsigned_inputs=*/false,
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_1x64c4__neonsme2,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_kai_qs8_weights_and_biases,
                        xnn_packed_stride_kai_qs8_weights_and_biases);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QP8_F32_QC8W_GEMM_MINMAX_16X64C4__NEONSME2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme2_get_mr(), /*nr=*/xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme2_get_nr(), /*kr=*/4, /*sr=*/1,
          /*mr_packed=*/xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme2_get_mr(),
          /*is_igemm=*/false,
          /*unsigned_inputs=*/false,
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test_QP8F32QC8W(xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme2,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_kai_qs8_weights_and_biases,
                        xnn_packed_stride_kai_qs8_weights_and_biases);
          },

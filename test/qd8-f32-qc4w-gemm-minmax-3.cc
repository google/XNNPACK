...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC4W_GEMM_MINMAX_7X8C4__ASM_AARCH64_NEONDOT_LD32_2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/4,
          /*adj_k_block=*/4,
          /*mr=*/7, /*nr=*/8, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc4w_gemm_minmax_ukernel_7x8c4__asm_aarch64_neondot_ld32_2,
                        xnn_init_f32_qc4w_minmax_scalar_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w_non_planar_aarch64);
          },
          xnn_arch_arm_neon_dot)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC4W_GEMM_MINMAX_7X8C4__ASM_AARCH64_NEONDOT_LD64_2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/7, /*nr=*/8, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc4w_gemm_minmax_ukernel_7x8c4__asm_aarch64_neondot_ld64_2,
                        xnn_init_f32_qc4w_minmax_scalar_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w_non_planar_aarch64);
          },
          xnn_arch_arm_neon_dot)),

...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VMINC__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vminc_ukernel__wasmsimd_arm_x4, VBinOpCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vminc_ukernel__wasmsimd_arm_x8, VBinOpCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASMSIMD_X86_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vminc_ukernel__wasmsimd_x86_x4, VBinOpCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASMSIMD_X86_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vminc_ukernel__wasmsimd_x86_x8, VBinOpCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASM_X1, batch_eq_1) {
    VBinOpCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vminc_ukernel__wasm_x1, VBinOpCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASM_X2, batch_eq_2) {
    VBinOpCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vminc_ukernel__wasm_x2, VBinOpCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vminc_ukernel__wasm_x4, VBinOpCMicrokernelTester::OpType::MinC);
  }

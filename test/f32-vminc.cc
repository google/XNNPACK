...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VMINC__WASM_X1, batch_eq_1) {
    VBinaryCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vminc_ukernel__wasm_x1, VBinaryCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASM_X2, batch_eq_2) {
    VBinaryCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vminc_ukernel__wasm_x2, VBinaryCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASM_X4, batch_eq_4) {
    VBinaryCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vminc_ukernel__wasm_x4, VBinaryCMicrokernelTester::OpType::MinC);
  }
  ...
  TEST(F32_VMINC__WASM_X8, batch_eq_8) {
    VBinaryCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vminc_ukernel__wasm_x8, VBinaryCMicrokernelTester::OpType::MinC);
  }

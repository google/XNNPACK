...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(F32_VADD__WASMSIMD_X4, batch_div_4) {
  ...
  TEST(F32_VADD__WASMSIMD_X4, batch_lt_4) {
  ...
  TEST(F32_VADD__WASMSIMD_X4, batch_gt_4) {
  ...
  TEST(F32_VADD__WASMSIMD_X4, inplace_a) {
  ...
  TEST(F32_VADD__WASMSIMD_X4, inplace_b) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_b(true)
  ...
  TEST(F32_VADD__WASMSIMD_X4, inplace_a_and_b) {
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
  ...
  TEST(F32_VADD__WASMSIMD_X8, batch_div_8) {
  ...
  TEST(F32_VADD__WASMSIMD_X8, batch_lt_8) {
  ...
  TEST(F32_VADD__WASMSIMD_X8, batch_gt_8) {
  ...
  TEST(F32_VADD__WASMSIMD_X8, inplace_a) {
  ...
  TEST(F32_VADD__WASMSIMD_X8, inplace_b) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_b(true)
  ...
  TEST(F32_VADD__WASMSIMD_X8, inplace_a_and_b) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
...
TEST(F32_VADD__SCALAR_X1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vadd_ukernel__scalar_x1, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VADD__SCALAR_X2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vadd_ukernel__scalar_x2, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VADD__SCALAR_X4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vadd_ukernel__scalar_x4, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VADD__SCALAR_X8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vadd_ukernel__scalar_x8, VBinaryMicrokernelTester::OpType::Add, VBinaryMicrokernelTester::Variant::Scalar);
}

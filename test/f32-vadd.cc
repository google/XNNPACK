...
TEST(F32_VADD__SCALAR_X1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vadd_ukernel__scalar_x1, VBinaryMicrokernelTester::OpType::Add);
}
...
TEST(F32_VADD__SCALAR_X2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vadd_ukernel__scalar_x2, VBinaryMicrokernelTester::OpType::Add);
}
...
TEST(F32_VADD__SCALAR_X4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vadd_ukernel__scalar_x4, VBinaryMicrokernelTester::OpType::Add);
}
...
TEST(F32_VADD__SCALAR_X8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .Test(xnn_f32_vadd_ukernel__scalar_x8, VBinaryMicrokernelTester::OpType::Add);
}

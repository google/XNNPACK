...
#include "vbinary-microkernel-tester.h"
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VADD__AVX_X8, batch_eq_8) {
    TEST_REQUIRES_X86_AVX;
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vadd_ukernel__avx_x8, VBinOpMicrokernelTester::OpType::Add);
  }

  TEST(F32_VADD__AVX_X8, batch_div_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX_X8, batch_lt_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX_X8, batch_gt_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX_X8, inplace_a) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX_X8, inplace_b) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX_X8, inplace_a_and_b) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VADD__AVX_X16, batch_eq_16) {
    TEST_REQUIRES_X86_AVX;
    VBinOpMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vadd_ukernel__avx_x16, VBinOpMicrokernelTester::OpType::Add);
  }

  TEST(F32_VADD__AVX_X16, batch_div_16) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VADD__AVX_X16, batch_lt_16) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VADD__AVX_X16, batch_gt_16) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VADD__AVX_X16, inplace_a) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VADD__AVX_X16, inplace_b) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX_X16, inplace_a_and_b) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VADD__AVX512F_X16, batch_eq_16) {
    TEST_REQUIRES_X86_AVX512F;
    VBinOpMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vadd_ukernel__avx512f_x16, VBinOpMicrokernelTester::OpType::Add);
  }

  TEST(F32_VADD__AVX512F_X16, batch_div_16) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, batch_lt_16) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, batch_gt_16) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, inplace_a) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, inplace_b) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, inplace_a_and_b) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, qmin) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X16, qmax) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VADD__AVX512F_X32, batch_eq_32) {
    TEST_REQUIRES_X86_AVX512F;
    VBinOpMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vadd_ukernel__avx512f_x32, VBinOpMicrokernelTester::OpType::Add);
  }

  TEST(F32_VADD__AVX512F_X32, batch_div_32) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VADD__AVX512F_X32, batch_lt_32) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VADD__AVX512F_X32, batch_gt_32) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VADD__AVX512F_X32, inplace_a) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VADD__AVX512F_X32, inplace_b) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X32, inplace_a_and_b) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X32, qmin) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VADD__AVX512F_X32, qmax) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 160; batch_size += 31) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)

...
PROD_FMA3_ASM_MICROKERNEL_SRCS = [
]

NON_PROD_FMA3_ASM_MICROKERNEL_SRCS = [
    "src/f32-gemm/gen/f32-gemm-4x8-minmax-asm-fma3-broadcast.S",
]

FMA3_ASM_MICROKERNEL_SRCS = PROD_FMA3_ASM_MICROKERNEL_SRCS + NON_PROD_FMA3_ASM_MICROKERNEL_SRCS

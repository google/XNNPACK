...
PROD_AVX2_MICROKERNEL_SRCS = [
    ...
    "src/f16-maxpool/gen/f16-maxpool-9p-minmax-avx2-u16.c",
    ...
    "src/qd8-f16-qc2w-gemm/gen/qd8-f16-qc2w-gemm-8x8c8-minmax-avx2-madd.c",
    ...
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-8x8c8-minmax-avx2-madd.c",
    ...
    "src/qs8-packw/gen/qs8-packw-x16c8-gemm-goi-avx2-madd.c",
    "src/qs8-qc2w-gemm/gen/qs8-qc2w-gemm-1x8c8-minmax-avx2-madd.c",
    "src/qs8-qc2w-gemm/gen/qs8-qc2w-gemm-5x8c8-minmax-avx2-madd.c",
    "src/qs8-qc2w-packw/gen/qd8-qc2w-packw-x8c8-gemm-goi-avx2.c",
    "src/qs8-qc2w-packw/gen/qs8-to-qu8-qc2w-packw-x8c8-gemm-goi-avx2.c",
    ...
    "src/qs8-rdsum/gen/qs8-rdsum-7p7x-minmax-fp32-avx2-u64.c",
...
NON_PROD_AVX2_MICROKERNEL_SRCS = [
    ...
    "src/qd8-f16-qc2w-gemm/gen/qd8-f16-qc2w-gemm-3x8c8-minmax-avx2-madd.c",
    "src/qd8-f16-qc2w-gemm/gen/qd8-f16-qc2w-gemm-4x8c8-minmax-avx2-madd.c",
    "src/qd8-f16-qc2w-gemm/gen/qd8-f16-qc2w-gemm-5x8c8-minmax-avx2-madd.c",
    "src/qd8-f16-qc2w-gemm/gen/qd8-f16-qc2w-gemm-6x8c8-minmax-avx2-madd.c",
    "src/qd8-f16-qc2w-gemm/gen/qd8-f16-qc2w-gemm-7x8c8-minmax-avx2-madd.c",
    ...
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-2x8c8-minmax-avx2-madd.c",
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-3x8c8-minmax-avx2-madd.c",
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-4x8c8-minmax-avx2-madd.c",
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-5x8c8-minmax-avx2-madd.c",
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-6x8c8-minmax-avx2-madd.c",
    "src/qd8-f32-qc2w-gemm/gen/qd8-f32-qc2w-gemm-7x8c8-minmax-avx2-madd.c",
    ...
    "src/qs8-qc2w-packw/gen/qd8-qc2w-packw-x16c8-gemm-goi-avx2.c",
    "src/qs8-qc2w-packw/gen/qs8-to-qu8-qc2w-packw-x16c8-gemm-goi-avx2.c",
    ...
    "src/qs8-rdsum/gen/qs8-rdsum-7p7x-minmax-fp32-avx2-u32.c",
    ...
    "src/x8-packw/gen/x8-packw-x8c8-gemm-goi-avx2-prfm.c",
    "src/x8-packw/gen/x8-packw-x8c8-gemm-goi-avx2.c",
    "src/x8-packw/gen/x8-packw-x16c8-gemm-goi-avx2-prfm.c",
    "src/x8-packw/gen/x8-packw-x16c8-gemm-goi-avx2.c",

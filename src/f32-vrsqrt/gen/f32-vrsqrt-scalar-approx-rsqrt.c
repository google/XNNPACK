...
void xnn_f32_vrsqrt_ukernel__scalar_approx_rsqrt_u1(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vrsqrt_ukernel__scalar_approx_rsqrt_u2(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vrsqrt_ukernel__scalar_approx_rsqrt_u4(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vrsqrt_ukernel__scalar_approx_rsqrt_u8(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    xnn_simd_f32_t vy_2 = xnn_approx_reciprocal_sqrt_f32(vx_2);
    xnn_simd_f32_t vy_3 = xnn_approx_reciprocal_sqrt_f32(vx_3);
    xnn_simd_f32_t vy_4 = xnn_approx_reciprocal_sqrt_f32(vx_4);
    xnn_simd_f32_t vy_5 = xnn_approx_reciprocal_sqrt_f32(vx_5);
    xnn_simd_f32_t vy_6 = xnn_approx_reciprocal_sqrt_f32(vx_6);
    xnn_simd_f32_t vy_7 = xnn_approx_reciprocal_sqrt_f32(vx_7);

    xnn_simd_f32_t vt1_0, vt2_0, vt3_0, vt4_0;
    xnn_simd_f32_t vt1_1, vt2_1, vt3_1, vt4_1;
    xnn_simd_f32_t vt1_2, vt2_2, vt3_2, vt4_2;
    xnn_simd_f32_t vt1_3, vt2_3, vt3_3, vt4_3;
    xnn_simd_f32_t vt1_4, vt2_4, vt3_4, vt4_4;
    xnn_simd_f32_t vt1_5, vt2_5, vt3_5, vt4_5;
    xnn_simd_f32_t vt1_6, vt2_6, vt3_6, vt4_6;
    xnn_simd_f32_t vt1_7, vt2_7, vt3_7, vt4_7;
    // Do a Newton-Raphson step as described above.
    vt1_0 = xnn_mul_f32(vy_0, vy_0);
    vt1_1 = xnn_mul_f32(vy_1, vy_1);
    vt1_2 = xnn_mul_f32(vy_2, vy_2);
    vt1_3 = xnn_mul_f32(vy_3, vy_3);
    vt1_4 = xnn_mul_f32(vy_4, vy_4);
    vt1_5 = xnn_mul_f32(vy_5, vy_5);
    vt1_6 = xnn_mul_f32(vy_6, vy_6);
    vt1_7 = xnn_mul_f32(vy_7, vy_7);
    vt2_0 = xnn_mul_f32(vx_0, vt1_0);
    vt2_1 = xnn_mul_f32(vx_1, vt1_1);
    vt2_2 = xnn_mul_f32(vx_2, vt1_2);
    vt2_3 = xnn_mul_f32(vx_3, vt1_3);
    vt2_4 = xnn_mul_f32(vx_4, vt1_4);
    vt2_5 = xnn_mul_f32(vx_5, vt1_5);
    vt2_6 = xnn_mul_f32(vx_6, vt1_6);
    vt2_7 = xnn_mul_f32(vx_7, vt1_7);
    vt3_0 = xnn_sub_f32(vthree, vt2_0);
    vt3_1 = xnn_sub_f32(vthree, vt2_1);
    vt3_2 = xnn_sub_f32(vthree, vt2_2);
    vt3_3 = xnn_sub_f32(vthree, vt2_3);
    vt3_4 = xnn_sub_f32(vthree, vt2_4);
    vt3_5 = xnn_sub_f32(vthree, vt2_5);
    vt3_6 = xnn_sub_f32(vthree, vt2_6);
    vt3_7 = xnn_sub_f32(vthree, vt2_7);
    vt4_0 = xnn_mul_f32(vhalf, vy_0);
    vt4_1 = xnn_mul_f32(vhalf, vy_1);
    vt4_2 = xnn_mul_f32(vhalf, vy_2);
    vt4_3 = xnn_mul_f32(vhalf, vy_3);
    vt4_4 = xnn_mul_f32(vhalf, vy_4);
    vt4_5 = xnn_mul_f32(vhalf, vy_5);
    vt4_6 = xnn_mul_f32(vhalf, vy_6);
    vt4_7 = xnn_mul_f32(vhalf, vy_7);
    vy_0 = xnn_mul_f32(vt3_0, vt4_0);
    vy_1 = xnn_mul_f32(vt3_1, vt4_1);
    vy_2 = xnn_mul_f32(vt3_2, vt4_2);
    vy_3 = xnn_mul_f32(vt3_3, vt4_3);
    vy_4 = xnn_mul_f32(vt3_4, vt4_4);
    vy_5 = xnn_mul_f32(vt3_5, vt4_5);
    vy_6 = xnn_mul_f32(vt3_6, vt4_6);
    vy_7 = xnn_mul_f32(vt3_7, vt4_7);
    // Do a Newton-Raphson step as described above.
    vt1_0 = xnn_mul_f32(vy_0, vy_0);
    vt1_1 = xnn_mul_f32(vy_1, vy_1);
    vt1_2 = xnn_mul_f32(vy_2, vy_2);

    ...
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    xnn_simd_f32_t vy_2 = approx_reciprocal_sqrt_f32(vx_2);
    xnn_simd_f32_t vy_3 = approx_reciprocal_sqrt_f32(vx_3);
    xnn_simd_f32_t vy_4 = approx_reciprocal_sqrt_f32(vx_4);
    xnn_simd_f32_t vy_5 = approx_reciprocal_sqrt_f32(vx_5);
    xnn_simd_f32_t vy_6 = approx_reciprocal_sqrt_f32(vx_6);
    xnn_simd_f32_t vy_7 = approx_reciprocal_sqrt_f32(vx_7);

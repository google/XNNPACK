...
void xnn_f32_vrsqrt_ukernel__rvv_rsqrt_u1v(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_rsqrt_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch > 0; ) {
    ...
    vfloat32m1_t t0_f32v = __riscv_vfrsqrt7_v_f32m1(in_f32v, n);
    vfloat32m1_t in_half_f32v = __riscv_vfmul_vf_f32m1(in_f32v, 0.5f, n);

    // First Newton-Raphson iteration
    vfloat32m1_t t1_f32v = __riscv_vfmul_vv_f32m1(t0_f32v, t0_f32v, n);
    vfloat32m1_t t2_f32v = __riscv_vfnmsub_vv_f32m1(in_half_f32v, t1_f32v, onephalf_f32v, n);
    t0_f32v = __riscv_vfmul_vv_f32m1(t0_f32v, t2_f32v, n);

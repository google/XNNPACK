...
void xnn_f32_rminmax_ukernel__wasmrelaxedsimd_minmax_u32_acc4(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* restrict params)
{
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const v128_t vt4 = wasm_v128_load(input + 16);
    const v128_t vt5 = wasm_v128_load(input + 20);
    const v128_t vt6 = wasm_v128_load(input + 24);
    const v128_t vt7 = wasm_v128_load(input + 28);
    input += 32;
    ...
    vmin0 = wasm_f32x4_relaxed_min(vmin0, vt4);
    vmin1 = wasm_f32x4_relaxed_min(vmin1, vt5);
    vmin2 = wasm_f32x4_relaxed_min(vmin2, vt6);
    vmin3 = wasm_f32x4_relaxed_min(vmin3, vt7);
    ...
    vmax0 = wasm_f32x4_relaxed_max(vmax0, vt4);
    vmax1 = wasm_f32x4_relaxed_max(vmax1, vt5);
    vmax2 = wasm_f32x4_relaxed_max(vmax2, vt6);
    vmax3 = wasm_f32x4_relaxed_max(vmax3, vt7);
  }

...
void xnn_f32_rsum2_ukernel__wasmsimd_u4(
...
void xnn_f32_rsum2_ukernel__wasmsimd_u8_acc2(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__wasmsimd_u8(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__wasmsimd_u12_acc3(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__wasmsimd_u12(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__wasmsimd_u16_acc4(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__wasmsimd_u16_acc2(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__wasmsimd_u16(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);

...
void xnn_f32_rsum2_ukernel__avx_u8(
...
void xnn_f32_rsum2_ukernel__avx_u16_acc2(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__avx_u16(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__avx_u24_acc3(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__avx_u24(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__avx_u32_acc4(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__avx_u32_acc2(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__avx_u32(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);

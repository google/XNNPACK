...
static XNN_INLINE float load_tail_reduce_add_squared_f32(xnn_simd_f32_t acc,
  ...
  if XNN_UNLIKELY (num_elements & 1) {
    float32x2_t vt = vld1_dup_f32(input);
    vt = vmul_f32(vt, vt);
    result = vadd_f32(result, vt);
  }
...
void xnn_f32_rsum2_ukernel__neon_u4(
...
void xnn_f32_rsum2_ukernel__neon_u8_acc2(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__neon_u8(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__neon_u12_acc3(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__neon_u12(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__neon_u16_acc4(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__neon_u16_acc2(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
...
void xnn_f32_rsum2_ukernel__neon_u16(
    size_t batch, const float* input, float* output,
    const struct xnn_f32_scale_params* restrict params) {
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);

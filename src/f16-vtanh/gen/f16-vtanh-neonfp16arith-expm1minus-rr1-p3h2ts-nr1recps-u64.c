...
void xnn_f16_vtanh_ukernel__neonfp16arith_expm1minus_rr1_p3h2ts_nr1recps_u64(
    size_t n,
    const void* input,
    void* output,
    const union xnn_f16_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; n >= 8 * sizeof(float16x8_t); n -= 8 * sizeof(float16x8_t)) {
    ...
    const float16x8_t verepo2 = vrecpsq_f16(vrepo2, vepo2);
    const float16x8_t verepo3 = vrecpsq_f16(vrepo3, vepo3);
    const float16x8_t verepo4 = vrecpsq_f16(vrepo4, vepo4);
    const float16x8_t verepo5 = vrecpsq_f16(vrepo5, vepo5);
    const float16x8_t verepo6 = vrecpsq_f16(vrepo6, vepo6);
    const float16x8_t verepo7 = vrecpsq_f16(vrepo7, vepo7);
    vrepo0 = vmulq_f16(vrepo0, verepo0);
    vrepo1 = vmulq_f16(vrepo1, verepo1);
    vrepo2 = vmulq_f16(vrepo2, verepo2);
    vrepo3 = vmulq_f16(vrepo3, verepo3);
    vrepo4 = vmulq_f16(vrepo4, verepo4);
    vrepo5 = vmulq_f16(vrepo5, verepo5);
    vrepo6 = vmulq_f16(vrepo6, verepo6);
    vrepo7 = vmulq_f16(vrepo7, verepo7);

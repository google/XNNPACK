...
void xnn_f16_vtanh_ukernel__neonfp16arith_expm1minus_rr1_p3h2ts_nr1recps_x80(
    size_t n,
    const void* input,
    void* output,
    const union xnn_f16_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; n >= 10 * sizeof(float16x8_t); n -= 10 * sizeof(float16x8_t)) {
    ...
    const float16x8_t verepo8 = vrecpsq_f16(vrepo8, vepo8);
    const float16x8_t verepo9 = vrecpsq_f16(vrepo9, vepo9);
    ...
    vrepo8 = vmulq_f16(vrepo8, verepo8);
    vrepo9 = vmulq_f16(vrepo9, verepo9);

...
void xnn_f16_vtanh_ukernel__f16c_polynomial_p19h9t2_x80(
    size_t batch,
    const void* input,
    void* output,
    const union xnn_f16_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 80 * sizeof(uint16_t); batch -= 80 * sizeof(uint16_t)) {
    ...
    __m256 vp6 = _mm256_add_ps(_mm256_mul_ps(vc19, vt6), vc17);
    __m256 vp7 = _mm256_add_ps(_mm256_mul_ps(vc19, vt7), vc17);
    __m256 vp8 = _mm256_add_ps(_mm256_mul_ps(vc19, vt8), vc17);
    __m256 vp9 = _mm256_add_ps(_mm256_mul_ps(vc19, vt9), vc17);
    ...
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vt6), vc15);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vt7), vc15);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vt8), vc15);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vt9), vc15);
    ...
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vt6), vc13);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vt7), vc13);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vt8), vc13);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vt9), vc13);
    ...
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vt6), vc11);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vt7), vc11);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vt8), vc11);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vt9), vc11);
    ...
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vt6), vc9);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vt7), vc9);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vt8), vc9);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vt9), vc9);
    ...
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vt6), vc7);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vt7), vc7);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vt8), vc7);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vt9), vc7);
    ...
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vt6), vc5);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vt7), vc5);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vt8), vc5);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vt9), vc5);
    ...
    const __m256 vy6 = _mm256_add_ps(_mm256_mul_ps(vp6, vxt6), vx6);
    const __m256 vy7 = _mm256_add_ps(_mm256_mul_ps(vp7, vxt7), vx7);
    const __m256 vy8 = _mm256_add_ps(_mm256_mul_ps(vp8, vxt8), vx8);
    const __m256 vy9 = _mm256_add_ps(_mm256_mul_ps(vp9, vxt9), vx9);

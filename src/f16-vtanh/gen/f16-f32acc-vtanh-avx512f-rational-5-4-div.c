...
void xnn_f16_f32acc_vtanh_ukernel__avx512f_rational_5_4_div_u16(
    size_t batch,
...
void xnn_f16_f32acc_vtanh_ukernel__avx512f_rational_5_4_div_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(xnn_float16); batch -= 32 * sizeof(xnn_float16)) {
    xnn_simd_f32_t vx_0 = xnn_loadu_f16_f32(input + 0 * 16);
    xnn_simd_f32_t vx_1 = xnn_loadu_f16_f32(input + 1 * 16);
    input += 32;
    ...
    xnn_store_f32_f16(output + 0 * 16, vy_0);
    xnn_store_f32_f16(output + 1 * 16, vy_1);
    output += 32;
  }
  for (; batch >= 16 * sizeof(xnn_float16); batch -= 16 * sizeof(xnn_float16)) {
    xnn_simd_f32_t vx = xnn_loadu_f16_f32(input);
...
void xnn_f16_f32acc_vtanh_ukernel__avx512f_rational_5_4_div_u64(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 64 * sizeof(xnn_float16); batch -= 64 * sizeof(xnn_float16)) {
    xnn_simd_f32_t vx_0 = xnn_loadu_f16_f32(input + 0 * 16);
    xnn_simd_f32_t vx_1 = xnn_loadu_f16_f32(input + 1 * 16);
    xnn_simd_f32_t vx_2 = xnn_loadu_f16_f32(input + 2 * 16);
    xnn_simd_f32_t vx_3 = xnn_loadu_f16_f32(input + 3 * 16);
    input += 64;
    ...
    xnn_store_f32_f16(output + 0 * 16, vy_0);
    xnn_store_f32_f16(output + 1 * 16, vy_1);
    xnn_store_f32_f16(output + 2 * 16, vy_2);
    xnn_store_f32_f16(output + 3 * 16, vy_3);
    output += 64;
  }
  for (; batch >= 16 * sizeof(xnn_float16); batch -= 16 * sizeof(xnn_float16)) {
    xnn_simd_f32_t vx = xnn_loadu_f16_f32(input);

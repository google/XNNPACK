...
{ 
    ...
    vfloat16m4_t p0H = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE, index, vl);
    vfloat16m4_t p0L = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 1, index, vl);
    vfloat16m4_t  p1 = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 2, index, vl);
    vfloat16m4_t  p2 = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 3, index, vl);
    vfloat16m4_t  p3 = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 4, index, vl);
    vfloat16m4_t  p4 = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 5, index, vl);
    vfloat16m4_t  p5 = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 6, index, vl);
    vfloat16m4_t x_m = __riscv_vloxei16_v_f16m4((_Float16*)RVVMF_FP16_tanhsp_LOOK_UP_TABLE + 7, index, vl);
...
void xnn_f16_vtanh_ukernel__rvvfp16arith_tanh_u4v(
    size_t batch,
    ...
    const struct xnn_f16_default_params* unused_params)
{
  ...
  do {
    ...
    vfloat16m4_t vx = __riscv_vle16_v_f16m4((_Float16*)input, n);
    input += n;
    vfloat16m4_t vacc = __riscv_vtanh_f16m4(vx, n);
    __riscv_vse16_v_f16m4((_Float16*)output, vacc, n);
    output += n;

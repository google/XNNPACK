...
void xnn_f16_vtanh_ukernel__avx512fp16_rational_5_4_nr_u32(
    size_t batch,
...
void xnn_f16_vtanh_ukernel__avx512fp16_rational_5_4_nr_u64(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vtanh_ukernel__avx512fp16_rational_5_4_nr_u128(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)

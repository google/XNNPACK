...
static XNN_INLINE void xnn_store_f32_f16(xnn_float16* o, xnn_simd_f32_t v) { xnn_store_tail_f16(o, xnn_cvt_f16_f32(v), 1); }
...
void xnn_f16_f32acc_vtanh_ukernel__scalar_rational_5_4_div_u1(
    size_t batch,
...
void xnn_f16_f32acc_vtanh_ukernel__scalar_rational_5_4_div_u2(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_f32acc_vtanh_ukernel__scalar_rational_5_4_div_u4(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)

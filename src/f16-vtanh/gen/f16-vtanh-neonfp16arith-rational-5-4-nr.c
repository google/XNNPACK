...
void xnn_f16_vtanh_ukernel__neonfp16arith_rational_5_4_nr_u8(
    size_t batch,
...
void xnn_f16_vtanh_ukernel__neonfp16arith_rational_5_4_nr_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 16 * sizeof(xnn_float16); batch -= 16 * sizeof(xnn_float16)) {
    ...
    const xnn_simd_f16_t vy_0 = xnn_mul_f16(vp_0, vrq_0);
    const xnn_simd_f16_t vy_1 = xnn_mul_f16(vp_1, vrq_1);
...
void xnn_f16_vtanh_ukernel__neonfp16arith_rational_5_4_nr_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(xnn_float16); batch -= 32 * sizeof(xnn_float16)) {
    ...
    const xnn_simd_f16_t vy_0 = xnn_mul_f16(vp_0, vrq_0);
    const xnn_simd_f16_t vy_1 = xnn_mul_f16(vp_1, vrq_1);
    const xnn_simd_f16_t vy_2 = xnn_mul_f16(vp_2, vrq_2);
    const xnn_simd_f16_t vy_3 = xnn_mul_f16(vp_3, vrq_3);

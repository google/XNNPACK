...
void xnn_f16_vtanh_ukernel__neonfp16arith_expm1minus_rr1_p3h2ts_recpeadj_x80(
    size_t n,
    const void* input,
    void* output,
    const union xnn_f16_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; n >= 10 * sizeof(float16x8_t); n -= 10 * sizeof(float16x8_t)) {
    ...
    const float16x8_t vey7 = vfmsq_f16(vemo7, vy7, vepo7);
    const float16x8_t vey8 = vfmsq_f16(vemo8, vy8, vepo8);
    const float16x8_t vey9 = vfmsq_f16(vemo9, vy9, vepo9);
    ...
    vy7 = vfmaq_f16(vy7, vey7, vrepo7);
    vy8 = vfmaq_f16(vy8, vey8, vrepo8);
    vy9 = vfmaq_f16(vy9, vey9, vrepo9);

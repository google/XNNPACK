...
void xnn_f16_vtanh_ukernel__wasmrelaxedsimd_expm1minus_rr1_p3h2ts_div_u8(
    size_t batch,
    ...
    const struct xnn_f16_default_params* restrict params) XNN_OOB_READS
{
  ...
  for (; batch >= 1 * xnn_simd_bytes_f16; batch -= 1 * xnn_simd_bytes_f16) {
    const xnn_simd_f16_t vx = xnn_loadu_f16(i); i += 8;
...
void xnn_f16_vtanh_ukernel__wasmrelaxedsimd_expm1minus_rr1_p3h2ts_div_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* restrict params) XNN_OOB_READS
{
  ...
  for (; batch >= 2 * xnn_simd_bytes_f16; batch -= 2 * xnn_simd_bytes_f16) {
    const xnn_simd_f16_t vx0 = xnn_loadu_f16(i); i += 8;
    const xnn_simd_f16_t vx1 = xnn_loadu_f16(i); i += 8;
    ...
    xnn_storeu_f16(o, vy0); o += 8;
    xnn_storeu_f16(o, vy1); o += 8;
  }
  for (; batch >= 1 * xnn_simd_bytes_f16; batch -= 1 * xnn_simd_bytes_f16) {
    const xnn_simd_f16_t vx = xnn_loadu_f16(i); i += 8;
...
void xnn_f16_vtanh_ukernel__wasmrelaxedsimd_expm1minus_rr1_p3h2ts_div_u24(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* restrict params) XNN_OOB_READS
{
  ...
  const xnn_float16* i = input;
  xnn_float16* o = output;
  for (; batch >= 3 * xnn_simd_bytes_f16; batch -= 3 * xnn_simd_bytes_f16) {
    const xnn_simd_f16_t vx0 = xnn_loadu_f16(i); i += 8;
    const xnn_simd_f16_t vx1 = xnn_loadu_f16(i); i += 8;
    const xnn_simd_f16_t vx2 = xnn_loadu_f16(i); i += 8;
...
void xnn_f16_vtanh_ukernel__wasmrelaxedsimd_expm1minus_rr1_p3h2ts_div_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* restrict params) XNN_OOB_READS
{
  ...
  for (; batch >= 4 * xnn_simd_bytes_f16; batch -= 4 * xnn_simd_bytes_f16) {
    ...
    const xnn_simd_f16_t vx1 = xnn_loadu_f16(i); i += 8;
    const xnn_simd_f16_t vx2 = xnn_loadu_f16(i); i += 8;
    const xnn_simd_f16_t vx3 = xnn_loadu_f16(i); i += 8;

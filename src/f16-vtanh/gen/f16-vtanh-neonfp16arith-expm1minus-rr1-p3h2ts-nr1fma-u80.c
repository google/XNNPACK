...
void xnn_f16_vtanh_ukernel__neonfp16arith_expm1minus_rr1_p3h2ts_nr1fma_u80(
    size_t n,
    const void* input,
    void* output,
    const union xnn_f16_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; n >= 10 * sizeof(float16x8_t); n -= 10 * sizeof(float16x8_t)) {
    ...
    float16x8_t vrepo7 = vrecpeq_f16(vepo7);
    float16x8_t vrepo8 = vrecpeq_f16(vepo8);
    float16x8_t vrepo9 = vrecpeq_f16(vepo9);
    ...
    const float16x8_t verepo4 = vfmaq_f16(vminus_one, vrepo4, vepo4);
    const float16x8_t verepo5 = vfmaq_f16(vminus_one, vrepo5, vepo5);
    const float16x8_t verepo6 = vfmaq_f16(vminus_one, vrepo6, vepo6);
    const float16x8_t verepo7 = vfmaq_f16(vminus_one, vrepo7, vepo7);
    const float16x8_t verepo8 = vfmaq_f16(vminus_one, vrepo8, vepo8);
    const float16x8_t verepo9 = vfmaq_f16(vminus_one, vrepo9, vepo9);
    ...
    vrepo4 = vfmsq_f16(vrepo4, vrepo4, verepo4);
    vrepo5 = vfmsq_f16(vrepo5, vrepo5, verepo5);
    vrepo6 = vfmsq_f16(vrepo6, vrepo6, verepo6);
    vrepo7 = vfmsq_f16(vrepo7, vrepo7, verepo7);
    vrepo8 = vfmsq_f16(vrepo8, vrepo8, verepo8);
    vrepo9 = vfmsq_f16(vrepo9, vrepo9, verepo9);
    ...
    float16x8_t vy7 = vmulq_f16(vemo7, vrepo7);
    float16x8_t vy8 = vmulq_f16(vemo8, vrepo8);
    float16x8_t vy9 = vmulq_f16(vemo9, vrepo9);

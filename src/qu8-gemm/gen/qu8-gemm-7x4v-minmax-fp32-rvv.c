...
void xnn_qu8_gemm_minmax_fp32_ukernel_7x4v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vfacc4 = __riscv_vfmul_vf_f32m4(vfacc4, vscale, vl);
    vfacc5 = __riscv_vfmul_vf_f32m4(vfacc5, vscale, vl);
    vfacc6 = __riscv_vfmul_vf_f32m4(vfacc6, vscale, vl);

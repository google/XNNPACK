    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN XNN_DISABLE_MSAN
{
  ...
  do {
    ...
    uint32x4_t vnacc2 = vmovq_n_u32(0);
    uint32x4_t vnacc3 = vmovq_n_u32(0);
    uint32x4_t vnacc4 = vmovq_n_u32(0);
    uint32x4_t vnacc5 = vmovq_n_u32(0);
    uint32x4_t vnacc6 = vmovq_n_u32(0);
    uint32x4_t vnacc7 = vmovq_n_u32(0);
    ...
    while (k >= 8 * sizeof(uint8_t)) {
      ...
      vnacc2 = vdotq_lane_u32(vnacc2, vb_zero_point, va2x01234567, 0);
      ...
      vnacc3 = vdotq_lane_u32(vnacc3, vb_zero_point, va3x01234567, 0);
      ...
      vnacc4 = vdotq_lane_u32(vnacc4, vb_zero_point, va4x01234567, 0);
      ...
      vnacc5 = vdotq_lane_u32(vnacc5, vb_zero_point, va5x01234567, 0);
      ...
      vnacc6 = vdotq_lane_u32(vnacc6, vb_zero_point, va6x01234567, 0);
      ...
      vnacc7 = vdotq_lane_u32(vnacc7, vb_zero_point, va7x01234567, 0);
      ...
      vnacc2 = vdotq_lane_u32(vnacc2, vb_zero_point, va2x01234567, 1);
      ...
      vnacc3 = vdotq_lane_u32(vnacc3, vb_zero_point, va3x01234567, 1);
      ...
      vnacc4 = vdotq_lane_u32(vnacc4, vb_zero_point, va4x01234567, 1);
      ...
      vnacc5 = vdotq_lane_u32(vnacc5, vb_zero_point, va5x01234567, 1);
      ...
      vnacc6 = vdotq_lane_u32(vnacc6, vb_zero_point, va6x01234567, 1);
      ...
      vnacc7 = vdotq_lane_u32(vnacc7, vb_zero_point, va7x01234567, 1);
    ...
    int32x4_t vacc2x0123 = vreinterpretq_s32_u32(vsubq_u32(vpacc2x0123, vnacc2));
    int32x4_t vacc2x4567 = vreinterpretq_s32_u32(vsubq_u32(vpacc2x4567, vnacc2));
    int32x4_t vacc2x89AB = vreinterpretq_s32_u32(vsubq_u32(vpacc2x89AB, vnacc2));
    int32x4_t vacc2xCDEF = vreinterpretq_s32_u32(vsubq_u32(vpacc2xCDEF, vnacc2));
    int32x4_t vacc3x0123 = vreinterpretq_s32_u32(vsubq_u32(vpacc3x0123, vnacc3));
    int32x4_t vacc3x4567 = vreinterpretq_s32_u32(vsubq_u32(vpacc3x4567, vnacc3));
    int32x4_t vacc3x89AB = vreinterpretq_s32_u32(vsubq_u32(vpacc3x89AB, vnacc3));
    int32x4_t vacc3xCDEF = vreinterpretq_s32_u32(vsubq_u32(vpacc3xCDEF, vnacc3));
    int32x4_t vacc4x0123 = vreinterpretq_s32_u32(vsubq_u32(vpacc4x0123, vnacc4));
    int32x4_t vacc4x4567 = vreinterpretq_s32_u32(vsubq_u32(vpacc4x4567, vnacc4));
    int32x4_t vacc4x89AB = vreinterpretq_s32_u32(vsubq_u32(vpacc4x89AB, vnacc4));
    int32x4_t vacc4xCDEF = vreinterpretq_s32_u32(vsubq_u32(vpacc4xCDEF, vnacc4));
    int32x4_t vacc5x0123 = vreinterpretq_s32_u32(vsubq_u32(vpacc5x0123, vnacc5));
    int32x4_t vacc5x4567 = vreinterpretq_s32_u32(vsubq_u32(vpacc5x4567, vnacc5));
    int32x4_t vacc5x89AB = vreinterpretq_s32_u32(vsubq_u32(vpacc5x89AB, vnacc5));
    int32x4_t vacc5xCDEF = vreinterpretq_s32_u32(vsubq_u32(vpacc5xCDEF, vnacc5));
    int32x4_t vacc6x0123 = vreinterpretq_s32_u32(vsubq_u32(vpacc6x0123, vnacc6));
    int32x4_t vacc6x4567 = vreinterpretq_s32_u32(vsubq_u32(vpacc6x4567, vnacc6));
    int32x4_t vacc6x89AB = vreinterpretq_s32_u32(vsubq_u32(vpacc6x89AB, vnacc6));
    int32x4_t vacc6xCDEF = vreinterpretq_s32_u32(vsubq_u32(vpacc6xCDEF, vnacc6));
    int32x4_t vacc7x0123 = vreinterpretq_s32_u32(vsubq_u32(vpacc7x0123, vnacc7));
    int32x4_t vacc7x4567 = vreinterpretq_s32_u32(vsubq_u32(vpacc7x4567, vnacc7));
    int32x4_t vacc7x89AB = vreinterpretq_s32_u32(vsubq_u32(vpacc7x89AB, vnacc7));
    int32x4_t vacc7xCDEF = vreinterpretq_s32_u32(vsubq_u32(vpacc7xCDEF, vnacc7));

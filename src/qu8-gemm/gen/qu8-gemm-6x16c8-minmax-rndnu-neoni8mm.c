...
void xnn_qu8_gemm_minmax_rndnu_ukernel_6x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(uint8_t)) {
      ...
      const uint8x16_t vb1011x89ABCDEF = vld1q_u8(w); w = (const uint8_t*) w + 16;
      const uint8x16_t vb1213x89ABCDEF = vld1q_u8(w); w = (const uint8_t*) w + 16;
      const uint8x16_t vb1415x89ABCDEF = vld1q_u8(w); w = (const uint8_t*) w + 16;

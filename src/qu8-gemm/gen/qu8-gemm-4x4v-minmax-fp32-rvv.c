...
void xnn_qu8_gemm_minmax_fp32_ukernel_4x4v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qu8_conv_minmax_params* restrict params)
{
  ...
  do {
    ...
    vfacc0 = __riscv_vfmul_vf_f32m4(vfacc0, vscale, vl);
    vfacc1 = __riscv_vfmul_vf_f32m4(vfacc1, vscale, vl);
    vfacc2 = __riscv_vfmul_vf_f32m4(vfacc2, vscale, vl);
    vfacc3 = __riscv_vfmul_vf_f32m4(vfacc3, vscale, vl);
    ...
    vuint8m1_t vout81 = __riscv_vncvt_x_x_w_u8m1(__riscv_vreinterpret_u16m2(vout1), vl);
    vuint8m1_t vout82 = __riscv_vncvt_x_x_w_u8m1(__riscv_vreinterpret_u16m2(vout2), vl);
    vuint8m1_t vout83 = __riscv_vncvt_x_x_w_u8m1(__riscv_vreinterpret_u16m2(vout3), vl);

    __riscv_vse8_v_u8m1(c0, vout80, vl);
    c0 = (uint8_t*) ((uintptr_t) c0 + cn_stride);
    __riscv_vse8_v_u8m1(c1, vout81, vl);
    c1 = (uint8_t*) ((uintptr_t) c1 + cn_stride);
    __riscv_vse8_v_u8m1(c2, vout82, vl);
    c2 = (uint8_t*) ((uintptr_t) c2 + cn_stride);
    __riscv_vse8_v_u8m1(c3, vout83, vl);

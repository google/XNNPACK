    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const __m128i vout7x0123456789AB4567CDEF = _mm_packus_epi16(_mm256_castsi256_si128(vacc7x0123456789AB4567CDEF), _mm256_extracti128_si256(vacc7x0123456789AB4567CDEF, 1));

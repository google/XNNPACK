    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN
{
  ...
  do {
    ...
    uint8x16_t vout0x0123456789ABCDEF = vuzp1q_u8(vreinterpretq_u8_s16(vacc0x01234567), vreinterpretq_u8_s16(vacc0x89ABCDEF));
    uint8x16_t vout1x0123456789ABCDEF = vuzp1q_u8(vreinterpretq_u8_s16(vacc1x01234567), vreinterpretq_u8_s16(vacc1x89ABCDEF));
    uint8x16_t vout2x0123456789ABCDEF = vuzp1q_u8(vreinterpretq_u8_s16(vacc2x01234567), vreinterpretq_u8_s16(vacc2x89ABCDEF));
    uint8x16_t vout3x0123456789ABCDEF = vuzp1q_u8(vreinterpretq_u8_s16(vacc3x01234567), vreinterpretq_u8_s16(vacc3x89ABCDEF));
#else
    ...
    uint8x16_t vout0x0123456789ABCDEF = vreinterpretq_u8_s8(vcombine_s8(vmovn_s16(vacc0x01234567), vmovn_s16(vacc0x89ABCDEF)));
    uint8x16_t vout1x0123456789ABCDEF = vreinterpretq_u8_s8(vcombine_s8(vmovn_s16(vacc1x01234567), vmovn_s16(vacc1x89ABCDEF)));
    uint8x16_t vout2x0123456789ABCDEF = vreinterpretq_u8_s8(vcombine_s8(vmovn_s16(vacc2x01234567), vmovn_s16(vacc2x89ABCDEF)));
    uint8x16_t vout3x0123456789ABCDEF = vreinterpretq_u8_s8(vcombine_s8(vmovn_s16(vacc3x01234567), vmovn_s16(vacc3x89ABCDEF)));
#endif

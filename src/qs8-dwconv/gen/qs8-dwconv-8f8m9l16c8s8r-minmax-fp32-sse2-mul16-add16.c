...
void xnn_qs8_dwconv_minmax_fp32_ukernel_8f8m9l16c8s8r__sse2_mul16_add16(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 8 inputs.
    {
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const __m128i vi6x01234567 = _mm_loadl_epi64((const __m128i*) i6);
          const __m128i vk6x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 48 * sizeof(int8_t)));
          i6 += 8;
          ...
          const __m128i vi7x01234567 = _mm_loadl_epi64((const __m128i*) i7);
          const __m128i vk7x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 56 * sizeof(int8_t)));
          i7 += 8;
    ...
    for (size_t ks = kernel_size - 8; ks > 9; ks -= 8) {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const __m128i vi7x01234567 = _mm_loadl_epi64((const __m128i*) i7);
        const __m128i vk7x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 112 * sizeof(int8_t)));
        const __m128i vi7x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i7 + 8));
        const __m128i vk7x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 120 * sizeof(int8_t)));
        i7 += 16;
    ...
    // Last pass to process up to 9 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const __m128i vk8x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 128 * sizeof(int8_t)));
        const __m128i vi8x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i8 + 8));
        const __m128i vk8x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 136 * sizeof(int8_t)));
        i8 += 16;

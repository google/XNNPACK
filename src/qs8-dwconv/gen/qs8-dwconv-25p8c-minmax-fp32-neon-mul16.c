...
void xnn_qs8_dwconv_minmax_fp32_ukernel_25p8c__neon_mul16(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (size_t co = 0; co < channels; co += 328) {
    size_t channel_supertile = 328;
    if (co + channel_supertile > channels) {
      channel_supertile = channels - co;
    }
    int8_t* o = output + co;
    const int8_t** input_co = input;
    size_t ow = output_width;
    // output_increment assumes we process `channels` at a time. Fix it.
    size_t oi = output_increment + (channels - channel_supertile) * sizeof(int8_t);
    do {
      const int8_t* i0 = input_co[0];
      assert(i0 != NULL);
      if XNN_UNPREDICTABLE(i0 != zero) {
        i0 += co;
        i0 = (const int8_t*) ((uintptr_t) i0 + input_offset);
      }
      const int8_t* i1 = input_co[1];
      assert(i1 != NULL);
      if XNN_UNPREDICTABLE(i1 != zero) {
        i1 += co;
        i1 = (const int8_t*) ((uintptr_t) i1 + input_offset);
      }
      const int8_t* i2 = input_co[2];
      assert(i2 != NULL);
      if XNN_UNPREDICTABLE(i2 != zero) {
        i2 += co;
        i2 = (const int8_t*) ((uintptr_t) i2 + input_offset);
      }
      const int8_t* i3 = input_co[3];
      assert(i3 != NULL);
      if XNN_UNPREDICTABLE(i3 != zero) {
        i3 += co;
        i3 = (const int8_t*) ((uintptr_t) i3 + input_offset);
      }
      const int8_t* i4 = input_co[4];
      assert(i4 != NULL);
      if XNN_UNPREDICTABLE(i4 != zero) {
        i4 += co;
        i4 = (const int8_t*) ((uintptr_t) i4 + input_offset);
      }
      const int8_t* i5 = input_co[5];
      assert(i5 != NULL);
      if XNN_UNPREDICTABLE(i5 != zero) {
        i5 += co;
        i5 = (const int8_t*) ((uintptr_t) i5 + input_offset);
      }
      const int8_t* i6 = input_co[6];
      assert(i6 != NULL);
      if XNN_UNPREDICTABLE(i6 != zero) {
        i6 += co;
        i6 = (const int8_t*) ((uintptr_t) i6 + input_offset);
      }
      const int8_t* i7 = input_co[7];
      assert(i7 != NULL);
      if XNN_UNPREDICTABLE(i7 != zero) {
        i7 += co;
        i7 = (const int8_t*) ((uintptr_t) i7 + input_offset);
      }
      const int8_t* i8 = input_co[8];
      assert(i8 != NULL);
      if XNN_UNPREDICTABLE(i8 != zero) {
        i8 += co;
        i8 = (const int8_t*) ((uintptr_t) i8 + input_offset);
      }
      const int8_t* i9 = input_co[9];
      assert(i9 != NULL);
      if XNN_UNPREDICTABLE(i9 != zero) {
        i9 += co;
        i9 = (const int8_t*) ((uintptr_t) i9 + input_offset);
      }
      const int8_t* i10 = input_co[10];
      assert(i10 != NULL);
      if XNN_UNPREDICTABLE(i10 != zero) {
        i10 += co;
        i10 = (const int8_t*) ((uintptr_t) i10 + input_offset);
      }
      const int8_t* i11 = input_co[11];
      assert(i11 != NULL);
      if XNN_UNPREDICTABLE(i11 != zero) {
        i11 += co;
        i11 = (const int8_t*) ((uintptr_t) i11 + input_offset);
      }
      const int8_t* i12 = input_co[12];
      assert(i12 != NULL);
      if XNN_UNPREDICTABLE(i12 != zero) {
        i12 += co;
        i12 = (const int8_t*) ((uintptr_t) i12 + input_offset);
      }
      const int8_t* i13 = input_co[13];
      assert(i13 != NULL);
      if XNN_UNPREDICTABLE(i13 != zero) {
        i13 += co;
        i13 = (const int8_t*) ((uintptr_t) i13 + input_offset);
      }
      const int8_t* i14 = input_co[14];
      assert(i14 != NULL);
      if XNN_UNPREDICTABLE(i14 != zero) {
        i14 += co;
        i14 = (const int8_t*) ((uintptr_t) i14 + input_offset);
      }
      const int8_t* i15 = input_co[15];
      assert(i15 != NULL);
      if XNN_UNPREDICTABLE(i15 != zero) {
        i15 += co;
        i15 = (const int8_t*) ((uintptr_t) i15 + input_offset);
      }
      const int8_t* i16 = input_co[16];
      assert(i16 != NULL);
      if XNN_UNPREDICTABLE(i16 != zero) {
        i16 += co;
        i16 = (const int8_t*) ((uintptr_t) i16 + input_offset);
      }
      const int8_t* i17 = input_co[17];
      assert(i17 != NULL);
      if XNN_UNPREDICTABLE(i17 != zero) {
        i17 += co;
        i17 = (const int8_t*) ((uintptr_t) i17 + input_offset);
      }
      const int8_t* i18 = input_co[18];
      assert(i18 != NULL);
      if XNN_UNPREDICTABLE(i18 != zero) {
        i18 += co;
        i18 = (const int8_t*) ((uintptr_t) i18 + input_offset);
      }
      const int8_t* i19 = input_co[19];
      assert(i19 != NULL);
      if XNN_UNPREDICTABLE(i19 != zero) {
        i19 += co;
        i19 = (const int8_t*) ((uintptr_t) i19 + input_offset);
      }
      const int8_t* i20 = input_co[20];
      assert(i20 != NULL);
      if XNN_UNPREDICTABLE(i20 != zero) {
        i20 += co;
        i20 = (const int8_t*) ((uintptr_t) i20 + input_offset);
      }
      const int8_t* i21 = input_co[21];
      assert(i21 != NULL);
      if XNN_UNPREDICTABLE(i21 != zero) {
        i21 += co;
        i21 = (const int8_t*) ((uintptr_t) i21 + input_offset);
      }
      const int8_t* i22 = input_co[22];
      assert(i22 != NULL);
      if XNN_UNPREDICTABLE(i22 != zero) {
        i22 += co;
        i22 = (const int8_t*) ((uintptr_t) i22 + input_offset);
      }
      const int8_t* i23 = input_co[23];
      assert(i23 != NULL);
      if XNN_UNPREDICTABLE(i23 != zero) {
        i23 += co;
        i23 = (const int8_t*) ((uintptr_t) i23 + input_offset);
      }
      const int8_t* i24 = input_co[24];
      assert(i24 != NULL);
      ...
      input_co = (const int8_t**) ((uintptr_t) input_co + input_stride);

      size_t c = channel_supertile;
      const void* w = (const void*) ((uintptr_t) weights + co * (25 + sizeof(int32_t)));
      for (; c >= 8; c -= 8) {
      ...
      if XNN_UNLIKELY(c != 0) {
        {
          ...
          const int16x8_t vk9x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 72)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi9x01234567), vget_low_s16(vk9x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi9x01234567), vget_high_s16(vk9x01234567));
          const int16x8_t vi10x01234567 = vmovl_s8(vld1_s8(i10));
          const int16x8_t vk10x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 80)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi10x01234567), vget_low_s16(vk10x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi10x01234567), vget_high_s16(vk10x01234567));
          const int16x8_t vi11x01234567 = vmovl_s8(vld1_s8(i11));
          const int16x8_t vk11x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 88)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi11x01234567), vget_low_s16(vk11x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi11x01234567), vget_high_s16(vk11x01234567));
          const int16x8_t vi12x01234567 = vmovl_s8(vld1_s8(i12));
          const int16x8_t vk12x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 96)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi12x01234567), vget_low_s16(vk12x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi12x01234567), vget_high_s16(vk12x01234567));
          const int16x8_t vi13x01234567 = vmovl_s8(vld1_s8(i13));
          const int16x8_t vk13x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 104)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi13x01234567), vget_low_s16(vk13x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi13x01234567), vget_high_s16(vk13x01234567));
          const int16x8_t vi14x01234567 = vmovl_s8(vld1_s8(i14));
          const int16x8_t vk14x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 112)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi14x01234567), vget_low_s16(vk14x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi14x01234567), vget_high_s16(vk14x01234567));
          const int16x8_t vi15x01234567 = vmovl_s8(vld1_s8(i15));
          const int16x8_t vk15x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 120)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi15x01234567), vget_low_s16(vk15x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi15x01234567), vget_high_s16(vk15x01234567));
          const int16x8_t vi16x01234567 = vmovl_s8(vld1_s8(i16));
          const int16x8_t vk16x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 128)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi16x01234567), vget_low_s16(vk16x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi16x01234567), vget_high_s16(vk16x01234567));
          const int16x8_t vi17x01234567 = vmovl_s8(vld1_s8(i17));
          const int16x8_t vk17x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 136)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi17x01234567), vget_low_s16(vk17x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi17x01234567), vget_high_s16(vk17x01234567));
          const int16x8_t vi18x01234567 = vmovl_s8(vld1_s8(i18));
          const int16x8_t vk18x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 144)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi18x01234567), vget_low_s16(vk18x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi18x01234567), vget_high_s16(vk18x01234567));
          const int16x8_t vi19x01234567 = vmovl_s8(vld1_s8(i19));
          const int16x8_t vk19x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 152)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi19x01234567), vget_low_s16(vk19x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi19x01234567), vget_high_s16(vk19x01234567));
          const int16x8_t vi20x01234567 = vmovl_s8(vld1_s8(i20));
          const int16x8_t vk20x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 160)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi20x01234567), vget_low_s16(vk20x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi20x01234567), vget_high_s16(vk20x01234567));
          const int16x8_t vi21x01234567 = vmovl_s8(vld1_s8(i21));
          const int16x8_t vk21x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 168)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi21x01234567), vget_low_s16(vk21x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi21x01234567), vget_high_s16(vk21x01234567));
          const int16x8_t vi22x01234567 = vmovl_s8(vld1_s8(i22));
          const int16x8_t vk22x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 176)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi22x01234567), vget_low_s16(vk22x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi22x01234567), vget_high_s16(vk22x01234567));
          const int16x8_t vi23x01234567 = vmovl_s8(vld1_s8(i23));
          const int16x8_t vk23x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 184)));

          vacc0123 = vmlal_s16(vacc0123, vget_low_s16(vi23x01234567), vget_low_s16(vk23x01234567));
          vacc4567 = vmlal_s16(vacc4567, vget_high_s16(vi23x01234567), vget_high_s16(vk23x01234567));
          const int16x8_t vi24x01234567 = vmovl_s8(vld1_s8(i24));
          const int16x8_t vk24x01234567 = vmovl_s8(vld1_s8((const void*) ((const int8_t*) w + 192)));
          ...
          if (c & 4) {
            vst1_lane_u32((void*) o, vreinterpret_u32_s8(vout01234567), 0); o += 4;
            vout01234567 = vext_s8(vout01234567, vout01234567, 4);
          }
          if (c & 2) {
            vst1_lane_u16((void*) o, vreinterpret_u16_s8(vout01234567), 0); o += 2;
            vout01234567 = vext_s8(vout01234567, vout01234567, 2);
          }
          if (c & 1) {
            vst1_lane_s8(o, vout01234567, 0); o += 1;
          }
        }
      }

      o = (int8_t*) ((uintptr_t) o + oi);
    } while (--ow != 0);
  }
}

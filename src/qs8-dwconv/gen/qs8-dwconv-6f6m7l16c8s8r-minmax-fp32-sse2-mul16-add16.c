...
void xnn_qs8_dwconv_minmax_fp32_ukernel_6f6m7l16c8s8r__sse2_mul16_add16(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
  ...
  do {
    ...
    // Last pass to process up to 7 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const __m128i vsignprod6x01234567 = _mm_cmpgt_epi16(_mm_setzero_si128(), vprod01234567);
        vacc0123 = _mm_add_epi32(vacc0123, _mm_unpacklo_epi16(vprod01234567, vsignprod6x01234567));
        vacc4567 = _mm_add_epi32(vacc4567, _mm_unpackhi_epi16(vprod01234567, vsignprod6x01234567));
        const __m128i vsignprod6x89ABCDEF = _mm_cmpgt_epi16(_mm_setzero_si128(), vprod89ABCDEF);
        vacc89AB = _mm_add_epi32(vacc89AB, _mm_unpacklo_epi16(vprod89ABCDEF, vsignprod6x89ABCDEF));
        vaccCDEF = _mm_add_epi32(vaccCDEF, _mm_unpackhi_epi16(vprod89ABCDEF, vsignprod6x89ABCDEF));

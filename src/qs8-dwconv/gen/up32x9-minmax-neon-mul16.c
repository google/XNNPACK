    ...
    const union xnn_qs8_gemm_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN
{
  ...
  do {
    ...
    for (; c >= 32; c -= 32) {
      ...
      vaccOPQR = vqrdmulhq_s32(vaccOPQR, vmultiplier);
      vaccSTUV = vqrdmulhq_s32(vaccSTUV, vmultiplier);
      ...
      vaccOPQR = vcltq_s32(vaccOPQR, vbicq_s32(vaccOPQR, vzero_shift_mask), vmovq_n_s32(0));
      vaccSTUV = vcltq_s32(vaccSTUV, vbicq_s32(vaccSTUV, vzero_shift_mask), vmovq_n_s32(0));

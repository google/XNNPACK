...
void xnn_x16_packw_gemm_goi_ukernel_x16__avx512skx_u16_prfm(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (; n >= 16; n -= 16) {
      if XNN_LIKELY(b != NULL) {
        ...
        _mm256_storeu_si256((__m256i*) (packed_w + 0), vb0);
        b += 16;
      } else {
      ...
      for (; k >= 16; k -= 16) {
        ...
        const __m512i out_0 = _mm512_shuffle_i32x4(w0, w0, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_8 = _mm512_shuffle_i32x4(w0, w0, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 0), _mm512_castsi512_si256(out_0));
        _mm256_storeu_si256((__m256i*) (packed_w + 128), _mm512_castsi512_si256(out_8));
        const __m512i out_1 = _mm512_shuffle_i32x4(w1, w1, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_9 = _mm512_shuffle_i32x4(w1, w1, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 16), _mm512_castsi512_si256(out_1));
        _mm256_storeu_si256((__m256i*) (packed_w + 144), _mm512_castsi512_si256(out_9));
        const __m512i out_2 = _mm512_shuffle_i32x4(w2, w2, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_10 = _mm512_shuffle_i32x4(w2, w2, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 32), _mm512_castsi512_si256(out_2));
        _mm256_storeu_si256((__m256i*) (packed_w + 160), _mm512_castsi512_si256(out_10));
        const __m512i out_3 = _mm512_shuffle_i32x4(w3, w3, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_11 = _mm512_shuffle_i32x4(w3, w3, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 48), _mm512_castsi512_si256(out_3));
        _mm256_storeu_si256((__m256i*) (packed_w + 176), _mm512_castsi512_si256(out_11));
        const __m512i out_4 = _mm512_shuffle_i32x4(w4, w4, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_12 = _mm512_shuffle_i32x4(w4, w4, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 64), _mm512_castsi512_si256(out_4));
        _mm256_storeu_si256((__m256i*) (packed_w + 192), _mm512_castsi512_si256(out_12));
        const __m512i out_5 = _mm512_shuffle_i32x4(w5, w5, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_13 = _mm512_shuffle_i32x4(w5, w5, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 80), _mm512_castsi512_si256(out_5));
        _mm256_storeu_si256((__m256i*) (packed_w + 208), _mm512_castsi512_si256(out_13));
        const __m512i out_6 = _mm512_shuffle_i32x4(w6, w6, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_14 = _mm512_shuffle_i32x4(w6, w6, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 96), _mm512_castsi512_si256(out_6));
        _mm256_storeu_si256((__m256i*) (packed_w + 224), _mm512_castsi512_si256(out_14));
        const __m512i out_7 = _mm512_shuffle_i32x4(w7, w7, _MM_SHUFFLE(2, 0, 2, 0));
        const __m512i out_15 = _mm512_shuffle_i32x4(w7, w7, _MM_SHUFFLE(3, 1, 3, 1));
        _mm256_storeu_si256((__m256i*) (packed_w + 112), _mm512_castsi512_si256(out_7));
        _mm256_storeu_si256((__m256i*) (packed_w + 240), _mm512_castsi512_si256(out_15));
        packed_w += 256;
      }
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      for (; k >= 16; k -= 16) {
        ...
        const __m256i v7 = _mm256_loadu_si256((const __m256i*) w7);
        w7 += 16;
        const __m256i v15 = _mm256_setzero_si256();
        __m512i z7 = _mm512_inserti64x4(_mm512_castsi256_si512(v7), v15, 1);

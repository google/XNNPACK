      ...
      if XNN_UNLIKELY(k != 0) {
        switch (k) {
          ...
          case 1:
          {
            ...
            uint16x4_t vtmp0x89AB = vdup_n_u16(0);
            uint16x4_t vtmp0xCDEF = vdup_n_u16(0);
            vtmp0x0123 = vld1_lane_u16(w0, vtmp0x0123, 0);
            vtmp0x4567 = vld1_lane_u16(w4, vtmp0x4567, 0);
            vtmp0x89AB = vld1_lane_u16(w8, vtmp0x89AB, 0);
            vtmp0xCDEF = vld1_lane_u16(w12, vtmp0xCDEF, 0);
            vtmp0x0123 = vld1_lane_u16(w1, vtmp0x0123, 1);
            vtmp0x4567 = vld1_lane_u16(w5, vtmp0x4567, 1);
            vtmp0x89AB = vld1_lane_u16(w9, vtmp0x89AB, 1);
            vtmp0xCDEF = vld1_lane_u16(w13, vtmp0xCDEF, 1);
            vtmp0x0123 = vld1_lane_u16(w2, vtmp0x0123, 2);
            vtmp0x4567 = vld1_lane_u16(w6, vtmp0x4567, 2);
            vtmp0x89AB = vld1_lane_u16(w10, vtmp0x89AB, 2);
            vtmp0xCDEF = vld1_lane_u16(w14, vtmp0xCDEF, 2);
            vtmp0x0123 = vld1_lane_u16(w3, vtmp0x0123, 3);
            vtmp0x4567 = vld1_lane_u16(w7, vtmp0x4567, 3);
            vtmp0x89AB = vld1_lane_u16(w11, vtmp0x89AB, 3);
            vst1_u16(packed_weights, vtmp0x0123); packed_weights += 4;
            vst1_u16(packed_weights, vtmp0x4567); packed_weights += 4;
            vst1_u16(packed_weights, vtmp0x89AB); packed_weights += 4;
            vst1_u16(packed_weights, vtmp0xCDEF); packed_weights += 4;
          ...
          case 2:
          {
            ...
            vtmp01xCDEF.val[0] = vdup_n_u16(0);
            vtmp01xCDEF.val[1] = vdup_n_u16(0);
            vtmp01x0123 = vld2_lane_u16(w0, vtmp01x0123, 0);
            vtmp01x4567 = vld2_lane_u16(w4, vtmp01x4567, 0);
            vtmp01x89AB = vld2_lane_u16(w8, vtmp01x89AB, 0);
            vtmp01xCDEF = vld2_lane_u16(w12, vtmp01xCDEF, 0);
            vtmp01x0123 = vld2_lane_u16(w1, vtmp01x0123, 1);
            vtmp01x4567 = vld2_lane_u16(w5, vtmp01x4567, 1);
            vtmp01x89AB = vld2_lane_u16(w9, vtmp01x89AB, 1);
            vtmp01xCDEF = vld2_lane_u16(w13, vtmp01xCDEF, 1);
            vtmp01x0123 = vld2_lane_u16(w2, vtmp01x0123, 2);
            vtmp01x4567 = vld2_lane_u16(w6, vtmp01x4567, 2);
            vtmp01x89AB = vld2_lane_u16(w10, vtmp01x89AB, 2);
            vtmp01xCDEF = vld2_lane_u16(w14, vtmp01xCDEF, 2);
            vtmp01x0123 = vld2_lane_u16(w3, vtmp01x0123, 3);
            vtmp01x4567 = vld2_lane_u16(w7, vtmp01x4567, 3);
            vtmp01x89AB = vld2_lane_u16(w11, vtmp01x89AB, 3);
            vst1_u16(packed_weights, vtmp01x0123.val[0]); packed_weights += 4;
            vst1_u16(packed_weights, vtmp01x4567.val[0]); packed_weights += 4;
            vst1_u16(packed_weights, vtmp01x89AB.val[0]); packed_weights += 4;
            vst1_u16(packed_weights, vtmp01xCDEF.val[0]); packed_weights += 4;
          ...
          case 3:
          {
            ...
            vtmp012xCDEF.val[1] = vdup_n_u16(0);
            vtmp012xCDEF.val[2] = vdup_n_u16(0);
            vtmp012x0123 = vld3_lane_u16(w0, vtmp012x0123, 0);
            vtmp012x4567 = vld3_lane_u16(w4, vtmp012x4567, 0);
            vtmp012x89AB = vld3_lane_u16(w8, vtmp012x89AB, 0);
            vtmp012xCDEF = vld3_lane_u16(w12, vtmp012xCDEF, 0);
            vtmp012x0123 = vld3_lane_u16(w1, vtmp012x0123, 1);
            vtmp012x4567 = vld3_lane_u16(w5, vtmp012x4567, 1);
            vtmp012x89AB = vld3_lane_u16(w9, vtmp012x89AB, 1);
            vtmp012xCDEF = vld3_lane_u16(w13, vtmp012xCDEF, 1);
            vtmp012x0123 = vld3_lane_u16(w2, vtmp012x0123, 2);
            vtmp012x4567 = vld3_lane_u16(w6, vtmp012x4567, 2);
            vtmp012x89AB = vld3_lane_u16(w10, vtmp012x89AB, 2);
            vtmp012xCDEF = vld3_lane_u16(w14, vtmp012xCDEF, 2);
            vtmp012x0123 = vld3_lane_u16(w3, vtmp012x0123, 3);
            vtmp012x4567 = vld3_lane_u16(w7, vtmp012x4567, 3);
            vtmp012x89AB = vld3_lane_u16(w11, vtmp012x89AB, 3);
            vst1_u16(packed_weights, vtmp012x0123.val[0]); packed_weights += 4;
            vst1_u16(packed_weights, vtmp012x4567.val[0]); packed_weights += 4;
            vst1_u16(packed_weights, vtmp012x89AB.val[0]); packed_weights += 4;
            vst1_u16(packed_weights, vtmp012xCDEF.val[0]); packed_weights += 4;

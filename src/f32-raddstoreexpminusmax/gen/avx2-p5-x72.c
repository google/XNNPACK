...
//   Template: src/f32-raddstoreexpminusmax/avx2-p5.c.in
...
void xnn_f32_raddstoreexpminusmax_ukernel__avx2_p5_x72(
    size_t elements,
    const float* input,
    float* output,
    float* sum,
    float max)
{
  ...
  for (; elements >= 72 * sizeof(float); elements -= 72 * sizeof(float)) {

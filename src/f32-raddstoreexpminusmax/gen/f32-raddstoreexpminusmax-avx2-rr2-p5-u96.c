...
void xnn_f32_raddstoreexpminusmax_ukernel__avx2_rr2_p5_u96(
    size_t batch,
    const float* input,
    const float* max,
    float* output,
    ...
    const struct xnn_f32_expminus_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 96 * sizeof(float); batch -= 96 * sizeof(float)) {
    ...
    __m256 vn4 = _mm256_add_ps(_mm256_mul_ps(vx4, vlog2e), vmagic_bias);
    __m256 vn5 = _mm256_add_ps(_mm256_mul_ps(vx5, vlog2e), vmagic_bias);
    __m256 vn6 = _mm256_add_ps(_mm256_mul_ps(vx6, vlog2e), vmagic_bias);
    __m256 vn7 = _mm256_add_ps(_mm256_mul_ps(vx7, vlog2e), vmagic_bias);
    __m256 vn8 = _mm256_add_ps(_mm256_mul_ps(vx8, vlog2e), vmagic_bias);
    __m256 vn9 = _mm256_add_ps(_mm256_mul_ps(vx9, vlog2e), vmagic_bias);
    __m256 vn10 = _mm256_add_ps(_mm256_mul_ps(vx10, vlog2e), vmagic_bias);
    __m256 vn11 = _mm256_add_ps(_mm256_mul_ps(vx11, vlog2e), vmagic_bias);
    ...
    __m256 vt4 = _mm256_add_ps(_mm256_mul_ps(vn4, vminus_ln2_hi), vx4);
    __m256 vt5 = _mm256_add_ps(_mm256_mul_ps(vn5, vminus_ln2_hi), vx5);
    __m256 vt6 = _mm256_add_ps(_mm256_mul_ps(vn6, vminus_ln2_hi), vx6);
    __m256 vt7 = _mm256_add_ps(_mm256_mul_ps(vn7, vminus_ln2_hi), vx7);
    __m256 vt8 = _mm256_add_ps(_mm256_mul_ps(vn8, vminus_ln2_hi), vx8);
    __m256 vt9 = _mm256_add_ps(_mm256_mul_ps(vn9, vminus_ln2_hi), vx9);
    __m256 vt10 = _mm256_add_ps(_mm256_mul_ps(vn10, vminus_ln2_hi), vx10);
    __m256 vt11 = _mm256_add_ps(_mm256_mul_ps(vn11, vminus_ln2_hi), vx11);
    ...
    vt10 = _mm256_add_ps(_mm256_mul_ps(vn10, vminus_ln2_lo), vt10);
    vt11 = _mm256_add_ps(_mm256_mul_ps(vn11, vminus_ln2_lo), vt11);
    ...
    __m256 vp10 = _mm256_add_ps(_mm256_mul_ps(vc5, vt10), vc4);
    __m256 vp11 = _mm256_add_ps(_mm256_mul_ps(vc5, vt11), vc4);
    ...
    vp10 = _mm256_add_ps(_mm256_mul_ps(vp10, vt10), vc3);
    vp11 = _mm256_add_ps(_mm256_mul_ps(vp11, vt11), vc3);
    ...
    vp10 = _mm256_add_ps(_mm256_mul_ps(vp10, vt10), vc2);
    vp11 = _mm256_add_ps(_mm256_mul_ps(vp11, vt11), vc2);
    ...
    vp10 = _mm256_add_ps(_mm256_mul_ps(vp10, vt10), vc1);
    vp11 = _mm256_add_ps(_mm256_mul_ps(vp11, vt11), vc1);
    ...
    __m256 vf4 = _mm256_add_ps(_mm256_mul_ps(vt4, vp4), vs4);
    __m256 vf5 = _mm256_add_ps(_mm256_mul_ps(vt5, vp5), vs5);
    __m256 vf6 = _mm256_add_ps(_mm256_mul_ps(vt6, vp6), vs6);
    __m256 vf7 = _mm256_add_ps(_mm256_mul_ps(vt7, vp7), vs7);
    __m256 vf8 = _mm256_add_ps(_mm256_mul_ps(vt8, vp8), vs8);
    __m256 vf9 = _mm256_add_ps(_mm256_mul_ps(vt9, vp9), vs9);
    __m256 vf10 = _mm256_add_ps(_mm256_mul_ps(vt10, vp10), vs10);
    __m256 vf11 = _mm256_add_ps(_mm256_mul_ps(vt11, vp11), vs11);
    ...
    // Store 96 (12x4) outputs at a time.

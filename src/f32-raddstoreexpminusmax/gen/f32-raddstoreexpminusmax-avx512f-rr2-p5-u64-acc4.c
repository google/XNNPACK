...
void xnn_f32_raddstoreexpminusmax_ukernel__avx512f_rr2_p5_u64_acc4(
    size_t batch,
    const float* input,
    const float* max,
    float* output,
    ...
    const struct xnn_f32_expminus_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    __m512 vn2 = _mm512_add_ps(_mm512_mul_ps(vx2, vlog2e), vmagic_bias);
    __m512 vn3 = _mm512_add_ps(_mm512_mul_ps(vx3, vlog2e), vmagic_bias);
    ...
    __m512 vt2 = _mm512_add_ps(_mm512_mul_ps(vn2, vminus_ln2_hi), vx2);
    __m512 vt3 = _mm512_add_ps(_mm512_mul_ps(vn3, vminus_ln2_hi), vx3);

    vt0 = _mm512_add_ps(_mm512_mul_ps(vn0, vminus_ln2_lo), vt0);
    vt1 = _mm512_add_ps(_mm512_mul_ps(vn1, vminus_ln2_lo), vt1);
    vt2 = _mm512_add_ps(_mm512_mul_ps(vn2, vminus_ln2_lo), vt2);
    vt3 = _mm512_add_ps(_mm512_mul_ps(vn3, vminus_ln2_lo), vt3);

    // Compute degree-5 polynomial approximation for exp(t) on [-log(2)/2, log(2)/2].
    __m512 vp0 = _mm512_add_ps(_mm512_mul_ps(vc5, vt0), vc4);
    __m512 vp1 = _mm512_add_ps(_mm512_mul_ps(vc5, vt1), vc4);
    __m512 vp2 = _mm512_add_ps(_mm512_mul_ps(vc5, vt2), vc4);
    __m512 vp3 = _mm512_add_ps(_mm512_mul_ps(vc5, vt3), vc4);

    vp0 = _mm512_add_ps(_mm512_mul_ps(vp0, vt0), vc3);
    vp1 = _mm512_add_ps(_mm512_mul_ps(vp1, vt1), vc3);
    vp2 = _mm512_add_ps(_mm512_mul_ps(vp2, vt2), vc3);
    vp3 = _mm512_add_ps(_mm512_mul_ps(vp3, vt3), vc3);

    vp0 = _mm512_add_ps(_mm512_mul_ps(vp0, vt0), vc2);
    vp1 = _mm512_add_ps(_mm512_mul_ps(vp1, vt1), vc2);
    vp2 = _mm512_add_ps(_mm512_mul_ps(vp2, vt2), vc2);
    vp3 = _mm512_add_ps(_mm512_mul_ps(vp3, vt3), vc2);

    vp0 = _mm512_add_ps(_mm512_mul_ps(vp0, vt0), vc1);
    vp1 = _mm512_add_ps(_mm512_mul_ps(vp1, vt1), vc1);
    vp2 = _mm512_add_ps(_mm512_mul_ps(vp2, vt2), vc1);
    vp3 = _mm512_add_ps(_mm512_mul_ps(vp3, vt3), vc1);
    ...
    __m512 vf2 = _mm512_add_ps(_mm512_mul_ps(vt2, vp2), vs2);
    __m512 vf3 = _mm512_add_ps(_mm512_mul_ps(vt3, vp3), vs3);

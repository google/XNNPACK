...
void xnn_f32_raddstoreexpminusmax_ukernel__hvx_rr2_p5_u128_acc3(
    size_t batch,
    const float* input,
    const float* max,
    float* output,
    ...
    const union xnn_f32_expminus_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 128 * sizeof(float); batch -= 128 * sizeof(float)) {
    ...
    *((HVX_UVector *)(output + 96)) = vf3;
    ...
    vacc2 = Q6_Vsf_vadd_VsfVsf(vacc2, vf1);
    vacc1 = Q6_Vsf_vadd_VsfVsf(vacc1, vf2);
    vacc0 = Q6_Vsf_vadd_VsfVsf(vacc0, vf3);
  }
  vacc0 = Q6_Vsf_vadd_VsfVsf(vacc0, vacc1);
  vacc0 = Q6_Vsf_vadd_VsfVsf(vacc0, vacc2);

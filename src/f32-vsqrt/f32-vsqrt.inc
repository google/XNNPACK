...
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__sse2_sqrt_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__sse2_sqrt_u8, 8, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__sse2_sqrt_u16, 16, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__sse2_rsqrt_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__sse2_rsqrt_u8, 8, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__sse2_rsqrt_u16, 16, false, float, struct xnn_f32_default_params, NULL)
...
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__wasmsimd_sqrt_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__wasmsimd_sqrt_u8, 8, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__wasmsimd_sqrt_u16, 16, false, float, struct xnn_f32_default_params, NULL)
#endif  // XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD

XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__scalar_sqrt_u1, 1, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__scalar_sqrt_u2, 2, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsqrt_ukernel__scalar_sqrt_u4, 4, false, float, struct xnn_f32_default_params, NULL)

...
void xnn_f32_vsqrt_ukernel__avx512f_sqrt_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= xnn_simd_bytes_f32; batch -= xnn_simd_bytes_f32) {
    xnn_simd_f32_t vx = xnn_loadu_f32(input); input += 16;
    xnn_simd_f32_t vy = xnn_sqrt_f32(vx);
    xnn_storeu_f32(output, vy); output += 16;
  }
...
void xnn_f32_vsqrt_ukernel__avx512f_sqrt_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vsqrt_ukernel__avx512f_sqrt_u48(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)

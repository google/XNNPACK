...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_s8_vclamp_ukernel__neon_u64, 64, false, int8_t, struct xnn_s8_minmax_params, xnn_init_s8_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(0, xnn_s8_vclamp_ukernel__scalar_u4, 4, false, int8_t, struct xnn_s8_minmax_params, xnn_init_s8_minmax_scalar_params)

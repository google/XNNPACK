...
void xnn_s8_vclamp_ukernel__sse2_u64(
  ...
  const __m128i voutput_max_with_bias =
      _mm_set1_epi8(UINT8_C(0x80) ^ params->scalar.max);
  const __m128i voutput_min_with_bias =
      _mm_set1_epi8(UINT8_C(0x80) ^ params->scalar.min);

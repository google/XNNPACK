    ...
    const struct xnn_qs8_rsum_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; channels >= 64; channels -= 64) {
    ...
    __m256i vaccWXYZabcd = _mm256_setzero_si256();
    __m256i vaccerfghijl = _mm256_setzero_si256();
    __m256i vaccmnopqrst = _mm256_setzero_si256();
    __m256i vaccuvqxyz01 = _mm256_setzero_si256();
    ...
    while (r > 0) {
      ...
      __m256i vacc16_mnopqrstuvqxyz01 = _mm256_setzero_si256();
      for (int current_batch = min(r, 252); current_batch > 0; current_batch -= 7) {
        ...
        __m256i vinWXYZabcderfghijl;
        __m256i vinmnopqrstuvqxyz01;
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i0[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i0[48]));
        ...
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i1[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i1[48]));
        vacc16_0123456789ABCDEF = _mm256_add_epi16(vacc16_0123456789ABCDEF, vin0123456789ABCDEF);
        vacc16_GHIJKLMNOPQRSTUV = _mm256_add_epi16(vacc16_GHIJKLMNOPQRSTUV, vinGHIJKLMNOPQRSTUV);
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i2[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i2[48]));
        vacc16_0123456789ABCDEF = _mm256_add_epi16(vacc16_0123456789ABCDEF, vin0123456789ABCDEF);
        vacc16_GHIJKLMNOPQRSTUV = _mm256_add_epi16(vacc16_GHIJKLMNOPQRSTUV, vinGHIJKLMNOPQRSTUV);
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i3[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i3[48]));
        vacc16_0123456789ABCDEF = _mm256_add_epi16(vacc16_0123456789ABCDEF, vin0123456789ABCDEF);
        vacc16_GHIJKLMNOPQRSTUV = _mm256_add_epi16(vacc16_GHIJKLMNOPQRSTUV, vinGHIJKLMNOPQRSTUV);
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i4[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i4[48]));
        vacc16_0123456789ABCDEF = _mm256_add_epi16(vacc16_0123456789ABCDEF, vin0123456789ABCDEF);
        vacc16_GHIJKLMNOPQRSTUV = _mm256_add_epi16(vacc16_GHIJKLMNOPQRSTUV, vinGHIJKLMNOPQRSTUV);
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i5[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i5[48]));
        vacc16_0123456789ABCDEF = _mm256_add_epi16(vacc16_0123456789ABCDEF, vin0123456789ABCDEF);
        vacc16_GHIJKLMNOPQRSTUV = _mm256_add_epi16(vacc16_GHIJKLMNOPQRSTUV, vinGHIJKLMNOPQRSTUV);
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
        ...
        vinWXYZabcderfghijl = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i6[32]));
        vinmnopqrstuvqxyz01 = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i*) &i6[48]));
        vacc16_0123456789ABCDEF = _mm256_add_epi16(vacc16_0123456789ABCDEF, vin0123456789ABCDEF);
        vacc16_GHIJKLMNOPQRSTUV = _mm256_add_epi16(vacc16_GHIJKLMNOPQRSTUV, vinGHIJKLMNOPQRSTUV);
        vacc16_WXYZabcderfghijl = _mm256_add_epi16(vacc16_WXYZabcderfghijl, vinWXYZabcderfghijl);
        vacc16_mnopqrstuvqxyz01 = _mm256_add_epi16(vacc16_mnopqrstuvqxyz01, vinmnopqrstuvqxyz01);
      ...
      vaccWXYZabcd = _mm256_add_epi32(vaccWXYZabcd, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vacc16_WXYZabcderfghijl)));
      vaccerfghijl = _mm256_add_epi32(vaccerfghijl, _mm256_cvtepi16_epi32(_mm256_extractf128_si256(vacc16_WXYZabcderfghijl, 1)));
      vaccmnopqrst = _mm256_add_epi32(vaccmnopqrst, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vacc16_mnopqrstuvqxyz01)));
      vaccuvqxyz01 = _mm256_add_epi32(vaccuvqxyz01, _mm256_cvtepi16_epi32(_mm256_extractf128_si256(vacc16_mnopqrstuvqxyz01, 1)));
      r = doz(r, 252);
    }
    ...
    __m256i voWXYZabcd = _mm256_loadu_si256((const __m256i*) o); o += 8;
    __m256i voerfghijl = _mm256_loadu_si256((const __m256i*) o); o += 8;
    __m256i vomnopqrst = _mm256_loadu_si256((const __m256i*) o); o += 8;
    __m256i vouvqxyz01 = _mm256_loadu_si256((const __m256i*) o); o += 8;
    ...
    voWXYZabcd = _mm256_add_epi32(voWXYZabcd, vaccWXYZabcd);
    voerfghijl = _mm256_add_epi32(voerfghijl, vaccerfghijl);
    vomnopqrst = _mm256_add_epi32(vomnopqrst, vaccmnopqrst);
    vouvqxyz01 = _mm256_add_epi32(vouvqxyz01, vaccuvqxyz01);
    ...
    _mm256_storeu_si256((__m256i*) output, voWXYZabcd); output += 8;
    _mm256_storeu_si256((__m256i*) output, voerfghijl); output += 8;
    _mm256_storeu_si256((__m256i*) output, vomnopqrst); output += 8;
    _mm256_storeu_si256((__m256i*) output, vouvqxyz01); output += 8;

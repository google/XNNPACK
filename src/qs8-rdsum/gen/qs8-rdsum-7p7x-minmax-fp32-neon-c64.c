    ...
    const union xnn_qs8_rsum_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; channels >= 64; channels -= 64) {
    ...
    int32x4_t vaccWXYZ = vdupq_n_s32(0);
    int32x4_t vaccabcd = vdupq_n_s32(0);
    int32x4_t vaccerfg = vdupq_n_s32(0);
    int32x4_t vacchijl = vdupq_n_s32(0);
    int32x4_t vaccmnop = vdupq_n_s32(0);
    int32x4_t vaccqrst = vdupq_n_s32(0);
    int32x4_t vaccuvqx = vdupq_n_s32(0);
    int32x4_t vaccyz01 = vdupq_n_s32(0);
    ...
    int32x4_t voWXYZ = vld1q_s32(o); o += 4;
    int32x4_t voabcd = vld1q_s32(o); o += 4;
    int32x4_t voerfg = vld1q_s32(o); o += 4;
    int32x4_t vohijl = vld1q_s32(o); o += 4;
    int32x4_t vomnop = vld1q_s32(o); o += 4;
    int32x4_t voqrst = vld1q_s32(o); o += 4;
    int32x4_t vouvqx = vld1q_s32(o); o += 4;
    int32x4_t voyz01 = vld1q_s32(o); o += 4;
    ...
    vaccWXYZ = vaddq_s32(voWXYZ, vaccWXYZ);
    vaccabcd = vaddq_s32(voabcd, vaccabcd);
    vaccerfg = vaddq_s32(voerfg, vaccerfg);
    vacchijl = vaddq_s32(vohijl, vacchijl);
    vaccmnop = vaddq_s32(vomnop, vaccmnop);
    vaccqrst = vaddq_s32(voqrst, vaccqrst);
    vaccuvqx = vaddq_s32(vouvqx, vaccuvqx);
    vaccyz01 = vaddq_s32(voyz01, vaccyz01);
    ...
    vst1q_s32(output, vaccWXYZ); output += 4;
    vst1q_s32(output, vaccabcd); output += 4;
    vst1q_s32(output, vaccerfg); output += 4;
    vst1q_s32(output, vacchijl); output += 4;
    vst1q_s32(output, vaccmnop); output += 4;
    vst1q_s32(output, vaccqrst); output += 4;
    vst1q_s32(output, vaccuvqx); output += 4;
    vst1q_s32(output, vaccyz01); output += 4;

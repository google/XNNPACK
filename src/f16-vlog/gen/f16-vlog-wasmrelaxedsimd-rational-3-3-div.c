...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_3_3_div_u8(
    size_t batch,
...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_3_3_div_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_3_3_div_u24(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_3_3_div_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)

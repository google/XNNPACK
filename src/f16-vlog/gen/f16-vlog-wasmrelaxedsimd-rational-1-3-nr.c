...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_1_3_nr_u8(
    size_t batch,
    ...
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= xnn_simd_bytes_f16; batch -= xnn_simd_bytes_f16) {
    ...
    xnn_simd_f16_t vy = xnn_mul_f16(vp, vrq);
...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_1_3_nr_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 16 * sizeof(uint16_t); batch -= 16 * sizeof(uint16_t)) {
    ...
    xnn_simd_f16_t vrq_0 = xnn_rcp_f16(vq_0);
    xnn_simd_f16_t vrq_1 = xnn_rcp_f16(vq_1);
    for (size_t iter = 0; iter < XNN_SIMD_NUM_RCP_ITER_F16; iter++) {
      vrq_0 = xnn_mul_f16(vrq_0, xnn_fnmadd_f16(vrq_0, vq_0, vtwo));
      vrq_1 = xnn_mul_f16(vrq_1, xnn_fnmadd_f16(vrq_1, vq_1, vtwo));
    }
    xnn_simd_f16_t vy_0 = xnn_mul_f16(vp_0, vrq_0);
    xnn_simd_f16_t vy_1 = xnn_mul_f16(vp_1, vrq_1);
...
void xnn_f16_vlog_ukernel__wasmrelaxedsimd_rational_1_3_nr_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(uint16_t); batch -= 32 * sizeof(uint16_t)) {
    ...
    xnn_simd_f16_t vrq_0 = xnn_rcp_f16(vq_0);
    xnn_simd_f16_t vrq_1 = xnn_rcp_f16(vq_1);
    xnn_simd_f16_t vrq_2 = xnn_rcp_f16(vq_2);
    xnn_simd_f16_t vrq_3 = xnn_rcp_f16(vq_3);
    for (size_t iter = 0; iter < XNN_SIMD_NUM_RCP_ITER_F16; iter++) {
      vrq_0 = xnn_mul_f16(vrq_0, xnn_fnmadd_f16(vrq_0, vq_0, vtwo));
      vrq_1 = xnn_mul_f16(vrq_1, xnn_fnmadd_f16(vrq_1, vq_1, vtwo));
      vrq_2 = xnn_mul_f16(vrq_2, xnn_fnmadd_f16(vrq_2, vq_2, vtwo));
      vrq_3 = xnn_mul_f16(vrq_3, xnn_fnmadd_f16(vrq_3, vq_3, vtwo));
    }
    xnn_simd_f16_t vy_0 = xnn_mul_f16(vp_0, vrq_0);
    xnn_simd_f16_t vy_1 = xnn_mul_f16(vp_1, vrq_1);
    xnn_simd_f16_t vy_2 = xnn_mul_f16(vp_2, vrq_2);
    xnn_simd_f16_t vy_3 = xnn_mul_f16(vp_3, vrq_3);

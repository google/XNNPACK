...
void xnn_qu8_vmul_minmax_fp32_ukernel__rvv_u16(
    size_t batch,
    ...
    const union xnn_qu8_mul_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vuint8m1_t in_b_u8v = __riscv_vle8_v_u8m1(input_b, vl); input_b += vl;
    vuint16m2_t a_u16v = __riscv_vwsubu_vx_u16m2(in_a_u8v, a_zero_point, vl);
    vuint16m2_t b_u16v = __riscv_vwsubu_vx_u16m2(in_b_u8v, b_zero_point, vl);

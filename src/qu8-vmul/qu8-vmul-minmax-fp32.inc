...
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__sse2_mul16_ld64_u8, 8, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__sse2_mul16_ld64_u16, 16, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)
...
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__wasmsimd_mul32_ld64_u8, 8, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__wasmsimd_mul32_ld64_u16, 16, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)
...
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__scalar_u1, 1, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__scalar_u2, 2, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)
XNN_UKERNEL(0, xnn_qu8_vmul_minmax_fp32_ukernel__scalar_u4, 4, false, uint8_t, union xnn_qu8_mul_minmax_params, xnn_init_qu8_mul_minmax_scalar_params)

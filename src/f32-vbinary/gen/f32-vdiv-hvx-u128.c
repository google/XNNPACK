...
void xnn_f32_vdiv_ukernel__hvx_u128(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
    const struct xnn_f32_default_params* restrict params)
{
  ...
  for (; batch >= 128 * sizeof(float); batch -= 128 * sizeof(float)) {
    ...
    HVX_Vector vacc0 = xnn_div_f32(va0, vb0);
    HVX_Vector vacc1 = xnn_div_f32(va1, vb1);
    HVX_Vector vacc2 = xnn_div_f32(va2, vb2);
    HVX_Vector vacc3 = xnn_div_f32(va3, vb3);

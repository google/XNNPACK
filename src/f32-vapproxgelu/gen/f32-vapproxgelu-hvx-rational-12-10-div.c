...
void xnn_f32_vapproxgelu_ukernel__hvx_rational_12_10_div_u32(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vapproxgelu_ukernel__hvx_rational_12_10_div_u64(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vapproxgelu_ukernel__hvx_rational_12_10_div_u128(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])

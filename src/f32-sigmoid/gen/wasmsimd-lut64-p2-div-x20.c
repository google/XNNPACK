    ...
    const void* params) XNN_DISABLE_TSAN
{
  ...
  for (; n >= 20 * sizeof(float); n -= 20 * sizeof(float)) {
    ...
    v128_t vlGH   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) vidxGH));
    v128_t vlIJ = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) vidxIJ));
    vlGH   = __builtin_wasm_load32_lane((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxGH   >> 32)), vlGH,   1);
    vlIJ = __builtin_wasm_load32_lane((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxIJ >> 32)), vlIJ, 1);

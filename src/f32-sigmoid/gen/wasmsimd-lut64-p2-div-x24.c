    ...
    const void* params) XNN_DISABLE_TSAN
{
  ...
  for (; n >= 24 * sizeof(float); n -= 24 * sizeof(float)) {
    ...
    const v128_t vlK   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) vidxKL));
    const v128_t vlM = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) vidxMN));
    const v128_t vlL = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxKL >> 32)));
    const v128_t vlN = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxMN >> 32)));

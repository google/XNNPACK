    ...
    const void* params)
{
  ...
  for (; n >= 128 * sizeof(float); n -= 128 * sizeof(float)) {
    ...
    vf6 = _mm512_mask_sub_ps(vf6, _mm512_movepi32_mask(_mm512_castps_si512(vx6)), vone, vf6);
    vf7 = _mm512_mask_sub_ps(vf7, _mm512_movepi32_mask(_mm512_castps_si512(vx7)), vone, vf7);

    ...
    const void* params) XNN_DISABLE_TSAN
{
  ...
  for (; n >= 24 * sizeof(float); n -= 24 * sizeof(float)) {
    ...
    const __m128i vidxKLMN = _mm_slli_epi32(_mm_and_si128(_mm_castps_si128(vnKLMN), vindex_mask), 2);
      ...
      const __m128i vlGH = _mm_insert_epi32(vlG, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxGH >> 32))), 1);
      const __m128i vlIJ = _mm_insert_epi32(vlI, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxIJ >> 32))), 1);
      ...
      const __m128i vlKL = _mm_insert_epi32(vlK, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxKL >> 32))), 1);
      const __m128i vlMN = _mm_insert_epi32(vlM, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + (uint32_t) (vidxMN >> 32))), 1);
      ...
      const __m128i vlGH = _mm_insert_epi32(vlG, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + vidxH)), 1);
      const __m128i vlIJ = _mm_insert_epi32(vlI, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + vidxJ)), 1);
      const __m128i vlGHIJ = _mm_unpacklo_epi64(vlGH, vlIJ);
      ...
      const __m128i vlKL = _mm_insert_epi32(vlK, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + vidxL)), 1);
      const __m128i vlMN = _mm_insert_epi32(vlM, *((const int*) ((uintptr_t) xnn_table_exp2minus_k_over_64 + vidxN)), 1);
      const __m128i vlKLMN = _mm_unpacklo_epi64(vlKL, vlMN);

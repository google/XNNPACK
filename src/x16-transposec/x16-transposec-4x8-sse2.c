...
void xnn_x16_transposec_ukernel__4x8_sse2(const uint16_t* input,
                                          uint16_t* output, size_t input_stride,
  ...
  const size_t output_reset =
      tile_width * output_stride -
      round_down_po2(block_height, 2) * sizeof(uint16_t);
  ...
  do {
    ...
    if (bh != 0) {
      ...
      if (bh & 2) {
        unaligned_store_u32(
            o7, (uint32_t)_mm_cvtsi128_si32(_mm_shuffle_epi32(v3, 0xE)));
        o7 += 2;
        unaligned_store_u32(o6, (uint32_t)_mm_cvtsi128_si32(v3));
        o6 += 2;
        unaligned_store_u32(
            o5, (uint32_t)_mm_cvtsi128_si32(_mm_shuffle_epi32(v1, 0xE)));
        o5 += 2;
        unaligned_store_u32(o4, (uint32_t)_mm_cvtsi128_si32(v1));
        o4 += 2;
        unaligned_store_u32(
            o3, (uint32_t)_mm_cvtsi128_si32(_mm_shuffle_epi32(v2, 0xE)));
        o3 += 2;
        unaligned_store_u32(o2, (uint32_t)_mm_cvtsi128_si32(v2));
        o2 += 2;
        unaligned_store_u32(
            o1, (uint32_t)_mm_cvtsi128_si32(_mm_shuffle_epi32(v0, 0xE)));
        o1 += 2;

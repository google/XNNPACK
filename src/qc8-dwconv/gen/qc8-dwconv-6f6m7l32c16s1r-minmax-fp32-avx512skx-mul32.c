...
void xnn_qc8_dwconv_minmax_fp32_ukernel_6f6m7l32c16s1r__avx512skx_mul32(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 6 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 32 * sizeof(int32_t) + 192 * sizeof(int8_t));
    ...
    for (size_t ks = kernel_size - 6; ks > 7; ks -= 6) {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 192 * sizeof(int8_t));
    ...
    // Last pass to process up to 7 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 224 * sizeof(int8_t));
      ...
      if XNN_UNLIKELY(c != 0) {
        ...
        do {
          ...
          __m512 vscaled0123456789ABCDEF = _mm512_cvtepi32_ps(vacc0123456789ABCDEF);
          const __m512 vscale0123456789ABCDEF = _mm512_loadu_ps((const void*) ((uintptr_t) w + 112 * sizeof(int8_t)));
          vscaled0123456789ABCDEF = _mm512_mul_ps(vscaled0123456789ABCDEF, vscale0123456789ABCDEF);
          vscaled0123456789ABCDEF = _mm512_min_ps(vscaled0123456789ABCDEF, voutput_max_less_zero_point);
          vacc0123456789ABCDEF = _mm512_cvtps_epi32(vscaled0123456789ABCDEF);

    ...
    const union xnn_f32_elu_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 24 * sizeof(float); batch -= 24 * sizeof(float)) {
    ...
    vtKLMN = wasm_f32x4_add(vtKLMN, wasm_f32x4_mul(vnKLMN, vminus_ln2_lo));
    ...
    v128_t vpKLMN = wasm_f32x4_add(vc5, wasm_f32x4_mul(vc6, vtKLMN));
    ...
    vpKLMN = wasm_f32x4_add(vc4, wasm_f32x4_mul(vpKLMN, vtKLMN));
    ...
    vpKLMN = wasm_f32x4_add(vc3, wasm_f32x4_mul(vpKLMN, vtKLMN));
    ...
    vpKLMN = wasm_f32x4_add(vc2, wasm_f32x4_mul(vpKLMN, vtKLMN));

...
//   Template: src/math/f32-tanh-avx2-expm1.c.in
...
void xnn_math_f32_tanh__avx2_expm1_rr1_lut8_p4h3_gather_nr1adj(
    size_t n,
    const float* input,
    float* output)
{
  ...
  for (; n != 0; n -= sizeof(__m256)) {
    ...
    const __m256 verep1 = _mm256_fnmsub_ps(vrep1, vep1, vminus_one);
    vrep1 = _mm256_fmadd_ps(verep1, vrep1, vrep1);

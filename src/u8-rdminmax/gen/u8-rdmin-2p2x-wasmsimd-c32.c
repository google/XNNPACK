...
void xnn_u8_rdmin_ukernel_2p2x__wasmsimd_c32(
    size_t rows,
    size_t channels,
    const uint8_t* input,
    size_t input_stride,
    ...
    const void* params) XNN_OOB_READS
{
  ...
  for (; channels >= 32; channels -= 32) {
    ...
    xnn_simd_u8_t vmin16 = xnn_loadu_u8(output + 16 * sizeof(uint8_t));;
    ...
    for (int r = rows; r > 0; r -= 2) {
      ...
      vmin16 = xnn_min_u8(vmin16, vin_0_16);
      vmin0 = xnn_min_u8(vmin0, vin_1_0);
      vmin16 = xnn_min_u8(vmin16, vin_1_16);

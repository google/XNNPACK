...
XNN_UKERNEL_WITH_PARAMS(XNN_ARCH_WASMRELAXEDSIMD, xnn_f32_ibilinear_ukernel__wasmrelaxedsimd_c4, 4, 1, float, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(XNN_ARCH_WASMRELAXEDSIMD, xnn_f32_ibilinear_ukernel__wasmrelaxedsimd_c8, 8, 1, float, float, struct xnn_f32_default_params, NULL)

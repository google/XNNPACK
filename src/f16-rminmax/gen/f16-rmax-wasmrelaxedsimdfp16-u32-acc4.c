...
void xnn_f16_rmax_ukernel__wasmrelaxedsimdfp16_u32_acc4(
    size_t batch,
    ...
    const struct xnn_f16_default_params* restrict params)
{
  ...
  xnn_simd_f16_t vmax2 = vmax0;
  xnn_simd_f16_t vmax3 = vmax0;

  for (; batch >= 32 * sizeof(uint16_t); batch -= 32 * sizeof(uint16_t)) {
    const xnn_simd_f16_t vt0 = xnn_loadu_f16(input + 0);
    const xnn_simd_f16_t vt1 = xnn_loadu_f16(input + 8);
    const xnn_simd_f16_t vt2 = xnn_loadu_f16(input + 16);
    const xnn_simd_f16_t vt3 = xnn_loadu_f16(input + 24);
    input += 32;

    vmax0 = xnn_max_f16(vmax0, vt0);
    vmax1 = xnn_max_f16(vmax1, vt1);
    vmax2 = xnn_max_f16(vmax2, vt2);
    vmax3 = xnn_max_f16(vmax3, vt3);
  }
  vmax0 = xnn_max_f16(vmax0, vmax1);
  vmax2 = xnn_max_f16(vmax2, vmax3);
  vmax0 = xnn_max_f16(vmax0, vmax2);

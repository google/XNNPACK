...
void xnn_f16_rminmax_ukernel__neonfp16arith_u64(
    size_t batch,
    const void* input,
    void* output,
    const union xnn_f16_default_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 64 * sizeof(uint16_t); batch -= 64 * sizeof(uint16_t)) {
    ...
    const float16x8_t vt4 = vreinterpretq_f16_u16(vld1q_u16(i)); i += 8;
    const float16x8_t vt5 = vreinterpretq_f16_u16(vld1q_u16(i)); i += 8;
    const float16x8_t vt6 = vreinterpretq_f16_u16(vld1q_u16(i)); i += 8;
    const float16x8_t vt7 = vreinterpretq_f16_u16(vld1q_u16(i)); i += 8;
    ...
    vmin0 = vminq_f16(vmin0, vt4);
    vmax0 = vmaxq_f16(vmax0, vt4);
    vmin0 = vminq_f16(vmin0, vt5);
    vmax0 = vmaxq_f16(vmax0, vt5);
    vmin0 = vminq_f16(vmin0, vt6);
    vmax0 = vmaxq_f16(vmax0, vt6);
    vmin0 = vminq_f16(vmin0, vt7);
    vmax0 = vmaxq_f16(vmax0, vt7);
  }

...
void xnn_qd8_f16_qc8w_gemm_minmax_ukernel_6x32c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vksumzp1xGHIJ = vmulq_s32(vksumGHIJ, vinput_zero_point12);
    const int32x4_t vksumzp1xKLMN = vmulq_s32(vksumKLMN, vinput_zero_point12);
    const int32x4_t vksumzp1xOPQR = vmulq_s32(vksumOPQR, vinput_zero_point12);
    const int32x4_t vksumzp1xSTUV = vmulq_s32(vksumSTUV, vinput_zero_point12);
    ...
    const int32x4_t vinput_zero_point34 = vdupq_n_s32(qp3->zero_point);
    const int32x4_t vksumzp3x0123 = vmulq_s32(vksum0123, vinput_zero_point34);
    const int32x4_t vksumzp3x4567 = vmulq_s32(vksum4567, vinput_zero_point34);
    const int32x4_t vksumzp3x89AB = vmulq_s32(vksum89AB, vinput_zero_point34);
    const int32x4_t vksumzp3xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point34);
    const int32x4_t vksumzp3xGHIJ = vmulq_s32(vksumGHIJ, vinput_zero_point34);
    const int32x4_t vksumzp3xKLMN = vmulq_s32(vksumKLMN, vinput_zero_point34);
    const int32x4_t vksumzp3xOPQR = vmulq_s32(vksumOPQR, vinput_zero_point34);
    const int32x4_t vksumzp3xSTUV = vmulq_s32(vksumSTUV, vinput_zero_point34);
    const int32x4_t vinput_zero_point45 = vdupq_n_s32(qp4->zero_point);
    ...
    const int32x4_t vinput_zero_point56 = vdupq_n_s32(qp5->zero_point);
    const int32x4_t vksumzp5x0123 = vmulq_s32(vksum0123, vinput_zero_point56);
    const int32x4_t vksumzp5x4567 = vmulq_s32(vksum4567, vinput_zero_point56);
    const int32x4_t vksumzp5x89AB = vmulq_s32(vksum89AB, vinput_zero_point56);
    const int32x4_t vksumzp5xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point56);
    const int32x4_t vksumzp5xGHIJ = vmulq_s32(vksumGHIJ, vinput_zero_point56);
    const int32x4_t vksumzp5xKLMN = vmulq_s32(vksumKLMN, vinput_zero_point56);
    const int32x4_t vksumzp5xOPQR = vmulq_s32(vksumOPQR, vinput_zero_point56);
    const int32x4_t vksumzp5xSTUV = vmulq_s32(vksumSTUV, vinput_zero_point56);
    ...
    vout1xGHIJ = vmulq_f32(vout1xGHIJ, vinput_scale1);
    vout1xKLMN = vmulq_f32(vout1xKLMN, vinput_scale1);
    vout1xOPQR = vmulq_f32(vout1xOPQR, vinput_scale1);
    vout1xSTUV = vmulq_f32(vout1xSTUV, vinput_scale1);
    ...
    const float32x4_t vinput_scale3 = vdupq_n_f32(qp3->inv_scale);
    vout3x0123 = vmulq_f32(vout3x0123, vinput_scale3);
    vout3x4567 = vmulq_f32(vout3x4567, vinput_scale3);
    vout3x89AB = vmulq_f32(vout3x89AB, vinput_scale3);
    vout3xCDEF = vmulq_f32(vout3xCDEF, vinput_scale3);
    vout3xGHIJ = vmulq_f32(vout3xGHIJ, vinput_scale3);
    vout3xKLMN = vmulq_f32(vout3xKLMN, vinput_scale3);
    vout3xOPQR = vmulq_f32(vout3xOPQR, vinput_scale3);
    vout3xSTUV = vmulq_f32(vout3xSTUV, vinput_scale3);
    const float32x4_t vinput_scale4 = vdupq_n_f32(qp4->inv_scale);
    ...
    const float32x4_t vinput_scale5 = vdupq_n_f32(qp5->inv_scale);
    vout5x0123 = vmulq_f32(vout5x0123, vinput_scale5);
    vout5x4567 = vmulq_f32(vout5x4567, vinput_scale5);
    vout5x89AB = vmulq_f32(vout5x89AB, vinput_scale5);
    vout5xCDEF = vmulq_f32(vout5xCDEF, vinput_scale5);
    vout5xGHIJ = vmulq_f32(vout5xGHIJ, vinput_scale5);
    vout5xKLMN = vmulq_f32(vout5xKLMN, vinput_scale5);
    vout5xOPQR = vmulq_f32(vout5xOPQR, vinput_scale5);
    vout5xSTUV = vmulq_f32(vout5xSTUV, vinput_scale5);

    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    float16x4_t vfp16out7x0123 = vcvt_f16_f32(vout7x0123);
    float16x4_t vfp16out7x4567 = vcvt_f16_f32(vout7x4567);
    float16x4_t vfp16out7x89AB = vcvt_f16_f32(vout7x89AB);
    float16x4_t vfp16out7xCDEF = vcvt_f16_f32(vout7xCDEF);
    ...
    vfp16out7x0123 = vmax_f16(vfp16out7x0123, voutput_min);
    vfp16out7x4567 = vmax_f16(vfp16out7x4567, voutput_min);
    vfp16out7x89AB = vmax_f16(vfp16out7x89AB, voutput_min);
    vfp16out7xCDEF = vmax_f16(vfp16out7xCDEF, voutput_min);
    ...
    vfp16out7x0123 = vmin_f16(vfp16out7x0123, voutput_max);
    vfp16out7x4567 = vmin_f16(vfp16out7x4567, voutput_max);
    vfp16out7x89AB = vmin_f16(vfp16out7x89AB, voutput_max);
    vfp16out7xCDEF = vmin_f16(vfp16out7xCDEF, voutput_max);
    if XNN_LIKELY(nc >= 16) {
      vst1_u16(c7, vreinterpret_u16_f16(vfp16out7x0123));
      vst1_u16(c7 + 4, vreinterpret_u16_f16(vfp16out7x4567));
      vst1_u16(c7 + 8, vreinterpret_u16_f16(vfp16out7x89AB));
      vst1_u16(c7 + 12, vreinterpret_u16_f16(vfp16out7xCDEF));
      ...
      if (nc & 8) {
        ...
        vst1_u16(c7, vreinterpret_u16_f16(vfp16out7x4567)); c7 += 4;
        vfp16out7x4567 = vfp16out7xCDEF;
      ...
      if (nc & 1) {
        vst1_lane_f16(c7, vfp16out7x0123, 0);

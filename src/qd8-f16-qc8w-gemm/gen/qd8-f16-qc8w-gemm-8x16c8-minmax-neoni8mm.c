    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vinput_zero_point78 = vdupq_n_s32(qp7->zero_point);
    const int32x4_t vksumzp7x0123 = vmulq_s32(vksum0123, vinput_zero_point78);
    const int32x4_t vksumzp7x4567 = vmulq_s32(vksum4567, vinput_zero_point78);
    const int32x4_t vksumzp7x89AB = vmulq_s32(vksum89AB, vinput_zero_point78);
    const int32x4_t vksumzp7xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point78);
    ...
    const float32x4_t vinput_scale7 = vdupq_n_f32(qp7->inv_scale);
    vout7x0123 = vmulq_f32(vout7x0123, vinput_scale7);
    vout7x4567 = vmulq_f32(vout7x4567, vinput_scale7);
    vout7x89AB = vmulq_f32(vout7x89AB, vinput_scale7);
    vout7xCDEF = vmulq_f32(vout7xCDEF, vinput_scale7);

...
void xnn_qd8_f16_qc8w_gemm_minmax_ukernel_8x16c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    int32x4_t vacc6x0123 = vmulq_lane_s32(vksum0123, vget_low_s32(vinput_zero_point67), 0);
    int32x4_t vacc7x0123 = vmulq_lane_s32(vksum0123, vget_high_s32(vinput_zero_point67), 0);
    int32x4_t vacc6x4567 = vmulq_lane_s32(vksum4567, vget_low_s32(vinput_zero_point67), 0);
    int32x4_t vacc7x4567 = vmulq_lane_s32(vksum4567, vget_high_s32(vinput_zero_point67), 0);
    int32x4_t vacc6x89AB = vmulq_lane_s32(vksum89AB, vget_low_s32(vinput_zero_point67), 0);
    int32x4_t vacc7x89AB = vmulq_lane_s32(vksum89AB, vget_high_s32(vinput_zero_point67), 0);
    int32x4_t vacc6xCDEF = vmulq_lane_s32(vksumCDEF, vget_low_s32(vinput_zero_point67), 0);
    int32x4_t vacc7xCDEF = vmulq_lane_s32(vksumCDEF, vget_high_s32(vinput_zero_point67), 0);
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      vacc6x89AB = vdotq_lane_s32(vacc6x89AB, vb0123x89AB, va6x0123, 0);
      vacc6xCDEF = vdotq_lane_s32(vacc6xCDEF, vb0123xCDEF, va6x0123, 0);
      vacc7x0123 = vdotq_lane_s32(vacc7x0123, vb0123x0123, va7x0123, 0);
      vacc7x4567 = vdotq_lane_s32(vacc7x4567, vb0123x4567, va7x0123, 0);
      vacc7x89AB = vdotq_lane_s32(vacc7x89AB, vb0123x89AB, va7x0123, 0);
      vacc7xCDEF = vdotq_lane_s32(vacc7xCDEF, vb0123xCDEF, va7x0123, 0);
    }

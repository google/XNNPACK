    ...
    const int16_t* twiddle)
{
  ...
  do {
    ...
    int32x4_t vacclr = vhaddq_s32(vacc1r, vaccr);
    int32x4_t vaccli = vhaddq_s32(vacc1i, vacci);
    int32x4_t vaccrr = vhsubq_s32(vacc1r, vaccr);
    int32x4_t vaccri = vhsubq_s32(vacci, vacc1i);

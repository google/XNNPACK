...
void xnn_qd8_bf16_qc8w_gemm_minmax_ukernel_1x8c4__neondotbf16(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    float16x8_t vfp16out0x01234567 = vcombine_f16(vcvt_bf16_f32(vout0x0123), vcvt_bf16_f32(vout0x4567));
    const float16x8_t voutput_min = vreinterpretq_f16_u16(vld1q_dup_u16((const uint16_t*) &params->scalar.min));
    vfp16out0x01234567 = vmaxq_bf16(vfp16out0x01234567, voutput_min);
    const float16x8_t voutput_max = vreinterpretq_f16_u16(vld1q_dup_u16((const uint16_t*) &params->scalar.max));
    vfp16out0x01234567 = vminq_bf16(vfp16out0x01234567, voutput_max);
    if XNN_LIKELY(nc >= 8) {

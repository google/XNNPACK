    ...
    const uint8_t table[restrict XNN_MIN_ELEMENTS(256)])
{
  ...
  for (; batch >= 64 * sizeof(uint8_t); batch -= 64 * sizeof(uint8_t)) {
    ...
    v128_t vy3 = wasm_i8x16_relaxed_swizzle(vtable0, vx3);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable1, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable2, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable3, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable4, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable5, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable6, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable7, vx3));
    vx0 = wasm_i8x16_sub(vx0, voffset);
    vx1 = wasm_i8x16_sub(vx1, voffset);
    vx2 = wasm_i8x16_sub(vx2, voffset);
    vx3 = wasm_i8x16_sub(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable8, vx3));
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtable9, vx3));
    vx0 = wasm_i8x16_sub_sat(vx0, voffset);
    vx1 = wasm_i8x16_sub_sat(vx1, voffset);
    vx2 = wasm_i8x16_sub_sat(vx2, voffset);
    vx3 = wasm_i8x16_sub_sat(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtableA, vx3));
    vx0 = wasm_i8x16_sub_sat(vx0, voffset);
    vx1 = wasm_i8x16_sub_sat(vx1, voffset);
    vx2 = wasm_i8x16_sub_sat(vx2, voffset);
    vx3 = wasm_i8x16_sub_sat(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtableB, vx3));
    vx0 = wasm_i8x16_sub_sat(vx0, voffset);
    vx1 = wasm_i8x16_sub_sat(vx1, voffset);
    vx2 = wasm_i8x16_sub_sat(vx2, voffset);
    vx3 = wasm_i8x16_sub_sat(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtableC, vx3));
    vx0 = wasm_i8x16_sub_sat(vx0, voffset);
    vx1 = wasm_i8x16_sub_sat(vx1, voffset);
    vx2 = wasm_i8x16_sub_sat(vx2, voffset);
    vx3 = wasm_i8x16_sub_sat(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtableD, vx3));
    vx0 = wasm_i8x16_sub_sat(vx0, voffset);
    vx1 = wasm_i8x16_sub_sat(vx1, voffset);
    vx2 = wasm_i8x16_sub_sat(vx2, voffset);
    vx3 = wasm_i8x16_sub_sat(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtableE, vx3));
    vx0 = wasm_i8x16_sub_sat(vx0, voffset);
    vx1 = wasm_i8x16_sub_sat(vx1, voffset);
    vx2 = wasm_i8x16_sub_sat(vx2, voffset);
    vx3 = wasm_i8x16_sub_sat(vx3, voffset);
    ...
    vy3 = wasm_v128_xor(vy3, wasm_i8x16_relaxed_swizzle(vtableF, vx3));

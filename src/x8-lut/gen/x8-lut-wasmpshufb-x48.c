    ...
    const uint8_t table[restrict XNN_MIN_ELEMENTS(256)])
{
  ...
  for (; batch >= 48 * sizeof(uint8_t); batch -= 48 * sizeof(uint8_t)) {
    ...
    v128_t vy2 = wasm_i8x16_relaxed_swizzle(vtable0, vx2);

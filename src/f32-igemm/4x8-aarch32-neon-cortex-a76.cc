...
// void xnn_f32_igemm_minmax_ukernel_4x8__aarch32_neon_prfm_cortex_a76(
//     size_t mr,                            r0
//     size_t nc,                            r1
...
// Converted from: src/f32-igemm/gen/4x8-minmax-aarch32-neon-prfm-cortex-a76.S
...
xnn_status xnn_generate_f32_igemm_ukernel_4x8__aarch32_neon_cortex_a76(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, size_t ks, const void* params) {
...
xnn_status xnn_generate_f32_igemm_ukernel_4x8__aarch32_neon_prfm_cortex_a76(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, size_t ks, const void* params) {
  using namespace xnnpack::aarch32;
  Generator g(code);

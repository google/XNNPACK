...
void xnn_f32_igemm_minmax_ukernel_8x128__hvx_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        vacc5x2 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc5x2, Q6_Vqf32_vmpy_VsfVsf(va5, vb2));
        vacc5x3 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc5x3, Q6_Vqf32_vmpy_VsfVsf(va5, vb3));
        ...
        vacc6x2 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc6x2, Q6_Vqf32_vmpy_VsfVsf(va6, vb2));
        vacc6x3 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc6x3, Q6_Vqf32_vmpy_VsfVsf(va6, vb3));
        ...
        vacc7x2 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc7x2, Q6_Vqf32_vmpy_VsfVsf(va7, vb2));
        vacc7x3 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc7x3, Q6_Vqf32_vmpy_VsfVsf(va7, vb3));
        k -= sizeof(float);
      } while (k != 0);
      p -= 8 * sizeof(void*);
    } while (p != 0);
    ...
    vacc5x2 = Q6_Vsf_vmax_VsfVsf(vmin, vacc5x2);
    vacc6x2 = Q6_Vsf_vmax_VsfVsf(vmin, vacc6x2);
    vacc7x2 = Q6_Vsf_vmax_VsfVsf(vmin, vacc7x2);
    ...
    vacc5x3 = Q6_Vsf_vmax_VsfVsf(vmin, vacc5x3);
    vacc6x3 = Q6_Vsf_vmax_VsfVsf(vmin, vacc6x3);
    vacc7x3 = Q6_Vsf_vmax_VsfVsf(vmin, vacc7x3);
    ...
    vacc5x2 = Q6_Vsf_vmin_VsfVsf(vmax, vacc5x2);
    vacc6x2 = Q6_Vsf_vmin_VsfVsf(vmax, vacc6x2);
    vacc7x2 = Q6_Vsf_vmin_VsfVsf(vmax, vacc7x2);
    ...
    vacc5x3 = Q6_Vsf_vmin_VsfVsf(vmax, vacc5x3);
    vacc6x3 = Q6_Vsf_vmin_VsfVsf(vmax, vacc6x3);
    vacc7x3 = Q6_Vsf_vmin_VsfVsf(vmax, vacc7x3);

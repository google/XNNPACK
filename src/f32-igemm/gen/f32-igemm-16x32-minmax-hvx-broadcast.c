    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    HVX_Vector vacc8x = vacc0x0;
    HVX_Vector vacc9x = vacc0x0;
    HVX_Vector vacc10x = vacc0x0;
    HVX_Vector vacc11x = vacc0x0;
    HVX_Vector vacc12x = vacc0x0;
    HVX_Vector vacc13x = vacc0x0;
    HVX_Vector vacc14x = vacc0x0;
    HVX_Vector vacc15x = vacc0x0;
    w += 32;
    ...
    do {
      ...
      do {
        ...
        a7 += 1;
        const HVX_Vector va8 =  Q6_V_vsplat_R(a8);
        a8 += 1;
        const HVX_Vector va9 =  Q6_V_vsplat_R(a9);
        a9 += 1;
        const HVX_Vector va10 =  Q6_V_vsplat_R(a10);
        a10 += 1;
        const HVX_Vector va11 =  Q6_V_vsplat_R(a11);
        a11 += 1;
        const HVX_Vector va12 =  Q6_V_vsplat_R(a12);
        a12 += 1;
        const HVX_Vector va13 =  Q6_V_vsplat_R(a13);
        a13 += 1;
        const HVX_Vector va14 =  Q6_V_vsplat_R(a14);
        a14 += 1;
        const HVX_Vector va15 =  Q6_V_vsplat_R(a15);
        a15 += 1;
        ...
        vacc8x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va8, vb0), vacc8x0));
        vacc9x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va9, vb0), vacc9x0));
        vacc10x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va10, vb0), vacc10x0));
        vacc11x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va11, vb0), vacc11x0));
        vacc12x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va12, vb0), vacc12x0));
        vacc13x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va13, vb0), vacc13x0));
        vacc14x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va14, vb0), vacc14x0));
        vacc15x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va15, vb0), vacc15x0));
        k -= sizeof(float);
      } while (k != 0);
      p -= 16 * sizeof(void*);
    } while (p != 0);
    ...
    vacc8x = Q6_Vw_vmax_VwVw(vmin, vacc8x0);
    vacc9x = Q6_Vw_vmax_VwVw(vmin, vacc9x0);
    vacc10x = Q6_Vw_vmax_VwVw(vmin, vacc10x0);
    vacc11x = Q6_Vw_vmax_VwVw(vmin, vacc11x0);
    vacc12x = Q6_Vw_vmax_VwVw(vmin, vacc12x0);
    vacc13x = Q6_Vw_vmax_VwVw(vmin, vacc13x0);
    vacc14x = Q6_Vw_vmax_VwVw(vmin, vacc14x0);
    vacc15x = Q6_Vw_vmax_VwVw(vmin, vacc15x0);
    ...
    vacc8x = Q6_Vw_vmin_VwVw(vmax, vacc8x0);
    vacc9x = Q6_Vw_vmin_VwVw(vmax, vacc9x0);
    vacc10x = Q6_Vw_vmin_VwVw(vmax, vacc10x0);
    vacc11x = Q6_Vw_vmin_VwVw(vmax, vacc11x0);
    vacc12x = Q6_Vw_vmin_VwVw(vmax, vacc12x0);
    vacc13x = Q6_Vw_vmin_VwVw(vmax, vacc13x0);
    vacc14x = Q6_Vw_vmin_VwVw(vmax, vacc14x0);
    vacc15x = Q6_Vw_vmin_VwVw(vmax, vacc15x0);

  ...
  do {
    ...
    do {
      ...
      do {
        ...
        a6 += 1;
        const HVX_Vector va7 =  Q6_V_vsplat_R(a7);
        a7 += 1;
        ...
        vacc7x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va7, vb0), vacc7x0));
        k -= sizeof(float);
      } while (k != 0);
      p -= 8 * sizeof(void*);
    } while (p != 0);
    ...
    vacc7x = Q6_Vw_vmax_VwVw(vmin, vacc7x0);
    ...
    vacc7x = Q6_Vw_vmin_VwVw(vmax, vacc7x0);

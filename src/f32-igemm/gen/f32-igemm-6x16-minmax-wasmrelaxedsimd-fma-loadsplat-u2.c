...
void xnn_f32_igemm_minmax_ukernel_6x16__wasmrelaxedsimd_fma_loadsplat_u2(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const struct xnn_f32_minmax_params* restrict params)
{
  ...
  do {
    ...
    v128_t vacc4x89AB = vacc0x89AB;
    v128_t vacc4xCDEF = vacc0xCDEF;
    v128_t vacc5x0123 = vacc0x0123;
    v128_t vacc5x4567 = vacc0x4567;
    v128_t vacc5x89AB = vacc0x89AB;
    v128_t vacc5xCDEF = vacc0xCDEF;
    w += 16;
    ...
    do {
      ...
      while (k >= 2 * sizeof(float)) {
        ...
        a3 += 2;
        const v128_t va4x0 = wasm_v128_load32_splat(a4);
        const v128_t va4x1 = wasm_v128_load32_splat(a4 + 1);
        a4 += 2;
        const v128_t va5x0 = wasm_v128_load32_splat(a5);
        const v128_t va5x1 = wasm_v128_load32_splat(a5 + 1);
        a5 += 2;
        ...
        vacc4x0123 = wasm_f32x4_relaxed_madd(va4x0, vb0x0123, vacc4x0123);
        vacc4x4567 = wasm_f32x4_relaxed_madd(va4x0, vb0x4567, vacc4x4567);
        vacc4x89AB = wasm_f32x4_relaxed_madd(va4x0, vb0x89AB, vacc4x89AB);
        vacc4xCDEF = wasm_f32x4_relaxed_madd(va4x0, vb0xCDEF, vacc4xCDEF);
        vacc5x0123 = wasm_f32x4_relaxed_madd(va5x0, vb0x0123, vacc5x0123);
        vacc5x4567 = wasm_f32x4_relaxed_madd(va5x0, vb0x4567, vacc5x4567);
        vacc5x89AB = wasm_f32x4_relaxed_madd(va5x0, vb0x89AB, vacc5x89AB);
        vacc5xCDEF = wasm_f32x4_relaxed_madd(va5x0, vb0xCDEF, vacc5xCDEF);
        ...
        vacc4x0123 = wasm_f32x4_relaxed_madd(va4x1, vb1x0123, vacc4x0123);
        vacc4x4567 = wasm_f32x4_relaxed_madd(va4x1, vb1x4567, vacc4x4567);
        vacc4x89AB = wasm_f32x4_relaxed_madd(va4x1, vb1x89AB, vacc4x89AB);
        vacc4xCDEF = wasm_f32x4_relaxed_madd(va4x1, vb1xCDEF, vacc4xCDEF);
        vacc5x0123 = wasm_f32x4_relaxed_madd(va5x1, vb1x0123, vacc5x0123);
        vacc5x4567 = wasm_f32x4_relaxed_madd(va5x1, vb1x4567, vacc5x4567);
        vacc5x89AB = wasm_f32x4_relaxed_madd(va5x1, vb1x89AB, vacc5x89AB);
        vacc5xCDEF = wasm_f32x4_relaxed_madd(va5x1, vb1xCDEF, vacc5xCDEF);
        k -= 2 * sizeof(float);
      }
      ...
      while (k != 0) {
        ...
        vacc4x89AB = wasm_f32x4_relaxed_madd(va4, vb89AB, vacc4x89AB);
        vacc4xCDEF = wasm_f32x4_relaxed_madd(va4, vbCDEF, vacc4xCDEF);
        vacc5x0123 = wasm_f32x4_relaxed_madd(va5, vb0123, vacc5x0123);
        vacc5x4567 = wasm_f32x4_relaxed_madd(va5, vb4567, vacc5x4567);
        vacc5x89AB = wasm_f32x4_relaxed_madd(va5, vb89AB, vacc5x89AB);
        vacc5xCDEF = wasm_f32x4_relaxed_madd(va5, vbCDEF, vacc5xCDEF);
        k -= sizeof(float);
      }
      p -= 6 * sizeof(void*);
    } while (p != 0);
    ...
    vacc4x89AB = wasm_f32x4_relaxed_max(vmin, vacc4x89AB);
    vacc5x89AB = wasm_f32x4_relaxed_max(vmin, vacc5x89AB);
    ...
    vacc4xCDEF = wasm_f32x4_relaxed_max(vmin, vacc4xCDEF);
    vacc5xCDEF = wasm_f32x4_relaxed_max(vmin, vacc5xCDEF);
    ...
    vacc4x89AB = wasm_f32x4_relaxed_min(vmax, vacc4x89AB);
    vacc5x89AB = wasm_f32x4_relaxed_min(vmax, vacc5x89AB);
    ...
    vacc4xCDEF = wasm_f32x4_relaxed_min(vmax, vacc4xCDEF);
    vacc5xCDEF = wasm_f32x4_relaxed_min(vmax, vacc5xCDEF);
    if XNN_LIKELY(nc >= 16) {
      wasm_v128_store(c5, vacc5x0123);
      wasm_v128_store(c5 + 4, vacc5x4567);
      wasm_v128_store(c5 + 8, vacc5x89AB);
      wasm_v128_store(c5 + 12, vacc5xCDEF);
      c5 = (float*) ((uintptr_t) c5 + cn_stride);
      wasm_v128_store(c4, vacc4x0123);
      wasm_v128_store(c4 + 4, vacc4x4567);
      wasm_v128_store(c4 + 8, vacc4x89AB);
      wasm_v128_store(c4 + 12, vacc4xCDEF);

    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    HVX_Vector vacc0x = _mm256_load_ps(w + 64);
    HVX_Vector vacc0x = _mm256_load_ps(w + 96);
    HVX_Vector vacc1x = vacc0x0;
    HVX_Vector vacc1x = vacc0x1;
    HVX_Vector vacc1x = vacc0x2;
    HVX_Vector vacc1x = vacc0x3;
    w += 128;
    ...
    do {
      ...
      do {
        ...
        const HVX_Vector vb = _mm256_load_ps(w + 64);
        const HVX_Vector vb = _mm256_load_ps(w + 96);
        w += 128;
        ...
        vacc0x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va0, vb2), vacc0x2));
        vacc0x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va0, vb3), vacc0x3));
        ...
        vacc1x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va1, vb2), vacc1x2));
        vacc1x = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vsf(Q6_Vqf32_vmpy_VsfVsf(va1, vb3), vacc1x3));
        k -= sizeof(float);
      } while (k != 0);
      p -= 2 * sizeof(void*);
    } while (p != 0);
    ...
    vacc0x = Q6_Vw_vmax_VwVw(vmin, vacc0x2);
    vacc1x = Q6_Vw_vmax_VwVw(vmin, vacc1x2);
    vacc0x = Q6_Vw_vmax_VwVw(vmin, vacc0x3);
    vacc1x = Q6_Vw_vmax_VwVw(vmin, vacc1x3);
    ...
    vacc0x = Q6_Vw_vmin_VwVw(vmax, vacc0x2);
    vacc1x = Q6_Vw_vmin_VwVw(vmax, vacc1x2);
    vacc0x = Q6_Vw_vmin_VwVw(vmax, vacc0x3);
    vacc1x = Q6_Vw_vmin_VwVw(vmax, vacc1x3);

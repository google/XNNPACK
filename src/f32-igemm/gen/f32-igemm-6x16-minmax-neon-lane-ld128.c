    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    float32x4_t vacc4x89AB = vacc0x89AB;
    float32x4_t vacc4xCDEF = vacc0xCDEF;
    float32x4_t vacc5x0123 = vacc0x0123;
    float32x4_t vacc5x4567 = vacc0x4567;
    float32x4_t vacc5x89AB = vacc0x89AB;
    float32x4_t vacc5xCDEF = vacc0xCDEF;
    ...
    do {
      ...
      for (; k >= 4 * sizeof(float); k -= 4 * sizeof(float)) {
        ...
        vacc0x89AB = vmlaq_lane_f32(vacc0x89AB, vb89ABc0, vget_low_f32(va0), 0);
        vacc1x89AB = vmlaq_lane_f32(vacc1x89AB, vb89ABc0, vget_low_f32(va1), 0);
        vacc2x89AB = vmlaq_lane_f32(vacc2x89AB, vb89ABc0, vget_low_f32(va2), 0);
        vacc3x89AB = vmlaq_lane_f32(vacc3x89AB, vb89ABc0, vget_low_f32(va3), 0);
        vacc4x89AB = vmlaq_lane_f32(vacc4x89AB, vb89ABc0, vget_low_f32(va4), 0);
        vacc5x89AB = vmlaq_lane_f32(vacc5x89AB, vb89ABc0, vget_low_f32(va5), 0);
        vacc0xCDEF = vmlaq_lane_f32(vacc0xCDEF, vbCDEFc0, vget_low_f32(va0), 0);
        vacc1xCDEF = vmlaq_lane_f32(vacc1xCDEF, vbCDEFc0, vget_low_f32(va1), 0);
        vacc2xCDEF = vmlaq_lane_f32(vacc2xCDEF, vbCDEFc0, vget_low_f32(va2), 0);
        vacc3xCDEF = vmlaq_lane_f32(vacc3xCDEF, vbCDEFc0, vget_low_f32(va3), 0);
        vacc4xCDEF = vmlaq_lane_f32(vacc4xCDEF, vbCDEFc0, vget_low_f32(va4), 0);
        vacc5xCDEF = vmlaq_lane_f32(vacc5xCDEF, vbCDEFc0, vget_low_f32(va5), 0);
        ...
        vacc0x89AB = vmlaq_lane_f32(vacc0x89AB, vb89ABc1, vget_low_f32(va0), 1);
        vacc1x89AB = vmlaq_lane_f32(vacc1x89AB, vb89ABc1, vget_low_f32(va1), 1);
        vacc2x89AB = vmlaq_lane_f32(vacc2x89AB, vb89ABc1, vget_low_f32(va2), 1);
        vacc3x89AB = vmlaq_lane_f32(vacc3x89AB, vb89ABc1, vget_low_f32(va3), 1);
        vacc4x89AB = vmlaq_lane_f32(vacc4x89AB, vb89ABc1, vget_low_f32(va4), 1);
        vacc5x89AB = vmlaq_lane_f32(vacc5x89AB, vb89ABc1, vget_low_f32(va5), 1);
        vacc0xCDEF = vmlaq_lane_f32(vacc0xCDEF, vbCDEFc1, vget_low_f32(va0), 1);
        vacc1xCDEF = vmlaq_lane_f32(vacc1xCDEF, vbCDEFc1, vget_low_f32(va1), 1);
        vacc2xCDEF = vmlaq_lane_f32(vacc2xCDEF, vbCDEFc1, vget_low_f32(va2), 1);
        vacc3xCDEF = vmlaq_lane_f32(vacc3xCDEF, vbCDEFc1, vget_low_f32(va3), 1);
        vacc4xCDEF = vmlaq_lane_f32(vacc4xCDEF, vbCDEFc1, vget_low_f32(va4), 1);
        vacc5xCDEF = vmlaq_lane_f32(vacc5xCDEF, vbCDEFc1, vget_low_f32(va5), 1);
        ...
        vacc0x89AB = vmlaq_lane_f32(vacc0x89AB, vb89ABc2, vget_high_f32(va0), 0);
        vacc1x89AB = vmlaq_lane_f32(vacc1x89AB, vb89ABc2, vget_high_f32(va1), 0);
        vacc2x89AB = vmlaq_lane_f32(vacc2x89AB, vb89ABc2, vget_high_f32(va2), 0);
        vacc3x89AB = vmlaq_lane_f32(vacc3x89AB, vb89ABc2, vget_high_f32(va3), 0);
        vacc4x89AB = vmlaq_lane_f32(vacc4x89AB, vb89ABc2, vget_high_f32(va4), 0);
        vacc5x89AB = vmlaq_lane_f32(vacc5x89AB, vb89ABc2, vget_high_f32(va5), 0);
        vacc0xCDEF = vmlaq_lane_f32(vacc0xCDEF, vbCDEFc2, vget_high_f32(va0), 0);
        vacc1xCDEF = vmlaq_lane_f32(vacc1xCDEF, vbCDEFc2, vget_high_f32(va1), 0);
        vacc2xCDEF = vmlaq_lane_f32(vacc2xCDEF, vbCDEFc2, vget_high_f32(va2), 0);
        vacc3xCDEF = vmlaq_lane_f32(vacc3xCDEF, vbCDEFc2, vget_high_f32(va3), 0);
        vacc4xCDEF = vmlaq_lane_f32(vacc4xCDEF, vbCDEFc2, vget_high_f32(va4), 0);
        vacc5xCDEF = vmlaq_lane_f32(vacc5xCDEF, vbCDEFc2, vget_high_f32(va5), 0);
        ...
        vacc0x89AB = vmlaq_lane_f32(vacc0x89AB, vb89ABc3, vget_high_f32(va0), 1);
        vacc1x89AB = vmlaq_lane_f32(vacc1x89AB, vb89ABc3, vget_high_f32(va1), 1);
        vacc2x89AB = vmlaq_lane_f32(vacc2x89AB, vb89ABc3, vget_high_f32(va2), 1);
        vacc3x89AB = vmlaq_lane_f32(vacc3x89AB, vb89ABc3, vget_high_f32(va3), 1);
        vacc4x89AB = vmlaq_lane_f32(vacc4x89AB, vb89ABc3, vget_high_f32(va4), 1);
        vacc5x89AB = vmlaq_lane_f32(vacc5x89AB, vb89ABc3, vget_high_f32(va5), 1);
        vacc0xCDEF = vmlaq_lane_f32(vacc0xCDEF, vbCDEFc3, vget_high_f32(va0), 1);
        vacc1xCDEF = vmlaq_lane_f32(vacc1xCDEF, vbCDEFc3, vget_high_f32(va1), 1);
        vacc2xCDEF = vmlaq_lane_f32(vacc2xCDEF, vbCDEFc3, vget_high_f32(va2), 1);
        vacc3xCDEF = vmlaq_lane_f32(vacc3xCDEF, vbCDEFc3, vget_high_f32(va3), 1);
        vacc4xCDEF = vmlaq_lane_f32(vacc4xCDEF, vbCDEFc3, vget_high_f32(va4), 1);
        vacc5xCDEF = vmlaq_lane_f32(vacc5xCDEF, vbCDEFc3, vget_high_f32(va5), 1);
      }
      if XNN_UNLIKELY(k != 0) {
        do {
          ...
          vacc4x89AB = vmlaq_f32(vacc4x89AB, va4, vb89AB);
          vacc5x89AB = vmlaq_f32(vacc5x89AB, va5, vb89AB);
          vacc0xCDEF = vmlaq_f32(vacc0xCDEF, va0, vbCDEF);
          vacc1xCDEF = vmlaq_f32(vacc1xCDEF, va1, vbCDEF);
          vacc2xCDEF = vmlaq_f32(vacc2xCDEF, va2, vbCDEF);
          vacc3xCDEF = vmlaq_f32(vacc3xCDEF, va3, vbCDEF);
          vacc4xCDEF = vmlaq_f32(vacc4xCDEF, va4, vbCDEF);
          vacc5xCDEF = vmlaq_f32(vacc5xCDEF, va5, vbCDEF);
    ...
    vacc4x89AB = vminq_f32(vacc4x89AB, vmax);
    vacc5x89AB = vminq_f32(vacc5x89AB, vmax);
    ...
    vacc4xCDEF = vminq_f32(vacc4xCDEF, vmax);
    vacc5xCDEF = vminq_f32(vacc5xCDEF, vmax);
    ...
    vacc4x89AB = vmaxq_f32(vacc4x89AB, vmin);
    vacc5x89AB = vmaxq_f32(vacc5x89AB, vmin);
    ...
    vacc4xCDEF = vmaxq_f32(vacc4xCDEF, vmin);
    vacc5xCDEF = vmaxq_f32(vacc5xCDEF, vmin);

    if XNN_LIKELY(nc >= 16) {
      vst1q_f32(c5, vacc5x0123);
      vst1q_f32(c5 + 4, vacc5x4567);
      vst1q_f32(c5 + 8, vacc5x89AB);
      vst1q_f32(c5 + 12, vacc5xCDEF);
      c5 = (float*) ((uintptr_t) c5 + cn_stride);
      vst1q_f32(c4, vacc4x0123);
      vst1q_f32(c4 + 4, vacc4x4567);
      vst1q_f32(c4 + 8, vacc4x89AB);
      vst1q_f32(c4 + 12, vacc4xCDEF);
      ...
      if (nc & 8) {
        ...
        vst1q_f32(c5, vacc5x4567); c5 += 4;
        vst1q_f32(c4, vacc4x4567); c4 += 4;
        vst1q_f32(c3, vacc3x4567); c3 += 4;
        vst1q_f32(c2, vacc2x4567); c2 += 4;
        vst1q_f32(c1, vacc1x4567); c1 += 4;
        vst1q_f32(c0, vacc0x4567); c0 += 4;

        vacc5x0123 = vacc5x89AB;
        vacc5x4567 = vacc5xCDEF;
        vacc4x0123 = vacc4x89AB;
        vacc4x4567 = vacc4xCDEF;
      ...
      if (nc & 4) {
        ...
        vacc5x4567 = vacc5x89AB;
        vacc5x89AB = vacc5xCDEF;
        vacc4x0123 = vacc4x4567;
        vacc4x4567 = vacc4x89AB;
        vacc4x89AB = vacc4xCDEF;

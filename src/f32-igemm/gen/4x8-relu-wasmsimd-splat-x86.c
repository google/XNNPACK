    ...
    const union xnn_f32_relu_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vacc0x0123 = wasm_f32x4_pmax(vacc0x0123, vzero);
    vacc1x0123 = wasm_f32x4_pmax(vacc1x0123, vzero);
    vacc2x0123 = wasm_f32x4_pmax(vacc2x0123, vzero);
    vacc3x0123 = wasm_f32x4_pmax(vacc3x0123, vzero);
    vacc0x4567 = wasm_f32x4_pmax(vacc0x4567, vzero);
    vacc1x4567 = wasm_f32x4_pmax(vacc1x4567, vzero);
    vacc2x4567 = wasm_f32x4_pmax(vacc2x4567, vzero);
    vacc3x4567 = wasm_f32x4_pmax(vacc3x4567, vzero);

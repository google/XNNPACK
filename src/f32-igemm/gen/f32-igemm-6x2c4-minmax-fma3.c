...
void xnn_f32_igemm_minmax_ukernel_6x2c4__fma3(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      for (; k >= 4 * sizeof(float); k -= 4 * sizeof(float)) {
        ...
        vacc4x0c4 = _mm_fmadd_ps(va4, vb0, vacc4x0c4);
        vacc4x1c4 = _mm_fmadd_ps(va4, vb1, vacc4x1c4);
        vacc5x0c4 = _mm_fmadd_ps(va5, vb0, vacc5x0c4);
        vacc5x1c4 = _mm_fmadd_ps(va5, vb1, vacc5x1c4);
      }
      if XNN_UNLIKELY(k != 0) {
        const __m128 va0 = _mm_loadu_ps(a0);
        const __m128 va1 = _mm_loadu_ps(a1);
        ...
        vacc4x0c4 = _mm_fmadd_ps(_mm_andnot_ps(vmask0, va4), vb0, vacc4x0c4);
        vacc4x1c4 = _mm_fmadd_ps(_mm_andnot_ps(vmask1, va4), vb1, vacc4x1c4);
        vacc5x0c4 = _mm_fmadd_ps(_mm_andnot_ps(vmask0, va5), vb0, vacc5x0c4);
        vacc5x1c4 = _mm_fmadd_ps(_mm_andnot_ps(vmask1, va5), vb1, vacc5x1c4);
      }
      p -= 6 * sizeof(void*);
    } while (p != 0);

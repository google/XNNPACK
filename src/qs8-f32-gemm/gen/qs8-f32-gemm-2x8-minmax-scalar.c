...
void xnn_qs8_f32_gemm_minmax_ukernel_2x8__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    float vfpacc1x4 = (float) vacc1x4;
    float vfpacc1x5 = (float) vacc1x5;
    float vfpacc1x6 = (float) vacc1x6;
    float vfpacc1x7 = (float) vacc1x7;
    vfpacc0x0 *= vscale[0];
    vfpacc1x0 *= vscale[1];
    vfpacc0x1 *= vscale[0];
    vfpacc1x1 *= vscale[1];
    ...
    float vout1x4 = vfpacc1x4 + vbias4;
    float vout0x5 = vfpacc0x5 + vbias5;
    float vout1x5 = vfpacc1x5 + vbias5;
    float vout0x6 = vfpacc0x6 + vbias6;
    float vout1x6 = vfpacc1x6 + vbias6;
    float vout0x7 = vfpacc0x7 + vbias7;
    float vout1x7 = vfpacc1x7 + vbias7;

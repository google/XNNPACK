...
//   Template: src/qs8-gemm/MRx4c8-wasmsimd-extmul-extaddpair.c.in
...
void xnn_qs8_gemm_minmax_ukernel_4x4c8__wasmsimd_extmul_extaddpair(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_gemm_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN
{
  ...
  do {
    ...
    size_t k = 0;
    while (k < kc) {
      const v128_t vxa0 = __builtin_wasm_load64_zero((long long*) a0);
      a0 += 8;
      const v128_t vxa1 = __builtin_wasm_load64_zero((long long*) a1);
      a1 += 8;
      const v128_t vxa2 = __builtin_wasm_load64_zero((long long*) a2);
      a2 += 8;
      const v128_t vxa3 = __builtin_wasm_load64_zero((long long*) a3);
      a3 += 8;

      const v128_t vxb0 = __builtin_wasm_load64_zero((long long*) w);

      const v128_t vprod0x0 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa0, vxb0);
      vacc0x0 = wasm_i32x4_add(vacc0x0, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod0x0));
      const v128_t vprod1x0 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa1, vxb0);
      vacc1x0 = wasm_i32x4_add(vacc1x0, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod1x0));
      const v128_t vprod2x0 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa2, vxb0);
      vacc2x0 = wasm_i32x4_add(vacc2x0, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod2x0));
      const v128_t vprod3x0 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa3, vxb0);
      vacc3x0 = wasm_i32x4_add(vacc3x0, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod3x0));
      const v128_t vxb1 = __builtin_wasm_load64_zero((long long*) ((uintptr_t) w + 8 * sizeof(int8_t)));

      const v128_t vprod0x1 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa0, vxb1);
      vacc0x1 = wasm_i32x4_add(vacc0x1, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod0x1));
      const v128_t vprod1x1 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa1, vxb1);
      vacc1x1 = wasm_i32x4_add(vacc1x1, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod1x1));
      const v128_t vprod2x1 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa2, vxb1);
      vacc2x1 = wasm_i32x4_add(vacc2x1, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod2x1));
      const v128_t vprod3x1 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa3, vxb1);
      vacc3x1 = wasm_i32x4_add(vacc3x1, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod3x1));
      const v128_t vxb2 = __builtin_wasm_load64_zero((long long*) ((uintptr_t) w + 16 * sizeof(int8_t)));

      const v128_t vprod0x2 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa0, vxb2);
      vacc0x2 = wasm_i32x4_add(vacc0x2, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod0x2));
      const v128_t vprod1x2 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa1, vxb2);
      vacc1x2 = wasm_i32x4_add(vacc1x2, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod1x2));
      const v128_t vprod2x2 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa2, vxb2);
      vacc2x2 = wasm_i32x4_add(vacc2x2, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod2x2));
      const v128_t vprod3x2 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa3, vxb2);
      vacc3x2 = wasm_i32x4_add(vacc3x2, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod3x2));
      const v128_t vxb3 = __builtin_wasm_load64_zero((long long*) ((uintptr_t) w + 24 * sizeof(int8_t)));

      const v128_t vprod0x3 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa0, vxb3);
      vacc0x3 = wasm_i32x4_add(vacc0x3, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod0x3));
      const v128_t vprod1x3 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa1, vxb3);
      vacc1x3 = wasm_i32x4_add(vacc1x3, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod1x3));
      const v128_t vprod2x3 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa2, vxb3);
      vacc2x3 = wasm_i32x4_add(vacc2x3, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod2x3));
      const v128_t vprod3x3 = __builtin_wasm_extmul_low_i8x16_s_i16x8(vxa3, vxb3);
      vacc3x3 = wasm_i32x4_add(vacc3x3, __builtin_wasm_extadd_pairwise_i16x8_s_i32x4(vprod3x3));
    ...
    const v128_t vsign3x0123 = wasm_i32x4_lt(vacc3x0123, vzero);
    ...
    const v128_t vacc3x01 = wasm_v32x4_shuffle(vacc3x0123, vsign3x0123, 0, 4, 1, 5);
    ...
    const v128_t vprod3x01 = wasm_i64x2_add(wasm_i64x2_mul(vacc3x01, vmultiplier), vrounding);
    const v128_t vacc3x23 = wasm_v32x4_shuffle(vacc3x0123, vsign3x0123, 2, 6, 3, 7);
    ...
    const v128_t vprod3x23 = wasm_i64x2_add(wasm_i64x2_mul(vacc3x23, vmultiplier), vrounding);
    ...
    const v128_t vq31prod3x0123 = wasm_v32x4_shuffle(vprod3x01, vprod3x23, 1, 3, 5, 7);
    ...
    const v128_t vrem3x0123 = wasm_i32x4_add(wasm_v128_and(vq31prod3x0123, vremainder_mask), wasm_i32x4_lt(vq31prod3x0123, vzero));
    ...
    vacc3x0123 = wasm_i32x4_sub(wasm_i32x4_shr(vq31prod3x0123, vshift), wasm_i32x4_gt(vrem3x0123, vthreshold));
    ...
    v128_t vacc23x0123 = wasm_i16x8_add_saturate(wasm_i16x8_narrow_i32x4(vacc2x0123, vacc3x0123), voutput_zero_point);
      ...
      *((float*) c3) = (float) wasm_f32x4_extract_lane(vout, 3);
      ...
      if (nc & 2) {
        ...
        *((uint16_t*) c2) = (uint16_t) wasm_i16x8_extract_lane(vout, 4);
        c2 += 2;
        *((uint16_t*) c3) = (uint16_t) wasm_i16x8_extract_lane(vout, 6);
        c3 += 2;
      ...
      if (nc & 1) {
        ...
        *c3 = (int8_t) wasm_i8x16_extract_lane(vout, 12);
      }

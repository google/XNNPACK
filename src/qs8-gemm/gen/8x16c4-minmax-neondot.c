...
void xnn_qs8_gemm_minmax_ukernel_8x16c4__neondot(
  ...
  do {
    ...
    vacc6x89AB = vsraq_n_s32(vproduct6x89AB, vbicq_s32(vacc6x89AB, vzero_shift_mask), 31);
    vacc6xCDEF = vsraq_n_s32(vproduct6xCDEF, vbicq_s32(vacc6xCDEF, vzero_shift_mask), 31);
    ...
    vacc7x89AB = vsraq_n_s32(vproduct7x89AB, vbicq_s32(vacc7x89AB, vzero_shift_mask), 31);
    vacc7xCDEF = vsraq_n_s32(vproduct7xCDEF, vbicq_s32(vacc7xCDEF, vzero_shift_mask), 31);

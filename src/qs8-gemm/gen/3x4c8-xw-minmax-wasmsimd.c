...
void xnn_qs8_gemm_xw_minmax_ukernel_3x4c8__wasmsimd(
    ...
    size_t cm_stride,
    size_t cn_stride,
    const union xnn_qs8_gemm_xw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN XNN_DISABLE_MSAN
{
  assert(mr != 0);
  assert(mr <= 3);
  assert(nc != 0);
  ...
  do {
    ...
    const v128_t vprod0x01 = wasm_i64x2_add(__builtin_wasm_extmul_low_i32x4_s_i64x2(vacc0x0123, vmultiplier), vrounding);
    const v128_t vprod0x23 = wasm_i64x2_add(__builtin_wasm_extmul_high_i32x4_s_i64x2(vacc0x0123, vmultiplier), vrounding);
    const v128_t vprod1x01 = wasm_i64x2_add(__builtin_wasm_extmul_low_i32x4_s_i64x2(vacc1x0123, vmultiplier), vrounding);
    const v128_t vprod1x23 = wasm_i64x2_add(__builtin_wasm_extmul_high_i32x4_s_i64x2(vacc1x0123, vmultiplier), vrounding);
    const v128_t vprod2x01 = wasm_i64x2_add(__builtin_wasm_extmul_low_i32x4_s_i64x2(vacc2x0123, vmultiplier), vrounding);
    const v128_t vprod2x23 = wasm_i64x2_add(__builtin_wasm_extmul_high_i32x4_s_i64x2(vacc2x0123, vmultiplier), vrounding);

    const v128_t vq31prod0x01 = wasm_i64x2_shl(vprod0x01, 1);
    const v128_t vq31prod0x23 = wasm_i64x2_add(vprod0x23, vprod0x23);
    const v128_t vq31prod1x01 = wasm_i64x2_shl(vprod1x01, 1);
    const v128_t vq31prod1x23 = wasm_i64x2_add(vprod1x23, vprod1x23);
    const v128_t vq31prod2x01 = wasm_i64x2_shl(vprod2x01, 1);
    const v128_t vq31prod2x23 = wasm_i64x2_add(vprod2x23, vprod2x23);

    const v128_t vq31prod0x0123 = wasm_v32x4_shuffle(vq31prod0x01, vq31prod0x23, 1, 3, 5, 7);
    const v128_t vq31prod1x0123 = wasm_v32x4_shuffle(vq31prod1x01, vq31prod1x23, 1, 3, 5, 7);
    const v128_t vq31prod2x0123 = wasm_v32x4_shuffle(vq31prod2x01, vq31prod2x23, 1, 3, 5, 7);

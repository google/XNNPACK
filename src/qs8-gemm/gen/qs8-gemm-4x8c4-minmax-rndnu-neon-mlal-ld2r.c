...
void xnn_qs8_gemm_minmax_rndnu_ukernel_4x8c4__neon_mlal_ld2r(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      const int32x2x2_t va3x0 = vld2_dup_s32((const void*)a3); a3 += 8;
      const int32x2x2_t va3x1 = vld2_dup_s32((const void*)a3); a3 += 8;
      ...
      const int8x8_t va3c0x0 = vreinterpret_s8_s32(va3x0.val[0]);
      const int8x8_t va3c0x1 = vreinterpret_s8_s32(va3x1.val[0]);
      ...
      const int8x8_t va3c1x0 = vreinterpret_s8_s32(va3x0.val[1]);
      const int8x8_t va3c1x1 = vreinterpret_s8_s32(va3x1.val[1]);

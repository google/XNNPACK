...
void xnn_qs8_gemm_minmax_fp32_ukernel_8x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN XNN_DISABLE_MSAN
{
  ...
  do {
    ...
    float32x4_t vproduct6x0123 = vcvtq_f32_s32(vacc6x0123);
    float32x4_t vproduct6x4567 = vcvtq_f32_s32(vacc6x4567);
    float32x4_t vproduct7x0123 = vcvtq_f32_s32(vacc7x0123);
    float32x4_t vproduct7x4567 = vcvtq_f32_s32(vacc7x4567);
    ...
    vproduct6x0123 = vmulq_f32(vproduct6x0123, vscale);
    vproduct6x4567 = vmulq_f32(vproduct6x4567, vscale);
    vproduct7x0123 = vmulq_f32(vproduct7x0123, vscale);
    vproduct7x4567 = vmulq_f32(vproduct7x4567, vscale);
    ...
    vacc6x0123 = vcvtnq_s32_f32(vproduct6x0123);
    vacc6x4567 = vcvtnq_s32_f32(vproduct6x4567);
    vacc7x0123 = vcvtnq_s32_f32(vproduct7x0123);
    vacc7x4567 = vcvtnq_s32_f32(vproduct7x4567);

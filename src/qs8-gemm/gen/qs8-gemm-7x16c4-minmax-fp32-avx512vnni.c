    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m128i vout4x0123456789ABCDEF = _mm_shuffle_epi8(vout4x012389AB4567CDEF, _mm_loadu_epi8(params->fp32_avx512vnni.shuffle_control_mask));
    __m128i vout5x0123456789ABCDEF = _mm_shuffle_epi8(vout5x012389AB4567CDEF, _mm_loadu_epi8(params->fp32_avx512vnni.shuffle_control_mask));
    __m128i vout6x0123456789ABCDEF = _mm_shuffle_epi8(vout6x012389AB4567CDEF, _mm_loadu_epi8(params->fp32_avx512vnni.shuffle_control_mask));

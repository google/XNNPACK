...
void xnn_qs8_packw_gemm_goi_ukernel_x16c8__avx2_madd(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (;n >= 16; n -= 16) {
      ...
      for (; k >= 32; k -= 32) {
        ...
        vacc8 = mm256_dpbusd_epi32_madd(vacc8, vone, v8_0);
        vacc8 = mm256_dpbusd_epi32_madd(vacc8, vone, v8_1);
        vacc8 = mm256_dpbusd_epi32_madd(vacc8, vone, v8_2);
        vacc8 = mm256_dpbusd_epi32_madd(vacc8, vone, v8_3);
        vacc12 = mm256_dpbusd_epi32_madd(vacc12, vone, v12_0);
        vacc12 = mm256_dpbusd_epi32_madd(vacc12, vone, v12_1);
        vacc12 = mm256_dpbusd_epi32_madd(vacc12, vone, v12_2);
        vacc12 = mm256_dpbusd_epi32_madd(vacc12, vone, v12_3);
      ...
      for (; k >= 8; k -= 8) {
        ...
        vacc8 = mm256_dpbusd_epi32_madd(vacc8, vone, v8);
        vacc12 = mm256_dpbusd_epi32_madd(vacc12, vone, v12);
      ...
      if (k != 0) {
        ...
        __m256i v8 = _mm256_set1_epi64x((int64_t) safe_load_u64(w8, k, 0));
        v8 = _mm256_blend_epi32(v8, _mm256_set1_epi64x((int64_t) safe_load_u64(w9, k, 0)), 0x0C);
        v8 = _mm256_blend_epi32(v8, _mm256_set1_epi64x((int64_t) safe_load_u64(w10, k, 0)), 0x30);
        v8 = _mm256_blend_epi32(v8, _mm256_set1_epi64x((int64_t) safe_load_u64(w11, k, 0)), 0xC0);
        __m256i v12 = _mm256_set1_epi64x((int64_t) safe_load_u64(w12, k, 0));
        v12 = _mm256_blend_epi32(v12, _mm256_set1_epi64x((int64_t) safe_load_u64(w13, k, 0)), 0x0C);
        v12 = _mm256_blend_epi32(v12, _mm256_set1_epi64x((int64_t) safe_load_u64(w14, k, 0)), 0x30);
        v12 = _mm256_blend_epi32(v12, _mm256_set1_epi64x((int64_t) safe_load_u64(w15, k, 0)), 0xC0);
    ...
    weights = (const int8_t*)((intptr_t) weights + nc * n_stride);
  } while (--g != 0);
}

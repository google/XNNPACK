  ...
  do {
    ...
    for (;n >= 64; n -= 64) {
      ...
      for (; k != 0; --k) {
        ...
        ksum31 += (uint32_t) v31;
        out[31] = v31;
        const int8_t v32 = *w32++;
        ksum32 += (uint32_t) v32;
        out[32] = v32;
        const int8_t v33 = *w33++;
        ksum33 += (uint32_t) v33;
        out[33] = v33;
        const int8_t v34 = *w34++;
        ksum34 += (uint32_t) v34;
        out[34] = v34;
        const int8_t v35 = *w35++;
        ksum35 += (uint32_t) v35;
        out[35] = v35;
        const int8_t v36 = *w36++;
        ksum36 += (uint32_t) v36;
        out[36] = v36;
        const int8_t v37 = *w37++;
        ksum37 += (uint32_t) v37;
        out[37] = v37;
        const int8_t v38 = *w38++;
        ksum38 += (uint32_t) v38;
        out[38] = v38;
        const int8_t v39 = *w39++;
        ksum39 += (uint32_t) v39;
        out[39] = v39;
        const int8_t v40 = *w40++;
        ksum40 += (uint32_t) v40;
        out[40] = v40;
        const int8_t v41 = *w41++;
        ksum41 += (uint32_t) v41;
        out[41] = v41;
        const int8_t v42 = *w42++;
        ksum42 += (uint32_t) v42;
        out[42] = v42;
        const int8_t v43 = *w43++;
        ksum43 += (uint32_t) v43;
        out[43] = v43;
        const int8_t v44 = *w44++;
        ksum44 += (uint32_t) v44;
        out[44] = v44;
        const int8_t v45 = *w45++;
        ksum45 += (uint32_t) v45;
        out[45] = v45;
        const int8_t v46 = *w46++;
        ksum46 += (uint32_t) v46;
        out[46] = v46;
        const int8_t v47 = *w47++;
        ksum47 += (uint32_t) v47;
        out[47] = v47;
        const int8_t v48 = *w48++;
        ksum48 += (uint32_t) v48;
        out[48] = v48;
        const int8_t v49 = *w49++;
        ksum49 += (uint32_t) v49;
        out[49] = v49;
        const int8_t v50 = *w50++;
        ksum50 += (uint32_t) v50;
        out[50] = v50;
        const int8_t v51 = *w51++;
        ksum51 += (uint32_t) v51;
        out[51] = v51;
        const int8_t v52 = *w52++;
        ksum52 += (uint32_t) v52;
        out[52] = v52;
        const int8_t v53 = *w53++;
        ksum53 += (uint32_t) v53;
        out[53] = v53;
        const int8_t v54 = *w54++;
        ksum54 += (uint32_t) v54;
        out[54] = v54;
        const int8_t v55 = *w55++;
        ksum55 += (uint32_t) v55;
        out[55] = v55;
        const int8_t v56 = *w56++;
        ksum56 += (uint32_t) v56;
        out[56] = v56;
        const int8_t v57 = *w57++;
        ksum57 += (uint32_t) v57;
        out[57] = v57;
        const int8_t v58 = *w58++;
        ksum58 += (uint32_t) v58;
        out[58] = v58;
        const int8_t v59 = *w59++;
        ksum59 += (uint32_t) v59;
        out[59] = v59;
        const int8_t v60 = *w60++;
        ksum60 += (uint32_t) v60;
        out[60] = v60;
        const int8_t v61 = *w61++;
        ksum61 += (uint32_t) v61;
        out[61] = v61;
        const int8_t v62 = *w62++;
        ksum62 += (uint32_t) v62;
        out[62] = v62;
        const int8_t v63 = *w63++;
        ksum63 += (uint32_t) v63;
        out[63] = v63;
        out += 64;
      }

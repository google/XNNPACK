...
void xnn_f32_rdsum_ukernel_7p7x__avx_c64(
    size_t rows,
    size_t channels,
    const float* input,
    size_t input_stride,
    ...
    const struct xnn_f32_scaleminmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; channels >= 64; channels -= 64) {
    ...
    for (int r = rows; r > 0; r -= 7) {
      ...
      vin4 = _mm256_loadu_ps(&i0[32]);
      vin5 = _mm256_loadu_ps(&i0[40]);
      vin6 = _mm256_loadu_ps(&i0[48]);
      vin7 = _mm256_loadu_ps(&i0[56]);
      ...
      vin4 = _mm256_loadu_ps(&i1[32]);
      vin5 = _mm256_loadu_ps(&i1[40]);
      vin6 = _mm256_loadu_ps(&i1[48]);
      vin7 = _mm256_loadu_ps(&i1[56]);
      vacc0 = _mm256_add_ps(vin0, vacc0);
      vacc1 = _mm256_add_ps(vin1, vacc1);
      vacc2 = _mm256_add_ps(vin2, vacc2);
      vacc3 = _mm256_add_ps(vin3, vacc3);
      ...
      vin4 = _mm256_loadu_ps(&i2[32]);
      vin5 = _mm256_loadu_ps(&i2[40]);
      vin6 = _mm256_loadu_ps(&i2[48]);
      vin7 = _mm256_loadu_ps(&i2[56]);
      vacc0 = _mm256_add_ps(vin0, vacc0);
      vacc1 = _mm256_add_ps(vin1, vacc1);
      vacc2 = _mm256_add_ps(vin2, vacc2);
      vacc3 = _mm256_add_ps(vin3, vacc3);
      ...
      vin4 = _mm256_loadu_ps(&i3[32]);
      vin5 = _mm256_loadu_ps(&i3[40]);
      vin6 = _mm256_loadu_ps(&i3[48]);
      vin7 = _mm256_loadu_ps(&i3[56]);
      vacc0 = _mm256_add_ps(vin0, vacc0);
      vacc1 = _mm256_add_ps(vin1, vacc1);
      vacc2 = _mm256_add_ps(vin2, vacc2);
      vacc3 = _mm256_add_ps(vin3, vacc3);
      ...
      vin4 = _mm256_loadu_ps(&i4[32]);
      vin5 = _mm256_loadu_ps(&i4[40]);
      vin6 = _mm256_loadu_ps(&i4[48]);
      vin7 = _mm256_loadu_ps(&i4[56]);
      vacc0 = _mm256_add_ps(vin0, vacc0);
      vacc1 = _mm256_add_ps(vin1, vacc1);
      vacc2 = _mm256_add_ps(vin2, vacc2);
      vacc3 = _mm256_add_ps(vin3, vacc3);
      ...
      vin4 = _mm256_loadu_ps(&i5[32]);
      vin5 = _mm256_loadu_ps(&i5[40]);
      vin6 = _mm256_loadu_ps(&i5[48]);
      vin7 = _mm256_loadu_ps(&i5[56]);
      vacc0 = _mm256_add_ps(vin0, vacc0);
      vacc1 = _mm256_add_ps(vin1, vacc1);
      vacc2 = _mm256_add_ps(vin2, vacc2);
      vacc3 = _mm256_add_ps(vin3, vacc3);
      ...
      vin4 = _mm256_loadu_ps(&i6[32]);
      vin5 = _mm256_loadu_ps(&i6[40]);
      vin6 = _mm256_loadu_ps(&i6[48]);
      vin7 = _mm256_loadu_ps(&i6[56]);
      vacc0 = _mm256_add_ps(vin0, vacc0);
      vacc1 = _mm256_add_ps(vin1, vacc1);
      vacc2 = _mm256_add_ps(vin2, vacc2);
      vacc3 = _mm256_add_ps(vin3, vacc3);
    ...
    vacc4 = _mm256_max_ps(vacc4, vmin);
    vacc4 = _mm256_min_ps(vacc4, vmax);
    vacc5 = _mm256_mul_ps(vacc5, vscale);
    vacc5 = _mm256_max_ps(vacc5, vmin);
    vacc5 = _mm256_min_ps(vacc5, vmax);
    ...
    vacc7 = _mm256_max_ps(vacc7, vmin);
    vacc7 = _mm256_min_ps(vacc7, vmax);
    ...
    __m256 vo4 = _mm256_loadu_ps(o); o += 8;
    __m256 vo5 = _mm256_loadu_ps(o); o += 8;
    __m256 vo6 = _mm256_loadu_ps(o); o += 8;
    __m256 vo7 = _mm256_loadu_ps(o); o += 8;
    ...
    _mm256_storeu_ps(output, vacc4); output += 8;
    _mm256_storeu_ps(output, vacc5); output += 8;
    _mm256_storeu_ps(output, vacc6); output += 8;
    _mm256_storeu_ps(output, vacc7); output += 8;

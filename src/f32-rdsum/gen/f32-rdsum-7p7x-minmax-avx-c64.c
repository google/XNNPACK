    ...
    const struct xnn_f32_scale_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; channels >= 64; channels -= 64) {
    ...
    for (int r = rows; r > 0; r -= 7) {
      ...
      vin4 = xnn_loadu_f32(&i0[32]);
      vin5 = xnn_loadu_f32(&i0[40]);
      vin6 = xnn_loadu_f32(&i0[48]);
      vin7 = xnn_loadu_f32(&i0[56]);
      ...
      vin4 = xnn_loadu_f32(&i1[32]);
      vin5 = xnn_loadu_f32(&i1[40]);
      vin6 = xnn_loadu_f32(&i1[48]);
      vin7 = xnn_loadu_f32(&i1[56]);
      vacc0 = xnn_add_f32(vin0, vacc0);
      vacc1 = xnn_add_f32(vin1, vacc1);
      vacc2 = xnn_add_f32(vin2, vacc2);
      vacc3 = xnn_add_f32(vin3, vacc3);
      ...
      vin4 = xnn_loadu_f32(&i2[32]);
      vin5 = xnn_loadu_f32(&i2[40]);
      vin6 = xnn_loadu_f32(&i2[48]);
      vin7 = xnn_loadu_f32(&i2[56]);
      vacc0 = xnn_add_f32(vin0, vacc0);
      vacc1 = xnn_add_f32(vin1, vacc1);
      vacc2 = xnn_add_f32(vin2, vacc2);
      vacc3 = xnn_add_f32(vin3, vacc3);
      ...
      vin4 = xnn_loadu_f32(&i3[32]);
      vin5 = xnn_loadu_f32(&i3[40]);
      vin6 = xnn_loadu_f32(&i3[48]);
      vin7 = xnn_loadu_f32(&i3[56]);
      vacc0 = xnn_add_f32(vin0, vacc0);
      vacc1 = xnn_add_f32(vin1, vacc1);
      vacc2 = xnn_add_f32(vin2, vacc2);
      vacc3 = xnn_add_f32(vin3, vacc3);
      ...
      vin4 = xnn_loadu_f32(&i4[32]);
      vin5 = xnn_loadu_f32(&i4[40]);
      vin6 = xnn_loadu_f32(&i4[48]);
      vin7 = xnn_loadu_f32(&i4[56]);
      vacc0 = xnn_add_f32(vin0, vacc0);
      vacc1 = xnn_add_f32(vin1, vacc1);
      vacc2 = xnn_add_f32(vin2, vacc2);
      vacc3 = xnn_add_f32(vin3, vacc3);
      ...
      vin4 = xnn_loadu_f32(&i5[32]);
      vin5 = xnn_loadu_f32(&i5[40]);
      vin6 = xnn_loadu_f32(&i5[48]);
      vin7 = xnn_loadu_f32(&i5[56]);
      vacc0 = xnn_add_f32(vin0, vacc0);
      vacc1 = xnn_add_f32(vin1, vacc1);
      vacc2 = xnn_add_f32(vin2, vacc2);
      vacc3 = xnn_add_f32(vin3, vacc3);
      ...
      vin4 = xnn_loadu_f32(&i6[32]);
      vin5 = xnn_loadu_f32(&i6[40]);
      vin6 = xnn_loadu_f32(&i6[48]);
      vin7 = xnn_loadu_f32(&i6[56]);
      vacc0 = xnn_add_f32(vin0, vacc0);
      vacc1 = xnn_add_f32(vin1, vacc1);
      vacc2 = xnn_add_f32(vin2, vacc2);
      vacc3 = xnn_add_f32(vin3, vacc3);
    ...
    xnn_simd_f32_t vo4 = xnn_loadu_f32(o); o += 8;
    xnn_simd_f32_t vo5 = xnn_loadu_f32(o); o += 8;
    xnn_simd_f32_t vo6 = xnn_loadu_f32(o); o += 8;
    xnn_simd_f32_t vo7 = xnn_loadu_f32(o); o += 8;
    ...
    xnn_storeu_f32(output, vacc4); output += 8;
    xnn_storeu_f32(output, vacc5); output += 8;
    xnn_storeu_f32(output, vacc6); output += 8;
    xnn_storeu_f32(output, vacc7); output += 8;

...
void xnn_f32_qc4w_gemm_minmax_ukernel_6x8__fma3_dup(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_qc4w_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; k >= 4 * sizeof(float); k -= 4 * sizeof(float)) {
      ...
      vacc4x0123 = _mm_fmadd_ps(va4c0000, vb0123c0, vacc4x0123);
      vacc5x0123 = _mm_fmadd_ps(va5c0000, vb0123c0, vacc5x0123);
      ...
      vacc4x4567 = _mm_fmadd_ps(va4c0000, vb4567c0, vacc4x4567);
      vacc5x4567 = _mm_fmadd_ps(va5c0000, vb4567c0, vacc5x4567);
      ...
      vacc4x0123 = _mm_fmadd_ps(va4c1111, vb0123c1, vacc4x0123);
      vacc5x0123 = _mm_fmadd_ps(va5c1111, vb0123c1, vacc5x0123);
      ...
      vacc4x4567 = _mm_fmadd_ps(va4c1111, vb4567c1, vacc4x4567);
      vacc5x4567 = _mm_fmadd_ps(va5c1111, vb4567c1, vacc5x4567);
      ...
      vacc4x0123 = _mm_fmadd_ps(va4c2222, vb0123c2, vacc4x0123);
      vacc5x0123 = _mm_fmadd_ps(va5c2222, vb0123c2, vacc5x0123);
      ...
      vacc4x4567 = _mm_fmadd_ps(va4c2222, vb4567c2, vacc4x4567);
      vacc5x4567 = _mm_fmadd_ps(va5c2222, vb4567c2, vacc5x4567);
      ...
      vacc4x0123 = _mm_fmadd_ps(va4c3333, vb0123c3, vacc4x0123);
      vacc5x0123 = _mm_fmadd_ps(va5c3333, vb0123c3, vacc5x0123);
      ...
      vacc4x4567 = _mm_fmadd_ps(va4c3333, vb4567c3, vacc4x4567);
      vacc5x4567 = _mm_fmadd_ps(va5c3333, vb4567c3, vacc5x4567);
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      vacc4x0123 = _mm_fmadd_ps(va4, vb0123, vacc4x0123);
      vacc5x0123 = _mm_fmadd_ps(va5, vb0123, vacc5x0123);
      ...
      vacc4x4567 = _mm_fmadd_ps(va4, vb4567, vacc4x4567);
      vacc5x4567 = _mm_fmadd_ps(va5, vb4567, vacc5x4567);

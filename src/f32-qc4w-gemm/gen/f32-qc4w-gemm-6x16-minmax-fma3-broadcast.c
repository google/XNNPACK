...
void xnn_f32_qc4w_gemm_minmax_ukernel_6x16__fma3_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_qc4w_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; k >= 2 * sizeof(float); k -= sizeof(float) * 2) {
      ...
      vacc5x01234567 = _mm256_fmadd_ps(va5c0, vb01234567c0, vacc5x01234567);
      ...
      vacc5x89ABCDEF = _mm256_fmadd_ps(va5c0, vb89ABCDEFc0, vacc5x89ABCDEF);
      ...
      vacc5x01234567 = _mm256_fmadd_ps(va5c1, vb01234567c1, vacc5x01234567);
      ...
      vacc5x89ABCDEF = _mm256_fmadd_ps(va5c1, vb89ABCDEFc1, vacc5x89ABCDEF);
    }
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      vacc5x89ABCDEF = _mm256_fmadd_ps(va5, vb89ABCDEF, vacc5x89ABCDEF);
    }

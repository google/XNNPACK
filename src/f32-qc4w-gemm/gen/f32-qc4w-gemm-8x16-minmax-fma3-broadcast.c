...
void xnn_f32_qc4w_gemm_minmax_ukernel_8x16__fma3_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_qc4w_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; k >= 2 * sizeof(float); k -= sizeof(float) * 2) {
      ...
      vacc6x01234567 = _mm256_fmadd_ps(va6c0, vb01234567c0, vacc6x01234567);
      vacc7x01234567 = _mm256_fmadd_ps(va7c0, vb01234567c0, vacc7x01234567);
      ...
      vacc6x89ABCDEF = _mm256_fmadd_ps(va6c0, vb89ABCDEFc0, vacc6x89ABCDEF);
      vacc7x89ABCDEF = _mm256_fmadd_ps(va7c0, vb89ABCDEFc0, vacc7x89ABCDEF);
      ...
      vacc6x01234567 = _mm256_fmadd_ps(va6c1, vb01234567c1, vacc6x01234567);
      vacc7x01234567 = _mm256_fmadd_ps(va7c1, vb01234567c1, vacc7x01234567);
      ...
      vacc6x89ABCDEF = _mm256_fmadd_ps(va6c1, vb89ABCDEFc1, vacc6x89ABCDEF);
      vacc7x89ABCDEF = _mm256_fmadd_ps(va7c1, vb89ABCDEFc1, vacc7x89ABCDEF);
    }
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      vacc7x89ABCDEF = _mm256_fmadd_ps(va7, vb89ABCDEF, vacc7x89ABCDEF);
    }

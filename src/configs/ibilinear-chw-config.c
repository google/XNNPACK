...
static void init_f16_ibilinear_chw_config(void) {
  ...
  if (hardware_config->use_arm_neon_fp16_arith) {
    f16_ibilinear_chw_config.ukernel = (xnn_ibilinear_chw_ukernel_fn)
  ...
  f16_ibilinear_chw_config.indirection_init =
      (xnn_indirection_init_resize_bilinear2d_chw_fn)
...
static void init_f32_ibilinear_chw_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    f32_ibilinear_chw_config.ukernel =
        (xnn_ibilinear_chw_ukernel_fn)xnn_f32_ibilinear_chw_ukernel__neon_p8;
    f32_ibilinear_chw_config.channel_tile = 1;
  } else if (!XNN_PLATFORM_MOBILE) {
    f32_ibilinear_chw_config.ukernel =
        (xnn_ibilinear_chw_ukernel_fn)xnn_f32_ibilinear_chw_ukernel__scalar_p4;
    f32_ibilinear_chw_config.channel_tile = 1;
  }
#elif XNN_ARCH_ARM64
  f32_ibilinear_chw_config.ukernel =
      (xnn_ibilinear_chw_ukernel_fn)xnn_f32_ibilinear_chw_ukernel__neonfma_p8;
  f32_ibilinear_chw_config.channel_tile = 1;
#elif XNN_ARCH_X86 || XNN_ARCH_X86_64
  f32_ibilinear_chw_config.ukernel =
      (xnn_ibilinear_chw_ukernel_fn)xnn_f32_ibilinear_chw_ukernel__sse_p8;
  f32_ibilinear_chw_config.channel_tile = 1;
#elif XNN_ARCH_WASMRELAXEDSIMD || XNN_ARCH_WASMSIMD
  f32_ibilinear_chw_config.ukernel =
      (xnn_ibilinear_chw_ukernel_fn)xnn_f32_ibilinear_chw_ukernel__wasmsimd_p8;
  f32_ibilinear_chw_config.channel_tile = 1;
#else
  f32_ibilinear_chw_config.ukernel =
      (xnn_ibilinear_chw_ukernel_fn)xnn_f32_ibilinear_chw_ukernel__scalar_p4;

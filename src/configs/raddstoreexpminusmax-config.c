...
static struct xnn_raddstoreexpminusmax_config f16_raddstoreexpminusmax_config =
    {0};
static struct xnn_raddstoreexpminusmax_config f32_raddstoreexpminusmax_config =
    {0};
...
static bool is_f16_compatible_config(
    const struct xnn_hardware_config
        hardware_config[restrict XNN_MIN_ELEMENTS(1)]) {

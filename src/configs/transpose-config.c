...
static void init_transpose_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    ...
    transpose_config.x8 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
    ...
    transpose_config.x32 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
            xnn_x32_transposec_ukernel__4x4_reuse_dec_zip_neon,
        .tile_size = 32,
    };
    transpose_config.x64 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
            xnn_x64_transposec_ukernel__2x2_reuse_dec_zip_neon,
        .tile_size = 32,
    };
    ...
    transpose_config.x8 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
            xnn_x8_transposec_ukernel__2x4_scalar_int,
        .tile_size = 32,
    };
    transpose_config.x16 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
    ...
    transpose_config.x24 = (struct xnn_transpose_subconfig){
        .const_size_ukernel =
            (xnn_transposec_ukernel_fn)xnn_x24_transposec_ukernel__1x2_scalar,
        .tile_size = 32,
    };
    transpose_config.x32 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
    ...
    transpose_config.x64 = (struct xnn_transpose_subconfig){
        .const_size_ukernel = (xnn_transposec_ukernel_fn)
            xnn_x64_transposec_ukernel__4x2_scalar_int,
        .tile_size = 32,
    };
    transpose_config.xx = (struct xnn_transpose_subconfig){
        .variable_size_ukernel = xnn_xx_transposev_ukernel__1x1_scalar_memcpy,
  ...
  transpose_config.x64 = (struct xnn_transpose_subconfig){
      .const_size_ukernel = (xnn_transposec_ukernel_fn)
          xnn_x64_transposec_ukernel__2x2_multi_dec_zip_neon,
      .tile_size = 32,
  };
  transpose_config.xx = (struct xnn_transpose_subconfig){
      .variable_size_ukernel = xnn_xx_transposev_ukernel__1x1_scalar_memcpy,
  ...
  transpose_config.x8 = (struct xnn_transpose_subconfig){
      .const_size_ukernel = (xnn_transposec_ukernel_fn)
          xnn_x8_transposec_ukernel__16x16_reuse_mov_sse2,
      .tile_size = 32,
  };
  transpose_config.x16 = (struct xnn_transpose_subconfig){
      .const_size_ukernel = (xnn_transposec_ukernel_fn)
          xnn_x16_transposec_ukernel__8x8_reuse_multi_sse2,
      .tile_size = 32,
  };
  transpose_config.x24 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
  ...
  transpose_config.x32 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
          (xnn_transposec_ukernel_fn)xnn_x32_transposec_ukernel__4x4_sse,
      .tile_size = 32,
  };
  transpose_config.x64 = (struct xnn_transpose_subconfig){
      .const_size_ukernel = (xnn_transposec_ukernel_fn)
  ...
  if (hardware_config->use_x86_ssse3) {
    transpose_config.x24 = (struct xnn_transpose_subconfig){
        .const_size_ukernel =
            (xnn_transposec_ukernel_fn)xnn_x24_transposec_ukernel__4x4_ssse3,
        .tile_size = 32,
    };
  }
  ...
  transpose_config.x8 = (struct xnn_transpose_subconfig){
      .const_size_ukernel = (xnn_transposec_ukernel_fn)
          xnn_x8_transposec_ukernel__16x16_reuse_mov_wasmsimd,
      .tile_size = 32,
  };
  transpose_config.x16 = (struct xnn_transpose_subconfig){
      .const_size_ukernel = (xnn_transposec_ukernel_fn)
          xnn_x16_transposec_ukernel__8x8_reuse_mov_wasmsimd,
      .tile_size = 32,
  };
  transpose_config.x24 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
  ...
  transpose_config.x64 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
          (xnn_transposec_ukernel_fn)xnn_x64_transposec_ukernel__4x2_scalar_int,
      .tile_size = 32,
  };
  transpose_config.xx = (struct xnn_transpose_subconfig){
      .variable_size_ukernel = xnn_xx_transposev_ukernel__1x1_scalar_memcpy,
  ...
  transpose_config.x8 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
          (xnn_transposec_ukernel_fn)xnn_x8_transposec_ukernel__2x4_scalar_int,
      .tile_size = 32,
  };
  transpose_config.x16 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
          (xnn_transposec_ukernel_fn)xnn_x16_transposec_ukernel__2x4_scalar_int,
      .tile_size = 32,
  };
  transpose_config.x24 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
  ...
  if (hardware_config->vlenb >= 128) {
    transpose_config.x32 = (struct xnn_transpose_subconfig){
        .const_size_ukernel =
            (xnn_transposec_ukernel_fn)xnn_x32_transposec_ukernel__32x8_rvv,
        .tile_size = 32,
    };
  } else if (hardware_config->vlenb == 64) {
    transpose_config.x32 = (struct xnn_transpose_subconfig){
        .const_size_ukernel =
            (xnn_transposec_ukernel_fn)xnn_x32_transposec_ukernel__16x8_rvv,
        .tile_size = 32,
    };
  } else if (hardware_config->vlenb == 32) {
    transpose_config.x32 = (struct xnn_transpose_subconfig){
        .const_size_ukernel =
            (xnn_transposec_ukernel_fn)xnn_x32_transposec_ukernel__8x8_rvv,
        .tile_size = 32,
    };
  } else if (hardware_config->vlenb == 16) {
    transpose_config.x32 = (struct xnn_transpose_subconfig){
        .const_size_ukernel =
            (xnn_transposec_ukernel_fn)xnn_x32_transposec_ukernel__4x4_rvv,
        .tile_size = 32,
    };
  } else {
    transpose_config.x32 = (struct xnn_transpose_subconfig){
  ...
  transpose_config.x32 = (struct xnn_transpose_subconfig){
      .const_size_ukernel =
          (xnn_transposec_ukernel_fn)xnn_x32_transposec_ukernel__2x4_scalar_int,
      .tile_size = 32,
  };
#endif
  transpose_config.x64 = (struct xnn_transpose_subconfig){

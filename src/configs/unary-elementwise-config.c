...
static void init_f32_rndd_config(void) {
    ...
    f32_rndd_config.element_tile = hardware_config->vlenb / sizeof(float) * 4; // (VLENB/sizeof)*LMUL
  #else
    f32_rndd_config.ukernel = (xnn_vunary_ukernel_fn) xnn_f32_vrndd_ukernel__scalar_libm_u1;
    f32_rndd_config.element_tile = 1;
  #endif
...
static void init_f32_rndne_config(void) {
    ...
    f32_rndne_config.element_tile = hardware_config->vlenb / sizeof(float) * 4; // (VLENB/sizeof)*LMUL
  #else
    f32_rndne_config.ukernel = (xnn_vunary_ukernel_fn) xnn_f32_vrndne_ukernel__scalar_libm_u1;
    f32_rndne_config.element_tile = 1;
  #endif
...
static void init_f32_rndu_config(void) {
    ...
    f32_rndu_config.element_tile = hardware_config->vlenb / sizeof(float) * 4; // (VLENB/sizeof)*LMUL
  #else
    f32_rndu_config.ukernel = (xnn_vunary_ukernel_fn) xnn_f32_vrndu_ukernel__scalar_libm_u1;
    f32_rndu_config.element_tile = 1;
  #endif
...
static void init_f32_rndz_config(void) {
    ...
    f32_rndz_config.element_tile = hardware_config->vlenb / sizeof(float) * 4; // (VLENB/sizeof)*LMUL
  #else
    f32_rndz_config.ukernel = (xnn_vunary_ukernel_fn) xnn_f32_vrndz_ukernel__scalar_libm_u1;
    f32_rndz_config.element_tile = 1;
  #endif
...
static void init_f32_to_qs8_cvt_config(void) {
    ...
    f32_to_qs8_cvt_config.init.f32_qs8_cvt = xnn_init_f32_qs8_cvt_scalar_params;
    f32_to_qs8_cvt_config.element_tile = hardware_config->vlenb/sizeof(float) * 2; // (VLENB/sizeof)*LMUL
  #else
...
static void init_f32_to_qu8_cvt_config(void) {
    ...
    f32_to_qu8_cvt_config.init.f32_qu8_cvt = xnn_init_f32_qu8_cvt_scalar_params;
    f32_to_qu8_cvt_config.element_tile = hardware_config->vlenb/sizeof(float) * 2; // (VLENB/sizeof)*LMUL;
  #else
...
static void init_s32_to_f32_cvt_config(void) {
    ...
    if (hardware_config->use_arm_neon) {
      ...
      s32_to_f32_cvt_config.init.s32_f32_cvt = xnn_init_s32_f32_cvt_scalar_params;
      s32_to_f32_cvt_config.element_tile = 16;
    } else {
      s32_to_f32_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_s32_f32_vcvt_ukernel__scalar_u4;
      s32_to_f32_cvt_config.init.s32_f32_cvt = xnn_init_s32_f32_cvt_scalar_params;
      s32_to_f32_cvt_config.element_tile = 4;
    }
  #elif XNN_ARCH_X86 || XNN_ARCH_X86_64
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    assert(hardware_config != NULL);
...
static void init_u32_to_f32_cvt_config(void) {
    ...
    if (hardware_config->use_arm_neon) {
      ...
      u32_to_f32_cvt_config.init.u32_f32_cvt = xnn_init_u32_f32_cvt_scalar_params;
      u32_to_f32_cvt_config.element_tile = 16;
    } else {
      u32_to_f32_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_u32_f32_vcvt_ukernel__scalar_u4;
      u32_to_f32_cvt_config.init.u32_f32_cvt = xnn_init_u32_f32_cvt_scalar_params;
      u32_to_f32_cvt_config.element_tile = 4;
    }
  #elif XNN_ARCH_X86 || XNN_ARCH_X86_64
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    assert(hardware_config != NULL);
...
static void init_qs8_cvt_config(void) {
  ...
  #elif XNN_ARCH_RISCV && XNN_ENABLE_RISCV_VECTOR
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    qs8_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_qs8_vcvt_ukernel__rvv_u2v;
    qs8_cvt_config.init.qs8_cvt = xnn_init_qs8_cvt_scalar_params;
    qs8_cvt_config.element_tile = hardware_config->vlenb / sizeof(int8_t) * 2; // (VLENB/sizeof)*LMUL;
  #else
    qs8_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_qs8_vcvt_ukernel__scalar_u4;
    qs8_cvt_config.init.qs8_cvt = xnn_init_qs8_cvt_scalar_params;
    qs8_cvt_config.element_tile = 4;
...
static void init_qu8_cvt_config(void) {
  ...
  #elif XNN_ARCH_RISCV && XNN_ENABLE_RISCV_VECTOR
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    qu8_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_qu8_vcvt_ukernel__rvv_u2v;
    qu8_cvt_config.init.qu8_cvt = xnn_init_qu8_cvt_scalar_params;
    qu8_cvt_config.element_tile = hardware_config->vlenb / sizeof(int8_t) * 2; // (VLENB/sizeof)*LMUL;
  #else
    qu8_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_qu8_vcvt_ukernel__scalar_u4;
    qu8_cvt_config.init.qu8_cvt = xnn_init_qu8_cvt_scalar_params;
    qu8_cvt_config.element_tile = 4;

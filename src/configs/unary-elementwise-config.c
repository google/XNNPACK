...
static void init_f32_to_qs8_cvt_config(void) {
  ...
  #elif XNN_ARCH_RISCV && XNN_ENABLE_RISCV_VECTOR
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    f32_to_qs8_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_f32_qs8_vcvt_ukernel__rvv_u8v;
    f32_to_qs8_cvt_config.init.f32_qs8_cvt = xnn_init_f32_qs8_cvt_rvv_params;
    f32_to_qs8_cvt_config.element_tile = hardware_config->vlenb/sizeof(float) * 8; // (VLENB/sizeof)*LMUL
  #else
...
static void init_f32_to_qu8_cvt_config(void) {
  ...
  #elif XNN_ARCH_RISCV && XNN_ENABLE_RISCV_VECTOR
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    f32_to_qu8_cvt_config.ukernel = (xnn_vunary_ukernel_fn) xnn_f32_qu8_vcvt_ukernel__rvv_u8v;
    f32_to_qu8_cvt_config.init.f32_qu8_cvt = xnn_init_f32_qu8_cvt_rvv_params;
    f32_to_qu8_cvt_config.element_tile = hardware_config->vlenb/sizeof(float) * 8; // (VLENB/sizeof)*LMUL;
  #else

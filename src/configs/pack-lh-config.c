...
static void init_f16_qdint8_pack_lh_config(void) {
  f16_qdint8_pack_lh_config.ukernel = (xnn_pack_lh_ukernel_fn)xnn_pack_lh_f16_qdint8;
...
static void init_f16_qduint8_pack_lh_config(void) {
  f16_qduint8_pack_lh_config.ukernel = (xnn_pack_lh_ukernel_fn)xnn_pack_lh_f16_qduint8;
...
static void init_f32_qdint8_pack_lh_config(void) {
  f32_qdint8_pack_lh_config.ukernel = (xnn_pack_lh_ukernel_fn)xnn_pack_lh_f32_qdint8;
...
static void init_f32_qduint8_pack_lh_config(void) {
  f32_qduint8_pack_lh_config.ukernel = (xnn_pack_lh_ukernel_fn)xnn_pack_lh_f32_qduint8;
...
static void init_qp8_pack_lh_config(void) {
  ...
  qp8_pack_lh_config.ukernel = (xnn_pack_lh_ukernel_fn)xnn_x8_packq_f32qp8_ukernel__aarch64_neon_u2;
#else
  qp8_pack_lh_config.ukernel = (xnn_pack_lh_ukernel_fn)xnn_x8_packq_f32qp8_ukernel__scalar_u1;
...
static void init_x8_igemm_pack_lh_config(void) {
    ...
    assert(hardware_config != NULL);
    if ((hardware_config->arch_flags & xnn_arch_arm_sme2)) {
      x8_igemm_pack_lh_config.igemm_ukernel = (xnn_pack_lh_igemm_ukernel_fn) xnn_x8_pack_lh_ukernel__igemm_neonsme2;
      x8_igemm_pack_lh_config.igemm_size_fn = (xnn_pack_lh_igemm_size_fn) xnn_x8_pack_lh_size__igemm_neonsme2;
      x8_igemm_pack_lh_config.igemm_offset_fn = (xnn_pack_lh_igemm_offset_fn) xnn_x8_pack_lh_offset__igemm_neonsme2;
    }
  #endif  // XNN_ENABLE_ARM_SME2
  #endif  // XNN_ARCH_ARM64 && XNN_ENABLE_KLEIDIAI

...
static void init_f16_vmulcaddc_config(void) {
  ...
  if (hardware_config->use_arm_neon_fp16_arith) {
    f16_vmulcaddc_config.ukernel = (xnn_vmulcaddc_ukernel_fn)
  ...
  if (hardware_config->use_x86_avx2) {
    f16_vmulcaddc_config.ukernel =
        (xnn_vmulcaddc_ukernel_fn)xnn_f16_vmulcaddc_minmax_ukernel_c8__fma3_2x;
    f16_vmulcaddc_config.init.f16 = xnn_init_f16_minmax_scalar_params;
    f16_vmulcaddc_config.channel_tile = 8;
    f16_vmulcaddc_config.row_tile = 2;
  }
...
static void init_f32_vmulcaddc_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    f32_vmulcaddc_config.ukernel =
        (xnn_vmulcaddc_ukernel_fn)xnn_f32_vmulcaddc_minmax_ukernel_c4__neon_2x;
    ...
    f32_vmulcaddc_config.ukernel = (xnn_vmulcaddc_ukernel_fn)
        xnn_f32_vmulcaddc_minmax_ukernel_c1__scalar_2x;
    f32_vmulcaddc_config.init.f32 = xnn_init_f32_minmax_scalar_params;
...
#elif XNN_ARCH_ARM64
  f32_vmulcaddc_config.ukernel =
      (xnn_vmulcaddc_ukernel_fn)xnn_f32_vmulcaddc_minmax_ukernel_c4__neonfma_2x;
  f32_vmulcaddc_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_vmulcaddc_config.channel_tile = 4;
  f32_vmulcaddc_config.row_tile = 2;
#elif XNN_ARCH_X86 || XNN_ARCH_X86_64
  f32_vmulcaddc_config.ukernel =
      (xnn_vmulcaddc_ukernel_fn)xnn_f32_vmulcaddc_minmax_ukernel_c4__sse_2x;
  f32_vmulcaddc_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_vmulcaddc_config.channel_tile = 4;
  f32_vmulcaddc_config.row_tile = 2;
  ...
  if (hardware_config->is_x86) {
    f32_vmulcaddc_config.ukernel = (xnn_vmulcaddc_ukernel_fn)
        xnn_f32_vmulcaddc_minmax_ukernel_c4__wasmsimd_x86_2x;
    f32_vmulcaddc_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_vmulcaddc_config.channel_tile = 4;
    f32_vmulcaddc_config.row_tile = 2;
  } else {
...
#elif XNN_ARCH_WASM
  f32_vmulcaddc_config.ukernel =
      (xnn_vmulcaddc_ukernel_fn)xnn_f32_vmulcaddc_minmax_ukernel_c1__wasm_2x;
  f32_vmulcaddc_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_vmulcaddc_config.channel_tile = 1;
  f32_vmulcaddc_config.row_tile = 2;
#else
  f32_vmulcaddc_config.ukernel =
      (xnn_vmulcaddc_ukernel_fn)xnn_f32_vmulcaddc_minmax_ukernel_c1__scalar_2x;
  f32_vmulcaddc_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_vmulcaddc_config.channel_tile = 1;
  f32_vmulcaddc_config.row_tile = 2;
#endif

...
static void init_f16_spmm_config(void) {
  ...
  if (hardware_config->use_arm_neon_fp16_arith) {
    f16_spmm_config.ukernel = (xnn_spmm_ukernel_fn)
...
static void init_f32_spmm_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    f32_spmm_config.ukernel =
        (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x1__neon;
    f32_spmm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_spmm_config.mr = 32;
    f32_spmm_config.nr = 1;
  } else if (!XNN_PLATFORM_MOBILE) {
    f32_spmm_config.ukernel =
        (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_8x1__scalar;
    f32_spmm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
...
#elif XNN_ARCH_ARM64
  f32_spmm_config.ukernel =
      (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x1__neonfma_pipelined;
  f32_spmm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_spmm_config.mr = 32;
  f32_spmm_config.nr = 1;
#elif XNN_ARCH_X86 || XNN_ARCH_X86_64
  f32_spmm_config.ukernel =
      (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x1__sse;
  f32_spmm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_spmm_config.mr = 32;
  f32_spmm_config.nr = 1;
  ...
  if (hardware_config->is_x86) {
    f32_spmm_config.ukernel = (xnn_spmm_ukernel_fn)
  ...
  if (hardware_config->is_x86) {
    f32_spmm_config.ukernel =
        (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x1__wasmsimd_x86;
    f32_spmm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_spmm_config.mr = 32;
    f32_spmm_config.nr = 1;
  } else {
    f32_spmm_config.ukernel =
        (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x1__wasmsimd_arm;
    f32_spmm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_spmm_config.mr = 32;
    f32_spmm_config.nr = 1;
  }
...
static void init_f32_spmm2_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    f32_spmm2_config.ukernel =
        (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_8x2__scalar;
...
#elif XNN_ARCH_ARM64
  f32_spmm2_config.ukernel =
      (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x2__aarch64_neonfma;
  f32_spmm2_config.init.f32 = xnn_init_f32_minmax_scalar_params;
...
static void init_f32_spmm4_config(void) {
  ...
  if (!XNN_PLATFORM_MOBILE) {
    f32_spmm4_config.ukernel =
        (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_8x4__scalar;
...
#elif XNN_ARCH_ARM64
  f32_spmm4_config.ukernel =
      (xnn_spmm_ukernel_fn)xnn_f32_spmm_minmax_ukernel_32x4__aarch64_neonfma;
  f32_spmm4_config.init.f32 = xnn_init_f32_minmax_scalar_params;

  ...
  if (XNN_ENABLE_ARM_SME2 &&
    ...
    pf16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        xnn_init_hmp_gemm_ukernel(
            (xnn_gemm_ukernel_fn)xnn_pf16_gemm_minmax_ukernel_1x32c2__neonsme2);
    pf16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
        xnn_init_hmp_gemm_ukernel((
            xnn_gemm_ukernel_fn)xnn_pf16_gemm_minmax_ukernel_32x32c2__neonsme2);
...
static void init_f32_gemm_config_impl(struct xnn_gemm_config* f32_gemm_config,
  ...
  if ((!consistent_arithmetic &&
    ...
    f32_gemm_config->pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_gemm_config->pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_f32_gemm_goi_w;
  ...
  if (hardware_config->is_x86) {
    ...
    if (hardware_concurrency() >
      ...
      f32_gemm_config->relu.gemm[XNN_MR_TO_INDEX(1)] =
          xnn_init_hmp_gemm_ukernel(
              (xnn_gemm_ukernel_fn)
                  xnn_f32_gemm_relu_ukernel_1x8__wasmsimd_loadsplat);
      f32_gemm_config->relu.gemm[XNN_MR_TO_INDEX(4)] =
          xnn_init_hmp_gemm_ukernel(
              (xnn_gemm_ukernel_fn)
  ...
  f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] = xnn_init_hmp_gemm_ukernel(
      (xnn_gemm_ukernel_fn)xnn_f32_gemm_minmax_ukernel_1x64__hvx_broadcast);
  f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(5)] = xnn_init_hmp_gemm_ukernel(
      (xnn_gemm_ukernel_fn)xnn_f32_gemm_minmax_ukernel_5x64__hvx_broadcast);
  f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_gemm_config->pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_x32_packw_gemm_gio_ukernel_x64__hvx_u2;
  f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
...
static void init_f32_gemm_nr2_config_impl(
  ...
  if ((!consistent_arithmetic &&
    ...
    f32_gemm_nr2_config->minmax
        .gemm[XNN_MR_TO_INDEX(10)] = xnn_init_hmp_gemm_ukernel(
        (xnn_gemm_ukernel_fn)
            xnn_f32_gemm_minmax_ukernel_10x16c2__asm_amd64_avx512f_broadcast);
    f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_nr2_config->pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_gemm_nr2_config->pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_f32_gemm_goi_w;
...
static void init_qdu8_f32_qb4w_gemm_config(void) {
  ...
  if ((hardware_config->arch_flags & xnn_arch_x86_avx512vnnigfni) &&
      hardware_config->uarch[0] != xnn_uarch_zen4) {
...
static void init_qdu8_f32_qc4w_gemm_config(void) {
  ...
  if (false && (hardware_config->arch_flags & xnn_arch_x86_avx512vnnigfni) &&
      hardware_config->uarch[0] != xnn_uarch_zen4) {

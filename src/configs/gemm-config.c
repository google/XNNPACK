  ...
  // Arch-specific parameters.
    ...
    // TODO(b/460806642): Don't enable this without a fast packing kernel.
      ...
      if (hardware_config->arch_flags & xnn_arch_x86_avx512f) {
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_1x16__avx512f_broadcast);
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(7)] = XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_7x16__avx512f_broadcast);
        f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
        f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn) xnn_x32_packw_gemm_gio_ukernel_x16__avx512f_u8;

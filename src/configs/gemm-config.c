...
static struct xnn_gemm_config pqs8_qc2w_gemm_config = {0};
...
XNN_INIT_ONCE_GUARD(pqs8_qc2w_gemm);
...
static void init_pqs8_qc2w_gemm_config(void) {
  pqs8_qc2w_gemm_config.log2_input_element_size = XNN_LOG2_SIZEOF_INT8_T;
  pqs8_qc2w_gemm_config.log2_filter_element_size = XNN_LOG2_SIZEOF_INT8_T;
  pqs8_qc2w_gemm_config.log2_filter_element_bit_size = XNN_LOG2_BIT_SIZEOF_INT2;
  pqs8_qc2w_gemm_config.bias_element_size = sizeof(int32_t);
...
#if XNN_ENABLE_ARM_SME2
    const size_t mr =
        xnn_pqs8_qc2w_gemm_minmax_fp32_ukernel_32x64c4__neonsme2_get_mr();
    const size_t nr =
        xnn_pqs8_qc2w_gemm_minmax_fp32_ukernel_32x64c4__neonsme2_get_nr();
    if (mr > XNN_MAX_MR) {
      return;
    }
    pqs8_qc2w_gemm_config.arch = xnn_arch_arm_sme2;
    pqs8_qc2w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_pqs8_qc2w_gemm_minmax_fp32_ukernel_1x64c4__neonsme2);
    pqs8_qc2w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_pqs8_qc2w_gemm_minmax_fp32_ukernel_32x64c4__neonsme2);
    pqs8_qc2w_gemm_config.init.qs8_qc8w =
        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
    pqs8_qc2w_gemm_config.pack_weights_and_biases =
        xnn_pack_kai_qs8_qc2w_weights_and_biases_sme2;
    pqs8_qc2w_gemm_config.packed_stride_weights_and_biases =
        xnn_packed_stride_kai_qs8_qc2w_weights_and_biases_sme2;
    pqs8_qc2w_gemm_config.mr = mr;
    pqs8_qc2w_gemm_config.mr_packed = mr;
    pqs8_qc2w_gemm_config.nr = nr;
    pqs8_qc2w_gemm_config.log2_kr = 2;
    pqs8_qc2w_gemm_config.log2_sr = 0;
    pqs8_qc2w_gemm_config.planes = 4;
#endif  // XNN_ENABLE_ARM_SME2
  }
#endif  // XNN_ARCH_ARM64 && XNN_ENABLE_KLEIDIAI
}
...
const struct xnn_gemm_config* xnn_init_pqs8_qc2w_gemm_config() {
  if (xnn_init_hardware_config() == NULL) {
    return NULL;
  }
  XNN_INIT_ONCE(pqs8_qc2w_gemm);
  return pqs8_qc2w_gemm_config.mr ? &pqs8_qc2w_gemm_config : NULL;
}

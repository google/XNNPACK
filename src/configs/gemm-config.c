...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith) {
    ...
    f16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(6)] = XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(6)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    f16_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x16_packw_gemm_gio_ukernel_x8__scalar;
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith) {
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      case xnn_uarch_cortex_a55:
        f16_gemm_config.minmax
            .gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f16_gemm_minmax_ukernel_1x16__asm_aarch64_neonfp16arith_ld64);
        f16_gemm_config.minmax
            .gemm[XNN_MR_TO_INDEX(6)] = XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f16_gemm_minmax_ukernel_6x16__asm_aarch64_neonfp16arith_cortex_a55);
        f16_gemm_config.minmax
            .igemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_igemm_minmax_ukernel_1x16__asm_aarch64_neonfp16arith_ld64);
        f16_gemm_config.minmax
            .igemm[XNN_MR_TO_INDEX(6)] = XNN_INIT_HMP_IGEMM_UKERNEL(
      ...
      case xnn_uarch_exynos_m5:
        f16_gemm_config.minmax
            ...
            xnn_f16_gemm_minmax_ukernel_1x16__asm_aarch64_neonfp16arith_ld64);
        f16_gemm_config.minmax
            .gemm[XNN_MR_TO_INDEX(4)] = XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f16_gemm_minmax_ukernel_4x16__asm_aarch64_neonfp16arith_ld64);
        f16_gemm_config.minmax
            .igemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_igemm_minmax_ukernel_1x16__asm_aarch64_neonfp16arith_ld64);
        f16_gemm_config.minmax
            .igemm[XNN_MR_TO_INDEX(4)] = XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    {
      /* Choose micro-kernels for little cores according to micro-kernel
       * specification for the big core */
      ...
      for (size_t i = 1; i < XNN_MAX_UARCH_TYPES; i++) {
        switch (hardware_config->uarch[i]) {
          case xnn_uarch_cortex_a55:
            if (mr == 6 && nr == 16) {
              f16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(6)]
                  .function[i] = XNN_INIT_GEMM_UKERNEL(
                  xnn_f16_gemm_minmax_ukernel_6x16__asm_aarch64_neonfp16arith_cortex_a55);
              f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(6)]
                  .function[i] = XNN_INIT_IGEMM_UKERNEL(
                  xnn_f16_igemm_minmax_ukernel_6x16__asm_aarch64_neonfp16arith_cortex_a55);
            }
            break;
          case xnn_uarch_cortex_a55r0:
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512fp16) {
    ...
    f16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(8)] = XNN_INIT_HMP_GEMM_UKERNEL(
        xnn_f16_gemm_minmax_ukernel_8x32__avx512fp16_broadcast);
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_igemm_minmax_ukernel_1x32__avx512fp16_broadcast);
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_igemm_minmax_ukernel_8x32__avx512fp16_broadcast);
    f16_gemm_config.init.f16 = xnn_init_f16_minmax_scalar_params;
    f16_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x16_packw_gemm_gio_ukernel_x32__scalar;
#if XNN_ENABLE_AVX512SKX
    f16_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x16_packw_gemm_goi_ukernel_x32__avx512skx_u16_prfm;
#elif XNN_ENABLE_AVX2
    f16_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x16_packw_gemm_goi_ukernel_x32__avx2_u16_prfm;
#else
    f16_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
    ...
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_f32acc_igemm_minmax_ukernel_1x32__avx512skx_broadcast);
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_f32acc_igemm_minmax_ukernel_4x32__avx512skx_broadcast);
    f16_gemm_config.init.f16 = xnn_init_f16_minmax_scalar_params;
    f16_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x16_packw_gemm_gio_ukernel_x32__scalar;
    f16_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  if (hardware_config->arch_flags & xnn_arch_riscv_vector_fp16_arith) {
    ...
    f16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(7)] = XNN_INIT_HMP_GEMM_UKERNEL(
        xnn_f16_gemm_minmax_ukernel_7x4v__rvvfp16arith);
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_igemm_minmax_ukernel_1x4v__rvvfp16arith);
    f16_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f16_igemm_minmax_ukernel_7x4v__rvvfp16arith);
    f16_gemm_config.init.f16 = xnn_init_f16_minmax_scalar_params;
    f16_gemm_config.pack_gemm_gio =
...
EM_JS(int, hardware_concurrency, (void), {
  var concurrency = 1;
  try { concurrency = self.navigator.hardwareConcurrency; }
  catch(e) {
...
static void init_pf16_gemm_config(void) {
  ...
  if ((hardware_config->arch_flags & xnn_arch_arm_sme2)) {
    ...
    pf16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
    ...
    pf16_gemm_config.pack_igemm_goki = (xnn_pack_conv_goki_w_fn)
        xnn_pack_kai_f16_conv_goki_w_sme;  // both sme and sme2 use the same
                                           // packing kernel
    ...
    pf16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_pf16_gemm_minmax_ukernel_1x32c2__neonsme);
    pf16_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
...
static void init_bf16_f32_gemm_config(void) {
  ...
  bf16_f32_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_BFLOAT16 + 3;
  ...
  if (XNN_ENABLE_AVX512BF16 &&
    ...
    bf16_f32_gemm_config.minmax
        .gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
        xnn_bf16_f32_gemm_minmax_ukernel_1x32c2__asm_amd64_avx512bf16_broadcast);
    bf16_f32_gemm_config.minmax
        .gemm[XNN_MR_TO_INDEX(11)] = XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    bf16_f32_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x16_x32_packw_gemm_goi_ukernel_x32c2__scalar;
    bf16_f32_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x16_x32_packw_gemm_gio_ukernel_x32c2__scalar;
...
static void init_pf32_gemm_config(void) {
  ...
  if (XNN_ENABLE_ARM_SME2 &&
    ...
    pf32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_pf32_gemm_minmax_ukernel_1x32__neonsme2);
    pf32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_pf32_gemm_minmax_ukernel_32x32__neonsme2);
    pf32_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(mr)] =
        XNN_INIT_HMP_PACKED_IGEMM_UKERNEL(
            xnn_pf32_igemm_minmax_ukernel_32x32__neonsme2);
    pf32_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    pf32_gemm_config.pack_weights_and_biases =
        xnn_pack_kai_f32_weights_and_biases;
    pf32_gemm_config.packed_stride_weights_and_biases =
        xnn_packed_stride_kai_f32_weights_and_biases;
    pf32_gemm_config.pack_igemm_goki =
        (xnn_pack_conv_goki_w_fn)xnn_pack_kai_pf32_conv_goki_w_sme;
    pf32_gemm_config.pack_igemm_kgo =
    ...
    pf32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_pf32_gemm_minmax_ukernel_1x32__neonsme);
    pf32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_pf32_gemm_minmax_ukernel_32x32__neonsme);
    pf32_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(mr)] =
        XNN_INIT_HMP_PACKED_IGEMM_UKERNEL(
            xnn_pf32_igemm_minmax_ukernel_32x32__neonsme);
    pf32_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    pf32_gemm_config.pack_weights_and_biases =
        xnn_pack_kai_f32_weights_and_biases;
    pf32_gemm_config.packed_stride_weights_and_biases =
...
static void init_pqs8_qc8w_gemm_config(void) {
  ...
  pqs8_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
...
static void init_f32_gemm_config_impl(struct xnn_gemm_config* f32_gemm_config,
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      ...
      case xnn_uarch_kryo:
        f32_gemm_config->minmax
            .gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_gemm_minmax_ukernel_1x8__asm_aarch32_neon_cortex_a53_prfm);
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
                xnn_f32_gemm_minmax_ukernel_4x8__asm_aarch32_neon_cortex_a7);
        f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
        f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
            xnn_x32_packw_gemm_gio_ukernel_x8__neon_u2;
        f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
      ...
      case xnn_uarch_cortex_a53:
        ...
        break;
      case xnn_uarch_cortex_a55r0:
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_1x4__scalar);
    f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_4x4__scalar);
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_1x4__scalar);
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_4x4__scalar);
    f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x4__scalar;
    f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
    ...
    case xnn_uarch_exynos_m2:
      f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_1x8s4__neonfma);
      f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_4x8s4__neonfma);
      f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(6)] =
          XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_6x8s4__neonfma);
      f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
      f32_gemm_config->pack_gemm_gio =
    ...
    case xnn_uarch_neoverse_v2:
      ...
      f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(8)] =
          XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    case xnn_uarch_cortex_x4:
      ...
      f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
      f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
          xnn_x32_packw_gemm_gio_ukernel_x16__neon_u2;
      f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
    ...
    default:
      ...
      f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(7)] =
          XNN_INIT_HMP_GEMM_UKERNEL(
...
#if XNN_ENABLE_ASSEMBLY
  f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
      xnn_f32_gemm_minmax_ukernel_1x8__asm_aarch64_neonfma_ld128_acc4);
  f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(6)] = XNN_INIT_HMP_GEMM_UKERNEL(
      xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_ld128);
  f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_gemm_config->pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_x32_packw_gemm_gio_ukernel_x8__neon_u2;
  f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
      xnn_x32_packw_gemm_goi_ukernel_x8__neon_ld4lane_u4_prfm;
  f32_gemm_config->mr = 6;
  f32_gemm_config->nr = 8;
...
// TODO(b/460806642): Don't enable this without a fast packing kernel.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512f) {
    ...
    f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x32__scalar;
    f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x32_packw_gemm_goi_ukernel_x32__avx512f_u4_prfm;
    f32_gemm_config->mr = 7;
    f32_gemm_config->nr = 32;
  } else
#endif
    ...
    XNN_ENABLE_FMA3 && XNN_ENABLE_AVX
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
                xnn_f32_gemm_minmax_ukernel_1x16__asm_amd64_fma3_broadcast);
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(2)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
        ...
        f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
        f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
            xnn_x32_packw_gemm_gio_ukernel_x16__scalar;
        f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        ...
        f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(5)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_1x8__sse_load1);
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_4x8__sse_load1);
    f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_config->pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  if (hardware_config->is_x86) {
    ...
    f32_gemm_config->nr = 16;
    f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x32_packw_gemm_goi_ukernel_x16__wasmsimd_u4;
#else
    f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    if (hardware_concurrency() >
        kCoreCountThresholdForAdaptiveAvxOptimization) {
      f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_GEMM_UKERNEL(
      ...
      f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_1x8__wasmsimd_splat);
      f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_4x8__wasmsimd_splat);
      f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(6)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_1x8__wasmsimd_splat);
    f32_gemm_config->linear.gemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_5x8__wasmsimd_splat);
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_riscv_vector) {
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_1x4v__rvv);
    f32_gemm_config->minmax.gemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_7x4v__rvv);
    f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_config->pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  if (hardware_config->arch_flags & xnn_arch_hvx) {
    ...
    f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x64__hvx_u2;
    f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x32_packw_gemm_goi_ukernel_x64__scalar_int_u2;
    f32_gemm_config->mr = 5;
  ...
  f32_gemm_config->init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_gemm_config->pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_x32_packw_gemm_gio_ukernel_x4__scalar;
  f32_gemm_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
      xnn_x32_packw_gemm_goi_ukernel_x4__scalar_float_u4;
  f32_gemm_config->mr = 4;
  f32_gemm_config->nr = 4;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      ...
      case xnn_uarch_krait:
      case xnn_uarch_kryo:
        f32_igemm_config.minmax
            .igemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f32_igemm_minmax_ukernel_1x8__asm_aarch32_neon_cortex_a53_prfm);
        f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(4)] =
            XNN_INIT_HMP_IGEMM_UKERNEL(
                xnn_f32_igemm_minmax_ukernel_4x8__asm_aarch32_neon_cortex_a7);
        f32_igemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
        f32_igemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
            xnn_x32_packw_gemm_gio_ukernel_x8__neon_u2;
        f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
            xnn_x32_packw_gemm_goi_ukernel_x8__neon_ld4lane_u4_prfm;
      ...
      case xnn_uarch_cortex_a53:
        ...
        break;
      case xnn_uarch_cortex_a55r0:
        f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
            XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_1x4__scalar);
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_4x4__scalar);
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_1x4__scalar);
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_4x4__scalar);
    f32_igemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_igemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x4__scalar;
    f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
    ...
    case xnn_uarch_exynos_m2:
      ...
      f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(6)] =
          XNN_INIT_HMP_IGEMM_UKERNEL(
              xnn_f32_igemm_minmax_ukernel_6x8s4__neonfma);
      f32_igemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
      f32_igemm_config.pack_gemm_gio =
          (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
      f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
          xnn_x32_packw_gemm_goi_ukernel_x8s4__neon_ld4lane_u4_prfm;
      f32_igemm_config.mr = 6;
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512f) {
    ...
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      ...
      default:
        ...
        f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(5)] =
            XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    f32_igemm_config.nr = 16;
      ...
      if (hardware_config->arch_flags & xnn_arch_x86_sse2) {
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_1x8__sse_load1);
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_4x8__sse_load1);
    f32_igemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_igemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  if (hardware_config->is_x86) {
    ...
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f32_igemm_ukernel_1x16__wasmrelaxedsimd_fma_loadsplat_u2);
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f32_igemm_ukernel_4x16__wasmrelaxedsimd_fma_loadsplat_u2);
    f32_igemm_config.minmax
        .igemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_IGEMM_UKERNEL(
        xnn_f32_igemm_minmax_ukernel_1x16__wasmrelaxedsimd_fma_loadsplat_u2);
    f32_igemm_config.minmax
        .igemm[XNN_MR_TO_INDEX(4)] = XNN_INIT_HMP_IGEMM_UKERNEL(
        xnn_f32_igemm_minmax_ukernel_4x16__wasmrelaxedsimd_fma_loadsplat_u2);
    f32_igemm_config.mr = 4;
    f32_igemm_config.nr = 16;
    f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x32_packw_gemm_goi_ukernel_x16__wasmsimd_u4;
    ...
    if (hardware_concurrency() >
      ...
      f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_1x8__wasmsimd_splat);
      f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_4x8__wasmsimd_splat);
      f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(6)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_1x8__wasmsimd_splat);
    f32_igemm_config.linear.igemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_5x8__wasmsimd_splat);
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_riscv_vector) {
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_7x4v__rvv);
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_1x4v__rvv);
    f32_igemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_igemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  if (hardware_config->arch_flags & xnn_arch_hvx) {
    ...
    f32_igemm_config.minmax.igemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f32_igemm_minmax_ukernel_5x64__hvx_broadcast);
    f32_igemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_igemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x64__hvx_u2;
    f32_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
...
static void init_f32_gemm_nr2_config_impl(
    struct xnn_gemm_config* f32_gemm_nr2_config, bool consistent_arithmetic) {
  // Common parameters.
...
// Arch-specific parameters.
  ...
  (void)hardware_config;  // May be unused.
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_gemm_minmax_ukernel_4x2__neon_lane_ld64);
    f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f32_igemm_minmax_ukernel_4x2__neon_lane_ld64);
    f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_nr2_config->pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_gemm_nr2_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x32_packw_gemm_goi_ukernel_x2__neon_ld2lane_u2_prfm;
    f32_gemm_nr2_config->mr = 4;
    f32_gemm_nr2_config->nr = 2;
  } else {
    f32_gemm_nr2_config->linear.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_4x2__scalar);
    f32_gemm_nr2_config->linear.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_4x2__scalar);
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_4x2__scalar);
    f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_4x2__scalar);
    f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_nr2_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x2__scalar;
    f32_gemm_nr2_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
...
// TODO(b/460806642): Don't enable this without a fast packing kernel.
...
#if XNN_ENABLE_AVX512F
  if (hardware_config->arch_flags & xnn_arch_x86_avx512f) {
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_gemm_minmax_ukernel_1x16__avx512f_broadcast);
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_gemm_minmax_ukernel_7x16__avx512f_broadcast);
    f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_f32_igemm_minmax_ukernel_1x16__avx512f_broadcast);
    f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      ...
      default:
        ...
        f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(1)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
                xnn_f32_gemm_minmax_ukernel_1x8__fma3_broadcast);
        f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(5)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
                xnn_f32_gemm_minmax_ukernel_5x8__fma3_broadcast);
        f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(10)] =
            XNN_INIT_HMP_GEMM_UKERNEL(
                xnn_f32_gemm_minmax_ukernel_10x8__fma3_broadcast);
        f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(1)] =
            XNN_INIT_HMP_IGEMM_UKERNEL(
                xnn_f32_igemm_minmax_ukernel_1x8__fma3_broadcast);
        f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(5)] =
            XNN_INIT_HMP_IGEMM_UKERNEL(
                xnn_f32_igemm_minmax_ukernel_5x8__fma3_broadcast);
        f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(10)] =
            XNN_INIT_HMP_IGEMM_UKERNEL(
                xnn_f32_igemm_minmax_ukernel_10x8__fma3_broadcast);
        f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
        f32_gemm_nr2_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
            xnn_x32_packw_gemm_gio_ukernel_x8__scalar;
        f32_gemm_nr2_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
            xnn_x32_packw_gemm_goi_ukernel_x8__avx_u4;
        f32_gemm_nr2_config->mr = 10;
        f32_gemm_nr2_config->nr = 8;
    ...
    f32_gemm_nr2_config->nr = 8;
      ...
      if (hardware_config->arch_flags & xnn_arch_x86_sse2) {
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_minmax_ukernel_4x2c4__sse);
    f32_gemm_nr2_config->minmax.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_minmax_ukernel_4x2c4__sse);
    f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_nr2_config->pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_f32_gemm_gio_w;
    f32_gemm_nr2_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
...
#else
    f32_gemm_nr2_config->linear.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_gemm_ukernel_4x2c4__wasmsimd);
    f32_gemm_nr2_config->linear.igemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(xnn_f32_igemm_ukernel_4x2c4__wasmsimd);
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_hvx) {
    ...
    f32_gemm_nr2_config->minmax.gemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_gemm_minmax_ukernel_8x32__hvx_broadcast);
    f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_gemm_nr2_config->pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x32_packw_gemm_gio_ukernel_x32__hvx_u2;
    f32_gemm_nr2_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x32_packw_gemm_goi_ukernel_x32__scalar_int_u2;
  ...
  f32_gemm_nr2_config->init.f32 = xnn_init_f32_minmax_scalar_params;
  f32_gemm_nr2_config->pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_x32_packw_gemm_gio_ukernel_x2__scalar;
  f32_gemm_nr2_config->pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
      xnn_x32_packw_gemm_goi_ukernel_x2__scalar_float_u4;
  f32_gemm_nr2_config->mr = 4;
  f32_gemm_nr2_config->nr = 2;
...
// Arch-specific parameters.
  ...
  (void)hardware_config;  // May be unused.
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_qc4w_gemm_minmax_ukernel_1x8__neon_lane_ld64);
    f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_qc4w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_f32_qc4w_gemm_goi_w;
    f32_qc4w_gemm_config.mr = 4;
    f32_qc4w_gemm_config.nr = 8;
  } else {
    f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_qc4w_gemm_minmax_ukernel_1x4__scalar);
    f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_qc4w_gemm_minmax_ukernel_4x4__scalar);
    f32_qc4w_gemm_config.init.f32_qc4w = xnn_init_f32_qc4w_minmax_scalar_params;
    f32_qc4w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_f32_qc4w_gemm_goi_w;
    f32_qc4w_gemm_config.mr = 4;
  ...
  f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(6)] =
      XNN_INIT_HMP_GEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512skx) {
    ...
    f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
...
static void init_f32_qc8w_gemm_config(void) {
  ...
  f32_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    ...
    f32_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_qc8w_gemm_minmax_ukernel_1x4__scalar);
    f32_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_f32_qc8w_gemm_minmax_ukernel_4x4__scalar);
    f32_qc8w_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_qc8w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_x8_packw_gemm_gio_ukernel_x4__scalar;
    f32_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
  ...
  switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
    ...
    case xnn_uarch_neoverse_v1:
    default:
      f32_qc8w_gemm_config.minmax
          .gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
          xnn_f32_qc8w_gemm_minmax_ukernel_1x8__asm_aarch64_neonfma_ld128_acc4);
      f32_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(6)] =
          XNN_INIT_HMP_GEMM_UKERNEL(
      ...
      f32_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
          xnn_x8_packw_gemm_gio_ukernel_x8__scalar;
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512skx) {
    ...
    f32_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    f32_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_x8_packw_gemm_goi_ukernel_x32__scalar_u2;
    ...
    f32_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_f32_qc8w_gemm_minmax_ukernel_5x16__avx2_broadcast);
    f32_qc8w_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    f32_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_x8_packw_gemm_gio_ukernel_x16__scalar;
    f32_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
...
#elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
#if XNN_ARCH_WASMRELAXEDSIMD
  f32_qc8w_gemm_config.linear.gemm[XNN_MR_TO_INDEX(1)] =
      XNN_INIT_HMP_GEMM_UKERNEL(
          xnn_f32_qc8w_gemm_ukernel_1x8__wasmrelaxedsimd_fma_loadsplat);
  f32_qc8w_gemm_config.linear.gemm[XNN_MR_TO_INDEX(4)] =
      XNN_INIT_HMP_GEMM_UKERNEL(
...
static void init_qdu8_f16_qc4w_gemm_config(void) {
  ...
  qdu8_f16_qc4w_gemm_config.log2_filter_element_bit_size =
  ...
  qdu8_f16_qc4w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_qc4w_gemm_gio_w;
  qdu8_f16_qc4w_gemm_config.pack_gemm_goi =
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx256vnni) {
    ...
    qdu8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc4w_gemm_minmax_ukernel_1x8c8__avx256vnni);
    qdu8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f16_qc4w_gemm_config.packed_stride_weights_and_biases =
        NULL;  // Override the default packing function.
    qdu8_f16_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_qc4w_packw_gemm_goi_ukernel_x8c8__avx256vnni;
    qdu8_f16_qc4w_gemm_config.init.f16_qc4w =
    ...
    qdu8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f16_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_qc4uw_packw_gemm_goi_ukernel_x8c8__sse2;
    qdu8_f16_qc4w_gemm_config.init.f16_qc4w =
        xnn_init_f16_qc4w_minmax_scalar_params;
    qdu8_f16_qc4w_gemm_config.mr = 8;
    qdu8_f16_qc4w_gemm_config.nr = 8;
    ...
    qdu8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_f16_qc4w_gemm_config(void) {
  ...
  qd8_f16_qc4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  ...
  qd8_f16_qc4w_gemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs4_weights_and_biases;
  qd8_f16_qc4w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_qc4w_gemm_gio_w;
  qd8_f16_qc4w_gemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_qc4w_gemm_goi_w;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    if (XNN_ENABLE_ARM_DOTPROD &&
      ...
      qd8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    qd8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc4w_gemm_minmax_ukernel_1x16__neonfp16arith_mlal_lane);
    qd8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(6)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc4w_gemm_minmax_ukernel_6x16__neonfp16arith_mlal_lane);
    qd8_f16_qc4w_gemm_config.init.f16_qc4w =
        xnn_init_f16_qc4w_minmax_scalar_params;
  ...
  if (hardware_config->arch_flags & xnn_arch_riscv_vector_fp16_arith) {
    ...
    qd8_f16_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc4w_gemm_minmax_ukernel_7x2v__rvvfp16arith);
    qd8_f16_qc4w_gemm_config.init.f16_qc4w =
        xnn_init_f16_qc4w_minmax_scalar_params;
    qd8_f16_qc4w_gemm_config.mr = 7;
    qd8_f16_qc4w_gemm_config.nr =
        2 * hardware_config->vlenb / sizeof(xnn_float16);
    qd8_f16_qc4w_gemm_config.planes = 2;
  }
#endif
...
static void init_qd8_f16_qc2w_gemm_config(void) {
  ...
  qd8_f16_qc2w_gemm_config.log2_filter_element_bit_size =
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon_dot) {
...
#if XNN_ARCH_ARM64
    qd8_f16_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qd8_f16_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(2)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qdu8_f16_qc2w_gemm_config(void) {
  ...
  qdu8_f16_qc2w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT2;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avxvnni) {
    ...
    qdu8_f16_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc2w_gemm_minmax_ukernel_1x8c8__avxvnni);
    qdu8_f16_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc2w_gemm_minmax_ukernel_5x8c8__avxvnni);
    qdu8_f16_qc2w_gemm_config.pack_weights_and_biases =
        (xnn_pack_weights_and_biases_fn)xnn_pack_qd8_qc2w_weights_and_biases;
    qdu8_f16_qc2w_gemm_config.packed_stride_weights_and_biases =
        (xnn_packed_stride_weights_and_biases_fn)
            xnn_packed_stride_qc2w_weights_and_biases;
    qdu8_f16_qc2w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qd8_qc2w_gemm_gio_w;
    qdu8_f16_qc2w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qd8_qc2w_gemm_goi_w;
    ...
    qdu8_f16_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_f16_qb4w_gemm_config(void) {
  ...
  qd8_f16_qb4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  qd8_f16_qb4w_gemm_config.bias_element_size = sizeof(float);
  qd8_f16_qb4w_gemm_config.packed_stride_weights_and_biases =
      xnn_packed_stride_qb4_weights_and_biases;
  qd8_f16_qb4w_gemm_config.pack_weights_and_biases =
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    if (XNN_ENABLE_ARM_DOTPROD &&
        ...
        (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith)) {
#if XNN_ENABLE_ARM_DOTPROD
      qd8_f16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
              xnn_qd8_f16_qb4w_gemm_minmax_ukernel_1x16c4__neondotfp16arith);
      qd8_f16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
              xnn_qd8_f16_qb4w_gemm_minmax_ukernel_4x16c4__neondotfp16arith);
      qd8_f16_qb4w_gemm_config.init.f16_qb4w =
      ...
      qd8_f16_qb4w_gemm_config.minmax
          .dqgemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_DQGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    qd8_f16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qb4w_gemm_minmax_ukernel_1x16__neonfp16arith_mlal_lane);
    qd8_f16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(6)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qb4w_gemm_minmax_ukernel_6x16__neonfp16arith_mlal_lane);
    qd8_f16_qb4w_gemm_config.init.f16_qb4w =
        xnn_init_f16_qb4w_minmax_scalar_params;
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx2) {
    ...
    qd8_f16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_bf16_qb4w_gemm_config(void) {
  ...
  qd8_bf16_qb4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  qd8_bf16_qb4w_gemm_config.bias_element_size = sizeof(float);
  qd8_bf16_qb4w_gemm_config.packed_stride_weights_and_biases =
      xnn_packed_stride_qb4_weights_and_biases;
  qd8_bf16_qb4w_gemm_config.pack_weights_and_biases =
      xnn_pack_qb4_weights_and_biases;

  // Scalar fallback.
  qd8_bf16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
      XNN_INIT_HMP_DQGEMM_UKERNEL(
          xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_1x4__scalar);
  qd8_bf16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
      XNN_INIT_HMP_DQGEMM_UKERNEL(
          xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_4x4__scalar);
  qd8_bf16_qb4w_gemm_config.init.bf16_qb4w =
...
// The i8mm kernels convert fp32->bf16 with `vcvt_bf16_f32`, so they require
// both the i8mm and bf16 arch extensions. The neondot kernels do the conversion
// with integer ops, so they only need dotprod. Prefer i8mm, then dotprod, else
// scalar.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx2) {
    ...
    qd8_bf16_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_f32_qc2w_gemm_config(void) {
  ...
  qd8_f32_qc2w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT2;
...
static void init_qdu8_f32_qc2w_gemm_config(void) {
  ...
  qdu8_f32_qc2w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT2;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avxvnni) {
    ...
    qdu8_f32_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f32_qc2w_gemm_minmax_ukernel_1x8c8__avxvnni);
    qdu8_f32_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f32_qc2w_gemm_minmax_ukernel_5x8c8__avxvnni);
    qdu8_f32_qc2w_gemm_config.pack_weights_and_biases =
        (xnn_pack_weights_and_biases_fn)xnn_pack_qd8_qc2w_weights_and_biases;
    qdu8_f32_qc2w_gemm_config.packed_stride_weights_and_biases =
        (xnn_packed_stride_weights_and_biases_fn)
            xnn_packed_stride_qc2w_weights_and_biases;
    qdu8_f32_qc2w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qd8_qc2w_gemm_gio_w;
    qdu8_f32_qc2w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qd8_qc2w_gemm_goi_w;
    ...
    qdu8_f32_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f32_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_f32_qc4w_gemm_config(void) {
  ...
  qd8_f32_qc4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  ...
  qd8_f32_qc4w_gemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs4_weights_and_biases;
  qd8_f32_qc4w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_qc4w_gemm_gio_w;  // Ignored
  qd8_f32_qc4w_gemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_qc4w_gemm_goi_w;  // Ignored
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512amx) {
    ...
    qd8_f32_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qp8_f32_qc4w_gemm_config(void) {
  ...
  qp8_f32_qc4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  ...
  if (XNN_ENABLE_ARM_SME2 &&
    ...
    const size_t nr =
        xnn_qp8_f32_qc4w_gemm_minmax_ukernel_16x64c4__neonsme2_get_nr();
...
#if XNN_ENABLE_ARM_SME
    const size_t mr =
        xnn_qp8_f32_qc4w_gemm_minmax_ukernel_16x64c4__neonsme_get_mr();
    const size_t nr =
        xnn_qp8_f32_qc4w_gemm_minmax_ukernel_16x64c4__neonsme_get_nr();
    qp8_f32_qc4w_gemm_config.minmax.qp8gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_QP8GEMM_UKERNEL(
...
static void init_qp8_f32_qc8w_gemm_config(void) {
  ...
  qp8_f32_qc8w_gemm_config.log2_filter_element_bit_size =
  ...
  if (XNN_ENABLE_ARM_SME2 &&
    ...
    const size_t nr =
        xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme2_get_nr();
    qp8_f32_qc8w_gemm_config.minmax.qp8gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_QP8GEMM_UKERNEL(
    ...
    qp8_f32_qc8w_gemm_config.packed_stride_weights_and_biases =
...
#if XNN_ENABLE_ARM_SME
    const size_t mr =
        xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme_get_mr();
    const size_t nr =
        xnn_qp8_f32_qc8w_gemm_minmax_ukernel_16x64c4__neonsme_get_nr();
    qp8_f32_qc8w_gemm_config.minmax.qp8gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_QP8GEMM_UKERNEL(
    ...
    qp8_f32_qc8w_gemm_config.minmax.qp8gemm[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_QP8GEMM_UKERNEL(
    ...
    qp8_f32_qc8w_gemm_config.minmax
        .qp8gemm[XNN_MR_TO_INDEX(16)] = XNN_INIT_HMP_QP8GEMM_UKERNEL(
...
static void init_qp8_f32_qb4w_gemm_config(void) {
  ...
  qp8_f32_qb4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
...
// Arch-specific parameters.
  ...
  if (XNN_ENABLE_ARM_I8MM &&
      (hardware_config->arch_flags & xnn_arch_arm_neon_i8mm)) {
#if XNN_ENABLE_ARM_I8MM && XNN_ENABLE_ARM_DOTPROD
    qp8_f32_qb4w_gemm_config.minmax.qp8gemm_bl[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_QP8GEMM_BL_UKERNEL(
            xnn_qp8_f32_qb4w_gemm_minmax_ukernel_1x4c16s2__aarch64_neondot);
    qp8_f32_qb4w_gemm_config.minmax.qp8gemm_bl[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_QP8GEMM_BL_UKERNEL(
            xnn_qp8_f32_qb4w_gemm_minmax_ukernel_16x4c16s2__neoni8mm_mstep4);
    qp8_f32_qb4w_gemm_config.init.f32_qb4w =
        xnn_init_f32_qb4w_minmax_scalar_params;
    qp8_f32_qb4w_gemm_config.pack_weights_and_biases =
        xnn_pack_kai_qb4_weights_and_biases;
    qp8_f32_qb4w_gemm_config.packed_stride_weights_and_biases =
    ...
    qp8_f32_qb4w_gemm_config.minmax.qp8gemm_bl[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_QP8GEMM_BL_UKERNEL(
...
static void init_qdu8_f32_qb4w_gemm_config(void) {
  ...
  qdu8_f32_qb4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  qdu8_f32_qb4w_gemm_config.bias_element_size = sizeof(float);
  qdu8_f32_qb4w_gemm_config.packed_stride_weights_and_biases =
      xnn_packed_stride_qb4_weights_and_biases;
...
// Arch-specific parameters.
  ...
  if ((hardware_config->arch_flags & xnn_arch_x86_avx512vnnigfni) &&
      hardware_config->uarch[XNN_UARCH_INDEX] != xnn_uarch_zen4 &&
      hardware_config->uarch[XNN_UARCH_INDEX] != xnn_uarch_zen5) {
    qdu8_f32_qb4w_gemm_config.arch = xnn_arch_x86_avx512vnnigfni;
    qdu8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f32_qb4w_gemm_minmax_ukernel_1x16c8__avx512vnnigfni_prfm);
    qdu8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(14)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f32_qb4w_gemm_minmax_ukernel_14x16c8__avx512vnnigfni_prfm);
    qdu8_f32_qb4w_gemm_config.init.f32_qb4w =
        xnn_init_f32_qb4w_minmax_scalar_params;
    ...
    qdu8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_f32_qb4w_gemm_config(void) {
  ...
  qd8_f32_qb4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  qd8_f32_qb4w_gemm_config.bias_element_size = sizeof(float);
  qd8_f32_qb4w_gemm_config.packed_stride_weights_and_biases =
      xnn_packed_stride_qb4_weights_and_biases;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    if (XNN_ENABLE_ARM_DOTPROD &&
        (hardware_config->arch_flags & xnn_arch_arm_neon_dot)) {
#if XNN_ENABLE_ARM_DOTPROD
      qd8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
              xnn_qd8_f32_qb4w_gemm_minmax_ukernel_1x16c4__neondot);
      qd8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
              xnn_qd8_f32_qb4w_gemm_minmax_ukernel_4x16c4__neondot);
      qd8_f32_qb4w_gemm_config.init.f32_qb4w =
          xnn_init_f32_qb4w_minmax_scalar_params;
      ...
      qd8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(6)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    qd8_f32_qb4w_gemm_config.planes = 2;
    qd8_f32_qb4w_gemm_config.pack_gemm_goi_bl =
        (xnn_packw_gemm_goi_bl_ukernel_fn)
            xnn_qb4_packw_gemm_goi_ukernel_x16c8__aarch64_neondot;
#endif  // XNN_ENABLE_ARM_I8MM
  } else if (XNN_ENABLE_ARM_DOTPROD &&
             (hardware_config->arch_flags & xnn_arch_arm_neon_dot)) {
#if XNN_ENABLE_ARM_DOTPROD
    ...
    qd8_f32_qb4w_gemm_config.pack_gemm_goi_bl =
        (xnn_packw_gemm_goi_bl_ukernel_fn)
            xnn_qb4_packw_gemm_goi_ukernel_x16c4__aarch64_neondot;
#endif  // XNN_ENABLE_ARM_DOTPROD
  } else {
    qd8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx2) {
    ...
    qd8_f32_qb4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qd8_f16_qc8w_gemm_config(void) {
  ...
  qd8_f16_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
  ...
  qd8_f16_qc8w_gemm_config.pack_gemm_gio =
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    ...
    if (XNN_ENABLE_ARM_DOTPROD &&
        ...
        (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith)) {
#if XNN_ENABLE_ARM_DOTPROD
      qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
              xnn_qd8_f16_qc8w_gemm_minmax_ukernel_1x8c4__neondotfp16arith);
      qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
      ...
      qd8_f16_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
          xnn_qs8_packw_gemm_gio_ukernel_x8c4__scalar;
#endif  // XNN_ENABLE_ARM_DOTPROD
    } else if (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith) {
      switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
        case xnn_uarch_cortex_a53:
        case xnn_uarch_cortex_a55:
          qd8_f16_qc8w_gemm_config.minmax
              .dqgemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_DQGEMM_UKERNEL(
        ...
        default:
          ...
          qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(2)] =
              XNN_INIT_HMP_DQGEMM_UKERNEL(
...
#if XNN_MAX_UARCH_TYPES > 1 && XNN_ENABLE_ARM_DOTPROD
    {
      ...
      for (size_t i = 1; i < XNN_MAX_UARCH_TYPES; i++) {
        switch (hardware_config->uarch[i]) {
          case xnn_uarch_cortex_a55:
#if XNN_ENABLE_ARM_DOTPROD
            if (mr == 4 && nr == 8 && log2_kr == 2 &&
                (hardware_config->arch_flags & xnn_arch_arm_neon_dot) &&
                (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith)) {
              qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)]
                  .function[i] = XNN_INIT_DQGEMM_UKERNEL(
                  xnn_qd8_f16_qc8w_gemm_minmax_ukernel_1x8c4__neondotfp16arith);
              qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(4)]
                  .function[i] = XNN_INIT_DQGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    qd8_f16_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_qs8_packw_gemm_gio_ukernel_x16c4__scalar;
#endif  // XNN_ENABLE_ARM_DOTPROD
  } else if (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith) {
    qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512amx) {
    ...
    qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
#if XNN_ENABLE_AVX256VNNI
    qd8_f16_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x64c4__avx256vnni_prfm;
#else
    qd8_f16_qc8w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_gemm_goi_w;
#endif
    ...
    qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qd8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
...
static void init_qdu8_f16_qc8w_gemm_config(void) {
  ...
  qdu8_f16_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
  ...
  qdu8_f16_qc8w_gemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs8_weights_and_biases;
  qdu8_f16_qc8w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
  qdu8_f16_qc8w_gemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_gemm_goi_w;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx256vnni) {
    ...
    qdu8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc8w_gemm_minmax_ukernel_1x8c8__avx256vnni);
    qdu8_f16_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f16_qc8w_gemm_minmax_ukernel_8x8c8__avx256vnni);
    qdu8_f16_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f16_qc8w_igemm_minmax_ukernel_1x8c8__avx256vnni);
    qdu8_f16_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
    ...
    qdu8_f16_qc8w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
    qdu8_f16_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x8c8__avx256vnni_prfm;
    ...
    qdu8_f16_qc8w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
    qdu8_f16_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x8c8__avxvnni_prfm;
...
static void init_qd8_f16_qc8w_igemm_config(void) {
  ...
  qd8_f16_qc8w_igemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
  qd8_f16_qc8w_igemm_config.bias_element_size = sizeof(float);
  // Use the same packing function throughout.
  qd8_f16_qc8w_igemm_config.pack_weights_and_biases =
      (xnn_pack_weights_and_biases_fn)xnn_pack_qs8_weights_and_biases;
  qd8_f16_qc8w_igemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs8_weights_and_biases;
  qd8_f16_qc8w_igemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
  qd8_f16_qc8w_igemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_gemm_goi_w;
#if XNN_ENABLE_ARM_FP16_SCALAR && XNN_ENABLE_ARM_FP16_VECTOR && XNN_ARCH_ARM
  const struct xnn_hardware_config* hardware_config =
      xnn_init_hardware_config();
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
    ...
    if (XNN_ENABLE_ARM_DOTPROD &&
        ...
        (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith)) {
#if XNN_ENABLE_ARM_DOTPROD
      qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_DQIGEMM_UKERNEL(
              xnn_qd8_f16_qc8w_igemm_minmax_ukernel_1x8c4__neondotfp16arith);
      qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_DQIGEMM_UKERNEL(
      ...
      qd8_f16_qc8w_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
          xnn_qs8_packw_gemm_goi_ukernel_x8c4__neondot;
      qd8_f16_qc8w_igemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
          xnn_qs8_packw_gemm_gio_ukernel_x8c4__scalar;
#endif  // XNN_ENABLE_ARM_DOTPROD
    } else if (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith) {
      qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
      ...
      qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(2)] =
          XNN_INIT_HMP_DQIGEMM_UKERNEL(
        ...
        switch (hardware_config->uarch[i]) {
          case xnn_uarch_cortex_a55:
            ...
            if (mr == 4 && nr == 8 && log2_kr == 2 &&
                ...
                (hardware_config->arch_flags & xnn_arch_arm_neon_fp16_arith)) {
              qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)]
                  .function[i] = XNN_INIT_DQIGEMM_UKERNEL(
                  xnn_qd8_f16_qc8w_igemm_minmax_ukernel_1x8c4__neondotfp16arith);
              qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(4)]
                  .function[i] = XNN_INIT_DQIGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      case xnn_uarch_cortex_a55:
        qd8_f16_qc8w_igemm_config.minmax
            .dqigemm[XNN_MR_TO_INDEX(4)] = XNN_INIT_HMP_DQIGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512amx) {
    ...
    qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
    ...
    qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
    ...
    qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_riscv_vector_fp16_arith) {
    qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f16_qc8w_igemm_minmax_ukernel_1x2v__rvvfp16arith);
    qd8_f16_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f16_qc8w_igemm_minmax_ukernel_7x2v__rvvfp16arith);
    qd8_f16_qc8w_igemm_config.init.f16 = xnn_init_f16_minmax_scalar_params;
    qd8_f16_qc8w_igemm_config.mr = 7;
    qd8_f16_qc8w_igemm_config.nr =
        2 * hardware_config->vlenb / sizeof(xnn_float16);
  }
#endif
...
static void init_qdu8_f32_qc8w_gemm_config(void) {
  ...
  qdu8_f32_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
  ...
  qdu8_f32_qc8w_gemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs8_weights_and_biases;
  qdu8_f32_qc8w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
  qdu8_f32_qc8w_gemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_gemm_goi_w;
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512vnni) {
    ...
    qdu8_f32_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f32_qc8w_gemm_minmax_ukernel_1x64c4__asm_amd64_avx512vnni);
    qdu8_f32_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f32_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(10)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f32_qc8w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
#if XNN_ENABLE_AVX256VNNI
    qdu8_f32_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x16c8__avx256vnni_prfm;
#else
    qdu8_f32_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x16c8__scalar;
#endif
...
static void init_qdu8_f32_qc8w_igemm_config(void) {
  ...
  qdu8_f32_qc8w_igemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_UINT8_T + 3;
  ...
  qdu8_f32_qc8w_igemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs8_weights_and_biases;
  qdu8_f32_qc8w_igemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
  qdu8_f32_qc8w_igemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_gemm_goi_w;
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  const struct xnn_hardware_config* hardware_config =
      xnn_init_hardware_config();
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512vnni) {
    ...
    qdu8_f32_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f32_qc8w_igemm_minmax_ukernel_1x16c8__avx512vnni_prfm);
    qdu8_f32_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(10)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
    ...
    qdu8_f32_qc8w_igemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
#if XNN_ENABLE_AVX256VNNI
    qdu8_f32_qc8w_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x16c8__avx256vnni_prfm;
#else
    qdu8_f32_qc8w_igemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x16c8__scalar;
    ...
    qdu8_f32_qc8w_igemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
...
static void init_qdu8_f32_qc4w_gemm_config(void) {
  ...
  qdu8_f32_qc4w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_BIT_SIZEOF_INT4;
  ...
  qdu8_f32_qc4w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_qc4w_gemm_gio_w;  // Ignored
  qdu8_f32_qc4w_gemm_config.pack_gemm_goi =
      (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_qc4w_gemm_goi_w;  // Ignored
...
// Arch-specific parameters.
  ...
  if ((hardware_config->arch_flags & xnn_arch_x86_avx512vnnigfni) &&
    ...
    qdu8_f32_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(14)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f32_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qdu8_f32_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_qc4uw_packw_gemm_goi_ukernel_x16c8__scalar;
    qdu8_f32_qc4w_gemm_config.init.f32_qc4w =
        xnn_init_f32_qc4w_minmax_scalar_params;
    qdu8_f32_qc4w_gemm_config.mr = 8;
    qdu8_f32_qc4w_gemm_config.nr = 16;
...
static void init_qd8_f32_qc8w_gemm_config(void) {
  ...
  qd8_f32_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
  ...
  qd8_f32_qc8w_gemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs8_weights_and_biases;
  qd8_f32_qc8w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
...
// Arch-specific parameters.
    ...
    if (XNN_ENABLE_ARM_DOTPROD &&
      ...
      switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
        case xnn_uarch_cortex_a55:
          ...
          qd8_f32_qc8w_gemm_config.minmax
              .dqgemm[XNN_MR_TO_INDEX(4)] = XNN_INIT_HMP_DQGEMM_UKERNEL(
...
#endif  // XNN_ENABLE_ARM_DOTPROD
    {
      switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
        ...
        default:
          ...
          qd8_f32_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(2)] =
              XNN_INIT_HMP_DQGEMM_UKERNEL(
                  xnn_qd8_f32_qc8w_gemm_minmax_ukernel_2x8c2s4__neon_mlal);
          qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
              XNN_INIT_HMP_DQIGEMM_UKERNEL(
                  xnn_qd8_f32_qc8w_igemm_minmax_ukernel_1x8c2s4__neon_mlal);
          qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(2)] =
              XNN_INIT_HMP_DQIGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      ...
      case xnn_uarch_cortex_a55:
        ...
        qd8_f32_qc8w_gemm_config.minmax
            .dqigemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_DQIGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512amx) {
    ...
    qd8_f32_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qd8_f32_qc8w_gemm_minmax_ukernel_16x64c4__avx512amx);
    qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f32_qc8w_igemm_minmax_ukernel_1x64c4__avx512amx);
    qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(16)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_wasm_sdot) {
    if (hardware_config->is_x86) {
      ...
      qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
          XNN_INIT_HMP_DQIGEMM_UKERNEL(
              xnn_qd8_f32_qc8w_igemm_minmax_ukernel_1x16c4__wasmsdot_u2);
      qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(4)] =
          XNN_INIT_HMP_DQIGEMM_UKERNEL(
              xnn_qd8_f32_qc8w_igemm_minmax_ukernel_4x16c4__wasmsdot_u2);
      qd8_f32_qc8w_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
      qd8_f32_qc8w_gemm_config.mr = 4;
      qd8_f32_qc8w_gemm_config.nr = 16;
      qd8_f32_qc8w_gemm_config.log2_kr = 2;
    ...
    qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f32_qc8w_igemm_minmax_ukernel_1x16c2s2__wasmsimd_dot16x2);
    qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_DQIGEMM_UKERNEL(
            xnn_qd8_f32_qc8w_igemm_minmax_ukernel_4x16c2s2__wasmsimd_dot16x2);
    qd8_f32_qc8w_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
    qd8_f32_qc8w_gemm_config.mr = 4;
    qd8_f32_qc8w_gemm_config.nr = 16;
    qd8_f32_qc8w_gemm_config.log2_kr = 1;
...
// consider clang21.1 version check
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon_dot) {
    ...
    qs8_qc2w_gemm_config.init.qs8_qc8w =
    ...
    qs8_qc2w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_qc2w_gemm_goi_w;
...
#endif  // XNN_ENABLE_ARM_DOTPROD
  {
    ...
    qs8_qc2w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avxvnni) {
    ...
    qs8_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_1x8c8__avxvnni);
    qs8_qc2w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_5x8c8__avxvnni);
    qs8_qc2w_gemm_config.init.qs8_qc8w =
        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
    qs8_qc2w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_to_qu8_qc2w_gemm_goi_w;
    qs8_qc2w_gemm_config.mr = 5;
    qs8_qc2w_gemm_config.nr = 8;
    qs8_qc2w_gemm_config.log2_kr = 3;
  } else
#endif
// TODO(fbarchard): add prfm and test on spr.  5x8 is not fastest but there is
// clang bug causing register spill due to MR and 5x8 spills by only 1 register
// so it is less sensitive to memory and uarch.  tune if spill can be fixed.
// TODO(fbarchard): use 4x8 for avx256skx as well
...
#endif
  {
    ...
    qs8_qc2w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_1x4__scalar_fmagic);
    qs8_qc2w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512vnnigfni) {
    ...
    qs8_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_1x16c8__avx512vnnigfni_prfm);
    qs8_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_7x16c8__avx512vnnigfni_prfm);
    qs8_qc4w_gemm_config.init.qs8_qc8w =
        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
    qs8_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_to_qu8_qc4w_packw_gemm_goi_ukernel_x16c8__avx256vnni;
...
#if XNN_ENABLE_AVX512VNNI && XNN_ENABLE_AVX256VNNI && XNN_ARCH_X86_64 && \
    !XNN_PLATFORM_WINDOWS && XNN_ENABLE_ASSEMBLY
      if (hardware_config->arch_flags & xnn_arch_x86_avx512vnni) {
    qs8_qc4w_gemm_config.arch = xnn_arch_x86_avx512vnni;
    qs8_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
            xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_1x16c8__asm_amd64_avx512vnni);
    qs8_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(8)] =
        XNN_INIT_HMP_DQGEMM_UKERNEL(
    ...
    qs8_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_1x8c8__avx256vnni_prfm);
    qs8_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_7x8c8__avx256vnni_prfm);
    qs8_qc4w_gemm_config.init.qs8_qc8w =
        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
    qs8_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_to_qu8_qc4w_packw_gemm_goi_ukernel_x8c8__avx256vnni;
    qs8_qc4w_gemm_config.planes = 2;
    qs8_qc4w_gemm_config.mr = 7;
    ...
    if (hardware_config->arch_flags & xnn_arch_x86_avxvnni) {
      ...
      qs8_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(5)] =
          XNN_INIT_HMP_GEMM_UKERNEL(
              xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_5x8c8__avxvnni_prfm);
      qs8_qc4w_gemm_config.init.qs8_qc8w =
          xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
      qs8_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
          xnn_qs8_to_qu8_qc4w_packw_gemm_goi_ukernel_x8c8__avxvnni;
      qs8_qc4w_gemm_config.planes = 2;
      qs8_qc4w_gemm_config.mr = 5;
      qs8_qc4w_gemm_config.nr = 8;
      qs8_qc4w_gemm_config.log2_kr = 3;
      ...
      qs8_qc4w_gemm_config.minmax
          .gemm[XNN_MR_TO_INDEX(7)] = XNN_INIT_HMP_GEMM_UKERNEL(
          xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_7x16c8__avx512skx_madd_prfm);
      qs8_qc4w_gemm_config.init.qs8_qc8w =
          xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
      // TODO(fbarchard): generate avx512/avx2 packw instead of scalar in future
      qs8_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
          xnn_qs8_to_qu8_qc4uw_packw_gemm_goi_ukernel_x16c8__scalar;
      qs8_qc4w_gemm_config.pack_gemm_gio =
          (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_to_qu8_qc4uw_gemm_gio_w;
      ...
      // TODO(fbarchard): generate avx2 packw instead of sse2 in future
      qs8_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
          xnn_qs8_to_qu8_qc4uw_packw_gemm_goi_ukernel_x8c8__sse2;
      qs8_qc4w_gemm_config.pack_gemm_gio =
          (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_to_qu8_qc4uw_gemm_gio_w;
      qs8_qc4w_gemm_config.pack_weights_and_biases = NULL;
      qs8_qc4w_gemm_config.packed_stride_weights_and_biases = NULL;
      ...
      qs8_qc4w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(5)] =
          XNN_INIT_HMP_DQGEMM_UKERNEL(
              xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_5x4c8__avx_madd_prfm);
      qs8_qc4w_gemm_config.init.qs8_qc8w =
          xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params;
      qs8_qc4w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
          xnn_qs8_to_qu8_qc4uw_packw_gemm_goi_ukernel_x4c8__sse2;
      qs8_qc4w_gemm_config.planes = 2;
      qs8_qc4w_gemm_config.mr = 5;
...
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
  {
    ...
    qs8_qc4w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
            xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_3x4__scalar_fmagic);
    qs8_qc4w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_qc4w_gemm_goi_w;
    qs8_qc4w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_qc4w_gemm_gio_w;
    qs8_qc4w_gemm_config.pack_weights_and_biases = NULL;
...
static void init_qs8_qc8w_gemm_config(void) {
  ...
  qs8_qc8w_gemm_config.log2_filter_element_bit_size =
      XNN_LOG2_SIZEOF_INT8_T + 3;
  ...
  qs8_qc8w_gemm_config.packed_stride_weights_and_biases =
      (xnn_packed_stride_weights_and_biases_fn)
          xnn_packed_stride_qs8_weights_and_biases;
  qs8_qc8w_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_gemm_gio_w;
...
// Arch-specific parameters.
      ...
      for (size_t i = 1; i < XNN_MAX_UARCH_TYPES; i++) {
        switch (hardware_config->uarch[i]) {
          ...
          case xnn_uarch_cortex_a55:
            ...
            if (mr == 4 && nr == 8 && log2_kr == 2 &&
                (hardware_config->arch_flags & xnn_arch_arm_neon_dot)) {
              qs8_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)].function[i] =
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    qs8_qc8w_gemm_config.minmax
        .igemm[XNN_MR_TO_INDEX(2)] = XNN_INIT_HMP_IGEMM_UKERNEL(
  ...
  if (XNN_ENABLE_ARM_I8MM &&
    ...
    switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
      ...
      case xnn_uarch_cortex_a73:
        ...
        qs8_qc8w_gemm_config.minmax
            .gemm[XNN_MR_TO_INDEX(2)] = XNN_INIT_HMP_GEMM_UKERNEL(
        ...
        case xnn_uarch_cortex_a55:
          ...
          if (mr == 4 && nr == 16 && log2_kr == 2 &&
            ...
            qs8_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)]
                .function[i] = XNN_INIT_GEMM_UKERNEL(
                xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_4x16c4__asm_aarch64_neondot_cortex_a55);
            qs8_qc8w_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)].function[i] =
                XNN_INIT_IGEMM_UKERNEL(
                    xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x16c4__neondot);
            qs8_qc8w_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(4)]
                .function[i] = XNN_INIT_IGEMM_UKERNEL(
                xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c4__asm_aarch64_neondot_cortex_a55);
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512amx) {
    ...
    qs8_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    qs8_qc8w_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    qs8_qc8w_gemm_config.packed_stride_weights_and_biases =
        NULL;  // Override the default packing function.
    qs8_qc8w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_to_qu8_gemm_gio_w;
#if XNN_ENABLE_AVX256VNNI
    qs8_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_to_qu8_packw_gemm_goi_ukernel_x16c8__avx256vnni;
#else
    qs8_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_to_qu8_packw_gemm_goi_ukernel_x16c8__scalar;
#endif
    qs8_qc8w_gemm_config.pack_igemm_goki =
        (xnn_pack_conv_goki_w_fn)xnn_pack_qs8_to_qu8_conv_goki_w;
    qs8_qc8w_gemm_config.pack_igemm_kgo =
        (xnn_pack_conv_kgo_w_fn)xnn_pack_qs8_to_qu8_conv_kgo_w;
    qs8_qc8w_gemm_config.pack_deconv_goki =
    ...
    qs8_qc8w_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(5)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    qs8_qc8w_gemm_config.packed_stride_weights_and_biases =
        NULL;  // Override the default packing function.
    qs8_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_qs8_to_qu8_packw_gemm_gio_ukernel_x8c8__scalar;
    qs8_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
    ...
    qs8_qc8w_gemm_config.packed_stride_weights_and_biases =
        NULL;  // Override the default packing function.
    qs8_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_qs8_packw_gemm_gio_ukernel_x4c8__scalar;
    qs8_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x4c8__scalar;
    qs8_qc8w_gemm_config.pack_igemm_goki =
        (xnn_pack_conv_goki_w_fn)xnn_pack_qs8_conv_goki_w;
    qs8_qc8w_gemm_config.pack_igemm_kgo =
        (xnn_pack_conv_kgo_w_fn)xnn_pack_qs8_conv_kgo_w;
  ...
  if (hardware_config->arch_flags & xnn_arch_wasm_sdot) {
    ...
    qs8_qc8w_gemm_config.pack_gemm_gio =
        (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qs8_to_qu8_gemm_gio_w;
    qs8_qc8w_gemm_config.pack_gemm_goi =
        (xnn_packw_gemm_goi_ukernel_fn)xnn_pack_qs8_to_qu8_gemm_goi_w;
    qs8_qc8w_gemm_config.pack_igemm_goki =
        (xnn_pack_conv_goki_w_fn)xnn_pack_qs8_to_qu8_conv_goki_w;
    qs8_qc8w_gemm_config.pack_igemm_kgo =
        (xnn_pack_conv_kgo_w_fn)xnn_pack_qs8_to_qu8_conv_kgo_w;
  ...
  if (hardware_config->arch_flags & xnn_arch_hvx) {
    ...
    qs8_qc8w_gemm_config.pack_deconv_goki =
        (xnn_pack_deconv_goki_w_fn)xnn_pack_qs8_deconv_goki_w;
    qs8_qc8w_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn)
        xnn_qs8_packw_gemm_gio_ukernel_x128c4__scalar;
    qs8_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn)
        xnn_qs8_packw_gemm_goi_ukernel_x128c4__scalar;
    qs8_qc8w_gemm_config.mr = 2;
...
static void init_qu8_gemm_config(void) {
  ...
  qu8_gemm_config.pack_gemm_gio =
      (xnn_packw_gemm_gio_ukernel_fn)xnn_pack_qu8_gemm_gio_w;
  qu8_gemm_config.pack_gemm_goi =
...
// Arch-specific parameters.
  ...
  if (hardware_config->arch_flags & xnn_arch_arm_neon) {
...
#endif  // XNN_MAX_UARCH_TYPES > 1
#else   // XNN_ENABLE_ASSEMBLY
    qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
        xnn_qu8_gemm_minmax_rndnu_ukernel_1x8__neon_mlal_lane);
    qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(3)] = XNN_INIT_HMP_GEMM_UKERNEL(
    ...
    qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(2)] = XNN_INIT_HMP_GEMM_UKERNEL(
        xnn_qu8_gemm_minmax_fp32_ukernel_2x2c4__armsimd32);
    qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
            xnn_qu8_igemm_minmax_fp32_ukernel_1x2c4__armsimd32);
    qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(2)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
  ...
  qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_GEMM_UKERNEL(
      xnn_qu8_gemm_minmax_rndnu_ukernel_1x16__neon_mlal_lane);
  qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(4)] = XNN_INIT_HMP_GEMM_UKERNEL(
      xnn_qu8_gemm_minmax_rndnu_ukernel_4x16__neon_mlal_lane);
  qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] = XNN_INIT_HMP_IGEMM_UKERNEL(
      xnn_qu8_igemm_minmax_rndnu_ukernel_1x16__neon_mlal_lane);
  ...
  if (hardware_config->arch_flags & xnn_arch_x86_avx512skx) {
    ...
    qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(7)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
    ...
    qu8_gemm_config.log2_kr = 3;
      ...
      if (hardware_config->arch_flags & xnn_arch_x86_avx2) {
    qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_qu8_gemm_minmax_fp32_ukernel_1x8c8__avx2);
    qu8_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(3)] =
        XNN_INIT_HMP_GEMM_UKERNEL(xnn_qu8_gemm_minmax_fp32_ukernel_3x8c8__avx2);
    qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
        XNN_INIT_HMP_IGEMM_UKERNEL(
  ...
  qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(1)] =
      XNN_INIT_HMP_IGEMM_UKERNEL(xnn_qu8_igemm_minmax_fp32_ukernel_1x1v__rvv);
  qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(4)] =
      XNN_INIT_HMP_IGEMM_UKERNEL(xnn_qu8_igemm_minmax_fp32_ukernel_4x1v__rvv);
  qu8_gemm_config.init.qu8 = xnn_init_qu8_conv_minmax_fp32_scalar_params;
  qu8_gemm_config.mr = 4;
  ...
  qu8_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(3)] = XNN_INIT_HMP_IGEMM_UKERNEL(
...
const struct xnn_gemm_config* xnn_init_bf16_f32_gemm_config() {
  const struct xnn_hardware_config* hardware_config =
      xnn_init_hardware_config();
  if (hardware_config == NULL ||
      !xnn_is_bf16_compatible_config(hardware_config)) {
    return NULL;
  }

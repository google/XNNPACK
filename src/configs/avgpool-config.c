...
static void init_f16_avgpool_config(void) {
  ...
  if (hardware_config->use_arm_neon_fp16_arith) {
    f16_avgpool_config.ukernel = (xnn_avgpool_ukernel_fn)
        xnn_f16_avgpool_minmax_ukernel_9p__neonfp16arith_u8;
  ...
  if (hardware_config->use_x86_f16c) {
    f16_avgpool_config.ukernel =
        (xnn_avgpool_ukernel_fn)xnn_f16_avgpool_minmax_ukernel_9p__f16c_u8;
    f16_avgpool_config.init.f16 = xnn_init_f16_scaleminmax_scalar_params;
    f16_avgpool_config.primary_tile = 9;
    f16_avgpool_config.channel_tile = 8;
  }
...
static void init_f32_avgpool_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    f32_avgpool_config.ukernel =
        (xnn_avgpool_ukernel_fn)xnn_f32_avgpool_minmax_ukernel_9p__neon_u4;
    ...
    f32_avgpool_config.ukernel =
        (xnn_avgpool_ukernel_fn)xnn_f32_avgpool_minmax_ukernel_9p__scalar_u1;
    f32_avgpool_config.init.f32 = xnn_init_f32_scaleminmax_scalar_params;
    f32_avgpool_config.primary_tile = 9;
  ...
  f32_avgpool_config.ukernel =
      (xnn_avgpool_ukernel_fn)xnn_f32_avgpool_minmax_ukernel_9p__sse2_u4;
  f32_avgpool_config.init.f32 = xnn_init_f32_scaleminmax_scalar_params;
  f32_avgpool_config.primary_tile = 9;
  f32_avgpool_config.channel_tile = 4;
#elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  f32_avgpool_config.ukernel =
      (xnn_avgpool_ukernel_fn)xnn_f32_avgpool_minmax_ukernel_9p__wasmsimd_u4;
  f32_avgpool_config.init.f32 = xnn_init_f32_scaleminmax_scalar_params;
  f32_avgpool_config.primary_tile = 9;
  f32_avgpool_config.channel_tile = 4;
#else

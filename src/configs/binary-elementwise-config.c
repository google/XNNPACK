...
static void init_f32_vadd_config(void) {
    ...
    f32_vadd_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vadd_ukernel__hvx_u128;
    f32_vadd_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vaddc_ukernel__hvx_u128;
    f32_vadd_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vaddc_ukernel__hvx_u128;
...
static void init_f32_vmax_config(void) {
  ...
  #elif XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
    f32_vmax_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmax_ukernel__hvx_u128;
    f32_vmax_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmaxc_ukernel__hvx_u128;
    f32_vmax_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmaxc_ukernel__hvx_u128;
...
static void init_f32_vmin_config(void) {
  ...
  #elif XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
    f32_vmin_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmin_ukernel__hvx_u128;
    f32_vmin_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vminc_ukernel__hvx_u128;
    f32_vmin_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vminc_ukernel__hvx_u128;
...
static void init_f32_vmul_config(void) {
  ...
  #elif XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
    f32_vmul_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmul_ukernel__hvx_u128;
    f32_vmul_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmulc_ukernel__hvx_u128;
    f32_vmul_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vmulc_ukernel__hvx_u128;
...
static void init_f32_vsub_config(void) {
  ...
  #elif XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
    f32_vsub_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vsub_ukernel__hvx_u128;
    f32_vsub_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vsubc_ukernel__hvx_u128;
    f32_vsub_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrsubc_ukernel__hvx_u128;
...
static void init_f32_vsqrdiff_config(void) {
  ...
  #elif XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
    f32_vsqrdiff_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vsqrdiff_ukernel__hvx_u128;
    f32_vsqrdiff_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vsqrdiffc_ukernel__hvx_u128;
    f32_vsqrdiff_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vsqrdiffc_ukernel__hvx_u128;
...
static void init_qs8_vadd_config(void) {
  ...
  #elif XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
    qs8_vadd_config.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_qs8_vadd_minmax_ukernel__hvx_u128;
    qs8_vadd_config.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_qs8_vaddc_minmax_ukernel__hvx_u128;
    qs8_vadd_config.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_qs8_vaddc_minmax_ukernel__hvx_u128;
    qs8_vadd_config.init = (xnn_init_binary_params_fn) xnn_init_qs8_add_minmax_scalar_params;
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vadd_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vdiv_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vmax_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vmin_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vmul_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vprelu_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vsub_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f16_vsqrdiff_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL || !xnn_is_f16_compatible_config(hardware_config)) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vadd_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vcopysign_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vdiv_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vmax_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vmin_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vmul_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vprelu_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vsub_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_f32_vsqrdiff_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_qs8_vadd_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_qs8_vmul_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_qs8_vprelu_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_qu8_vadd_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_qu8_vmul_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
...
const struct xnn_binary_elementwise_config* xnn_get_qu8_vprelu_config() {
  const struct xnn_hardware_config* hardware_config = xnn_get_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }

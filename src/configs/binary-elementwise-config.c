...
static void init_f16_vmax_config(void) {
    ...
    assert(hardware_config != NULL);
      ...
      if (hardware_config->use_x86_avx512fp16) {
        ...
        f16_vmax_config.init.f16_minmax = xnn_init_f16_minmax_scalar_params;
...
static void init_f16_vmin_config(void) {
    ...
    assert(hardware_config != NULL);
      ...
      if (hardware_config->use_x86_avx512fp16) {
        ...
        f16_vmin_config.init.f16_minmax = xnn_init_f16_minmax_scalar_params;
...
static void init_f16_vprelu_config(void) {
    ...
    assert(hardware_config != NULL);
    if (hardware_config->use_arm_neon_fp16_arith) {
      f16_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vprelu_ukernel__neonfp16arith_u16;
      f16_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vpreluc_ukernel__neonfp16arith_u16;
      f16_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vrpreluc_ukernel__neonfp16arith_u16;
      f16_vprelu_config.init.f16_minmax = xnn_init_f16_minmax_scalar_params;
      f16_vprelu_config.minmax.element_tile = 16;
    }
  #elif XNN_ARCH_ARM64 && XNN_ENABLE_ARM_FP16_VECTOR
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    assert(hardware_config != NULL);
    ...
    #if XNN_ENABLE_AVX512FP16
      if (hardware_config->use_x86_avx512fp16) {
        f16_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vprelu_ukernel__avx512fp16_u64;
        f16_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vpreluc_ukernel__avx512fp16_u64;
        f16_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vrpreluc_ukernel__avx512fp16_u64;
        f16_vprelu_config.init.f16_minmax = xnn_init_f16_minmax_scalar_params;
        f16_vprelu_config.minmax.element_tile = 64;
      } else
    #endif
    if (hardware_config->use_x86_f16c) {
      f16_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vprelu_ukernel__f16c_u16;
      f16_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vpreluc_ukernel__f16c_u16;
      f16_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f16_vrpreluc_ukernel__f16c_u16;
      f16_vprelu_config.init.f16_minmax = xnn_init_f16_minmax_scalar_params;
      f16_vprelu_config.minmax.element_tile = 16;
    }
  #endif
...
static void init_f32_vprelu_config(void) {
    ...
    assert(hardware_config != NULL);
    if (hardware_config->use_arm_neon){
      f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__neon_u8;
      f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__neon_u8;
      f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__neon_u8;
      f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
      f32_vprelu_config.minmax.element_tile = 8;
    } else if (!XNN_PLATFORM_MOBILE) {
      f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__scalar_u8;
      f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__scalar_u8;
      f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__scalar_u8;
      f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
      f32_vprelu_config.minmax.element_tile = 8;
    }
  #elif XNN_ARCH_ARM64
    ...
    assert(hardware_config != NULL);
    if (!XNN_PLATFORM_MOBILE && hardware_config->use_x86_avx512f) {
      f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__avx512f_u32;
      f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__avx512f_u32;
      f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__avx512f_u32;
      f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
      f32_vprelu_config.minmax.element_tile = 32;
    } else if (hardware_config->use_x86_avx) {
      f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__avx_u16;
      f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__avx_u16;
      f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__avx_u16;
      f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
      f32_vprelu_config.minmax.element_tile = 16;
    } else {
      f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__sse2_u8;
      f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__sse2_u8;
      f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__sse2_u8;
      f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
      f32_vprelu_config.minmax.element_tile = 8;
    }
  #elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    assert(hardware_config != NULL);
    f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__wasmsimd_u16;
    f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__wasmsimd_u16;
    f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__wasmsimd_u16;
    f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
    f32_vprelu_config.minmax.element_tile = 16;
  #elif XNN_ARCH_WASM
    f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__wasm_u8;
    f32_vprelu_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vpreluc_ukernel__wasm_u8;
    f32_vprelu_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vrpreluc_ukernel__wasm_u8;
    f32_vprelu_config.init.f32_minmax = xnn_init_f32_minmax_scalar_params;
    f32_vprelu_config.minmax.element_tile = 8;
  #else
    f32_vprelu_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_f32_vprelu_ukernel__scalar_u8;

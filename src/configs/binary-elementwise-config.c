...
static struct xnn_binary_elementwise_config s32_vand_config = {0};
...
static struct xnn_binary_elementwise_config s32_vxor_config = {0};
...
XNN_INIT_ONCE_GUARD(s32_vand);
XNN_INIT_ONCE_GUARD(s32_vmul);
XNN_INIT_ONCE_GUARD(s32_vor);
XNN_INIT_ONCE_GUARD(s32_vxor);
...
static void init_s32_vand_config(void) {
  #if XNN_ARCH_ARM
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    assert(hardware_config != NULL);
    if (hardware_config->use_arm_neon) {
      s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__neon_u8;
      s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__neon_u8;
      s32_vand_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__neon_u8;
      s32_vand_config.linear.element_tile = 8;
    }
    else if (!XNN_PLATFORM_MOBILE) {
      s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__scalar_u2;
      s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__scalar_u2;
      s32_vand_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__scalar_u2;
      s32_vand_config.linear.element_tile = 2;
    }
  #elif XNN_ARCH_ARM64
    s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__neon_u8;
    s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__neon_u8;
    ...
    assert(hardware_config != NULL);
    if (!XNN_PLATFORM_MOBILE && hardware_config->use_x86_avx512f) {
      s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__avx512f_u32;
      s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__avx512f_u32;
      s32_vand_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__avx512f_u32;
      s32_vand_config.linear.element_tile = 32;
    }
    else if (hardware_config->use_x86_avx2) {
      s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__avx2_u16;
      s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__avx2_u16;
      s32_vand_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__avx2_u16;
      s32_vand_config.linear.element_tile = 16;
    }
    else {
      s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__sse41_u8;
      s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__sse41_u8;
      s32_vand_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__sse41_u8;
      s32_vand_config.linear.element_tile = 8;
    }
  #elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
    s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__wasmsimd_u16;
    s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__wasmsimd_u16;
    s32_vand_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__wasmsimd_u16;
    s32_vand_config.linear.element_tile = 16;
  #else
    s32_vand_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vand_ukernel__scalar_u2;
    s32_vand_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vandc_ukernel__scalar_u2;
...
static void init_s32_vxor_config(void) {
  #if XNN_ARCH_ARM
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    assert(hardware_config != NULL);
    if (hardware_config->use_arm_neon) {
      s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__neon_u8;
      s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__neon_u8;
      s32_vxor_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__neon_u8;
      s32_vxor_config.linear.element_tile = 8;
    }
    else if (!XNN_PLATFORM_MOBILE) {
      s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__scalar_u2;
      s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__scalar_u2;
      s32_vxor_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__scalar_u2;
      s32_vxor_config.linear.element_tile = 2;
    }
  #elif XNN_ARCH_ARM64
    s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__neon_u8;
    s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__neon_u8;
    ...
    assert(hardware_config != NULL);
    if (!XNN_PLATFORM_MOBILE && hardware_config->use_x86_avx512f) {
      s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__avx512f_u32;
      s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__avx512f_u32;
      s32_vxor_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__avx512f_u32;
      s32_vxor_config.linear.element_tile = 32;
    }
    else if (hardware_config->use_x86_avx2) {
      s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__avx2_u16;
      s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__avx2_u16;
      s32_vxor_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__avx2_u16;
      s32_vxor_config.linear.element_tile = 16;
    }
    else {
      s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__sse41_u8;
      s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__sse41_u8;
      s32_vxor_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__sse41_u8;
      s32_vxor_config.linear.element_tile = 8;
    }
  #elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
    s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__wasmsimd_u16;
    s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__wasmsimd_u16;
    s32_vxor_config.linear.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__wasmsimd_u16;
    s32_vxor_config.linear.element_tile = 16;
  #else
    s32_vxor_config.linear.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxor_ukernel__scalar_u2;
    s32_vxor_config.linear.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vxorc_ukernel__scalar_u2;
...
const struct xnn_binary_elementwise_config* xnn_init_s32_vand_config() {
  const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
  XNN_INIT_ONCE(s32_vand);
  return &s32_vand_config;
}
...
const struct xnn_binary_elementwise_config* xnn_init_s32_vxor_config() {
  const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
  XNN_INIT_ONCE(s32_vxor);
  return &s32_vxor_config;
}

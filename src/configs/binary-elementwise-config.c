...
static void init_s32_vmul_config(void) {
    ...
    assert(hardware_config != NULL);
    if (!XNN_PLATFORM_MOBILE && hardware_config->use_x86_avx512f) {
      s32_vmul_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmul_minmax_ukernel__avx512f_u32;
      s32_vmul_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmulc_minmax_ukernel__avx512f_u32;
  ...
  #elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
    s32_vmul_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmul_minmax_ukernel__wasmsimd_u16;
    s32_vmul_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmulc_minmax_ukernel__wasmsimd_u16;
    s32_vmul_config.minmax.ropc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmulc_minmax_ukernel__wasmsimd_u16;
    s32_vmul_config.minmax.element_tile = 16;
  #else
    s32_vmul_config.minmax.op_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmul_minmax_ukernel__scalar_u2;
    s32_vmul_config.minmax.opc_ukernel = (xnn_vbinary_ukernel_fn) xnn_s32_vmulc_minmax_ukernel__scalar_u2;

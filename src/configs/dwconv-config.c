...
static void init_f32_dwconv_config(void) {
    ...
    const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
    // If vlen=1024, reduce the lmul to avoid channel_tile overflow
    ...
    else if (hardware_config->vlenb == 128) {
      f32_dwconv_config[0].minmax = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_minmax_ukernel_3p4vc__rvv;
      f32_dwconv_config[0].linear = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_ukernel_3p4vc__rvv;
    }
    f32_dwconv_config[0].init.f32 = xnn_init_f32_minmax_scalar_params;
    ...
    if (hardware_config->vlenb < 128) {
      ...
      f32_dwconv_config[1].minmax = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_minmax_ukernel_4p4vc__rvv;
      f32_dwconv_config[1].linear = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_ukernel_4p4vc__rvv;
    }
    f32_dwconv_config[1].init.f32 = xnn_init_f32_minmax_scalar_params;
    ...
    if (hardware_config->vlenb < 128) {
      ...
      f32_dwconv_config[2].minmax = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_minmax_ukernel_9p4vc__rvv;
      f32_dwconv_config[2].linear = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_ukernel_9p4vc__rvv;
    }
    f32_dwconv_config[2].init.f32 = xnn_init_f32_minmax_scalar_params;
    ...
    if (hardware_config->vlenb < 128) {
      ...
      f32_dwconv_config[3].minmax = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_minmax_ukernel_25p4vc__rvv;
      f32_dwconv_config[3].linear = (xnn_dwconv_ukernel_fn) xnn_f32_dwconv_ukernel_25p4vc__rvv;
    }
    f32_dwconv_config[3].init.f32 = xnn_init_f32_minmax_scalar_params;

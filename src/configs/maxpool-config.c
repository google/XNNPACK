...
static void init_f16_maxpool_config(void) {
  ...
  if (hardware_config->use_arm_neon_fp16_arith) {
    f16_maxpool_config.ukernel = (xnn_maxpool_ukernel_fn)
        xnn_f16_maxpool_minmax_ukernel_9p__neonfp16arith_u8;
  ...
  if (hardware_config->use_x86_avx2) {
    f16_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_f16_maxpool_minmax_ukernel_9p__avx2_u16;
    f16_maxpool_config.init.f16 = xnn_init_f16_minmax_scalar_params;
  } else {
    f16_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_f16_maxpool_minmax_ukernel_9p__sse41_u8;
    f16_maxpool_config.init.f16 = xnn_init_f16_minmax_scalar_params;
  }
#endif
}
...
static void init_f32_maxpool_config(void) {
  ...
  if (hardware_config->use_arm_neon) {
    ...
    f32_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_f32_maxpool_minmax_ukernel_9p__scalar_u1;
    f32_maxpool_config.init.f32 = xnn_init_f32_minmax_scalar_params;
  }
#elif XNN_ARCH_ARM64
  f32_maxpool_config.ukernel =
  ...
  f32_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_f32_maxpool_minmax_ukernel_9p__sse2_u4;
  f32_maxpool_config.init.f32 = xnn_init_f32_minmax_scalar_params;
#elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  f32_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_f32_maxpool_minmax_ukernel_9p__wasmsimd_u4;
  f32_maxpool_config.init.f32 = xnn_init_f32_minmax_scalar_params;
#elif XNN_ARCH_WASM
  f32_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_f32_maxpool_minmax_ukernel_9p__scalar_u1;
  ...
  f32_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_f32_maxpool_minmax_ukernel_9p__rvv_u2v;
  f32_maxpool_config.init.f32 = xnn_init_f32_minmax_scalar_params;
#else
  f32_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_f32_maxpool_minmax_ukernel_9p__scalar_u1;
...
static void init_s8_maxpool_config(void) {
  ...
  assert(hardware_config != NULL);
  if (hardware_config->use_arm_neon) {
    s8_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_s8_maxpool_minmax_ukernel_9p__neon_u16;
    s8_maxpool_config.init.s8 = xnn_init_s8_minmax_scalar_params;
  } else if (!XNN_PLATFORM_MOBILE) {
    s8_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_s8_maxpool_minmax_ukernel_9p__scalar_u1;
    s8_maxpool_config.init.s8 = xnn_init_s8_minmax_scalar_params;
  }
#elif XNN_ARCH_ARM64
  s8_maxpool_config.ukernel =
  ...
  if (hardware_config->use_x86_sse4_1) {
    s8_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_s8_maxpool_minmax_ukernel_9p__sse41_u16;
    s8_maxpool_config.init.s8 = xnn_init_s8_minmax_scalar_params;
  } else {
    s8_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_s8_maxpool_minmax_ukernel_9p__scalar_u1;
...
#elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  s8_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_s8_maxpool_minmax_ukernel_9p__wasmsimd_u16;
  s8_maxpool_config.init.s8 = xnn_init_s8_minmax_scalar_params;
#else
  s8_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_s8_maxpool_minmax_ukernel_9p__scalar_u1;
...
static void init_u8_maxpool_config(void) {
  ...
  assert(hardware_config != NULL);
  if (hardware_config->use_arm_neon) {
    u8_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_u8_maxpool_minmax_ukernel_9p__neon_u16;
    u8_maxpool_config.init.u8 = xnn_init_u8_minmax_scalar_params;
  } else if (!XNN_PLATFORM_MOBILE) {
    u8_maxpool_config.ukernel =
        (xnn_maxpool_ukernel_fn)xnn_u8_maxpool_minmax_ukernel_9p__scalar_u1;
    u8_maxpool_config.init.u8 = xnn_init_u8_minmax_scalar_params;
  }
#elif XNN_ARCH_ARM64
  u8_maxpool_config.ukernel =
...
#elif XNN_ARCH_X86 || XNN_ARCH_X86_64
  u8_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_u8_maxpool_minmax_ukernel_9p__sse2_u16;
  u8_maxpool_config.init.u8 = xnn_init_u8_minmax_scalar_params;
#elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  u8_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_u8_maxpool_minmax_ukernel_9p__wasmsimd_u16;
  u8_maxpool_config.init.u8 = xnn_init_u8_minmax_scalar_params;
#else
  u8_maxpool_config.ukernel =
      (xnn_maxpool_ukernel_fn)xnn_u8_maxpool_minmax_ukernel_9p__scalar_u1;

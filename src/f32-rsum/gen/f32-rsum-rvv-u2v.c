    ...
    const union xnn_f32_scale_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  vfloat32m2_t sum0_f32v = __riscv_vfmv_s_f_f32m2(0.f, n);
  vfloat32m2_t sum1_f32v = __riscv_vfmv_s_f_f32m2(0.f, n);
  if (batch >= n * 8) {
  ...
  if (batch > 0) {
    for (; batch > 0;) {
      ...
      sum_f32v = __riscv_vfadd_vv_f32m2(sum_f32v, in_f32v, n1);
      batch -= n1;
    }
  }
  vfloat32m2_t out_f32v = __riscv_vfmul_vf_f32m2(sum_f32v, params->scalar.scale, n);
  acc_f32v = __riscv_vfredosum_vs_f32m2_f32m1(out_f32v, acc_f32v, n);

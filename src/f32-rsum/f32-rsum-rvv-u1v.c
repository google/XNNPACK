...
void xnn_f32_rsum_ukernel__rvv_u1v(
  ...
  vfloat32m1_t acc_f32v =
      __riscv_vfmv_s_f_f32m1(0.f, __riscv_vsetvl_e32m1(batch));
  ...
  for (; batch >= n * 8; batch -= n * 8) {
    vfloat32m1_t in0_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in1_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in2_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in3_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in4_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in5_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in6_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    vfloat32m1_t in7_f32v = __riscv_vle32_v_f32m1(input, n);
    input += n;
    ...
    vfloat32m1_t sum0123_f32v =
        __riscv_vfadd_vv_f32m1(sum01_f32v, sum23_f32v, n);
    vfloat32m1_t sum4567_f32v =
        __riscv_vfadd_vv_f32m1(sum45_f32v, sum67_f32v, n);
  ...
  for (; batch > 0;) {
    ...
    vfloat32m1_t in_f32v = __riscv_vle32_v_f32m1(input, n1);
    input += n1;
  ...
  vfloat32m1_t out_f32v =
      __riscv_vfmul_vf_f32m1(acc_f32v, params->scalar.scale, 1);

...
void xnn_f16_vsqrt_ukernel__aarch64_neonfp16arith_sqrt_u32(
    size_t batch,
    const void* input,
    void* output,
    const union xnn_f16_sqrt_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 32 * sizeof(uint16_t); batch -= 32 * sizeof(uint16_t)) {
    ...
    float16x8_t vacc2 = vreinterpretq_f16_u16(vld1q_u16(i)); i += 8;
    float16x8_t vacc3 = vreinterpretq_f16_u16(vld1q_u16(i)); i += 8;

    vacc0 = vsqrtq_f16(vacc0);
    vacc1 = vsqrtq_f16(vacc1);
    vacc2 = vsqrtq_f16(vacc2);
    vacc3 = vsqrtq_f16(vacc3);

    vst1q_u16(o, vreinterpretq_u16_f16(vacc0)); o += 8;
    vst1q_u16(o, vreinterpretq_u16_f16(vacc1)); o += 8;
    vst1q_u16(o, vreinterpretq_u16_f16(vacc2)); o += 8;
    vst1q_u16(o, vreinterpretq_u16_f16(vacc3)); o += 8;
  }

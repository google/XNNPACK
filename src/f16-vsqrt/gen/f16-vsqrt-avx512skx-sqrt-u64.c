...
void xnn_f16_vsqrt_ukernel__avx512skx_sqrt_u64(
    size_t batch,
    const void* input,
    void* output,
    const union xnn_f16_sqrt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(uint16_t); batch -= 64 * sizeof(uint16_t)) {
    ...
    __m512 vacc2 = _mm512_cvtph_ps(_mm256_loadu_si256((const __m256i*) (i + 32)));
    __m512 vacc3 = _mm512_cvtph_ps(_mm256_loadu_si256((const __m256i*) (i + 48)));
    i += 64;

    vacc0 = _mm512_sqrt_ps(vacc0);
    vacc1 = _mm512_sqrt_ps(vacc1);
    vacc2 = _mm512_sqrt_ps(vacc2);
    vacc3 = _mm512_sqrt_ps(vacc3);
    ...
    _mm256_storeu_si256((__m256i*) (o + 32), _mm512_cvtps_ph(vacc2, _MM_FROUND_TO_NEAREST_INT));
    _mm256_storeu_si256((__m256i*) (o + 48), _mm512_cvtps_ph(vacc3, _MM_FROUND_TO_NEAREST_INT));
    o += 64;
  }

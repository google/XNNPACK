...
void xnn_f32_vcos_ukernel__sse2_poly_4_u4(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vcos_ukernel__sse2_poly_4_u8(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vcos_ukernel__sse2_poly_4_u12(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vcos_ukernel__sse2_poly_4_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)

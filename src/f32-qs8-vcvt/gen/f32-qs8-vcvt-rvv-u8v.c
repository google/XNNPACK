    ...
    const struct xnn_f32_qs8_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch > 0; ) {
    ...
    x_f32v = __riscv_vfmul_vf_f32m8(x_f32v, scale, n);
    x_f32v = __riscv_vfmax_vf_f32m8(x_f32v, output_min_less_zero_point, n);
    x_f32v = __riscv_vfmin_vf_f32m8(x_f32v, output_max_less_zero_point, n);

    vint32m8_t y_i32v = __riscv_vfcvt_x_f_v_i32m8(x_f32v, n);
    y_i32v = __riscv_vadd_vx_i32m8(y_i32v, output_zero_point, n);

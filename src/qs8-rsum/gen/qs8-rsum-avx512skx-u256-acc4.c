    ...
    const struct xnn_qs8_rsum_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32768; batch -= 32768) {
    ...
    for (size_t current_batch = 32768; current_batch > 0; current_batch -= 256) {
    ...
    vacc2 = _mm512_add_epi32(vacc2, _mm512_madd_epi16(vone_16, vacc16_2));
    vacc3 = _mm512_add_epi32(vacc3, _mm512_madd_epi16(vone_16, vacc16_3));
  }

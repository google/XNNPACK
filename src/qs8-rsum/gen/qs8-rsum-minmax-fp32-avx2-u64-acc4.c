...
void xnn_qs8_rsum_minmax_fp32_ukernel__avx2_u64_acc4(
    size_t batch,
    const int8_t* input,
    int8_t* output,
    const union xnn_qs8_avgpool_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; num_batches > 0; --num_batches) {
    ...
    __m256i left2 = _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vacc16_2));
    __m256i right2 = _mm256_cvtepi16_epi32(_mm256_extractf128_si256(vacc16_2, 1));
    vacc2 = _mm256_add_epi32(vacc2, _mm256_add_epi32(left2, right2));
    __m256i left3 = _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vacc16_3));
    __m256i right3 = _mm256_cvtepi16_epi32(_mm256_extractf128_si256(vacc16_3, 1));
    vacc3 = _mm256_add_epi32(vacc3, _mm256_add_epi32(left3, right3));
    batch -= 1024;
  }
  if (XNN_UNLIKELY(batch != 0)) {
    ...
    vacc16_0 = _mm256_add_epi16(vacc16_0, vacc16_3);
  ...
  vacc0 = _mm256_add_epi32(vacc0, vacc3);

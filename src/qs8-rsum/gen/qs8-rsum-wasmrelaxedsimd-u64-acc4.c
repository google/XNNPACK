    ...
    const struct xnn_qs8_rsum_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  v128_t vacc3 = wasm_i32x4_const_splat(0);
  ...
  for (; batch >= 64; batch -= 64) {
    ...
    vacc2 = wasm_i32x4_relaxed_dot_i8x16_i7x16_add(vt2, vone, vacc2);
    vacc3 = wasm_i32x4_relaxed_dot_i8x16_i7x16_add(vt3, vone, vacc3);
  }
  ...
  vacc2 = wasm_i32x4_add(vacc2, vacc3);

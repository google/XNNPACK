...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    int32x4_t vbias89AB = vld1q_s32(w); w = (const int32_t*) w + 4;
    int32x4_t vbiasCDEF = vld1q_s32(w); w = (const int32_t*) w + 4;
    ...
    int32x4_t vacc01x89 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc01xAB = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc01xCD = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    int32x4_t vacc01xEF = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    ...
    int32x4_t vacc23x89 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc23xAB = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc23xCD = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    int32x4_t vacc23xEF = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    int32x4_t vacc45x01 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias0123), vreinterpretq_u64_s32(vbias0123)));
    int32x4_t vacc45x23 = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias0123), vreinterpretq_u64_s32(vbias0123)));
    int32x4_t vacc45x45 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias4567), vreinterpretq_u64_s32(vbias4567)));
    int32x4_t vacc45x67 = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias4567), vreinterpretq_u64_s32(vbias4567)));
    int32x4_t vacc45x89 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc45xAB = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc45xCD = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    int32x4_t vacc45xEF = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    int32x4_t vacc67x01 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias0123), vreinterpretq_u64_s32(vbias0123)));
    int32x4_t vacc67x23 = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias0123), vreinterpretq_u64_s32(vbias0123)));
    int32x4_t vacc67x45 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias4567), vreinterpretq_u64_s32(vbias4567)));
    int32x4_t vacc67x67 = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias4567), vreinterpretq_u64_s32(vbias4567)));
    int32x4_t vacc67x89 = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc67xAB = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbias89AB), vreinterpretq_u64_s32(vbias89AB)));
    int32x4_t vacc67xCD = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    int32x4_t vacc67xEF = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vbiasCDEF), vreinterpretq_u64_s32(vbiasCDEF)));
    ...
    float32x4_t vfpacc6x89AB = vcvtq_f32_s32(vacc6x89AB);
    float32x4_t vfpacc6xCDEF = vcvtq_f32_s32(vacc6xCDEF);
    float32x4_t vfpacc7x0123 = vcvtq_f32_s32(vacc7x0123);
    float32x4_t vfpacc7x4567 = vcvtq_f32_s32(vacc7x4567);
    float32x4_t vfpacc7x89AB = vcvtq_f32_s32(vacc7x89AB);
    float32x4_t vfpacc7xCDEF = vcvtq_f32_s32(vacc7xCDEF);
    ...
    vfpacc6x89AB = vmulq_f32(vfpacc6x89AB, vscale89AB);
    vfpacc7x89AB = vmulq_f32(vfpacc7x89AB, vscale89AB);
    ...
    vfpacc6xCDEF = vmulq_f32(vfpacc6xCDEF, vscaleCDEF);
    vfpacc7xCDEF = vmulq_f32(vfpacc7xCDEF, vscaleCDEF);
    ...
    vacc6x89AB = vcvtnq_s32_f32(vfpacc6x89AB);
    vacc6xCDEF = vcvtnq_s32_f32(vfpacc6xCDEF);

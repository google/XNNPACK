...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_4x16c2s2__wasmsimd_dot16x2(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k != 0) {
      ...
      v128_t vb01234567 = wasm_v128_load((const int8_t*) w);
      v128_t vb0123 = wasm_i16x8_extend_low_i8x16(vb01234567);
      v128_t vb4567 = wasm_i16x8_extend_high_i8x16(vb01234567);
      v128_t vb89ABCDEF = wasm_v128_load((const int8_t*) w + 16);
      v128_t vb89AB = wasm_i16x8_extend_low_i8x16(vb89ABCDEF);
      v128_t vbCDEF = wasm_i16x8_extend_high_i8x16(vb89ABCDEF);
      ...
      va0x0123 = wasm_v32x4_shuffle(va0x0123, va0x0123, 1, 4, 3, 6);
      ...
      va1x0123 = wasm_v32x4_shuffle(va1x0123, va1x0123, 1, 4, 3, 6);
      ...
      va2x0123 = wasm_v32x4_shuffle(va2x0123, va2x0123, 1, 4, 3, 6);
      ...
      va3x0123 = wasm_v32x4_shuffle(va3x0123, va3x0123, 1, 4, 3, 6);

      vb01234567 = wasm_v128_load((const int8_t*) w + 32);
      vb0123 = wasm_i16x8_extend_low_i8x16(vb01234567);
      vb4567 = wasm_i16x8_extend_high_i8x16(vb01234567);
      vb89ABCDEF = wasm_v128_load((const int8_t*) w + 48);
      vb89AB = wasm_i16x8_extend_low_i8x16(vb89ABCDEF);
      vbCDEF = wasm_i16x8_extend_high_i8x16(vb89ABCDEF);

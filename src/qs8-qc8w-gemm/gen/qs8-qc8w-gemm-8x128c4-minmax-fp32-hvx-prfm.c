...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_8x128c4__hvx_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  const uint32_t prefetch_size = HEXAGON_V64_CREATE_H(0, 0, kc * 128, 1);
  do {
    ...
    if (((((intptr_t) a) | a_stride) & (sizeof(int32_t) - 1)) != 0) {
      for (; k >= 8 * sizeof(int8_t); k -= 8 * sizeof(int8_t)) {
        ...
        const HVX_Vector va7x4567 = Q6_V_vsplat_R(unaligned_load_s32(a7+4)); a7 += 8;
        ...
        vacc7x3 = Q6_Vw_vrmpyacc_VwVbVb(vacc7x3, va7x0123, vb3x0123);
        ...
        vacc7x0 = Q6_Vw_vrmpyacc_VwVbVb(vacc7x0, va7x4567, vb0x4567);
        vacc7x1 = Q6_Vw_vrmpyacc_VwVbVb(vacc7x1, va7x4567, vb1x4567);
        vacc7x2 = Q6_Vw_vrmpyacc_VwVbVb(vacc7x2, va7x4567, vb2x4567);
        vacc7x3 = Q6_Vw_vrmpyacc_VwVbVb(vacc7x3, va7x4567, vb3x4567);
      }
    } else {
      for (; k >= 8 * sizeof(int8_t); k -= 8 * sizeof(int8_t)) {
        ...
        const HVX_Vector va7x0123 = Q6_V_vsplat_R(*((const int32_t*)a7));
        const HVX_Vector va7x4567 = Q6_V_vsplat_R(*((const int32_t*)a7+4)); a7 += 8;
    ...
    vacc7x3 = rescale_fp32(vacc7x3, vscale3);
    ...
    HVX_Vector vout7x1 = Q6_Vh_vpack_VwVw_sat(vacc7x3, vacc7x2);

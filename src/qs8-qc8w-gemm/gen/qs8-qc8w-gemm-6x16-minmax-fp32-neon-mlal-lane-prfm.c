...
void xnn_qc8_gemm_minmax_fp32_ukernel_6x16__neon_mlal_lane_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qc8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    vacc4x89AB = vreinterpretq_s32_f32(vaddq_f32(vfpacc4x89AB, vmagic_bias));
    vacc4xCDEF = vreinterpretq_s32_f32(vaddq_f32(vfpacc4xCDEF, vmagic_bias));
    ...
    vacc4x89AB = vqsubq_s32(vacc4x89AB, vmagic_bias_less_output_zero_point);
    vacc4xCDEF = vqsubq_s32(vacc4xCDEF, vmagic_bias_less_output_zero_point);
    ...
    vacc5x89AB = vqsubq_s32(vacc5x89AB, vmagic_bias_less_output_zero_point);
    vacc5xCDEF = vqsubq_s32(vacc5xCDEF, vmagic_bias_less_output_zero_point);

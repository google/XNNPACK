    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; k >= 8 * sizeof(int8_t); k -= 8 * sizeof(int8_t)) {
      ...
      const HVX_Vector va8x4567 = Q6_V_vsplat_R(unaligned_load_s32(a8+4)); a8 += 8;
      ...
      vacc8x0 = Q6_Vw_vrmpyacc_VwVbVb(vacc8x0, va8x4567, vb0x4567);
      vacc8x1 = Q6_Vw_vrmpyacc_VwVbVb(vacc8x1, va8x4567, vb1x4567);
      vacc8x2 = Q6_Vw_vrmpyacc_VwVbVb(vacc8x2, va8x4567, vb2x4567);
      vacc8x3 = Q6_Vw_vrmpyacc_VwVbVb(vacc8x3, va8x4567, vb3x4567);
    }

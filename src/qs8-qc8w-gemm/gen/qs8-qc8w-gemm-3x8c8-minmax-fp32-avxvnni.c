...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_3x8c8__avxvnni(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x2x0123 = _mm256_dpbusd_avx_epi32(vacc1x2x0123, va2x89ABCDEF, vb01234567x4567);
      vacc1x2x4567 = _mm256_dpbusd_avx_epi32(vacc1x2x4567, va2x89ABCDEF, vb89ABCDEFx4567);

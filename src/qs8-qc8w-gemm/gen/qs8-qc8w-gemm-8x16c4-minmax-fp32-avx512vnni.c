...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_8x16c4__avx512vnni(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m512i vacc0x7x0123456789ABCDEF = vacc0x0x0123456789ABCDEF;
    ...
    vacc0x7x0123456789ABCDEF = _mm512_cvtps_epi32(vscaled7x0123456789ABCDEF);
    ...
    __m256i vacc0x7x012389AB4567CDEF = _mm256_packs_epi32(_mm512_castsi512_si256(vacc0x7x0123456789ABCDEF), _mm512_extracti32x8_epi32(vacc0x7x0123456789ABCDEF, 1));
    ...
    vacc0x7x012389AB4567CDEF = _mm256_adds_epi16(vacc0x7x012389AB4567CDEF, voutput_zero_point);
    ...
    const __m128i vout7x012389AB4567CDEF = _mm_packs_epi16(_mm256_castsi256_si128(vacc0x7x012389AB4567CDEF), _mm256_extracti128_si256(vacc0x7x012389AB4567CDEF, 1));

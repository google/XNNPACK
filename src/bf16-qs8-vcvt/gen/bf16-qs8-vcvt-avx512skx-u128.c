...
void xnn_bf16_qs8_vcvt_ukernel__avx512skx_u128(
    size_t batch,
    ...
    const struct xnn_bf16_qs8_cvt_params* restrict params)
{
  ...
  for (; batch >= 128 * sizeof(xnn_bfloat16); batch -= 128 * sizeof(xnn_bfloat16)) {
    ...
    __m512 vxGHIJ = _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(_mm256_loadu_si256((const __m256i*) (input + 64))), 16));
    __m512 vxKLMN = _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(_mm256_loadu_si256((const __m256i*) (input + 80))), 16));
    __m512 vxOPQR = _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(_mm256_loadu_si256((const __m256i*) (input + 96))), 16));
    __m512 vxSTUV = _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(_mm256_loadu_si256((const __m256i*) (input + 112))), 16));
    input += 128;
    ...
    vxOPQR = _mm512_min_ps(vxOPQR, voverflow_max);
    vxSTUV = _mm512_min_ps(vxSTUV, voverflow_max);

...
void xnn_s32_vmax_ukernel__avx512f_u16(
    size_t batch,
...
void xnn_s32_vmax_ukernel__avx512f_u32(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vmax_ukernel__avx512f_u48(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vmax_ukernel__avx512f_u64(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,

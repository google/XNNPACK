  ...
  do {
    float* o = output;
    {
      ...
      for (; c >= 4; c -= 4) {
        ...
        const v128_t vmax018 = wasm_f32x4_pmax(wasm_f32x4_pmax(vi1, vi0), vi8);
        const v128_t vmax23 = wasm_f32x4_pmax(vi2, vi3);
        const v128_t vmax45 = wasm_f32x4_pmax(vi4, vi5);
        const v128_t vmax67 = wasm_f32x4_pmax(vi6, vi7);

        const v128_t vmax2345 = wasm_f32x4_pmax(vmax23, vmax45);
        const v128_t vmax01678 = wasm_f32x4_pmax(vmax018, vmax67);
        const v128_t vmax = wasm_f32x4_pmax(vmax2345, vmax01678);
        const v128_t vout = wasm_f32x4_pmax(voutput_min, wasm_f32x4_pmin(voutput_max, vmax));
      ...
      if (c != 0) {
        ...
        const v128_t vmax01678 = wasm_f32x4_pmax(vmax018, vmax67);
        const v128_t vmax = wasm_f32x4_pmax(vmax2345, vmax01678);
        v128_t vout = wasm_f32x4_pmax(voutput_min, wasm_f32x4_pmin(voutput_max, vmax));
    ...
    for (ptrdiff_t k = (ptrdiff_t) kernel_elements - 9; k > 0; k -= 8) {
      ...
      for (; c >= 4; c -= 4) {
        ...
        const v128_t vmax01 = wasm_f32x4_pmax(wasm_f32x4_pmax(vi0, vi1), vo);
        const v128_t vmax23 = wasm_f32x4_pmax(vi2, vi3);
        const v128_t vmax45 = wasm_f32x4_pmax(vi4, vi5);
        const v128_t vmax67 = wasm_f32x4_pmax(vi6, vi7);

        const v128_t vmax2345 = wasm_f32x4_pmax(vmax23, vmax45);
        const v128_t vmax0167 = wasm_f32x4_pmax(vmax01, vmax67);

...
XNN_UKERNEL_WITH_PARAMS(0,
    ...
    xnn_init_f32_minmax_params_fn, xnn_init_f32_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(0,
    xnn_f32_maxpool_minmax_ukernel_9p8x__wasmsimd_arm_c4,
    /*channel_tile=*/4, /*channel_scaled_tile=*/4,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-16384, /*qmax=*/16384,
    xnn_init_f32_minmax_params_fn, xnn_init_f32_minmax_scalar_params)
XNN_UKERNEL_WITH_PARAMS(0,
    xnn_f32_maxpool_minmax_ukernel_9p8x__wasmsimd_x86_c4,
    /*channel_tile=*/4, /*channel_scaled_tile=*/4,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-16384, /*qmax=*/16384,
    xnn_init_f32_minmax_params_fn, xnn_init_f32_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(0,
    xnn_f32_maxpool_minmax_ukernel_9p8x__wasm_c1,
...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector,
    xnn_f32_maxpool_minmax_ukernel_9p8x__rvv_c1v,
    /*channel_tile=*/1, /*channel_scaled_tile=*/(1*xnn_init_hardware_config()->vlenb/sizeof(float)),
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-16384, /*qmax=*/16384,
    xnn_init_f32_minmax_params_fn, xnn_init_f32_minmax_scalar_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector,
    xnn_f32_maxpool_minmax_ukernel_9p8x__rvv_c2v,

    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    float* o = output;
    {
      ...
      const float* i1 = 1 < kernel_elements ? *input++ : i0;
      const float* i2 = 2 < kernel_elements ? *input++ : i0;
      const float* i3 = 3 < kernel_elements ? *input++ : i0;
      const float* i4 = 4 < kernel_elements ? *input++ : i0;
      const float* i5 = 5 < kernel_elements ? *input++ : i0;
      const float* i6 = 6 < kernel_elements ? *input++ : i0;
      const float* i7 = 7 < kernel_elements ? *input++ : i0;
      const float* i8 = 8 < kernel_elements ? *input++ : i0;
    ...
    for (ptrdiff_t k = (ptrdiff_t) kernel_elements - 9; k > 0; k -= 8) {
      const float* i0 = *input++;
      const float* i1 = 1 < k ? *input++ : i0;
      const float* i2 = 2 < k ? *input++ : i0;
      const float* i3 = 3 < k ? *input++ : i0;
      const float* i4 = 4 < k ? *input++ : i0;
      const float* i5 = 5 < k ? *input++ : i0;
      const float* i6 = 6 < k ? *input++ : i0;
      const float* i7 = 7 < k ? *input++ : i0;
      i0 = (const float*) ((uintptr_t) i0 + input_offset);
      i1 = (const float*) ((uintptr_t) i1 + input_offset);
      i2 = (const float*) ((uintptr_t) i2 + input_offset);
      i3 = (const float*) ((uintptr_t) i3 + input_offset);

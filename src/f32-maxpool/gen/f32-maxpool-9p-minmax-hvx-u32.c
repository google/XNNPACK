...
void xnn_f32_maxpool_minmax_ukernel_9p__hvx_u32(
    ...
    const struct xnn_f32_minmax_params* restrict params)
{
  ...
  do {
    ...
    size_t c = channels;
    for (; c >= 32; c -= 32) {
      const xnn_simd_f32_t vi0 = xnn_load_impl(i0); i0 += 32;
      const xnn_simd_f32_t vi1 = xnn_load_impl(i1); i1 += 32;
      const xnn_simd_f32_t vi2 = xnn_load_impl(i2); i2 += 32;
      const xnn_simd_f32_t vi3 = xnn_load_impl(i3); i3 += 32;
      const xnn_simd_f32_t vi4 = xnn_load_impl(i4); i4 += 32;
      const xnn_simd_f32_t vi5 = xnn_load_impl(i5); i5 += 32;
      const xnn_simd_f32_t vi6 = xnn_load_impl(i6); i6 += 32;
      const xnn_simd_f32_t vi7 = xnn_load_impl(i7); i7 += 32;
      const xnn_simd_f32_t vi8 = xnn_load_impl(i8); i8 += 32;

...
void xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_6x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      const int8x16_t vb89ABx0123 = vshrq_n_s8(vshlq_n_s8(vb89ABx16, 6), 6);
      const int8x16_t vbCDEFx0123 = vshrq_n_s8(vshlq_n_s8(vbCDEFx16, 6), 6);
      // Second crumb.
      ...
      const int8x16_t vb89ABx4567 = vshrq_n_s8(vshlq_n_s8(vb89ABx16, 4), 6);
      const int8x16_t vbCDEFx4567 = vshrq_n_s8(vshlq_n_s8(vbCDEFx16, 4), 6);
      // Third crumb.
      ...
      const int8x16_t vb89ABx89AB = vshrq_n_s8(vshlq_n_s8(vb89ABx16, 2), 6);
      const int8x16_t vbCDEFx89AB = vshrq_n_s8(vshlq_n_s8(vbCDEFx16, 2), 6);
      // Fourth crumb.
      const int8x16_t vb0123xCDEF = vshrq_n_s8(vb0123x16, 6);
      const int8x16_t vb4567xCDEF = vshrq_n_s8(vb4567x16, 6);
      const int8x16_t vb89ABxCDEF = vshrq_n_s8(vb89ABx16, 6);
      const int8x16_t vbCDEFxCDEF = vshrq_n_s8(vbCDEFx16, 6);
    ...
    while (k >= 8 * sizeof(int8_t)) {
      ...
      const int8x16_t vb0123x89AB = vshrq_n_s8(vshlq_n_s8(vb01234567x89AB, 6), 6);
      const int8x16_t vb0123xCDEF = vshrq_n_s8(vshlq_n_s8(vb01234567xCDEF, 6), 6);
      ...
      const int8x16_t vb4567x89AB = vshrq_n_s8(vshlq_n_s8(vb01234567x89AB, 4), 6);
      const int8x16_t vb4567xCDEF = vshrq_n_s8(vshlq_n_s8(vb01234567xCDEF, 4), 6);

...
void xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_1x4__scalar_fmagic(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    for (; k >= 4 * sizeof(int8_t); k -= 4 * sizeof(int8_t)) {
      ...
      w = (const uint8_t*) w + 4;
      const int32_t vb0c0 = (int32_t) ((int8_t) (vbi0 << 6) >> 6);
      const int32_t vb0c1 = (int32_t) ((int8_t) (vbi0 << 4) >> 6);
      const int32_t vb0c2 = (int32_t) ((int8_t) (vbi0 << 2) >> 6);
      const int32_t vb0c3 = (int32_t) ((int8_t) (vbi0) >> 6);
      const int32_t vb1c0 = (int32_t) ((int8_t) (vbi1 << 6) >> 6);
      const int32_t vb1c1 = (int32_t) ((int8_t) (vbi1 << 4) >> 6);
      const int32_t vb1c2 = (int32_t) ((int8_t) (vbi1 << 2) >> 6);
      const int32_t vb1c3 = (int32_t) ((int8_t) (vbi1) >> 6);
      const int32_t vb2c0 = (int32_t) ((int8_t) (vbi2 << 6) >> 6);
      const int32_t vb2c1 = (int32_t) ((int8_t) (vbi2 << 4) >> 6);
      const int32_t vb2c2 = (int32_t) ((int8_t) (vbi2 << 2) >> 6);
      const int32_t vb2c3 = (int32_t) ((int8_t) (vbi2) >> 6);
      const int32_t vb3c0 = (int32_t) ((int8_t) (vbi3 << 6) >> 6);
      const int32_t vb3c1 = (int32_t) ((int8_t) (vbi3 << 4) >> 6);
      const int32_t vb3c2 = (int32_t) ((int8_t) (vbi3 << 2) >> 6);
      const int32_t vb3c3 = (int32_t) ((int8_t) (vbi3) >> 6);

...
void xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_6x4c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      a4 += 32;
      const __m128i va5x0 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5)), vsign_mask);
      const __m128i va5x1 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 8)), vsign_mask);
      const __m128i va5x2 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 16)), vsign_mask);
      const __m128i va5x3 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 24)), vsign_mask);
      a5 += 32;
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      if (k != 0) {
        ...
        a4 += 8;
        const __m128i va5x3 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5)), vsign_mask);
        a5 += 8;

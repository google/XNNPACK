...
void xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_2x4c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_kzp2(vacc1x1x01, va1x1, vb01234567x23);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_kzp2(vacc1x1x23, va1x1, vb89ABCDEFx23);
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_kzp2(vacc1x1x01, va1x3, vb01234567x67);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_kzp2(vacc1x1x23, va1x3, vb89ABCDEFx67);
      w = (const int8_t*) w + 32;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_kzp2(vacc1x1x01, va1x89ABCDEF, vb01234567x23);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_kzp2(vacc1x1x23, va1x89ABCDEF, vb89ABCDEFx23);

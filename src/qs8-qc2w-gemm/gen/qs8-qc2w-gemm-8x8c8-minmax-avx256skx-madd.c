...
void xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_8x8c8__avx256skx_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x0, vb01234567x0123);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x0, vb89ABCDEFx0123);
      ...
      vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x1, vb01234567x4567);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x1, vb89ABCDEFx4567);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x2, vb01234567x89AB);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x2, vb89ABCDEFx89AB);
      ...
      vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x3, vb01234567xCDEF);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x3, vb89ABCDEFxCDEF);
      w = (const int8_t*) w + 64;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x01234567, vb01234567x0123);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x01234567, vb89ABCDEFx0123);
      ...
      vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x89ABCDEF, vb01234567x4567);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x89ABCDEF, vb89ABCDEFx4567);
      ...
      if (k != 0) {
        ...
        vacc7x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x0123, va7x3, vb01234567x89AB);
        vacc7x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc7x4567, va7x3, vb89ABCDEFx89AB);
        k -= 8 * sizeof(int8_t);
      }
    }

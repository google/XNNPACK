...
void xnn_qs8_qc2w_gemm_minmax_fp32_ukernel_1x8c4__neondot(
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      const int8x16_t vb0123x16 = vld1q_s8(w);
      w = (const int8_t*)w + 16;
      const int8x16_t vb4567x16 = vld1q_s8(w);
      w = (const int8_t*)w + 16;
      // First crumb.
      ...
      vacc0x0123 =
          vdotq_lane_s32(vacc0x0123, vb0123x0123, vget_low_s8(va_0x16), 0);
      vacc0x4567 =
          vdotq_lane_s32(vacc0x4567, vb4567x0123, vget_low_s8(va_0x16), 0);

      vacc0x0123 =
          vdotq_lane_s32(vacc0x0123, vb0123x4567, vget_low_s8(va_0x16), 1);
      vacc0x4567 =
          vdotq_lane_s32(vacc0x4567, vb4567x4567, vget_low_s8(va_0x16), 1);

      vacc0x0123 =
          vdotq_lane_s32(vacc0x0123, vb0123x89AB, vget_high_s8(va_0x16), 0);
      vacc0x4567 =
          vdotq_lane_s32(vacc0x4567, vb4567x89AB, vget_high_s8(va_0x16), 0);

      vacc0x0123 =
          vdotq_lane_s32(vacc0x0123, vb0123xCDEF, vget_high_s8(va_0x16), 1);
      vacc0x4567 =
          vdotq_lane_s32(vacc0x4567, vb4567xCDEF, vget_high_s8(va_0x16), 1);

      k -= 16 * sizeof(int8_t);
    }
    // Handle up to 8 final positions of `k`.
    if XNN_UNLIKELY (k > 0) {
      int8x16_t vb0123x16 = vld1q_s8(w);
      w = (const int8_t*)w + 16;
      int8x16_t vb4567x16 = vld1q_s8(w);
      w = (const int8_t*)w + 16;

      if XNN_UNLIKELY (k >= 8 * sizeof(int8_t)) {
        // Load a 1x8 block of activations.
        const int8x8_t va0x8 = vld1_s8(a0);
        a0 += 8;
      ...
      if XNN_UNLIKELY (k >= 4 * sizeof(int8_t)) {
        ...
        const int8x8_t va0x0123 =
            vreinterpret_s8_s32(vld1_dup_s32((const int32_t*)a0));
        a0 += 4;
    ...
    const float32x4_t vscale0123 = vld1q_f32((const float*)w);
    w = (const float*)w + 4;
    vfpacc0x0123 = vmulq_f32(vfpacc0x0123, vscale0123);
    const float32x4_t vscale4567 = vld1q_f32((const float*)w);
    w = (const float*)w + 4;
    ...
    const int16x8_t voutput_zero_point =
        vdupq_n_s16(params->fp32_neonv8.output_zero_point);

#if XNN_ARCH_ARM64
    const int16x8_t vacc0x01234567 =
        vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc0x0123), vacc0x4567),
                   voutput_zero_point);
    int8x16_t vout0x01234567_16 =
        vqmovn_high_s16(vqmovn_s16(vacc0x01234567), vacc0x01234567);
#else
    const int16x8_t vacc0x01234567 =
        vqaddq_s16(vcombine_s16(vqmovn_s32(vacc0x0123), vqmovn_s32(vacc0x4567)),
                   voutput_zero_point);
    int8x16_t vout0x01234567_16 =
        vcombine_s8(vqmovn_s16(vacc0x01234567), vqmovn_s16(vacc0x01234567));
#endif
    ...
    vout0x01234567_16 = vmaxq_s8(vout0x01234567_16, voutput_min);

    vout0x01234567_16 = vminq_s8(vout0x01234567_16, voutput_max);

    if XNN_LIKELY (nc >= 8) {
      vst1_s8(c0, vget_low_s8(vout0x01234567_16));
      ...
      int8x8_t vout0x01234567 = vget_low_s8(vout0x01234567_16);
      if (nc & 4) {
        vst1_lane_u32((void*)c0, vreinterpret_u32_s8(vout0x01234567), 0);
        c0 += 4;
        vout0x01234567 = vext_s8(vout0x01234567, vout0x01234567, 4);
      }
      if (nc & 2) {
        vst1_lane_u16((void*)c0, vreinterpret_u16_s8(vout0x01234567), 0);
        c0 += 2;

...
void xnn_qd8_f32_qb4w_gemm_minmax_ukernel_8x32c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    float32x4_t vout6xGHIJ = vmulq_lane_f32(vksumGHIJ, vget_low_f32(vinput_zero_point67), 0);
    float32x4_t vout7xGHIJ = vmulq_lane_f32(vksumGHIJ, vget_high_f32(vinput_zero_point67), 0);
    float32x4_t vout6xKLMN = vmulq_lane_f32(vksumKLMN, vget_low_f32(vinput_zero_point67), 0);
    float32x4_t vout7xKLMN = vmulq_lane_f32(vksumKLMN, vget_high_f32(vinput_zero_point67), 0);
    float32x4_t vout6xOPQR = vmulq_lane_f32(vksumOPQR, vget_low_f32(vinput_zero_point67), 0);
    float32x4_t vout7xOPQR = vmulq_lane_f32(vksumOPQR, vget_high_f32(vinput_zero_point67), 0);
    float32x4_t vout6xSTUV = vmulq_lane_f32(vksumSTUV, vget_low_f32(vinput_zero_point67), 0);
    ...
    for (size_t nb=0; nb < n_blocks; ++nb) {
      ...
      float32x4_t vf7xGHIJ = vcvtq_f32_s32(vacc7xGHIJ);
      vout7xGHIJ = vfmaq_f32(vout7xGHIJ, vf7xGHIJ, vfilter_output_scaleGHIJ);
      float32x4_t vf7xKLMN = vcvtq_f32_s32(vacc7xKLMN);
      vout7xKLMN = vfmaq_f32(vout7xKLMN, vf7xKLMN, vfilter_output_scaleKLMN);
      float32x4_t vf7xOPQR = vcvtq_f32_s32(vacc7xOPQR);
      vout7xOPQR = vfmaq_f32(vout7xOPQR, vf7xOPQR, vfilter_output_scaleOPQR);
      float32x4_t vf7xSTUV = vcvtq_f32_s32(vacc7xSTUV);
      vout7xSTUV = vfmaq_f32(vout7xSTUV, vf7xSTUV, vfilter_output_scaleSTUV);
    }
    ...
    vout6xGHIJ = vmulq_f32(vout6xGHIJ, one_sixteenth);
    vout6xKLMN = vmulq_f32(vout6xKLMN, one_sixteenth);
    vout6xOPQR = vmulq_f32(vout6xOPQR, one_sixteenth);
    vout6xSTUV = vmulq_f32(vout6xSTUV, one_sixteenth);
    ...
    vout7xGHIJ = vmulq_f32(vout7xGHIJ, one_sixteenth);
    vout7xKLMN = vmulq_f32(vout7xKLMN, one_sixteenth);
    vout7xOPQR = vmulq_f32(vout7xOPQR, one_sixteenth);
    vout7xSTUV = vmulq_f32(vout7xSTUV, one_sixteenth);
    ...
    vout7xSTUV = vmulq_lane_f32(vout7xSTUV, vget_high_f32(vinput_scale67), 1);
      ...
      vout7xGHIJ = vaddq_f32(vbiasGHIJ, vout7xGHIJ);
      ...
      vout7xKLMN = vaddq_f32(vbiasKLMN, vout7xKLMN);
      ...
      vout7xOPQR = vaddq_f32(vbiasOPQR, vout7xOPQR);
      ...
      vout7xSTUV = vaddq_f32(vbiasSTUV, vout7xSTUV);
    #else
      const float32x4_t vbias0123 = vld1q_f32(w); w = (const float*) w + 4;
      vout0x0123 = vaddq_f32(vbias0123, vout0x0123);
      vout1x0123 = vaddq_f32(vbias0123, vout1x0123);

...
void xnn_qd8_f32_qb4w_gemm_minmax_ukernel_14x16c8__avx512vnni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512 vinput_zero_point8 = _mm512_set1_ps((float) quantization_params[8].zero_point);
  const __m512 vinput_zero_point9 = _mm512_set1_ps((float) quantization_params[9].zero_point);
  const __m512 vinput_zero_point10 = _mm512_set1_ps((float) quantization_params[10].zero_point);
  const __m512 vinput_zero_point11 = _mm512_set1_ps((float) quantization_params[11].zero_point);
  const __m512 vinput_zero_point12 = _mm512_set1_ps((float) quantization_params[12].zero_point);
  const __m512 vinput_zero_point13 = _mm512_set1_ps((float) quantization_params[13].zero_point);
  ...
  do {
    ...
    __m512 vscaled12x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point12);
    __m512 vscaled13x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point13);
    ...
    for (size_t kb=0; kb < kc; kb+=bl) {
      ...
      __m512i vacc12x01234567 = _mm512_setzero_epi32();
      __m512i vacc12x89ABCDEF = _mm512_setzero_epi32();
      __m512i vacc13x01234567 = _mm512_setzero_epi32();
      __m512i vacc13x89ABCDEF = _mm512_setzero_epi32();
      size_t k = bl;
      while (k >= 16 * sizeof(int8_t)) {
        ...
        a11 += 16;
        const __m512i va12x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a12));
        const __m512i va12x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a12 + 8));
        a12 += 16;
        const __m512i va13x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a13));
        const __m512i va13x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a13 + 8));
        a13 += 16;
      ...
      __m512 vf12x0123456789ABCDEF = _mm512_cvtepi32_ps(vacc12x0123456789ABCDEF);
      __m512 vf13x0123456789ABCDEF = _mm512_cvtepi32_ps(vacc13x0123456789ABCDEF);
      ...
      vscaled12x0123456789ABCDEF = _mm512_fmadd_ps(vf12x0123456789ABCDEF, vfilter_output_scale0123456789ABCDEF, vscaled12x0123456789ABCDEF);
      vscaled13x0123456789ABCDEF = _mm512_fmadd_ps(vf13x0123456789ABCDEF, vfilter_output_scale0123456789ABCDEF, vscaled13x0123456789ABCDEF);
    }
    ...
    vscaled12x0123456789ABCDEF = _mm512_add_ps(vscaled12x0123456789ABCDEF, vbias0123456789ABCDEF);
    vscaled13x0123456789ABCDEF = _mm512_add_ps(vscaled13x0123456789ABCDEF, vbias0123456789ABCDEF);

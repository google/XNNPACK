...
void xnn_qd8_f32_qb4w_gemm_minmax_ukernel_8x16c8__avx512skx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512 vinput_zero_point0 = _mm512_set1_ps((float) quantization_params[0].zero_point);
  const __m512 vinput_zero_point1 = _mm512_set1_ps((float) quantization_params[1].zero_point);
  const __m512 vinput_zero_point2 = _mm512_set1_ps((float) quantization_params[2].zero_point);
  const __m512 vinput_zero_point3 = _mm512_set1_ps((float) quantization_params[3].zero_point);
  const __m512 vinput_zero_point4 = _mm512_set1_ps((float) quantization_params[4].zero_point);
  const __m512 vinput_zero_point5 = _mm512_set1_ps((float) quantization_params[5].zero_point);
  const __m512 vinput_zero_point6 = _mm512_set1_ps((float) quantization_params[6].zero_point);
  const __m512 vinput_zero_point7 = _mm512_set1_ps((float) quantization_params[7].zero_point);
  const __m512 voutput_min = _mm512_set1_ps(params->scalar.min);
  const __m512 voutput_max = _mm512_set1_ps(params->scalar.max);
  const __m256i vmask = _mm256_set1_epi8(params->scalar.mask);

  do {
    const __m512 vksum0123456789ABCDEF = _mm512_load_ps((const float*) w);
    __m512 vout0x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point0);
    __m512 vout1x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point1);
    __m512 vout2x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point2);
    __m512 vout3x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point3);
    __m512 vout4x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point4);
    __m512 vout5x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point5);
    __m512 vout6x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point6);
    __m512 vout7x0123456789ABCDEF = _mm512_mul_ps(vksum0123456789ABCDEF, vinput_zero_point7);
    w = (const int32_t*) w + 16;

    for (size_t nb=0; nb<n_blocks; ++nb){
      __m512i vacc0x0123 = _mm512_setzero_si512();
      __m512i vacc0x4567 = _mm512_setzero_si512();
      __m512i vacc0x89AB = _mm512_setzero_si512();
      __m512i vacc0xCDEF = _mm512_setzero_si512();
      __m512i vacc1x0123 = _mm512_setzero_si512();
      __m512i vacc1x4567 = _mm512_setzero_si512();
      __m512i vacc1x89AB = _mm512_setzero_si512();
      __m512i vacc1xCDEF = _mm512_setzero_si512();
      __m512i vacc2x0123 = _mm512_setzero_si512();
      __m512i vacc2x4567 = _mm512_setzero_si512();
      __m512i vacc2x89AB = _mm512_setzero_si512();
      __m512i vacc2xCDEF = _mm512_setzero_si512();
      __m512i vacc3x0123 = _mm512_setzero_si512();
      __m512i vacc3x4567 = _mm512_setzero_si512();
      __m512i vacc3x89AB = _mm512_setzero_si512();
      __m512i vacc3xCDEF = _mm512_setzero_si512();
      __m512i vacc4x0123 = _mm512_setzero_si512();
      __m512i vacc4x4567 = _mm512_setzero_si512();
      __m512i vacc4x89AB = _mm512_setzero_si512();
      __m512i vacc4xCDEF = _mm512_setzero_si512();
      __m512i vacc5x0123 = _mm512_setzero_si512();
      __m512i vacc5x4567 = _mm512_setzero_si512();
      __m512i vacc5x89AB = _mm512_setzero_si512();
      __m512i vacc5xCDEF = _mm512_setzero_si512();
      __m512i vacc6x0123 = _mm512_setzero_si512();
      __m512i vacc6x4567 = _mm512_setzero_si512();
      __m512i vacc6x89AB = _mm512_setzero_si512();
      __m512i vacc6xCDEF = _mm512_setzero_si512();
      __m512i vacc7x0123 = _mm512_setzero_si512();
      __m512i vacc7x4567 = _mm512_setzero_si512();
      __m512i vacc7x89AB = _mm512_setzero_si512();
      __m512i vacc7xCDEF = _mm512_setzero_si512();
    ...
    // Add 4 adjacent sums
      ...
      vout1x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc1x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout1x0123456789ABCDEF);
      vout2x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc2x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout2x0123456789ABCDEF);
      vout3x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc3x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout3x0123456789ABCDEF);
      vout4x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc4x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout4x0123456789ABCDEF);
      vout5x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc5x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout5x0123456789ABCDEF);
      vout6x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc6x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout6x0123456789ABCDEF);
      vout7x0123456789ABCDEF = _mm512_fmadd_ps(_mm512_cvtepi32_ps(vacc7x0123456789ABCDEF), vfilter_output_scale0123456789ABCDEF, vout7x0123456789ABCDEF);
    }

    __m512 one_sixteenth = _mm512_set1_ps(1.0f/16);
    vout0x0123456789ABCDEF = _mm512_mul_ps(vout0x0123456789ABCDEF, one_sixteenth);
    vout1x0123456789ABCDEF = _mm512_mul_ps(vout1x0123456789ABCDEF, one_sixteenth);
    vout2x0123456789ABCDEF = _mm512_mul_ps(vout2x0123456789ABCDEF, one_sixteenth);
    vout3x0123456789ABCDEF = _mm512_mul_ps(vout3x0123456789ABCDEF, one_sixteenth);
    vout4x0123456789ABCDEF = _mm512_mul_ps(vout4x0123456789ABCDEF, one_sixteenth);
    vout5x0123456789ABCDEF = _mm512_mul_ps(vout5x0123456789ABCDEF, one_sixteenth);
    vout6x0123456789ABCDEF = _mm512_mul_ps(vout6x0123456789ABCDEF, one_sixteenth);
    vout7x0123456789ABCDEF = _mm512_mul_ps(vout7x0123456789ABCDEF, one_sixteenth);
    ...
    vout1x0123456789ABCDEF = _mm512_fmadd_ps(vout1x0123456789ABCDEF, _mm512_set1_ps(quantization_params[1].inv_scale), vbias0123456789ABCDEF);
    vout2x0123456789ABCDEF = _mm512_fmadd_ps(vout2x0123456789ABCDEF, _mm512_set1_ps(quantization_params[2].inv_scale), vbias0123456789ABCDEF);
    vout3x0123456789ABCDEF = _mm512_fmadd_ps(vout3x0123456789ABCDEF, _mm512_set1_ps(quantization_params[3].inv_scale), vbias0123456789ABCDEF);
    vout4x0123456789ABCDEF = _mm512_fmadd_ps(vout4x0123456789ABCDEF, _mm512_set1_ps(quantization_params[4].inv_scale), vbias0123456789ABCDEF);
    vout5x0123456789ABCDEF = _mm512_fmadd_ps(vout5x0123456789ABCDEF, _mm512_set1_ps(quantization_params[5].inv_scale), vbias0123456789ABCDEF);
    vout6x0123456789ABCDEF = _mm512_fmadd_ps(vout6x0123456789ABCDEF, _mm512_set1_ps(quantization_params[6].inv_scale), vbias0123456789ABCDEF);
    vout7x0123456789ABCDEF = _mm512_fmadd_ps(vout7x0123456789ABCDEF, _mm512_set1_ps(quantization_params[7].inv_scale), vbias0123456789ABCDEF);
    ...
    vout4x0123456789ABCDEF = _mm512_max_ps(vout4x0123456789ABCDEF, voutput_min);
    vout5x0123456789ABCDEF = _mm512_max_ps(vout5x0123456789ABCDEF, voutput_min);
    vout6x0123456789ABCDEF = _mm512_max_ps(vout6x0123456789ABCDEF, voutput_min);
    vout7x0123456789ABCDEF = _mm512_max_ps(vout7x0123456789ABCDEF, voutput_min);
    ...
    vout4x0123456789ABCDEF = _mm512_min_ps(vout4x0123456789ABCDEF, voutput_max);
    vout5x0123456789ABCDEF = _mm512_min_ps(vout5x0123456789ABCDEF, voutput_max);
    vout6x0123456789ABCDEF = _mm512_min_ps(vout6x0123456789ABCDEF, voutput_max);
    vout7x0123456789ABCDEF = _mm512_min_ps(vout7x0123456789ABCDEF, voutput_max);
    if XNN_LIKELY(nc >= 16) {
      ...
      _mm512_storeu_ps(c6, vout6x0123456789ABCDEF);
      _mm512_storeu_ps(c7, vout7x0123456789ABCDEF);
      ...
      _mm512_mask_storeu_ps(c6, vmask, vout6x0123456789ABCDEF);
      _mm512_mask_storeu_ps(c7, vmask, vout7x0123456789ABCDEF);
      nc = 0;
    }
  } while (nc != 0);
}

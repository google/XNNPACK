...
void xnn_qd8_f16_qc4w_gemm_minmax_ukernel_1x8c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
...
void xnn_qd8_f16_qb4w_gemm_minmax_ukernel_1x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t bl,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    float32x4_t vinput_scale0 = vld1q_dup_f32(&quantization_params[0].inv_scale);

...
void xnn_qd8_f16_qc4w_gemm_minmax_ukernel_5x16c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vinput_zero_point0 = vdupq_n_s32(qp0->zero_point);
    ...
    const int32x4_t vinput_zero_point1 = vdupq_n_s32(qp1->zero_point);
    ...
    const int32x4_t vinput_zero_point2 = vdupq_n_s32(qp2->zero_point);
    ...
    const int32x4_t vinput_zero_point3 = vdupq_n_s32(qp3->zero_point);
    ...
    const int32x4_t vinput_zero_point4 = vdupq_n_s32(qp4->zero_point);

...
void xnn_qd8_f16_qc4w_gemm_minmax_ukernel_14x8c8__avx256vnnigfni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m256i vshl4 = _mm256_load_si256((const __m256i*) params->avxvnni.gfni_shl4);  // 0x01020408
  do {

...
void xnn_qd8_f16_qc4w_gemm_minmax_ukernel_14x8c8__avx256skx_madd_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc6x0123 = _mm256_dpbusd_epi32_madd(vacc6x0123, va6x01234567, vb01234567x0123);
      vacc6x4567 = _mm256_dpbusd_epi32_madd(vacc6x4567, va6x01234567, vb89ABCDEFx0123);
      vacc7x0123 = _mm256_dpbusd_epi32_madd(vacc7x0123, va7x01234567, vb01234567x0123);
      vacc7x4567 = _mm256_dpbusd_epi32_madd(vacc7x4567, va7x01234567, vb89ABCDEFx0123);
      vacc8x0123 = _mm256_dpbusd_epi32_madd(vacc8x0123, va8x01234567, vb01234567x0123);
      vacc8x4567 = _mm256_dpbusd_epi32_madd(vacc8x4567, va8x01234567, vb89ABCDEFx0123);
      vacc9x0123 = _mm256_dpbusd_epi32_madd(vacc9x0123, va9x01234567, vb01234567x0123);
      vacc9x4567 = _mm256_dpbusd_epi32_madd(vacc9x4567, va9x01234567, vb89ABCDEFx0123);
      vacc10x0123 = _mm256_dpbusd_epi32_madd(vacc10x0123, va10x01234567, vb01234567x0123);
      vacc10x4567 = _mm256_dpbusd_epi32_madd(vacc10x4567, va10x01234567, vb89ABCDEFx0123);
      vacc11x0123 = _mm256_dpbusd_epi32_madd(vacc11x0123, va11x01234567, vb01234567x0123);
      vacc11x4567 = _mm256_dpbusd_epi32_madd(vacc11x4567, va11x01234567, vb89ABCDEFx0123);
      vacc12x0123 = _mm256_dpbusd_epi32_madd(vacc12x0123, va12x01234567, vb01234567x0123);
      vacc12x4567 = _mm256_dpbusd_epi32_madd(vacc12x4567, va12x01234567, vb89ABCDEFx0123);
      vacc13x0123 = _mm256_dpbusd_epi32_madd(vacc13x0123, va13x01234567, vb01234567x0123);
      vacc13x4567 = _mm256_dpbusd_epi32_madd(vacc13x4567, va13x01234567, vb89ABCDEFx0123);
      ...
      vacc6x0123 = _mm256_dpbusd_epi32_madd(vacc6x0123, va6x89ABCDEF, vb01234567x4567);
      vacc6x4567 = _mm256_dpbusd_epi32_madd(vacc6x4567, va6x89ABCDEF, vb89ABCDEFx4567);
      vacc7x0123 = _mm256_dpbusd_epi32_madd(vacc7x0123, va7x89ABCDEF, vb01234567x4567);
      vacc7x4567 = _mm256_dpbusd_epi32_madd(vacc7x4567, va7x89ABCDEF, vb89ABCDEFx4567);
      vacc8x0123 = _mm256_dpbusd_epi32_madd(vacc8x0123, va8x89ABCDEF, vb01234567x4567);
      vacc8x4567 = _mm256_dpbusd_epi32_madd(vacc8x4567, va8x89ABCDEF, vb89ABCDEFx4567);
      vacc9x0123 = _mm256_dpbusd_epi32_madd(vacc9x0123, va9x89ABCDEF, vb01234567x4567);
      vacc9x4567 = _mm256_dpbusd_epi32_madd(vacc9x4567, va9x89ABCDEF, vb89ABCDEFx4567);
      vacc10x0123 = _mm256_dpbusd_epi32_madd(vacc10x0123, va10x89ABCDEF, vb01234567x4567);
      vacc10x4567 = _mm256_dpbusd_epi32_madd(vacc10x4567, va10x89ABCDEF, vb89ABCDEFx4567);
      vacc11x0123 = _mm256_dpbusd_epi32_madd(vacc11x0123, va11x89ABCDEF, vb01234567x4567);
      vacc11x4567 = _mm256_dpbusd_epi32_madd(vacc11x4567, va11x89ABCDEF, vb89ABCDEFx4567);
      vacc12x0123 = _mm256_dpbusd_epi32_madd(vacc12x0123, va12x89ABCDEF, vb01234567x4567);
      vacc12x4567 = _mm256_dpbusd_epi32_madd(vacc12x4567, va12x89ABCDEF, vb89ABCDEFx4567);
      vacc13x0123 = _mm256_dpbusd_epi32_madd(vacc13x0123, va13x89ABCDEF, vb01234567x4567);
      vacc13x4567 = _mm256_dpbusd_epi32_madd(vacc13x4567, va13x89ABCDEF, vb89ABCDEFx4567);

...
void xnn_f16_vcos_ukernel__wasmrelaxedsimd_rational_3_2_div_u8(
    size_t batch,
...
void xnn_f16_vcos_ukernel__wasmrelaxedsimd_rational_3_2_div_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vcos_ukernel__wasmrelaxedsimd_rational_3_2_div_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(xnn_float16); batch -= 32 * sizeof(xnn_float16)) {
    ...
    vx_3 = xnn_add_f16(xnn_sub_f16(vpi_half_hi, vx_3), vpi_half_lo);
    vx_0 = xnn_min_f16(vx_0, xnn_sub_f16(vpi, vx_0));
    vx_1 = xnn_min_f16(vx_1, xnn_sub_f16(vpi, vx_1));

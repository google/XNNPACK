...
void xnn_f16_f32acc_vcos_ukernel__f16c_poly_3_u8(
    size_t batch,
...
void xnn_f16_f32acc_vcos_ukernel__f16c_poly_3_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 16 * sizeof(xnn_float16); batch -= 16 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 8, vy_res_0);
    xnn_store_f32_f16(output + 1 * 8, vy_res_1);
    output += 16;
  }
...
void xnn_f16_f32acc_vcos_ukernel__f16c_poly_3_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(xnn_float16); batch -= 32 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 8, vy_res_0);
    xnn_store_f32_f16(output + 1 * 8, vy_res_1);
    xnn_store_f32_f16(output + 2 * 8, vy_res_2);
    xnn_store_f32_f16(output + 3 * 8, vy_res_3);
    output += 32;
  }

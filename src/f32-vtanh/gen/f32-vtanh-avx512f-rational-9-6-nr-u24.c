    ...
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 48 * sizeof(float); batch -= 48 * sizeof(float)) {
    ...
    const __m512 vt0_0 = _mm512_rcp14_ps(vq_0);
    const __m512 vt0_1 = _mm512_rcp14_ps(vq_1);
    const __m512 vt0_2 = _mm512_rcp14_ps(vq_2);
    const __m512 vt1_0 = _mm512_mul_ps(vt0_0, _mm512_fnmadd_ps(vt0_0, vq_0, vtwo));
    const __m512 vt1_1 = _mm512_mul_ps(vt0_1, _mm512_fnmadd_ps(vt0_1, vq_1, vtwo));
    const __m512 vt1_2 = _mm512_mul_ps(vt0_2, _mm512_fnmadd_ps(vt0_2, vq_2, vtwo));
    const __m512 vy_0 =  _mm512_mul_ps(vp_0, vt1_0);
    const __m512 vy_1 =  _mm512_mul_ps(vp_1, vt1_1);
    const __m512 vy_2 =  _mm512_mul_ps(vp_2, vt1_2);

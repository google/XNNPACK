    ...
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const __m256 vt1_3 = _mm256_mul_ps(vt0_3, _mm256_fnmadd_ps(vt0_3, vq_3, vtwo));

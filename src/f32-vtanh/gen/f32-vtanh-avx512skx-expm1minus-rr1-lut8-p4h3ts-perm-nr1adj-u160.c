...
void xnn_f32_vtanh_ukernel__avx512skx_expm1minus_rr1_lut8_p4h3ts_perm_nr1adj_u160(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 160 * sizeof(float); batch -= 160 * sizeof(float)) {
    ...
    const __mmask16 vnan_mask6 = _mm512_cmp_ps_mask(vx6, vx6, _CMP_EQ_OQ);
    __m512 vz6 = _mm512_range_ps(vsat_cutoff, vx6, 0xA);
    vz6 = _mm512_mask_blend_ps(vnan_mask6, vx6, vz6);
    const __mmask16 vnan_mask7 = _mm512_cmp_ps_mask(vx7, vx7, _CMP_EQ_OQ);
    __m512 vz7 = _mm512_range_ps(vsat_cutoff, vx7, 0xA);
    vz7 = _mm512_mask_blend_ps(vnan_mask7, vx7, vz7);
    const __mmask16 vnan_mask8 = _mm512_cmp_ps_mask(vx8, vx8, _CMP_EQ_OQ);
    __m512 vz8 = _mm512_range_ps(vsat_cutoff, vx8, 0xA);
    vz8 = _mm512_mask_blend_ps(vnan_mask8, vx8, vz8);
    const __mmask16 vnan_mask9 = _mm512_cmp_ps_mask(vx9, vx9, _CMP_EQ_OQ);
    __m512 vz9 = _mm512_range_ps(vsat_cutoff, vx9, 0xA);
    vz9 = _mm512_mask_blend_ps(vnan_mask9, vx9, vz9);

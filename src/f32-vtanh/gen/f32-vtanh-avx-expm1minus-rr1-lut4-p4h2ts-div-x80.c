...
void xnn_f32_vtanh_ukernel__avx_expm1minus_rr1_lut4_p4h2ts_perm_div_x80(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 80 * sizeof(float); batch -= 80 * sizeof(float)) {
    ...
    __m256 vp6 = _mm256_add_ps(_mm256_mul_ps(vc4, vt6), vc3);
    __m256 vp7 = _mm256_add_ps(_mm256_mul_ps(vc4, vt7), vc3);
    __m256 vp8 = _mm256_add_ps(_mm256_mul_ps(vc4, vt8), vc3);
    __m256 vp9 = _mm256_add_ps(_mm256_mul_ps(vc4, vt9), vc3);
    ...
    vp4 = _mm256_add_ps(_mm256_mul_ps(vp4, vts4), vts4);
    vp5 = _mm256_add_ps(_mm256_mul_ps(vp5, vts5), vts5);
    vp6 = _mm256_add_ps(_mm256_mul_ps(vp6, vts6), vts6);
    vp7 = _mm256_add_ps(_mm256_mul_ps(vp7, vts7), vts7);
    vp8 = _mm256_add_ps(_mm256_mul_ps(vp8, vts8), vts8);
    vp9 = _mm256_add_ps(_mm256_mul_ps(vp9, vts9), vts9);
    ...
    const __m256 vemo4 = _mm256_add_ps(_mm256_mul_ps(vp4, vtwo), vsmo4);
    const __m256 vemo5 = _mm256_add_ps(_mm256_mul_ps(vp5, vtwo), vsmo5);
    const __m256 vemo6 = _mm256_add_ps(_mm256_mul_ps(vp6, vtwo), vsmo6);
    const __m256 vemo7 = _mm256_add_ps(_mm256_mul_ps(vp7, vtwo), vsmo7);
    const __m256 vemo8 = _mm256_add_ps(_mm256_mul_ps(vp8, vtwo), vsmo8);
    const __m256 vemo9 = _mm256_add_ps(_mm256_mul_ps(vp9, vtwo), vsmo9);

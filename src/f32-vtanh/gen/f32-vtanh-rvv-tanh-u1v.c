...
{ 
    ...
    #endif
    #if 1 == 2
    vbool16_t mask = __riscv_vmsltu_vx_u32m1_b16(ix, 0x3c000000, vl);
    #endif
    #if 1 == 4
    vbool8_t  mask = __riscv_vmsltu_vx_u32m1_b8(ix, 0x3c000000, vl);
    #endif
    ...
    #endif
    #if 1 == 2
    mask = __riscv_vmsgtu_vx_u32m1_b16(ix, 0x41102cb3, vl);
    #endif
    #if 1 == 4
    mask = __riscv_vmsgtu_vx_u32m1_b8(ix, 0x41102cb3, vl);
    #endif
    ...
    vfloat32m1_t p0H = __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 0, index, vl);
    vfloat32m1_t p0L = __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 1, index, vl);
    vfloat32m1_t p1 =  __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 2, index, vl);
    vfloat32m1_t p2 =  __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 3, index, vl);
    vfloat32m1_t p3 =  __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 4, index, vl);
    vfloat32m1_t p4 =  __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 5, index, vl);
    vfloat32m1_t p5 =  __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 6, index, vl);
    vfloat32m1_t x_m = __riscv_vloxei32_v_f32m1((float*)RVVMF_tanhsp_LOOK_UP_TABLE + 7, index, vl);
...
void xnn_f32_vtanh_ukernel__rvv_tanh_u1v(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* params)
{
  ...
  do {
    ...
    input += n;
    vfloat32m1_t vacc = __riscv_vtanh_f32m1(vx, n);

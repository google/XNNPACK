...
void xnn_f32_vtanh_ukernel__avx_expm1minus_rr1_lut8_p4h3_div_x24(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 24 * sizeof(float); batch -= 24 * sizeof(float)) {
    ...
    __m256 vnGHIJKLMN = _mm256_add_ps(_mm256_mul_ps(vzGHIJKLMN, vlog2e), vmagic_bias);
    ...
    const __m256 vtGHIJKLMN = _mm256_add_ps(_mm256_mul_ps(vnGHIJKLMN, vminus_ln2), vzGHIJKLMN);
    ...
    __m256 vpGHIJKLMN = _mm256_add_ps(_mm256_mul_ps(vc4, vtGHIJKLMN), vc3);
    ...
    vpGHIJKLMN = _mm256_add_ps(_mm256_mul_ps(vpGHIJKLMN, vtGHIJKLMN), vc2);
    ...
    vpGHIJKLMN = _mm256_add_ps(_mm256_mul_ps(vpGHIJKLMN, vtGHIJKLMN), vtwo);
    ...
    const __m256 vemoGHIJKLMN = _mm256_add_ps(_mm256_mul_ps(vpGHIJKLMN, vtsGHIJKLMN), vsmoGHIJKLMN);

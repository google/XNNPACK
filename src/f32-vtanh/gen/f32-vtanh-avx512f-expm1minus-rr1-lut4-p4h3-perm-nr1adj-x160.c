...
void xnn_f32_vtanh_ukernel__avx512f_expm1minus_rr1_lut4_p4h3_perm_nr1adj_x160(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 160 * sizeof(float); batch -= 160 * sizeof(float)) {
    ...
    __m512 vz6 = _mm512_castsi512_ps(_mm512_andnot_epi32(vsign_mask, _mm512_castps_si512(vx6)));
    __m512 vz7 = _mm512_castsi512_ps(_mm512_andnot_epi32(vsign_mask, _mm512_castps_si512(vx7)));
    __m512 vz8 = _mm512_castsi512_ps(_mm512_andnot_epi32(vsign_mask, _mm512_castps_si512(vx8)));
    __m512 vz9 = _mm512_castsi512_ps(_mm512_andnot_epi32(vsign_mask, _mm512_castps_si512(vx9)));
    ...
    vz6 = _mm512_min_ps(vsat_cutoff, vz6);
    vz7 = _mm512_min_ps(vsat_cutoff, vz7);
    vz8 = _mm512_min_ps(vsat_cutoff, vz8);
    vz9 = _mm512_min_ps(vsat_cutoff, vz9);

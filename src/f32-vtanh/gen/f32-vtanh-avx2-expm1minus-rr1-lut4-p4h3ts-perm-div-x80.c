...
void xnn_f32_vtanh_ukernel__avx2_expm1minus_rr1_lut4_p4h3ts_perm_div_x80(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 80 * sizeof(float); batch -= 80 * sizeof(float)) {
    ...
    const __m256i ve8 = _mm256_slli_epi32(_mm256_castps_si256(vn8), 21);
    const __m256i ve9 = _mm256_slli_epi32(_mm256_castps_si256(vn9), 21);

...
void xnn_f32_vtanh_ukernel__neonfma_expm1minus_rr1_lut8_p4h3_nr1recps1fma_x16(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 16 * sizeof(float); batch -= 16 * sizeof(float)) {
    ...
    uint32x2_t vl_lo0123 = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidx01]);
    const uint64_t vidx23 = vgetq_lane_u64(vidx0123, 1);
    uint32x2_t vl_lo4567 = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidx45]);
    const uint64_t vidx67 = vgetq_lane_u64(vidx4567, 1);
    uint32x2_t vl_lo89AB = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidx89]);
    const uint64_t vidxAB = vgetq_lane_u64(vidx89AB, 1);
    uint32x2_t vl_loCDEF = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidxCD]);
    const uint64_t vidxEF = vgetq_lane_u64(vidxCDEF, 1);
    uint32x2_t vl_hi0123 = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidx23]);
    uint32x2_t vl_hi4567 = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidx67]);
    uint32x2_t vl_hi89AB = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidxAB]);
    uint32x2_t vl_hiCDEF = vld1_dup_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) vidxEF]);
    vl_lo0123 = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidx01 >> 32)], vl_lo0123, 1);
    vl_hi0123 = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidx23 >> 32)], vl_hi0123, 1);
    vl_lo4567 = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidx45 >> 32)], vl_lo4567, 1);
    vl_hi4567 = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidx67 >> 32)], vl_hi4567, 1);
    vl_lo89AB = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidx89 >> 32)], vl_lo89AB, 1);
    vl_hi89AB = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidxAB >> 32)], vl_hi89AB, 1);
    vl_loCDEF = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidxCD >> 32)], vl_loCDEF, 1);
    vl_hiCDEF = vld1_lane_u32(&xnn_table_exp2minus_k_over_8[(uint32_t) (vidxEF >> 32)], vl_hiCDEF, 1);
    const uint32x4_t vl0123 = vcombine_u32(vl_lo0123, vl_hi0123);
    const uint32x4_t vl4567 = vcombine_u32(vl_lo4567, vl_hi4567);
    const uint32x4_t vl89AB = vcombine_u32(vl_lo89AB, vl_hi89AB);
    const uint32x4_t vlCDEF = vcombine_u32(vl_loCDEF, vl_hiCDEF);

...
void xnn_f32_vtanh_ukernel__sse2_rational_9_8_nr_u4(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vtanh_ukernel__sse2_rational_9_8_nr_u8(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vtanh_ukernel__sse2_rational_9_8_nr_u12(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vtanh_ukernel__sse2_rational_9_8_nr_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])

    ...
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const __m512 vt0_3 = _mm512_rcp14_ps(vq_3);
    ...
    const __m512 vt1_3 = _mm512_mul_ps(vt0_3, _mm512_fnmadd_ps(vt0_3, vq_3, vtwo));
    ...
    const __m512 vy_3 =  _mm512_mul_ps(vp_3, vt1_3);

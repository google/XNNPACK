...
//   Template: src/f32-vtanh/fma3-rational-9-6.c.in
    ...
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  const __m256 vtwo = _mm256_set1_ps(params->fma3_rational_9_6.two);
  ...
  for (; batch >= 24 * sizeof(float); batch -= 24 * sizeof(float)) {
    ...
    __m256 vq_2 = _mm256_fmadd_ps(vx2_2, vbeta_6, vbeta_4);
    vq_0 = _mm256_fmadd_ps(vx2_0, vq_0, vbeta_2);
    vq_1 = _mm256_fmadd_ps(vx2_1, vq_1, vbeta_2);
    vq_2 = _mm256_fmadd_ps(vx2_2, vq_2, vbeta_2);
    vq_0 = _mm256_fmadd_ps(vx2_0, vq_0, vbeta_0);
    vq_1 = _mm256_fmadd_ps(vx2_1, vq_1, vbeta_0);
    vq_2 = _mm256_fmadd_ps(vx2_2, vq_2, vbeta_0);

    // Divide the numerator by the denominator.
    const __m256 vt0_0 = _mm256_rcp_ps(vq_0);
    const __m256 vt0_1 = _mm256_rcp_ps(vq_1);
    const __m256 vt0_2 = _mm256_rcp_ps(vq_2);
    const __m256 vt1_0 = _mm256_mul_ps(vt0_0, _mm256_fnmadd_ps(vt0_0, vq_0, vtwo));
    const __m256 vt1_1 = _mm256_mul_ps(vt0_1, _mm256_fnmadd_ps(vt0_1, vq_1, vtwo));
    const __m256 vt1_2 = _mm256_mul_ps(vt0_2, _mm256_fnmadd_ps(vt0_2, vq_2, vtwo));
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    const __m256 vt1 = _mm256_mul_ps(vt0, _mm256_fnmadd_ps(vt0, vq, vtwo));

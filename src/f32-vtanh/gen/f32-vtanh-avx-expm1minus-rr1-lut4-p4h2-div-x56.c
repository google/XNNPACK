...
void xnn_f32_vtanh_ukernel__avx_expm1minus_rr1_lut4_p4h2_perm_div_x56(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m256 vindex_mask = _mm256_load_ps((const float*) params->avx_expm1minus_rr1_lut4_p4h2_perm.index_mask);
  const __m256 vtable = _mm256_load_ps(params->avx_expm1minus_rr1_lut4_p4h2_perm.table);

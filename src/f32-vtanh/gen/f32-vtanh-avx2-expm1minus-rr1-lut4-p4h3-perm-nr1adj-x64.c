...
void xnn_f32_vtanh_ukernel__avx2_expm1minus_rr1_lut4_p4h3_perm_nr1adj_x64(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m256 vsign_mask = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.sign_mask);
  const __m256 vsat_cutoff = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.sat_cutoff);
  const __m256 vlog2e = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.log2e);
  const __m256 vmagic_bias = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.magic_bias);
  const __m256 vtable = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.table);
  const __m256 vminus_ln2 = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.minus_ln2);
  const __m256 vc4 = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.c4);
  const __m256 vc3 = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.c3);
  const __m256 vc2 = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.c2);
  const __m256 vtwo = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.two);
  const __m256 vminus_one = _mm256_load_ps(params->avx2_expm1minus_rr1_lut4_p4h3_perm.minus_one);
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const __m256i ve4 = _mm256_slli_epi32(_mm256_castps_si256(vn4), 21);
    const __m256i ve5 = _mm256_slli_epi32(_mm256_castps_si256(vn5), 21);
    const __m256i ve6 = _mm256_slli_epi32(_mm256_castps_si256(vn6), 21);
    const __m256i ve7 = _mm256_slli_epi32(_mm256_castps_si256(vn7), 21);
  ...
  if XNN_UNLIKELY(batch != 0) {
    ...
    const __m256i vmask = _mm256_loadu_si256((const __m256i*) ((uintptr_t) &params->avx2_expm1minus_rr1_lut4_p4h3_perm.mask_table[7] - batch));

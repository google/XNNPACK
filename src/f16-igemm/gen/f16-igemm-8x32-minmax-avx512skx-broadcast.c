...
void xnn_f16_igemm_minmax_ukernel_8x32__avx512skx_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        a6 += 1;
        const __m512 va7 = _mm512_cvtph_ps(_mm256_set1_epi16((short) *a7));
        a7 += 1;
        ...
        vacc4x1 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va4, vb1, vacc4x1), _MM_FROUND_TO_NEAREST_INT));
        vacc5x0 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va5, vb0, vacc5x0), _MM_FROUND_TO_NEAREST_INT));
        vacc5x1 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va5, vb1, vacc5x1), _MM_FROUND_TO_NEAREST_INT));
        vacc6x0 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va6, vb0, vacc6x0), _MM_FROUND_TO_NEAREST_INT));
        vacc6x1 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va6, vb1, vacc6x1), _MM_FROUND_TO_NEAREST_INT));
        vacc7x0 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va7, vb0, vacc7x0), _MM_FROUND_TO_NEAREST_INT));
        vacc7x1 = _mm512_cvtph_ps(_mm512_cvtps_ph(_mm512_fmadd_ps(va7, vb1, vacc7x1), _MM_FROUND_TO_NEAREST_INT));
    ...
    vacc7x0 = _mm512_max_ps(vacc7x0, vmin);
    ...
    vacc4x1 = _mm512_max_ps(vacc4x1, vmin);
    vacc5x1 = _mm512_max_ps(vacc5x1, vmin);
    vacc6x1 = _mm512_max_ps(vacc6x1, vmin);
    vacc7x1 = _mm512_max_ps(vacc7x1, vmin);
    ...
    vacc7x0 = _mm512_min_ps(vacc7x0, vmax);
    ...
    vacc4x1 = _mm512_min_ps(vacc4x1, vmax);
    vacc5x1 = _mm512_min_ps(vacc5x1, vmax);
    vacc6x1 = _mm512_min_ps(vacc6x1, vmax);
    vacc7x1 = _mm512_min_ps(vacc7x1, vmax);

    if XNN_LIKELY(nc >= 32) {
      _mm256_storeu_si256((__m256i*) c7, _mm512_cvtps_ph(vacc7x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_storeu_si256((__m256i*) (c7 + 16), _mm512_cvtps_ph(vacc7x1, _MM_FROUND_TO_NEAREST_INT));
      c7 = (uint16_t*) ((uintptr_t) c7 + cn_stride);
      _mm256_storeu_si256((__m256i*) c6, _mm512_cvtps_ph(vacc6x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_storeu_si256((__m256i*) (c6 + 16), _mm512_cvtps_ph(vacc6x1, _MM_FROUND_TO_NEAREST_INT));
      c6 = (uint16_t*) ((uintptr_t) c6 + cn_stride);
      _mm256_storeu_si256((__m256i*) c5, _mm512_cvtps_ph(vacc5x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_storeu_si256((__m256i*) (c5 + 16), _mm512_cvtps_ph(vacc5x1, _MM_FROUND_TO_NEAREST_INT));
      c5 = (uint16_t*) ((uintptr_t) c5 + cn_stride);
      _mm256_storeu_si256((__m256i*) c4, _mm512_cvtps_ph(vacc4x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_storeu_si256((__m256i*) (c4 + 16), _mm512_cvtps_ph(vacc4x1, _MM_FROUND_TO_NEAREST_INT));
      ...
      _mm256_mask_storeu_epi16(c7 + 0, vmask0, _mm512_cvtps_ph(vacc7x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c7 + 16, vmask1, _mm512_cvtps_ph(vacc7x1, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c6 + 0, vmask0, _mm512_cvtps_ph(vacc6x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c6 + 16, vmask1, _mm512_cvtps_ph(vacc6x1, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c5 + 0, vmask0, _mm512_cvtps_ph(vacc5x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c5 + 16, vmask1, _mm512_cvtps_ph(vacc5x1, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c4 + 0, vmask0, _mm512_cvtps_ph(vacc4x0, _MM_FROUND_TO_NEAREST_INT));
      _mm256_mask_storeu_epi16(c4 + 16, vmask1, _mm512_cvtps_ph(vacc4x1, _MM_FROUND_TO_NEAREST_INT));

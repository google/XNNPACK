...
void xnn_f32_dwconv_minmax_ukernel_9p64c__hvx_acc2(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; c >= 64; c -= 64) {
      ...
      xnn_simd_f32_t vacc32p0 = Q6_Vqf32_vadd_Vqf32Vsf(Q6_V_vzero(), xnn_load_f32(w + 32));
      ...
      vacc32p0 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi0x32, vk0x32), vacc32p0);
      ...
      xnn_simd_f32_t vacc0p1 = Q6_Vqf32_vmpy_VsfVsf(vi1x0, vk1x0);
      xnn_simd_f32_t vacc32p1 = Q6_Vqf32_vmpy_VsfVsf(vi1x32, vk1x32);
      ...
      vacc32p0 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi2x32, vk2x32), vacc32p0);
      ...
      vacc0p1 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi3x0, vk3x0), vacc0p1);
      vacc32p1 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi3x32, vk3x32), vacc32p1);
      ...
      vacc32p0 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi4x32, vk4x32), vacc32p0);
      ...
      vacc0p1 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi5x0, vk5x0), vacc0p1);
      vacc32p1 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi5x32, vk5x32), vacc32p1);
      ...
      vacc32p0 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi6x32, vk6x32), vacc32p0);
      ...
      vacc0p1 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi7x0, vk7x0), vacc0p1);
      vacc32p1 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi7x32, vk7x32), vacc32p1);
      ...
      vacc32p0 = Q6_Vqf32_vadd_Vqf32Vqf32(Q6_Vqf32_vmpy_VsfVsf(vi8x32, vk8x32), vacc32p0);

      w += 640;

      // Add up all accumulators to vacc0p0
      vacc0p0 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc0p0, vacc0p1);
      vacc32p0 = Q6_Vqf32_vadd_Vqf32Vqf32(vacc32p0, vacc32p1);

      xnn_simd_f32_t vacc0 = xnn_max_f32(vmin, Q6_Vsf_equals_Vqf32(vacc0p0));
      xnn_simd_f32_t vacc32 = xnn_max_f32(vmin, Q6_Vsf_equals_Vqf32(vacc32p0));
    ...
    for (; c >= 32; c -= 32) {
      xnn_simd_f32_t vacc0p0 = Q6_Vqf32_vadd_Vqf32Vsf(Q6_V_vzero(), xnn_load_f32(w));

...
//   Template: src/f32-dwconv/unipass-hvx.c.in
...
void xnn_f32_dwconv_minmax_ukernel_25p32c__hvx(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; c >= 32; c -= 32) {
      xnn_simd_f32_t vacc0p0 = Q6_Vqf32_vadd_Vqf32Vsf(Q6_V_vzero(), xnn_load_f32(w + 0));
    ...
    if XNN_UNLIKELY(c != 0) {
      ...
      xnn_simd_f32_t vacc0p0 = Q6_Vqf32_vadd_Vqf32Vsf(Q6_V_vzero(), xnn_load_tail_f32(w, c));

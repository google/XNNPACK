...
void xnn_f32_dwconv_minmax_ukernel_25p8c__wasmrelaxedsimd_acc2(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 8; c -= 8) {
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi9x4567, vk9x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi11x4567, vk11x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi13x4567, vk13x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi15x4567, vk15x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi17x4567, vk17x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi19x4567, vk19x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi21x4567, vk21x4567), vacc4567p1);
      ...
      vacc4567p1 = wasm_f32x4_add(wasm_f32x4_mul(vi23x4567, vk23x4567), vacc4567p1);

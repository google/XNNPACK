  ...
  do {
    ...
    // First pass to process 7 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        vaccGHIJKLMNp0 = _mm256_fmadd_ps(vi3xGHIJKLMN, vk3xGHIJKLMN, vaccGHIJKLMNp0);
        vaccOPQRSTUVp0 = _mm256_fmadd_ps(vi3xOPQRSTUV, vk3xOPQRSTUV, vaccOPQRSTUVp0);
        ...
        vaccGHIJKLMNp0 = _mm256_fmadd_ps(vi5xGHIJKLMN, vk5xGHIJKLMN, vaccGHIJKLMNp0);
        vaccOPQRSTUVp0 = _mm256_fmadd_ps(vi5xOPQRSTUV, vk5xOPQRSTUV, vaccOPQRSTUVp0);

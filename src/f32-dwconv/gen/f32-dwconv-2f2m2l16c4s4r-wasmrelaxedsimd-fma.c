...
void xnn_f32_dwconv_ukernel_2f2m2l16c4s4r__wasmrelaxedsimd_fma(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
  ...
  do {
    ...
    // First pass to process 2 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        vacc89ABp0 = __builtin_wasm_fma_f32x4(vacc89ABp0, vi0x89AB, vk0x89AB);
        vaccCDEFp0 = __builtin_wasm_fma_f32x4(vaccCDEFp0, vi0xCDEF, vk0xCDEF);
        ...
        vacc89ABp0 = __builtin_wasm_fma_f32x4(vacc89ABp0, vi1x89AB, vk1x89AB);
        vaccCDEFp0 = __builtin_wasm_fma_f32x4(vaccCDEFp0, vi1xCDEF, vk1xCDEF);
    ...
    // Last pass to process up to 2 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const v128_t vacc89AB = vacc89ABp0;
        const v128_t vaccCDEF = vaccCDEFp0;

...
void xnn_f32_dwconv_minmax_ukernel_25p8c__wasmrelaxedsimd_fma_acc2(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 8; c -= 8) {
      ...
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi3x4567, vk3x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi5x0123, vk5x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi5x4567, vk5x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi7x0123, vk7x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi7x4567, vk7x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi9x0123, vk9x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi9x4567, vk9x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi11x0123, vk11x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi11x4567, vk11x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi13x0123, vk13x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi13x4567, vk13x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi15x0123, vk15x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi15x4567, vk15x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi17x0123, vk17x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi17x4567, vk17x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi19x0123, vk19x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi19x4567, vk19x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi21x0123, vk21x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi21x4567, vk21x4567);
      ...
      vacc0123p1 = __builtin_wasm_relaxed_madd_f32x4(vacc0123p1, vi23x0123, vk23x0123);
      vacc4567p1 = __builtin_wasm_relaxed_madd_f32x4(vacc4567p1, vi23x4567, vk23x4567);

    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 8; c -= 8) {
      ...
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi3x4567, vk3x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi5x0123, vk5x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi5x4567, vk5x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi7x0123, vk7x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi7x4567, vk7x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi9x0123, vk9x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi9x4567, vk9x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi11x0123, vk11x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi11x4567, vk11x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi13x0123, vk13x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi13x4567, vk13x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi15x0123, vk15x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi15x4567, vk15x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi17x0123, vk17x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi17x4567, vk17x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi19x0123, vk19x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi19x4567, vk19x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi21x0123, vk21x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi21x4567, vk21x4567, vacc4567p1);
      ...
      vacc0123p1 = wasm_f32x4_relaxed_madd(vi23x0123, vk23x0123, vacc0123p1);
      vacc4567p1 = wasm_f32x4_relaxed_madd(vi23x4567, vk23x4567, vacc4567p1);

...
void xnn_bf16_f32_igemm_minmax_ukernel_4x16__neonfma_lane_ld64(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      for (; k >= 4 * sizeof(xnn_bfloat16); k -= 4 * sizeof(xnn_bfloat16)) {
        ...
        vacc1x2 = vfmaq_lane_f32(vacc1x2, vb2x0, vget_low_f32(va1), 0);
        vacc1x3 = vfmaq_lane_f32(vacc1x3, vb3x0, vget_low_f32(va1), 0);
        vacc2x0 = vfmaq_lane_f32(vacc2x0, vb0x0, vget_low_f32(va2), 0);
        vacc2x1 = vfmaq_lane_f32(vacc2x1, vb1x0, vget_low_f32(va2), 0);
        vacc2x2 = vfmaq_lane_f32(vacc2x2, vb2x0, vget_low_f32(va2), 0);
        vacc2x3 = vfmaq_lane_f32(vacc2x3, vb3x0, vget_low_f32(va2), 0);
        vacc3x0 = vfmaq_lane_f32(vacc3x0, vb0x0, vget_low_f32(va3), 0);
        vacc3x1 = vfmaq_lane_f32(vacc3x1, vb1x0, vget_low_f32(va3), 0);
        vacc3x2 = vfmaq_lane_f32(vacc3x2, vb2x0, vget_low_f32(va3), 0);
        vacc3x3 = vfmaq_lane_f32(vacc3x3, vb3x0, vget_low_f32(va3), 0);
        ...
        vacc1x2 = vfmaq_lane_f32(vacc1x2, vb2x1, vget_low_f32(va1), 1);
        vacc1x3 = vfmaq_lane_f32(vacc1x3, vb3x1, vget_low_f32(va1), 1);
        vacc2x0 = vfmaq_lane_f32(vacc2x0, vb0x1, vget_low_f32(va2), 1);
        vacc2x1 = vfmaq_lane_f32(vacc2x1, vb1x1, vget_low_f32(va2), 1);
        vacc2x2 = vfmaq_lane_f32(vacc2x2, vb2x1, vget_low_f32(va2), 1);
        vacc2x3 = vfmaq_lane_f32(vacc2x3, vb3x1, vget_low_f32(va2), 1);
        vacc3x0 = vfmaq_lane_f32(vacc3x0, vb0x1, vget_low_f32(va3), 1);
        vacc3x1 = vfmaq_lane_f32(vacc3x1, vb1x1, vget_low_f32(va3), 1);
        vacc3x2 = vfmaq_lane_f32(vacc3x2, vb2x1, vget_low_f32(va3), 1);
        vacc3x3 = vfmaq_lane_f32(vacc3x3, vb3x1, vget_low_f32(va3), 1);
        ...
        vacc1x2 = vfmaq_lane_f32(vacc1x2, vb2x2, vget_high_f32(va1), 0);
        vacc1x3 = vfmaq_lane_f32(vacc1x3, vb3x2, vget_high_f32(va1), 0);
        vacc2x0 = vfmaq_lane_f32(vacc2x0, vb0x2, vget_high_f32(va2), 0);
        vacc2x1 = vfmaq_lane_f32(vacc2x1, vb1x2, vget_high_f32(va2), 0);
        vacc2x2 = vfmaq_lane_f32(vacc2x2, vb2x2, vget_high_f32(va2), 0);
        vacc2x3 = vfmaq_lane_f32(vacc2x3, vb3x2, vget_high_f32(va2), 0);
        vacc3x0 = vfmaq_lane_f32(vacc3x0, vb0x2, vget_high_f32(va3), 0);
        vacc3x1 = vfmaq_lane_f32(vacc3x1, vb1x2, vget_high_f32(va3), 0);
        vacc3x2 = vfmaq_lane_f32(vacc3x2, vb2x2, vget_high_f32(va3), 0);
        vacc3x3 = vfmaq_lane_f32(vacc3x3, vb3x2, vget_high_f32(va3), 0);
        ...
        vacc1x2 = vfmaq_lane_f32(vacc1x2, vb2x3, vget_high_f32(va1), 1);
        vacc1x3 = vfmaq_lane_f32(vacc1x3, vb3x3, vget_high_f32(va1), 1);
        vacc2x0 = vfmaq_lane_f32(vacc2x0, vb0x3, vget_high_f32(va2), 1);
        vacc2x1 = vfmaq_lane_f32(vacc2x1, vb1x3, vget_high_f32(va2), 1);
        vacc2x2 = vfmaq_lane_f32(vacc2x2, vb2x3, vget_high_f32(va2), 1);
        vacc2x3 = vfmaq_lane_f32(vacc2x3, vb3x3, vget_high_f32(va2), 1);
        vacc3x0 = vfmaq_lane_f32(vacc3x0, vb0x3, vget_high_f32(va3), 1);
        vacc3x1 = vfmaq_lane_f32(vacc3x1, vb1x3, vget_high_f32(va3), 1);
        vacc3x2 = vfmaq_lane_f32(vacc3x2, vb2x3, vget_high_f32(va3), 1);
        vacc3x3 = vfmaq_lane_f32(vacc3x3, vb3x3, vget_high_f32(va3), 1);
        wk += 64;
      }
      for (; k != 0; k -= sizeof(xnn_bfloat16)) {
        ...
        vacc1x2 = vfmaq_f32(vacc1x2, va1, vb2);
        vacc1x3 = vfmaq_f32(vacc1x3, va1, vb3);
        vacc2x0 = vfmaq_f32(vacc2x0, va2, vb0);
        vacc2x1 = vfmaq_f32(vacc2x1, va2, vb1);
        vacc2x2 = vfmaq_f32(vacc2x2, va2, vb2);
        vacc2x3 = vfmaq_f32(vacc2x3, va2, vb3);
        vacc3x0 = vfmaq_f32(vacc3x0, va3, vb0);
        vacc3x1 = vfmaq_f32(vacc3x1, va3, vb1);
        vacc3x2 = vfmaq_f32(vacc3x2, va3, vb2);
        vacc3x3 = vfmaq_f32(vacc3x3, va3, vb3);
      }
      p -= 4 * sizeof(void*);
    } while (p != 0);
    w = (const void*) wk;

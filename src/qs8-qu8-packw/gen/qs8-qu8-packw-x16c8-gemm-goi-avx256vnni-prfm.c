...
void xnn_qs8_to_qu8_packw_gemm_goi_ukernel_x16c8__avx256vnni_prfm(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  const void* params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (;n >= 16; n -= 16) {
      ...
      size_t k = kc;
      for (; k >= 16; k -= 16) {
        const __m128i v0_01 = _mm_loadu_si128((const __m128i*) w0);
        const __m128i v1_01 = _mm_loadu_si128((const __m128i*) w1);
        const __m128i v2_01 = _mm_loadu_si128((const __m128i*) w2);
        const __m128i v3_01 = _mm_loadu_si128((const __m128i*) w3);
        const __m128i v4_01 = _mm_loadu_si128((const __m128i*) w4);
        const __m128i v5_01 = _mm_loadu_si128((const __m128i*) w5);
        const __m128i v6_01 = _mm_loadu_si128((const __m128i*) w6);
        const __m128i v7_01 = _mm_loadu_si128((const __m128i*) w7);
        const __m128i v8_01 = _mm_loadu_si128((const __m128i*) w8);
        const __m128i v9_01 = _mm_loadu_si128((const __m128i*) w9);
        const __m128i v10_01 = _mm_loadu_si128((const __m128i*) w10);
        const __m128i v11_01 = _mm_loadu_si128((const __m128i*) w11);
        const __m128i v12_01 = _mm_loadu_si128((const __m128i*) w12);
        const __m128i v13_01 = _mm_loadu_si128((const __m128i*) w13);
        const __m128i v14_01 = _mm_loadu_si128((const __m128i*) w14);
        const __m128i v15_01 = _mm_loadu_si128((const __m128i*) w15);

        const __m256i v0_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v0_01), v1_01, 1);
        const __m256i v2_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v2_01), v3_01, 1);
        const __m256i v4_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v4_01), v5_01, 1);
        const __m256i v6_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v6_01), v7_01, 1);
        const __m256i v8_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v8_01), v9_01, 1);
        const __m256i v10_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v10_01), v11_01, 1);
        const __m256i v12_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v12_01), v13_01, 1);
        const __m256i v14_0123 = _mm256_insertf128_si256(_mm256_castsi128_si256(v14_01), v15_01, 1);

        const __m256i v0_0 = _mm256_unpacklo_epi64(v0_0123, v2_0123);
        const __m256i v0_1 = _mm256_unpackhi_epi64(v0_0123, v2_0123);
        const __m256i v4_0 = _mm256_unpacklo_epi64(v4_0123, v6_0123);
        const __m256i v4_1 = _mm256_unpackhi_epi64(v4_0123, v6_0123);
        const __m256i v8_0 = _mm256_unpacklo_epi64(v8_0123, v10_0123);
        const __m256i v8_1 = _mm256_unpackhi_epi64(v8_0123, v10_0123);
        const __m256i v12_0 = _mm256_unpacklo_epi64(v12_0123, v14_0123);
        const __m256i v12_1 = _mm256_unpackhi_epi64(v12_0123, v14_0123);
        ...
        _mm256_storeu_si256((__m256i *)&out[128],  v8_1);
        _mm256_storeu_si256((__m256i *)&out[160],  v12_1);

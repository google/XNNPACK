...
void xnn_f16_vadd_ukernel__rvvfp16arith_u2v(
    size_t batch,
    ...
    const struct xnn_f16_default_params* restrict params)
{
  ...
  do {
    ...
    n -= vl;
    vfloat16m2_t va = __riscv_vle16_v_f16m2((const void *) a, vl);
    a += vl;
    vfloat16m2_t vb = __riscv_vle16_v_f16m2((const void *) b, vl);
    b += vl;
    vfloat16m2_t vacc = __riscv_vfadd_vv_f16m2(va, vb, vl);
    __riscv_vse16_v_f16m2((void *) o, vacc, vl);
    o += vl;
  } while (n > 0);
}

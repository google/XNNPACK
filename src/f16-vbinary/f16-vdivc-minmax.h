...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon_fp16_arith, xnn_f16_vdivc_minmax_ukernel__aarch64_neonfp16arith_u8, 8, false, xnn_float16, union xnn_f16_minmax_params, xnn_init_f16_minmax_scalar_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon_fp16_arith, xnn_f16_vdivc_minmax_ukernel__aarch64_neonfp16arith_u16, 16, false, xnn_float16, union xnn_f16_minmax_params, xnn_init_f16_minmax_scalar_params)
#endif  // XNN_ENABLE_ARM_FP16_VECTOR && (XNN_ARCH_ARM64)

#if XNN_ENABLE_ARM_FP16_SCALAR && (XNN_ARCH_ARM || XNN_ARCH_ARM64)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_fp16_arith, xnn_f16_vdivc_minmax_ukernel__fp16arith_u1, 1, false, xnn_float16, union xnn_f16_minmax_params, xnn_init_f16_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_avx512fp16, xnn_f16_vdivc_minmax_ukernel__avx512fp16_u32, 32, false, xnn_float16, union xnn_f16_minmax_params, xnn_init_f16_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_f16c, xnn_f16_vdivc_minmax_ukernel__f16c_u8, 8, false, xnn_float16, union xnn_f16_minmax_params, xnn_init_f16_minmax_scalar_params)

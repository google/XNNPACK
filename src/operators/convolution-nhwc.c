...
static enum xnn_status create_dwconv_path(
    ...
    xnn_init_extra_data_params_fn init_scale_params,
...
static enum xnn_status create_igemm(
    ...
    xnn_init_extra_data_params_fn init_scale_params,
    const float* scale_params,
    xnn_init_extra_data_params_fn init_kernel_scale_params,
    ...
    xnn_operator_t* convolution_op_out)
{
  ...
  return create_convolution2d_nhwc(
    ...
    (xnn_init_extra_data_params_fn)xnn_init_qs8_qc8w_scale_fp32_params, bias,
    (xnn_init_extra_data_params_fn)xnn_init_qs8_qc8w_scale_fp32_params, kernel_scale,
    ...
    xnn_operator_t* convolution_op_out)
{
  ...
  enum xnn_status status = create_convolution2d_nhwc(
    ...
    /*init_scale_params=*/(xnn_init_extra_data_params_fn)xnn_init_qs8_qc8w_scale_fp32_params,

...
enum xnn_status create_batch_matrix_multiply_nc(
  ...
  if (packing_params != NULL) {
    batch_matrix_multiply_op->params2 = xnn_allocate_zero_memory(
        sizeof(union xnn_params2));
    if (batch_matrix_multiply_op->params2 == NULL) {
      xnn_log_error("failed to allocate %zu bytes for %s operator descriptor",
                    sizeof(union xnn_params2),
                    xnn_operator_type_to_string(operator_type));
      return xnn_status_out_of_memory;
    }
    memcpy(batch_matrix_multiply_op->params2, packing_params,
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_f16(
  ...
  return create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), /*packing_params=*/NULL, gemm_config,
      gemm_ukernels, xnn_operator_type_batch_matrix_multiply_nc_f16,
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_pf16(
  ...
  return create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), /*packing_params=*/NULL, gemm_config,
      gemm_ukernels, xnn_operator_type_batch_matrix_multiply_nc_pf16,
      batch_matrix_multiply_op_out);
}
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_bf16_f32(
  ...
  return create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), /*packing_params=*/NULL, gemm_config,
      gemm_ukernels, xnn_operator_type_batch_matrix_multiply_nc_bf16_f32,
      batch_matrix_multiply_op_out);
}
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_f32(
  ...
  return create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), /*packing_params=*/NULL, gemm_config,
      gemm_ukernels, xnn_operator_type_batch_matrix_multiply_nc_f32,
      batch_matrix_multiply_op_out);
}
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_pf32(
  ...
  return create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), /*packing_params=*/NULL, gemm_config,
      gemm_ukernels, xnn_operator_type_batch_matrix_multiply_nc_pf32,
      batch_matrix_multiply_op_out);
}
...
enum xnn_status create_batch_matrix_multiply_nc_qx8_f32_qc8w(
  ...
  enum xnn_status status = create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), /*packing_params=*/NULL, gemm_config,
      gemm_ukernels, expected_operator_type, batch_matrix_multiply_op_out);
  if (status != xnn_status_success) {
    return status;
  }
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_qs8(
  ...
  return create_batch_matrix_multiply_nc(
      flags, &params, sizeof(params), &packing_params, gemm_config,
      gemm_ukernels, xnn_operator_type_batch_matrix_multiply_nc_qs8,
      batch_matrix_multiply_op_out);
}
...
enum xnn_status xnn_create_batch_matrix_multiply_nc_qs8_const_weights(
  ...
  enum xnn_status status = xnn_create_batch_matrix_multiply_nc_qs8(
      input_zero_point, output_zero_point, output_min, output_max, flags,
      batch_matrix_multiply_op_out);
  if (status != xnn_status_success) {
    return status;
  }
...
static enum xnn_status reshape_batch_matrix_multiply_nc(
    ...
    const void* packing_params, xnn_init_scale_params_fn init_scale_b,
    const float* scale_b, size_t extra_weights_bytes, size_t num_threads) {
...
enum xnn_status xnn_reshape_batch_matrix_multiply_nc_f16(
  ...
  return reshape_batch_matrix_multiply_nc(
      ...
      /*extra_weights_bytes=*/0, pthreadpool_get_threads_count(threadpool));
}
...
enum xnn_status xnn_reshape_batch_matrix_multiply_nc_qs8(
  ...
  return reshape_batch_matrix_multiply_nc(
      ...
      batch_matrix_multiply_op->params2,
      (xnn_init_scale_params_fn) xnn_init_qs8_to_qs8_qc8w_scale_fp32_params,
      scale_b, /*extra_weights_bytes=*/sizeof(float),
...
enum xnn_status xnn_reshape_batch_matrix_multiply_nc_qp8_f32_qc8w(
  ...
  return reshape_batch_matrix_multiply_nc(
      ...
      &batch_matrix_multiply_op->params.f32_minmax,
      sizeof(batch_matrix_multiply_op->params.f32_minmax),
      /*packing_params=*/NULL, /*init_scale_b=*/NULL,
      /*scale_b=*/NULL, /*extra_weights_bytes=*/0,
      pthreadpool_get_threads_count(threadpool));
}

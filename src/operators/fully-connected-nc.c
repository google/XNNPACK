...
static enum xnn_status create_fully_connected_nc(
    ...
    int packed_weights_padding_byte, size_t extra_weights_bytes,
    ...
    if (gemm_config->pack_weights_and_biases) {
      ...
      if (kernel_scale_params != NULL) {
        ...
        init_kernel_scale_params(
            ...
            gemm_config->nr * weights_stride, gemm_config->nr * weights_stride,
            0, kernel_scale_params, weights);
      }
      ...
      if (scale_params != NULL) {
        ...
        init_scale_params(output_channels, gemm_config->nr, gemm_config->nr,
                          gemm_config->nr * weights_stride,
                          gemm_config->nr * weights_stride, 0, scale_params,
                          weights);
      }
    }
...
enum xnn_status xnn_create_fully_connected_nc_f16(
  ...
  return create_fully_connected_nc_f16(
      ...
      gemm_config, xnn_operator_type_fully_connected_nc_f16,
...
enum xnn_status xnn_create_fully_connected_nc_pf16(
  ...
  return create_fully_connected_nc_f16(
      input_channels, output_channels, input_stride, output_stride, kernel,
      bias, output_min, output_max, flags, code_cache, weights_cache,
      gemm_config, xnn_operator_type_fully_connected_nc_pf16,
      fully_connected_op_out);
}
...
enum xnn_status xnn_create_fully_connected_nc_qd8_f16_qc4w(
  ...
  return create_fully_connected_nc_qx8_f16_qc4w(
      ...
      flags, code_cache, weights_cache, gemm_config,
      xnn_operator_type_fully_connected_nc_qd8_f16_qc4w,
      fully_connected_op_out);
}
...
enum xnn_status xnn_create_fully_connected_nc_qdu8_f32_qc8w(
  ...
  return create_fully_connected_nc_qdx8_f32_qc8w(
      ...
      kernel_scale, kernel, bias, output_min, output_max, flags, code_cache,
      weights_cache, gemm_config,
      xnn_operator_type_fully_connected_nc_qdu8_f32_qc8w,
      fully_connected_op_out);
}
...
enum xnn_status xnn_create_fully_connected_nc_bf16_f32(
  ...
  return create_fully_connected_nc_f32(
      input_channels, output_channels, input_stride, output_stride, kernel,
      bias, output_min, output_max, flags, code_cache, weights_cache,
      gemm_config, xnn_operator_type_fully_connected_nc_bf16_f32,
      fully_connected_op_out);
}
...
enum xnn_status xnn_create_fully_connected_nc_f32_qc4w(
    ...
    float output_max, uint32_t flags, xnn_code_cache_t code_cache,
    xnn_weights_cache_t weights_cache, xnn_operator_t* fully_connected_op_out) {
  if (isnan(output_min)) {
    xnn_log_error(
        "failed to create %s operator with NaN output lower bound: lower bound "
...
enum xnn_status xnn_create_fully_connected_nc_qs8_qc8w(
  ...
  return create_fully_connected_nc_qx8_qc8w(
      ...
      code_cache, weights_cache, gemm_config,
      xnn_operator_type_fully_connected_nc_qs8_qc8w, fully_connected_op_out);
}
...
enum xnn_status xnn_create_fully_connected_nc_pqs8_qc8w(
  ...
  return create_fully_connected_nc_qx8_qc8w(
      ...
      output_zero_point, output_scale, output_min, output_max, flags,
      code_cache, weights_cache, gemm_config,
      xnn_operator_type_fully_connected_nc_pqs8_qc8w, fully_connected_op_out);
}
...
static enum xnn_status reshape_fully_connected_nc(
  ...
  struct xnn_hmp_gemm_ukernel* gemm_cases =
      fully_connected_op->ukernel.gemm.gemm_cases;

  if (batch_size == 1 && fully_connected_op->ukernel.gemm.gemm_cases[0]
                                 .function[XNN_UARCH_DEFAULT] != NULL) {
    mr = 1;
  }
  ...
  const bool packed_lhs =
      ...
      (fully_connected_op->type ==
       xnn_operator_type_fully_connected_nc_qp8_f32_qb4w) ||
      (fully_connected_op->type == xnn_operator_type_fully_connected_nc_pf32) ||
      (fully_connected_op->type == xnn_operator_type_fully_connected_nc_pf16) ||
      (fully_connected_op->type ==
  ...
  if (packed_lhs) {
    switch (fully_connected_op->type) {
      ...
      case xnn_operator_type_fully_connected_nc_qp8_f32_qc8w:
        fully_connected_op->context.gemm.gemm.gemm.packed_lh_offset_fn =
      ...
      case xnn_operator_type_fully_connected_nc_pqs8_qc8w:
        fully_connected_op->context.gemm.gemm.gemm.packed_lh_offset_fn =
            xnn_init_x8_pack_lh_config()->offset_fn;
        break;
      default:
        XNN_UNREACHABLE;
    }
  }
  memcpy(&fully_connected_op->context.gemm.gemm.gemm.params, params,
         params_size);
  fully_connected_op->context.gemm.gemm.gemm.fused_params =
      &fully_connected_op->context.gemm.gemm.gemm.params;
...
enum xnn_status xnn_reshape_fully_connected_nc_f16(
  ...
  return reshape_fully_connected_nc(
      ...
      sizeof(fully_connected_op->params.f16_minmax), threadpool);
}
...
enum xnn_status xnn_reshape_fully_connected_nc_f32_qc4w(
  ...
  return reshape_fully_connected_nc(
      ...
      sizeof(fully_connected_op->params.f32_qc4w_minmax), threadpool);
}
...
enum xnn_status xnn_reshape_fully_connected_nc_qs8(
  ...
  return reshape_fully_connected_nc(
      ...
      sizeof(fully_connected_op->params.qs8_qc8w_conv_minmax), threadpool);
}
...
static enum xnn_status setup_fully_connected_nc(
  ...
  fully_connected_op->context.gemm.gemm.gemm.quantization_params =
      quantization_params;
...
enum xnn_status xnn_setup_fully_connected_nc_f16(
  ...
  return setup_fully_connected_nc(fully_connected_op,

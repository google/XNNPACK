...
enum xnn_status xnn_reshape_softmax_nc_qu8(xnn_operator_t softmax_op,
  ...
  softmax_op->context.u8_softmax = (struct u8_softmax_context){
      ...
      .rmax_ukernel =
          (xnn_u8_rmax_ukernel_fn)softmax_op->contiguous_reduce_config->ukernel,
...
enum xnn_status xnn_reshape_softmax_nc_f16(xnn_operator_t softmax_op,
  ...
  return reshape_softmax_nc_floating_point(
      ...
      (xnn_compute_reciprocal_fn)compute_reciprocal_f16, &rmax_init,
      sizeof(rmax_init), &rmax_params, sizeof(rmax_params), &expminus_params,
      sizeof(expminus_params), &mul_params, sizeof(mul_params));
}
...
enum xnn_status xnn_reshape_softmax_nc_f32(xnn_operator_t softmax_op,
  ...
  return reshape_softmax_nc_floating_point(
      ...
      (xnn_compute_reciprocal_fn)compute_reciprocal_f32, &rmax_init,
      sizeof(rmax_init), &rmax_params, sizeof(rmax_params), &expminus_params,
      sizeof(expminus_params), &mul_params, sizeof(mul_params));
}

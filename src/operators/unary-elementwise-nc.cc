...
{
  assert(unary_elementwise_config != nullptr);
  assert(unary_elementwise_config->ukernel != nullptr);
  assert(rminmax_config == nullptr || rminmax_config->ukernel != nullptr);
...
{
  xnn_operator_t unary_elementwise_op = nullptr;
  ...
  if (unary_elementwise_config == nullptr) {
    xnn_log_error(
  ...
  unary_elementwise_op = reinterpret_cast<xnn_operator_t>(xnn_allocate_zero_simd_memory(sizeof(struct xnn_operator)));
  if (unary_elementwise_op == nullptr) {
    xnn_log_error(
    ...
    pthreadpool_t threadpool)
{
  ...
  if ((((input_stride ^ channels) | (output_stride ^ channels)) == 0) || batch_size == 1) {
    ...
    univector_contiguous.log2_xsize = static_cast<uint16_t>(log2_input_size);
    univector_contiguous.log2_ysize = static_cast<uint16_t>(log2_output_size);
    univector_contiguous.ukernel = ukernel;
    unary_elementwise_op->context.univector_contiguous = univector_contiguous;
    if (params_size != 0) {
    ...
    univector_strided.n = channels << log2_input_size;
    univector_strided.x_stride = input_stride << log2_input_size;
    univector_strided.y_stride = output_stride << log2_output_size;
    univector_strided.ukernel = ukernel;
    unary_elementwise_op->context.univector_strided = univector_strided;
    if (params_size != 0) {
    ...
    pthreadpool_t threadpool)
{
  ...
  init_unary_elementwise_nc(
    flags, /*params=*/nullptr, /*params_size=*/0,
    operator_type, unary_elementwise_config, /*rminmax_config=*/nullptr, &unary_elementwise_op);
    ...
    xnn_operator_t* abs_op_out)
{
  ...
  if XNN_LIKELY(f16_abs_config != nullptr && f16_abs_config->init.f16_default != nullptr) {
    f16_abs_config->init.f16_default(&params);
  }

  return create_unary_elementwise_nc(
    flags, f16_abs_config, /*rminmax_config=*/nullptr,
    ...
    xnn_operator_t* abs_op_out)
{
  ...
  if XNN_LIKELY(f32_abs_config != nullptr && f32_abs_config->init.f32_default != nullptr) {
    f32_abs_config->init.f32_default(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_abs_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_rndne_config(), /*rminmax_config=*/nullptr,
    ...
    xnn_operator_t* rounding_op_out)
{
  ...
  if XNN_LIKELY(f32_rndne_config != nullptr && f32_rndne_config->init.f32_rnd != nullptr) {
    f32_rndne_config->init.f32_rnd(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_rndne_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_rndu_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
    ...
    xnn_operator_t* ceiling_op_out)
{
  ...
  struct xnn_f32_rnd_params params;
  if XNN_LIKELY(f32_rndu_config != nullptr && f32_rndu_config->init.f32_rnd != nullptr) {
    f32_rndu_config->init.f32_rnd(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_rndu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* clamp_op_out)
{
  ...
  if XNN_LIKELY(f16_clamp_config != nullptr) {
    assert(f16_clamp_config->init.f16_minmax != nullptr);
    f16_clamp_config->init.f16_minmax(&params, output_min_as_half, output_max_as_half);
  }

  return create_unary_elementwise_nc(
    flags, f16_clamp_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* clamp_op_out)
{
  ...
  if (relu_activation && f32_relu_config != nullptr && f32_relu_config->ukernel != nullptr) {
    unary_elementwise_config = f32_relu_config;
  }

  union xnn_f32_minmax_params params;
  if XNN_LIKELY(f32_clamp_config != nullptr) {
    assert(f32_clamp_config->init.f32_minmax != nullptr);
    f32_clamp_config->init.f32_minmax(&params, output_min, output_max);
  }

  return create_unary_elementwise_nc(
    flags, unary_elementwise_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* clamp_op_out)
{
  ...
  assert(s8_clamp_config != nullptr);

  struct xnn_s8_minmax_params params;
  assert(s8_clamp_config->init.s8_minmax != nullptr);
  s8_clamp_config->init.s8_minmax(&params, output_min, output_max);

  return create_unary_elementwise_nc(
    flags, s8_clamp_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* clamp_op_out)
{
  ...
  assert(u8_clamp_config != nullptr);

  struct xnn_u8_minmax_params params;
  assert(u8_clamp_config->init.u8_minmax != nullptr);
  u8_clamp_config->init.u8_minmax(&params, output_min, output_max);

  return create_unary_elementwise_nc(
    flags, u8_clamp_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  return create_unary_elementwise_nc(
    flags, f16_to_f32_cvt_config, /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  return create_unary_elementwise_nc(
    flags, f32_to_f16_cvt_config, /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  if XNN_LIKELY(f32_to_qs8_cvt_config != nullptr) {
    assert(f32_to_qs8_cvt_config->init.f32_qs8_cvt != nullptr);
    f32_to_qs8_cvt_config->init.f32_qs8_cvt(&params, 1.0f / output_scale, output_zero_point, output_min, output_max);
  }

  return create_unary_elementwise_nc(
    flags, f32_to_qs8_cvt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  struct xnn_f16_default_params params;
  if (f16_rminmax_config->init.f16_default != nullptr) {
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  struct xnn_f32_default_params params;
  if (f32_rminmax_config->init.f32_default != nullptr) {
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  if XNN_LIKELY(f32_to_qu8_cvt_config != nullptr) {
    assert(f32_to_qu8_cvt_config->init.f32_qu8_cvt != nullptr);
    f32_to_qu8_cvt_config->init.f32_qu8_cvt(&params, 1.0f / output_scale, output_zero_point, output_min, output_max);
  }

  return create_unary_elementwise_nc(
    flags, f32_to_qu8_cvt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  if (input_output_scale < (1.0f / (1 << 8)) || input_output_scale > (1 << 7)) {
    xnn_log_error(
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  if XNN_LIKELY(qs8_to_f16_cvt_config != nullptr) {
    assert(qs8_to_f16_cvt_config->init.qs8_f16_cvt != nullptr);
    qs8_to_f16_cvt_config->init.qs8_f16_cvt(&params, fp16_input_scale, input_zero_point);
  }

  return create_unary_elementwise_nc(
    flags, qs8_to_f16_cvt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  if XNN_LIKELY(qs8_to_f32_cvt_config != nullptr) {
    assert(qs8_to_f32_cvt_config->init.qs8_f32_cvt != nullptr);
    qs8_to_f32_cvt_config->init.qs8_f32_cvt(&params, input_scale, input_zero_point);
  }

  return create_unary_elementwise_nc(
    flags, qs8_to_f32_cvt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  const float input_output_scale = input_scale / output_scale;
  if (input_output_scale < (1.0f / (1 << 16)) || input_output_scale > (1 << 8)) {
    xnn_log_error(
  ...
  assert(qs16_to_qs8_cvt_config != nullptr);

  struct xnn_qs16_qs8_cvt_params params;
  assert(qs16_to_qs8_cvt_config->init.qs16_qs8_cvt != nullptr);
  qs16_to_qs8_cvt_config->init.qs16_qs8_cvt(&params, input_output_scale, output_zero_point);

  return create_unary_elementwise_nc(
    flags, qs16_to_qs8_cvt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* convert_op_out)
{
  ...
  if XNN_LIKELY(qu8_to_f32_cvt_config != nullptr) {
    assert(qu8_to_f32_cvt_config->init.qu8_f32_cvt != nullptr);
    qu8_to_f32_cvt_config->init.qu8_f32_cvt(&params, input_scale, input_zero_point);
  }

  return create_unary_elementwise_nc(
    flags, qu8_to_f32_cvt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_xx_copy_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
  ...
  xnn_operator_t* elu_op_out)
{
  ...
  if XNN_LIKELY(f16_elu_config != nullptr) {
    assert(f16_elu_config->init.f16_elu != nullptr);
    f16_elu_config->init.f16_elu(&params,
      /*prescale=*/xnn_float16_from_float(1.0f), alpha_as_half, /*beta=*/xnn_float16_from_float(1.0f));
  }

  return create_unary_elementwise_nc(
    flags, f16_elu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* elu_op_out)
{
  ...
  if XNN_LIKELY(f32_elu_config != nullptr) {
    assert(f32_elu_config->init.f32_elu != nullptr);
    f32_elu_config->init.f32_elu(&params, 1.0f /* prescale */, alpha, 1.0f /* beta */);
  }

  return create_unary_elementwise_nc(
    flags, f32_elu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_rndd_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
    ...
    xnn_operator_t* floor_op_out)
{
  ...
  struct xnn_f32_rnd_params params;
  if XNN_LIKELY(f32_rndd_config != nullptr && f32_rndd_config->init.f32_rnd != nullptr) {
    f32_rndd_config->init.f32_rnd(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_rndd_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
enum xnn_status xnn_create_gelu_nc_f32(uint32_t flags,
  ...
  struct xnn_f32_default_params params;
  if XNN_LIKELY (f32_gelu_config != nullptr) {
    if (f32_gelu_config->init.f32_default != nullptr) {
      f32_gelu_config->init.f32_default(&params);
    }
  }

  return create_unary_elementwise_nc(
      flags, f32_gelu_config, /*rminmax_config=*/nullptr, &params, sizeof(params),
    ...
    xnn_operator_t* hardswish_op_out)
{
  ...
  if XNN_LIKELY(f16_hswish_config != nullptr && f16_hswish_config->init.f16_hswish != nullptr) {
    f16_hswish_config->init.f16_hswish(&params);
  }

  return create_unary_elementwise_nc(
    flags, f16_hswish_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* hardswish_op_out)
{
  ...
  if XNN_LIKELY(f32_hswish_config != nullptr && f32_hswish_config->init.f32_hswish != nullptr) {
    f32_hswish_config->init.f32_hswish(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_hswish_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* leaky_relu_op_out)
{
  ...
  if XNN_LIKELY(f16_lrelu_config != nullptr) {
    assert(f16_lrelu_config->init.f16_lrelu != nullptr);
    f16_lrelu_config->init.f16_lrelu(&params, negative_slope_as_half);
  }

  return create_unary_elementwise_nc(
    flags, f16_lrelu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* leaky_relu_op_out)
{
  ...
  if XNN_LIKELY(f32_lrelu_config != nullptr) {
    assert(f32_lrelu_config->init.f32_lrelu != nullptr);
    f32_lrelu_config->init.f32_lrelu(&params, negative_slope);
  }

  return create_unary_elementwise_nc(
    flags, f32_lrelu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* log_op_out)
{
  ...
  struct xnn_f32_default_params params;
  if XNN_LIKELY(f32_log_config != nullptr) {
    if (f32_log_config->init.f32_default != nullptr) {
      f32_log_config->init.f32_default(&params);
    }
  }

  return create_unary_elementwise_nc(
    flags, f32_log_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* leaky_relu_op_out)
{
  ...
  if (positive_input_output_scale < (1.0f / (1 << 8)) || positive_input_output_scale > (1 << 7)) {
    xnn_log_error(
  ...
  if (negative_input_output_scale <= -(1 << 7) || negative_input_output_scale > (1 << 7)) {
    xnn_log_error(
  ...
  if (fabsf(negative_input_output_scale) < (1.0f / (1 << 8))) {
    xnn_log_error(
  ...
  assert(qs8_lrelu_config != nullptr);

  struct xnn_qs8_lrelu_params params;
  assert(qs8_lrelu_config->init.qs8_lrelu != nullptr);
  ...
  return create_unary_elementwise_nc(
    flags, qs8_lrelu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  xnn_operator_t* leaky_relu_op_out)
{
  ...
  assert(qu8_lrelu_config != nullptr);

  struct xnn_qu8_lrelu_params params;
  assert(qu8_lrelu_config->init.qu8_lrelu != nullptr);
  ...
  return create_unary_elementwise_nc(
    flags, qu8_lrelu_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* negate_op_out)
{
  ...
  struct xnn_f16_default_params params;
  if XNN_LIKELY(f16_neg_config != nullptr && f16_neg_config->init.f16_default != nullptr) {
    f16_neg_config->init.f16_default(&params);
  }

  return create_unary_elementwise_nc(
    flags, f16_neg_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* negate_op_out)
{
  ...
  struct xnn_f32_default_params params;
  if XNN_LIKELY(f32_neg_config != nullptr && f32_neg_config->init.f32_default != nullptr) {
    f32_neg_config->init.f32_default(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_neg_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* sigmoid_op_out)
{
  ...
  if XNN_LIKELY(f16_sigmoid_config != nullptr && f16_sigmoid_config->init.f16_sigmoid != nullptr) {
    f16_sigmoid_config->init.f16_sigmoid(&params);
  }

  return create_unary_elementwise_nc(
    flags, f16_sigmoid_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* sigmoid_op_out)
{
  ...
  if XNN_LIKELY(f32_sigmoid_config != nullptr && f32_sigmoid_config->init.f32_sigmoid != nullptr) {
    f32_sigmoid_config->init.f32_sigmoid(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_sigmoid_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_sqr_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
    ...
    xnn_operator_t* square_op_out)
{
  ...
  struct xnn_f32_default_params params;
  if XNN_LIKELY(f32_sqr_config != nullptr && f32_sqr_config->init.f32_default != nullptr) {
    f32_sqr_config->init.f32_default(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_sqr_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_sqrt_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
    ...
    xnn_operator_t* sqrt_op_out)
{
  ...
  if XNN_LIKELY(f32_sqrt_config != nullptr && f32_sqrt_config->init.f32_sqrt != nullptr) {
    f32_sqrt_config->init.f32_sqrt(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_sqrt_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_rsqrt_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
...
enum xnn_status xnn_create_reciprocal_square_root_nc_f32(
  ...
  if XNN_LIKELY (f32_rsqrt_config != nullptr &&
                 f32_rsqrt_config->init.f32_rsqrt != nullptr) {
    f32_rsqrt_config->init.f32_rsqrt(&params);
  }

  return create_unary_elementwise_nc(
      flags, f32_rsqrt_config, /*rminmax_config=*/nullptr, &params, sizeof(params),
    ...
    xnn_operator_t* tanh_op_out)
{
  ...
  if XNN_LIKELY(f16_tanh_config != nullptr && f16_tanh_config->init.f16_tanh != nullptr) {
    f16_tanh_config->init.f16_tanh(&params);
  }

  return create_unary_elementwise_nc(
    flags, f16_tanh_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    xnn_operator_t* tanh_op_out)
{
  ...
  if XNN_LIKELY(f32_tanh_config != nullptr && f32_tanh_config->init.f32_tanh != nullptr) {
    f32_tanh_config->init.f32_tanh(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_tanh_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
...
{
  return create_unary_elementwise_nc(
    flags, xnn_init_f16_rndz_config(), /*rminmax_config=*/nullptr,
    /*params=*/nullptr, /*params_size=*/0,
    ...
    xnn_operator_t* truncation_op_out)
{
  ...
  struct xnn_f32_rnd_params params;
  if XNN_LIKELY(f32_rndz_config != nullptr && f32_rndz_config->init.f32_rnd != nullptr) {
    f32_rndz_config->init.f32_rnd(&params);
  }

  return create_unary_elementwise_nc(
    flags, f32_rndz_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
    ...
    pthreadpool_t threadpool)
{
  ...
  f16_qd8_convert.n = channels * sizeof(uint16_t);
  f16_qd8_convert.x_stride = input_stride * sizeof(uint16_t);
  f16_qd8_convert.y_stride = output_stride;
  f16_qd8_convert.batch_size = batch_size;
  f16_qd8_convert.rminmax_ukernel = convert_op->rminmax_config->ukernel;
  f16_qd8_convert.convert_ukernel = convert_op->unary_elementwise_config->ukernel;
  f16_qd8_convert.init_params = convert_op->unary_elementwise_config->init.f16_qs8_cvt;
  convert_op->context.f16_qd8_convert = f16_qd8_convert;
    ...
    pthreadpool_t threadpool)
{
  ...
  f32_qd8_convert.n = channels * sizeof(float);
  f32_qd8_convert.x_stride = input_stride * sizeof(float);
  f32_qd8_convert.y_stride = output_stride;
  f32_qd8_convert.batch_size = batch_size;
  f32_qd8_convert.rminmax_ukernel = convert_op->rminmax_config->ukernel;
  f32_qd8_convert.convert_ukernel = convert_op->unary_elementwise_config->ukernel;
  f32_qd8_convert.init_params = convert_op->unary_elementwise_config->init.f32_qs8_cvt;
  convert_op->context.f32_qd8_convert = f32_qd8_convert;
...
enum xnn_status xnn_reshape_convert_nc_f32_qp8(xnn_operator_t convert_op,
  ...
  f32_qp8_convert.m = batch_size;
  f32_qp8_convert.k = channels;
  f32_qp8_convert.mr = mr_packed;
  f32_qp8_convert.kr = kr;
  f32_qp8_convert.sr = sr;
  f32_qp8_convert.lhs_stride = input_stride * sizeof(float);
  f32_qp8_convert.packq_ukernel = (xnn_x8_packq_f32qp8_ukernel_fn)
                              convert_op->unary_elementwise_config->ukernel;
  convert_op->context.f32_qp8_convert = f32_qp8_convert;
  ...
  xnn_operator_t* exp_op_out)
{
  ...
  struct xnn_f32_default_params params;
  if XNN_LIKELY(f32_exp_config != nullptr) {
    if (f32_exp_config->init.f32_default != nullptr) {
      f32_exp_config->init.f32_default(&params);
    }
  }

  return create_unary_elementwise_nc(
    flags, f32_exp_config, /*rminmax_config=*/nullptr,
    &params, sizeof(params),
  ...
  pthreadpool_t threadpool)
{
  ...
  const bool relu_activation = (output_max == INFINITY) && (output_min == 0.0f);
  if (relu_activation && f32_relu_config->ukernel != nullptr) {
    ...
    pthreadpool_t threadpool)
{
  ...
  return run_unary_elementwise_nc(
    ...
    channels, input_stride, output_stride, batch_size,
    input, output,
    f16_to_f32_cvt_config, /*params=*/nullptr, /*params_size=*/0,
    /*log2_input_size=*/XNN_LOG2_SIZEOF_HALF,
    /*log2_output_size=*/XNN_LOG2_SIZEOF_FLOAT,
    flags,
    threadpool);
    ...
    pthreadpool_t threadpool)
{
  ...
  return run_unary_elementwise_nc(
    ...
    channels, input_stride, output_stride, batch_size,
    input, output,
    f32_to_f16_cvt_config, /*params=*/nullptr, /*params_size=*/0,
    /*log2_input_size=*/XNN_LOG2_SIZEOF_FLOAT,
    /*log2_output_size=*/XNN_LOG2_SIZEOF_HALF,
    flags,
    threadpool);
    ...
    pthreadpool_t threadpool)
{
  return run_unary_elementwise_nc(
    ...
    channels, input_stride, output_stride, batch_size,
    input, output,
    xnn_init_xx_copy_config(), nullptr, 0,
    /*log2_input_size=*/XNN_LOG2_SIZEOF_UINT32_T,
    /*log2_output_size=*/XNN_LOG2_SIZEOF_UINT32_T,
    flags,
    threadpool);
  ...
  pthreadpool_t threadpool)
{
  ...
  struct xnn_f32_rsqrt_params params;
  if XNN_LIKELY(f32_rsqrt_config != nullptr && f32_rsqrt_config->init.f32_rsqrt != nullptr) {
    f32_rsqrt_config->init.f32_rsqrt(&params);
  }

...
enum xnn_status xnn_create_clz_nc_s32(uint32_t flags,
  ...
  const struct xnn_unary_elementwise_config* s32_clz_config =
      xnn_init_s32_clz_config();
  assert(s32_clz_config != NULL);
  ...
  return create_unary_elementwise_nc(
      flags, s32_clz_config, /*rminmax_config=*/NULL, &params, sizeof(params),
      xnn_operator_type_clz_nc_s32, clz_op_out);
}
...
enum xnn_status xnn_reshape_clamp_nc_u8(xnn_operator_t clamp_op,
                                        size_t batch_size, size_t channels,
                                        size_t input_stride,
                                        size_t output_stride,
                                        pthreadpool_t threadpool) {
  return reshape_unary_elementwise_nc(
      clamp_op, xnn_operator_type_clamp_nc_u8, batch_size, channels,
      input_stride, output_stride,
      /*log2_input_size=*/XNN_LOG2_SIZEOF_UINT8_T,
      /*log2_output_size=*/XNN_LOG2_SIZEOF_UINT8_T, &clamp_op->params.u8_minmax,
...
enum xnn_status xnn_reshape_clz_nc_s32(xnn_operator_t clz_op, size_t batch_size,
                                       ...
                                       pthreadpool_t threadpool) {
  return reshape_unary_elementwise_nc(
      clz_op, xnn_operator_type_clz_nc_s32, batch_size, channels, input_stride,
      output_stride,
      /*log2_input_size=*/XNN_LOG2_SIZEOF_INT32_T,
      /*log2_output_size=*/XNN_LOG2_SIZEOF_INT32_T, &clz_op->params.s32_default,
      sizeof(clz_op->params.s32_default), threadpool);
}

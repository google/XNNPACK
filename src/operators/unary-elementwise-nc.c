...
static enum xnn_status init_op(
  ...
  if (input_datatype != output_datatype) {
    if (op_type == xnn_unary_convert) {
      ...
      //} else if (input_datatype == xnn_datatype_qint16 && output_datatype == xnn_datatype_qint8) {
      //  return init_op_config(op, xnn_init_qs16_to_qs8_cvt_config(), params, input_quantization, output_quantization);
  ...
  if (datatype == xnn_datatype_qint8) {
    switch (op_type) {
      //case xnn_unary_abs:
      //  return init_op_config(op, xnn_init_qs8_abs_config(), params, input_quantization, output_quantization);
      //case xnn_unary_bankers_rounding:
      //  return init_op_config(op, xnn_init_qs8_rndne_config(), params, input_quantization, output_quantization);
      //case xnn_unary_ceiling:
      //  return init_op_config(op, xnn_init_qs8_rndu_config(), params, input_quantization, output_quantization);
      ...
      //  return init_op_config(op, xnn_init_qs8_rndd_config(), params, input_quantization, output_quantization);
      case xnn_unary_gelu:
        break;
      //case xnn_unary_hardswish:
      //  return init_op_config(op, xnn_init_qs8_hswish_config(), params, input_quantization, output_quantization);
      ...
      //  return init_op_config(op, xnn_init_qs8_neg_config(), params, input_quantization, output_quantization);
      //case xnn_unary_reciprocal_square_root:
      //  return init_op_config(op, xnn_init_qs8_rsqrt_config(), params, input_quantization, output_quantization);
      //case xnn_unary_square_root:
      //  return init_op_config(op, xnn_init_qs8_sqrt_config(), params, input_quantization, output_quantization);
      //case xnn_unary_square:
      //  return init_op_config(op, xnn_init_qs8_sqr_config(), params, input_quantization, output_quantization);
    ...
    switch (op_type) {
      //case xnn_unary_abs:
      //  return init_op_config(op, xnn_init_qu8_abs_config(), params, input_quantization, output_quantization);
      //case xnn_unary_bankers_rounding:
      //  return init_op_config(op, xnn_init_qu8_rndne_config(), params, input_quantization, output_quantization);
      //case xnn_unary_ceiling:
      //  return init_op_config(op, xnn_init_qu8_rndu_config(), params, input_quantization, output_quantization);
      case xnn_unary_clamp:
        if (input_quantization->scale != output_quantization->scale || 
            input_quantization->zero_point != output_quantization->zero_point) {
      ...
      case xnn_unary_exp:
        break;
      //case xnn_unary_floor:
      //  return init_op_config(op, xnn_init_qu8_rndd_config(), params, input_quantization, output_quantization);
      case xnn_unary_gelu:
        break;
      //case xnn_unary_hardswish:
      //  return init_op_config(op, xnn_init_qu8_hswish_config(), params, input_quantization, output_quantization);
      case xnn_unary_leaky_relu:
        return init_op_config(op, xnn_init_qu8_lrelu_config(), params, input_quantization, output_quantization);
      case xnn_unary_log:
        break;
      //case xnn_unary_negate:
      //  return init_op_config(op, xnn_init_qu8_neg_config(), params, input_quantization, output_quantization);
      //case xnn_unary_reciprocal_square_root:
      //  return init_op_config(op, xnn_init_qu8_rsqrt_config(), params, input_quantization, output_quantization);
      //case xnn_unary_square_root:
      //  return init_op_config(op, xnn_init_qu8_sqrt_config(), params, input_quantization, output_quantization);
      //case xnn_unary_square:
      //  return init_op_config(op, xnn_init_qu8_sqr_config(), params, input_quantization, output_quantization);
      case xnn_unary_convert:

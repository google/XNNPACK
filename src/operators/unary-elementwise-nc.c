    ...
    pthreadpool_t threadpool)
{
  ...
  convert_op->compute[0].task_1d_dynamic =
      (pthreadpool_task_1d_dynamic_t)xnn_compute_f16_qd8_convert;
  switch (expected_type) {
    ...
    case xnn_operator_type_convert_nc_f16_qdu8:
      convert_op->compute[0].task_1d_dynamic =
          (pthreadpool_task_1d_dynamic_t)xnn_compute_f16_qdu8_convert;
      break;
    default:
      XNN_UNREACHABLE;
  }
    ...
    pthreadpool_t threadpool)
{
  ...
  switch (expected_type) {
    case xnn_operator_type_convert_nc_f32_qd8:
      convert_op->compute[0].task_1d_dynamic =
          (pthreadpool_task_1d_dynamic_t)xnn_compute_f32_qd8_convert;
      break;
    case xnn_operator_type_convert_nc_f32_qdu8:
      convert_op->compute[0].task_1d_dynamic =
          (pthreadpool_task_1d_dynamic_t)xnn_compute_f32_qdu8_convert;
      break;
    default:
      XNN_UNREACHABLE;
  }

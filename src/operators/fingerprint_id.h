...
enum xnn_fingerprint_id {
  ...
  xnn_fingerprint_id_no_fingerprint = 1,
  ...
  xnn_fingerprint_id_convolution2d_nchw_f16_conv2d_hwc2chw = 30,
  xnn_fingerprint_id_convolution2d_nchw_f16_conv2d_hwc2chw_fp32_static_weights =
      31,
  xnn_fingerprint_id_convolution2d_nchw_f16_dwconv = 32,
  xnn_fingerprint_id_convolution2d_nchw_f16_dwconv_fp32_static_weights = 33,
  xnn_fingerprint_id_convolution2d_nchw_f32_conv2d_hwc2chw = 34,
  xnn_fingerprint_id_convolution2d_nchw_f32_dwconv = 35,

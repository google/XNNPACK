...
void xnn_f16_vmulcaddc_minmax_ukernel_c4v__rvvfp16arith_2x(
    size_t rows,
    size_t channels,
    ...
    const struct xnn_f16_minmax_params* restrict params)
{
  ...
  do {
    ...
    while (c > 0) {
      ...
      vfloat16m4_t vscale = __riscv_vle16_v_f16m4(w, vl);
      vfloat16m4_t vbias = __riscv_vle16_v_f16m4(w + vlmax, vl);
      w += 2 * vlmax;

      vfloat16m4_t vacc0 = __riscv_vle16_v_f16m4(i0, vl); i0 += vl;
      vfloat16m4_t vacc1 = __riscv_vle16_v_f16m4(i1, vl); i1 += vl;

      vacc0 = __riscv_vfmadd_vv_f16m4(vacc0, vscale, vbias, vl);
      vacc1 = __riscv_vfmadd_vv_f16m4(vacc1, vscale, vbias, vl);

      vacc0 = __riscv_vfmax_vf_f16m4(vacc0, vmin_val, vl);
      vacc1 = __riscv_vfmax_vf_f16m4(vacc1, vmin_val, vl);

      vacc0 = __riscv_vfmin_vf_f16m4(vacc0, vmax_val, vl);
      vacc1 = __riscv_vfmin_vf_f16m4(vacc1, vmax_val, vl);

      __riscv_vse16_v_f16m4(o0, vacc0, vl); o0 += vl;
      __riscv_vse16_v_f16m4(o1, vacc1, vl); o1 += vl;

...
void xnn_qd8_f32_qc8w_igemm_minmax_ukernel_7x4v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params)
{
  ...
  do {
    ...
    vfpacc6 = __riscv_vfmax(vfpacc6, voutput_min, vl);
    ...
    vfpacc6 = __riscv_vfmin(vfpacc6, voutput_max, vl);

    __riscv_vse32(c6, vfpacc6, vl);

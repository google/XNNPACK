    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vksumzp3x0123 = vmulq_s32(vksum0123, vinput_zero_point);
    const int32x4_t vksumzp2x4567 = vmulq_s32(vksum4567, vinput_zero_point);
    const int32x4_t vksumzp3x4567 = vmulq_s32(vksum4567, vinput_zero_point);
    const int32x4_t vksumzp2x89AB = vmulq_s32(vksum89AB, vinput_zero_point);
    const int32x4_t vksumzp3x89AB = vmulq_s32(vksum89AB, vinput_zero_point);
    const int32x4_t vksumzp2xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point);
    const int32x4_t vksumzp3xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point);

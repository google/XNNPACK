...
void xnn_qd8_f32_qc8w_igemm_minmax_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vksumzp4x0123 = vmulq_s32(vksum0123, vinput_zero_point);
    const int32x4_t vksumzp5x0123 = vmulq_s32(vksum0123, vinput_zero_point);
    const int32x4_t vksumzp4x4567 = vmulq_s32(vksum4567, vinput_zero_point);
    const int32x4_t vksumzp5x4567 = vmulq_s32(vksum4567, vinput_zero_point);
    const int32x4_t vksumzp4x89AB = vmulq_s32(vksum89AB, vinput_zero_point);
    const int32x4_t vksumzp5x89AB = vmulq_s32(vksum89AB, vinput_zero_point);
    const int32x4_t vksumzp4xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point);
    const int32x4_t vksumzp5xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point);
    const int32x4_t vksumzp6x0123 = vmulq_s32(vksum0123, vinput_zero_point);
    const int32x4_t vksumzp7x0123 = vmulq_s32(vksum0123, vinput_zero_point);
    const int32x4_t vksumzp6x4567 = vmulq_s32(vksum4567, vinput_zero_point);
    const int32x4_t vksumzp7x4567 = vmulq_s32(vksum4567, vinput_zero_point);
    const int32x4_t vksumzp6x89AB = vmulq_s32(vksum89AB, vinput_zero_point);
    const int32x4_t vksumzp7x89AB = vmulq_s32(vksum89AB, vinput_zero_point);
    const int32x4_t vksumzp6xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point);
    const int32x4_t vksumzp7xCDEF = vmulq_s32(vksumCDEF, vinput_zero_point);

...
void xnn_s16_vmul_ukernel__avx2_u8(
    size_t batch,
...
void xnn_s16_vmul_ukernel__avx2_u24(
    size_t batch,
    const int16_t* input_a,
    const int16_t* input_b,
    int16_t* output,
    const union xnn_s16_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 24 * sizeof(int16_t); batch -= 24 * sizeof(int16_t)) {
    ...
    xnn_simd_s32_t vin2_low_2 = xnn_cvt_s16_s32(xnn_low_s16(vin2_2));
    xnn_simd_s32_t vin2_high_2 = xnn_cvt_s16_s32(xnn_high_s16(vin2_2));
    ...
    const union xnn_s16_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int16_t); batch -= 32 * sizeof(int16_t)) {
    ...
    xnn_simd_s32_t vin2_low_3 = xnn_cvt_s16_s32(xnn_low_s16(vin2_3));
    xnn_simd_s32_t vin2_high_3 = xnn_cvt_s16_s32(xnn_high_s16(vin2_3));

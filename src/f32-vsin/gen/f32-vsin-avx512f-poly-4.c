...
void xnn_f32_vsin_ukernel__avx512f_poly_4_u16(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vsin_ukernel__avx512f_poly_4_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vsin_ukernel__avx512f_poly_4_u48(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vsin_ukernel__avx512f_poly_4_u64(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)

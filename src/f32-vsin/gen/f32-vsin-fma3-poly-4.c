...
void xnn_f32_vsin_ukernel__fma3_poly_4_u8(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vsin_ukernel__fma3_poly_4_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vsin_ukernel__fma3_poly_4_u24(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vsin_ukernel__fma3_poly_4_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)

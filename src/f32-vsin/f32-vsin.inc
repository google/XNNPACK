...
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__scalar_rational_5_4_div_u1, 1, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__scalar_rational_5_4_div_u2, 2, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__scalar_rational_5_4_div_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__scalar_rational_5_4_div_u8, 8, false, float, struct xnn_f32_default_params, NULL)

#if XNN_ARCH_X86 || XNN_ARCH_X86_64
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__sse2_rational_5_4_div_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__sse2_rational_5_4_div_u8, 8, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__sse2_rational_5_4_div_u12, 12, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__sse2_rational_5_4_div_u16, 16, false, float, struct xnn_f32_default_params, NULL)
...
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__wasmsimd_rational_5_4_div_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__wasmsimd_rational_5_4_div_u8, 8, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__wasmsimd_rational_5_4_div_u12, 12, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__wasmsimd_rational_5_4_div_u16, 16, false, float, struct xnn_f32_default_params, NULL)
#endif  // XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD

#if XNN_ARCH_HEXAGON && XNN_ENABLE_HVX
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__hvx_rational_5_4_div_u32,  32,  false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__hvx_rational_5_4_div_u64,  64,  false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__hvx_rational_5_4_div_u96,  96,  false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL(0, xnn_f32_vsin_ukernel__hvx_rational_5_4_div_u128, 128, false, float, struct xnn_f32_default_params, NULL)

...
// void xnn_f32_gemm_minmax_ukernel_6x8__aarch64_neonfma_prfm_cortex_a76(
//     size_t mr,                x0
//     size_t nc,                x1
//     size_t kc,                x2 / x0
...
// Converted from: src/f32-gemm/gen/6x8-minmax-aarch64-neonfma-prfm-cortex-a76.S
...
xnn_status xnn_generate_f32_gemm_ukernel_6x8__aarch64_neonfma_cortex_a76(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, const void* params) {
...
xnn_status xnn_generate_f32_gemm_ukernel_6x8__aarch64_neonfma_prfm_cortex_a76(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, const void* params) {
  using namespace xnnpack::aarch64;
  Generator g(code);
  assert(params != nullptr);
  const jit_gemm_params* gemm_params = static_cast<const jit_gemm_params*>(params);

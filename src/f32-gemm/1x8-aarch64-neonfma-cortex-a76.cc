...
// void xnn_f32_gemm_minmax_ukernel_1x8__aarch64_neonfma_prfm_cortex_a76(
...
// Converted from: src/f32-gemm/gen/1x8-minmax-aarch64-neonfma-prfm-cortex-a76.S
...
xnn_status xnn_generate_f32_gemm_ukernel_1x8__aarch64_neonfma_cortex_a76(
...
xnn_status xnn_generate_f32_gemm_ukernel_1x8__aarch64_neonfma_prfm_cortex_a76(
    xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, const void* params)
{
  using namespace xnnpack::aarch64;
  Generator g(code);

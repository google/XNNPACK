...
// void xnn_f32_gemm_minmax_ukernel_4x8__aarch32_neon_ld64(
//     size_t mr,                            r0
//     size_t nc,                            r1
//     size_t kc,                            r2 -> r5
...
xnn_status xnn_generate_f32_gemm_ukernel_4x8__aarch32_neon_ld64(xnn_code_buffer* code, size_t nc, size_t kc, void* params) {

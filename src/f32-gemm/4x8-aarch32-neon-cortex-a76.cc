...
// void xnn_f32_gemm_minmax_ukernel_4x8__aarch32_neon_prfm_cortex_a76(
//     size_t mr,                            r0
//     size_t nc,                            r1
//     size_t kc,                            r2 -> r5
...
// Converted from: src/f32-gemm/gen/4x8-minmax-aarch32-neon-prfm-cortex-a76.S
...
xnn_status xnn_generate_f32_gemm_ukernel_4x8__aarch32_neon_cortex_a76(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, const void* params) {
...
xnn_status xnn_generate_f32_gemm_ukernel_4x8__aarch32_neon_prfm_cortex_a76(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, const void* params) {
  using namespace xnnpack::aarch32;
  Generator g(code);

    ...
    const union xnn_f32_output_params params[restrict static 1])
{
  ...
  do {
    ...
    vacc5x0123 = vminq_f32(vacc5x0123, voutput_clamp.val[0]);
    ...
    vacc5x4567 = vminq_f32(vacc5x4567, voutput_clamp.val[0]);
    ...
    vacc5x0123 = vmaxq_f32(vacc5x0123, voutput_clamp.val[1]);
    ...
    vacc5x4567 = vmaxq_f32(vacc5x4567, voutput_clamp.val[1]);

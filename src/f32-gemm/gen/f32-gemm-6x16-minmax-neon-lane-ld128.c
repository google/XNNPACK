  ...
  do {
    ...
    if XNN_UNLIKELY(k != 0) {
      if XNN_UNLIKELY(k & (2 * sizeof(float))) {
        ...
        vacc4x2 = vmlaq_lane_f32(vacc4x2, vb89ABc0, va4, 0);
        vacc5x2 = vmlaq_lane_f32(vacc5x2, vb89ABc0, va5, 0);
        ...
        vacc4x3 = vmlaq_lane_f32(vacc4x3, vbCDEFc0, va4, 0);
        vacc5x3 = vmlaq_lane_f32(vacc5x3, vbCDEFc0, va5, 0);
        ...
        vacc4x2 = vmlaq_lane_f32(vacc4x2, vb89ABc1, va4, 1);
        vacc5x2 = vmlaq_lane_f32(vacc5x2, vb89ABc1, va5, 1);
        ...
        vacc4x3 = vmlaq_lane_f32(vacc4x3, vbCDEFc1, va4, 1);
        vacc5x3 = vmlaq_lane_f32(vacc5x3, vbCDEFc1, va5, 1);
      }

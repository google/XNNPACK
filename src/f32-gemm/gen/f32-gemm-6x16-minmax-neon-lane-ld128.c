...
void xnn_f32_gemm_minmax_ukernel_6x16__neon_lane_ld128(
    size_t mr,
    size_t nc,
    size_t kc,
  ...
  do {
    ...
    if XNN_UNLIKELY(k != 0) {
      if XNN_UNLIKELY(k & (2 * sizeof(float))) {
        ...
        vacc4x89AB = vmlaq_lane_f32(vacc4x89AB, vb89ABc0, va4, 0);
        vacc5x89AB = vmlaq_lane_f32(vacc5x89AB, vb89ABc0, va5, 0);
        vacc0xCDEF = vmlaq_lane_f32(vacc0xCDEF, vbCDEFc0, va0, 0);
        vacc1xCDEF = vmlaq_lane_f32(vacc1xCDEF, vbCDEFc0, va1, 0);
        vacc2xCDEF = vmlaq_lane_f32(vacc2xCDEF, vbCDEFc0, va2, 0);
        vacc3xCDEF = vmlaq_lane_f32(vacc3xCDEF, vbCDEFc0, va3, 0);
        vacc4xCDEF = vmlaq_lane_f32(vacc4xCDEF, vbCDEFc0, va4, 0);
        vacc5xCDEF = vmlaq_lane_f32(vacc5xCDEF, vbCDEFc0, va5, 0);
        ...
        vacc4x89AB = vmlaq_lane_f32(vacc4x89AB, vb89ABc1, va4, 1);
        vacc5x89AB = vmlaq_lane_f32(vacc5x89AB, vb89ABc1, va5, 1);
        vacc0xCDEF = vmlaq_lane_f32(vacc0xCDEF, vbCDEFc1, va0, 1);
        vacc1xCDEF = vmlaq_lane_f32(vacc1xCDEF, vbCDEFc1, va1, 1);
        vacc2xCDEF = vmlaq_lane_f32(vacc2xCDEF, vbCDEFc1, va2, 1);
        vacc3xCDEF = vmlaq_lane_f32(vacc3xCDEF, vbCDEFc1, va3, 1);
        vacc4xCDEF = vmlaq_lane_f32(vacc4xCDEF, vbCDEFc1, va4, 1);
        vacc5xCDEF = vmlaq_lane_f32(vacc5xCDEF, vbCDEFc1, va5, 1);
      }

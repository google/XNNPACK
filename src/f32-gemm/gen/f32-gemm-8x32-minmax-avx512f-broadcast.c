...
void xnn_f32_gemm_minmax_ukernel_8x32__avx512f_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 32) {
      ...
      _mm_mask_storeu_epi32(c5 + 16, vmask1, vacc5x1);
      _mm_mask_storeu_epi32(c6 + 0, vmask0, vacc6x0);
      _mm_mask_storeu_epi32(c6 + 16, vmask1, vacc6x1);
      _mm_mask_storeu_epi32(c7 + 0, vmask0, vacc7x0);
      _mm_mask_storeu_epi32(c7 + 16, vmask1, vacc7x1);

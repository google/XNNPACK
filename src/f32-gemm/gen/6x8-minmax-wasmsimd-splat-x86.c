    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vacc4x0123 = wasm_f32x4_pmax(vacc4x0123, vmin);
    vacc5x0123 = wasm_f32x4_pmax(vacc5x0123, vmin);
    ...
    vacc4x4567 = wasm_f32x4_pmax(vacc4x4567, vmin);
    vacc5x4567 = wasm_f32x4_pmax(vacc5x4567, vmin);
    ...
    vacc4x0123 = wasm_f32x4_pmin(vacc4x0123, vmax);
    vacc5x0123 = wasm_f32x4_pmin(vacc5x0123, vmax);
    ...
    vacc4x4567 = wasm_f32x4_pmin(vacc4x4567, vmax);
    vacc5x4567 = wasm_f32x4_pmin(vacc5x4567, vmax);

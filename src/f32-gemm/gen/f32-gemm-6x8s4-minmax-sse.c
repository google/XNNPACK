...
void xnn_f32_gemm_minmax_ukernel_6x8s4__sse(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; k >= 4 * sizeof(float); k -= 4 * sizeof(float)) {
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(va5, vb0123c0));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(va5, vb4567c0));
      ...
      va5 = _mm_shuffle_ps(va5, va5, _MM_SHUFFLE(0, 3, 2, 1));
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(va5, vb0123c1));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(va5, vb4567c1));
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(va5, vb0123c2));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(va5, vb4567c2));
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(va5, vb0123c3));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(va5, vb4567c3));
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb0123c0), va5), vb0123c0));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb4567c0), va5), vb4567c0));
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb0123c1), va5), vb0123c1));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb4567c1), va5), vb4567c1));
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb0123c2), va5), vb0123c2));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb4567c2), va5), vb4567c2));
      ...
      vacc5x0123 = _mm_add_ps(vacc5x0123, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb0123c3), va5), vb0123c3));
      ...
      vacc5x4567 = _mm_add_ps(vacc5x4567, _mm_mul_ps(_mm_andnot_ps(_mm_cmpeq_ps(_mm_setzero_ps(), vb4567c3), va5), vb4567c3));

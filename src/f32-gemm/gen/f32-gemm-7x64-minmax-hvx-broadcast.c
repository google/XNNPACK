    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    xnn_simd_f32_t vacc4x1 = vacc0x1;
    xnn_simd_f32_t vacc5x0 = vacc0x0;
    xnn_simd_f32_t vacc5x1 = vacc0x1;
    xnn_simd_f32_t vacc6x0 = vacc0x0;
    xnn_simd_f32_t vacc6x1 = vacc0x1;
    w += 64;
    ...
    do {
      ...
      vacc4x1 = xnn_fmadd_qf32(va4, vb1, vacc4x1);
      vacc5x1 = xnn_fmadd_qf32(va5, vb1, vacc5x1);
      vacc6x1 = xnn_fmadd_qf32(va6, vb1, vacc6x1);

...
void xnn_f32_gemm_minmax_ukernel_16x64__avx512f_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    __m512 vacc12x1 = vacc0x1;
    __m512 vacc12x2 = vacc0x2;
    __m512 vacc12x3 = vacc0x3;
    __m512 vacc13x0 = vacc0x0;
    __m512 vacc13x1 = vacc0x1;
    __m512 vacc13x2 = vacc0x2;
    __m512 vacc13x3 = vacc0x3;
    __m512 vacc14x0 = vacc0x0;
    __m512 vacc14x1 = vacc0x1;
    __m512 vacc14x2 = vacc0x2;
    __m512 vacc14x3 = vacc0x3;
    __m512 vacc15x0 = vacc0x0;
    __m512 vacc15x1 = vacc0x1;
    __m512 vacc15x2 = vacc0x2;
    __m512 vacc15x3 = vacc0x3;
    w += 64;
    ...
    do {
      ...
      vacc12x1 = _mm512_fmadd_ps(va12, vb1, vacc12x1);
      vacc12x2 = _mm512_fmadd_ps(va12, vb2, vacc12x2);
      vacc12x3 = _mm512_fmadd_ps(va12, vb3, vacc12x3);
      const __m512 va13 = _mm512_set1_ps(*a13);
      vacc13x0 = _mm512_fmadd_ps(va13, vb0, vacc13x0);
      vacc13x1 = _mm512_fmadd_ps(va13, vb1, vacc13x1);
      vacc13x2 = _mm512_fmadd_ps(va13, vb2, vacc13x2);
      vacc13x3 = _mm512_fmadd_ps(va13, vb3, vacc13x3);
      const __m512 va14 = _mm512_set1_ps(*a14);
      vacc14x0 = _mm512_fmadd_ps(va14, vb0, vacc14x0);
      vacc14x1 = _mm512_fmadd_ps(va14, vb1, vacc14x1);
      vacc14x2 = _mm512_fmadd_ps(va14, vb2, vacc14x2);
      vacc14x3 = _mm512_fmadd_ps(va14, vb3, vacc14x3);
      const __m512 va15 = _mm512_set1_ps(*a15);
      vacc15x0 = _mm512_fmadd_ps(va15, vb0, vacc15x0);
      vacc15x1 = _mm512_fmadd_ps(va15, vb1, vacc15x1);
      vacc15x2 = _mm512_fmadd_ps(va15, vb2, vacc15x2);
      vacc15x3 = _mm512_fmadd_ps(va15, vb3, vacc15x3);
    ...
    vacc12x1 = _mm512_max_ps(vmin, vacc12x1);
    vacc13x1 = _mm512_max_ps(vmin, vacc13x1);
    vacc14x1 = _mm512_max_ps(vmin, vacc14x1);
    vacc15x1 = _mm512_max_ps(vmin, vacc15x1);
    ...
    vacc12x2 = _mm512_max_ps(vmin, vacc12x2);
    vacc13x2 = _mm512_max_ps(vmin, vacc13x2);
    vacc14x2 = _mm512_max_ps(vmin, vacc14x2);
    vacc15x2 = _mm512_max_ps(vmin, vacc15x2);
    ...
    vacc12x3 = _mm512_max_ps(vmin, vacc12x3);
    vacc13x3 = _mm512_max_ps(vmin, vacc13x3);
    vacc14x3 = _mm512_max_ps(vmin, vacc14x3);
    vacc15x3 = _mm512_max_ps(vmin, vacc15x3);
    ...
    vacc12x1 = _mm512_min_ps(vmax, vacc12x1);
    vacc13x1 = _mm512_min_ps(vmax, vacc13x1);
    vacc14x1 = _mm512_min_ps(vmax, vacc14x1);
    vacc15x1 = _mm512_min_ps(vmax, vacc15x1);
    ...
    vacc12x2 = _mm512_min_ps(vmax, vacc12x2);
    vacc13x2 = _mm512_min_ps(vmax, vacc13x2);
    vacc14x2 = _mm512_min_ps(vmax, vacc14x2);
    vacc15x2 = _mm512_min_ps(vmax, vacc15x2);
    ...
    vacc12x3 = _mm512_min_ps(vmax, vacc12x3);
    vacc13x3 = _mm512_min_ps(vmax, vacc13x3);
    vacc14x3 = _mm512_min_ps(vmax, vacc14x3);
    vacc15x3 = _mm512_min_ps(vmax, vacc15x3);
    ...
    if XNN_LIKELY(nc >= 64) {
      ...
      _mm512_storeu_ps(c12 + 16, vacc12x1);
      _mm512_storeu_ps(c12 + 32, vacc12x2);
      _mm512_storeu_ps(c12 + 48, vacc12x3);
      c12 = (float*) ((uintptr_t) c12 + cn_stride);
      _mm512_storeu_ps(c13, vacc13x0);
      _mm512_storeu_ps(c13 + 16, vacc13x1);
      _mm512_storeu_ps(c13 + 32, vacc13x2);
      _mm512_storeu_ps(c13 + 48, vacc13x3);
      c13 = (float*) ((uintptr_t) c13 + cn_stride);
      _mm512_storeu_ps(c14, vacc14x0);
      _mm512_storeu_ps(c14 + 16, vacc14x1);
      _mm512_storeu_ps(c14 + 32, vacc14x2);
      _mm512_storeu_ps(c14 + 48, vacc14x3);
      c14 = (float*) ((uintptr_t) c14 + cn_stride);
      _mm512_storeu_ps(c15, vacc15x0);
      _mm512_storeu_ps(c15 + 16, vacc15x1);
      _mm512_storeu_ps(c15 + 32, vacc15x2);
      _mm512_storeu_ps(c15 + 48, vacc15x3);
      ...
      _mm512_mask_storeu_ps(c12 + 16, vmask1, vacc12x1);
      _mm512_mask_storeu_ps(c12 + 32, vmask2, vacc12x2);
      _mm512_mask_storeu_ps(c12 + 48, vmask3, vacc12x3);
      _mm512_mask_storeu_ps(c13 + 0, vmask0, vacc13x0);
      _mm512_mask_storeu_ps(c13 + 16, vmask1, vacc13x1);
      _mm512_mask_storeu_ps(c13 + 32, vmask2, vacc13x2);
      _mm512_mask_storeu_ps(c13 + 48, vmask3, vacc13x3);
      _mm512_mask_storeu_ps(c14 + 0, vmask0, vacc14x0);
      _mm512_mask_storeu_ps(c14 + 16, vmask1, vacc14x1);
      _mm512_mask_storeu_ps(c14 + 32, vmask2, vacc14x2);
      _mm512_mask_storeu_ps(c14 + 48, vmask3, vacc14x3);
      _mm512_mask_storeu_ps(c15 + 0, vmask0, vacc15x0);
      _mm512_mask_storeu_ps(c15 + 16, vmask1, vacc15x1);
      _mm512_mask_storeu_ps(c15 + 32, vmask2, vacc15x2);
      _mm512_mask_storeu_ps(c15 + 48, vmask3, vacc15x3);
      nc = 0;
    }
  } while (nc != 0);
}

...
void xnn_f32_gemm_minmax_ukernel_6x16__aarch64_neonfma_lane_ld128(
    size_t mr,
    size_t nc,
    size_t kc,
  ...
  do {
    ...
    if XNN_LIKELY(k >= 4 * sizeof(float)) {
      do {
        ...
        vacc4x2 = vfmaq_lane_f32(vacc4x2, vb89ABc0, vget_low_f32(va4), 0);
        vacc5x2 = vfmaq_lane_f32(vacc5x2, vb89ABc0, vget_low_f32(va5), 0);
        ...
        vacc4x3 = vfmaq_lane_f32(vacc4x3, vbCDEFc0, vget_low_f32(va4), 0);
        vacc5x3 = vfmaq_lane_f32(vacc5x3, vbCDEFc0, vget_low_f32(va5), 0);
        ...
        vacc4x2 = vfmaq_lane_f32(vacc4x2, vb89ABc1, vget_low_f32(va4), 1);
        vacc5x2 = vfmaq_lane_f32(vacc5x2, vb89ABc1, vget_low_f32(va5), 1);
        ...
        vacc4x3 = vfmaq_lane_f32(vacc4x3, vbCDEFc1, vget_low_f32(va4), 1);
        vacc5x3 = vfmaq_lane_f32(vacc5x3, vbCDEFc1, vget_low_f32(va5), 1);
        ...
        vacc4x2 = vfmaq_lane_f32(vacc4x2, vb89ABc2, vget_high_f32(va4), 0);
        vacc5x2 = vfmaq_lane_f32(vacc5x2, vb89ABc2, vget_high_f32(va5), 0);
        ...
        vacc4x3 = vfmaq_lane_f32(vacc4x3, vbCDEFc2, vget_high_f32(va4), 0);
        vacc5x3 = vfmaq_lane_f32(vacc5x3, vbCDEFc2, vget_high_f32(va5), 0);
        ...
        vacc4x2 = vfmaq_lane_f32(vacc4x2, vb89ABc3, vget_high_f32(va4), 1);
        vacc5x2 = vfmaq_lane_f32(vacc5x2, vb89ABc3, vget_high_f32(va5), 1);
        ...
        vacc4x3 = vfmaq_lane_f32(vacc4x3, vbCDEFc3, vget_high_f32(va4), 1);
        vacc5x3 = vfmaq_lane_f32(vacc5x3, vbCDEFc3, vget_high_f32(va5), 1);
        k -= 4 * sizeof(float);
    ...
    if XNN_UNLIKELY(k != 0) {
      if XNN_UNLIKELY(k & (2 * sizeof(float))) {
        ...
        vacc4x2 = vfmaq_lane_f32(vacc4x2, vb89ABc0, va4, 0);
        vacc5x2 = vfmaq_lane_f32(vacc5x2, vb89ABc0, va5, 0);
        ...
        vacc4x3 = vfmaq_lane_f32(vacc4x3, vbCDEFc0, va4, 0);
        vacc5x3 = vfmaq_lane_f32(vacc5x3, vbCDEFc0, va5, 0);
        ...
        vacc4x2 = vfmaq_lane_f32(vacc4x2, vb89ABc1, va4, 1);
        vacc5x2 = vfmaq_lane_f32(vacc5x2, vb89ABc1, va5, 1);
        ...
        vacc4x3 = vfmaq_lane_f32(vacc4x3, vbCDEFc1, va4, 1);
        vacc5x3 = vfmaq_lane_f32(vacc5x3, vbCDEFc1, va5, 1);
      }
      if XNN_UNLIKELY(k & (1 * sizeof(float))) {
        ...
        vacc4x2 = vfmaq_f32(vacc4x2, va4, vb89AB);
        vacc5x2 = vfmaq_f32(vacc5x2, va5, vb89AB);
        ...
        vacc4x3 = vfmaq_f32(vacc4x3, va4, vbCDEF);
        vacc5x3 = vfmaq_f32(vacc5x3, va5, vbCDEF);
      }
    }

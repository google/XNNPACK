    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    while (k >= 4 * sizeof(float)) {
      ...
      vacc1x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc1x0123, va1c0, vb0123c0);
      vacc2x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc2x0123, va2c0, vb0123c0);
      vacc3x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc3x0123, va3c0, vb0123c0);
      vacc4x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc4x0123, va4c0, vb0123c0);
      vacc5x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc5x0123, va5c0, vb0123c0);
      vacc0x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc0x4567, va0c0, vb4567c0);
      vacc1x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc1x4567, va1c0, vb4567c0);
      vacc2x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc2x4567, va2c0, vb4567c0);
      vacc3x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc3x4567, va3c0, vb4567c0);
      vacc4x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc4x4567, va4c0, vb4567c0);
      vacc5x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc5x4567, va5c0, vb4567c0);
      ...
      vacc1x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc1x0123, va1c1, vb0123c1);
      vacc2x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc2x0123, va2c1, vb0123c1);
      vacc3x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc3x0123, va3c1, vb0123c1);
      vacc4x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc4x0123, va4c1, vb0123c1);
      vacc5x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc5x0123, va5c1, vb0123c1);
      vacc0x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc0x4567, va0c1, vb4567c1);
      vacc1x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc1x4567, va1c1, vb4567c1);
      vacc2x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc2x4567, va2c1, vb4567c1);
      vacc3x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc3x4567, va3c1, vb4567c1);
      vacc4x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc4x4567, va4c1, vb4567c1);
      vacc5x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc5x4567, va5c1, vb4567c1);
      ...
      vacc1x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc1x0123, va1c2, vb0123c2);
      vacc2x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc2x0123, va2c2, vb0123c2);
      vacc3x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc3x0123, va3c2, vb0123c2);
      vacc4x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc4x0123, va4c2, vb0123c2);
      vacc5x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc5x0123, va5c2, vb0123c2);
      vacc0x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc0x4567, va0c2, vb4567c2);
      vacc1x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc1x4567, va1c2, vb4567c2);
      vacc2x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc2x4567, va2c2, vb4567c2);
      vacc3x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc3x4567, va3c2, vb4567c2);
      vacc4x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc4x4567, va4c2, vb4567c2);
      vacc5x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc5x4567, va5c2, vb4567c2);
      ...
      vacc1x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc1x0123, va1c3, vb0123c3);
      vacc2x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc2x0123, va2c3, vb0123c3);
      vacc3x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc3x0123, va3c3, vb0123c3);
      vacc4x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc4x0123, va4c3, vb0123c3);
      vacc5x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc5x0123, va5c3, vb0123c3);
      vacc0x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc0x4567, va0c3, vb4567c3);
      vacc1x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc1x4567, va1c3, vb4567c3);
      vacc2x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc2x4567, va2c3, vb4567c3);
      vacc3x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc3x4567, va3c3, vb4567c3);
      vacc4x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc4x4567, va4c3, vb4567c3);
      vacc5x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc5x4567, va5c3, vb4567c3);
    ...
    if XNN_UNLIKELY(k != 0) {
      do {
        ...
        vacc1x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc1x0123, va1, vb0123);
        vacc2x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc2x0123, va2, vb0123);
        vacc3x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc3x0123, va3, vb0123);
        vacc4x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc4x0123, va4, vb0123);
        vacc5x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc5x0123, va5, vb0123);
        vacc0x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc0x4567, va0, vb4567);
        vacc1x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc1x4567, va1, vb4567);
        vacc2x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc2x4567, va2, vb4567);
        vacc3x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc3x4567, va3, vb4567);
        vacc4x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc4x4567, va4, vb4567);
        vacc5x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc5x4567, va5, vb4567);

...
void xnn_f32_gemm_minmax_ukernel_32x32__neonsme2(
  ...
  printf("RUNNING MICROKERNEL SME m %zu n %zu k %zu\n", m, n, k);fflush(stdout);
#if XNN_ENABLE_KLEIDIAI
  printf("calling MICROKERNEL SME %p\n", kai_run_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme2_mopa);fflush(stdout);

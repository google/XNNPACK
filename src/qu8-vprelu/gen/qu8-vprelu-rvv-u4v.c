...
void xnn_qu8_vprelu_ukernel__rvv_u4v(
    size_t batch,
    ...
    const union xnn_qs8_vprelu_scalar_params* restrict params)
{
  ...
  for (size_t vl; batch > 0;
    ...
    const vuint8m1_t vb8 = __riscv_vle8_v_u8m1(input_b, vl);
    vint32m4_t va32 = __riscv_vreinterpret_v_u32m4_i32m4(
        __riscv_vzext_vf4_u32m4(va8, vl));
    vint32m4_t vb32 = __riscv_vreinterpret_v_u32m4_i32m4(
        __riscv_vzext_vf4_u32m4(vb8, vl));

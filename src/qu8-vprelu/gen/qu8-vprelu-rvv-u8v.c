...
void xnn_qu8_vprelu_ukernel__rvv_u8v(
    size_t batch,
    ...
    const union xnn_qs8_vprelu_scalar_params* restrict params)
{
  ...
  for (size_t vl; batch > 0;
    ...
    const vuint8m2_t vb8 = __riscv_vle8_v_u8m2(input_b, vl);
    vint32m8_t va32 = __riscv_vreinterpret_v_u32m8_i32m8(
        __riscv_vzext_vf4_u32m8(va8, vl));
    vint32m8_t vb32 = __riscv_vreinterpret_v_u32m8_i32m8(
        __riscv_vzext_vf4_u32m8(vb8, vl));
    va32 = __riscv_vsub_vx_i32m8(va32, input_zero_point, vl);
    vb32 = __riscv_vsub_vx_i32m8(vb32, slope_zero_point, vl);

    const vbool4_t ma =
        __riscv_vmslt_vx_i32m8_b4(va32, 0, vl);

    vint32m8_t vacc = __riscv_vmul_vv_i32m8_mu(ma, va32, va32, vb32, vl);

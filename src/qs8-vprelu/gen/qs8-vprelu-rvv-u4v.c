...
void xnn_qs8_vprelu_ukernel__rvv_u4v(
    size_t batch,
    ...
    const union xnn_qs8_vprelu_scalar_params* restrict params)
{
  ...
  for (size_t vl; batch > 0;
    ...
    const vint8m1_t vb8 = __riscv_vle8_v_i8m1(input_b, vl);
    ...
    vb32 = __riscv_vsub_vx_i32m4(vb32, slope_zero_point, vl);

    const vbool8_t ma =
        __riscv_vmslt_vx_i32m4_b8(va32, 0, vl);

    vint32m4_t vacc = __riscv_vmul_vv_i32m4_mu(ma, va32, va32, vb32, vl);

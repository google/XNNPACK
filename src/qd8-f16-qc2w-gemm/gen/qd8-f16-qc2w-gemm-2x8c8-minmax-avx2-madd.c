    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc1x1x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc1x1x0123, va1x3, vb01234567xCDEF);
      vacc1x1x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc1x1x4567, va1x3, vb89ABCDEFxCDEF);
      w = (const int8_t*) w + 64;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x1x0123 = _mm256_dpbusd_epi32_madd_kzp2(vacc1x1x0123, va1x89ABCDEF, vb01234567x4567);
      vacc1x1x4567 = _mm256_dpbusd_epi32_madd_kzp2(vacc1x1x4567, va1x89ABCDEF, vb89ABCDEFx4567);

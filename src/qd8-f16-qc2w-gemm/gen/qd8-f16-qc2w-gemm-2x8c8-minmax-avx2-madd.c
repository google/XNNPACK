    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc1x0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x0123, vb01234567x4567, va0x1);
      vacc1x0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x4567, vb89ABCDEFx4567, va0x1);
      vacc1x1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x0123, vb01234567x4567, va1x1);
      vacc1x1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x4567, vb89ABCDEFx4567, va1x1);
      ...
      vacc1x0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x0123, vb01234567xCDEF, va0x3);
      vacc1x0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x4567, vb89ABCDEFxCDEF, va0x3);
      vacc1x1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x0123, vb01234567xCDEF, va1x3);
      vacc1x1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x4567, vb89ABCDEFxCDEF, va1x3);
      w = (const int8_t*) w + 64;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x0123, vb01234567x4567, va0x89ABCDEF);
      vacc1x0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x4567, vb89ABCDEFx4567, va0x89ABCDEF);
      vacc1x1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x0123, vb01234567x4567, va1x89ABCDEF);
      vacc1x1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x4567, vb89ABCDEFx4567, va1x89ABCDEF);

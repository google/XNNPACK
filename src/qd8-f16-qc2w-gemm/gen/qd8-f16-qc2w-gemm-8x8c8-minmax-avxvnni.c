...
void xnn_qd8_f16_qc2w_gemm_minmax_ukernel_8x8c8__avxvnni(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256i vacc1x0123 = _mm256_setzero_si256();
    __m256i vacc1x4567 = _mm256_setzero_si256();
    __m256i vsum2x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point2);
    __m256i vacc2x0123 = _mm256_setzero_si256();
    __m256i vacc2x4567 = _mm256_setzero_si256();
    __m256i vsum3x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point3);
    __m256i vacc3x0123 = _mm256_setzero_si256();
    __m256i vacc3x4567 = _mm256_setzero_si256();
    __m256i vsum4x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point4);
    __m256i vacc4x0123 = _mm256_setzero_si256();
    __m256i vacc4x4567 = _mm256_setzero_si256();
    __m256i vsum5x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point5);
    __m256i vacc5x0123 = _mm256_setzero_si256();
    __m256i vacc5x4567 = _mm256_setzero_si256();
    __m256i vsum6x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point6);
    __m256i vacc6x0123 = _mm256_setzero_si256();
    __m256i vacc6x4567 = _mm256_setzero_si256();
    __m256i vsum7x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point7);
    __m256i vacc7x0123 = _mm256_setzero_si256();
    __m256i vacc7x4567 = _mm256_setzero_si256();
    w = (const int32_t*) w + 8;
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      a0 += 32;
      const __m256i va1x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a1));
      const __m256i va1x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a1 + 8));
      const __m256i va1x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a1 + 16));
      const __m256i va1x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a1 + 24));
      a1 += 32;
      const __m256i va2x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a2));
      const __m256i va2x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a2 + 8));
      const __m256i va2x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a2 + 16));
      const __m256i va2x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a2 + 24));
      a2 += 32;
      const __m256i va3x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a3));
      const __m256i va3x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a3 + 8));
      const __m256i va3x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a3 + 16));
      const __m256i va3x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a3 + 24));
      a3 += 32;
      const __m256i va4x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a4));
      const __m256i va4x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a4 + 8));
      const __m256i va4x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a4 + 16));
      const __m256i va4x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a4 + 24));
      a4 += 32;
      const __m256i va5x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a5));
      const __m256i va5x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a5 + 8));
      const __m256i va5x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a5 + 16));
      const __m256i va5x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a5 + 24));
      a5 += 32;
      const __m256i va6x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a6));
      const __m256i va6x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a6 + 8));
      const __m256i va6x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a6 + 16));
      const __m256i va6x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a6 + 24));
      a6 += 32;
      const __m256i va7x0 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a7));
      const __m256i va7x1 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a7 + 8));
      const __m256i va7x2 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a7 + 16));
      const __m256i va7x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a7 + 24));
      a7 += 32;
      ...
      vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567x0123, va0x0);
      vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFx0123, va0x0);
      vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567x0123, va1x0);
      vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFx0123, va1x0);
      vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567x0123, va2x0);
      vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFx0123, va2x0);
      vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567x0123, va3x0);
      vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFx0123, va3x0);
      vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567x0123, va4x0);
      vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFx0123, va4x0);
      vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567x0123, va5x0);
      vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFx0123, va5x0);
      vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567x0123, va6x0);
      vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFx0123, va6x0);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567x0123, va7x0);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFx0123, va7x0);
      vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567x4567, va0x1);
      vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFx4567, va0x1);
      vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567x4567, va1x1);
      vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFx4567, va1x1);
      vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567x4567, va2x1);
      vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFx4567, va2x1);
      vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567x4567, va3x1);
      vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFx4567, va3x1);
      vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567x4567, va4x1);
      vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFx4567, va4x1);
      vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567x4567, va5x1);
      vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFx4567, va5x1);
      vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567x4567, va6x1);
      vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFx4567, va6x1);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567x4567, va7x1);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFx4567, va7x1);
      vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567x89AB, va0x2);
      vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFx89AB, va0x2);
      vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567x89AB, va1x2);
      vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFx89AB, va1x2);
      vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567x89AB, va2x2);
      vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFx89AB, va2x2);
      vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567x89AB, va3x2);
      vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFx89AB, va3x2);
      vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567x89AB, va4x2);
      vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFx89AB, va4x2);
      vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567x89AB, va5x2);
      vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFx89AB, va5x2);
      vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567x89AB, va6x2);
      vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFx89AB, va6x2);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567x89AB, va7x2);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFx89AB, va7x2);
      vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567xCDEF, va0x3);
      vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFxCDEF, va0x3);
      vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567xCDEF, va1x3);
      vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFxCDEF, va1x3);
      vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567xCDEF, va2x3);
      vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFxCDEF, va2x3);
      vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567xCDEF, va3x3);
      vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFxCDEF, va3x3);
      vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567xCDEF, va4x3);
      vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFxCDEF, va4x3);
      vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567xCDEF, va5x3);
      vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFxCDEF, va5x3);
      vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567xCDEF, va6x3);
      vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFxCDEF, va6x3);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567xCDEF, va7x3);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFxCDEF, va7x3);
      w = (const int8_t*) w + 64;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567x0123, va0x01234567);
      vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFx0123, va0x01234567);
      vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567x0123, va1x01234567);
      vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFx0123, va1x01234567);
      vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567x0123, va2x01234567);
      vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFx0123, va2x01234567);
      vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567x0123, va3x01234567);
      vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFx0123, va3x01234567);
      vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567x0123, va4x01234567);
      vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFx0123, va4x01234567);
      vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567x0123, va5x01234567);
      vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFx0123, va5x01234567);
      vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567x0123, va6x01234567);
      vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFx0123, va6x01234567);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567x0123, va7x01234567);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFx0123, va7x01234567);
      vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567x4567, va0x89ABCDEF);
      vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFx4567, va0x89ABCDEF);
      vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567x4567, va1x89ABCDEF);
      vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFx4567, va1x89ABCDEF);
      vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567x4567, va2x89ABCDEF);
      vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFx4567, va2x89ABCDEF);
      vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567x4567, va3x89ABCDEF);
      vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFx4567, va3x89ABCDEF);
      vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567x4567, va4x89ABCDEF);
      vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFx4567, va4x89ABCDEF);
      vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567x4567, va5x89ABCDEF);
      vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFx4567, va5x89ABCDEF);
      vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567x4567, va6x89ABCDEF);
      vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFx4567, va6x89ABCDEF);
      vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567x4567, va7x89ABCDEF);
      vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFx4567, va7x89ABCDEF);
      ...
      if (k != 0) {
        ...
        a0 += 8;
        const __m256i va1x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a1));
        a1 += 8;
        const __m256i va2x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a2));
        a2 += 8;
        const __m256i va3x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a3));
        a3 += 8;
        const __m256i va4x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a4));
        a4 += 8;
        const __m256i va5x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a5));
        a5 += 8;
        const __m256i va6x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a6));
        a6 += 8;
        const __m256i va7x3 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a7));
        a7 += 8;
        ...
        vacc0x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x0123, vb01234567x89AB, va0x3);
        vacc0x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc0x4567, vb89ABCDEFx89AB, va0x3);
        vacc1x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x0123, vb01234567x89AB, va1x3);
        vacc1x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc1x4567, vb89ABCDEFx89AB, va1x3);
        vacc2x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x0123, vb01234567x89AB, va2x3);
        vacc2x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc2x4567, vb89ABCDEFx89AB, va2x3);
        vacc3x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x0123, vb01234567x89AB, va3x3);
        vacc3x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc3x4567, vb89ABCDEFx89AB, va3x3);
        vacc4x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x0123, vb01234567x89AB, va4x3);
        vacc4x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc4x4567, vb89ABCDEFx89AB, va4x3);
        vacc5x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x0123, vb01234567x89AB, va5x3);
        vacc5x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc5x4567, vb89ABCDEFx89AB, va5x3);
        vacc6x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x0123, vb01234567x89AB, va6x3);
        vacc6x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc6x4567, vb89ABCDEFx89AB, va6x3);
        vacc7x0123 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x0123, vb01234567x89AB, va7x3);
        vacc7x4567 = _mm256_dpbusd_epi32_madd_qd8_qc2w(vacc7x4567, vb89ABCDEFx89AB, va7x3);
        k -= 8 * sizeof(int8_t);
      }
    }
    ...
    vacc1x01234567 = _mm256_add_epi32(vacc1x01234567, vsum1x01234567);
    ...
    vacc2x01234567 = _mm256_add_epi32(vacc2x01234567, vsum2x01234567);
    ...
    vacc3x01234567 = _mm256_add_epi32(vacc3x01234567, vsum3x01234567);
    ...
    vacc4x01234567 = _mm256_add_epi32(vacc4x01234567, vsum4x01234567);
    ...
    vacc5x01234567 = _mm256_add_epi32(vacc5x01234567, vsum5x01234567);
    ...
    vacc6x01234567 = _mm256_add_epi32(vacc6x01234567, vsum6x01234567);
    ...
    vacc7x01234567 = _mm256_add_epi32(vacc7x01234567, vsum7x01234567);
    ...
    const __m256 lh_row_sum_7 = _mm256_set1_ps(row_sum[7]);
    vout7x01234567 = _mm256_fnmadd_ps(biased_rh_zero_points_01234567, lh_row_sum_7, vout7x01234567);
    ...
    const __m256 vscaled_lh_zero_point_1 = _mm256_set1_ps((float)original_kc * quantization_params[1].zero_point);
    const __m256 vscaled_lh_zero_point_2 = _mm256_set1_ps((float)original_kc * quantization_params[2].zero_point);
    const __m256 vscaled_lh_zero_point_3 = _mm256_set1_ps((float)original_kc * quantization_params[3].zero_point);
    const __m256 vscaled_lh_zero_point_4 = _mm256_set1_ps((float)original_kc * quantization_params[4].zero_point);
    const __m256 vscaled_lh_zero_point_5 = _mm256_set1_ps((float)original_kc * quantization_params[5].zero_point);
    const __m256 vscaled_lh_zero_point_6 = _mm256_set1_ps((float)original_kc * quantization_params[6].zero_point);
    const __m256 vscaled_lh_zero_point_7 = _mm256_set1_ps((float)original_kc * quantization_params[7].zero_point);
    vout0x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_0, vout0x01234567);
    vout1x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_1, vout1x01234567);
    vout2x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_2, vout2x01234567);
    vout3x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_3, vout3x01234567);
    vout4x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_4, vout4x01234567);
    vout5x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_5, vout5x01234567);
    vout6x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_6, vout6x01234567);
    vout7x01234567 = _mm256_fmadd_ps(rh_zero_points_01234567, vscaled_lh_zero_point_7, vout7x01234567);

...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_7x1v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params)
{
  ...
  do {
    ...
    vfpacc4 = __riscv_vfmax(vfpacc4, output_min_less_zero_point, vl);
    vfpacc5 = __riscv_vfmax(vfpacc5, output_min_less_zero_point, vl);
    vfpacc6 = __riscv_vfmax(vfpacc6, output_min_less_zero_point, vl);
    ...
    vfpacc4 = __riscv_vfmin(vfpacc4, output_max_less_zero_point, vl);
    vfpacc5 = __riscv_vfmin(vfpacc5, output_max_less_zero_point, vl);
    vfpacc6 = __riscv_vfmin(vfpacc6, output_max_less_zero_point, vl);
    ...
    vint16m2_t vout4 = __riscv_vfncvt_x(vfpacc4, vl);
    vint16m2_t vout5 = __riscv_vfncvt_x(vfpacc5, vl);
    vint16m2_t vout6 = __riscv_vfncvt_x(vfpacc6, vl);
    ...
    vout4 = __riscv_vadd(vout4, (int16_t) output_zero_point, vl);
    vout5 = __riscv_vadd(vout5, (int16_t) output_zero_point, vl);
    vout6 = __riscv_vadd(vout6, (int16_t) output_zero_point, vl);

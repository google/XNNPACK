...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_3x128c4__hvx(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    HVX_Vector vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc0x2));
    HVX_Vector vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc0x3));
    ...
    HVX_Vector vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc1x2));
    HVX_Vector vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc1x3));
    ...
    HVX_Vector vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc2x2));
    HVX_Vector vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc2x3));
    ...
    vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(vscaled{M}x2, vscale2));
    vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(vscaled{M}x3, vscale3));
    vscaled{M}x0 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(vscaled{M}x0, vscale0));
    vscaled{M}x1 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(vscaled{M}x1, vscale1));
    vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(vscaled{M}x2, vscale2));
    vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(vscaled{M}x3, vscale3));
    ...
    vscaled{M}x2 = Q6_Vsf_vmin_VsfVsf(vscaled{M}x2, voutput_max_less_zero_point);
    vscaled{M}x3 = Q6_Vsf_vmin_VsfVsf(vscaled{M}x3, voutput_max_less_zero_point);
    vscaled{M}x0 = Q6_Vsf_vmin_VsfVsf(vscaled{M}x0, voutput_max_less_zero_point);
    vscaled{M}x1 = Q6_Vsf_vmin_VsfVsf(vscaled{M}x1, voutput_max_less_zero_point);
    vscaled{M}x2 = Q6_Vsf_vmin_VsfVsf(vscaled{M}x2, voutput_max_less_zero_point);
    vscaled{M}x3 = Q6_Vsf_vmin_VsfVsf(vscaled{M}x3, voutput_max_less_zero_point);
    ...
    HVX_Vector vscaled0x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x2, Q6_V_vzero());
    HVX_Vector vscaled0x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x3, Q6_V_vzero());
    ...
    HVX_Vector vscaled1x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x2, Q6_V_vzero());
    HVX_Vector vscaled1x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x3, Q6_V_vzero());
    ...
    HVX_Vector vscaled2x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x2, Q6_V_vzero());
    HVX_Vector vscaled2x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x3, Q6_V_vzero());

    vacc0x0 = Q6_Vw_convert_Vqf32(vscaled0x32_qf);
    vacc0x1 = Q6_Vw_convert_Vqf32(vscaled0x32_qf);
    vacc0x2 = Q6_Vw_convert_Vqf32(vscaled0x32_qf);
    vacc0x3 = Q6_Vw_convert_Vqf32(vscaled0x32_qf);
    vacc1x0 = Q6_Vw_convert_Vqf32(vscaled1x32_qf);
    vacc1x1 = Q6_Vw_convert_Vqf32(vscaled1x32_qf);
    vacc1x2 = Q6_Vw_convert_Vqf32(vscaled1x32_qf);
    vacc1x3 = Q6_Vw_convert_Vqf32(vscaled1x32_qf);
    vacc2x0 = Q6_Vw_convert_Vqf32(vscaled2x32_qf);
    vacc2x1 = Q6_Vw_convert_Vqf32(vscaled2x32_qf);
    vacc2x2 = Q6_Vw_convert_Vqf32(vscaled2x32_qf);
    vacc2x3 = Q6_Vw_convert_Vqf32(vscaled2x32_qf);

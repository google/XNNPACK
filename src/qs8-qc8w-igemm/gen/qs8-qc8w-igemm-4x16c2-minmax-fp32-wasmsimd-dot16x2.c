...
//   Template: src/qs8-igemm/MRx16c2-wasmsimd-dot16x2.c.in
...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c2__wasmsimd_dot16x2(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    do {
      ...
      while (k != 0) {
        v128_t va0x0123 = wasm_v128_load16_splat(a0);
        va0x0123 = wasm_i16x8_extend_low_i8x16(va0x0123);
        a0 += 2;
        v128_t va1x0123 = wasm_v128_load16_splat(a1);
        va1x0123 = wasm_i16x8_extend_low_i8x16(va1x0123);
        a1 += 2;
        v128_t va2x0123 = wasm_v128_load16_splat(a2);
        va2x0123 = wasm_i16x8_extend_low_i8x16(va2x0123);
        a2 += 2;
        v128_t va3x0123 = wasm_v128_load16_splat(a3);
        va3x0123 = wasm_i16x8_extend_low_i8x16(va3x0123);
        a3 += 2;

        const v128_t vb01234567 = wasm_v128_load((const int8_t*) w);
        const v128_t vb0123 = wasm_i16x8_extend_low_i8x16(vb01234567);
        const v128_t vb4567 = wasm_i16x8_extend_high_i8x16(vb01234567);
        const v128_t vb89ABCDEF = wasm_v128_load((const int8_t*) w + 16);
        const v128_t vb89AB = wasm_i16x8_extend_low_i8x16(vb89ABCDEF);
        const v128_t vbCDEF = wasm_i16x8_extend_high_i8x16(vb89ABCDEF);

        vacc0x0123 += wasm_i32x4_dot_i16x8(vb0123, va0x0123);
        vacc0x4567 += wasm_i32x4_dot_i16x8(vb4567, va0x0123);
        vacc0x89AB += wasm_i32x4_dot_i16x8(vb89AB, va0x0123);
        vacc0xCDEF += wasm_i32x4_dot_i16x8(vbCDEF, va0x0123);
        vacc1x0123 += wasm_i32x4_dot_i16x8(vb0123, va1x0123);
        vacc1x4567 += wasm_i32x4_dot_i16x8(vb4567, va1x0123);
        vacc1x89AB += wasm_i32x4_dot_i16x8(vb89AB, va1x0123);
        vacc1xCDEF += wasm_i32x4_dot_i16x8(vbCDEF, va1x0123);
        vacc2x0123 += wasm_i32x4_dot_i16x8(vb0123, va2x0123);
        vacc2x4567 += wasm_i32x4_dot_i16x8(vb4567, va2x0123);
        vacc2x89AB += wasm_i32x4_dot_i16x8(vb89AB, va2x0123);
        vacc2xCDEF += wasm_i32x4_dot_i16x8(vbCDEF, va2x0123);
        vacc3x0123 += wasm_i32x4_dot_i16x8(vb0123, va3x0123);
        vacc3x4567 += wasm_i32x4_dot_i16x8(vb4567, va3x0123);
        vacc3x89AB += wasm_i32x4_dot_i16x8(vb89AB, va3x0123);
        vacc3xCDEF += wasm_i32x4_dot_i16x8(vbCDEF, va3x0123);

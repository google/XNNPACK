...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_3x8c8__wasmusdot_u2(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    v128_t vout2x01234567_2x01234567 = wasm_i8x16_narrow_i16x8(vacc2x01234567, vacc2x01234567);

    vout0x01234567_1x01234567 = wasm_i8x16_min(vout0x01234567_1x01234567, voutput_max);
    vout2x01234567_2x01234567 = wasm_i8x16_min(vout2x01234567_2x01234567, voutput_max);

    if (nc >= 8) {
      wasm_v128_store64_lane(c2, vout2x01234567_2x01234567, 0);
      ...
      if (nc & 4) {
        wasm_v128_store32_lane(c2, vout2x01234567_2x01234567, 0);
        c2 += 4;
        ...
        vout2x01234567_2x01234567 = wasm_u64x2_shr(vout2x01234567_2x01234567, 32);
      }
      if (nc & 2) {
        wasm_v128_store16_lane(c2, vout2x01234567_2x01234567, 0);
        c2 += 2;
        ...
        vout2x01234567_2x01234567 = wasm_u32x4_shr(vout2x01234567_2x01234567, 16);
      }
      if (nc & 1) {
        wasm_v128_store8_lane(c2, vout2x01234567_2x01234567, 0);

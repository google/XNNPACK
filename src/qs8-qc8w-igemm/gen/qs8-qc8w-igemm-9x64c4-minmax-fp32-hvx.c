...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_9x64c4__hvx(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    HVX_Vector vscaled{M}x0 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc8x0));
    HVX_Vector vscaled{M}x1 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc8x1));
    ...
    HVX_Vector vscaled8x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x0, Q6_V_vzero());
    HVX_Vector vscaled8x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x1, Q6_V_vzero());
    ...
    vacc8x0 = Q6_Vw_convert_Vqf32(vscaled8x32_qf);
    vacc8x1 = Q6_Vw_convert_Vqf32(vscaled8x32_qf);
    ...
    vacc8x0 = Q6_Vw_vadd_VwVw(vacc8x0, voutput_zero_point);
    vacc8x1 = Q6_Vw_vadd_VwVw(vacc8x1, voutput_zero_point);
    ...
    HVX_Vector vout8x0 =  Q6_Vh_vpack_VwVw_sat(vacc8x0, vacc8x1);
    ...
    HVX_Vector vout8 = Q6_Vb_vpack_VhVh_sat(vout8x0, vout8x1);
    ...
    if XNN_LIKELY(nc >= 64) {
      Q6_V_vstu_variable(c8, 64, vout8);

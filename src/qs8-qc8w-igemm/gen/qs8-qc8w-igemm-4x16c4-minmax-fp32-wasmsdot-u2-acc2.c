...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c4__wasmsdot_u2_acc2(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    v128_t vacc3x0x0123= vacc0x0x0123;
    v128_t vacc3x1x0123= vacc0x1x0123;
    v128_t vacc3x0x4567= vacc0x0x4567;
    v128_t vacc3x1x4567= vacc0x1x4567;
    v128_t vacc3x0x89AB= vacc0x0x89AB;
    v128_t vacc3x1x89AB= vacc0x1x89AB;
    v128_t vacc3x0xCDEF= vacc0x0xCDEF;
    ...
    do {
      ...
      while (k >= 8 * sizeof(int8_t)) {
        ...
        vacc3x1x0123 = wasm_i32x4_relaxed_dot_i8x16_i7x16_add(vb1x0123, va3x1x0123, vacc3x1x0123);
        vacc3x1x4567 = wasm_i32x4_relaxed_dot_i8x16_i7x16_add(vb1x4567, va3x1x0123, vacc3x1x4567);
        vacc3x1x89AB = wasm_i32x4_relaxed_dot_i8x16_i7x16_add(vb1x89AB, va3x1x0123, vacc3x1x89AB);
        vacc3x1xCDEF = wasm_i32x4_relaxed_dot_i8x16_i7x16_add(vb1xCDEF, va3x1x0123, vacc3x1xCDEF);
      ...
      vacc3x0x0123 = wasm_i32x4_add(vacc3x0x0123, vacc3x1x0123);
      vacc3x0x4567 = wasm_i32x4_add(vacc3x0x4567, vacc3x1x4567);
      vacc3x0x89AB = wasm_i32x4_add(vacc3x0x89AB, vacc3x1x89AB);
      vacc3x0xCDEF = wasm_i32x4_add(vacc3x0xCDEF, vacc3x1xCDEF);
    ...
    vacc3x0x0123 = wasm_f32x4_mul(vacc3x0x0123, vscale0123);
    vacc3x0x4567 = wasm_f32x4_mul(vacc3x0x4567, vscale4567);
    vacc3x0x89AB = wasm_f32x4_mul(vacc3x0x89AB, vscale89AB);
    vacc3x0xCDEF = wasm_f32x4_mul(vacc3x0xCDEF, vscaleCDEF);
    ...
    vacc3x0x0123 = wasm_f32x4_add(vacc3x0x0123, vmagic_bias);
    vacc3x0x4567 = wasm_f32x4_add(vacc3x0x4567, vmagic_bias);
    vacc3x0x89AB = wasm_f32x4_add(vacc3x0x89AB, vmagic_bias);
    vacc3x0xCDEF = wasm_f32x4_add(vacc3x0xCDEF, vmagic_bias);
    ...
    vacc3x0x0123 = wasm_i32x4_max(vacc3x0x0123, vmagic_min);
    vacc3x0x4567 = wasm_i32x4_max(vacc3x0x4567, vmagic_min);
    vacc3x0x89AB = wasm_i32x4_max(vacc3x0x89AB, vmagic_min);
    vacc3x0xCDEF = wasm_i32x4_max(vacc3x0xCDEF, vmagic_min);
    ...
    vacc3x0x0123 = wasm_i32x4_sub(vacc3x0x0123, vmagic_bias_less_output_zero_point);
    vacc3x0x4567 = wasm_i32x4_sub(vacc3x0x4567, vmagic_bias_less_output_zero_point);
    vacc3x0x89AB = wasm_i32x4_sub(vacc3x0x89AB, vmagic_bias_less_output_zero_point);
    vacc3x0xCDEF = wasm_i32x4_sub(vacc3x0xCDEF, vmagic_bias_less_output_zero_point);
    ...
    v128_t vacc3x01234567 = wasm_i16x8_narrow_i32x4(vacc3x0x0123, vacc3x0x4567);
    v128_t vacc3x89ABCDEF = wasm_i16x8_narrow_i32x4(vacc3x0x89AB, vacc3x0xCDEF);

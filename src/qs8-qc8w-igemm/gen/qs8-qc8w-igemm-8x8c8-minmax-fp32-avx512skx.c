...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_8x8c8__avx256skx(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    vscaled6x01234567 = _mm256_mul_ps(vscaled6x01234567, vscale01234567);
    vscaled7x01234567 = _mm256_mul_ps(vscaled7x01234567, vscale01234567);

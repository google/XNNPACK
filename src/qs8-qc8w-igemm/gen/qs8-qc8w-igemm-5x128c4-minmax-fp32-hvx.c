...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_5x128c4__hvx(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    HVX_Vector vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc3x2));
    HVX_Vector vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc3x3));
    ...
    HVX_Vector vscaled{M}x2 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc4x2));
    HVX_Vector vscaled{M}x3 = Q6_Vsf_equals_Vqf32(Q6_Vqf32_convert_Vw(vacc4x3));
    ...
    HVX_Vector vscaled3x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x2, Q6_V_vzero());
    HVX_Vector vscaled3x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x3, Q6_V_vzero());
    ...
    HVX_Vector vscaled4x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x2, Q6_V_vzero());
    HVX_Vector vscaled4x32_qf = Q6_Vqf32_vadd_VsfVsf(vscaled{M}x3, Q6_V_vzero());
    ...
    vacc3x2 = Q6_Vw_convert_Vqf32(vscaled3x32_qf);
    vacc3x3 = Q6_Vw_convert_Vqf32(vscaled3x32_qf);
    vacc4x0 = Q6_Vw_convert_Vqf32(vscaled4x32_qf);
    vacc4x1 = Q6_Vw_convert_Vqf32(vscaled4x32_qf);
    vacc4x2 = Q6_Vw_convert_Vqf32(vscaled4x32_qf);
    vacc4x3 = Q6_Vw_convert_Vqf32(vscaled4x32_qf);
    ...
    vacc3x2 = Q6_Vw_vadd_VwVw(vacc3x2, voutput_zero_point);
    vacc3x3 = Q6_Vw_vadd_VwVw(vacc3x3, voutput_zero_point);
    vacc4x0 = Q6_Vw_vadd_VwVw(vacc4x0, voutput_zero_point);
    vacc4x1 = Q6_Vw_vadd_VwVw(vacc4x1, voutput_zero_point);
    vacc4x2 = Q6_Vw_vadd_VwVw(vacc4x2, voutput_zero_point);
    vacc4x3 = Q6_Vw_vadd_VwVw(vacc4x3, voutput_zero_point);
    ...
    HVX_Vector vout3x1 =  Q6_Vh_vpack_VwVw_sat(vacc3x2, vacc3x3);
    HVX_Vector vout4x0 =  Q6_Vh_vpack_VwVw_sat(vacc4x0, vacc4x1);
    HVX_Vector vout4x1 =  Q6_Vh_vpack_VwVw_sat(vacc4x2, vacc4x3);
    ...
    if XNN_LIKELY(nc >= 128) {
      Q6_V_vstu_variable(c4, 128, vout4);
      c4 = (int8_t*) ((uintptr_t) c4 + cn_stride);
      Q6_V_vstu_variable(c3, 128, vout3);

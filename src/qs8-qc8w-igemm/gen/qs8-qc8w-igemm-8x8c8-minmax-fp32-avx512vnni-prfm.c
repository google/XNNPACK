...
void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_8x8c8__avx512vnni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m128i voutb5x01234567 = _mm256_cvtsepi32_epi8(vacc5x0123);
    __m128i voutb6x01234567 = _mm256_cvtsepi32_epi8(vacc6x0123);
    __m128i voutb7x01234567 = _mm256_cvtsepi32_epi8(vacc7x0123);

...
void xnn_s32_vmulc_minmax_ukernel__avx2_u8(
    size_t batch,
...
void xnn_s32_vmulc_minmax_ukernel__avx2_u16(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
...
void xnn_s32_vmulc_minmax_ukernel__avx2_u24(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
...
void xnn_s32_vmulc_minmax_ukernel__avx2_u32(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,

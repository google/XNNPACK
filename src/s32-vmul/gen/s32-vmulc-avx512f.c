...
void xnn_s32_vmulc_minmax_ukernel__avx512f_u16(
    size_t batch,
    ...
    const union xnn_s32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  xnn_simd_s32_t voutput_min = xnn_set1_s32(&params->avx512f.min);
  xnn_simd_s32_t voutput_max = xnn_set1_s32(&params->avx512f.max);
...
void xnn_s32_vmulc_minmax_ukernel__avx512f_u48(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
...
void xnn_s32_vmulc_minmax_ukernel__avx512f_u64(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,

...
#include "xnnpack/simd/u32-neon.h"

#include "xnnpack/common.h"
#include "xnnpack/microparams.h"


void xnn_u32_f32_vcvt_ukernel__neon_u4(
    size_t batch,
...
void xnn_u32_f32_vcvt_ukernel__neon_u8(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_u32_f32_vcvt_ukernel__neon_u12(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_u32_f32_vcvt_ukernel__neon_u16(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])

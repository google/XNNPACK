...
void xnn_u32_f32_vcvt_ukernel__scalar_u1(
    size_t batch,
...
void xnn_u32_f32_vcvt_ukernel__scalar_u2(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(int32_t); batch -= 2 * sizeof(uint32_t)) {
...
void xnn_u32_f32_vcvt_ukernel__scalar_u3(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 3 * sizeof(int32_t); batch -= 3 * sizeof(uint32_t)) {
    const xnn_simd_u32_t vx0 = xnn_loadu_u32(input);
    const xnn_simd_u32_t vx1 = xnn_loadu_u32(input + 1 * xnn_simd_size_u32);
...
void xnn_u32_f32_vcvt_ukernel__scalar_u4(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int32_t); batch -= 4 * sizeof(uint32_t)) {
    const xnn_simd_u32_t vx0 = xnn_loadu_u32(input);
    const xnn_simd_u32_t vx1 = xnn_loadu_u32(input + 1 * xnn_simd_size_u32);
    const xnn_simd_u32_t vx2 = xnn_loadu_u32(input + 2 * xnn_simd_size_u32);

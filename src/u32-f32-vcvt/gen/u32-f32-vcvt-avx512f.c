...
void xnn_u32_f32_vcvt_ukernel__avx512f_u16(
    size_t batch,
...
void xnn_u32_f32_vcvt_ukernel__avx512f_u32(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_u32_f32_vcvt_ukernel__avx512f_u48(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 48 * sizeof(int32_t); batch -= 48 * sizeof(uint32_t)) {
    const xnn_simd_u32_t vx0 = xnn_loadu_u32(input);
    const xnn_simd_u32_t vx1 = xnn_loadu_u32(input + 1 * xnn_simd_size_u32);
...
void xnn_u32_f32_vcvt_ukernel__avx512f_u64(
    size_t batch,
    const uint32_t* input,
    float* output,
    const struct xnn_u32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(int32_t); batch -= 64 * sizeof(uint32_t)) {
    const xnn_simd_u32_t vx0 = xnn_loadu_u32(input);
    const xnn_simd_u32_t vx1 = xnn_loadu_u32(input + 1 * xnn_simd_size_u32);
    const xnn_simd_u32_t vx2 = xnn_loadu_u32(input + 2 * xnn_simd_size_u32);

...
void xnn_bf16_rminmax_ukernel__neon_u24_acc3(
    size_t batch,
    ...
    const struct xnn_bf16_default_params* restrict params) XNN_OOB_READS
{
  ...
  int16x8_t vmax0 = vreinterpretq_s16_u16(vld1q_dup_u16((uint16_t*)((uintptr_t) o + 1 * sizeof(uint16_t))));
  ...
  #endif
  o[1] = (uint16_t)(vmax_s ^ ((vmax_s >> 15) & 0x7FFF));
}

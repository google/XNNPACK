...
void xnn_bf16_rmax_ukernel__neon_u32_acc2(
    size_t batch,
    ...
    const struct xnn_bf16_default_params* restrict params) XNN_OOB_READS
{
  ...
  for (; batch >= 32 * sizeof(uint16_t); batch -= 32 * sizeof(uint16_t)) {
    ...
    const int16x8_t vi3 = vreinterpretq_s16_u16(vld1q_u16(i)); i += 8;
    ...
    const int16x8_t vt3 = veorq_s16(vi3, vreinterpretq_s16_u16(vandq_u16(vreinterpretq_u16_s16(vshrq_n_s16(vi3, 15)), vsign_mask)));

    vmax0 = vmaxq_s16(vmax0, vt0);
    vmax1 = vmaxq_s16(vmax1, vt1);
    vmax0 = vmaxq_s16(vmax0, vt2);
    vmax1 = vmaxq_s16(vmax1, vt3);
  }
  vmax0 = vmaxq_s16(vmax0, vmax1);

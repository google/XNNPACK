...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_4x4__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 4) {
      ...
      c2[0] = xnn_bfloat16_from_float(vout2x0);
      c2[1] = xnn_bfloat16_from_float(vout2x1);
      c2[2] = xnn_bfloat16_from_float(vout2x2);
      c2[3] = xnn_bfloat16_from_float(vout2x3);
      c3[0] = xnn_bfloat16_from_float(vout3x0);
      c3[1] = xnn_bfloat16_from_float(vout3x1);
      c3[2] = xnn_bfloat16_from_float(vout3x2);
      c3[3] = xnn_bfloat16_from_float(vout3x3);

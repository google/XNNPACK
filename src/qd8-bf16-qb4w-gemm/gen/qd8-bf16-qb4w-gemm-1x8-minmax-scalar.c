...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_1x8__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      c0[4] = xnn_bfloat16_from_float(vout0x4);
      c0[5] = xnn_bfloat16_from_float(vout0x5);
      c0[6] = xnn_bfloat16_from_float(vout0x6);
      c0[7] = xnn_bfloat16_from_float(vout0x7);

...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_6x32c8__neoni8mmbf16(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    size_t cm_stride,
    size_t cn_stride,
    const struct xnn_bf16_qb4w_minmax_params* restrict params,
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    float32x4_t vout4xGHIJ = vmulq_lane_f32(vksumGHIJ, vget_low_f32(vinput_zero_point45), 0);
    float32x4_t vout5xGHIJ = vmulq_lane_f32(vksumGHIJ, vget_high_f32(vinput_zero_point45), 0);
    float32x4_t vout4xKLMN = vmulq_lane_f32(vksumKLMN, vget_low_f32(vinput_zero_point45), 0);
    float32x4_t vout5xKLMN = vmulq_lane_f32(vksumKLMN, vget_high_f32(vinput_zero_point45), 0);
    float32x4_t vout4xOPQR = vmulq_lane_f32(vksumOPQR, vget_low_f32(vinput_zero_point45), 0);
    float32x4_t vout5xOPQR = vmulq_lane_f32(vksumOPQR, vget_high_f32(vinput_zero_point45), 0);
    float32x4_t vout4xSTUV = vmulq_lane_f32(vksumSTUV, vget_low_f32(vinput_zero_point45), 0);
    ...
    for (size_t kb=0; kb < kc; kb += bl) {
      ...
      while (k >= 16 * sizeof(int8_t)) {
        ...
        // Multiply-accumulate: 6x8 * 8x32 --> 6x32.
      ...
      if XNN_UNLIKELY(k != 0) {
        ...
        // Multiply-accumulate: 6x4 * 4x32 --> 6x32.
      ...
      float32x4_t vf5xGHIJ = vcvtq_f32_s32(vacc5xGHIJ);
      vout5xGHIJ = vfmaq_f32(vout5xGHIJ, vf5xGHIJ, vfilter_output_scaleGHIJ);
      float32x4_t vf5xKLMN = vcvtq_f32_s32(vacc5xKLMN);
      vout5xKLMN = vfmaq_f32(vout5xKLMN, vf5xKLMN, vfilter_output_scaleKLMN);
      float32x4_t vf5xOPQR = vcvtq_f32_s32(vacc5xOPQR);
      vout5xOPQR = vfmaq_f32(vout5xOPQR, vf5xOPQR, vfilter_output_scaleOPQR);
    ...
    vout5xGHIJ = vaddq_f32(vbiasGHIJ, vout5xGHIJ);
    ...
    vout5xKLMN = vaddq_f32(vbiasKLMN, vout5xKLMN);
    ...
    vout5xOPQR = vaddq_f32(vbiasOPQR, vout5xOPQR);
    ...
    vout5xSTUV = vaddq_f32(vbiasSTUV, vout5xSTUV);
    ...
    vout5xGHIJ = vmaxq_f32(vout5xGHIJ, voutput_min);
    vout5xKLMN = vmaxq_f32(vout5xKLMN, voutput_min);
    vout5xOPQR = vmaxq_f32(vout5xOPQR, voutput_min);
    vout5xSTUV = vmaxq_f32(vout5xSTUV, voutput_min);
    ...
    vout5xGHIJ = vminq_f32(vout5xGHIJ, voutput_max);
    vout5xKLMN = vminq_f32(vout5xKLMN, voutput_max);
    vout5xOPQR = vminq_f32(vout5xOPQR, voutput_max);
    vout5xSTUV = vminq_f32(vout5xSTUV, voutput_max);

    uint16x8_t vbf16out0x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout0x0123), vcvt_bf16_f32(vout0x4567)));
    uint16x8_t vbf16out0x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout0x89AB), vcvt_bf16_f32(vout0xCDEF)));
    uint16x8_t vbf16out0xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout0xGHIJ), vcvt_bf16_f32(vout0xKLMN)));
    uint16x8_t vbf16out0xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout0xOPQR), vcvt_bf16_f32(vout0xSTUV)));
    uint16x8_t vbf16out1x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout1x0123), vcvt_bf16_f32(vout1x4567)));
    uint16x8_t vbf16out1x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout1x89AB), vcvt_bf16_f32(vout1xCDEF)));
    uint16x8_t vbf16out1xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout1xGHIJ), vcvt_bf16_f32(vout1xKLMN)));
    uint16x8_t vbf16out1xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout1xOPQR), vcvt_bf16_f32(vout1xSTUV)));
    uint16x8_t vbf16out2x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout2x0123), vcvt_bf16_f32(vout2x4567)));
    uint16x8_t vbf16out2x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout2x89AB), vcvt_bf16_f32(vout2xCDEF)));
    uint16x8_t vbf16out2xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout2xGHIJ), vcvt_bf16_f32(vout2xKLMN)));
    uint16x8_t vbf16out2xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout2xOPQR), vcvt_bf16_f32(vout2xSTUV)));
    uint16x8_t vbf16out3x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout3x0123), vcvt_bf16_f32(vout3x4567)));
    uint16x8_t vbf16out3x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout3x89AB), vcvt_bf16_f32(vout3xCDEF)));
    uint16x8_t vbf16out3xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout3xGHIJ), vcvt_bf16_f32(vout3xKLMN)));
    uint16x8_t vbf16out3xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout3xOPQR), vcvt_bf16_f32(vout3xSTUV)));
    uint16x8_t vbf16out4x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout4x0123), vcvt_bf16_f32(vout4x4567)));
    uint16x8_t vbf16out4x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout4x89AB), vcvt_bf16_f32(vout4xCDEF)));
    uint16x8_t vbf16out4xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout4xGHIJ), vcvt_bf16_f32(vout4xKLMN)));
    uint16x8_t vbf16out4xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout4xOPQR), vcvt_bf16_f32(vout4xSTUV)));
    uint16x8_t vbf16out5x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout5x0123), vcvt_bf16_f32(vout5x4567)));
    uint16x8_t vbf16out5x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout5x89AB), vcvt_bf16_f32(vout5xCDEF)));
    uint16x8_t vbf16out5xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout5xGHIJ), vcvt_bf16_f32(vout5xKLMN)));
    uint16x8_t vbf16out5xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout5xOPQR), vcvt_bf16_f32(vout5xSTUV)));
    if XNN_LIKELY(nc >= 32) {
      vst1q_u16(c0, vbf16out0x01234567);
      vst1q_u16(c0 + 8, vbf16out0x89ABCDEF);
      vst1q_u16(c0 + 16, vbf16out0xGHIJKLMN);
      vst1q_u16(c0 + 24, vbf16out0xOPQRSTUV);
      vst1q_u16(c1, vbf16out1x01234567);
      vst1q_u16(c1 + 8, vbf16out1x89ABCDEF);
      vst1q_u16(c1 + 16, vbf16out1xGHIJKLMN);
      vst1q_u16(c1 + 24, vbf16out1xOPQRSTUV);
      vst1q_u16(c2, vbf16out2x01234567);
      vst1q_u16(c2 + 8, vbf16out2x89ABCDEF);
      vst1q_u16(c2 + 16, vbf16out2xGHIJKLMN);
      vst1q_u16(c2 + 24, vbf16out2xOPQRSTUV);
      vst1q_u16(c3, vbf16out3x01234567);
      vst1q_u16(c3 + 8, vbf16out3x89ABCDEF);
      vst1q_u16(c3 + 16, vbf16out3xGHIJKLMN);
      vst1q_u16(c3 + 24, vbf16out3xOPQRSTUV);
      vst1q_u16(c4, vbf16out4x01234567);
      vst1q_u16(c4 + 8, vbf16out4x89ABCDEF);
      vst1q_u16(c4 + 16, vbf16out4xGHIJKLMN);
      vst1q_u16(c4 + 24, vbf16out4xOPQRSTUV);
      vst1q_u16(c5, vbf16out5x01234567);
      vst1q_u16(c5 + 8, vbf16out5x89ABCDEF);
      vst1q_u16(c5 + 16, vbf16out5xGHIJKLMN);
      vst1q_u16(c5 + 24, vbf16out5xOPQRSTUV);
     ...
     if (nc & 16) {
       vst1q_u16(c0, vbf16out0x01234567); c0 += 8;
       vbf16out0x01234567 = vbf16out0xGHIJKLMN;
       vst1q_u16(c1, vbf16out1x01234567); c1 += 8;
       vbf16out1x01234567 = vbf16out1xGHIJKLMN;
       vst1q_u16(c2, vbf16out2x01234567); c2 += 8;
       vbf16out2x01234567 = vbf16out2xGHIJKLMN;
       vst1q_u16(c3, vbf16out3x01234567); c3 += 8;
       vbf16out3x01234567 = vbf16out3xGHIJKLMN;
       vst1q_u16(c4, vbf16out4x01234567); c4 += 8;
       vbf16out4x01234567 = vbf16out4xGHIJKLMN;
       vst1q_u16(c5, vbf16out5x01234567); c5 += 8;
       vbf16out5x01234567 = vbf16out5xGHIJKLMN;
       vst1q_u16(c0, vbf16out0x89ABCDEF); c0 += 8;
       vbf16out0x89ABCDEF = vbf16out0xOPQRSTUV;
       vst1q_u16(c1, vbf16out1x89ABCDEF); c1 += 8;
       vbf16out1x89ABCDEF = vbf16out1xOPQRSTUV;
       vst1q_u16(c2, vbf16out2x89ABCDEF); c2 += 8;
       vbf16out2x89ABCDEF = vbf16out2xOPQRSTUV;
       vst1q_u16(c3, vbf16out3x89ABCDEF); c3 += 8;
       vbf16out3x89ABCDEF = vbf16out3xOPQRSTUV;
       vst1q_u16(c4, vbf16out4x89ABCDEF); c4 += 8;
       vbf16out4x89ABCDEF = vbf16out4xOPQRSTUV;
       vst1q_u16(c5, vbf16out5x89ABCDEF); c5 += 8;
       vbf16out5x89ABCDEF = vbf16out5xOPQRSTUV;
     }
     if (nc & 8) {
       vst1q_u16(c0, vbf16out0x01234567); c0 += 8;
       vbf16out0x01234567 = vbf16out0x89ABCDEF;
       vst1q_u16(c1, vbf16out1x01234567); c1 += 8;
       vbf16out1x01234567 = vbf16out1x89ABCDEF;
       vst1q_u16(c2, vbf16out2x01234567); c2 += 8;
       vbf16out2x01234567 = vbf16out2x89ABCDEF;
       vst1q_u16(c3, vbf16out3x01234567); c3 += 8;
       vbf16out3x01234567 = vbf16out3x89ABCDEF;
       vst1q_u16(c4, vbf16out4x01234567); c4 += 8;
       vbf16out4x01234567 = vbf16out4x89ABCDEF;
       vst1q_u16(c5, vbf16out5x01234567); c5 += 8;
       vbf16out5x01234567 = vbf16out5x89ABCDEF;
     }
     uint16x4_t vbf16out0x0123 = vget_low_u16(vbf16out0x01234567);
     uint16x4_t vbf16out1x0123 = vget_low_u16(vbf16out1x01234567);
     uint16x4_t vbf16out2x0123 = vget_low_u16(vbf16out2x01234567);
     uint16x4_t vbf16out3x0123 = vget_low_u16(vbf16out3x01234567);
     uint16x4_t vbf16out4x0123 = vget_low_u16(vbf16out4x01234567);
     uint16x4_t vbf16out5x0123 = vget_low_u16(vbf16out5x01234567);
     if (nc & 4) {
       vst1_u16(c0, vbf16out0x0123); c0 += 4;
       vst1_u16(c1, vbf16out1x0123); c1 += 4;
       vst1_u16(c2, vbf16out2x0123); c2 += 4;
       vst1_u16(c3, vbf16out3x0123); c3 += 4;
       vst1_u16(c4, vbf16out4x0123); c4 += 4;
       vst1_u16(c5, vbf16out5x0123); c5 += 4;
       vbf16out0x0123 = vget_high_u16(vbf16out0x01234567);
       vbf16out1x0123 = vget_high_u16(vbf16out1x01234567);
       vbf16out2x0123 = vget_high_u16(vbf16out2x01234567);
       vbf16out3x0123 = vget_high_u16(vbf16out3x01234567);
       vbf16out4x0123 = vget_high_u16(vbf16out4x01234567);
       vbf16out5x0123 = vget_high_u16(vbf16out5x01234567);
     }
     if (nc & 2) {
       vst1_lane_u32((void*) c0, vreinterpret_u32_u16(vbf16out0x0123), 0); c0 += 2;
       vst1_lane_u32((void*) c1, vreinterpret_u32_u16(vbf16out1x0123), 0); c1 += 2;
       vst1_lane_u32((void*) c2, vreinterpret_u32_u16(vbf16out2x0123), 0); c2 += 2;
       vst1_lane_u32((void*) c3, vreinterpret_u32_u16(vbf16out3x0123), 0); c3 += 2;
       vst1_lane_u32((void*) c4, vreinterpret_u32_u16(vbf16out4x0123), 0); c4 += 2;
       vst1_lane_u32((void*) c5, vreinterpret_u32_u16(vbf16out5x0123), 0); c5 += 2;
       vbf16out0x0123 = vext_u16(vbf16out0x0123, vbf16out0x0123, 2);
       vbf16out1x0123 = vext_u16(vbf16out1x0123, vbf16out1x0123, 2);
       vbf16out2x0123 = vext_u16(vbf16out2x0123, vbf16out2x0123, 2);
       vbf16out3x0123 = vext_u16(vbf16out3x0123, vbf16out3x0123, 2);
       vbf16out4x0123 = vext_u16(vbf16out4x0123, vbf16out4x0123, 2);
       vbf16out5x0123 = vext_u16(vbf16out5x0123, vbf16out5x0123, 2);
     }
     if (nc & 1) {
       vst1_lane_u16(c0, vbf16out0x0123, 0);
       vst1_lane_u16(c1, vbf16out1x0123, 0);
       vst1_lane_u16(c2, vbf16out2x0123, 0);
       vst1_lane_u16(c3, vbf16out3x0123, 0);
       vst1_lane_u16(c4, vbf16out4x0123, 0);
       vst1_lane_u16(c5, vbf16out5x0123, 0);
     }
      nc = 0;
    }
  } while (nc != 0);

...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_8x16c8__neoni8mmbf16(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    float32x4_t vout6x89AB = vmulq_lane_f32(vksum89AB, vget_low_f32(vinput_zero_point67), 0);
    float32x4_t vout7x89AB = vmulq_lane_f32(vksum89AB, vget_high_f32(vinput_zero_point67), 0);
    float32x4_t vout6xCDEF = vmulq_lane_f32(vksumCDEF, vget_low_f32(vinput_zero_point67), 0);
    ...
    for (size_t kb=0; kb < kc; kb += bl) {
      ...
      float32x4_t vf7x89AB = vcvtq_f32_s32(vacc7x89AB);
      vout7x89AB = vfmaq_f32(vout7x89AB, vf7x89AB, vfilter_output_scale89AB);
      float32x4_t vf7xCDEF = vcvtq_f32_s32(vacc7xCDEF);
      vout7xCDEF = vfmaq_f32(vout7xCDEF, vf7xCDEF, vfilter_output_scaleCDEF);
    }
    ...
    vout7x89AB = vaddq_f32(vbias89AB, vout7x89AB);
    ...
    vout7xCDEF = vaddq_f32(vbiasCDEF, vout7xCDEF);
    ...
    uint16x8_t vbf16out6x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout6x0123), vcvt_bf16_f32(vout6x4567)));
    uint16x8_t vbf16out6x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout6x89AB), vcvt_bf16_f32(vout6xCDEF)));
    uint16x8_t vbf16out7x01234567 = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout7x0123), vcvt_bf16_f32(vout7x4567)));
    uint16x8_t vbf16out7x89ABCDEF = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout7x89AB), vcvt_bf16_f32(vout7xCDEF)));
    if XNN_LIKELY(nc >= 16) {
      ...
      vst1q_u16(c6, vbf16out6x01234567);
      vst1q_u16(c6 + 8, vbf16out6x89ABCDEF);
      vst1q_u16(c7, vbf16out7x01234567);
      vst1q_u16(c7 + 8, vbf16out7x89ABCDEF);
     ...
     if (nc & 8) {
       ...
       vst1q_u16(c6, vbf16out6x01234567); c6 += 8;
       vbf16out6x01234567 = vbf16out6x89ABCDEF;
       vst1q_u16(c7, vbf16out7x01234567); c7 += 8;
       vbf16out7x01234567 = vbf16out7x89ABCDEF;
     }
     ...
     uint16x4_t vbf16out6x0123 = vget_low_u16(vbf16out6x01234567);
     uint16x4_t vbf16out7x0123 = vget_low_u16(vbf16out7x01234567);
     if (nc & 4) {
       ...
       vst1_u16(c6, vbf16out6x0123); c6 += 4;
       vst1_u16(c7, vbf16out7x0123); c7 += 4;
       ...
       vbf16out6x0123 = vget_high_u16(vbf16out6x01234567);
       vbf16out7x0123 = vget_high_u16(vbf16out7x01234567);
     }
     if (nc & 2) {
       ...
       vst1_lane_u32((void*) c6, vreinterpret_u32_u16(vbf16out6x0123), 0); c6 += 2;
       vst1_lane_u32((void*) c7, vreinterpret_u32_u16(vbf16out7x0123), 0); c7 += 2;
       ...
       vbf16out6x0123 = vext_u16(vbf16out6x0123, vbf16out6x0123, 2);
       vbf16out7x0123 = vext_u16(vbf16out7x0123, vbf16out7x0123, 2);
     }
     if (nc & 1) {
       ...
       vst1_lane_u16(c6, vbf16out6x0123, 0);
       vst1_lane_u16(c7, vbf16out7x0123, 0);
     }
      nc = 0;
    }
  } while (nc != 0);

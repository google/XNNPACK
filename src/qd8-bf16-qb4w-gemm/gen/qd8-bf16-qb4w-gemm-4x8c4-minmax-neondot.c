...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_4x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    const uint32x4_t vrnebias = vdupq_n_u32(0x7FFFu);
    const uint32x4_t vone = vdupq_n_u32(1u);
    uint32x4_t vlo0x0123   = vreinterpretq_u32_f32(vout0x0123);
    uint32x4_t vhi0x4567 = vreinterpretq_u32_f32(vout0x4567);
    vlo0x0123   = vaddq_u32(vlo0x0123,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo0x0123,   16), vone)));
    vhi0x4567 = vaddq_u32(vhi0x4567, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi0x4567, 16), vone)));
    uint16x8_t vbf16out0x01234567 =
        vcombine_u16(vshrn_n_u32(vlo0x0123, 16),
                    vshrn_n_u32(vhi0x4567, 16));
    uint32x4_t vlo1x0123   = vreinterpretq_u32_f32(vout1x0123);
    uint32x4_t vhi1x4567 = vreinterpretq_u32_f32(vout1x4567);
    vlo1x0123   = vaddq_u32(vlo1x0123,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo1x0123,   16), vone)));
    vhi1x4567 = vaddq_u32(vhi1x4567, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi1x4567, 16), vone)));
    uint16x8_t vbf16out1x01234567 =
        vcombine_u16(vshrn_n_u32(vlo1x0123, 16),
                    vshrn_n_u32(vhi1x4567, 16));
    uint32x4_t vlo2x0123   = vreinterpretq_u32_f32(vout2x0123);
    uint32x4_t vhi2x4567 = vreinterpretq_u32_f32(vout2x4567);
    vlo2x0123   = vaddq_u32(vlo2x0123,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo2x0123,   16), vone)));
    vhi2x4567 = vaddq_u32(vhi2x4567, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi2x4567, 16), vone)));
    uint16x8_t vbf16out2x01234567 =
        vcombine_u16(vshrn_n_u32(vlo2x0123, 16),
                    vshrn_n_u32(vhi2x4567, 16));
    uint32x4_t vlo3x0123   = vreinterpretq_u32_f32(vout3x0123);
    uint32x4_t vhi3x4567 = vreinterpretq_u32_f32(vout3x4567);
    vlo3x0123   = vaddq_u32(vlo3x0123,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo3x0123,   16), vone)));
    vhi3x4567 = vaddq_u32(vhi3x4567, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi3x4567, 16), vone)));
    uint16x8_t vbf16out3x01234567 =
        vcombine_u16(vshrn_n_u32(vlo3x0123, 16),
                    vshrn_n_u32(vhi3x4567, 16));
    if XNN_LIKELY(nc >= 8) {

...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_8x32c8__neoni8mmbf16(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    uint16x8_t vbf16out7xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout7xGHIJ), vcvt_bf16_f32(vout7xKLMN)));
    uint16x8_t vbf16out7xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout7xOPQR), vcvt_bf16_f32(vout7xSTUV)));
    if XNN_LIKELY(nc >= 32) {
      ...
      vst1q_u16(c7 + 16, vbf16out7xGHIJKLMN);
      vst1q_u16(c7 + 24, vbf16out7xOPQRSTUV);
     ...
     if (nc & 16) {
       ...
       vbf16out7x01234567 = vbf16out7xGHIJKLMN;
       ...
       vst1q_u16(c7, vbf16out7x89ABCDEF); c7 += 8;
       vbf16out7x89ABCDEF = vbf16out7xOPQRSTUV;
     }
     if (nc & 8) {
       vst1q_u16(c0, vbf16out0x01234567); c0 += 8;

...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_7x32c8__neoni8mmbf16(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    float32x4_t vout6xGHIJ = vmulq_f32(vksumGHIJ, vinput_zero_point67);
    float32x4_t vout6xKLMN = vmulq_f32(vksumKLMN, vinput_zero_point67);
    float32x4_t vout6xOPQR = vmulq_f32(vksumOPQR, vinput_zero_point67);
    ...
    for (size_t kb=0; kb < kc; kb += bl) {
      ...
      int32x4_t vacc67xGH = vdupq_n_s32(0);
      int32x4_t vacc67xIJ = vdupq_n_s32(0);
      int32x4_t vacc67xKL = vdupq_n_s32(0);
      int32x4_t vacc67xMN = vdupq_n_s32(0);
      int32x4_t vacc67xOP = vdupq_n_s32(0);
      int32x4_t vacc67xQR = vdupq_n_s32(0);
      int32x4_t vacc67xST = vdupq_n_s32(0);
      int32x4_t vacc67xUV = vdupq_n_s32(0);
      ...
      float32x4_t vf6xGHIJ = vcvtq_f32_s32(vacc6xGHIJ);
      vout6xGHIJ = vfmaq_f32(vout6xGHIJ, vf6xGHIJ, vfilter_output_scaleGHIJ);
      float32x4_t vf6xKLMN = vcvtq_f32_s32(vacc6xKLMN);
      vout6xKLMN = vfmaq_f32(vout6xKLMN, vf6xKLMN, vfilter_output_scaleKLMN);
      float32x4_t vf6xOPQR = vcvtq_f32_s32(vacc6xOPQR);
      vout6xOPQR = vfmaq_f32(vout6xOPQR, vf6xOPQR, vfilter_output_scaleOPQR);
      float32x4_t vf6xSTUV = vcvtq_f32_s32(vacc6xSTUV);
      vout6xSTUV = vfmaq_f32(vout6xSTUV, vf6xSTUV, vfilter_output_scaleSTUV);
    }
    ...
    vout6xGHIJ = vaddq_f32(vbiasGHIJ, vout6xGHIJ);
    ...
    vout6xKLMN = vaddq_f32(vbiasKLMN, vout6xKLMN);
    ...
    vout6xOPQR = vaddq_f32(vbiasOPQR, vout6xOPQR);
    ...
    vout6xSTUV = vaddq_f32(vbiasSTUV, vout6xSTUV);
    ...
    vout6xGHIJ = vmaxq_f32(vout6xGHIJ, voutput_min);
    vout6xKLMN = vmaxq_f32(vout6xKLMN, voutput_min);
    vout6xOPQR = vmaxq_f32(vout6xOPQR, voutput_min);
    vout6xSTUV = vmaxq_f32(vout6xSTUV, voutput_min);
    ...
    vout6xGHIJ = vminq_f32(vout6xGHIJ, voutput_max);
    vout6xKLMN = vminq_f32(vout6xKLMN, voutput_max);
    vout6xOPQR = vminq_f32(vout6xOPQR, voutput_max);
    vout6xSTUV = vminq_f32(vout6xSTUV, voutput_max);
    ...
    uint16x8_t vbf16out6xGHIJKLMN = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout6xGHIJ), vcvt_bf16_f32(vout6xKLMN)));
    uint16x8_t vbf16out6xOPQRSTUV = vreinterpretq_u16_bf16(vcombine_bf16(vcvt_bf16_f32(vout6xOPQR), vcvt_bf16_f32(vout6xSTUV)));
    if XNN_LIKELY(nc >= 32) {
      ...
      vst1q_u16(c6 + 16, vbf16out6xGHIJKLMN);
      vst1q_u16(c6 + 24, vbf16out6xOPQRSTUV);
     ...
     if (nc & 16) {
       ...
       vbf16out6x01234567 = vbf16out6xGHIJKLMN;
       ...
       vst1q_u16(c6, vbf16out6x89ABCDEF); c6 += 8;
       vbf16out6x89ABCDEF = vbf16out6xOPQRSTUV;
     }
     if (nc & 8) {
       vst1q_u16(c0, vbf16out0x01234567); c0 += 8;

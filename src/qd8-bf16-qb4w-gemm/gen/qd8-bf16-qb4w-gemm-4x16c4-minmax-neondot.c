...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_4x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const uint16x8_t vbias01234567 = vld1q_u16(w); w = (const uint16_t*) w + 8;
    const uint16x8_t vbias89ABCDEF = vld1q_u16(w); w = (const uint16_t*) w + 8;
    const float32x4_t vbias0123 = vreinterpretq_f32_u16(vshll_n_u16(vget_low_u16(vbias01234567), 16));
    const float32x4_t vbias4567 = vreinterpretq_f32_u16(vshll_n_u16(vget_high_u16(vbias01234567), 16));
    const float32x4_t vbias89AB = vreinterpretq_f32_u16(vshll_n_u16(vget_low_u16(vbias89ABCDEF), 16));
    const float32x4_t vbiasCDEF = vreinterpretq_f32_u16(vshll_n_u16(vget_high_u16(vbias89ABCDEF), 16));
    ...
    uint16x8_t vbf16out0x01234567 = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout0x0123)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout0x4567)), 16));
    uint16x8_t vbf16out0x89ABCDEF = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout0x89AB)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout0xCDEF)), 16));
    uint16x8_t vbf16out1x01234567 = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout1x0123)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout1x4567)), 16));
    uint16x8_t vbf16out1x89ABCDEF = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout1x89AB)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout1xCDEF)), 16));
    uint16x8_t vbf16out2x01234567 = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout2x0123)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout2x4567)), 16));
    uint16x8_t vbf16out2x89ABCDEF = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout2x89AB)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout2xCDEF)), 16));
    uint16x8_t vbf16out3x01234567 = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout3x0123)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout3x4567)), 16));
    uint16x8_t vbf16out3x89ABCDEF = vcombine_u16(vshrn_n_u32(vreinterpretq_u32_f32((vout3x89AB)), 16), vshrn_n_u32(vreinterpretq_u32_f32((vout3xCDEF)), 16));
    ...
    if XNN_LIKELY(nc >= 16) {
     ...
     bfloat16x4_t vbf16out0x0123 = vget_low_u16(vbf16out0x01234567);
     bfloat16x4_t vbf16out1x0123 = vget_low_u16(vbf16out1x01234567);
     bfloat16x4_t vbf16out2x0123 = vget_low_u16(vbf16out2x01234567);
     bfloat16x4_t vbf16out3x0123 = vget_low_u16(vbf16out3x01234567);
     if (nc & 4) {

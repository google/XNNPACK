...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_5x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    uint32x4_t vlo4x0123   = vreinterpretq_u32_f32(vout4x0123);
    uint32x4_t vhi4x4567 = vreinterpretq_u32_f32(vout4x4567);
    vlo4x0123   = vaddq_u32(vlo4x0123,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo4x0123,   16), vone)));
    vhi4x4567 = vaddq_u32(vhi4x4567, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi4x4567, 16), vone)));
    uint16x8_t vbf16out4x01234567 =
        vcombine_u16(vshrn_n_u32(vlo4x0123, 16),
                    vshrn_n_u32(vhi4x4567, 16));
    if XNN_LIKELY(nc >= 8) {

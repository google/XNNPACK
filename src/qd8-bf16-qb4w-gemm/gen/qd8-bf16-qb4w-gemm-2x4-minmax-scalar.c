...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_2x4__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 4) {
      c0[0] = xnn_bfloat16_from_float(vout0x0);
      c0[1] = xnn_bfloat16_from_float(vout0x1);
      c0[2] = xnn_bfloat16_from_float(vout0x2);
      c0[3] = xnn_bfloat16_from_float(vout0x3);
      c1[0] = xnn_bfloat16_from_float(vout1x0);
      c1[1] = xnn_bfloat16_from_float(vout1x1);
      c1[2] = xnn_bfloat16_from_float(vout1x2);
      c1[3] = xnn_bfloat16_from_float(vout1x3);

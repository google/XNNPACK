...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_3x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    uint32x4_t vlo0x89AB   = vreinterpretq_u32_f32(vout0x89AB);
    uint32x4_t vhi0xCDEF = vreinterpretq_u32_f32(vout0xCDEF);
    vlo0x89AB   = vaddq_u32(vlo0x89AB,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo0x89AB,   16), vone)));
    vhi0xCDEF = vaddq_u32(vhi0xCDEF, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi0xCDEF, 16), vone)));
    uint16x8_t vbf16out0x89ABCDEF =
        vcombine_u16(vshrn_n_u32(vlo0x89AB, 16),
                    vshrn_n_u32(vhi0xCDEF, 16));
    ...
    uint32x4_t vlo1x89AB   = vreinterpretq_u32_f32(vout1x89AB);
    uint32x4_t vhi1xCDEF = vreinterpretq_u32_f32(vout1xCDEF);
    vlo1x89AB   = vaddq_u32(vlo1x89AB,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo1x89AB,   16), vone)));
    vhi1xCDEF = vaddq_u32(vhi1xCDEF, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi1xCDEF, 16), vone)));
    uint16x8_t vbf16out1x89ABCDEF =
        vcombine_u16(vshrn_n_u32(vlo1x89AB, 16),
                    vshrn_n_u32(vhi1xCDEF, 16));
    ...
    uint32x4_t vlo2x89AB   = vreinterpretq_u32_f32(vout2x89AB);
    uint32x4_t vhi2xCDEF = vreinterpretq_u32_f32(vout2xCDEF);
    vlo2x89AB   = vaddq_u32(vlo2x89AB,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo2x89AB,   16), vone)));
    vhi2xCDEF = vaddq_u32(vhi2xCDEF, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi2xCDEF, 16), vone)));
    uint16x8_t vbf16out2x89ABCDEF =
        vcombine_u16(vshrn_n_u32(vlo2x89AB, 16),
                    vshrn_n_u32(vhi2xCDEF, 16));
    if XNN_LIKELY(nc >= 16) {

...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_2x8__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      c1[4] = xnn_bfloat16_from_float(vout1x4);
      c1[5] = xnn_bfloat16_from_float(vout1x5);
      c1[6] = xnn_bfloat16_from_float(vout1x6);
      c1[7] = xnn_bfloat16_from_float(vout1x7);

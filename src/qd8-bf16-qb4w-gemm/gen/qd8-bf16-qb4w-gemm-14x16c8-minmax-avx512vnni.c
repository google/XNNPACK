...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_14x16c8__avx512vnni(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  xnn_bfloat16* c8 = (xnn_bfloat16*) ((uintptr_t) c7 + cm_stride);
  if XNN_UNPREDICTABLE(mr <= 8) {
    a8 = a7;
    c8 = c7;
  }
  const int8_t* a9 = (const int8_t*) ((uintptr_t) a8 + a_stride);
  xnn_bfloat16* c9 = (xnn_bfloat16*) ((uintptr_t) c8 + cm_stride);
  if XNN_UNPREDICTABLE(mr < 10) {
    a9 = a8;
    c9 = c8;
  }
  const int8_t* a10 = (const int8_t*) ((uintptr_t) a9 + a_stride);
  xnn_bfloat16* c10 = (xnn_bfloat16*) ((uintptr_t) c9 + cm_stride);
  if XNN_UNPREDICTABLE(mr <= 10) {
    a10 = a9;
    c10 = c9;
  }
  const int8_t* a11 = (const int8_t*) ((uintptr_t) a10 + a_stride);
  xnn_bfloat16* c11 = (xnn_bfloat16*) ((uintptr_t) c10 + cm_stride);
  if XNN_UNPREDICTABLE(mr < 12) {
    a11 = a10;
    c11 = c10;
  }
  const int8_t* a12 = (const int8_t*) ((uintptr_t) a11 + a_stride);
  xnn_bfloat16* c12 = (xnn_bfloat16*) ((uintptr_t) c11 + cm_stride);
  if XNN_UNPREDICTABLE(mr <= 12) {
    a12 = a11;
    c12 = c11;
  }
  const int8_t* a13 = (const int8_t*) ((uintptr_t) a12 + a_stride);
  xnn_bfloat16* c13 = (xnn_bfloat16*) ((uintptr_t) c12 + cm_stride);
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 16) {
      ...
      c8 = (xnn_bfloat16*) ((uintptr_t) c8 + cn_stride);
      c9 = (xnn_bfloat16*) ((uintptr_t) c9 + cn_stride);
      c10 = (xnn_bfloat16*) ((uintptr_t) c10 + cn_stride);
      c11 = (xnn_bfloat16*) ((uintptr_t) c11 + cn_stride);
      c12 = (xnn_bfloat16*) ((uintptr_t) c12 + cn_stride);
      c13 = (xnn_bfloat16*) ((uintptr_t) c13 + cn_stride);

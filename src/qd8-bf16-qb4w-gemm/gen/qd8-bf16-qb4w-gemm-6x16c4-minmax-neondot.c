...
void xnn_qd8_bf16_qb4w_gemm_minmax_ukernel_6x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    uint32x4_t vlo3x89AB   = vreinterpretq_u32_f32(vout3x89AB);
    uint32x4_t vhi3xCDEF = vreinterpretq_u32_f32(vout3xCDEF);
    vlo3x89AB   = vaddq_u32(vlo3x89AB,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo3x89AB,   16), vone)));
    vhi3xCDEF = vaddq_u32(vhi3xCDEF, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi3xCDEF, 16), vone)));
    uint16x8_t vbf16out3x89ABCDEF =
        vcombine_u16(vshrn_n_u32(vlo3x89AB, 16),
                    vshrn_n_u32(vhi3xCDEF, 16));
    ...
    uint32x4_t vlo4x89AB   = vreinterpretq_u32_f32(vout4x89AB);
    uint32x4_t vhi4xCDEF = vreinterpretq_u32_f32(vout4xCDEF);
    vlo4x89AB   = vaddq_u32(vlo4x89AB,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo4x89AB,   16), vone)));
    vhi4xCDEF = vaddq_u32(vhi4xCDEF, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi4xCDEF, 16), vone)));
    uint16x8_t vbf16out4x89ABCDEF =
        vcombine_u16(vshrn_n_u32(vlo4x89AB, 16),
                    vshrn_n_u32(vhi4xCDEF, 16));
    uint32x4_t vlo5x0123   = vreinterpretq_u32_f32(vout5x0123);
    uint32x4_t vhi5x4567 = vreinterpretq_u32_f32(vout5x4567);
    vlo5x0123   = vaddq_u32(vlo5x0123,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo5x0123,   16), vone)));
    vhi5x4567 = vaddq_u32(vhi5x4567, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi5x4567, 16), vone)));
    uint16x8_t vbf16out5x01234567 =
        vcombine_u16(vshrn_n_u32(vlo5x0123, 16),
                    vshrn_n_u32(vhi5x4567, 16));
    uint32x4_t vlo5x89AB   = vreinterpretq_u32_f32(vout5x89AB);
    uint32x4_t vhi5xCDEF = vreinterpretq_u32_f32(vout5xCDEF);
    vlo5x89AB   = vaddq_u32(vlo5x89AB,   vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vlo5x89AB,   16), vone)));
    vhi5xCDEF = vaddq_u32(vhi5xCDEF, vaddq_u32(vrnebias, vandq_u32(vshrq_n_u32(vhi5xCDEF, 16), vone)));
    uint16x8_t vbf16out5x89ABCDEF =
        vcombine_u16(vshrn_n_u32(vlo5x89AB, 16),
                    vshrn_n_u32(vhi5xCDEF, 16));
    if XNN_LIKELY(nc >= 16) {

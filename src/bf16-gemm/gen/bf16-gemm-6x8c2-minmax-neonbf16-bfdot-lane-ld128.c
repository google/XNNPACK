    ...
    const union xnn_bf16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  const bfloat16_t* a5 = (const bfloat16_t*) ((uintptr_t) a4 + a_stride);
  bfloat16_t* c5 = (bfloat16_t*) ((uintptr_t) c4 + cm_stride);
  ...
  do {
    ...
    for (; k >= 8 * sizeof(bfloat16_t); k -= 8 * sizeof(bfloat16_t)) {
      ...
      const bfloat16x8_t va5 = vld1q_bf16(a5); a5 += 8;
      ...
      vacc4x0123 = vbfdotq_laneq_f32(vacc4x0123, vb0123c01, va4, 0);
      vacc5x0123 = vbfdotq_laneq_f32(vacc5x0123, vb0123c01, va5, 0);
      ...
      vacc4x4567 = vbfdotq_laneq_f32(vacc4x4567, vb4567c01, va4, 0);
      vacc5x4567 = vbfdotq_laneq_f32(vacc5x4567, vb4567c01, va5, 0);
      ...
      vacc4x0123 = vbfdotq_laneq_f32(vacc4x0123, vb0123c23, va4, 1);
      vacc5x0123 = vbfdotq_laneq_f32(vacc5x0123, vb0123c23, va5, 1);
      ...
      vacc4x4567 = vbfdotq_laneq_f32(vacc4x4567, vb4567c23, va4, 1);
      vacc5x4567 = vbfdotq_laneq_f32(vacc5x4567, vb4567c23, va5, 1);
      ...
      vacc4x0123 = vbfdotq_laneq_f32(vacc4x0123, vb0123c45, va4, 2);
      vacc5x0123 = vbfdotq_laneq_f32(vacc5x0123, vb0123c45, va5, 2);
      ...
      vacc4x4567 = vbfdotq_laneq_f32(vacc4x4567, vb4567c45, va4, 2);
      vacc5x4567 = vbfdotq_laneq_f32(vacc5x4567, vb4567c45, va5, 2);
      ...
      vacc4x0123 = vbfdotq_laneq_f32(vacc4x0123, vb0123c67, va4, 3);
      vacc5x0123 = vbfdotq_laneq_f32(vacc5x0123, vb0123c67, va5, 3);
      ...
      vacc4x4567 = vbfdotq_laneq_f32(vacc4x4567, vb4567c67, va4, 3);
      vacc5x4567 = vbfdotq_laneq_f32(vacc5x4567, vb4567c67, va5, 3);
    }
    if XNN_UNLIKELY(k != 0) {
      ...
      const bfloat16x8_t va5 = vld1q_bf16(a5); a5 = (const bfloat16_t*) ((uintptr_t) a5 + k);
      ...
      const uint32x4_t va5c01 = vdupq_lane_u32(vreinterpret_u32_bf16(vget_low_bf16(va5)), 0);
      ...
      const uint32x4_t va4x0123c01 = vbicq_u32(va4c01, vm0123c01);
      vacc4x0123 = vbfdotq_f32(vacc4x0123, vb0123c01, vreinterpretq_bf16_u32(va4x0123c01));
      const uint32x4_t va5x0123c01 = vbicq_u32(va5c01, vm0123c01);
      vacc5x0123 = vbfdotq_f32(vacc5x0123, vb0123c01, vreinterpretq_bf16_u32(va5x0123c01));
      ...
      const uint32x4_t va4x4567c01 = vbicq_u32(va4c01, vm4567c01);
      vacc4x4567 = vbfdotq_f32(vacc4x4567, vb4567c01, vreinterpretq_bf16_u32(va4x4567c01));
      const uint32x4_t va5x4567c01 = vbicq_u32(va5c01, vm4567c01);
      vacc5x4567 = vbfdotq_f32(vacc5x4567, vb4567c01, vreinterpretq_bf16_u32(va5x4567c01));
      ...
      if (k > 2 * sizeof(bfloat16_t)) {
        ...
        const uint32x4_t va5c23 = vdupq_lane_u32(vreinterpret_u32_bf16(vget_low_bf16(va5)), 1);
        ...
        const uint32x4_t va4x0123c23 = vbicq_u32(va4c23, vm0123c23);
        vacc4x0123 = vbfdotq_f32(vacc4x0123, vb0123c23, vreinterpretq_bf16_u32(va4x0123c23));
        const uint32x4_t va5x0123c23 = vbicq_u32(va5c23, vm0123c23);
        vacc5x0123 = vbfdotq_f32(vacc5x0123, vb0123c23, vreinterpretq_bf16_u32(va5x0123c23));
        ...
        const uint32x4_t va4x4567c23 = vbicq_u32(va4c23, vm4567c23);
        vacc4x4567 = vbfdotq_f32(vacc4x4567, vb4567c23, vreinterpretq_bf16_u32(va4x4567c23));
        const uint32x4_t va5x4567c23 = vbicq_u32(va5c23, vm4567c23);
        vacc5x4567 = vbfdotq_f32(vacc5x4567, vb4567c23, vreinterpretq_bf16_u32(va5x4567c23));
        ...
        if (k > 4 * sizeof(bfloat16_t)) {
          ...
          const uint32x4_t va5c45 = vdupq_lane_u32(vreinterpret_u32_bf16(vget_high_bf16(va5)), 0);
          ...
          const uint32x4_t va4x0123c45 = vbicq_u32(va4c45, vm0123c45);
          vacc4x0123 = vbfdotq_f32(vacc4x0123, vb0123c45, vreinterpretq_bf16_u32(va4x0123c45));
          const uint32x4_t va5x0123c45 = vbicq_u32(va5c45, vm0123c45);
          vacc5x0123 = vbfdotq_f32(vacc5x0123, vb0123c45, vreinterpretq_bf16_u32(va5x0123c45));
          ...
          const uint32x4_t va4x4567c45 = vbicq_u32(va4c45, vm4567c45);
          vacc4x4567 = vbfdotq_f32(vacc4x4567, vb4567c45, vreinterpretq_bf16_u32(va4x4567c45));
          const uint32x4_t va5x4567c45 = vbicq_u32(va5c45, vm4567c45);
          vacc5x4567 = vbfdotq_f32(vacc5x4567, vb4567c45, vreinterpretq_bf16_u32(va5x4567c45));
          ...
          if (k > 6 * sizeof(bfloat16_t)) {
            ...
            const uint32x4_t va5c67 = vdupq_lane_u32(vreinterpret_u32_bf16(vget_high_bf16(va5)), 1);
            ...
            const uint32x4_t va4x0123c67 = vbicq_u32(va4c67, vm0123c67);
            vacc4x0123 = vbfdotq_f32(vacc4x0123, vb0123c67, vreinterpretq_bf16_u32(va4x0123c67));
            const uint32x4_t va5x0123c67 = vbicq_u32(va5c67, vm0123c67);
            vacc5x0123 = vbfdotq_f32(vacc5x0123, vb0123c67, vreinterpretq_bf16_u32(va5x0123c67));
            ...
            const uint32x4_t va4x4567c67 = vbicq_u32(va4c67, vm4567c67);
            vacc4x4567 = vbfdotq_f32(vacc4x4567, vb4567c67, vreinterpretq_bf16_u32(va4x4567c67));
            const uint32x4_t va5x4567c67 = vbicq_u32(va5c67, vm4567c67);
            vacc5x4567 = vbfdotq_f32(vacc5x4567, vb4567c67, vreinterpretq_bf16_u32(va5x4567c67));
          }
        }
      }
    }
    ...
    bfloat16x4_t vout5x0123 = vcvt_bf16_f32(vacc5x0123);
    ...
    bfloat16x4_t vout4x4567 = vcvt_bf16_f32(vacc4x4567);
    bfloat16x4_t vout5x4567 = vcvt_bf16_f32(vacc5x4567);
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      vst1_bf16(c4 + 4, vout4x4567);
      c4 = (bfloat16_t*) ((uintptr_t) c4 + cn_stride);
      vst1_bf16(c5, vout5x0123);
      vst1_bf16(c5 + 4, vout5x4567);
      c5 = (bfloat16_t*) ((uintptr_t) c5 + cn_stride);
      ...
      a5 = (const bfloat16_t*) ((uintptr_t) a5 - kc);
      ...
      if (nc & 4) {
        ...
        vst1_bf16(c4, vout4x0123); c4 += 4;
        vst1_bf16(c5, vout5x0123); c5 += 4;
      ...
      if (nc & 2) {
        ...
        vst1_lane_u32((void*) c5, vreinterpret_u32_bf16(vout5x0123), 0); c5 += 2;
        ...
        vout5x0123 = vreinterpret_bf16_u16(vext_u16(vreinterpret_u16_bf16(vout5x0123), vreinterpret_u16_bf16(vout5x0123), 2));
      }
      if (nc & 1) {
        ...
        vst1_lane_bf16(c5, vout5x0123, 0);
      }

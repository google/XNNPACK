...
void xnn_bf16_gemm_minmax_ukernel_5x4c8__neonfma_zip(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_bf16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; k >= 8 * sizeof(uint16_t); k -= 8 * sizeof(uint16_t)) {
      ...
      const uint16x8_t va4h = vld1q_u16(a4); a4 += 8;
      ...
      const uint16x8x2_t va4f = vzipq_u16(vzero, va4h);
      ...
      vacc4x0 = vfmaq_f32(vacc4x0, vreinterpretq_f32_u16(va4f.val[0]), vreinterpretq_f32_u16(vb0f.val[0]));
      ...
      vacc4x1 = vfmaq_f32(vacc4x1, vreinterpretq_f32_u16(va4f.val[0]), vreinterpretq_f32_u16(vb1f.val[0]));
      ...
      vacc4x2 = vfmaq_f32(vacc4x2, vreinterpretq_f32_u16(va4f.val[0]), vreinterpretq_f32_u16(vb2f.val[0]));
      ...
      vacc4x3 = vfmaq_f32(vacc4x3, vreinterpretq_f32_u16(va4f.val[0]), vreinterpretq_f32_u16(vb3f.val[0]));
      ...
      vacc4x0 = vfmaq_f32(vacc4x0, vreinterpretq_f32_u16(va4f.val[1]), vreinterpretq_f32_u16(vb0f.val[1]));
      ...
      vacc4x1 = vfmaq_f32(vacc4x1, vreinterpretq_f32_u16(va4f.val[1]), vreinterpretq_f32_u16(vb1f.val[1]));
      ...
      vacc4x2 = vfmaq_f32(vacc4x2, vreinterpretq_f32_u16(va4f.val[1]), vreinterpretq_f32_u16(vb2f.val[1]));
      ...
      vacc4x3 = vfmaq_f32(vacc4x3, vreinterpretq_f32_u16(va4f.val[1]), vreinterpretq_f32_u16(vb3f.val[1]));
    }
    if XNN_UNLIKELY(k != 0) {
      ...
      const uint16x8_t va4h = vld1q_u16(a4); a4 = (const uint16_t*) ((uintptr_t) a4 + k);
      ...
      const uint16x8_t va4x0h = vbicq_u16(va4h, vm0h);
      ...
      const uint16x8_t va4x1h = vbicq_u16(va4h, vm1h);
      ...
      const uint16x8_t va4x2h = vbicq_u16(va4h, vm2h);
      ...
      const uint16x8_t va4x3h = vbicq_u16(va4h, vm3h);
      ...
      const uint16x8x2_t va4x0f = vzipq_u16(vzero, va4x0h);
      ...
      const uint16x8x2_t va4x1f = vzipq_u16(vzero, va4x1h);
      ...
      const uint16x8x2_t va4x2f = vzipq_u16(vzero, va4x2h);
      ...
      const uint16x8x2_t va4x3f = vzipq_u16(vzero, va4x3h);
      ...
      vacc4x0 = vfmaq_f32(vacc4x0, vreinterpretq_f32_u16(va4x0f.val[0]), vreinterpretq_f32_u16(vb0f.val[0]));
      ...
      vacc4x1 = vfmaq_f32(vacc4x1, vreinterpretq_f32_u16(va4x1f.val[0]), vreinterpretq_f32_u16(vb1f.val[0]));
      ...
      vacc4x2 = vfmaq_f32(vacc4x2, vreinterpretq_f32_u16(va4x2f.val[0]), vreinterpretq_f32_u16(vb2f.val[0]));
      ...
      vacc4x3 = vfmaq_f32(vacc4x3, vreinterpretq_f32_u16(va4x3f.val[0]), vreinterpretq_f32_u16(vb3f.val[0]));
      ...
      vacc4x0 = vfmaq_f32(vacc4x0, vreinterpretq_f32_u16(va4x0f.val[1]), vreinterpretq_f32_u16(vb0f.val[1]));
      ...
      vacc4x1 = vfmaq_f32(vacc4x1, vreinterpretq_f32_u16(va4x1f.val[1]), vreinterpretq_f32_u16(vb1f.val[1]));
      ...
      vacc4x2 = vfmaq_f32(vacc4x2, vreinterpretq_f32_u16(va4x2f.val[1]), vreinterpretq_f32_u16(vb2f.val[1]));
      ...
      vacc4x3 = vfmaq_f32(vacc4x3, vreinterpretq_f32_u16(va4x3f.val[1]), vreinterpretq_f32_u16(vb3f.val[1]));
    }

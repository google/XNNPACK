    ...
    const union xnn_bf16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; k >= 8 * sizeof(uint16_t); k -= 8 * sizeof(uint16_t)) {
      ...
      const float32x4_t va4e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va4));
      ...
      const float32x4_t va4o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va4));
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      const float32x4_t va4x0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va4x0));
      ...
      const float32x4_t va4x1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va4x1));
      ...
      const float32x4_t va4x2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va4x2));
      ...
      const float32x4_t va4x3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va4x3));
      ...
      const float32x4_t va4x0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va4x0));
      ...
      const float32x4_t va4x1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va4x1));
      ...
      const float32x4_t va4x2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va4x2));
      ...
      const float32x4_t va4x3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va4x3));

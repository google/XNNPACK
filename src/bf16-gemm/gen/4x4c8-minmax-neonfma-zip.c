    ...
    const union xnn_bf16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; k >= 8 * sizeof(uint16_t); k -= 8 * sizeof(uint16_t)) {
      ...
      const float32x4_t va0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va0));
      const float32x4_t va1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va1));
      const float32x4_t va2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va2));
      const float32x4_t va3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va3));

      const float32x4_t vb0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, vb0));
      const float32x4_t vb1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, vb1));
      const float32x4_t vb2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, vb2));
      const float32x4_t vb3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, vb3));
      ...
      const float32x4_t va0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va0));
      const float32x4_t va1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va1));
      const float32x4_t va2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va2));
      const float32x4_t va3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va3));

      const float32x4_t vb0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, vb0));
      const float32x4_t vb1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, vb1));
      const float32x4_t vb2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, vb2));
      const float32x4_t vb3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, vb3));
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      const float32x4_t va0x0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va0x0));
      const float32x4_t va1x0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va1x0));
      const float32x4_t va2x0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va2x0));
      const float32x4_t va3x0e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va3x0));
      const float32x4_t va0x1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va0x1));
      const float32x4_t va1x1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va1x1));
      const float32x4_t va2x1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va2x1));
      const float32x4_t va3x1e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va3x1));
      const float32x4_t va0x2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va0x2));
      const float32x4_t va1x2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va1x2));
      const float32x4_t va2x2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va2x2));
      const float32x4_t va3x2e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va3x2));
      const float32x4_t va0x3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va0x3));
      const float32x4_t va1x3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va1x3));
      const float32x4_t va2x3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va2x3));
      const float32x4_t va3x3e = vreinterpretq_f32_u16(vzip1q_u16(vzero, va3x3));
      ...
      const float32x4_t va0x0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va0x0));
      const float32x4_t va1x0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va1x0));
      const float32x4_t va2x0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va2x0));
      const float32x4_t va3x0o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va3x0));
      const float32x4_t va0x1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va0x1));
      const float32x4_t va1x1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va1x1));
      const float32x4_t va2x1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va2x1));
      const float32x4_t va3x1o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va3x1));
      const float32x4_t va0x2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va0x2));
      const float32x4_t va1x2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va1x2));
      const float32x4_t va2x2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va2x2));
      const float32x4_t va3x2o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va3x2));
      const float32x4_t va0x3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va0x3));
      const float32x4_t va1x3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va1x3));
      const float32x4_t va2x3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va2x3));
      const float32x4_t va3x3o = vreinterpretq_f32_u16(vzip2q_u16(vzero, va3x3));

    ...
    const struct xnn_qu8_cvt_params* restrict params)
{
  ...
  do {
    ...
    vint16m2_t acc_i16v = __riscv_vreinterpret_i16m2(__riscv_vwsubu_vx_u16m2(in_u8v, input_zero_point, vl));
    ...
    acc_i16v = __riscv_vmax_vx_i16m2(acc_i16v, 0, vl);
    vuint8m1_t out_u8v = __riscv_vnclipu_wx_u8m1(__riscv_vreinterpret_u16m2(acc_i16v), 8, __RISCV_VXRM_RNU, vl);

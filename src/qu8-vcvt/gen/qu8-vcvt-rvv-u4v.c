    ...
    const struct xnn_qu8_cvt_params* restrict params)
{
  ...
  do {
    ...
    vint16m8_t acc_i16v = __riscv_vreinterpret_i16m8(__riscv_vwsubu_vx_u16m8(in_u8v, input_zero_point, vl));
    ...
    acc_i16v = __riscv_vmax_vx_i16m8(acc_i16v, 0, vl);
    vuint8m4_t out_u8v = __riscv_vnclipu_wx_u8m4(__riscv_vreinterpret_u16m8(acc_i16v), 8, __RISCV_VXRM_RNU, vl);
    __riscv_vse8_v_u8m4(output, out_u8v, vl); output += vl;
  } while (batch != 0);
}

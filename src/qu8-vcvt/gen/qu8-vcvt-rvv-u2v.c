    ...
    const struct xnn_qu8_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vuint8m2_t acc_u8v = __riscv_vle8_v_u8m2(input, n); input += n;
    vuint16m4_t acc_u16v = __riscv_vwcvtu_x_x_v_u16m4(acc_u8v, n);
    vint32m8_t acc_i32v = __riscv_vwmacc_vx_i32m8(bias_i32v, multiplier, __riscv_vreinterpret_v_u16m4_i16m4(acc_u16v), n);
    vint16m4_t out_i16v = __riscv_vnclip_wx_i16m4(acc_i32v, 8, __RISCV_VXRM_RDN, n);
    out_i16v = __riscv_vmax_vx_i16m4(out_i16v, 0, n);
    vuint8m2_t out_u8v = __riscv_vnclipu_wx_u8m2(__riscv_vreinterpret_v_i16m4_u16m4(out_i16v), 0, __RISCV_VXRM_RNU, n);

    ...
    const struct xnn_qu8_cvt_params* restrict params)
{
  ...
  do {
    ...
    vint16m4_t acc_i16v = __riscv_vreinterpret_i16m4(__riscv_vwsubu_vx(in_u8v, input_zero_point, vl));
    ...
    vuint8m2_t out_u8v = __riscv_vnclipu(__riscv_vreinterpret_u16m4(acc_i16v), 0, __RISCV_VXRM_RDN, vl);

...
XNN_UKERNEL(xnn_arch_riscv_vector, xnn_qu8_vcvt_ukernel__rvv_u1v, 1, true, XNN_QUANTIZED(uint8_t), XNN_QUANTIZED(uint8_t), struct xnn_qu8_cvt_params, xnn_init_qu8_cvt_scalar_params)
XNN_UKERNEL(xnn_arch_riscv_vector, xnn_qu8_vcvt_ukernel__rvv_u2v, 2, true, XNN_QUANTIZED(uint8_t), XNN_QUANTIZED(uint8_t), struct xnn_qu8_cvt_params, xnn_init_qu8_cvt_scalar_params)
XNN_UKERNEL(xnn_arch_riscv_vector, xnn_qu8_vcvt_ukernel__rvv_u4v, 4, true, XNN_QUANTIZED(uint8_t), XNN_QUANTIZED(uint8_t), struct xnn_qu8_cvt_params, xnn_init_qu8_cvt_scalar_params)

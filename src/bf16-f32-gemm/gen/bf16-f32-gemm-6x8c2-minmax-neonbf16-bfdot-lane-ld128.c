...
//   float bias[8];
//   for each pair of input channels: uint16_t kernel[8][2];  // bf16
//
...
void xnn_bf16_f32_gemm_minmax_ukernel_6x8c2__neonbf16_bfdot_lane_ld128(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_f32_minmax_params* restrict params)
{
  ...
  do {
    ...
    for (; k >= 8 * sizeof(xnn_bfloat16); k -= 8 * sizeof(xnn_bfloat16)) {
      ...
      a3 += 8;
      const bfloat16x8_t va4 = vreinterpretq_bf16_u16(vld1q_u16(a4));
      a4 += 8;
      const bfloat16x8_t va5 = vreinterpretq_bf16_u16(vld1q_u16(a5));
      a5 += 8;
      ...
      vacc4x0 = vbfdotq_laneq_f32(vacc4x0, vb0c0, va4, 0);
      vacc4x1 = vbfdotq_laneq_f32(vacc4x1, vb1c0, va4, 0);
      vacc5x0 = vbfdotq_laneq_f32(vacc5x0, vb0c0, va5, 0);
      vacc5x1 = vbfdotq_laneq_f32(vacc5x1, vb1c0, va5, 0);
      ...
      vacc4x0 = vbfdotq_laneq_f32(vacc4x0, vb0c1, va4, 1);
      vacc4x1 = vbfdotq_laneq_f32(vacc4x1, vb1c1, va4, 1);
      vacc5x0 = vbfdotq_laneq_f32(vacc5x0, vb0c1, va5, 1);
      vacc5x1 = vbfdotq_laneq_f32(vacc5x1, vb1c1, va5, 1);
      ...
      vacc4x0 = vbfdotq_laneq_f32(vacc4x0, vb0c2, va4, 2);
      vacc4x1 = vbfdotq_laneq_f32(vacc4x1, vb1c2, va4, 2);
      vacc5x0 = vbfdotq_laneq_f32(vacc5x0, vb0c2, va5, 2);
      vacc5x1 = vbfdotq_laneq_f32(vacc5x1, vb1c2, va5, 2);
      ...
      vacc4x0 = vbfdotq_laneq_f32(vacc4x0, vb0c3, va4, 3);
      vacc4x1 = vbfdotq_laneq_f32(vacc4x1, vb1c3, va4, 3);
      vacc5x0 = vbfdotq_laneq_f32(vacc5x0, vb0c3, va5, 3);
      vacc5x1 = vbfdotq_laneq_f32(vacc5x1, vb1c3, va5, 3);
      wk += 64;
    }
    ...
    while (k != 0) {
      ...
      if XNN_LIKELY(k >= 2 * sizeof(xnn_bfloat16)) {
        ...
        a3 += 2;
        va4_pair = unaligned_load_u32(a4);
        a4 += 2;
        va5_pair = unaligned_load_u32(a5);
        a5 += 2;
        ...
        va4_pair = (uint32_t) *a4++;
        va5_pair = (uint32_t) *a5++;
        k = 0;
      }
      ...
      const bfloat16x8_t va4 = vreinterpretq_bf16_u32(vdupq_n_u32(va4_pair));
      const bfloat16x8_t va5 = vreinterpretq_bf16_u32(vdupq_n_u32(va5_pair));
      ...
      vacc4x0 = vbfdotq_f32(vacc4x0, vb0, va4);
      vacc4x1 = vbfdotq_f32(vacc4x1, vb1, va4);
      vacc5x0 = vbfdotq_f32(vacc5x0, vb0, va5);
      vacc5x1 = vbfdotq_f32(vacc5x1, vb1, va5);
    }
    w = (const void*) wk;

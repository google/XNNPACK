    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w >= 16 * sizeof(__fp16); w -= 16 * sizeof(__fp16)) {
      ...
      float16x8_t vo0p2 = vmulq_laneq_f16(vi1x8ACE9BDF.val[0], vw01234567, 5);
      ...
      vo0p1 = vfmaq_lane_f16(vo0p1, vi2x8ACE9BDF.val[1], vw89, 1);
    ...
    if XNN_LIKELY(w != 0) {
      ...
      float16x8_t vo0p2 = vmulq_laneq_f16(vi1x8ACE, vw01234567, 5);
      ...
      vo0p1 = vfmaq_lane_f16(vo0p1, vi2x9BDF, vw89, 1);

    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      float16x8_t vo1p1 = vmulq_laneq_f16(vi1x89ABCDEF, vw01234567, 3);
      float16x8_t vo2p1 = vmulq_laneq_f16(vi2x89ABCDEF, vw01234567, 3);
      float16x8_t vo3p1 = vmulq_laneq_f16(vi3x89ABCDEF, vw01234567, 3);

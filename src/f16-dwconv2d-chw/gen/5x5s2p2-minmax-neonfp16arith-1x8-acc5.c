    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(__fp16); w -= 16 * sizeof(__fp16)) {
      ...
      float16x8_t vo0p4 = vmulq_lane_f16(vi3xGIKMOQSUHJLNPRTV.val[0], vget_low_f16(vwGHIJKLMN), 2);
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vi4xGIKMOQSUHJLNPRTV.val[0], vwGHIJKLMN, 7);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi4xGIKMOQSUHJLNPRTV.val[0], vget_high_f16(vwGHIJKLMN), 3);
      #endif
      // Right by 2 column
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi0xGIKMOQSUHJLNPRTV.val[1], vw01234567, 4);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi0xGIKMOQSUHJLNPRTV.val[1], vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi1xGIKMOQSUHJLNPRTV.val[1], vw89ABCDEF, 1);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi1xGIKMOQSUHJLNPRTV.val[1], vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p4 = vfmaq_laneq_f16(vo0p4, vi2xGIKMOQSUHJLNPRTV.val[1], vw89ABCDEF, 6);
      #else
        vo0p4 = vmlaq_lane_f16(vo0p4, vi2xGIKMOQSUHJLNPRTV.val[1], vget_high_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64

...
void xnn_f16_dwconv2d_chw_ukernel_3x3p1__neonfp16arith_1x4_acc3(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 4 * sizeof(__fp16); w -= 4 * sizeof(__fp16)) {
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi1x3456, vw01234567, 4);

      vo0p2 = vfma_laneq_f16(vo0p2, vi2x3456, vw01234567, 7);
      ...
      vo0p2 = vfma_lane_f16(vo0p2, vi2x5678, vw89, 1);

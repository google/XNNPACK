...
void xnn_f16_dwconv2d_chw_ukernel_3x3s2p1__neonfp16arith_2x8_acc2(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w >= 16 * sizeof(uint16_t); w -= 16 * sizeof(uint16_t)) {
      ...
      float16x8_t vo1p1 = vmulq_lane_f16(vreinterpretq_f16_u16(vi2xGIKMOQSUHJLNPRTV.val[0]), vget_low_f16(vw01234567), 2);
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi2xFHJLNPRT, vw01234567, 1);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi2xFHJLNPRT, vget_low_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi4xFHJLNPRT, vw01234567, 7);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi4xFHJLNPRT, vget_high_f16(vw01234567), 3);
      #endif
      // Right column
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vreinterpretq_f16_u16(vi3xGIKMOQSUHJLNPRTV.val[1]), vw01234567, 6);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vreinterpretq_f16_u16(vi3xGIKMOQSUHJLNPRTV.val[1]), vget_high_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64
    ...
    if XNN_LIKELY(w != 0) {
      ...
      float16x8_t vo1p1 = vmulq_lane_f16(vi2xGIKMOQSU, vget_low_f16(vw01234567), 2);
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi3xHJLNPRTV, vw01234567, 6);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi3xHJLNPRTV, vget_high_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64

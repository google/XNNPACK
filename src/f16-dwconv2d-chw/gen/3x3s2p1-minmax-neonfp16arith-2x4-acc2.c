...
void xnn_f16_dwconv2d_chw_ukernel_3x3s2p1__neonfp16arith_2x4_acc2(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w >= 8 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      float16x4_t vo1p1 = vmul_laneq_f16(vi2x8ACE9BDF.val[0], vw01234567, 2);
      ...
      vo1p1 = vfma_laneq_f16(vo1p1, vi2x7BDF, vw01234567, 1);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x7BDF, vw01234567, 4);
      vo1p0 = vfma_laneq_f16(vo1p0, vi3x7BDF, vw01234567, 4);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x7BDF, vw01234567, 7);
      vo1p1 = vfma_laneq_f16(vo1p1, vi4x7BDF, vw01234567, 7);
      ...
      vo1p1 = vfma_laneq_f16(vo1p1, vi3x8ACE9BDF.val[1], vw01234567, 6);
    ...
    if XNN_LIKELY(w != 0) {
      ...
      float16x4_t vo1p1 = vmul_laneq_f16(vi2x8ACE, vw01234567, 2);
      ...
      vo1p1 = vfma_laneq_f16(vo1p1, vi3x9BDF, vw01234567, 6);

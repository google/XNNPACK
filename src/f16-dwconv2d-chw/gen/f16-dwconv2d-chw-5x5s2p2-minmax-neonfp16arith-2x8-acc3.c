...
void xnn_f16_dwconv2d_chw_ukernel_5x5s2p2__neonfp16arith_2x8_acc3(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(uint16_t); w -= 16 * sizeof(uint16_t)) {
      ...
      float16x8_t vo1p2 = vmulq_lane_f16(vreinterpretq_f16_u16(vi3xGIKMOQSUHJLNPRTV.val[0]), vget_low_f16(vw89ABCDEF), 0);
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vreinterpretq_f16_u16(vi4xGIKMOQSUHJLNPRTV.val[0]), vw89ABCDEF, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vreinterpretq_f16_u16(vi4xGIKMOQSUHJLNPRTV.val[0]), vget_high_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vreinterpretq_f16_u16(vi5xGIKMOQSUHJLNPRTV.val[0]), vwGHIJKLMN, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vreinterpretq_f16_u16(vi5xGIKMOQSUHJLNPRTV.val[0]), vget_low_f16(vwGHIJKLMN), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vreinterpretq_f16_u16(vi3xGIKMOQSUHJLNPRTV.val[1]), vw89ABCDEF, 1);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vreinterpretq_f16_u16(vi3xGIKMOQSUHJLNPRTV.val[1]), vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vreinterpretq_f16_u16(vi5xGIKMOQSUHJLNPRTV.val[1]), vwGHIJKLMN, 3);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vreinterpretq_f16_u16(vi5xGIKMOQSUHJLNPRTV.val[1]), vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_lane_f16(vo1p2, vreinterpretq_f16_u16(vi6xGIKMOQSUHJLNPRTV.val[1]), vwOP, 0);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vreinterpretq_f16_u16(vi6xGIKMOQSUHJLNPRTV.val[1]), vwOP, 0);
      #endif
      // Left by 2 column
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi4xEGIKMOQS, vw89ABCDEF, 3);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi4xEGIKMOQS, vget_low_f16(vw89ABCDEF), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi6xEGIKMOQS, vwGHIJKLMN, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi6xEGIKMOQS, vget_high_f16(vwGHIJKLMN), 1);
      #endif
      // Left by 1 column, s1
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi2xFHJLNPRT, vw01234567, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi2xFHJLNPRT, vget_low_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi5xFHJLNPRT, vwGHIJKLMN, 1);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi5xFHJLNPRT, vget_low_f16(vwGHIJKLMN), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi2xIKMOQSUW, vw01234567, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi2xIKMOQSUW, vget_high_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi3xIKMOQSUW, vw89ABCDEF, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi3xIKMOQSUW, vget_low_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_lane_f16(vo1p2, vi6xIKMOQSUW, vwOP, 1);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi6xIKMOQSUW, vwOP, 1);
      #endif
    ...
    assert(w >= 1 * sizeof(uint16_t));
    {
      ...
      float16x8_t vo1p2 = vmulq_lane_f16(vi3xGIKMOQSU, vget_low_f16(vw89ABCDEF), 0);
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi4xGIKMOQSU, vw89ABCDEF, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi4xGIKMOQSU, vget_high_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi5xGIKMOQSU, vwGHIJKLMN, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi5xGIKMOQSU, vget_low_f16(vwGHIJKLMN), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi3xHJLNPRTV, vw89ABCDEF, 1);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi3xHJLNPRTV, vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi5xHJLNPRTV, vwGHIJKLMN, 3);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi5xHJLNPRTV, vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_lane_f16(vo1p2, vi6xHJLNPRTV, vwOP, 0);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi6xHJLNPRTV, vwOP, 0);
      #endif
      // Left by 2 columns

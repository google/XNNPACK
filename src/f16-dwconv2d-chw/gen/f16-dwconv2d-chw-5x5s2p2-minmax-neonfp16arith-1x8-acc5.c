...
void xnn_f16_dwconv2d_chw_ukernel_5x5s2p2__neonfp16arith_1x8_acc5(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(uint16_t); w -= 16 * sizeof(uint16_t)) {
      ...
      float16x8_t vo0p2 = vmulq_lane_f16(vreinterpretq_f16_u16(vi1xGIKMOQSUHJLNPRTV.val[0]), vget_low_f16(vw89ABCDEF), 0);
      float16x8_t vo0p3 = vmulq_lane_f16(vreinterpretq_f16_u16(vi2xGIKMOQSUHJLNPRTV.val[0]), vget_high_f16(vw89ABCDEF), 1);
      float16x8_t vo0p4 = vmulq_lane_f16(vreinterpretq_f16_u16(vi3xGIKMOQSUHJLNPRTV.val[0]), vget_low_f16(vwGHIJKLMN), 2);
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vreinterpretq_f16_u16(vi4xGIKMOQSUHJLNPRTV.val[0]), vwGHIJKLMN, 7);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vreinterpretq_f16_u16(vi4xGIKMOQSUHJLNPRTV.val[0]), vget_high_f16(vwGHIJKLMN), 3);
      #endif
      // Right by 2 column
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vreinterpretq_f16_u16(vi0xGIKMOQSUHJLNPRTV.val[1]), vw01234567, 4);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vreinterpretq_f16_u16(vi0xGIKMOQSUHJLNPRTV.val[1]), vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vreinterpretq_f16_u16(vi1xGIKMOQSUHJLNPRTV.val[1]), vw89ABCDEF, 1);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vreinterpretq_f16_u16(vi1xGIKMOQSUHJLNPRTV.val[1]), vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p4 = vfmaq_laneq_f16(vo0p4, vreinterpretq_f16_u16(vi2xGIKMOQSUHJLNPRTV.val[1]), vw89ABCDEF, 6);
      #else
        vo0p4 = vmlaq_lane_f16(vo0p4, vreinterpretq_f16_u16(vi2xGIKMOQSUHJLNPRTV.val[1]), vget_high_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi0xEGIKMOQS, vw01234567, 1);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi0xEGIKMOQS, vget_low_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi1xEGIKMOQS, vw01234567, 6);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi1xEGIKMOQS, vget_high_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64
        vo0p4 = vfmaq_laneq_f16(vo0p4, vi2xEGIKMOQS, vw89ABCDEF, 3);
      #else
        vo0p4 = vmlaq_lane_f16(vo0p4, vi2xEGIKMOQS, vget_low_f16(vw89ABCDEF), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi1xFHJLNPRT, vw01234567, 7);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi1xFHJLNPRT, vget_high_f16(vw01234567), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo0p4 = vfmaq_laneq_f16(vo0p4, vi2xFHJLNPRT, vw89ABCDEF, 4);
      #else
        vo0p4 = vmlaq_lane_f16(vo0p4, vi2xFHJLNPRT, vget_high_f16(vw89ABCDEF), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi0xIKMOQSUW, vw01234567, 5);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi0xIKMOQSUW, vget_high_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi1xIKMOQSUW, vw89ABCDEF, 2);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi1xIKMOQSUW, vget_low_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64
        vo0p4 = vfmaq_laneq_f16(vo0p4, vi2xIKMOQSUW, vw89ABCDEF, 7);
      #else
        vo0p4 = vmlaq_lane_f16(vo0p4, vi2xIKMOQSUW, vget_high_f16(vw89ABCDEF), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_lane_f16(vo0p1, vi4xIKMOQSUW, vwOP, 1);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi4xIKMOQSUW, vwOP, 1);
      #endif
    ...
    assert(w >= 1 * sizeof(uint16_t));
    {
      ...
      float16x8_t vo0p3 = vmulq_lane_f16(vi2xGIKMOQSU, vget_high_f16(vw89ABCDEF), 1);
      float16x8_t vo0p4 = vmulq_lane_f16(vi3xGIKMOQSU, vget_low_f16(vwGHIJKLMN), 2);
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vi4xGIKMOQSU, vwGHIJKLMN, 7);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi4xGIKMOQSU, vget_high_f16(vwGHIJKLMN), 3);
      #endif
      // Right by 1 column
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi0xHJLNPRTV, vw01234567, 4);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi0xHJLNPRTV, vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi1xHJLNPRTV, vw89ABCDEF, 1);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi1xHJLNPRTV, vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p4 = vfmaq_laneq_f16(vo0p4, vi2xHJLNPRTV, vw89ABCDEF, 6);
      #else
        vo0p4 = vmlaq_lane_f16(vo0p4, vi2xHJLNPRTV, vget_high_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64

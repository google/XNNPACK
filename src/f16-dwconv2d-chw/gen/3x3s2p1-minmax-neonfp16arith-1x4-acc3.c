...
void xnn_f16_dwconv2d_chw_ukernel_3x3s2p1__neonfp16arith_1x4_acc3(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w >= 8 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      vo0p1 = vfma_lane_f16(vo0p1, vi2x8ACE9BDF.val[0], vw89, 0);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi0x7BDF, vw01234567, 1);
      ...
      // Right column
      vo0p2 = vfma_laneq_f16(vo0p2, vi0x8ACE9BDF.val[1], vw01234567, 3);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x8ACE9BDF.val[1], vw01234567, 6);

      vo0p1 = vfma_lane_f16(vo0p1, vi2x8ACE9BDF.val[1], vw89, 1);
    ...
    if XNN_LIKELY(w != 0) {
      ...
      vo0p1 = vfma_lane_f16(vo0p1, vi2x8ACE, vw89, 0);
      ...
      // Right column
      vo0p2 = vfma_laneq_f16(vo0p2, vi0x9BDF, vw01234567, 3);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x9BDF, vw01234567, 6);

      vo0p1 = vfma_lane_f16(vo0p1, vi2x9BDF, vw89, 1);

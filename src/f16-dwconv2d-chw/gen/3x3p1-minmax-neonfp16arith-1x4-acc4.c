...
void xnn_f16_dwconv2d_chw_ukernel_3x3p1__neonfp16arith_1x4_acc4(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 4 * sizeof(__fp16); w -= 4 * sizeof(__fp16)) {
      ...
      float16x4_t vo0p2 = vmul_lane_f16(vi2x4567, vw89, 0);
      ...
      float16x4_t vo0p3 = vmul_laneq_f16(vi0x3456, vw01234567, 1);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi0x5678, vw01234567, 3);

      vo0p3 = vfma_laneq_f16(vo0p3, vi1x5678, vw01234567, 6);

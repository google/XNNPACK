...
void xnn_f16_dwconv2d_chw_ukernel_5x5p2__neonfp16arith_1x4_acc3(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(__fp16); w -= 4 * sizeof(__fp16)) {
      ...
      float16x4_t vo0p2 = vmul_laneq_f16(vi1x4567, vw89ABCDEF, 0);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x4567, vw89ABCDEF, 5);

      vo0p2 = vfma_laneq_f16(vo0p2, vi3x4567, vwGHIJKLMN, 2);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi1x3456, vw01234567, 7);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x3456, vw89ABCDEF, 4);

      vo0p1 = vfma_laneq_f16(vo0p1, vi3x3456, vwGHIJKLMN, 1);

      vo0p2 = vfma_laneq_f16(vo0p2, vi4x3456, vwGHIJKLMN, 6);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi2x2345, vw89ABCDEF, 3);

      vo0p0 = vfma_laneq_f16(vo0p0, vi3x2345, vwGHIJKLMN, 0);

      vo0p1 = vfma_laneq_f16(vo0p1, vi4x2345, vwGHIJKLMN, 5);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi0x5678, vw01234567, 4);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x5678, vw89ABCDEF, 1);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x5678, vw89ABCDEF, 6);

      vo0p2 = vfma_laneq_f16(vo0p2, vi3x5678, vwGHIJKLMN, 3);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi0x6789, vw01234567, 5);

      vo0p2 = vfma_laneq_f16(vo0p2, vi1x6789, vw89ABCDEF, 2);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x6789, vw89ABCDEF, 7);

      vo0p1 = vfma_laneq_f16(vo0p1, vi3x6789, vwGHIJKLMN, 4);

      vo0p2 = vfma_lane_f16(vo0p2, vi4x6789, vwOP, 1);

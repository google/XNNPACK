...
void xnn_f16_dwconv2d_chw_ukernel_5x5s2p2__neonfp16arith_1x4(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      // Center column
      vo0p0 = vfma_laneq_f16(vo0p0, vi0x8ACE9BDF.val[0], vw01234567, 3);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x8ACE9BDF.val[0], vw89ABCDEF, 0);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x8ACE9BDF.val[0], vw89ABCDEF, 5);

      vo0p0 = vfma_laneq_f16(vo0p0, vi3x8ACE9BDF.val[0], vwGHIJKLMN, 2);

      vo0p0 = vfma_laneq_f16(vo0p0, vi4x8ACE9BDF.val[0], vwGHIJKLMN, 7);

      // Right by 1 column
      vo0p0 = vfma_laneq_f16(vo0p0, vi0x8ACE9BDF.val[1], vw01234567, 4);
      ...
      vo0p0 = vfma_lane_f16(vo0p0, vi4x8ACE9BDF.val[1], vwOP, 0);
      ...
      vo0p0 = vfma_laneq_f16(vo0p0, vi1x68AC, vw01234567, 6);
      ...
      vo0p0 = vfma_laneq_f16(vo0p0, vi0x79BD, vw01234567, 2);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x79BD, vw01234567, 7);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x79BD, vw89ABCDEF, 4);
      ...
      vo0p0 = vfma_laneq_f16(vo0p0, vi1xACEG, vw89ABCDEF, 2);
    ...
    assert(w >= 1 * sizeof(__fp16));
    {
      ...
      // Center column
      vo0p0 = vfma_laneq_f16(vo0p0, vi0x8ACE, vw01234567, 3);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x8ACE, vw89ABCDEF, 0);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x8ACE, vw89ABCDEF, 5);

      vo0p0 = vfma_laneq_f16(vo0p0, vi3x8ACE, vwGHIJKLMN, 2);

      vo0p0 = vfma_laneq_f16(vo0p0, vi4x8ACE, vwGHIJKLMN, 7);

      // Right by 1 column
      vo0p0 = vfma_laneq_f16(vo0p0, vi0x9BDF, vw01234567, 4);
      ...
      vo0p0 = vfma_lane_f16(vo0p0, vi4x9BDF, vwOP, 0);

...
void xnn_f16_dwconv2d_chw_ukernel_5x5s2p2__neonfp16arith_2x4_acc3(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      float16x4_t vo0p2 = vmul_laneq_f16(vi1x8ACE9BDF.val[0], vw89ABCDEF, 0);
      float16x4_t vo1p2 = vmul_laneq_f16(vi3x8ACE9BDF.val[0], vw89ABCDEF, 0);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x8ACE9BDF.val[0], vw89ABCDEF, 5);
      vo1p1 = vfma_laneq_f16(vo1p1, vi4x8ACE9BDF.val[0], vw89ABCDEF, 5);

      vo0p2 = vfma_laneq_f16(vo0p2, vi3x8ACE9BDF.val[0], vwGHIJKLMN, 2);
      vo1p2 = vfma_laneq_f16(vo1p2, vi5x8ACE9BDF.val[0], vwGHIJKLMN, 2);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi1x8ACE9BDF.val[1], vw89ABCDEF, 1);
      vo1p2 = vfma_laneq_f16(vo1p2, vi3x8ACE9BDF.val[1], vw89ABCDEF, 1);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x8ACE9BDF.val[1], vw89ABCDEF, 6);
      vo1p0 = vfma_laneq_f16(vo1p0, vi4x8ACE9BDF.val[1], vw89ABCDEF, 6);

      vo0p1 = vfma_laneq_f16(vo0p1, vi3x8ACE9BDF.val[1], vwGHIJKLMN, 3);
      vo1p1 = vfma_laneq_f16(vo1p1, vi5x8ACE9BDF.val[1], vwGHIJKLMN, 3);

      vo0p2 = vfma_lane_f16(vo0p2, vi4x8ACE9BDF.val[1], vwOP, 0);
      vo1p2 = vfma_lane_f16(vo1p2, vi6x8ACE9BDF.val[1], vwOP, 0);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi2x68AC, vw89ABCDEF, 3);
      vo1p2 = vfma_laneq_f16(vo1p2, vi4x68AC, vw89ABCDEF, 3);

      vo0p0 = vfma_laneq_f16(vo0p0, vi3x68AC, vwGHIJKLMN, 0);
      vo1p0 = vfma_laneq_f16(vo1p0, vi5x68AC, vwGHIJKLMN, 0);

      vo0p1 = vfma_laneq_f16(vo0p1, vi4x68AC, vwGHIJKLMN, 5);
      vo1p1 = vfma_laneq_f16(vo1p1, vi6x68AC, vwGHIJKLMN, 5);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi0x79BD, vw01234567, 2);
      vo1p2 = vfma_laneq_f16(vo1p2, vi2x79BD, vw01234567, 2);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi3x79BD, vwGHIJKLMN, 1);
      vo1p2 = vfma_laneq_f16(vo1p2, vi5x79BD, vwGHIJKLMN, 1);

      vo0p0 = vfma_laneq_f16(vo0p0, vi4x79BD, vwGHIJKLMN, 6);
      vo1p0 = vfma_laneq_f16(vo1p0, vi6x79BD, vwGHIJKLMN, 6);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi0xACEG, vw01234567, 5);
      vo1p1 = vfma_laneq_f16(vo1p1, vi2xACEG, vw01234567, 5);

      vo0p2 = vfma_laneq_f16(vo0p2, vi1xACEG, vw89ABCDEF, 2);
      vo1p2 = vfma_laneq_f16(vo1p2, vi3xACEG, vw89ABCDEF, 2);
      ...
      vo0p2 = vfma_lane_f16(vo0p2, vi4xACEG, vwOP, 1);
      vo1p2 = vfma_lane_f16(vo1p2, vi6xACEG, vwOP, 1);

      vo0p0 = vadd_f16(vo0p0, vo0p1);
      vo1p0 = vadd_f16(vo1p0, vo1p1);
      vo0p0 = vadd_f16(vo0p0, vo0p2);
      vo1p0 = vadd_f16(vo1p0, vo1p2);
    ...
    assert(w >= 1 * sizeof(__fp16));
    {
      ...
      float16x4_t vo0p2 = vmul_laneq_f16(vi1x8ACE, vw89ABCDEF, 0);
      float16x4_t vo1p2 = vmul_laneq_f16(vi3x8ACE, vw89ABCDEF, 0);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x8ACE, vw89ABCDEF, 5);
      vo1p1 = vfma_laneq_f16(vo1p1, vi4x8ACE, vw89ABCDEF, 5);

      vo0p2 = vfma_laneq_f16(vo0p2, vi3x8ACE, vwGHIJKLMN, 2);
      vo1p2 = vfma_laneq_f16(vo1p2, vi5x8ACE, vwGHIJKLMN, 2);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi1x9BDF, vw89ABCDEF, 1);
      vo1p2 = vfma_laneq_f16(vo1p2, vi3x9BDF, vw89ABCDEF, 1);

      vo0p0 = vfma_laneq_f16(vo0p0, vi2x9BDF, vw89ABCDEF, 6);
      vo1p0 = vfma_laneq_f16(vo1p0, vi4x9BDF, vw89ABCDEF, 6);

      vo0p1 = vfma_laneq_f16(vo0p1, vi3x9BDF, vwGHIJKLMN, 3);
      vo1p1 = vfma_laneq_f16(vo1p1, vi5x9BDF, vwGHIJKLMN, 3);

      vo0p2 = vfma_lane_f16(vo0p2, vi4x9BDF, vwOP, 0);
      vo1p2 = vfma_lane_f16(vo1p2, vi6x9BDF, vwOP, 0);
    ...
    i2 = (const __fp16*) ((uintptr_t) i6 - input_decrement);

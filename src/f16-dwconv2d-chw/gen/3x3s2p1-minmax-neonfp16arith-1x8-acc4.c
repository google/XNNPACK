    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w >= 16 * sizeof(__fp16); w -= 16 * sizeof(__fp16)) {
      ...
      float16x8_t vo0p3 = vmulq_lane_f16(vi2x8ACE9BDF.val[0], vw89, 0);
      ...
      vo0p2 = vfmaq_laneq_f16(vo0p2, vi1x7BDF, vw01234567, 4);

      vo0p3 = vfmaq_laneq_f16(vo0p3, vi2x7BDF, vw01234567, 7);
      ...
      vo0p2 = vfmaq_lane_f16(vo0p2, vi2x8ACE9BDF.val[1], vw89, 1);
    ...
    if XNN_LIKELY(w != 0) {
      ...
      float16x8_t vo0p3 = vmulq_lane_f16(vi2x8ACE, vw89, 0);
      ...
      vo0p2 = vfmaq_lane_f16(vo0p2, vi2x9BDF, vw89, 1);

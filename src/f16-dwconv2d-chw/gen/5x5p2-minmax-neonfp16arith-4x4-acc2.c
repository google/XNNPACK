...
void xnn_f16_dwconv2d_chw_ukernel_5x5p2__neonfp16arith_4x4_acc2(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    float16x4_t vi7x0123 = vmov_n_f16(0.0f);
    ...
    for (; w > 8 * sizeof(__fp16); w -= 4 * sizeof(__fp16)) {
      ...
      float16x4_t vo0p1 = vmul_laneq_f16(vi0x4567, vw01234567, 3);
      float16x4_t vo1p1 = vmul_laneq_f16(vi1x4567, vw01234567, 3);
      float16x4_t vo2p1 = vmul_laneq_f16(vi2x4567, vw01234567, 3);
      float16x4_t vo3p1 = vmul_laneq_f16(vi3x4567, vw01234567, 3);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi3x4567, vwGHIJKLMN, 2);
      vo1p1 = vfma_laneq_f16(vo1p1, vi4x4567, vwGHIJKLMN, 2);
      vo2p1 = vfma_laneq_f16(vo2p1, vi5x4567, vwGHIJKLMN, 2);
      vo3p1 = vfma_laneq_f16(vo3p1, vi6x4567, vwGHIJKLMN, 2);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi0x3456, vw01234567, 2);
      vo1p1 = vfma_laneq_f16(vo1p1, vi1x3456, vw01234567, 2);
      vo2p1 = vfma_laneq_f16(vo2p1, vi2x3456, vw01234567, 2);
      vo3p1 = vfma_laneq_f16(vo3p1, vi3x3456, vw01234567, 2);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi2x3456, vw89ABCDEF, 4);
      vo1p1 = vfma_laneq_f16(vo1p1, vi3x3456, vw89ABCDEF, 4);
      vo2p1 = vfma_laneq_f16(vo2p1, vi4x3456, vw89ABCDEF, 4);
      vo3p1 = vfma_laneq_f16(vo3p1, vi5x3456, vw89ABCDEF, 4);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi4x3456, vwGHIJKLMN, 6);
      vo1p1 = vfma_laneq_f16(vo1p1, vi5x3456, vwGHIJKLMN, 6);
      vo2p1 = vfma_laneq_f16(vo2p1, vi6x3456, vwGHIJKLMN, 6);
      vo3p1 = vfma_laneq_f16(vo3p1, vi7x3456, vwGHIJKLMN, 6);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi1x2345, vw01234567, 6);
      vo1p1 = vfma_laneq_f16(vo1p1, vi2x2345, vw01234567, 6);
      vo2p1 = vfma_laneq_f16(vo2p1, vi3x2345, vw01234567, 6);
      vo3p1 = vfma_laneq_f16(vo3p1, vi4x2345, vw01234567, 6);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi3x2345, vwGHIJKLMN, 0);
      vo1p1 = vfma_laneq_f16(vo1p1, vi4x2345, vwGHIJKLMN, 0);
      vo2p1 = vfma_laneq_f16(vo2p1, vi5x2345, vwGHIJKLMN, 0);
      vo3p1 = vfma_laneq_f16(vo3p1, vi6x2345, vwGHIJKLMN, 0);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi0x5678, vw01234567, 4);
      vo1p1 = vfma_laneq_f16(vo1p1, vi1x5678, vw01234567, 4);
      vo2p1 = vfma_laneq_f16(vo2p1, vi2x5678, vw01234567, 4);
      vo3p1 = vfma_laneq_f16(vo3p1, vi3x5678, vw01234567, 4);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi2x5678, vw89ABCDEF, 6);
      vo1p1 = vfma_laneq_f16(vo1p1, vi3x5678, vw89ABCDEF, 6);
      vo2p1 = vfma_laneq_f16(vo2p1, vi4x5678, vw89ABCDEF, 6);
      vo3p1 = vfma_laneq_f16(vo3p1, vi5x5678, vw89ABCDEF, 6);
      ...
      vo0p1 = vfma_lane_f16(vo0p1, vi4x5678, vwOP, 0);
      vo1p1 = vfma_lane_f16(vo1p1, vi5x5678, vwOP, 0);
      vo2p1 = vfma_lane_f16(vo2p1, vi6x5678, vwOP, 0);
      vo3p1 = vfma_lane_f16(vo3p1, vi7x5678, vwOP, 0);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi1x6789, vw89ABCDEF, 2);
      vo1p1 = vfma_laneq_f16(vo1p1, vi2x6789, vw89ABCDEF, 2);
      vo2p1 = vfma_laneq_f16(vo2p1, vi3x6789, vw89ABCDEF, 2);
      vo3p1 = vfma_laneq_f16(vo3p1, vi4x6789, vw89ABCDEF, 2);
      ...
      vo0p1 = vfma_laneq_f16(vo0p1, vi3x6789, vwGHIJKLMN, 4);
      vo1p1 = vfma_laneq_f16(vo1p1, vi4x6789, vwGHIJKLMN, 4);
      vo2p1 = vfma_laneq_f16(vo2p1, vi5x6789, vwGHIJKLMN, 4);
      vo3p1 = vfma_laneq_f16(vo3p1, vi6x6789, vwGHIJKLMN, 4);

    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(uint16_t); w -= 8 * sizeof(uint16_t)) {
      ...
      float16x8_t vo1p2 = vmulq_lane_f16(vi2x89ABCDEF, vget_low_f16(vw89ABCDEF), 0);
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vi2x89ABCDEF, vw89ABCDEF, 5);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi2x89ABCDEF, vget_high_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi3x89ABCDEF, vw89ABCDEF, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi3x89ABCDEF, vget_high_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi3x89ABCDEF, vwGHIJKLMN, 2);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi3x89ABCDEF, vget_low_f16(vwGHIJKLMN), 2);
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi4x89ABCDEF, vwGHIJKLMN, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi4x89ABCDEF, vget_low_f16(vwGHIJKLMN), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi1x789ABCDE, vw01234567, 7);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi1x789ABCDE, vget_high_f16(vw01234567), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi2x789ABCDE, vw01234567, 7);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi2x789ABCDE, vget_high_f16(vw01234567), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vi3x789ABCDE, vwGHIJKLMN, 1);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi3x789ABCDE, vget_low_f16(vwGHIJKLMN), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi4x789ABCDE, vwGHIJKLMN, 1);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi4x789ABCDE, vget_low_f16(vwGHIJKLMN), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi4x789ABCDE, vwGHIJKLMN, 6);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi4x789ABCDE, vget_high_f16(vwGHIJKLMN), 2);
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi5x789ABCDE, vwGHIJKLMN, 6);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi5x789ABCDE, vget_high_f16(vwGHIJKLMN), 2);
      #endif
      // Left by 2 column
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi3x6789ABCD, vw89ABCDEF, 3);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi3x6789ABCD, vget_low_f16(vw89ABCDEF), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi5x6789ABCD, vwGHIJKLMN, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi5x6789ABCD, vget_high_f16(vwGHIJKLMN), 1);
      #endif
      // Right by 1 column
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi1x9ABCDEFG, vw01234567, 4);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi1x9ABCDEFG, vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi3x9ABCDEFG, vwGHIJKLMN, 3);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi3x9ABCDEFG, vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi4x9ABCDEFG, vwGHIJKLMN, 3);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi4x9ABCDEFG, vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vi0xABCDEFGH, vw01234567, 5);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi0xABCDEFGH, vget_high_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi1xABCDEFGH, vw01234567, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi1xABCDEFGH, vget_high_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi1xABCDEFGH, vw89ABCDEF, 2);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi1xABCDEFGH, vget_low_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi2xABCDEFGH, vw89ABCDEF, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi2xABCDEFGH, vget_low_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_lane_f16(vo1p2, vi5xABCDEFGH, vwOP, 1);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi5xABCDEFGH, vwOP, 1);
      #endif

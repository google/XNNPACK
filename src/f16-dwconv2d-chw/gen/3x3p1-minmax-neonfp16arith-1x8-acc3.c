    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p1 = vfmaq_laneq_f16(vo0p1, vi1x789ABCDE, vw01234567, 4);
      #else
        vo0p1 = vmlaq_lane_f16(vo0p1, vi1x789ABCDE, vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi2x789ABCDE, vw01234567, 7);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi2x789ABCDE, vget_high_f16(vw01234567), 3);
      #endif
      ...
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi2x9ABCDEFG, vw89, 1);
      #endif

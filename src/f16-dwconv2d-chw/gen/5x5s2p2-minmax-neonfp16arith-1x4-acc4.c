...
void xnn_f16_dwconv2d_chw_ukernel_5x5s2p2__neonfp16arith_1x4_acc4(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi4x8ACE9BDF.val[0], vwGHIJKLMN, 7);

      // Right by 1 column
      vo0p3 = vfma_laneq_f16(vo0p3, vi0x8ACE9BDF.val[1], vw01234567, 4);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x8ACE9BDF.val[1], vw89ABCDEF, 1);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x8ACE9BDF.val[1], vw89ABCDEF, 6);

      vo0p2 = vfma_laneq_f16(vo0p2, vi3x8ACE9BDF.val[1], vwGHIJKLMN, 3);

      vo0p3 = vfma_lane_f16(vo0p3, vi4x8ACE9BDF.val[1], vwOP, 0);
      ...
      vo0p3 = vfma_laneq_f16(vo0p3, vi3x68AC, vwGHIJKLMN, 0);
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi1x79BD, vw01234567, 7);

      vo0p3 = vfma_laneq_f16(vo0p3, vi2x79BD, vw89ABCDEF, 4);
    ...
    assert(w >= 1 * sizeof(__fp16));
    {
      ...
      vo0p2 = vfma_laneq_f16(vo0p2, vi4x8ACE, vwGHIJKLMN, 7);

      // Right by 1 column
      vo0p3 = vfma_laneq_f16(vo0p3, vi0x9BDF, vw01234567, 4);

      vo0p0 = vfma_laneq_f16(vo0p0, vi1x9BDF, vw89ABCDEF, 1);

      vo0p1 = vfma_laneq_f16(vo0p1, vi2x9BDF, vw89ABCDEF, 6);

      vo0p2 = vfma_laneq_f16(vo0p2, vi3x9BDF, vwGHIJKLMN, 3);

      vo0p3 = vfma_lane_f16(vo0p3, vi4x9BDF, vwOP, 0);

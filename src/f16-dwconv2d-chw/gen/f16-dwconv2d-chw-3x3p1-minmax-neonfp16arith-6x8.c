...
void xnn_f16_dwconv2d_chw_ukernel_3x3p1__neonfp16arith_6x8(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(uint16_t); w -= 8 * sizeof(uint16_t)) {
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi5x89ABCDEF, vw01234567, 2);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi5x89ABCDEF, vget_low_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi6x89ABCDEF, vw01234567, 5);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi6x89ABCDEF, vget_high_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_lane_f16(vo5p0, vi7x89ABCDEF, vw89, 0);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi7x89ABCDEF, vw89, 0);
      #endif
      // Left column
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi5x789ABCDE, vw01234567, 1);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi5x789ABCDE, vget_low_f16(vw01234567), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi6x789ABCDE, vw01234567, 4);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi6x789ABCDE, vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi7x789ABCDE, vw01234567, 7);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi7x789ABCDE, vget_high_f16(vw01234567), 3);
      #endif
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi5x9ABCDEFG, vw01234567, 3);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi5x9ABCDEFG, vget_low_f16(vw01234567), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_laneq_f16(vo5p0, vi6x9ABCDEFG, vw01234567, 6);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi6x9ABCDEFG, vget_high_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo5p0 = vfmaq_lane_f16(vo5p0, vi7x9ABCDEFG, vw89, 1);
      #else
        vo5p0 = vmlaq_lane_f16(vo5p0, vi7x9ABCDEFG, vw89, 1);
      #endif
      ...
      float16x8_t vo5 = vmaxq_f16(vo5p0, vmin);
    ...
    assert(w <= 8 * sizeof(uint16_t));
    {
      ...
      if XNN_LIKELY(w == 8 * sizeof(uint16_t)) {
        ...
        if (w & (1 * sizeof(uint16_t))) {
          vst1_lane_u16(o5, vreinterpret_u16_f16(vo5_lo), 0); o5 += 1;

    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w >= 16 * sizeof(__fp16); w -= 16 * sizeof(__fp16)) {
      ...
      float16x8_t vo1p1 = vmulq_laneq_f16(vi2x8ACE9BDF.val[0], vw01234567, 2);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi2x7BDF, vw01234567, 1);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi4x7BDF, vw01234567, 7);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi3x8ACE9BDF.val[1], vw01234567, 6);
    ...
    if XNN_LIKELY(w != 0) {
      ...
      float16x8_t vo1p1 = vmulq_laneq_f16(vi2x8ACE, vw01234567, 2);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi3x9BDF, vw01234567, 6);

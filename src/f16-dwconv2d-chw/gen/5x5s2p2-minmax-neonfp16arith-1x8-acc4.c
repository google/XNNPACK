...
void xnn_f16_dwconv2d_chw_ukernel_5x5s2p2__neonfp16arith_1x8_acc4(
    size_t input_height,
    size_t input_width,
    const void* input,
    const void* weights,
    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(uint16_t); w -= 16 * sizeof(uint16_t)) {
      ...
      float16x8_t vo0p3 = vmulq_lane_f16(vi2xGIKMOQSUHJLNPRTV.val[0], vget_high_f16(vw89ABCDEF), 1);
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi4xGIKMOQSUHJLNPRTV.val[0], vwGHIJKLMN, 7);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi4xGIKMOQSUHJLNPRTV.val[0], vget_high_f16(vwGHIJKLMN), 3);
      #endif
      // Right by 2 column
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi0xGIKMOQSUHJLNPRTV.val[1], vw01234567, 4);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi0xGIKMOQSUHJLNPRTV.val[1], vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi3xGIKMOQSUHJLNPRTV.val[1], vwGHIJKLMN, 3);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi3xGIKMOQSUHJLNPRTV.val[1], vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_lane_f16(vo0p3, vi4xGIKMOQSUHJLNPRTV.val[1], vwOP, 0);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi4xGIKMOQSUHJLNPRTV.val[1], vwOP, 0);
      #endif
      // Left by 2 column
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi3xEGIKMOQS, vwGHIJKLMN, 0);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi3xEGIKMOQS, vget_low_f16(vwGHIJKLMN), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi1xFHJLNPRT, vw01234567, 7);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi1xFHJLNPRT, vget_high_f16(vw01234567), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi2xFHJLNPRT, vw89ABCDEF, 4);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi2xFHJLNPRT, vget_high_f16(vw89ABCDEF), 0);
      #endif
      #if XNN_ARCH_ARM64
    ...
    assert(w >= 1 * sizeof(uint16_t));
    {
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi4xGIKMOQSU, vwGHIJKLMN, 7);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi4xGIKMOQSU, vget_high_f16(vwGHIJKLMN), 3);
      #endif
      // Right by 1 column
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi0xHJLNPRTV, vw01234567, 4);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi0xHJLNPRTV, vget_high_f16(vw01234567), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo0p2 = vfmaq_laneq_f16(vo0p2, vi3xHJLNPRTV, vwGHIJKLMN, 3);
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi3xHJLNPRTV, vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_lane_f16(vo0p3, vi4xHJLNPRTV, vwOP, 0);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi4xHJLNPRTV, vwOP, 0);
      #endif
      // Left by 2 columns

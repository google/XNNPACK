    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(uint16_t); w -= 8 * sizeof(uint16_t)) {
      ...
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi4x89ABCDEF, vget_high_f16(vwGHIJKLMN), 3);
      #endif
      // Left by 1 column
      ...
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi0x789ABCDE, vget_low_f16(vw01234567), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi3x789ABCDE, vget_low_f16(vwGHIJKLMN), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi4x789ABCDE, vwGHIJKLMN, 6);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi4x789ABCDE, vget_high_f16(vwGHIJKLMN), 2);
      #endif
      // Left by 2 column
      ...
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi2x6789ABCD, vget_low_f16(vw89ABCDEF), 3);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi3x6789ABCD, vwGHIJKLMN, 0);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi3x6789ABCD, vget_low_f16(vwGHIJKLMN), 0);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi1x9ABCDEFG, vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
        vo0p3 = vfmaq_laneq_f16(vo0p3, vi2x9ABCDEFG, vw89ABCDEF, 6);
      #else
        vo0p3 = vmlaq_lane_f16(vo0p3, vi2x9ABCDEFG, vget_high_f16(vw89ABCDEF), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #else
        vo0p2 = vmlaq_lane_f16(vo0p2, vi4xABCDEFGH, vwOP, 1);
      #endif

    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(__fp16); w -= 8 * sizeof(__fp16)) {
      ...
      vo0p2 = vfmaq_laneq_f16(vo0p2, vi4x4567, vwGHIJKLMN, 7);
      ...
      vo0p3 = vfmaq_laneq_f16(vo0p3, vi0x3456, vw01234567, 2);

      vo0p0 = vfmaq_laneq_f16(vo0p0, vi1x3456, vw01234567, 7);

      vo0p1 = vfmaq_laneq_f16(vo0p1, vi2x3456, vw89ABCDEF, 4);

      vo0p2 = vfmaq_laneq_f16(vo0p2, vi3x3456, vwGHIJKLMN, 1);

      vo0p3 = vfmaq_laneq_f16(vo0p3, vi4x3456, vwGHIJKLMN, 6);
      ...
      vo0p3 = vfmaq_laneq_f16(vo0p3, vi3x2345, vwGHIJKLMN, 0);
      ...
      vo0p2 = vfmaq_laneq_f16(vo0p2, vi1x5678, vw89ABCDEF, 1);

      vo0p3 = vfmaq_laneq_f16(vo0p3, vi2x5678, vw89ABCDEF, 6);

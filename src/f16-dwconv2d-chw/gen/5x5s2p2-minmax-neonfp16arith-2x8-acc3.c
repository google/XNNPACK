    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(__fp16); w -= 16 * sizeof(__fp16)) {
      ...
      float16x8_t vo1p2 = vmulq_lane_f16(vi3xGIKMOQSUHJLNPRTV.val[0], vget_low_f16(vw89ABCDEF), 0);
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi4xGIKMOQSUHJLNPRTV.val[0], vw89ABCDEF, 5);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi4xGIKMOQSUHJLNPRTV.val[0], vget_high_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi5xGIKMOQSUHJLNPRTV.val[0], vwGHIJKLMN, 2);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi5xGIKMOQSUHJLNPRTV.val[0], vget_low_f16(vwGHIJKLMN), 2);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_laneq_f16(vo1p2, vi3xGIKMOQSUHJLNPRTV.val[1], vw89ABCDEF, 1);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi3xGIKMOQSUHJLNPRTV.val[1], vget_low_f16(vw89ABCDEF), 1);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p1 = vfmaq_laneq_f16(vo1p1, vi5xGIKMOQSUHJLNPRTV.val[1], vwGHIJKLMN, 3);
      #else
        vo1p1 = vmlaq_lane_f16(vo1p1, vi5xGIKMOQSUHJLNPRTV.val[1], vget_low_f16(vwGHIJKLMN), 3);
      #endif
      #if XNN_ARCH_ARM64
      ...
      #endif
      #if XNN_ARCH_ARM64
        vo1p2 = vfmaq_lane_f16(vo1p2, vi6xGIKMOQSUHJLNPRTV.val[1], vwOP, 0);
      #else
        vo1p2 = vmlaq_lane_f16(vo1p2, vi6xGIKMOQSUHJLNPRTV.val[1], vwOP, 0);
      #endif
      // Left by 2 column

    ...
    const union xnn_f16_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 16 * sizeof(__fp16); w -= 16 * sizeof(__fp16)) {
      ...
      float16x8_t vo1p2 = vmulq_laneq_f16(vi3x8ACE9BDF.val[0], vw89ABCDEF, 0);

      vo0p1 = vfmaq_laneq_f16(vo0p1, vi2x8ACE9BDF.val[0], vw89ABCDEF, 5);
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi4x8ACE9BDF.val[0], vw89ABCDEF, 5);

      vo0p2 = vfmaq_laneq_f16(vo0p2, vi3x8ACE9BDF.val[0], vwGHIJKLMN, 2);
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi5x8ACE9BDF.val[0], vwGHIJKLMN, 2);
      ...
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi3x8ACE9BDF.val[1], vw89ABCDEF, 1);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi5x8ACE9BDF.val[1], vwGHIJKLMN, 3);

      vo0p2 = vfmaq_lane_f16(vo0p2, vi4x8ACE9BDF.val[1], vwOP, 0);
      vo1p2 = vfmaq_lane_f16(vo1p2, vi6x8ACE9BDF.val[1], vwOP, 0);
      ...
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi4x68AC, vw89ABCDEF, 3);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi6x68AC, vwGHIJKLMN, 5);
      ...
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi2x79BD, vw01234567, 2);
      ...
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi5x79BD, vwGHIJKLMN, 1);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi2xACEG, vw01234567, 5);

      vo0p2 = vfmaq_laneq_f16(vo0p2, vi1xACEG, vw89ABCDEF, 2);
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi3xACEG, vw89ABCDEF, 2);
      ...
      vo1p2 = vfmaq_lane_f16(vo1p2, vi6xACEG, vwOP, 1);
    ...
    assert(w >= 1 * sizeof(__fp16));
    {
      ...
      float16x8_t vo1p2 = vmulq_laneq_f16(vi3x8ACE, vw89ABCDEF, 0);

      vo0p1 = vfmaq_laneq_f16(vo0p1, vi2x8ACE, vw89ABCDEF, 5);
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi4x8ACE, vw89ABCDEF, 5);

      vo0p2 = vfmaq_laneq_f16(vo0p2, vi3x8ACE, vwGHIJKLMN, 2);
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi5x8ACE, vwGHIJKLMN, 2);
      ...
      vo1p2 = vfmaq_laneq_f16(vo1p2, vi3x9BDF, vw89ABCDEF, 1);
      ...
      vo1p1 = vfmaq_laneq_f16(vo1p1, vi5x9BDF, vwGHIJKLMN, 3);

      vo0p2 = vfmaq_lane_f16(vo0p2, vi4x9BDF, vwOP, 0);
      vo1p2 = vfmaq_lane_f16(vo1p2, vi6x9BDF, vwOP, 0);

    ...
    const union xnn_qs8_avgpool_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    int32_t n = __riscv_vsetvl_e8m2(c); c -= n;
    ...
    vint32m8_t acc_i32v = __riscv_vwadd_vx_i32m8(acc_i16v, init_bias, n);
    __riscv_vse32_v_i32m8(b, acc_i32v, n); b += n;
  } while (c > 0);
  ...
  for (rows -= 7; rows > 7; rows -= 7) {
    ...
    do {
      ...
      vint32m8_t acc_i32v = __riscv_vle32_v_i32m8(b, n);
      acc_i32v = __riscv_vwadd_wv_i32m8(acc_i32v, acc_i16v, n);
      __riscv_vse32_v_i32m8(b, acc_i32v, n); b += n;
    } while (c > 0);
  }
  ...
  do {
    ...
    vint32m8_t acc_i32v = __riscv_vle32_v_i32m8(buffer, n); buffer += n;
    acc_i32v = __riscv_vwadd_wv_i32m8(acc_i32v, acc_i16v, n);

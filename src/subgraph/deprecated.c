...
enum xnn_status xnn_define_even_split2(xnn_subgraph_t subgraph, int32_t split_dim, uint32_t input_id,
  ...
  return xnn_define_even_split(subgraph, xnn_even_split2, split_dim, input_id, /*num_outputs=*/2, outputs_id, flags);
}
...
enum xnn_status xnn_define_even_split3(xnn_subgraph_t subgraph, int32_t split_dim, uint32_t input_id,
  ...
  return xnn_define_even_split(subgraph, xnn_even_split3, split_dim, input_id, /*num_outputs=*/3, outputs_id, flags);
}
...
enum xnn_status xnn_define_even_split4(xnn_subgraph_t subgraph, int32_t split_dim, uint32_t input_id,
  ...
  return xnn_define_even_split(subgraph, xnn_even_split4, split_dim, input_id, /*num_outputs=*/4, outputs_id, flags);
}

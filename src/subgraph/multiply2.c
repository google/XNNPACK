...
enum xnn_status xnn_define_multiply2(
  ...
  uint32_t flags)
{
  if (!xnn_subgraph_xnnpack_initialized(xnn_node_type_multiply2)) {
  ...
  if (!xnn_subgraph_valid_nth_input_id(xnn_node_type_multiply2, input1_id, subgraph->num_values, 1)) {
    return xnn_status_invalid_parameter;
  }
  ...
  if (input1_value->type != xnn_value_type_dense_tensor) {
    xnn_log_error(
      ...
      xnn_node_type_to_string(xnn_node_type_multiply2), input1_id, input1_value->type);
    return xnn_status_invalid_parameter;
  }
  ...
  if (!xnn_subgraph_valid_nth_input_id(xnn_node_type_multiply2, input2_id, subgraph->num_values, 2)) {
    return xnn_status_invalid_parameter;
  }
  ...
  if (input2_value->type != xnn_value_type_dense_tensor) {
    xnn_log_error(
      ...
      xnn_node_type_to_string(xnn_node_type_multiply2), input2_id, input2_value->type);
    return xnn_status_invalid_parameter;
  }
  ...
  if (output_value->type != xnn_value_type_dense_tensor) {
    xnn_log_error(
      ...
      xnn_node_type_to_string(xnn_node_type_multiply2), output_id, output_value->type);
    return xnn_status_invalid_parameter;
  }
      ...
      input1_value->datatype != output_value->datatype)
  {
    xnn_log_error(
      ...
      xnn_node_type_to_string(xnn_node_type_multiply2), input1_id, input2_id, output_id,

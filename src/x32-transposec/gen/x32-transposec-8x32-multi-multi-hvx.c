...
void xnn_x32_transposec_ukernel__8x32_multi_multi_hvx(
    ...
    size_t block_height) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; bh >= 8; bh -= 8) {
      const HVX_Vector v3_0 = *((HVX_UVector *) i0); i0 = (uint32_t*) ((uintptr_t) i0 + input_offset);
      const HVX_Vector v3_1 = *((HVX_UVector *) i1); i1 = (uint32_t*) ((uintptr_t) i1 + input_offset);
      const HVX_Vector v3_2 = *((HVX_UVector *) i2); i2 = (uint32_t*) ((uintptr_t) i2 + input_offset);
      const HVX_Vector v3_3 = *((HVX_UVector *) i3); i3 = (uint32_t*) ((uintptr_t) i3 + input_offset);
      const HVX_Vector v3_4 = *((HVX_UVector *) i4); i4 = (uint32_t*) ((uintptr_t) i4 + input_offset);
      const HVX_Vector v3_5 = *((HVX_UVector *) i5); i5 = (uint32_t*) ((uintptr_t) i5 + input_offset);
      const HVX_Vector v3_6 = *((HVX_UVector *) i6); i6 = (uint32_t*) ((uintptr_t) i6 + input_offset);
      const HVX_Vector v3_7 = *((HVX_UVector *) i7); i7 = (uint32_t*) ((uintptr_t) i7 + input_offset);

      int rt = -4;
      const HVX_VectorPair v2_0 = Q6_W_vshuff_VVR(v3_1, v3_0, rt);
      const HVX_VectorPair v2_1 = Q6_W_vshuff_VVR(v3_3, v3_2, rt);
      const HVX_VectorPair v2_2 = Q6_W_vshuff_VVR(v3_5, v3_4, rt);
      const HVX_VectorPair v2_3 = Q6_W_vshuff_VVR(v3_7, v3_6, rt);

      rt = rt << 1;
      HVX_VectorPair v1_0 = Q6_W_vshuff_VVR(Q6_V_lo_W(v2_1), Q6_V_lo_W(v2_0), rt);
      HVX_VectorPair v1_1 = Q6_W_vshuff_VVR(Q6_V_hi_W(v2_1), Q6_V_hi_W(v2_0), rt);
      
      HVX_VectorPair v1_2 = Q6_W_vshuff_VVR(Q6_V_lo_W(v2_3), Q6_V_lo_W(v2_2), rt);
      HVX_VectorPair v1_3 = Q6_W_vshuff_VVR(Q6_V_hi_W(v2_3), Q6_V_hi_W(v2_2), rt);
      
      rt = rt << 1;
      HVX_VectorPair v0_0 = Q6_W_vshuff_VVR(Q6_V_lo_W(v1_2), Q6_V_lo_W(v1_0), rt);
      HVX_VectorPair v0_1 = Q6_W_vshuff_VVR(Q6_V_hi_W(v1_2), Q6_V_hi_W(v1_0), rt);
      
      HVX_VectorPair v0_2 = Q6_W_vshuff_VVR(Q6_V_lo_W(v1_3), Q6_V_lo_W(v1_1), rt);
      HVX_VectorPair v0_3 = Q6_W_vshuff_VVR(Q6_V_hi_W(v1_3), Q6_V_hi_W(v1_1), rt);

...
#if XNN_LOG_LEVEL > 0
static const uint16_t offset[56] = {
  0, 8, 12, 17, 35, 54, 71, 93, 101, 107, 120, 133, 146, 159, 167, 182, 187, 204, 222, 247, 254, 258, 270, 282, 294,
  300, 316, 339, 365, 391, 413, 435, 445, 456, 471, 480, 489, 499, 506, 512, 517, 546, 554, 562, 580, 587, 599, 618,
  638, 650, 665, 691, 704, 721, 730, 735
};

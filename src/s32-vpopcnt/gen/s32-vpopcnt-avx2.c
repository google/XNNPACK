...
void xnn_s32_vpopcnt_ukernel__avx2_u8(
    size_t batch,
    const int32_t* input,
    int32_t* output,
...
void xnn_s32_vpopcnt_ukernel__avx2_u16(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_vpopcnt_ukernel__avx2_u24(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_vpopcnt_ukernel__avx2_u32(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])

...
// MurmurHash3 implementation, copied from smhasher.
...
static void murmur_hash3(const void* key, int len, uint32_t seed, void* out)
{
...
{
  uint32_t hash;
  murmur_hash3(code_span.code, code_span.size, /*seed=*/XNN_CODE_CACHE_HASH_SEED, &hash);
  size_t idx;

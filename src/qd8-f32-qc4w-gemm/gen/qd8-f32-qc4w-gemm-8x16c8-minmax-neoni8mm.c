...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc45x89 = vmmlaq_s32(vacc45x89, va45x01234567, vxb89ABx01234567.val[0]);
      vacc45xAB = vmmlaq_s32(vacc45xAB, va45x01234567, vxb89ABx01234567.val[1]);
      vacc45xCD = vmmlaq_s32(vacc45xCD, va45x01234567, vxbCDEFx01234567.val[0]);
      vacc45xEF = vmmlaq_s32(vacc45xEF, va45x01234567, vxbCDEFx01234567.val[1]);
      ...
      vacc67x89 = vmmlaq_s32(vacc67x89, va67x01234567, vxb89ABx01234567.val[0]);
      vacc67xAB = vmmlaq_s32(vacc67xAB, va67x01234567, vxb89ABx01234567.val[1]);
      vacc67xCD = vmmlaq_s32(vacc67xCD, va67x01234567, vxbCDEFx01234567.val[0]);
      vacc67xEF = vmmlaq_s32(vacc67xEF, va67x01234567, vxbCDEFx01234567.val[1]);
      ...
      vacc45x89 = vmmlaq_s32(vacc45x89, va45x89ABCDEF, vxb89ABx89ABCDEF.val[0]);
      vacc45xAB = vmmlaq_s32(vacc45xAB, va45x89ABCDEF, vxb89ABx89ABCDEF.val[1]);
      vacc45xCD = vmmlaq_s32(vacc45xCD, va45x89ABCDEF, vxbCDEFx89ABCDEF.val[0]);
      vacc45xEF = vmmlaq_s32(vacc45xEF, va45x89ABCDEF, vxbCDEFx89ABCDEF.val[1]);
      ...
      vacc67x89 = vmmlaq_s32(vacc67x89, va67x89ABCDEF, vxb89ABx89ABCDEF.val[0]);
      vacc67xAB = vmmlaq_s32(vacc67xAB, va67x89ABCDEF, vxb89ABx89ABCDEF.val[1]);
      vacc67xCD = vmmlaq_s32(vacc67xCD, va67x89ABCDEF, vxbCDEFx89ABCDEF.val[0]);
      vacc67xEF = vmmlaq_s32(vacc67xEF, va67x89ABCDEF, vxbCDEFx89ABCDEF.val[1]);
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      vacc45x89 = vmmlaq_s32(vacc45x89, vreinterpretq_s8_u64(va45x01234567), vxb89ABx01234567.val[0]);
      vacc45xAB = vmmlaq_s32(vacc45xAB, vreinterpretq_s8_u64(va45x01234567), vxb89ABx01234567.val[1]);
      vacc45xCD = vmmlaq_s32(vacc45xCD, vreinterpretq_s8_u64(va45x01234567), vxbCDEFx01234567.val[0]);
      vacc45xEF = vmmlaq_s32(vacc45xEF, vreinterpretq_s8_u64(va45x01234567), vxbCDEFx01234567.val[1]);
      ...
      vacc67x89 = vmmlaq_s32(vacc67x89, vreinterpretq_s8_u64(va67x01234567), vxb89ABx01234567.val[0]);
      vacc67xAB = vmmlaq_s32(vacc67xAB, vreinterpretq_s8_u64(va67x01234567), vxb89ABx01234567.val[1]);
      vacc67xCD = vmmlaq_s32(vacc67xCD, vreinterpretq_s8_u64(va67x01234567), vxbCDEFx01234567.val[0]);
      vacc67xEF = vmmlaq_s32(vacc67xEF, vreinterpretq_s8_u64(va67x01234567), vxbCDEFx01234567.val[1]);
    }

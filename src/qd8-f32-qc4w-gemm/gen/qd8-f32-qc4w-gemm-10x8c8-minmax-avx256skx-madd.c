...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_10x8c8__avx256skx_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256i vacc16_9x0123 = _mm256_setzero_si256();
    __m256i vacc16_9x4567 = _mm256_setzero_si256();
    w = (const int32_t*) w + 8;
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc16_9x0123 = _mm256_add_epi16(vacc16_9x0123, _mm256_maddubs_epi16(va9x01234567, vb01234567x0123));
      vacc16_9x4567 = _mm256_add_epi16(vacc16_9x4567, _mm256_maddubs_epi16(va9x01234567, vb89ABCDEFx0123));
      ...
      vacc16_9x0123 = _mm256_add_epi16(vacc16_9x0123, _mm256_maddubs_epi16(va9x89ABCDEF, vb01234567x4567));
      vacc16_9x4567 = _mm256_add_epi16(vacc16_9x4567, _mm256_maddubs_epi16(va9x89ABCDEF, vb89ABCDEFx4567));
    ...
    vacc9x0123 = _mm256_sub_epi32(vacc9x0123, _mm256_madd_epi16(vacc16_9x0123, vminus_one));
    vacc9x4567 = _mm256_sub_epi32(vacc9x4567, _mm256_madd_epi16(vacc16_9x4567, vminus_one));

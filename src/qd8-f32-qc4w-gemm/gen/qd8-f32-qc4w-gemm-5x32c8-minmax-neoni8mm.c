...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_5x32c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vksumzp4xSTUV = vmulq_s32(vksumSTUV, vinput_zero_point45);
      ...
      int32x4_t vacc45xGH = vcombine_s32(vget_low_s32(vksumzp4xGHIJ), vget_low_s32(vksumzp4xGHIJ));
      int32x4_t vacc45xIJ = vcombine_s32(vget_high_s32(vksumzp4xGHIJ), vget_high_s32(vksumzp4xGHIJ));
      int32x4_t vacc45xKL = vcombine_s32(vget_low_s32(vksumzp4xKLMN), vget_low_s32(vksumzp4xKLMN));
      int32x4_t vacc45xMN = vcombine_s32(vget_high_s32(vksumzp4xKLMN), vget_high_s32(vksumzp4xKLMN));
      int32x4_t vacc45xOP = vcombine_s32(vget_low_s32(vksumzp4xOPQR), vget_low_s32(vksumzp4xOPQR));
      int32x4_t vacc45xQR = vcombine_s32(vget_high_s32(vksumzp4xOPQR), vget_high_s32(vksumzp4xOPQR));
      int32x4_t vacc45xST = vcombine_s32(vget_low_s32(vksumzp4xSTUV), vget_low_s32(vksumzp4xSTUV));
      int32x4_t vacc45xUV = vcombine_s32(vget_high_s32(vksumzp4xSTUV), vget_high_s32(vksumzp4xSTUV));
    #endif

...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_8x32c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vksumzp6xGHIJ = vmulq_lane_s32(vksumGHIJ, vget_low_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp7xGHIJ = vmulq_lane_s32(vksumGHIJ, vget_high_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp6xKLMN = vmulq_lane_s32(vksumKLMN, vget_low_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp7xKLMN = vmulq_lane_s32(vksumKLMN, vget_high_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp6xOPQR = vmulq_lane_s32(vksumOPQR, vget_low_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp7xOPQR = vmulq_lane_s32(vksumOPQR, vget_high_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp6xSTUV = vmulq_lane_s32(vksumSTUV, vget_low_s32(vinput_zero_point67), 0);
    const int32x4_t vksumzp7xSTUV = vmulq_lane_s32(vksumSTUV, vget_high_s32(vinput_zero_point67), 0);
      ...
      int32x4_t vacc67xGH = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vksumzp6xGHIJ), vreinterpretq_u64_s32(vksumzp7xGHIJ)));
      int32x4_t vacc67xIJ = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vksumzp6xGHIJ), vreinterpretq_u64_s32(vksumzp7xGHIJ)));
      int32x4_t vacc67xKL = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vksumzp6xKLMN), vreinterpretq_u64_s32(vksumzp7xKLMN)));
      int32x4_t vacc67xMN = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vksumzp6xKLMN), vreinterpretq_u64_s32(vksumzp7xKLMN)));
      int32x4_t vacc67xOP = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vksumzp6xOPQR), vreinterpretq_u64_s32(vksumzp7xOPQR)));
      int32x4_t vacc67xQR = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vksumzp6xOPQR), vreinterpretq_u64_s32(vksumzp7xOPQR)));
      int32x4_t vacc67xST = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vksumzp6xSTUV), vreinterpretq_u64_s32(vksumzp7xSTUV)));
      int32x4_t vacc67xUV = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vksumzp6xSTUV), vreinterpretq_u64_s32(vksumzp7xSTUV)));
    #else
      ...
      int32x4_t vacc67xGH = vcombine_s32(vget_low_s32(vksumzp6xGHIJ), vget_low_s32(vksumzp7xGHIJ));
      int32x4_t vacc67xIJ = vcombine_s32(vget_high_s32(vksumzp6xGHIJ), vget_high_s32(vksumzp7xGHIJ));
      int32x4_t vacc67xKL = vcombine_s32(vget_low_s32(vksumzp6xKLMN), vget_low_s32(vksumzp7xKLMN));
      int32x4_t vacc67xMN = vcombine_s32(vget_high_s32(vksumzp6xKLMN), vget_high_s32(vksumzp7xKLMN));
      int32x4_t vacc67xOP = vcombine_s32(vget_low_s32(vksumzp6xOPQR), vget_low_s32(vksumzp7xOPQR));
      int32x4_t vacc67xQR = vcombine_s32(vget_high_s32(vksumzp6xOPQR), vget_high_s32(vksumzp7xOPQR));
      int32x4_t vacc67xST = vcombine_s32(vget_low_s32(vksumzp6xSTUV), vget_low_s32(vksumzp7xSTUV));
      int32x4_t vacc67xUV = vcombine_s32(vget_high_s32(vksumzp6xSTUV), vget_high_s32(vksumzp7xSTUV));
    #endif
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      int32x4_t vacc7xGHIJ = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vacc67xGH), vreinterpretq_u64_s32(vacc67xIJ)));
      int32x4_t vacc6xKLMN = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vacc67xKL), vreinterpretq_u64_s32(vacc67xMN)));
      int32x4_t vacc7xKLMN = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vacc67xKL), vreinterpretq_u64_s32(vacc67xMN)));
      int32x4_t vacc6xOPQR = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vacc67xOP), vreinterpretq_u64_s32(vacc67xQR)));
      int32x4_t vacc7xOPQR = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vacc67xOP), vreinterpretq_u64_s32(vacc67xQR)));
      int32x4_t vacc6xSTUV = vreinterpretq_s32_u64(vtrn1q_u64(vreinterpretq_u64_s32(vacc67xST), vreinterpretq_u64_s32(vacc67xUV)));
      int32x4_t vacc7xSTUV = vreinterpretq_s32_u64(vtrn2q_u64(vreinterpretq_u64_s32(vacc67xST), vreinterpretq_u64_s32(vacc67xUV)));
    #else
      ...
      int32x4_t vacc7xGHIJ = vcombine_s32(vget_high_s32(vacc67xGH), vget_high_s32(vacc67xIJ));
      int32x4_t vacc6xKLMN = vcombine_s32(vget_low_s32(vacc67xKL), vget_low_s32(vacc67xMN));
      int32x4_t vacc7xKLMN = vcombine_s32(vget_high_s32(vacc67xKL), vget_high_s32(vacc67xMN));
      int32x4_t vacc6xOPQR = vcombine_s32(vget_low_s32(vacc67xOP), vget_low_s32(vacc67xQR));
      int32x4_t vacc7xOPQR = vcombine_s32(vget_high_s32(vacc67xOP), vget_high_s32(vacc67xQR));
      int32x4_t vacc6xSTUV = vcombine_s32(vget_low_s32(vacc67xST), vget_low_s32(vacc67xUV));
      int32x4_t vacc7xSTUV = vcombine_s32(vget_high_s32(vacc67xST), vget_high_s32(vacc67xUV));
    #endif
    ...
    float32x4_t vout7x89AB = vcvtq_n_f32_s32(vacc7x89AB, 4);
    float32x4_t vout7xCDEF = vcvtq_n_f32_s32(vacc7xCDEF, 4);
    float32x4_t vout7xGHIJ = vcvtq_n_f32_s32(vacc7xGHIJ, 4);
    float32x4_t vout7xKLMN = vcvtq_n_f32_s32(vacc7xKLMN, 4);
    float32x4_t vout7xOPQR = vcvtq_n_f32_s32(vacc7xOPQR, 4);
    float32x4_t vout7xSTUV = vcvtq_n_f32_s32(vacc7xSTUV, 4);
    ...
    vout6xGHIJ = vmulq_lane_f32(vout6xGHIJ, vget_low_f32(vinput_scale67), 1);
    vout7xGHIJ = vmulq_lane_f32(vout7xGHIJ, vget_high_f32(vinput_scale67), 1);
    vout6xKLMN = vmulq_lane_f32(vout6xKLMN, vget_low_f32(vinput_scale67), 1);
    vout7xKLMN = vmulq_lane_f32(vout7xKLMN, vget_high_f32(vinput_scale67), 1);
    vout6xOPQR = vmulq_lane_f32(vout6xOPQR, vget_low_f32(vinput_scale67), 1);
    vout7xOPQR = vmulq_lane_f32(vout7xOPQR, vget_high_f32(vinput_scale67), 1);
    vout6xSTUV = vmulq_lane_f32(vout6xSTUV, vget_low_f32(vinput_scale67), 1);
    vout7xSTUV = vmulq_lane_f32(vout7xSTUV, vget_high_f32(vinput_scale67), 1);
    ...
    vout7xGHIJ = vmaxq_f32(vout7xGHIJ, voutput_min);
    vout7xKLMN = vmaxq_f32(vout7xKLMN, voutput_min);
    vout7xOPQR = vmaxq_f32(vout7xOPQR, voutput_min);
    vout7xSTUV = vmaxq_f32(vout7xSTUV, voutput_min);
    ...
    vout7xGHIJ = vminq_f32(vout7xGHIJ, voutput_max);
    vout7xKLMN = vminq_f32(vout7xKLMN, voutput_max);
    vout7xOPQR = vminq_f32(vout7xOPQR, voutput_max);
    vout7xSTUV = vminq_f32(vout7xSTUV, voutput_max);
    ...
    if XNN_LIKELY(nc >= 32) {
      ...
      vst1q_f32(c6 + 16, vout6xGHIJ);
      vst1q_f32(c6 + 20, vout6xKLMN);
      vst1q_f32(c6 + 24, vout6xOPQR);
      vst1q_f32(c6 + 28, vout6xSTUV);
      vst1q_f32(c7, vout7x0123);
      vst1q_f32(c7 + 4, vout7x4567);
      vst1q_f32(c7 + 8, vout7x89AB);
      vst1q_f32(c7 + 12, vout7xCDEF);
      vst1q_f32(c7 + 16, vout7xGHIJ);
      vst1q_f32(c7 + 20, vout7xKLMN);
      vst1q_f32(c7 + 24, vout7xOPQR);
      vst1q_f32(c7 + 28, vout7xSTUV);
     ...
     if (nc & 16) {
       ...
       vout6x0123 = vout6xGHIJ;
       vst1q_f32(c7, vout7x0123); c7 += 4;
       vout7x0123 = vout7xGHIJ;
       ...
       vout6x4567 = vout6xKLMN;
       vst1q_f32(c7, vout7x4567); c7 += 4;
       vout7x4567 = vout7xKLMN;
       ...
       vst1q_f32(c6, vout6x89AB); c6 += 4;
       vout6x89AB = vout6xOPQR;
       vst1q_f32(c7, vout7x89AB); c7 += 4;
       vout7x89AB = vout7xOPQR;
       ...
       vst1q_f32(c6, vout6xCDEF); c6 += 4;
       vout6xCDEF = vout6xSTUV;
       vst1q_f32(c7, vout7xCDEF); c7 += 4;
       vout7xCDEF = vout7xSTUV;
     }
     if (nc & 8) {
       vst1q_f32(c0, vout0x0123); c0 += 4;

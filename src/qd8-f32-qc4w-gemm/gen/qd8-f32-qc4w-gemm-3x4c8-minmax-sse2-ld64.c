    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k < kc) {
      ...
      const __m128i vsb0 = _mm_cmpgt_epi8(_mm_setzero_si128(), vbm0);
      ...
      const __m128i vsb1 = _mm_cmpgt_epi8(_mm_setzero_si128(), vbm1);
      ...
      const __m128i vsb2 = _mm_cmpgt_epi8(_mm_setzero_si128(), vbm2);
      ...
      const __m128i vsb3 = _mm_cmpgt_epi8(_mm_setzero_si128(), vbm3);

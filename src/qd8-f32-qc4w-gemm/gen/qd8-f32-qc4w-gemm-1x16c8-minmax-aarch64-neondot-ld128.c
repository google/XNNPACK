    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; k >= 16 * sizeof(int8_t); k -= 16 * sizeof(int8_t)) {
      ...
      const uint8x16_t vb0123c0246 = vshlq_n_u8(vb0123c01234567, 4);
      const uint8x16_t vb0123c1357 = vandq_u8(vb0123c01234567, vmask);
      const uint8x16_t vb4567c0246 = vshlq_n_u8(vb4567c01234567, 4);
      const uint8x16_t vb4567c1357 = vandq_u8(vb4567c01234567, vmask);
      const uint8x16_t vb89ABc0246 = vshlq_n_u8(vb89ABc01234567, 4);
      const uint8x16_t vb89ABc1357 = vandq_u8(vb89ABc01234567, vmask);
      const uint8x16_t vbCDEFc0246 = vshlq_n_u8(vbCDEFc01234567, 4);
      const uint8x16_t vbCDEFc1357 = vandq_u8(vbCDEFc01234567, vmask);
      const uint8x16x2_t vbi0123c01234567 = vzipq_u8(vb0123c0246, vb0123c1357);
      const int8x16_t vb01c01234567 = vreinterpretq_s8_u8(vbi0123c01234567.val[0]);
      const int8x16_t vb23c01234567 = vreinterpretq_s8_u8(vbi0123c01234567.val[1]);
      const uint8x16x2_t vbi4567c01234567 = vzipq_u8(vb4567c0246, vb4567c1357);
      const int8x16_t vb45c01234567 = vreinterpretq_s8_u8(vbi4567c01234567.val[0]);
      const int8x16_t vb67c01234567 = vreinterpretq_s8_u8(vbi4567c01234567.val[1]);
      const uint8x16x2_t vbi89ABc01234567 = vzipq_u8(vb89ABc0246, vb89ABc1357);
      const int8x16_t vb89c01234567 = vreinterpretq_s8_u8(vbi89ABc01234567.val[0]);
      const int8x16_t vbABc01234567 = vreinterpretq_s8_u8(vbi89ABc01234567.val[1]);
      const uint8x16x2_t vbiCDEFc01234567 = vzipq_u8(vbCDEFc0246, vbCDEFc1357);
      const int8x16_t vbCDc01234567 = vreinterpretq_s8_u8(vbiCDEFc01234567.val[0]);
      const int8x16_t vbEFc01234567 = vreinterpretq_s8_u8(vbiCDEFc01234567.val[1]);
      ...
      const uint8x16_t vb0123c8ACE = vshlq_n_u8(vb0123c89ABCDEF, 4);
      const uint8x16_t vb0123c9BDF = vandq_u8(vb0123c89ABCDEF, vmask);
      const uint8x16_t vb4567c8ACE = vshlq_n_u8(vb4567c89ABCDEF, 4);
      const uint8x16_t vb4567c9BDF = vandq_u8(vb4567c89ABCDEF, vmask);
      const uint8x16_t vb89ABc8ACE = vshlq_n_u8(vb89ABc89ABCDEF, 4);
      const uint8x16_t vb89ABc9BDF = vandq_u8(vb89ABc89ABCDEF, vmask);
      const uint8x16_t vbCDEFc8ACE = vshlq_n_u8(vbCDEFc89ABCDEF, 4);
      const uint8x16_t vbCDEFc9BDF = vandq_u8(vbCDEFc89ABCDEF, vmask);
      const uint8x16x2_t vbi0123c89ABCDEF = vzipq_u8(vb0123c8ACE, vb0123c9BDF);
      const int8x16_t vb01c89ABCDEF = vreinterpretq_s8_u8(vbi0123c89ABCDEF.val[0]);
      const int8x16_t vb23c89ABCDEF = vreinterpretq_s8_u8(vbi0123c89ABCDEF.val[1]);
      const uint8x16x2_t vbi4567c89ABCDEF = vzipq_u8(vb4567c8ACE, vb4567c9BDF);
      const int8x16_t vb45c89ABCDEF = vreinterpretq_s8_u8(vbi4567c89ABCDEF.val[0]);
      const int8x16_t vb67c89ABCDEF = vreinterpretq_s8_u8(vbi4567c89ABCDEF.val[1]);
      const uint8x16x2_t vbi89ABc89ABCDEF = vzipq_u8(vb89ABc8ACE, vb89ABc9BDF);
      const int8x16_t vb89c89ABCDEF = vreinterpretq_s8_u8(vbi89ABc89ABCDEF.val[0]);
      const int8x16_t vbABc89ABCDEF = vreinterpretq_s8_u8(vbi89ABc89ABCDEF.val[1]);
      const uint8x16x2_t vbiCDEFc89ABCDEF = vzipq_u8(vbCDEFc8ACE, vbCDEFc9BDF);
      const int8x16_t vbCDc89ABCDEF = vreinterpretq_s8_u8(vbiCDEFc89ABCDEF.val[0]);
      const int8x16_t vbEFc89ABCDEF = vreinterpretq_s8_u8(vbiCDEFc89ABCDEF.val[1]);

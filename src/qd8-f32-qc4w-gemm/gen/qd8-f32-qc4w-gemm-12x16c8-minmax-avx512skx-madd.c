    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512i vinput_zero_point8 = _mm512_set1_epi32((int) quantization_params[8].zero_point);
  const __m512i vinput_zero_point9 = _mm512_set1_epi32((int) quantization_params[9].zero_point);
  const __m512i vinput_zero_point10 = _mm512_set1_epi32((int) quantization_params[10].zero_point);
  const __m512i vinput_zero_point11 = _mm512_set1_epi32((int) quantization_params[11].zero_point);
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      a0 += 16;
      const __m512i va1x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a1));
      const __m512i va1x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a1 + 8));
      a1 += 16;
      const __m512i va2x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a2));
      const __m512i va2x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a2 + 8));
      a2 += 16;
      const __m512i va3x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a3));
      const __m512i va3x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a3 + 8));
      a3 += 16;
      const __m512i va4x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a4));
      const __m512i va4x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a4 + 8));
      a4 += 16;
      const __m512i va5x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a5));
      const __m512i va5x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a5 + 8));
      a5 += 16;
      const __m512i va6x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a6));
      const __m512i va6x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a6 + 8));
      a6 += 16;
      const __m512i va7x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a7));
      const __m512i va7x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a7 + 8));
      a7 += 16;
      const __m512i va8x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a8));
      const __m512i va8x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a8 + 8));
      a8 += 16;
      const __m512i va9x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a9));
      const __m512i va9x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a9 + 8));
      a9 += 16;
      const __m512i va10x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a10));
      const __m512i va10x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a10 + 8));
      a10 += 16;
      const __m512i va11x01234567 = _mm512_set1_epi64((int64_t) unaligned_load_u64(a11));
      const __m512i va11x89ABCDEF = _mm512_set1_epi64((int64_t) unaligned_load_u64(a11 + 8));
      a11 += 16;
      ...
      vacc8x01234567 = _mm512_dpbusd_epi32_madd(vacc8x01234567, va8x01234567, vb01234567x01234567);
      vacc8x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc8x89ABCDEF, va8x01234567, vb89ABCDEFx01234567);
      vacc9x01234567 = _mm512_dpbusd_epi32_madd(vacc9x01234567, va9x01234567, vb01234567x01234567);
      vacc9x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc9x89ABCDEF, va9x01234567, vb89ABCDEFx01234567);
      vacc10x01234567 = _mm512_dpbusd_epi32_madd(vacc10x01234567, va10x01234567, vb01234567x01234567);
      vacc10x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc10x89ABCDEF, va10x01234567, vb89ABCDEFx01234567);
      vacc11x01234567 = _mm512_dpbusd_epi32_madd(vacc11x01234567, va11x01234567, vb01234567x01234567);
      vacc11x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc11x89ABCDEF, va11x01234567, vb89ABCDEFx01234567);
      ...
      vacc8x01234567 = _mm512_dpbusd_epi32_madd(vacc8x01234567, va8x89ABCDEF, vb01234567x89ABCDEF);
      vacc8x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc8x89ABCDEF, va8x89ABCDEF, vb89ABCDEFx89ABCDEF);
      vacc9x01234567 = _mm512_dpbusd_epi32_madd(vacc9x01234567, va9x89ABCDEF, vb01234567x89ABCDEF);
      vacc9x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc9x89ABCDEF, va9x89ABCDEF, vb89ABCDEFx89ABCDEF);
      vacc10x01234567 = _mm512_dpbusd_epi32_madd(vacc10x01234567, va10x89ABCDEF, vb01234567x89ABCDEF);
      vacc10x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc10x89ABCDEF, va10x89ABCDEF, vb89ABCDEFx89ABCDEF);
      vacc11x01234567 = _mm512_dpbusd_epi32_madd(vacc11x01234567, va11x89ABCDEF, vb01234567x89ABCDEF);
      vacc11x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc11x89ABCDEF, va11x89ABCDEF, vb89ABCDEFx89ABCDEF);

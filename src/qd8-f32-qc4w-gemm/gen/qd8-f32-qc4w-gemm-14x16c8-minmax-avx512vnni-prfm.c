...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_14x16c8__avx512vnni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512i vinput_zero_point12 = _mm512_set1_epi32((int) quantization_params[12].zero_point);
  const __m512i vinput_zero_point13 = _mm512_set1_epi32((int) quantization_params[13].zero_point);
  ...
  do {
    ...
    __m512i vsum12x0123456789ABCDEF = _mm512_mullo_epi32(vksum0123456789ABCDEF, vinput_zero_point12);
    __m512i vacc12x01234567 = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum12x0123456789ABCDEF, 0));
    __m512i vacc12x89ABCDEF = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum12x0123456789ABCDEF, 1));
    __m512i vsum13x0123456789ABCDEF = _mm512_mullo_epi32(vksum0123456789ABCDEF, vinput_zero_point13);
    __m512i vacc13x01234567 = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum13x0123456789ABCDEF, 0));
    __m512i vacc13x89ABCDEF = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum13x0123456789ABCDEF, 1));

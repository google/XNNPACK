...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_16x16c8__avx512vnnigfni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m512i vsum14x0123456789ABCDEF = _mm512_mullo_epi32(vksum0123456789ABCDEF, vinput_zero_point14);
    __m512i vacc14x01234567 = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum14x0123456789ABCDEF, 0));
    __m512i vacc14x89ABCDEF = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum14x0123456789ABCDEF, 1));
    __m512i vsum15x0123456789ABCDEF = _mm512_mullo_epi32(vksum0123456789ABCDEF, vinput_zero_point15);
    __m512i vacc15x01234567 = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum15x0123456789ABCDEF, 0));
    __m512i vacc15x89ABCDEF = _mm512_cvtepu32_epi64(_mm512_extracti64x4_epi64(vsum15x0123456789ABCDEF, 1));
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      a13 += 16;
      const __m512i va14x01234567 = _mm512_xor_epi64(_mm512_set1_epi64((int64_t) unaligned_load_u64(a14)), vsign_mask);
      const __m512i va14x89ABCDEF = _mm512_xor_epi64(_mm512_set1_epi64((int64_t) unaligned_load_u64(a14 + 8)), vsign_mask);
      a14 += 16;
      const __m512i va15x01234567 = _mm512_xor_epi64(_mm512_set1_epi64((int64_t) unaligned_load_u64(a15)), vsign_mask);
      const __m512i va15x89ABCDEF = _mm512_xor_epi64(_mm512_set1_epi64((int64_t) unaligned_load_u64(a15 + 8)), vsign_mask);
      a15 += 16;
      ...
      vacc14x01234567 = _mm512_dpbusd_epi32(vacc14x01234567, va14x01234567, vb01234567x01234567);
      vacc14x89ABCDEF = _mm512_dpbusd_epi32(vacc14x89ABCDEF, va14x01234567, vb89ABCDEFx01234567);
      vacc15x01234567 = _mm512_dpbusd_epi32(vacc15x01234567, va15x01234567, vb01234567x01234567);
      vacc15x89ABCDEF = _mm512_dpbusd_epi32(vacc15x89ABCDEF, va15x01234567, vb89ABCDEFx01234567);
      ...
      vacc14x01234567 = _mm512_dpbusd_epi32(vacc14x01234567, va14x89ABCDEF, vb01234567x89ABCDEF);
      vacc14x89ABCDEF = _mm512_dpbusd_epi32(vacc14x89ABCDEF, va14x89ABCDEF, vb89ABCDEFx89ABCDEF);
      vacc15x01234567 = _mm512_dpbusd_epi32(vacc15x01234567, va15x89ABCDEF, vb01234567x89ABCDEF);
      vacc15x89ABCDEF = _mm512_dpbusd_epi32(vacc15x89ABCDEF, va15x89ABCDEF, vb89ABCDEFx89ABCDEF);
    ...
    const __m512i vsum14x01234567 = _mm512_add_epi32(vacc14x01234567, _mm512_srli_epi64(vacc14x01234567, 32));
    const __m512i vsum14x89ABCDEF = _mm512_add_epi32(vacc14x89ABCDEF, _mm512_srli_epi64(vacc14x89ABCDEF, 32));
    __m512i vacc14x0123456789ABCDEF = _mm512_permutex2var_epi32(vsum14x01234567, vidx, vsum14x89ABCDEF);
    const __m512i vsum15x01234567 = _mm512_add_epi32(vacc15x01234567, _mm512_srli_epi64(vacc15x01234567, 32));
    const __m512i vsum15x89ABCDEF = _mm512_add_epi32(vacc15x89ABCDEF, _mm512_srli_epi64(vacc15x89ABCDEF, 32));
    __m512i vacc15x0123456789ABCDEF = _mm512_permutex2var_epi32(vsum15x01234567, vidx, vsum15x89ABCDEF);

...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_8x8c8__avx512skx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const __m256i vinput_zero_point7 = _mm256_set1_epi32((int) qp7->zero_point);
    ...
    const __m256 vinput_scale7 = _mm256_broadcast_ss(&qp7->inv_scale);

    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const int32x4_t vzp0 = vdupq_n_s32(qp0->zero_point);
    ...
    const int32x4_t vzp1 = vdupq_n_s32(qp1->zero_point);
    int32x4_t vacc1x0123 = vmulq_s32(vksum0123, vzp1);
    int32x4_t vacc1x4567 = vmulq_s32(vksum4567, vzp1);
    int32x4_t vacc1x89AB = vmulq_s32(vksum89AB, vzp1);
    int32x4_t vacc1xCDEF = vmulq_s32(vksumCDEF, vzp1);
    const int32x4_t vzp2 = vdupq_n_s32(qp2->zero_point);
    ...
    const int32x4_t vzp3 = vdupq_n_s32(qp3->zero_point);
    int32x4_t vacc3x0123 = vmulq_s32(vksum0123, vzp3);
    int32x4_t vacc3x4567 = vmulq_s32(vksum4567, vzp3);
    int32x4_t vacc3x89AB = vmulq_s32(vksum89AB, vzp3);
    int32x4_t vacc3xCDEF = vmulq_s32(vksumCDEF, vzp3);
    const int32x4_t vzp4 = vdupq_n_s32(qp4->zero_point);
    int32x4_t vacc4x0123 = vmulq_s32(vksum0123, vzp4);
    int32x4_t vacc4x4567 = vmulq_s32(vksum4567, vzp4);
    int32x4_t vacc4x89AB = vmulq_s32(vksum89AB, vzp4);
    int32x4_t vacc4xCDEF = vmulq_s32(vksumCDEF, vzp4);
    const int32x4_t vzp5 = vdupq_n_s32(qp5->zero_point);
    int32x4_t vacc5x0123 = vmulq_s32(vksum0123, vzp5);
    int32x4_t vacc5x4567 = vmulq_s32(vksum4567, vzp5);
    int32x4_t vacc5x89AB = vmulq_s32(vksum89AB, vzp5);
    int32x4_t vacc5xCDEF = vmulq_s32(vksumCDEF, vzp5);

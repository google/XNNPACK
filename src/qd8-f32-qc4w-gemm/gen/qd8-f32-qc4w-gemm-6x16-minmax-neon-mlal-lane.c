    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    vacc3x0123 = vshrq_n_s32(vacc3x0123, 4);
    vacc3x4567 = vshrq_n_s32(vacc3x4567, 4);
    vacc3x89AB = vshrq_n_s32(vacc3x89AB, 4);
    vacc3xCDEF = vshrq_n_s32(vacc3xCDEF, 4);
    vacc4x0123 = vshrq_n_s32(vacc4x0123, 4);
    vacc4x4567 = vshrq_n_s32(vacc4x4567, 4);
    vacc4x89AB = vshrq_n_s32(vacc4x89AB, 4);
    vacc4xCDEF = vshrq_n_s32(vacc4xCDEF, 4);
    vacc5x0123 = vshrq_n_s32(vacc5x0123, 4);
    vacc5x4567 = vshrq_n_s32(vacc5x4567, 4);
    vacc5x89AB = vshrq_n_s32(vacc5x89AB, 4);
    vacc5xCDEF = vshrq_n_s32(vacc5xCDEF, 4);

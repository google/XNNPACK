...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_4x4c8__ssse3_madd_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m128i vinput_zero_point3 = _mm_set1_epi32((int) quantization_params[3].zero_point + 128);

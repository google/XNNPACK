...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_6x4c8__ssse3_madd_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  const __m128i vinput_zero_point5 = _mm_set1_epi32((int) quantization_params[5].zero_point);
  ...
  do {
    ...
    const __m128i vsum5x02 = _mm_mul_epu32(vksum0123, vinput_zero_point5);
    const __m128i vsum5x13 = _mm_mul_epu32(vksum13, vinput_zero_point5);
    const __m128i vsum5x01 = _mm_unpacklo_epi32(vsum5x02, vsum5x13);
    const __m128i vsum5x23 = _mm_unpackhi_epi32(vsum5x02, vsum5x13);
    __m128i vacc5x01 = _mm_unpacklo_epi32(vsum5x01, _mm_setzero_si128());
    __m128i vacc5x23 = _mm_unpacklo_epi32(vsum5x23, _mm_setzero_si128());
    w = (const int32_t*) w + 4;
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      a4 += 16;
      const __m128i va5x01234567 = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5));
      const __m128i va5x89ABCDEF = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 8));
      a5 += 16;
    ...
    vout5x0123 = _mm_mul_ps(vout5x0123, _mm_set1_ps(quantization_params[5].inv_scale));
    ...
    vout5x0123 = _mm_add_ps(_mm_mul_ps(vout5x0123, vfilter_output_scale0123), vbias0123);
    ...
    vout5x0123 = _mm_max_ps(vout5x0123, voutput_min);
    ...
    vout5x0123 = _mm_min_ps(vout5x0123, voutput_max);

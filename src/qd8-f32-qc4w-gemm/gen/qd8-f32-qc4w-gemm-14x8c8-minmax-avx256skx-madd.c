    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256i vacc16_10x0123 = _mm256_setzero_si256();
    __m256i vacc16_10x4567 = _mm256_setzero_si256();
    __m256i vacc16_11x0123 = _mm256_setzero_si256();
    __m256i vacc16_11x4567 = _mm256_setzero_si256();
    __m256i vacc16_12x0123 = _mm256_setzero_si256();
    __m256i vacc16_12x4567 = _mm256_setzero_si256();
    __m256i vacc16_13x0123 = _mm256_setzero_si256();
    __m256i vacc16_13x4567 = _mm256_setzero_si256();
    w = (const int32_t*) w + 8;
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc16_10x0123 = _mm256_add_epi16(vacc16_10x0123, _mm256_maddubs_epi16(va10x01234567, vb01234567x0123));
      vacc16_10x4567 = _mm256_add_epi16(vacc16_10x4567, _mm256_maddubs_epi16(va10x01234567, vb89ABCDEFx0123));
      vacc16_11x0123 = _mm256_add_epi16(vacc16_11x0123, _mm256_maddubs_epi16(va11x01234567, vb01234567x0123));
      vacc16_11x4567 = _mm256_add_epi16(vacc16_11x4567, _mm256_maddubs_epi16(va11x01234567, vb89ABCDEFx0123));
      vacc16_12x0123 = _mm256_add_epi16(vacc16_12x0123, _mm256_maddubs_epi16(va12x01234567, vb01234567x0123));
      vacc16_12x4567 = _mm256_add_epi16(vacc16_12x4567, _mm256_maddubs_epi16(va12x01234567, vb89ABCDEFx0123));
      vacc16_13x0123 = _mm256_add_epi16(vacc16_13x0123, _mm256_maddubs_epi16(va13x01234567, vb01234567x0123));
      vacc16_13x4567 = _mm256_add_epi16(vacc16_13x4567, _mm256_maddubs_epi16(va13x01234567, vb89ABCDEFx0123));
      ...
      vacc16_10x0123 = _mm256_add_epi16(vacc16_10x0123, _mm256_maddubs_epi16(va10x89ABCDEF, vb01234567x4567));
      vacc16_10x4567 = _mm256_add_epi16(vacc16_10x4567, _mm256_maddubs_epi16(va10x89ABCDEF, vb89ABCDEFx4567));
      vacc16_11x0123 = _mm256_add_epi16(vacc16_11x0123, _mm256_maddubs_epi16(va11x89ABCDEF, vb01234567x4567));
      vacc16_11x4567 = _mm256_add_epi16(vacc16_11x4567, _mm256_maddubs_epi16(va11x89ABCDEF, vb89ABCDEFx4567));
      vacc16_12x0123 = _mm256_add_epi16(vacc16_12x0123, _mm256_maddubs_epi16(va12x89ABCDEF, vb01234567x4567));
      vacc16_12x4567 = _mm256_add_epi16(vacc16_12x4567, _mm256_maddubs_epi16(va12x89ABCDEF, vb89ABCDEFx4567));
      vacc16_13x0123 = _mm256_add_epi16(vacc16_13x0123, _mm256_maddubs_epi16(va13x89ABCDEF, vb01234567x4567));
      vacc16_13x4567 = _mm256_add_epi16(vacc16_13x4567, _mm256_maddubs_epi16(va13x89ABCDEF, vb89ABCDEFx4567));
    ...
    vacc10x0123 = _mm256_sub_epi32(vacc10x0123, _mm256_madd_epi16(vacc16_10x0123, vminus_one));
    vacc10x4567 = _mm256_sub_epi32(vacc10x4567, _mm256_madd_epi16(vacc16_10x4567, vminus_one));
    vacc11x0123 = _mm256_sub_epi32(vacc11x0123, _mm256_madd_epi16(vacc16_11x0123, vminus_one));
    vacc11x4567 = _mm256_sub_epi32(vacc11x4567, _mm256_madd_epi16(vacc16_11x4567, vminus_one));
    vacc12x0123 = _mm256_sub_epi32(vacc12x0123, _mm256_madd_epi16(vacc16_12x0123, vminus_one));
    vacc12x4567 = _mm256_sub_epi32(vacc12x4567, _mm256_madd_epi16(vacc16_12x4567, vminus_one));
    vacc13x0123 = _mm256_sub_epi32(vacc13x0123, _mm256_madd_epi16(vacc16_13x0123, vminus_one));
    vacc13x4567 = _mm256_sub_epi32(vacc13x4567, _mm256_madd_epi16(vacc16_13x4567, vminus_one));

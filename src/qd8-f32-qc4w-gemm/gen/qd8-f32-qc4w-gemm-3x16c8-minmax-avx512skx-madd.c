    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m512i vacc1x2x01234567 = _mm512_setzero_epi32();
    __m512i vacc1x2x89ABCDEF = _mm512_setzero_epi32();
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x1x89ABCDEF = _mm512_dpbusd_epi32_bw(vacc1x1x89ABCDEF, va1x89ABCDEF, vb89ABCDEFx89ABCDEF);
      vacc1x2x01234567 = _mm512_dpbusd_epi32_bw(vacc1x2x01234567, va2x89ABCDEF, vb01234567x89ABCDEF);
      vacc1x2x89ABCDEF = _mm512_dpbusd_epi32_bw(vacc1x2x89ABCDEF, va2x89ABCDEF, vb89ABCDEFx89ABCDEF);
    ...
    vacc2x01234567 = _mm512_add_epi32(vacc2x01234567, vacc1x2x01234567);
    vacc2x89ABCDEF = _mm512_add_epi32(vacc2x89ABCDEF, vacc1x2x89ABCDEF);

...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_2x8c8__avx2_madd_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x0x0123 = _mm256_dpbusd_epi32_bw(vacc1x0x0123, va0x89ABCDEF, vb01234567x4567);
      vacc1x0x4567 = _mm256_dpbusd_epi32_bw(vacc1x0x4567, va0x89ABCDEF, vb89ABCDEFx4567);
      vacc1x1x0123 = _mm256_dpbusd_epi32_bw(vacc1x1x0123, va1x89ABCDEF, vb01234567x4567);
      vacc1x1x4567 = _mm256_dpbusd_epi32_bw(vacc1x1x4567, va1x89ABCDEF, vb89ABCDEFx4567);

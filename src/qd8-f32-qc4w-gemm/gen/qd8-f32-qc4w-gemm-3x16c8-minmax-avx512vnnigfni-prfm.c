...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_3x16c8__avx512vnnigfni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512i vinput_zero_point0 = _mm512_set1_epi32((int) qp0->zero_point + 128);
  const __m512i vinput_zero_point1 = _mm512_set1_epi32((int) qp1->zero_point + 128);
  const __m512i vinput_zero_point2 = _mm512_set1_epi32((int) qp2->zero_point + 128);
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x2x01234567 = _mm512_dpbusd_epi32(vacc1x2x01234567, va2x89ABCDEF, vb01234567x89ABCDEF);
      vacc1x2x89ABCDEF = _mm512_dpbusd_epi32(vacc1x2x89ABCDEF, va2x89ABCDEF, vb89ABCDEFx89ABCDEF);

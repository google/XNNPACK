...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_6x32c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 32) {
      ...
      vst1q_f32(c5 + 16, vout5xGHIJ);
      vst1q_f32(c5 + 20, vout5xKLMN);
      vst1q_f32(c5 + 24, vout5xOPQR);
      vst1q_f32(c5 + 28, vout5xSTUV);
     ...
     if (nc & 16) {
       ...
       vst1q_f32(c5, vout5x89AB); c5 += 4;
       vout5x89AB = vout5xOPQR;
       ...
       vst1q_f32(c5, vout5xCDEF); c5 += 4;
       vout5xCDEF = vout5xSTUV;
     }
     if (nc & 8) {
       vst1q_f32(c0, vout0x0123); c0 += 4;

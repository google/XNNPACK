...
void xnn_pqs8_qc8w_gemm_minmax_ukernel_32x32__neonsme2(
  ...
  struct kai_matmul_requantize32_params kai_params = {
    .output_zero_point = minmax_params->fp32_scalar.output_zero_point,
    .min_value = minmax_params->fp32_scalar.output_min,
    .max_value = minmax_params->fp32_scalar.output_max,
  };

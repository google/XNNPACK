  ...
  do {
    ...
    for (; k > 9; k -= 9) {
      ...
      for (; c >= 4; c -= 4) {
        ...
        const xnn_simd_f32_t vi1 = xnn_loadu_f32(i1); i1 += 4;
        const xnn_simd_f32_t vi2 = xnn_loadu_f32(i2); i2 += 4;
        const xnn_simd_f32_t vi3 = xnn_loadu_f32(i3); i3 += 4;
        const xnn_simd_f32_t vi4 = xnn_loadu_f32(i4); i4 += 4;
        const xnn_simd_f32_t vi5 = xnn_loadu_f32(i5); i5 += 4;
        const xnn_simd_f32_t vi6 = xnn_loadu_f32(i6); i6 += 4;
        const xnn_simd_f32_t vi7 = xnn_loadu_f32(i7); i7 += 4;
        const xnn_simd_f32_t vi8 = xnn_loadu_f32(i8); i8 += 4;
        const xnn_simd_f32_t vprev = xnn_loadu_f32(prev_output); prev_output += 4;

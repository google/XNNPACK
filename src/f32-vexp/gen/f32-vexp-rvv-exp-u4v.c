...
forceinline vfloat32m4_t calc_polynom_deg_2_f32m4(vfloat32m4_t x, float a0, float a1, float a2, size_t vl)
{ 
    return __riscv_vfmadd_vv_f32m4(x, __riscv_vfmadd_vf_f32m4(x, a2,
        __riscv_vfmv_v_f_f32m4(a1, vl), vl), __riscv_vfmv_v_f_f32m4(a0, vl), vl);
}

forceinline void fast_2_sum_vv_f32m4(vfloat32m4_t a, vfloat32m4_t b, vfloat32m4_t* sh, vfloat32m4_t* sl, size_t vl)
{
    *sh = __riscv_vfadd_vv_f32m4(a, b, vl);
    *sl = __riscv_vfsub_vv_f32m4(b, __riscv_vfsub_vv_f32m4(*sh, a, vl), vl);
}
    
forceinline void fast_2_sum_fv_f32m4(float a, vfloat32m4_t b, vfloat32m4_t* sh, vfloat32m4_t* sl, size_t vl)
{
    *sh = __riscv_vfadd_vf_f32m4(b, a, vl);
    *sl = __riscv_vfsub_vv_f32m4(b, __riscv_vfsub_vf_f32m4(*sh, a, vl), vl);
}
        
forceinline void mul21_vv_f32m4(vfloat32m4_t ah, vfloat32m4_t al, vfloat32m4_t bh, vfloat32m4_t bl, vfloat32m4_t* rh, size_t vl)
{
    vfloat32m4_t zh, zl;
    zh = __riscv_vfmul_vv_f32m4(ah, bh, vl);
    zl = __riscv_vfmsub_vv_f32m4(ah, bh, zh, vl);
    zl = __riscv_vfadd_vv_f32m4(zl, __riscv_vfmadd_vv_f32m4(ah, bl, __riscv_vfmul_vv_f32m4(al, bh, vl), vl), vl);
    *rh = __riscv_vfadd_vv_f32m4(zh, zl, vl);
}

forceinline void fma12_vv_f32m4(vfloat32m4_t ah, vfloat32m4_t bh, vfloat32m4_t ch, vfloat32m4_t* zh, vfloat32m4_t* zl, size_t vl)
{ 
    *zh = __riscv_vfmadd_vv_f32m4(ah, bh, ch, vl);
    *zl = __riscv_vfmadd_vv_f32m4(ah, bh, __riscv_vfsub_vv_f32m4(ch, *zh, vl), vl);
}

forceinline void fma12_vf_f32m4(vfloat32m4_t ah, float bh, vfloat32m4_t ch, vfloat32m4_t* zh, vfloat32m4_t* zl, size_t vl)
{ 
    *zh = __riscv_vfmadd_vf_f32m4(ah, bh, ch, vl);
    *zl = __riscv_vfmadd_vf_f32m4(ah, bh, __riscv_vfsub_vv_f32m4(ch, *zh, vl), vl);
}
...
{
    vfloat32m4_t vmagicConst1 = __riscv_vfmv_v_f_f32m4(RVVMF_EXP_AS_FP32(MAGIC_CONST_1_F32), vl);
    vfloat32m4_t h = __riscv_vfmadd_vf_f32m4(x, RVVMF_EXP_AS_FP32(INV_LOG2_2K_F32), vmagicConst1, vl);
    ...
    *ei = __riscv_vsrl_vx_u32m4(hi, TABLE_SIZE_DEG_F32, vl);
    ...
    fma12_vf_f32m4(h, RVVMF_EXP_AS_FP32(M_LOG2_2K_L_F32),
        __riscv_vfmadd_vf_f32m4(h, RVVMF_EXP_AS_FP32(M_LOG2_2K_H_F32), x, vl), yh, yl, vl);
    *yl = __riscv_vfmadd_vf_f32m4(h, RVVMF_EXP_AS_FP32(M_LOG2_2K_LL_F32), *yl, vl);
    ...
    vuint32m4_t* index, vfloat32m4_t* th, vfloat32m4_t* tl, size_t vl)
{
    ...
    *th = __riscv_vloxei32_v_f32m4((float*)RVVMF_EXP_LOOK_UP_TABLE_HIGH_F32, *index, vl);
    *tl = __riscv_vloxei32_v_f32m4((float*)RVVMF_EXP_LOOK_UP_TABLE_LOW_F32, *index, vl);
}

forceinline void calculate_exp_polynom_hl_f32m4(vfloat32m4_t yh, vfloat32m4_t yl, vfloat32m4_t* ph, vfloat32m4_t* pl, size_t vl)
{
    vfloat32m4_t sqryh = __riscv_vfmul_vv_f32m4(yh, yh, vl);
    vfloat32m4_t r = calc_polynom_deg_2_f32m4(yh, RVVMF_EXP_AS_FP32(EXP_POL_COEFF_2_F32),
...
forceinline void update_exponent_f32m4(vuint32m4_t ei, vfloat32m4_t* res, size_t vl)
{
...
forceinline void update_exponent_with_subnormal_f32m4(float subnormalThreshold, vfloat32m4_t x,
    vuint32m4_t ei, vfloat32m4_t* res, size_t vl)
{
    ...
    subnormalRes = __riscv_vfadd_vv_f32m4(*res, __riscv_vreinterpret_v_u32m4_f32m4(shiftNum), vl);
...
forceinline void reconstruct_exp_hl_hl_f32m4(vfloat32m4_t x, vuint32m4_t ei, vfloat32m4_t th, vfloat32m4_t tl,
    vfloat32m4_t pm4h, vfloat32m4_t pm4l, vfloat32m4_t* res, float subnormalThreshold, size_t vl)
{
    vfloat32m4_t sh, sl;
    fast_2_sum_fv_f32m4(RVVMF_EXP_AS_FP32(ONE_F32), pm4h, &sh, &sl, vl);
...
vfloat32m4_t __riscv_vexp_f32m4(vfloat32m4_t x, size_t avl)
{
    ...
    vfloat32m4_t res, yh, yl, th, tl, pm4h, pm4l;
    vuint32m4_t ei, fi;
    ...
    calculate_exp_polynom_hl_f32m4(yh, yl, &pm4h, &pm4l, vl);
    reconstruct_exp_hl_hl_f32m4(x, ei, th, tl, pm4h, pm4l, &res, RVVMF_EXP_AS_FP32(EXP_SUBNORMAL_THRESHOLD_F32), vl);
    update_underflow_f32m4(x, &res, zeroThreshold, RVVMF_EXP_AS_FP32(EXP_UNDERFLOW_VALUE_F32), vl);
    ...
    const struct xnn_f32_default_params* params)
{
  ...
  do {
    ...
    input += n;
    vfloat32m4_t vacc = __riscv_vexp_f32m4(vx, n);

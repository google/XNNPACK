    ...
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    vp_2 = xnn_mul_f32(vr_2, vp_2);
    vp_3 = xnn_mul_f32(vr_3, vp_3);
    vp_4 = xnn_mul_f32(vr_4, vp_4);
    vp_5 = xnn_mul_f32(vr_5, vp_5);
    vp_6 = xnn_mul_f32(vr_6, vp_6);
    vp_7 = xnn_mul_f32(vr_7, vp_7);
    ...
    const xnn_simd_f32_t v2r_2 =  xnn_add_f32(xnn_div_f32(vp_2, vq_2), vone);
    const xnn_simd_f32_t v2r_3 =  xnn_add_f32(xnn_div_f32(vp_3, vq_3), vone);
    const xnn_simd_f32_t v2r_4 =  xnn_add_f32(xnn_div_f32(vp_4, vq_4), vone);
    const xnn_simd_f32_t v2r_5 =  xnn_add_f32(xnn_div_f32(vp_5, vq_5), vone);
    const xnn_simd_f32_t v2r_6 =  xnn_add_f32(xnn_div_f32(vp_6, vq_6), vone);
    const xnn_simd_f32_t v2r_7 =  xnn_add_f32(xnn_div_f32(vp_7, vq_7), vone);

...
uint32_t RVVMF_EXP_LOOK_UP_TABLE_LOW_F32[16] = {
    ...
    0x33231b71, 0x33412342, 0xb16c9d5e, 0xb22deaf6,
...
#if 2 == 1
    vbool16_t subnormalMask = __riscv_vmand_mm_b16(__riscv_vmfgt_vf_f32m1_b16(x, RVVMF_EXP_AS_FP32(ninf), vl),
...
#endif
#if 2 == 4
    vbool16_t subnormalMask = __riscv_vmand_mm_b8(__riscv_vmfgt_vf_f32m4_b8(x, RVVMF_EXP_AS_FP32(ninf), vl),
        __riscv_vmflt_vf_f32m4_b8(x, subnormalThreshold, vl), vl);
#endif
#if 2 == 8
    vbool16_t subnormalMask = __riscv_vmand_mm_b4(__riscv_vmfgt_vf_f32m8_b4(x, RVVMF_EXP_AS_FP32(ninf), vl),

    ...
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const xnn_simd_f32_t v2r_0 = xnn_mul_f32(vp_0, vrq_0);
    const xnn_simd_f32_t v2r_1 = xnn_mul_f32(vp_1, vrq_1);
    ...
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 48 * sizeof(float); batch -= 48 * sizeof(float)) {
    ...
    const xnn_simd_f32_t v2r_0 = xnn_mul_f32(vp_0, vrq_0);
    const xnn_simd_f32_t v2r_1 = xnn_mul_f32(vp_1, vrq_1);
    const xnn_simd_f32_t v2r_2 = xnn_mul_f32(vp_2, vrq_2);
    ...
    const struct xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const xnn_simd_f32_t v2r_1 = xnn_mul_f32(vp_1, vrq_1);
    const xnn_simd_f32_t v2r_2 = xnn_mul_f32(vp_2, vrq_2);
    const xnn_simd_f32_t v2r_3 = xnn_mul_f32(vp_3, vrq_3);

...
void xnn_f32_vexp_ukernel__avx512f_rational_3_2_nr_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= xnn_simd_bytes_f32; batch -= xnn_simd_bytes_f32) {
    ...
    const xnn_simd_f32_t v2r = xnn_fmadd_f32(vp, vrq, vone);
...
void xnn_f32_vexp_ukernel__avx512f_rational_3_2_nr_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const xnn_simd_f32_t v2r_0 = xnn_fmadd_f32(vp_0, vrq_0, vone);
    const xnn_simd_f32_t v2r_1 = xnn_fmadd_f32(vp_1, vrq_1, vone);
...
void xnn_f32_vexp_ukernel__avx512f_rational_3_2_nr_u48(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 48 * sizeof(float); batch -= 48 * sizeof(float)) {
    ...
    const xnn_simd_f32_t v2r_0 = xnn_fmadd_f32(vp_0, vrq_0, vone);
    const xnn_simd_f32_t v2r_1 = xnn_fmadd_f32(vp_1, vrq_1, vone);
    const xnn_simd_f32_t v2r_2 = xnn_fmadd_f32(vp_2, vrq_2, vone);
...
void xnn_f32_vexp_ukernel__avx512f_rational_3_2_nr_u64(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const xnn_simd_f32_t v2r_1 = xnn_fmadd_f32(vp_1, vrq_1, vone);
    const xnn_simd_f32_t v2r_2 = xnn_fmadd_f32(vp_2, vrq_2, vone);
    const xnn_simd_f32_t v2r_3 = xnn_fmadd_f32(vp_3, vrq_3, vone);

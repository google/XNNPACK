...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_6x8c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    const __m128i vsum3x46 = _mm_mul_epu32(vksum4567, vinput_zero_point3);
    const __m128i vsum3x57 = _mm_mul_epu32(vksum57, vinput_zero_point3);
    const __m128i vsum3x01 = _mm_unpacklo_epi32(vsum3x02, vsum3x13);
    const __m128i vsum3x23 = _mm_unpackhi_epi32(vsum3x02, vsum3x13);
    const __m128i vsum3x45 = _mm_unpacklo_epi32(vsum3x46, vsum3x57);
    const __m128i vsum3x67 = _mm_unpackhi_epi32(vsum3x46, vsum3x57);
    const __m128i vsum3x0123 = _mm_unpacklo_epi64(vsum3x01, vsum3x23);
    const __m128i vsum3x4567 = _mm_unpacklo_epi64(vsum3x45, vsum3x67);
    ...
    const __m128i vsum4x46 = _mm_mul_epu32(vksum4567, vinput_zero_point4);
    const __m128i vsum4x57 = _mm_mul_epu32(vksum57, vinput_zero_point4);
    const __m128i vsum4x01 = _mm_unpacklo_epi32(vsum4x02, vsum4x13);
    const __m128i vsum4x23 = _mm_unpackhi_epi32(vsum4x02, vsum4x13);
    const __m128i vsum4x45 = _mm_unpacklo_epi32(vsum4x46, vsum4x57);
    const __m128i vsum4x67 = _mm_unpackhi_epi32(vsum4x46, vsum4x57);
    const __m128i vsum4x0123 = _mm_unpacklo_epi64(vsum4x01, vsum4x23);
    const __m128i vsum4x4567 = _mm_unpacklo_epi64(vsum4x45, vsum4x67);
    ...
    const __m128i vsum5x46 = _mm_mul_epu32(vksum4567, vinput_zero_point5);
    const __m128i vsum5x57 = _mm_mul_epu32(vksum57, vinput_zero_point5);
    const __m128i vsum5x01 = _mm_unpacklo_epi32(vsum5x02, vsum5x13);
    const __m128i vsum5x23 = _mm_unpackhi_epi32(vsum5x02, vsum5x13);
    const __m128i vsum5x45 = _mm_unpacklo_epi32(vsum5x46, vsum5x57);
    const __m128i vsum5x67 = _mm_unpackhi_epi32(vsum5x46, vsum5x57);
    const __m128i vsum5x0123 = _mm_unpacklo_epi64(vsum5x01, vsum5x23);
    const __m128i vsum5x4567 = _mm_unpacklo_epi64(vsum5x45, vsum5x67);
    ...
    __m128i vacc3x45 = _mm_setzero_si128();
    __m128i vacc3x67 = _mm_setzero_si128();
    __m128i vacc4x01 = _mm_setzero_si128();
    __m128i vacc4x23 = _mm_setzero_si128();
    __m128i vacc4x45 = _mm_setzero_si128();
    __m128i vacc4x67 = _mm_setzero_si128();
    __m128i vacc5x01 = _mm_setzero_si128();
    __m128i vacc5x23 = _mm_setzero_si128();
    __m128i vacc5x45 = _mm_setzero_si128();
    __m128i vacc5x67 = _mm_setzero_si128();
    w = (const int32_t*) w + 8;
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      a4 += 32;
      const __m128i va5x0 = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5));
      const __m128i va5x1 = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 8));
      const __m128i va5x2 = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 16));
      const __m128i va5x3 = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 24));
      a5 += 32;
      ...
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p0, va3x0);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p0, va3x0);
      vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p0, va3x0);
      vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p0, va3x0);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p1, va3x1);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p1, va3x1);
      vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p1, va3x1);
      vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p1, va3x1);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p2, va3x2);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p2, va3x2);
      vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p2, va3x2);
      vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p2, va3x2);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p3, va3x3);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p3, va3x3);
      vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p3, va3x3);
      vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p3, va3x3);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p0, va4x0);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p0, va4x0);
      vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p0, va4x0);
      vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p0, va4x0);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p1, va4x1);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p1, va4x1);
      vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p1, va4x1);
      vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p1, va4x1);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p2, va4x2);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p2, va4x2);
      vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p2, va4x2);
      vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p2, va4x2);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p3, va4x3);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p3, va4x3);
      vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p3, va4x3);
      vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p3, va4x3);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p0, va5x0);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p0, va5x0);
      vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p0, va5x0);
      vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p0, va5x0);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p1, va5x1);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p1, va5x1);
      vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p1, va5x1);
      vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p1, va5x1);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p2, va5x2);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p2, va5x2);
      vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p2, va5x2);
      vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p2, va5x2);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p3, va5x3);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p3, va5x3);
      vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p3, va5x3);
      vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p3, va5x3);
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p0, va3x01234567);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p0, va3x01234567);
      vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p0, va3x01234567);
      vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p0, va3x01234567);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p1, va3x89ABCDEF);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p1, va3x89ABCDEF);
      vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p1, va3x89ABCDEF);
      vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p1, va3x89ABCDEF);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p0, va4x01234567);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p0, va4x01234567);
      vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p0, va4x01234567);
      vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p0, va4x01234567);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p1, va4x89ABCDEF);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p1, va4x89ABCDEF);
      vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p1, va4x89ABCDEF);
      vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p1, va4x89ABCDEF);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p0, va5x01234567);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p0, va5x01234567);
      vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p0, va5x01234567);
      vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p0, va5x01234567);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p1, va5x89ABCDEF);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p1, va5x89ABCDEF);
      vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p1, va5x89ABCDEF);
      vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p1, va5x89ABCDEF);
      ...
      if (k != 0) {
        ...
        a4 += 8;
        const __m128i va5x3 = _mm_set1_epi64x((int64_t) unaligned_load_u64(a5));
        a5 += 8;
        ...
        vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01_p2, va3x3);
        vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb23_p2, va3x3);
        vacc3x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x45, vb45_p2, va3x3);
        vacc3x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x67, vb67_p2, va3x3);
        vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01_p2, va4x3);
        vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb23_p2, va4x3);
        vacc4x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x45, vb45_p2, va4x3);
        vacc4x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x67, vb67_p2, va4x3);
        vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01_p2, va5x3);
        vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb23_p2, va5x3);
        vacc5x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x45, vb45_p2, va5x3);
        vacc5x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x67, vb67_p2, va5x3);
        k -= 8 * sizeof(int8_t);
      }
    }
    ...
    __m128i vacc3x4567 = _mm_hadd_epi32(vacc3x45, vacc3x67);
    vacc3x0123 = _mm_add_epi32(vacc3x0123, vsum3x0123);
    vacc3x4567 = _mm_add_epi32(vacc3x4567, vsum3x4567);
    __m128i vacc4x0123 = _mm_hadd_epi32(vacc4x01, vacc4x23);
    __m128i vacc4x4567 = _mm_hadd_epi32(vacc4x45, vacc4x67);
    vacc4x0123 = _mm_add_epi32(vacc4x0123, vsum4x0123);
    vacc4x4567 = _mm_add_epi32(vacc4x4567, vsum4x4567);
    __m128i vacc5x0123 = _mm_hadd_epi32(vacc5x01, vacc5x23);
    __m128i vacc5x4567 = _mm_hadd_epi32(vacc5x45, vacc5x67);
    vacc5x0123 = _mm_add_epi32(vacc5x0123, vsum5x0123);
    vacc5x4567 = _mm_add_epi32(vacc5x4567, vsum5x4567);
    ...
    __m128 vout3x4567 = _mm_cvtepi32_ps(vacc3x4567);
    __m128 vout4x0123 = _mm_cvtepi32_ps(vacc4x0123);
    __m128 vout4x4567 = _mm_cvtepi32_ps(vacc4x4567);
    __m128 vout5x0123 = _mm_cvtepi32_ps(vacc5x0123);
    __m128 vout5x4567 = _mm_cvtepi32_ps(vacc5x4567);
    ...
    vout3x4567 = _mm_sub_ps(vout3x4567, _mm_mul_ps(biased_rh_zero_points_4567, lh_row_sum_3));
    const __m128 lh_row_sum_4 = _mm_set1_ps(row_sum[4]);
    vout4x0123 = _mm_sub_ps(vout4x0123, _mm_mul_ps(biased_rh_zero_points_0123, lh_row_sum_4));
    vout4x4567 = _mm_sub_ps(vout4x4567, _mm_mul_ps(biased_rh_zero_points_4567, lh_row_sum_4));
    const __m128 lh_row_sum_5 = _mm_set1_ps(row_sum[5]);
    vout5x0123 = _mm_sub_ps(vout5x0123, _mm_mul_ps(biased_rh_zero_points_0123, lh_row_sum_5));
    vout5x4567 = _mm_sub_ps(vout5x4567, _mm_mul_ps(biased_rh_zero_points_4567, lh_row_sum_5));
    ...
    const __m128 vscaled_lh_zero_point_5 = _mm_set1_ps((float)original_kc * quantization_params[5].zero_point);
    ...
    vout3x4567 = _mm_add_ps(_mm_mul_ps(rh_zero_points_4567, vscaled_lh_zero_point_3), vout3x4567);
    vout4x0123 = _mm_add_ps(_mm_mul_ps(rh_zero_points_0123, vscaled_lh_zero_point_4), vout4x0123);
    vout4x4567 = _mm_add_ps(_mm_mul_ps(rh_zero_points_4567, vscaled_lh_zero_point_4), vout4x4567);
    vout5x0123 = _mm_add_ps(_mm_mul_ps(rh_zero_points_0123, vscaled_lh_zero_point_5), vout5x0123);
    vout5x4567 = _mm_add_ps(_mm_mul_ps(rh_zero_points_4567, vscaled_lh_zero_point_5), vout5x4567);
    ...
    vout3x4567 = _mm_mul_ps(vout3x4567, _mm_set1_ps(quantization_params[3].inv_scale));
    vout4x0123 = _mm_mul_ps(vout4x0123, _mm_set1_ps(quantization_params[4].inv_scale));
    vout4x4567 = _mm_mul_ps(vout4x4567, _mm_set1_ps(quantization_params[4].inv_scale));
    vout5x0123 = _mm_mul_ps(vout5x0123, _mm_set1_ps(quantization_params[5].inv_scale));
    vout5x4567 = _mm_mul_ps(vout5x4567, _mm_set1_ps(quantization_params[5].inv_scale));
    ...
    vout3x4567 = _mm_add_ps(_mm_mul_ps(vout3x4567, vfilter_output_scale4567), vbias4567);
    vout4x0123 = _mm_add_ps(_mm_mul_ps(vout4x0123, vfilter_output_scale0123), vbias0123);
    vout4x4567 = _mm_add_ps(_mm_mul_ps(vout4x4567, vfilter_output_scale4567), vbias4567);
    vout5x0123 = _mm_add_ps(_mm_mul_ps(vout5x0123, vfilter_output_scale0123), vbias0123);
    vout5x4567 = _mm_add_ps(_mm_mul_ps(vout5x4567, vfilter_output_scale4567), vbias4567);
    ...
    vout3x4567 = _mm_max_ps(vout3x4567, voutput_min);
    vout4x0123 = _mm_max_ps(vout4x0123, voutput_min);
    vout4x4567 = _mm_max_ps(vout4x4567, voutput_min);
    vout5x0123 = _mm_max_ps(vout5x0123, voutput_min);
    vout5x4567 = _mm_max_ps(vout5x4567, voutput_min);
    ...
    vout3x4567 = _mm_min_ps(vout3x4567, voutput_max);
    vout4x0123 = _mm_min_ps(vout4x0123, voutput_max);
    vout4x4567 = _mm_min_ps(vout4x4567, voutput_max);
    vout5x0123 = _mm_min_ps(vout5x0123, voutput_max);
    vout5x4567 = _mm_min_ps(vout5x4567, voutput_max);
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      _mm_storeu_ps(c3 + 4, vout3x4567);
      a3 = (const int8_t*) ((uintptr_t) a3 - kc);
      c3 = (float*) ((uintptr_t) c3 + cn_stride);
      _mm_storeu_ps(c4, vout4x0123);
      _mm_storeu_ps(c4 + 4, vout4x4567);
      a4 = (const int8_t*) ((uintptr_t) a4 - kc);
      c4 = (float*) ((uintptr_t) c4 + cn_stride);
      _mm_storeu_ps(c5, vout5x0123);
      _mm_storeu_ps(c5 + 4, vout5x4567);

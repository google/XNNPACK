...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_2x4c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x01, vb01234567x23, va1x1);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x23, vb89ABCDEFx23, va1x1);
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x01, vb01234567x67, va1x3);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x23, vb89ABCDEFx67, va1x3);
      w = (const int8_t*) w + 32;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x01, vb01234567x23, va1x89ABCDEF);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x23, vb89ABCDEFx23, va1x89ABCDEF);

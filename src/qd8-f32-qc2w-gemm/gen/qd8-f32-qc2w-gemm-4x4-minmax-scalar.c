...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_4x4__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    for (; k >= 4 * sizeof(int8_t); k -= 4 * sizeof(int8_t)) {
      ...
      a1 += 4;
      const int32_t va2c0 = (int32_t) (uint32_t) a2[0];
      const int32_t va2c1 = (int32_t) (uint32_t) a2[1];
      const int32_t va2c2 = (int32_t) (uint32_t) a2[2];
      const int32_t va2c3 = (int32_t) (uint32_t) a2[3];
      a2 += 4;
      const int32_t va3c0 = (int32_t) (uint32_t) a3[0];
      const int32_t va3c1 = (int32_t) (uint32_t) a3[1];
      const int32_t va3c2 = (int32_t) (uint32_t) a3[2];
      const int32_t va3c3 = (int32_t) (uint32_t) a3[3];
      a3 += 4;
    ...
    vout2x0 -= (vkernel_zero_point0 + 2.0f) * row_sum[2];
    vout2x0 += vkernel_zero_point0 * (float) kc * (float) vinput_zero_point2;
    vout2x1 -= (vkernel_zero_point1 + 2.0f) * row_sum[2];
    vout2x1 += vkernel_zero_point1 * (float) kc * (float) vinput_zero_point2;
    vout2x2 -= (vkernel_zero_point2 + 2.0f) * row_sum[2];
    vout2x2 += vkernel_zero_point2 * (float) kc * (float) vinput_zero_point2;
    vout2x3 -= (vkernel_zero_point3 + 2.0f) * row_sum[2];
    vout2x3 += vkernel_zero_point3 * (float) kc * (float) vinput_zero_point2;
    float vout3x0 = (float) vacc3x0;
    float vout3x1 = (float) vacc3x1;
    float vout3x2 = (float) vacc3x2;
    float vout3x3 = (float) vacc3x3;
    vout3x0 -= (vkernel_zero_point0 + 2.0f) * row_sum[3];
    vout3x0 += vkernel_zero_point0 * (float) kc * (float) vinput_zero_point3;
    vout3x1 -= (vkernel_zero_point1 + 2.0f) * row_sum[3];
    vout3x1 += vkernel_zero_point1 * (float) kc * (float) vinput_zero_point3;
    vout3x2 -= (vkernel_zero_point2 + 2.0f) * row_sum[3];
    vout3x2 += vkernel_zero_point2 * (float) kc * (float) vinput_zero_point3;
    vout3x3 -= (vkernel_zero_point3 + 2.0f) * row_sum[3];
    vout3x3 += vkernel_zero_point3 * (float) kc * (float) vinput_zero_point3;

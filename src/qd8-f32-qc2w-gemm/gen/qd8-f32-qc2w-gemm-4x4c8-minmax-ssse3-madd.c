...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_4x4c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x01, va1x0);
      vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx01, va1x0);
      vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x01, va2x0);
      vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx01, va2x0);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x01, va3x0);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx01, va3x0);
      vacc0x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc0x01, vb01234567x23, va0x1);
      vacc0x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc0x23, vb89ABCDEFx23, va0x1);
      ...
      vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x23, va1x1);
      vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx23, va1x1);
      vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x45, va1x2);
      vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx45, va1x2);
      vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x23, va2x1);
      vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx23, va2x1);
      vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x45, va2x2);
      vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx45, va2x2);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x23, va3x1);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx23, va3x1);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x45, va3x2);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx45, va3x2);
      vacc0x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc0x01, vb01234567x67, va0x3);
      vacc0x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc0x23, vb89ABCDEFx67, va0x3);
      vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x67, va1x3);
      vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx67, va1x3);
      vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x67, va2x3);
      vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx67, va2x3);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x67, va3x3);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx67, va3x3);
      w = (const int8_t*) w + 32;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x01, va1x01234567);
      vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx01, va1x01234567);
      vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x01, va2x01234567);
      vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx01, va2x01234567);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x01, va3x01234567);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx01, va3x01234567);
      vacc0x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc0x01, vb01234567x23, va0x89ABCDEF);
      vacc0x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc0x23, vb89ABCDEFx23, va0x89ABCDEF);
      vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x23, va1x89ABCDEF);
      vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx23, va1x89ABCDEF);
      vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x23, va2x89ABCDEF);
      vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx23, va2x89ABCDEF);
      vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x23, va3x89ABCDEF);
      vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx23, va3x89ABCDEF);
      ...
      if (k != 0) {
        ...
        vacc1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x01, vb01234567x45, va1x3);
        vacc1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x23, vb89ABCDEFx45, va1x3);
        vacc2x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x01, vb01234567x45, va2x3);
        vacc2x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc2x23, vb89ABCDEFx45, va2x3);
        vacc3x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x01, vb01234567x45, va3x3);
        vacc3x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc3x23, vb89ABCDEFx45, va3x3);
        k -= 8 * sizeof(int8_t);
      }
    }
    ...
    vout3x0123 = _mm_sub_ps(vout3x0123, _mm_mul_ps(biased_rh_zero_points_0123, lh_row_sum_3));

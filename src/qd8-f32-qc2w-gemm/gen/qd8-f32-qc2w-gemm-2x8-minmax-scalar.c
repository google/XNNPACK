    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    const float vkernel_zero_point0 = ((const float*) w)[8];
    const float vkernel_zero_point1 = ((const float*) w)[9];
    const float vkernel_zero_point2 = ((const float*) w)[10];
    const float vkernel_zero_point3 = ((const float*) w)[11];
    const float vkernel_zero_point4 = ((const float*) w)[12];
    const float vkernel_zero_point5 = ((const float*) w)[13];
    const float vkernel_zero_point6 = ((const float*) w)[14];
    const float vkernel_zero_point7 = ((const float*) w)[15];

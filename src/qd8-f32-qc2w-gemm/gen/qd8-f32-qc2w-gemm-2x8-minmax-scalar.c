...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_2x8__scalar(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    const float vkernel_zero_point0 = unaligned_indexed_load_f32(w, 8);
    const float vkernel_zero_point1 = unaligned_indexed_load_f32(w, 9);
    const float vkernel_zero_point2 = unaligned_indexed_load_f32(w, 10);
    const float vkernel_zero_point3 = unaligned_indexed_load_f32(w, 11);
    const float vkernel_zero_point4 = unaligned_indexed_load_f32(w, 12);
    const float vkernel_zero_point5 = unaligned_indexed_load_f32(w, 13);
    const float vkernel_zero_point6 = unaligned_indexed_load_f32(w, 14);
    const float vkernel_zero_point7 = unaligned_indexed_load_f32(w, 15);
    ...
    for (; k >= 4 * sizeof(int8_t); k -= 4 * sizeof(int8_t)) {
      ...
      const int32_t vb4c0 = (int32_t) (int8_t) (vbi4 & 3);
      const int32_t vb4c1 = (int32_t) (int8_t) ((vbi4 >> 2) & 3);
      const int32_t vb4c2 = (int32_t) (int8_t) ((vbi4 >> 4) & 3);
      const int32_t vb4c3 = (int32_t) (int8_t) ((vbi4 >> 6) & 3);
      const int32_t vb5c0 = (int32_t) (int8_t) (vbi5 & 3);
      const int32_t vb5c1 = (int32_t) (int8_t) ((vbi5 >> 2) & 3);
      const int32_t vb5c2 = (int32_t) (int8_t) ((vbi5 >> 4) & 3);
      const int32_t vb5c3 = (int32_t) (int8_t) ((vbi5 >> 6) & 3);
      const int32_t vb6c0 = (int32_t) (int8_t) (vbi6 & 3);
      const int32_t vb6c1 = (int32_t) (int8_t) ((vbi6 >> 2) & 3);
      const int32_t vb6c2 = (int32_t) (int8_t) ((vbi6 >> 4) & 3);
      const int32_t vb6c3 = (int32_t) (int8_t) ((vbi6 >> 6) & 3);
      const int32_t vb7c0 = (int32_t) (int8_t) (vbi7 & 3);
      const int32_t vb7c1 = (int32_t) (int8_t) ((vbi7 >> 2) & 3);
      const int32_t vb7c2 = (int32_t) (int8_t) ((vbi7 >> 4) & 3);
      const int32_t vb7c3 = (int32_t) (int8_t) ((vbi7 >> 6) & 3);
    ...
    vout0x4 -= (vkernel_zero_point4 + 2.0f) * row_sum[0];
    vout0x4 += vkernel_zero_point4 * (float) kc * (float) vinput_zero_point0;
    vout0x5 -= (vkernel_zero_point5 + 2.0f) * row_sum[0];
    vout0x5 += vkernel_zero_point5 * (float) kc * (float) vinput_zero_point0;
    vout0x6 -= (vkernel_zero_point6 + 2.0f) * row_sum[0];
    vout0x6 += vkernel_zero_point6 * (float) kc * (float) vinput_zero_point0;
    vout0x7 -= (vkernel_zero_point7 + 2.0f) * row_sum[0];
    vout0x7 += vkernel_zero_point7 * (float) kc * (float) vinput_zero_point0;
    ...
    vout1x4 -= (vkernel_zero_point4 + 2.0f) * row_sum[1];
    vout1x4 += vkernel_zero_point4 * (float) kc * (float) vinput_zero_point1;
    vout1x5 -= (vkernel_zero_point5 + 2.0f) * row_sum[1];
    vout1x5 += vkernel_zero_point5 * (float) kc * (float) vinput_zero_point1;
    vout1x6 -= (vkernel_zero_point6 + 2.0f) * row_sum[1];
    vout1x6 += vkernel_zero_point6 * (float) kc * (float) vinput_zero_point1;
    vout1x7 -= (vkernel_zero_point7 + 2.0f) * row_sum[1];
    vout1x7 += vkernel_zero_point7 * (float) kc * (float) vinput_zero_point1;

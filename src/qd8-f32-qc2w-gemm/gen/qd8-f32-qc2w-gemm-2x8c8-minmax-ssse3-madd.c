...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_2x8c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    __m128i vacc1x0x45 = _mm_setzero_si128();
    __m128i vacc1x0x67 = _mm_setzero_si128();
    __m128i vacc1x1x01 = _mm_setzero_si128();
    __m128i vacc1x1x23 = _mm_setzero_si128();
    __m128i vacc1x1x45 = _mm_setzero_si128();
    __m128i vacc1x1x67 = _mm_setzero_si128();
    w = (const int32_t*) w + 8;
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc1x0x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x01, vb01_p1, va0x1);
      vacc1x0x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x23, vb23_p1, va0x1);
      vacc1x0x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x45, vb45_p1, va0x1);
      vacc1x0x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x67, vb67_p1, va0x1);
      ...
      vacc1x0x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x01, vb01_p3, va0x3);
      vacc1x0x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x23, vb23_p3, va0x3);
      vacc1x0x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x45, vb45_p3, va0x3);
      vacc1x0x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x67, vb67_p3, va0x3);
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x01, vb01_p1, va1x1);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x23, vb23_p1, va1x1);
      vacc1x1x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x45, vb45_p1, va1x1);
      vacc1x1x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x67, vb67_p1, va1x1);
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x01, vb01_p3, va1x3);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x23, vb23_p3, va1x3);
      vacc1x1x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x45, vb45_p3, va1x3);
      vacc1x1x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x67, vb67_p3, va1x3);
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x0x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x01, vb01_p1, va0x89ABCDEF);
      vacc1x0x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x23, vb23_p1, va0x89ABCDEF);
      vacc1x0x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x45, vb45_p1, va0x89ABCDEF);
      vacc1x0x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x0x67, vb67_p1, va0x89ABCDEF);
      ...
      vacc1x1x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x01, vb01_p1, va1x89ABCDEF);
      vacc1x1x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x23, vb23_p1, va1x89ABCDEF);
      vacc1x1x45 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x45, vb45_p1, va1x89ABCDEF);
      vacc1x1x67 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc1x1x67, vb67_p1, va1x89ABCDEF);
    ...
    vacc0x45 = _mm_add_epi32(vacc0x45, vacc1x0x45);
    vacc0x67 = _mm_add_epi32(vacc0x67, vacc1x0x67);
    vacc1x01 = _mm_add_epi32(vacc1x01, vacc1x1x01);
    vacc1x23 = _mm_add_epi32(vacc1x23, vacc1x1x23);
    vacc1x45 = _mm_add_epi32(vacc1x45, vacc1x1x45);
    vacc1x67 = _mm_add_epi32(vacc1x67, vacc1x1x67);

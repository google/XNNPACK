...
void xnn_qd8_f32_qc2w_gemm_minmax_ukernel_6x4c8__ssse3_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    __m128i vsum5x0123 = _mm_unpacklo_epi64(vsum5x01, vsum5x23);
    w = (const int32_t*) w + 4;
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x01, va4x0);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx01, va4x0);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x01, va5x0);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx01, va5x0);
      ...
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x23, va4x1);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx23, va4x1);
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x45, va4x2);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx45, va4x2);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x23, va5x1);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx23, va5x1);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x45, va5x2);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx45, va5x2);
      ...
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x67, va4x3);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx67, va4x3);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x67, va5x3);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx67, va5x3);
      w = (const int8_t*) w + 32;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x01, va4x01234567);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx01, va4x01234567);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x01, va5x01234567);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx01, va5x01234567);
      ...
      vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x23, va4x89ABCDEF);
      vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx23, va4x89ABCDEF);
      vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x23, va5x89ABCDEF);
      vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx23, va5x89ABCDEF);
      ...
      if (k != 0) {
        ...
        vacc4x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x01, vb01234567x45, va4x3);
        vacc4x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc4x23, vb89ABCDEFx45, va4x3);
        vacc5x01 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x01, vb01234567x45, va5x3);
        vacc5x23 = _mm_dpbusd_epi32_madd_qd8_qc2w(vacc5x23, vb89ABCDEFx45, va5x3);
        k -= 8 * sizeof(int8_t);
      }
    }

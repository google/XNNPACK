    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 32 * sizeof(int8_t)) {
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x0, vb01234567x01);
      vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x0, vb89ABCDEFx01);
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x1, vb01234567x23);
      vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x1, vb89ABCDEFx23);
      vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x2, vb01234567x45);
      vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x2, vb89ABCDEFx45);
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x3, vb01234567x67);
      vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x3, vb89ABCDEFx67);
      w = (const int8_t*) w + 32;
      k -= 32 * sizeof(int8_t);
    }
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x01234567, vb01234567x01);
      vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x01234567, vb89ABCDEFx01);
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x89ABCDEF, vb01234567x23);
      vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x89ABCDEF, vb89ABCDEFx23);
      ...
      if (k != 0) {
        ...
        vacc5x01 = _mm_dpbusd_epi32_madd_kzp2(vacc5x01, va5x3, vb01234567x45);
        vacc5x23 = _mm_dpbusd_epi32_madd_kzp2(vacc5x23, va5x3, vb89ABCDEFx45);
        k -= 8 * sizeof(int8_t);
      }
    }
    ...
    vout5x0123 = _mm_sub_ps(vout5x0123, _mm_mul_ps(rh_zero_points_0123, lh_row_sum_5));

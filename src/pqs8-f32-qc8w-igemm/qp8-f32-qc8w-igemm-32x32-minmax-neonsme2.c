...
size_t xnn_pqs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme2_get_mr(void) {
#if XNN_ENABLE_KLEIDIAI
...
size_t xnn_pqs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme2_get_nr(void) {
#if XNN_ENABLE_KLEIDIAI
...
void xnn_pqs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme2(
...
#if XNN_ENABLE_KLEIDIAI
  const size_t kai_mr =
      kai_get_mr_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_sme2_mopa();
  const size_t k_chunk_count = divide_round_up(ks, kai_mr);

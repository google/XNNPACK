...
void xnn_f32_rdsum2_ukernel_7p7x__sse2_u16(
      ...
      if (channels != 0) {
        ...
        for (int r = k1; r > 0; r -= 7) {
          ...
          for (int i = 0; i < num_full_chunks; ++i) {
            xnn_simd_f32_t vin0 = xnn_loadu_f32(&i0[i*4]);
            xnn_simd_f32_t vin1 = xnn_loadu_f32(&i1[i*4]);
            xnn_simd_f32_t vin2 = xnn_loadu_f32(&i2[i*4]);
            xnn_simd_f32_t vin3 = xnn_loadu_f32(&i3[i*4]);
            xnn_simd_f32_t vin4 = xnn_loadu_f32(&i4[i*4]);
            xnn_simd_f32_t vin5 = xnn_loadu_f32(&i5[i*4]);
            xnn_simd_f32_t vin6 = xnn_loadu_f32(&i6[i*4]);
          ...
          if (remainder) {
            xnn_simd_f32_t vin0 = xnn_load_tail_f32(&i0[num_full_chunks*4], remainder);
            xnn_simd_f32_t vin1 = xnn_load_tail_f32(&i1[num_full_chunks*4], remainder);
            xnn_simd_f32_t vin2 = xnn_load_tail_f32(&i2[num_full_chunks*4], remainder);
            xnn_simd_f32_t vin3 = xnn_load_tail_f32(&i3[num_full_chunks*4], remainder);
            xnn_simd_f32_t vin4 = xnn_load_tail_f32(&i4[num_full_chunks*4], remainder);
            xnn_simd_f32_t vin5 = xnn_load_tail_f32(&i5[num_full_chunks*4], remainder);
            xnn_simd_f32_t vin6 = xnn_load_tail_f32(&i6[num_full_chunks*4], remainder);
...
void xnn_f32_rdsum2_ukernel_7p7x__sse2_u32(
  size_t channels, size_t k1, size_t k2, size_t k3, const float* input,
  size_t input_stride1, size_t input_stride2, size_t input_stride3,
  const float* zero, float* output,
  const struct xnn_f32_scale_params* restrict params) {
...
void xnn_f32_rdsum2_ukernel_7p7x__sse2_u64(
  size_t channels, size_t k1, size_t k2, size_t k3, const float* input,
  size_t input_stride1, size_t input_stride2, size_t input_stride3,
  const float* zero, float* output,
  const struct xnn_f32_scale_params* restrict params) {
    ...
    for (size_t j = 0; j < k2; ++j) {
      ...
      for (; channels >= 64; channels -= 64) {
        ...
        for (int r = k1; r > 0; r -= 7) {
          ...
          vacc6 = xnn_fmadd_f32(vin6, vin6, vacc6);
          vacc7 = xnn_fmadd_f32(vin7, vin7, vacc7);
          vacc8 = xnn_fmadd_f32(vin8, vin8, vacc8);
          vacc9 = xnn_fmadd_f32(vin9, vin9, vacc9);
          vacc10 = xnn_fmadd_f32(vin10, vin10, vacc10);
          vacc11 = xnn_fmadd_f32(vin11, vin11, vacc11);
          vacc12 = xnn_fmadd_f32(vin12, vin12, vacc12);
          vacc13 = xnn_fmadd_f32(vin13, vin13, vacc13);
          vacc14 = xnn_fmadd_f32(vin14, vin14, vacc14);
          vacc15 = xnn_fmadd_f32(vin15, vin15, vacc15);
          vin0 = xnn_loadu_f32(&i1[0]);
          vin1 = xnn_loadu_f32(&i1[4]);
          vin2 = xnn_loadu_f32(&i1[8]);
          vin3 = xnn_loadu_f32(&i1[12]);

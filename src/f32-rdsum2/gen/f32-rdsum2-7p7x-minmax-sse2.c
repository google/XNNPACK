    ...
    for (size_t j = 0; j < k2; ++j) {
      ...
      for (; channels >= 64; channels -= 64) {
        ...
        for (int r = k1; r > 0; r -= 7) {
          ...
          vin6 = xnn_mul_f32(vin6, vin6);
          vin7 = xnn_mul_f32(vin7, vin7);
          vin8 = xnn_mul_f32(vin8, vin8);
          vin9 = xnn_mul_f32(vin9, vin9);
          vin10 = xnn_mul_f32(vin10, vin10);
          vin11 = xnn_mul_f32(vin11, vin11);
          vin12 = xnn_mul_f32(vin12, vin12);
          vin13 = xnn_mul_f32(vin13, vin13);
          vin14 = xnn_mul_f32(vin14, vin14);
          vin15 = xnn_mul_f32(vin15, vin15);
          vacc0 = xnn_add_f32(vin0, vacc0);
          vacc1 = xnn_add_f32(vin1, vacc1);
          vacc2 = xnn_add_f32(vin2, vacc2);
          vacc3 = xnn_add_f32(vin3, vacc3);

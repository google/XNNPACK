...
void xnn_f32_rdsum2_ukernel_7p7x__hvx_u32(
      ...
      if (channels != 0) {
        ...
        for (int r = k1; r > 0; r -= 7) {
          ...
          for (int i = 0; i < num_full_chunks; ++i) {
            xnn_simd_f32_t vin0 = xnn_loadu_f32(&i0[i*32]);
            xnn_simd_f32_t vin1 = xnn_loadu_f32(&i1[i*32]);
            xnn_simd_f32_t vin2 = xnn_loadu_f32(&i2[i*32]);
            xnn_simd_f32_t vin3 = xnn_loadu_f32(&i3[i*32]);
            xnn_simd_f32_t vin4 = xnn_loadu_f32(&i4[i*32]);
            xnn_simd_f32_t vin5 = xnn_loadu_f32(&i5[i*32]);
            xnn_simd_f32_t vin6 = xnn_loadu_f32(&i6[i*32]);
          ...
          if (remainder) {
            xnn_simd_f32_t vin0 = xnn_load_tail_f32(&i0[num_full_chunks*32], remainder);
            xnn_simd_f32_t vin1 = xnn_load_tail_f32(&i1[num_full_chunks*32], remainder);
            xnn_simd_f32_t vin2 = xnn_load_tail_f32(&i2[num_full_chunks*32], remainder);
            xnn_simd_f32_t vin3 = xnn_load_tail_f32(&i3[num_full_chunks*32], remainder);
            xnn_simd_f32_t vin4 = xnn_load_tail_f32(&i4[num_full_chunks*32], remainder);
            xnn_simd_f32_t vin5 = xnn_load_tail_f32(&i5[num_full_chunks*32], remainder);
            xnn_simd_f32_t vin6 = xnn_load_tail_f32(&i6[num_full_chunks*32], remainder);
...
void xnn_f32_rdsum2_ukernel_7p7x__hvx_u64(
  size_t channels, size_t k1, size_t k2, size_t k3, const float* input,
  size_t input_stride1, size_t input_stride2, size_t input_stride3,
  const float* zero, float* output,
  const struct xnn_f32_scale_params* restrict params) {
...
void xnn_f32_rdsum2_ukernel_7p7x__hvx_u128(
  size_t channels, size_t k1, size_t k2, size_t k3, const float* input,
  size_t input_stride1, size_t input_stride2, size_t input_stride3,
  const float* zero, float* output,
  const struct xnn_f32_scale_params* restrict params) {

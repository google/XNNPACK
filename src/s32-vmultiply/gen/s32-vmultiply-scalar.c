...
void xnn_s32_vmultiply_ukernel__scalar_u1(
    size_t batch,
...
void xnn_s32_vmultiply_ukernel__scalar_u2(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vmultiply_ukernel__scalar_u4(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vmultiply_ukernel__scalar_u8(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,

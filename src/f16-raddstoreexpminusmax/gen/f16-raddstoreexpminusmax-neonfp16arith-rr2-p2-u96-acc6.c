    ...
    const void* params) XNN_OOB_READS
{
  ...
  float32x4_t vacc2_0 = vdupq_n_f32(0.0f);
  float32x4_t vacc2_1 = vdupq_n_f32(0.0f);
  float32x4_t vacc3_0 = vdupq_n_f32(0.0f);
  float32x4_t vacc3_1 = vdupq_n_f32(0.0f);
  float32x4_t vacc4_0 = vdupq_n_f32(0.0f);
  float32x4_t vacc4_1 = vdupq_n_f32(0.0f);
  float32x4_t vacc5_0 = vdupq_n_f32(0.0f);
  float32x4_t vacc5_1 = vdupq_n_f32(0.0f);
  for (; batch >= 96 * sizeof(uint16_t); batch -= 96 * sizeof(uint16_t)) {
    ...
    vacc2_0 = vaddq_f32(vacc2_0, vcvt_f32_f16(vget_low_f16(vf2)));
    vacc2_1 = vaddq_f32(vacc2_1, vcvt_f32_f16(vget_high_f16(vf2)));
    vacc3_0 = vaddq_f32(vacc3_0, vcvt_f32_f16(vget_low_f16(vf3)));
    vacc3_1 = vaddq_f32(vacc3_1, vcvt_f32_f16(vget_high_f16(vf3)));
    vacc4_0 = vaddq_f32(vacc4_0, vcvt_f32_f16(vget_low_f16(vf4)));
    vacc4_1 = vaddq_f32(vacc4_1, vcvt_f32_f16(vget_high_f16(vf4)));
    vacc5_0 = vaddq_f32(vacc5_0, vcvt_f32_f16(vget_low_f16(vf5)));
    vacc5_1 = vaddq_f32(vacc5_1, vcvt_f32_f16(vget_high_f16(vf5)));
    vacc0_0 = vaddq_f32(vacc0_0, vcvt_f32_f16(vget_low_f16(vf6)));
    vacc0_1 = vaddq_f32(vacc0_1, vcvt_f32_f16(vget_high_f16(vf6)));
    vacc1_0 = vaddq_f32(vacc1_0, vcvt_f32_f16(vget_low_f16(vf7)));
    vacc1_1 = vaddq_f32(vacc1_1, vcvt_f32_f16(vget_high_f16(vf7)));
    vacc2_0 = vaddq_f32(vacc2_0, vcvt_f32_f16(vget_low_f16(vf8)));
    vacc2_1 = vaddq_f32(vacc2_1, vcvt_f32_f16(vget_high_f16(vf8)));
    vacc3_0 = vaddq_f32(vacc3_0, vcvt_f32_f16(vget_low_f16(vf9)));
    vacc3_1 = vaddq_f32(vacc3_1, vcvt_f32_f16(vget_high_f16(vf9)));
    vacc4_0 = vaddq_f32(vacc4_0, vcvt_f32_f16(vget_low_f16(vfA)));
    vacc4_1 = vaddq_f32(vacc4_1, vcvt_f32_f16(vget_high_f16(vfA)));
    vacc5_0 = vaddq_f32(vacc5_0, vcvt_f32_f16(vget_low_f16(vfB)));
    vacc5_1 = vaddq_f32(vacc5_1, vcvt_f32_f16(vget_high_f16(vfB)));
  }

  vacc0_0 = vaddq_f32(vacc0_0, vacc1_0);
  vacc0_1 = vaddq_f32(vacc0_1, vacc1_1);
  vacc2_0 = vaddq_f32(vacc2_0, vacc3_0);
  vacc2_1 = vaddq_f32(vacc2_1, vacc3_1);
  vacc4_0 = vaddq_f32(vacc4_0, vacc5_0);
  vacc4_1 = vaddq_f32(vacc4_1, vacc5_1);
  vacc0_0 = vaddq_f32(vacc0_0, vacc2_0);
  vacc0_1 = vaddq_f32(vacc0_1, vacc2_1);
  vacc0_0 = vaddq_f32(vacc0_0, vacc4_0);
  vacc0_1 = vaddq_f32(vacc0_1, vacc4_1);

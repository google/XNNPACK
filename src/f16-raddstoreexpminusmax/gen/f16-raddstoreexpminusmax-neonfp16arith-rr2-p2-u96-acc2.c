...
void xnn_f16_raddstoreexpminusmax_ukernel__neonfp16arith_rr2_p2_u96_acc2(
    size_t batch,
    ...
    const void* params) XNN_OOB_READS
{
  ...
  for (; batch >= 96 * sizeof(uint16_t); batch -= 96 * sizeof(uint16_t)) {
    ...
    vacc1_0 = vaddq_f32(vacc1_0, vcvt_f32_f16(vget_low_f16(vf3)));
    vacc1_1 = vaddq_f32(vacc1_1, vcvt_f32_f16(vget_high_f16(vf3)));
    vacc0_0 = vaddq_f32(vacc0_0, vcvt_f32_f16(vget_low_f16(vf4)));
    vacc0_1 = vaddq_f32(vacc0_1, vcvt_f32_f16(vget_high_f16(vf4)));
    vacc1_0 = vaddq_f32(vacc1_0, vcvt_f32_f16(vget_low_f16(vf5)));
    vacc1_1 = vaddq_f32(vacc1_1, vcvt_f32_f16(vget_high_f16(vf5)));
    ...
    vacc1_0 = vaddq_f32(vacc1_0, vcvt_f32_f16(vget_low_f16(vf9)));
    vacc1_1 = vaddq_f32(vacc1_1, vcvt_f32_f16(vget_high_f16(vf9)));
    vacc0_0 = vaddq_f32(vacc0_0, vcvt_f32_f16(vget_low_f16(vfA)));
    vacc0_1 = vaddq_f32(vacc0_1, vcvt_f32_f16(vget_high_f16(vfA)));
    vacc1_0 = vaddq_f32(vacc1_0, vcvt_f32_f16(vget_low_f16(vfB)));
    vacc1_1 = vaddq_f32(vacc1_1, vcvt_f32_f16(vget_high_f16(vfB)));
  }

    ...
    const union xnn_f16_expminus_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 96 * sizeof(uint16_t); batch -= 96 * sizeof(uint16_t)) {
    ...
    _mm_storeu_si128((__m128i*) (o + 48), _mm256_cvtps_ph(vf6, _MM_FROUND_NO_EXC));
    _mm_storeu_si128((__m128i*) (o + 56), _mm256_cvtps_ph(vf7, _MM_FROUND_NO_EXC));
    _mm_storeu_si128((__m128i*) (o + 64), _mm256_cvtps_ph(vf8, _MM_FROUND_NO_EXC));
    _mm_storeu_si128((__m128i*) (o + 72), _mm256_cvtps_ph(vf9, _MM_FROUND_NO_EXC));
    _mm_storeu_si128((__m128i*) (o + 80), _mm256_cvtps_ph(vfA, _MM_FROUND_NO_EXC));
    _mm_storeu_si128((__m128i*) (o + 88), _mm256_cvtps_ph(vfB, _MM_FROUND_NO_EXC));
    o += 96;

...
void xnn_f16_raddstoreexpminusmax_ukernel__neonfp16arith_rr2_p2_u64_acc4(
    size_t batch,
    ...
    const void* params) XNN_OOB_READS
{
  ...
  for (; batch >= 64 * sizeof(uint16_t); batch -= 64 * sizeof(uint16_t)) {
    ...
    vacc2_0 = vaddq_f32(vacc2_0, vcvt_f32_f16(vget_low_f16(vf6)));
    vacc2_1 = vaddq_f32(vacc2_1, vcvt_f32_f16(vget_high_f16(vf6)));
    vacc3_0 = vaddq_f32(vacc3_0, vcvt_f32_f16(vget_low_f16(vf7)));
    vacc3_1 = vaddq_f32(vacc3_1, vcvt_f32_f16(vget_high_f16(vf7)));
  }

    ...
    const void* params) XNN_OOB_READS
{
  ...
  for (; batch >= 80 * sizeof(uint16_t); batch -= 80 * sizeof(uint16_t)) {
    ...
    vacc1_0 = vaddq_f32(vacc1_0, vcvt_f32_f16(vget_low_f16(vf6)));
    vacc1_1 = vaddq_f32(vacc1_1, vcvt_f32_f16(vget_high_f16(vf6)));
    vacc2_0 = vaddq_f32(vacc2_0, vcvt_f32_f16(vget_low_f16(vf7)));
    vacc2_1 = vaddq_f32(vacc2_1, vcvt_f32_f16(vget_high_f16(vf7)));
    vacc3_0 = vaddq_f32(vacc3_0, vcvt_f32_f16(vget_low_f16(vf8)));
    vacc3_1 = vaddq_f32(vacc3_1, vcvt_f32_f16(vget_high_f16(vf8)));
    vacc4_0 = vaddq_f32(vacc4_0, vcvt_f32_f16(vget_low_f16(vf9)));
    vacc4_1 = vaddq_f32(vacc4_1, vcvt_f32_f16(vget_high_f16(vf9)));
  }

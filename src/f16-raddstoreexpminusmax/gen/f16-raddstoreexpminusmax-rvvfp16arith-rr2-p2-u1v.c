    ...
    const void* params) XNN_OOB_READS
{
  ...
  do {
    ...
    const vfloat16m1_t vs = __riscv_vreinterpret_v_i16m1_f16m1(__riscv_vsll(__riscv_vreinterpret_v_f16m1_i16m1(vn), 10, vl));

    vn = __riscv_vfsub(vn, vmagic_bias, vl);

    vfloat16m1_t vt = __riscv_vmv_v_v_f16m1(vx, vl);
    ...
    vfloat16m1_t vf = __riscv_vmv_v_v_f16m1(vs, vl);

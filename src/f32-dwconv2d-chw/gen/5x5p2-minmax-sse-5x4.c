...
void xnn_f32_dwconv2d_chw_ukernel_5x5p2__sse_5x4(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const union xnn_f32_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m128 vi8x3012 = _mm_setzero_ps();
    ...
    i7 += 4;
    __m128 vi8x4567 = _mm_loadu_ps(i8);
    i8 += 4;
    ...
    for (; w > 8 * sizeof(float); w -= 4 * sizeof(float)) {
      ...
      __m128 vo4p0 = _mm_add_ps(vbias, _mm_mul_ps(vi4x4567, vk02));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi5x4567, vk12));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi6x4567, vk22));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi7x4567, vk32));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi8x4567, vk42));
      ...
      const __m128 vi8x7456 = _mm_shuffle_ps(vi8x4567, vi8x4567, _MM_SHUFFLE(2, 1, 0, 3));
      ...
      const __m128 vi8x3456 = _mm_move_ss(vi8x7456, vi8x3012);
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi4x3456, vk01));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi5x3456, vk11));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi6x3456, vk21));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi7x3456, vk31));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi8x3456, vk41));
      ...
      vi7x3012 = vi7x7456;
      const __m128 vi8x2345 = _mm_shuffle_ps(vi8x3012, vi8x7456, _MM_SHUFFLE(2, 1, 0, 3));
      vi8x3012 = vi8x7456;
      ...
      vi7x4567 = vi7x89AB;
      const __m128 vi8x8567 = _mm_move_ss(vi8x4567, vi8x89AB);
      vi8x4567 = vi8x89AB;
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi4x2345, vk00));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi5x2345, vk10));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi6x2345, vk20));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi7x2345, vk30));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi8x2345, vk40));
      ...
      const __m128 vi8x5678 = _mm_shuffle_ps(vi8x8567, vi8x8567, _MM_SHUFFLE(0, 3, 2, 1));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi4x5678, vk03));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi5x5678, vk13));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi6x5678, vk23));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi7x5678, vk33));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi8x5678, vk43));
      ...
      const __m128 vi8x6789 = _mm_shuffle_ps(vi8x5678, vi8x89AB, _MM_SHUFFLE(1, 0, 2, 1));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi4x6789, vk04));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi5x6789, vk14));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi6x6789, vk24));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi7x6789, vk34));
      ...
      vo4p0 = _mm_add_ps(vo4p0, _mm_mul_ps(vi8x6789, vk44));
    ...
    if XNN_LIKELY(w > 4 * sizeof(float)) {
      ...
      i7 += 4;
      const __m128 vi8x89AB = _mm_and_ps(_mm_loadu_ps(i8), vmask);
      i8 += 4;
    ...
    assert(w <= 4 * sizeof(float));
    {
      ...
      vi8x4567 = _mm_and_ps(vi8x4567, vmask);
      ...
      const __m128 vi8x8567 = _mm_move_ss(vi8x4567, vzero);
      ...
      const __m128 vi8x6789 = _mm_shuffle_ps(vi8x5678, vzero, _MM_SHUFFLE(1, 0, 2, 1));

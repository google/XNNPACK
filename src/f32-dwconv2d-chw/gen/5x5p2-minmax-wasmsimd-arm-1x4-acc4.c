    ...
    const union xnn_f32_chw_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(float); w -= 4 * sizeof(float)) {
      ...
      vo0p2 = wasm_f32x4_add(vo0p2, wasm_f32x4_mul(vi4x4567, wasm_v32x4_shuffle(vwKLMN, vwKLMN, 2 + 1, 2 + 1, 2 + 1, 2 + 1)));
      ...
      vo0p3 = wasm_f32x4_add(vo0p3, wasm_f32x4_mul(vi0x3456, wasm_v32x4_shuffle(vw0123, vw0123, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo0p3 = wasm_f32x4_add(vo0p3, wasm_f32x4_mul(vi4x3456, wasm_v32x4_shuffle(vwKLMN, vwKLMN, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo0p3 = wasm_f32x4_add(vo0p3, wasm_f32x4_mul(vi2x5678, wasm_v32x4_shuffle(vwCDEF, vwCDEF, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo0p3 = wasm_f32x4_add(vo0p3, wasm_f32x4_mul(vi1x6789, wasm_v32x4_shuffle(vw89AB, vw89AB, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));

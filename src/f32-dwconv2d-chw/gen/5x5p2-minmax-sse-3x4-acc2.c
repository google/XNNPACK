...
void xnn_f32_dwconv2d_chw_ukernel_5x5p2__sse_3x4_acc2(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const union xnn_f32_chw_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(float); w -= 4 * sizeof(float)) {
      ...
      __m128 vo1p1 = _mm_mul_ps(vi2x4567, vk12);
      __m128 vo2p1 = _mm_mul_ps(vi3x4567, vk12);
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi4x4567, vk32));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi5x4567, vk32));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi1x3456, vk01));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi2x3456, vk01));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi3x3456, vk21));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi4x3456, vk21));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi5x3456, vk41));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi6x3456, vk41));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi2x2345, vk10));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi3x2345, vk10));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi4x2345, vk30));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi5x2345, vk30));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi1x5678, vk03));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi2x5678, vk03));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi3x5678, vk23));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi4x5678, vk23));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi5x5678, vk43));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi6x5678, vk43));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi2x6789, vk14));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi3x6789, vk14));
      ...
      vo1p1 = _mm_add_ps(vo1p1, _mm_mul_ps(vi4x6789, vk34));
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi5x6789, vk34));

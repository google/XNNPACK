...
void xnn_f32_dwconv2d_chw_ukernel_3x3p1__rvv_7x1v(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    i0 = (const float*) ((uintptr_t) i7 - input_width);
    i1 = (const float*) ((uintptr_t) i8 - input_width);
    ...
    output_height = doz(output_height, 7);

...
void xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__rvv_7x1v(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    i0 = (const float*) ((uintptr_t) i13);
    i1 = (const float*) ((uintptr_t) i14);
    ...
    padded_input_height = doz(padded_input_height, 14);

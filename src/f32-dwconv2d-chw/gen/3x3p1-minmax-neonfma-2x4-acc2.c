    ...
    const union xnn_f32_chw_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; w > 4 * sizeof(float); w -= 4 * sizeof(float)) {
      ...
      float32x4_t vo1p1 = vmulq_laneq_f32(vi2x4567, vw4567, 1);
      ...
      vo1p1 = vfmaq_laneq_f32(vo1p1, vi1x3456, vw0123, 1);
      ...
      vo1p1 = vfmaq_laneq_f32(vo1p1, vi3x3456, vw4567, 3);
      ...
      vo1p1 = vfmaq_laneq_f32(vo1p1, vi2x5678, vw4567, 2);

    ...
    const union xnn_f32_chw_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(float); w -= 4 * sizeof(float)) {
      ...
      v128_t vo2p1 = wasm_f32x4_mul(vi2x4567, wasm_v32x4_shuffle(vw0123, vw0123, 2 + 1, 2 + 1, 2 + 1, 2 + 1));
      ...
      vo1p1 = wasm_f32x4_add(vo1p1, wasm_f32x4_mul(vi4x4567, wasm_v32x4_shuffle(vwGHIJ, vwGHIJ, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      vo2p1 = wasm_f32x4_add(vo2p1, wasm_f32x4_mul(vi5x4567, wasm_v32x4_shuffle(vwGHIJ, vwGHIJ, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo2p1 = wasm_f32x4_add(vo2p1, wasm_f32x4_mul(vi2x3456, wasm_v32x4_shuffle(vw0123, vw0123, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo1p1 = wasm_f32x4_add(vo1p1, wasm_f32x4_mul(vi5x3456, wasm_v32x4_shuffle(vwKLMN, vwKLMN, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      vo2p1 = wasm_f32x4_add(vo2p1, wasm_f32x4_mul(vi6x3456, wasm_v32x4_shuffle(vwKLMN, vwKLMN, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo2p1 = wasm_f32x4_add(vo2p1, wasm_f32x4_mul(vi3x2345, wasm_v32x4_shuffle(vw4567, vw4567, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo2p1 = wasm_f32x4_add(vo2p1, wasm_f32x4_mul(vi4x5678, wasm_v32x4_shuffle(vwCDEF, vwCDEF, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      ...
      vo1p1 = wasm_f32x4_add(vo1p1, wasm_f32x4_mul(vi2x6789, wasm_v32x4_shuffle(vw89AB, vw89AB, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));
      vo2p1 = wasm_f32x4_add(vo2p1, wasm_f32x4_mul(vi3x6789, wasm_v32x4_shuffle(vw89AB, vw89AB, 2 + 0, 2 + 0, 2 + 0, 2 + 0)));

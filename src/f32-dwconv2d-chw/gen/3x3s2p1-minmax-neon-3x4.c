...
void xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__neon_3x4(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,

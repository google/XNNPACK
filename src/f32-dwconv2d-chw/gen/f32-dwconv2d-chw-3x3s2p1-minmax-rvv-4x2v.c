...
void xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__rvv_4x2v(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    i6 += 2 * vl - 1;
    tuple = __riscv_vlseg2e32_v_f32m2x2(i7, vl);
    vfloat32m2_t vi7x1 = __riscv_vget_v_f32m2x2_f32m2(tuple, 0);
    vfloat32m2_t vi7x0 = __riscv_vget_v_f32m2x2_f32m2(tuple, 1);
    vfloat32m2_t vi7x2;
    vi7x0 = __riscv_vfslide1up_vf_f32m2(vi7x0, 0.0f, vl);
    i7 += 2 * vl - 1;
    tuple = __riscv_vlseg2e32_v_f32m2x2(i8, vl);
    vfloat32m2_t vi8x1 = __riscv_vget_v_f32m2x2_f32m2(tuple, 0);
    vfloat32m2_t vi8x0 = __riscv_vget_v_f32m2x2_f32m2(tuple, 1);
    vfloat32m2_t vi8x2;
    vi8x0 = __riscv_vfslide1up_vf_f32m2(vi8x0, 0.0f, vl);
    i8 += 2 * vl - 1;
    ...
    while (w > 2 * vlmax) {
      ...
      vi7x2 = __riscv_vfslide1down_vf_f32m2(vi7x0, *i7, vl);
      vi8x2 = __riscv_vfslide1down_vf_f32m2(vi8x0, *i8, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk00, vi6x0, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk10, vi7x0, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk20, vi8x0, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk01, vi6x1, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk11, vi7x1, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk21, vi8x1, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk02, vi6x2, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk12, vi7x2, vl);
      ...
      vo3p0 = __riscv_vfmacc_vf_f32m2(vo3p0, vk22, vi8x2, vl);
      ...
      i6 += 2 * vl;
      tuple = __riscv_vlseg2e32_v_f32m2x2(i7, vl);
      vi7x0 = __riscv_vget_v_f32m2x2_f32m2(tuple, 0);
      vi7x1 = __riscv_vget_v_f32m2x2_f32m2(tuple, 1);
      i7 += 2 * vl;
      tuple = __riscv_vlseg2e32_v_f32m2x2(i8, vl);
      vi8x0 = __riscv_vget_v_f32m2x2_f32m2(tuple, 0);
      vi8x1 = __riscv_vget_v_f32m2x2_f32m2(tuple, 1);
      i8 += 2 * vl;
    }
    ...
    assert(w <= 2*vlmax);
    {
      if (w & 1) {
        ...
        vi7x2 = __riscv_vfslide1down_vf_f32m2(vi7x0, 0.0f, vl);
        vi8x2 = __riscv_vfslide1down_vf_f32m2(vi8x0, 0.0f, vl);
      } else {
        vi0x2 = __riscv_vfslide1down_vf_f32m2(vi0x0, *i0, vl);
        i0++;
        vi1x2 = __riscv_vfslide1down_vf_f32m2(vi1x0, *i1, vl);

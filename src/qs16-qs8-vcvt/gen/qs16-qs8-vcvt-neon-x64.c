...
void xnn_qs16_qs8_vcvt_ukernel__neon_x64(
    size_t batch,
    const int16_t* input,
    int8_t* output,
    const union xnn_qs16_qs8_cvt_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 64 * sizeof(int16_t); batch -= 64 * sizeof(int16_t)) {
    ...
    const int16x8_t vx4 = vld1q_s16(input); input += 8;
    const int16x8_t vx5 = vld1q_s16(input); input += 8;
    const int16x8_t vx6 = vld1q_s16(input); input += 8;
    const int16x8_t vx7 = vld1q_s16(input); input += 8;
    ...
    int32x4_t vacc_lo4 = vshll_n_s16(vget_low_s16(vx4), 15);
    int32x4_t vacc_hi4 = vshll_n_s16(vget_high_s16(vx4), 15);
    int32x4_t vacc_lo5 = vshll_n_s16(vget_low_s16(vx5), 15);
    int32x4_t vacc_hi5 = vshll_n_s16(vget_high_s16(vx5), 15);
    int32x4_t vacc_lo6 = vshll_n_s16(vget_low_s16(vx6), 15);
    int32x4_t vacc_hi6 = vshll_n_s16(vget_high_s16(vx6), 15);
    int32x4_t vacc_lo7 = vshll_n_s16(vget_low_s16(vx7), 15);
    int32x4_t vacc_hi7 = vshll_n_s16(vget_high_s16(vx7), 15);
    ...
    vacc_lo4 = vqrdmulhq_s32(vacc_lo4, vmultiplier);
    vacc_hi4 = vqrdmulhq_s32(vacc_hi4, vmultiplier);
    vacc_lo5 = vqrdmulhq_s32(vacc_lo5, vmultiplier);
    vacc_hi5 = vqrdmulhq_s32(vacc_hi5, vmultiplier);
    vacc_lo6 = vqrdmulhq_s32(vacc_lo6, vmultiplier);
    vacc_hi6 = vqrdmulhq_s32(vacc_hi6, vmultiplier);
    vacc_lo7 = vqrdmulhq_s32(vacc_lo7, vmultiplier);
    vacc_hi7 = vqrdmulhq_s32(vacc_hi7, vmultiplier);
    ...
    int16x8_t vacc4 = vcombine_s16(vqmovn_s32(vacc_lo4), vqmovn_s32(vacc_hi4));
    int16x8_t vacc5 = vcombine_s16(vqmovn_s32(vacc_lo5), vqmovn_s32(vacc_hi5));
    int16x8_t vacc6 = vcombine_s16(vqmovn_s32(vacc_lo6), vqmovn_s32(vacc_hi6));
    int16x8_t vacc7 = vcombine_s16(vqmovn_s32(vacc_lo7), vqmovn_s32(vacc_hi7));
    ...
    vacc4 = vqaddq_s16(vacc4, voutput_zero_point);
    vacc5 = vqaddq_s16(vacc5, voutput_zero_point);
    vacc6 = vqaddq_s16(vacc6, voutput_zero_point);
    vacc7 = vqaddq_s16(vacc7, voutput_zero_point);
    ...
    const int8x8_t vy4 = vqmovn_s16(vacc4);
    const int8x8_t vy5 = vqmovn_s16(vacc5);
    const int8x8_t vy6 = vqmovn_s16(vacc6);
    const int8x8_t vy7 = vqmovn_s16(vacc7);

    vst1_s8(output, vy0); output += 8;
    vst1_s8(output, vy1); output += 8;
    vst1_s8(output, vy2); output += 8;
    vst1_s8(output, vy3); output += 8;
    vst1_s8(output, vy4); output += 8;
    vst1_s8(output, vy5); output += 8;
    vst1_s8(output, vy6); output += 8;
    vst1_s8(output, vy7); output += 8;
  }

...
void xnn_f16_qs8_vcvt_ukernel__avx512skx_u128(
    size_t batch,
    ...
    const struct xnn_f16_qs8_cvt_params* restrict params)
{
  ...
  for (; batch >= 128 * sizeof(xnn_float16); batch -= 128 * sizeof(xnn_float16)) {
    ...
    __m512 vxOPQR = _mm512_cvtph_ps(_mm256_loadu_si256((const __m256i*) (input + 96)));
    __m512 vxSTUV = _mm512_cvtph_ps(_mm256_loadu_si256((const __m256i*) (input + 112)));
    input += 128;

    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    #endif
    const float32x4_t vinput_scale2 = vld1q_dup_f32(&quantization_params[2].scale);
    #if XNN_ARCH_ARM64
      vout2x0123 = vfmaq_f32(vbias0123, vout2x0123, vinput_scale2);
    #else
      vout2x0123 = vmlaq_f32(vbias0123, vout2x0123, vinput_scale2);
    #endif
    #if XNN_ARCH_ARM64
      vout2x4567 = vfmaq_f32(vbias4567, vout2x4567, vinput_scale2);
    #else
      vout2x4567 = vmlaq_f32(vbias4567, vout2x4567, vinput_scale2);
    #endif
    #if XNN_ARCH_ARM64
      vout2x89AB = vfmaq_f32(vbias89AB, vout2x89AB, vinput_scale2);
    #else
      vout2x89AB = vmlaq_f32(vbias89AB, vout2x89AB, vinput_scale2);
    #endif
    #if XNN_ARCH_ARM64
      vout2xCDEF = vfmaq_f32(vbiasCDEF, vout2xCDEF, vinput_scale2);
    #else
      vout2xCDEF = vmlaq_f32(vbiasCDEF, vout2xCDEF, vinput_scale2);
    #endif

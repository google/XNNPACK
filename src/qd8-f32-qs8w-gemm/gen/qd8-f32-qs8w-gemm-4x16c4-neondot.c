    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    vout1x0123 = vaddq_f32(vout1x0123, vbias0);
    vout1x4567 = vaddq_f32(vout1x4567, vbias4);
    vout1x89AB = vaddq_f32(vout1x89AB, vbias8);
    vout1xCDEF = vaddq_f32(vout1xCDEF, vbias12);
    vout2x0123 = vaddq_f32(vout2x0123, vbias0);
    vout2x4567 = vaddq_f32(vout2x4567, vbias4);
    vout2x89AB = vaddq_f32(vout2x89AB, vbias8);
    vout2xCDEF = vaddq_f32(vout2xCDEF, vbias12);
    vout3x0123 = vaddq_f32(vout3x0123, vbias0);
    vout3x4567 = vaddq_f32(vout3x4567, vbias4);
    vout3x89AB = vaddq_f32(vout3x89AB, vbias8);
    vout3xCDEF = vaddq_f32(vout3xCDEF, vbias12);

...
void xnn_qd8_f32_qs8w_gemm_minmax_ukernel_4x16__neon_mlal_lane_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const float32x4_t vscale01 = vreinterpretq_f32_s32(vld1q_s32(&quantization_params[0].zero_point));
     ...
     vout0x89AB = vfmaq_lane_f32(vbias89AB, vout0x89AB, vget_low_f32(vscale01), 1);
     vout1x89AB = vfmaq_lane_f32(vbias89AB, vout1x89AB, vget_high_f32(vscale01), 1);
     vout0xCDEF = vfmaq_lane_f32(vbiasCDEF, vout0xCDEF, vget_low_f32(vscale01), 1);
     vout1xCDEF = vfmaq_lane_f32(vbiasCDEF, vout1xCDEF, vget_high_f32(vscale01), 1);
    #else
      ...
      vout0x89AB = vmlaq_lane_f32(vbias89AB, vout0x89AB, vget_low_f32(vscale01), 1);
      vout1x89AB = vmlaq_lane_f32(vbias89AB, vout1x89AB, vget_high_f32(vscale01), 1);
      vout0xCDEF = vmlaq_lane_f32(vbiasCDEF, vout0xCDEF, vget_low_f32(vscale01), 1);
      vout1xCDEF = vmlaq_lane_f32(vbiasCDEF, vout1xCDEF, vget_high_f32(vscale01), 1);
    #endif
    const float32x4_t vscale23 = vreinterpretq_f32_s32(vld1q_s32(&quantization_params[2].zero_point));
    #if XNN_ARCH_ARM64
     vout2x0123 = vfmaq_lane_f32(vbias0123, vout2x0123, vget_low_f32(vscale23), 1);
     vout3x0123 = vfmaq_lane_f32(vbias0123, vout3x0123, vget_high_f32(vscale23), 1);
     vout2x4567 = vfmaq_lane_f32(vbias4567, vout2x4567, vget_low_f32(vscale23), 1);
     vout3x4567 = vfmaq_lane_f32(vbias4567, vout3x4567, vget_high_f32(vscale23), 1);
     vout2x89AB = vfmaq_lane_f32(vbias89AB, vout2x89AB, vget_low_f32(vscale23), 1);
     vout3x89AB = vfmaq_lane_f32(vbias89AB, vout3x89AB, vget_high_f32(vscale23), 1);
     vout2xCDEF = vfmaq_lane_f32(vbiasCDEF, vout2xCDEF, vget_low_f32(vscale23), 1);
     vout3xCDEF = vfmaq_lane_f32(vbiasCDEF, vout3xCDEF, vget_high_f32(vscale23), 1);
    #else
      vout2x0123 = vmlaq_lane_f32(vbias0123, vout2x0123, vget_low_f32(vscale23), 1);
      vout3x0123 = vmlaq_lane_f32(vbias0123, vout3x0123, vget_high_f32(vscale23), 1);
      vout2x4567 = vmlaq_lane_f32(vbias4567, vout2x4567, vget_low_f32(vscale23), 1);
      vout3x4567 = vmlaq_lane_f32(vbias4567, vout3x4567, vget_high_f32(vscale23), 1);
      vout2x89AB = vmlaq_lane_f32(vbias89AB, vout2x89AB, vget_low_f32(vscale23), 1);
      vout3x89AB = vmlaq_lane_f32(vbias89AB, vout3x89AB, vget_high_f32(vscale23), 1);
      vout2xCDEF = vmlaq_lane_f32(vbiasCDEF, vout2xCDEF, vget_low_f32(vscale23), 1);
      vout3xCDEF = vmlaq_lane_f32(vbiasCDEF, vout3xCDEF, vget_high_f32(vscale23), 1);
    #endif

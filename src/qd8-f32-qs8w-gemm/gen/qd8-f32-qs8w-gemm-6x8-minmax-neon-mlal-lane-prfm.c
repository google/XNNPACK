...
void xnn_qd8_f32_qs8w_gemm_minmax_ukernel_6x8__neon_mlal_lane_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    #endif
    const float32x4_t vscale45 = vreinterpretq_f32_s32(vld1q_s32(&quantization_params[4].zero_point));
    #if XNN_ARCH_ARM64
     vout4x0123 = vfmaq_lane_f32(vbias0123, vout4x0123, vget_low_f32(vscale45), 1);
     vout5x0123 = vfmaq_lane_f32(vbias0123, vout5x0123, vget_high_f32(vscale45), 1);
     vout4x4567 = vfmaq_lane_f32(vbias4567, vout4x4567, vget_low_f32(vscale45), 1);
     vout5x4567 = vfmaq_lane_f32(vbias4567, vout5x4567, vget_high_f32(vscale45), 1);
    #else
      vout4x0123 = vmlaq_lane_f32(vbias0123, vout4x0123, vget_low_f32(vscale45), 1);
      vout5x0123 = vmlaq_lane_f32(vbias0123, vout5x0123, vget_high_f32(vscale45), 1);
      vout4x4567 = vmlaq_lane_f32(vbias4567, vout4x4567, vget_low_f32(vscale45), 1);
      vout5x4567 = vmlaq_lane_f32(vbias4567, vout5x4567, vget_high_f32(vscale45), 1);
    #endif
    ...
    vout4x0123 = vmaxq_f32(vout4x0123, vmin);
    vout4x4567 = vmaxq_f32(vout4x4567, vmin);
    vout4x0123 = vminq_f32(vout4x0123, vmax);
    vout4x4567 = vminq_f32(vout4x4567, vmax);
    vout5x0123 = vmaxq_f32(vout5x0123, vmin);
    vout5x4567 = vmaxq_f32(vout5x4567, vmin);
    vout5x0123 = vminq_f32(vout5x0123, vmax);
    vout5x4567 = vminq_f32(vout5x4567, vmax);
    if XNN_LIKELY(nc >= 8) {

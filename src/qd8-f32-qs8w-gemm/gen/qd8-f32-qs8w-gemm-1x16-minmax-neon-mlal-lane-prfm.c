...
void xnn_qd8_f32_qs8w_gemm_minmax_ukernel_1x16__neon_mlal_lane_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const float32x4_t vscale0 = vld1q_dup_f32(&quantization_params[0].inv_scale);
    #if XNN_ARCH_ARM64
      vout0x0123 = vfmaq_f32(vbias0123, vout0x0123, vscale0);
      vout0x4567 = vfmaq_f32(vbias4567, vout0x4567, vscale0);
      vout0x89AB = vfmaq_f32(vbias89AB, vout0x89AB, vscale0);
      vout0xCDEF = vfmaq_f32(vbiasCDEF, vout0xCDEF, vscale0);
    #else
      vout0x0123 = vmlaq_f32(vbias0123, vout0x0123, vscale0);
      vout0x4567 = vmlaq_f32(vbias4567, vout0x4567, vscale0);
      vout0x89AB = vmlaq_f32(vbias89AB, vout0x89AB, vscale0);
      vout0xCDEF = vmlaq_f32(vbiasCDEF, vout0xCDEF, vscale0);
    #endif

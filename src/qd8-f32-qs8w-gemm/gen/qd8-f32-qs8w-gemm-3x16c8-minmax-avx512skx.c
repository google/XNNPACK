    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512 vscale2 = _mm512_set1_ps(quantization_params[2].scale);
  const __m512i vzp2 = _mm512_set1_epi32(quantization_params[2].zero_point);
  ...
  do {
    ...
    // Set weight sums for 3 input rows.

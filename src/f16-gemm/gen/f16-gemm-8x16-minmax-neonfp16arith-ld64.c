    ...
    const union xnn_f16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    float16x8_t vacc6x1 = vacc0x1;
    float16x8_t vacc7x0 = vacc0x0;
    float16x8_t vacc7x1 = vacc0x1;
    ...
    while (k >= 4 * sizeof(uint16_t)) {
      ...
      const float16x8_t vb1c0 = vreinterpretq_f16_u16(vld1q_u16(w)); w = (const float16x8_t*) w + 1;
        ...
        vacc6x1 = vfmaq_lane_f16(vacc6x1, vb1c0, va6, 0);
        vacc7x1 = vfmaq_lane_f16(vacc7x1, vb1c0, va7, 0);
      #else
        ...
        vacc6x1 = vmlaq_lane_f16(vacc6x1, vb1c0, va6, 0);
        vacc7x1 = vmlaq_lane_f16(vacc7x1, vb1c0, va7, 0);
      #endif
      ...
      const float16x8_t vb1c1 = vreinterpretq_f16_u16(vld1q_u16(w)); w = (const float16x8_t*) w + 1;
        ...
        vacc6x1 = vfmaq_lane_f16(vacc6x1, vb1c1, va6, 1);
        vacc7x1 = vfmaq_lane_f16(vacc7x1, vb1c1, va7, 1);
      #else
        ...
        vacc6x1 = vmlaq_lane_f16(vacc6x1, vb1c1, va6, 1);
        vacc7x1 = vmlaq_lane_f16(vacc7x1, vb1c1, va7, 1);
      #endif
      ...
      const float16x8_t vb1c2 = vreinterpretq_f16_u16(vld1q_u16(w)); w = (const float16x8_t*) w + 1;
        ...
        vacc6x1 = vfmaq_lane_f16(vacc6x1, vb1c2, va6, 2);
        vacc7x1 = vfmaq_lane_f16(vacc7x1, vb1c2, va7, 2);
      #else
        ...
        vacc6x1 = vmlaq_lane_f16(vacc6x1, vb1c2, va6, 2);
        vacc7x1 = vmlaq_lane_f16(vacc7x1, vb1c2, va7, 2);
      #endif
      ...
      const float16x8_t vb1c3 = vreinterpretq_f16_u16(vld1q_u16(w)); w = (const float16x8_t*) w + 1;
        ...
        vacc6x1 = vfmaq_lane_f16(vacc6x1, vb1c3, va6, 3);
        vacc7x1 = vfmaq_lane_f16(vacc7x1, vb1c3, va7, 3);
      #else
        ...
        vacc6x1 = vmlaq_lane_f16(vacc6x1, vb1c3, va6, 3);
        vacc7x1 = vmlaq_lane_f16(vacc7x1, vb1c3, va7, 3);
      #endif
    ...
    if XNN_UNLIKELY(k != 0) {
      do {
        ...
        vacc6x1 = vfmaq_f16(vacc6x1, va6, vb1);
        vacc7x1 = vfmaq_f16(vacc7x1, va7, vb1);
    ...
    vacc6x1 = vmaxq_f16(vacc6x1, vmin);
    vacc7x1 = vmaxq_f16(vacc7x1, vmin);
    ...
    vacc6x1 = vminq_f16(vacc6x1, vmax);
    vacc7x1 = vminq_f16(vacc7x1, vmax);
    ...
    if XNN_LIKELY(nc >= 16) {
      ...
      vst1q_u16(c6 + 8, vreinterpretq_u16_f16(vacc6x1));
      c6 = (uint16_t*) ((uintptr_t) c6 + cn_stride);
      vst1q_u16(c7, vreinterpretq_u16_f16(vacc7x0));
      vst1q_u16(c7 + 8, vreinterpretq_u16_f16(vacc7x1));
      ...
      if (nc & 8) {
        ...
        vst1q_u16(c6, vreinterpretq_u16_f16(vacc6x0)); c6 += 8;
        vst1q_u16(c7, vreinterpretq_u16_f16(vacc7x0)); c7 += 8;

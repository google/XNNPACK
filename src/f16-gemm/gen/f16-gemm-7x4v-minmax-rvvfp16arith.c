    ...
    const struct xnn_f16_minmax_params* restrict params)
{
  ...
  const xnn_float16* a4 = (const xnn_float16*) ((uintptr_t) a3 + a_stride);
  xnn_float16* c4 = (xnn_float16*) ((uintptr_t) c3 + cm_stride);
  if XNN_UNPREDICTABLE(mr <= 4) {
    a4 = a3;
    c4 = c3;
  }
  const xnn_float16* a5 = (const xnn_float16*) ((uintptr_t) a4 + a_stride);
  xnn_float16* c5 = (xnn_float16*) ((uintptr_t) c4 + cm_stride);
  if XNN_UNPREDICTABLE(mr < 6) {
    a5 = a4;
    c5 = c4;
  }
  const xnn_float16* a6 = (const xnn_float16*) ((uintptr_t) a5 + a_stride);
  ...
  do {
    ...
    a4 = (const xnn_float16*) ((uintptr_t) a4 - kc);
    a5 = (const xnn_float16*) ((uintptr_t) a5 - kc);
    a6 = (const xnn_float16*) ((uintptr_t) a6 - kc);
  } while (nc != 0);
}

    ...
    const union xnn_f16_scaleminmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    do {
      ...
      a5 += 1;
      const __m256 va6 = _mm256_cvtph_ps(_mm_broadcastw_epi16(_mm_loadu_si16(a6)));
      a6 += 1;
      ...
      vacc4x01234567 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(va4, vb01234567, vacc4x01234567), _MM_FROUND_NO_EXC));
      vacc5x01234567 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(va5, vb01234567, vacc5x01234567), _MM_FROUND_NO_EXC));
      vacc6x01234567 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(va6, vb01234567, vacc6x01234567), _MM_FROUND_NO_EXC));
    ...
    vacc5x01234567 = _mm256_mul_ps(vacc5x01234567, vscale);
    vacc6x01234567 = _mm256_mul_ps(vacc6x01234567, vscale);
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      if (nc & 1) {
        _mm_storeu_si16(c6, vh6x01234567);

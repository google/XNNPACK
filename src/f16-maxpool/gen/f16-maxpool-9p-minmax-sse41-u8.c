...
XNN_FORCE_REALIZATION(vmax);
  ...
  do {
    ...
    size_t c = channels;
    for (; c >= 8; c -= 8) {
      const xnn_simd_s16_t vi0 = xnn_load_impl(i0); i0 += 8;
      const xnn_simd_s16_t vi1 = xnn_load_impl(i1); i1 += 8;
      const xnn_simd_s16_t vi2 = xnn_load_impl(i2); i2 += 8;
      const xnn_simd_s16_t vi3 = xnn_load_impl(i3); i3 += 8;
      const xnn_simd_s16_t vi4 = xnn_load_impl(i4); i4 += 8;
      const xnn_simd_s16_t vi5 = xnn_load_impl(i5); i5 += 8;
      const xnn_simd_s16_t vi6 = xnn_load_impl(i6); i6 += 8;
      const xnn_simd_s16_t vi7 = xnn_load_impl(i7); i7 += 8;
      const xnn_simd_s16_t vi8 = xnn_load_impl(i8); i8 += 8;

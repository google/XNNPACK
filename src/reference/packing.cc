...
#include "xnnpack/unaligned.h"
  ...
  #include "kai/ukernels/matmul/pack/kai_rhs_pack_nxk_qsi4cxps1s0_qsu4cxs1s0.h"
...
size_t xnn_packed_stride_kai_qs4_weights_and_biases_sme(
  ...
  size_t ret_val =
      kai_get_rhs_packed_stride_rhs_pack_nxk_qsi4cxps1s0_qsu4cxs1s0(k, nr, kr, sr)/
      kai_get_n_step_rhs_pack_nxk_qsi4cxps1s0_qsu4cxs1s0(nr);
  return ret_val;
}
...
void xnn_pack_kai_qs4_weights_and_biases_sme(
  ...
  struct kai_rhs_pack_nxk_qsi4cxps1s0_qsu4cxs1s0_params  kai_params;

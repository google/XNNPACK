...
#define DECLARE_F32_ARGMAXPOOL_UNIPASS_UKERNEL_FUNCTION(fn_name)                                                \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const float** input, \
                            size_t input_offset, float* output, uint32_t* index, size_t input_increment,        \
...
#define DECLARE_F32_ARGMAXPOOL_MULTIPASS_UKERNEL_FUNCTION(fn_name)                                                  \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const float** input,     \
                            size_t input_offset, float* accumulation_buffer, uint32_t* index_buffer, float* output, \

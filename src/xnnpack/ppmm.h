...
#define DECLARE_F32_PPMM_MINMAX_UKERNEL_FUNCTION(fn_name)                                              \
  XNN_INTERNAL void fn_name(size_t mr, size_t nc, size_t kc, const float* a, const float* w, float* c, \
                            size_t cm_stride, size_t cn_stride, const union xnn_f32_minmax_params* params);

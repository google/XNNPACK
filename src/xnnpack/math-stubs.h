...
DECLARE_F32_UNARY_MATH_FUNCTION(xnn_math_f32_roundd__psimd_addsub)
...
DECLARE_F32_UNARY_MATH_FUNCTION(xnn_math_f32_roundu__psimd_addsub)
...
DECLARE_F32_UNARY_MATH_FUNCTION(xnn_math_f32_sigmoid__wasmsimd_p5_div)

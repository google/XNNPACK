...
DECLARE_F16_IBILINEAR_UKERNEL_FUNCTION(
    xnn_f16_ibilinear_ukernel__neonfp16arith_c16)
...
DECLARE_F32_IBILINEAR_UKERNEL_FUNCTION(
    xnn_f32_ibilinear_ukernel__wasmrelaxedsimd_c8)
...
DECLARE_S8_IBILINEAR_UKERNEL_FUNCTION(
    xnn_s8_ibilinear_ukernel__wasmsimd_dot16x2_c8)
DECLARE_S8_IBILINEAR_UKERNEL_FUNCTION(
...
DECLARE_U8_IBILINEAR_UKERNEL_FUNCTION(
    xnn_u8_ibilinear_ukernel__wasmsimd_mul32_c8)
DECLARE_U8_IBILINEAR_UKERNEL_FUNCTION(

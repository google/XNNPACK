...
enum xnn_operator_type {
  ...
  xnn_operator_type_minimum,
  xnn_operator_type_multiply,
  ...
  xnn_operator_type_squared_difference,
  xnn_operator_type_subtract,

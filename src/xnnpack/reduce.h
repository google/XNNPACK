...
#define XNN_UKERNEL(arch_flags, fn_name, primary_tile, incremental_tile, channel_tile, datatype, output_type, params_type) \
  XNN_INTERNAL void fn_name(                        \
      size_t rows,                                  \
      size_t channels,                              \

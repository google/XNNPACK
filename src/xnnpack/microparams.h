...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  struct {
    uint8_t pos0[16]; // used by x24 kernels
    uint8_t pos1[16]; // used by x24 kernels
    uint8_t pos2[16]; // used by x24 kernels
    uint8_t pos3[16]; // used by x24 kernels
    uint8_t pos4[16]; // used by x24 kernels
    uint8_t pos5[16]; // used by x24 kernels
  } ssse3;
#endif  // XNN_ARCH_X86 || XNN_ARCH_X86_64
};

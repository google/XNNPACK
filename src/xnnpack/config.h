...
XNN_INTERNAL const struct xnn_pack_lh_config* xnn_init_x8_igemm_pack_lh_config();
...
static inline struct xnn_hmp_igemm_ukernel xnn_init_hmp_igemm_ukernel(
  ...
  struct xnn_hmp_igemm_ukernel ukernel = {.function = {function}};
  for (size_t i = 1; i < XNN_MAX_UARCH_TYPES; i++) {
    ukernel.function[i] = function;
  }
  return ukernel;
...
static inline struct xnn_hmp_igemm_ukernel xnn_init_hmp_packed_igemm_ukernel(
  ...
  struct xnn_hmp_igemm_ukernel ukernel = {.packed_lhs_function = {function}};
  for (size_t i = 1; i < XNN_MAX_UARCH_TYPES; i++) {
...
XNN_INTERNAL const struct xnn_gemm_config* xnn_init_pqs8_qc8w_igemm_config();

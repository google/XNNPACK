...
#define DECLARE_PAD_UKERNEL_FUNCTION(fn_name)                                                                         \
  XNN_INTERNAL void fn_name(size_t rows, size_t channels, size_t pre_padding, size_t post_padding, const void* input, \
                            size_t input_stride, void* output, size_t output_stride, const uint32_t fill_pattern);

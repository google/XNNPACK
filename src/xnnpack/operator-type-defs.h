...
XNN_ENUM_ITEM(xnn_operator_type_abs, "Abs (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_bankers_rounding, "Bankers Rounding (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_ceiling, "Ceiling (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_clamp, "Clamp (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_convert, "Convert")
...
XNN_ENUM_ITEM(xnn_operator_type_elu, "ELU (NC)")
XNN_ENUM_ITEM(xnn_operator_type_exp, "Exp (NC)")
XNN_ENUM_ITEM(xnn_operator_type_floor, "Floor (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_gelu, "GELU (NC)")
XNN_ENUM_ITEM(xnn_operator_type_hardswish, "HardSwish (NC)")
XNN_ENUM_ITEM(xnn_operator_type_leaky_relu, "Leaky ReLU (NC)")
XNN_ENUM_ITEM(xnn_operator_type_log, "Log (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_negate, "Negate (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_sigmoid, "Sigmoid (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_square, "Square (NC)")
XNN_ENUM_ITEM(xnn_operator_type_square_root, "Square Root (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_tanh, "Tanh (NC)")
...
XNN_ENUM_ITEM(xnn_operator_type_truncation, "Truncation (NC)")

...
#define DECLARE_F32_PAVGPOOL_MINMAX_MULTIPASS_UKERNEL_FUNCTION(fn_name)                                         \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const float** input, \
                            size_t input_offset, const float* zero, const float* multiplier, float* buffer,     \
...
#define DECLARE_F32_PAVGPOOL_MINMAX_UNIPASS_UKERNEL_FUNCTION(fn_name)                                           \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const float** input, \
                            size_t input_offset, const float* zero, const float* multiplier, float* output,     \

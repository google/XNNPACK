...
static XNN_INLINE v128_t xnn_cvt_s32_s16(xnn_simd_s32_t a, xnn_simd_s32_t b) {
    return wasm_i16x8_narrow_i32x4(a, b);
}

static XNN_INLINE v128_t xnn_cvt_s32_f32(xnn_simd_s32_t a) {
   return wasm_i32x4_to_f32x4(a);
}

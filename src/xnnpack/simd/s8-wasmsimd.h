...
static XNN_INLINE int8_t xnn_reduce_max_s8(xnn_simd_s8_t a) {
  v128_t max1 =
      wasm_i8x16_max(a, wasm_i8x16_shuffle(a, a, 8, 9, 10, 11, 12, 13, 14, 15,
                                           0, 1, 2, 3, 4, 5, 6, 7));
  max1 =
      wasm_i8x16_max(max1, wasm_i8x16_shuffle(max1, max1, 4, 5, 6, 7, 0, 1, 2,
                                              3, 12, 13, 14, 15, 8, 9, 10, 11));
  max1 =
      wasm_i8x16_max(max1, wasm_i8x16_shuffle(max1, max1, 2, 3, 0, 1, 6, 7, 4,
                                              5, 10, 11, 8, 9, 14, 15, 12, 13));
  max1 =
      wasm_i8x16_max(max1, wasm_i8x16_shuffle(max1, max1, 1, 0, 3, 2, 5, 4, 7,
...
static XNN_INLINE int8_t xnn_reduce_min_s8(xnn_simd_s8_t a) {
  v128_t min1 =
      wasm_i8x16_min(a, wasm_i8x16_shuffle(a, a, 8, 9, 10, 11, 12, 13, 14, 15,
                                           0, 1, 2, 3, 4, 5, 6, 7));
  min1 =
      wasm_i8x16_min(min1, wasm_i8x16_shuffle(min1, min1, 4, 5, 6, 7, 0, 1, 2,
                                              3, 12, 13, 14, 15, 8, 9, 10, 11));
  min1 =
      wasm_i8x16_min(min1, wasm_i8x16_shuffle(min1, min1, 2, 3, 0, 1, 6, 7, 4,
                                              5, 10, 11, 8, 9, 14, 15, 12, 13));
  min1 =
      wasm_i8x16_min(min1, wasm_i8x16_shuffle(min1, min1, 1, 0, 3, 2, 5, 4, 7,
                                              6, 9, 8, 11, 10, 13, 12, 15, 14));

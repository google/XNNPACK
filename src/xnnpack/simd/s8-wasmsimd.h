...
// SIMD vector type for s8 using wasm.
...
static XNN_INLINE int8_t xnn_horizontal_max_s8(xnn_simd_s8_t a) {
  v128_t min1 = wasm_i8x16_min(a, wasm_i8x16_shuffle(
    a, a, 8, 9, 10, 11, 12, 13, 14, 15, 0, 1, 2, 3, 4, 5, 6, 7));
  v128_t min2 = wasm_i8x16_min(min1, wasm_i8x16_shuffle(
    min1, min1, 4, 5, 6, 7, 0, 1, 2, 3, 12, 13, 14, 15, 8, 9, 10, 11));
  v128_t min3 = wasm_i8x16_min(min2, wasm_i8x16_shuffle(
    min2, min2, 2, 3, 0, 1, 6, 7, 4, 5, 10, 11, 8, 9, 14, 15, 12, 13));
  v128_t min4 = wasm_i8x16_min(min3, wasm_i8x16_shuffle(
    min3, min3, 1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12, 15, 14));

  return wasm_i8x16_extract_lane(min4, 0);
}

static XNN_INLINE int8_t xnn_horizontal_min_s8(xnn_simd_s8_t a) {
  v128_t max1 = wasm_i8x16_max(a, wasm_i8x16_shuffle(
    a, a, 8, 9, 10, 11, 12, 13, 14, 15, 0, 1, 2, 3, 4, 5, 6, 7));
  v128_t max2 = wasm_i8x16_max(max1, wasm_i8x16_shuffle(
    max1, max1, 4, 5, 6, 7, 0, 1, 2, 3, 12, 13, 14, 15, 8, 9, 10, 11));
  v128_t max3 = wasm_i8x16_min(max2, wasm_i8x16_shuffle(
    max2, max2, 2, 3, 0, 1, 6, 7, 4, 5, 10, 11, 8, 9, 14, 15, 12, 13));
  v128_t min4 = wasm_i8x16_min(max3, wasm_i8x16_shuffle(
    max3, max3, 1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12, 15, 14));

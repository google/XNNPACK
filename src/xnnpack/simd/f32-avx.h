...
static XNN_INLINE xnn_simd_f32_t xnn_shift_left_f32(xnn_simd_f32_t a,
                                                    uint8_t bits) {
...
// This intrinsic is not particularly efficient. If you really need this
// intrinsic, consider using `avx2` instead.
static XNN_INLINE xnn_simd_f32_t xnn_shift_right_f32(xnn_simd_f32_t a,
                                                     uint8_t bits) {
  __m128i a_lo = _mm256_castsi256_si128(_mm256_castps_si256(a));
  __m128i a_hi = _mm256_extractf128_si256(_mm256_castps_si256(a), 1);
...
// This intrinsic is not particularly efficient. If you really need this
// intrinsic, consider using `avx2` instead.
static XNN_INLINE xnn_simd_f32_t xnn_shift_right_signed_f32(xnn_simd_f32_t a,
                                                            uint8_t bits) {
  __m128i a_lo = _mm256_castsi256_si128(_mm256_castps_si256(a));
  __m128i a_hi = _mm256_extractf128_si256(_mm256_castps_si256(a), 1);

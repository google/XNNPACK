...
// Returns the packed RHS size (in bytes) per group for KAI f16 conv_goki
// packer.
XNN_INTERNAL size_t xnn_packed_size_kai_f16_conv_goki_w(size_t nc,  //
                                                        size_t ks,  //
                                                        size_t kc   //
);
...
XNN_INTERNAL void xnn_pack_qs8_qc2w_gemm_gio_w(
    size_t g, size_t nc, size_t kc, size_t nr, size_t kr, size_t sr,
...
XNN_INTERNAL void xnn_pack_qs8_to_qu8_qc4uw_gemm_gio_w(
    size_t g, size_t nc, size_t kc, size_t nr, size_t kr, size_t sr,
    size_t k_stride, const uint8_t* kernel, const int32_t* bias,
    const float* scale, void* packed_weights, size_t extra_bytes,
    const struct xnn_qs8_qc4w_packing_params* params);
 ...
 */
typedef void (*xnn_pack_f16_igemm_void_dst_fn)(
    size_t g, size_t nc, size_t ks, size_t kc, size_t nr, size_t kr, size_t sr,
...
XNN_INTERNAL void xnn_pack_bf16_f32_conv_goki_w(
    size_t g, size_t nc, size_t ks, size_t kc, size_t nr, size_t kr, size_t sr,
    const uint16_t* kernel, const float* bias, const void* scale,
    void* packed_weights, size_t extra_bytes, const void* params);
...
XNN_INTERNAL void xnn_pack_bf16_f32_dwconv_ghw_w(
    size_t primary_tile, size_t h, size_t w, size_t c, size_t channel_tile,
    const uint16_t* kernel, const float* bias, const void* scale,
    void* packed_weights, size_t per_tile_extra_bytes, const void* params);
...
XNN_INTERNAL void xnn_pack_bf16_f32_dwconv_hwg_w(
    size_t primary_tile, size_t h, size_t w, size_t c, size_t channel_tile,
    const uint16_t* kernel, const float* bias, const void* scale,
    void* packed_weights, size_t per_tile_extra_bytes, const void* params);

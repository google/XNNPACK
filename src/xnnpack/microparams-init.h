...
XNN_INTERNAL size_t xnn_init_f16_minmax_scalar_params(
    ...
    xnn_float16 output_min, xnn_float16 output_max);
...
DECLARE_INIT_UNARY_MICROPARAMS_FUNCTION(xnn_init_qs8_vhswish_scalar_params);
...
DECLARE_INIT_UNARY_MICROPARAMS_FUNCTION(xnn_init_qu8_vhswish_scalar_params);

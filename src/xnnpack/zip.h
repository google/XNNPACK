...
#define DECLARE_X8_ZIPC_UKERNEL_FUNCTION(fn_name) XNN_INTERNAL void fn_name(size_t n, const uint8_t* x, uint8_t* y);
...
#define DECLARE_X32_ZIPC_UKERNEL_FUNCTION(fn_name) XNN_INTERNAL void fn_name(size_t n, const uint32_t* x, uint32_t* y);

...
#define DECLARE_F16_PRELU_UKERNEL_FUNCTION(fn_name)                                                                    \
  XNN_INTERNAL void fn_name(size_t rows, size_t channels, const void* input, size_t input_stride, const void* weights, \
...
#define DECLARE_F32_PRELU_UKERNEL_FUNCTION(fn_name)                                                \
  XNN_INTERNAL void fn_name(size_t rows, size_t channels, const float* input, size_t input_stride, \

...
#ifndef THIRD_PARTY_XNNPACK_SRC_XNNPACK_SUBGRAPH_TYPES_H_
#define THIRD_PARTY_XNNPACK_SRC_XNNPACK_SUBGRAPH_TYPES_H_
...
#endif  // THIRD_PARTY_XNNPACK_SRC_XNNPACK_SUBGRAPH_TYPES_H_

...
#define DECLARE_F32_AVGPOOL_MINMAX_MULTIPASS_UKERNEL_FUNCTION(fn_name)                                          \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const float** input, \
                            size_t input_offset, const float* zero, float* buffer, float* output,               \
...
#define DECLARE_F32_AVGPOOL_MINMAX_UNIPASS_UKERNEL_FUNCTION(fn_name)                                            \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const float** input, \
                            size_t input_offset, const float* zero, float* output, size_t input_increment,      \
                            size_t output_increment, const union xnn_f32_scaleminmax_params* params);
...
#define DECLARE_QU8_AVGPOOL_MINMAX_MULTIPASS_UKERNEL_FUNCTION(fn_name)                                            \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const uint8_t** input, \
                            size_t input_offset, const uint8_t* zero, int32_t* buffer, uint8_t* output,           \
                            size_t input_increment, size_t output_increment,                                      \
...
#define DECLARE_QU8_AVGPOOL_MINMAX_UNIPASS_UKERNEL_FUNCTION(fn_name)                                              \
  XNN_INTERNAL void fn_name(size_t output_pixels, size_t kernel_elements, size_t channels, const uint8_t** input, \
                            size_t input_offset, const uint8_t* zero, uint8_t* output, size_t input_increment,    \
                            size_t output_increment, const union xnn_qu8_avgpool_params* params);

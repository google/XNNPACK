...
#define XNN_TEST_HWCONFIG_FLAG_NONE()                   \
  []() -> bool {                                        \
...
#define XNN_TEST_HWCONFIG_FLAG(FLAG)                            \
  []() -> bool {                                                \
    const struct xnn_hardware_config* hardware_config =         \
        xnn_init_hardware_config();                             \
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512SKX_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512skx)
#define TEST_REQUIRES_X86_AVX512SKX \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512skx)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512VBMI_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512vbmi)
#define TEST_REQUIRES_X86_AVX512VBMI \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512vbmi)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512VNNI_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512vnni)
#define TEST_REQUIRES_X86_AVX512VNNI \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512vnni)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512AMX_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512amx)
#define TEST_REQUIRES_X86_AVX512AMX \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512amx)
#else
...
#if XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512BF16_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512bf16)
#define TEST_REQUIRES_X86_AVX512BF16 \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512bf16)
#else
#define TEST_REQUIRES_X86_AVX512BF16_VALUE (false)
#define TEST_REQUIRES_X86_AVX512BF16 \
  do {                               \
  } while (0)
#endif
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512FP16_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512fp16)
#define TEST_REQUIRES_X86_AVX512FP16 \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512fp16)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX512VNNIGFNI_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx512vnnigfni)
#define TEST_REQUIRES_X86_AVX512VNNIGFNI \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx512vnnigfni)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVXVNNIINT8_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avxvnniint8)
#define TEST_REQUIRES_X86_AVXVNNIINT8 \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avxvnniint8)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX256SKX_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx256skx)
#define TEST_REQUIRES_X86_AVX256SKX \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx256skx)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX256VNNI_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx256vnni)
#define TEST_REQUIRES_X86_AVX256VNNI \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx256vnni)
#else
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
#define TEST_REQUIRES_X86_AVX256VNNIGFNI_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_x86_avx256vnnigfni)
#define TEST_REQUIRES_X86_AVX256VNNIGFNI \
  TEST_REQUIRES_HWCONFIG_FLAG(use_x86_avx256vnnigfni)
#else
...
#define TEST_REQUIRES_ARM_FP16_ARITH_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_fp16_arith)
#define TEST_REQUIRES_ARM_FP16_ARITH \
  TEST_REQUIRES_HWCONFIG_FLAG(use_arm_fp16_arith)
#else
...
#if XNN_ARCH_ARM
#define TEST_REQUIRES_ARM_NEON_FP16_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_neon_fp16)
#define TEST_REQUIRES_ARM_NEON_FP16 \
  TEST_REQUIRES_HWCONFIG_FLAG(use_arm_neon_fp16)
#else
...
#if XNN_ARCH_ARM
#define TEST_REQUIRES_ARM_NEON_FMA_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_neon_fma)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
#define TEST_REQUIRES_ARM_NEON_FP16_ARITH_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_neon_fp16_arith)
#define TEST_REQUIRES_ARM_NEON_FP16_ARITH \
  TEST_REQUIRES_HWCONFIG_FLAG(use_arm_neon_fp16_arith)
#else
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
#define TEST_REQUIRES_ARM_NEON_BF16_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_neon_bf16)
#define TEST_REQUIRES_ARM_NEON_BF16 \
  TEST_REQUIRES_HWCONFIG_FLAG(use_arm_neon_bf16)
#else
...
#define TEST_REQUIRES_ARM_NEON_DOT_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_neon_dot)
...
#define TEST_REQUIRES_ARM_NEON_DOT_FP16_ARITH_VALUE                           \
  []() -> bool {                                                              \
    const struct xnn_hardware_config* hardware_config =                       \
        xnn_init_hardware_config();                                           \
    return hardware_config != nullptr && hardware_config->use_arm_neon_dot && \
...
#if XNN_ARCH_ARM64
#define TEST_REQUIRES_ARM_NEON_I8MM_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_arm_neon_i8mm)
#define TEST_REQUIRES_ARM_NEON_I8MM \
  TEST_REQUIRES_HWCONFIG_FLAG(use_arm_neon_i8mm)
#else
...
#define TEST_REQUIRES_ARM_NEON_SME \
  do {                             \
  } while (0)
#endif  // XNN_ARCH_ARM64
...
#define TEST_REQUIRES_ARM_NEON_SME2 \
  do {                              \
  } while (0)
#endif  // XNN_ARCH_ARM64

#if XNN_ARCH_RISCV
#define TEST_REQUIRES_RISCV_VECTOR_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_riscv_vector)
...
#if XNN_ARCH_RISCV
#define TEST_REQUIRES_RISCV_VECTOR_FP16_ARITH_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_riscv_vector_fp16_arith)
#define TEST_REQUIRES_RISCV_VECTOR_FP16_ARITH \
  TEST_REQUIRES_HWCONFIG_FLAG(use_riscv_vector_fp16_arith)
#else
...
#define TEST_REQUIRES_RISCV_VECTOR_FP16_ARITH \
  ...
  #define TEST_REQUIRES_LOONGARCH_SX_VALUE XNN_TEST_HWCONFIG_FLAG(use_lsx)
  #define TEST_REQUIRES_LOONGARCH_SX TEST_REQUIRES_HWCONFIG_FLAG(use_lsx)
#else
  #define TEST_REQUIRES_LOONGARCH_SX_VALUE (false)
  #define TEST_REQUIRES_LOONGARCH_SX do {} while (0)
#endif

#if XNN_ARCH_LOONGARCH
  #define TEST_REQUIRES_LOONGARCH_ASX_VALUE XNN_TEST_HWCONFIG_FLAG(use_lasx)
  #define TEST_REQUIRES_LOONGARCH_ASX TEST_REQUIRES_HWCONFIG_FLAG(use_lasx)
#else
  #define TEST_REQUIRES_LOONGARCH_ASX_VALUE (false)
  #define TEST_REQUIRES_LOONGARCH_ASX do {} while (0)
#endif
...
#if XNN_ARCH_WASMRELAXEDSIMD
#define TEST_REQUIRES_WASM_BLENDVPS_VALUE \
  XNN_TEST_HWCONFIG_FLAG(use_wasm_blendvps)
#define TEST_REQUIRES_WASM_BLENDVPS \
  TEST_REQUIRES_HWCONFIG_FLAG(use_wasm_blendvps)
#else

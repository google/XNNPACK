...
void xnn_f32_vremc_ukernel__wasmsimd_u4(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
...
void xnn_f32_vremc_ukernel__wasmsimd_u8(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
...
void xnn_f32_vremc_ukernel__wasmsimd_u12(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
...
void xnn_f32_vremc_ukernel__wasmsimd_u16(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,

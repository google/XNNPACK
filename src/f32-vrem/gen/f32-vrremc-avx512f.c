...
//   Template: src/f32-vrem/f32-vrremc.c.in
...
void xnn_f32_vrremc_ukernel__avx512f_u16(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
    const union xnn_f32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  if XNN_UNLIKELY(batch != 0) {
    xnn_simd_f32_t vin2 = xnn_load_tail_f32(input_a, batch >> XNN_LOG2_SIZEOF_FLOAT);
...
void xnn_f32_vrremc_ukernel__avx512f_u32(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
...
void xnn_f32_vrremc_ukernel__avx512f_u48(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
    const union xnn_f32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 48 * sizeof(float); batch -= 48 * sizeof(float)) {
    xnn_simd_f32_t vin2_0 = xnn_loadu_f32(input_a);
    xnn_simd_f32_t vin2_1 = (xnn_loadu_f32(input_a + 1 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_2 = (xnn_loadu_f32(input_a + 2 * xnn_simd_size_f32));
    input_a += 48;

    xnn_simd_f32_t vy_0 = xnn_rem_f32(vin1, vin2_0);
    xnn_simd_f32_t vy_1 = xnn_rem_f32(vin1, vin2_1);
    xnn_simd_f32_t vy_2 = xnn_rem_f32(vin1, vin2_2);
...
void xnn_f32_vrremc_ukernel__avx512f_u64(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
    const union xnn_f32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    xnn_simd_f32_t vin2_1 = (xnn_loadu_f32(input_a + 1 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_2 = (xnn_loadu_f32(input_a + 2 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_3 = (xnn_loadu_f32(input_a + 3 * xnn_simd_size_f32));
    input_a += 64;

    xnn_simd_f32_t vy_0 = xnn_rem_f32(vin1, vin2_0);
    xnn_simd_f32_t vy_1 = xnn_rem_f32(vin1, vin2_1);
    xnn_simd_f32_t vy_2 = xnn_rem_f32(vin1, vin2_2);
    xnn_simd_f32_t vy_3 = xnn_rem_f32(vin1, vin2_3);

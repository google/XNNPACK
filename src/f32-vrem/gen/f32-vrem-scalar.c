...
void xnn_f32_vrem_ukernel__scalar_u1(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
...
void xnn_f32_vrem_ukernel__scalar_u4(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
    const union xnn_f32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(float); batch -= 4 * sizeof(float)) {
    ...
    xnn_simd_f32_t vin2_0 = xnn_loadu_f32(input_b);
    xnn_simd_f32_t vin2_1 = (xnn_loadu_f32(input_b + 1 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_2 = (xnn_loadu_f32(input_b + 2 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_3 = (xnn_loadu_f32(input_b + 3 * xnn_simd_size_f32));
    input_b += 4;

    xnn_simd_f32_t vy_0 = xnn_rem_f32(vin1_0, vin2_0);
    xnn_simd_f32_t vy_1 = xnn_rem_f32(vin1_1, vin2_1);
    xnn_simd_f32_t vy_2 = xnn_rem_f32(vin1_2, vin2_2);
    xnn_simd_f32_t vy_3 = xnn_rem_f32(vin1_3, vin2_3);
...
void xnn_f32_vrem_ukernel__scalar_u8(
    size_t batch,
    const float* input_a,
    const float* input_b,
    float* output,
    const union xnn_f32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    xnn_simd_f32_t vin2_2 = (xnn_loadu_f32(input_b + 2 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_3 = (xnn_loadu_f32(input_b + 3 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_4 = (xnn_loadu_f32(input_b + 4 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_5 = (xnn_loadu_f32(input_b + 5 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_6 = (xnn_loadu_f32(input_b + 6 * xnn_simd_size_f32));
    xnn_simd_f32_t vin2_7 = (xnn_loadu_f32(input_b + 7 * xnn_simd_size_f32));
    input_b += 8;
    ...
    xnn_simd_f32_t vy_2 = xnn_rem_f32(vin1_2, vin2_2);
    xnn_simd_f32_t vy_3 = xnn_rem_f32(vin1_3, vin2_3);
    xnn_simd_f32_t vy_4 = xnn_rem_f32(vin1_4, vin2_4);
    xnn_simd_f32_t vy_5 = xnn_rem_f32(vin1_5, vin2_5);
    xnn_simd_f32_t vy_6 = xnn_rem_f32(vin1_6, vin2_6);
    xnn_simd_f32_t vy_7 = xnn_rem_f32(vin1_7, vin2_7);

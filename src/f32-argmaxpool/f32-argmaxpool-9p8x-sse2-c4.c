...
static XNN_INLINE __m128i xnn_load_tail_safe_u32(const uint32_t* input,
                                                 size_t num_elements) {
  ...
  do {
    ...
    for (; k > 0; k -= 9) {
      ...
      for (; c >= 4; c -= 4) {
        ...
        __m128i vidx;
        if (ab) {
          vmax = _mm_loadu_ps(ab);
          ab += 4;
          vidx = _mm_loadu_si128((const __m128i*)ib);
          ib += 4;

          const __m128i vm0 = _mm_castps_si128(_mm_cmpgt_ps(vi0, vmax));
          vmax = _mm_max_ps(vi0, vmax);
          vidx = _mm_or_si128(_mm_andnot_si128(vm0, vidx),
                              _mm_and_si128(vm0, vidx0));
        } else {
          vmax = vi0;
          vidx = vidx0;
        }
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm1, vidx),
                            _mm_and_si128(vm1, vidx1));
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm2, vidx),
                            _mm_and_si128(vm2, vidx2));
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm3, vidx),
                            _mm_and_si128(vm3, vidx3));
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm4, vidx),
                            _mm_and_si128(vm4, vidx4));
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm5, vidx),
                            _mm_and_si128(vm5, vidx5));
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm6, vidx),
                            _mm_and_si128(vm6, vidx6));
        ...
        vidx = _mm_or_si128(_mm_andnot_si128(vm7, vidx),
                            _mm_and_si128(vm7, vidx7));

        const __m128i vm8 = _mm_castps_si128(_mm_cmpgt_ps(vi8, vmax));
        vidx8 = _mm_add_epi32(vidx7, v1);
        vmax = _mm_max_ps(vi8, vmax);
        vidx = _mm_or_si128(_mm_andnot_si128(vm8, vidx),
                            _mm_and_si128(vm8, vidx8));

...
void xnn_f32_argmaxpool_ukernel_9p8x__rvv_u1v(
  ...
  vuint32m1_t fidx_f32v =
      __riscv_vmv_v_x_u32m1(0, __riscv_vsetvl_e32m1(channels));
  do {
    ...
    for (; k > 0; k -= 9) {
      ...
      for (size_t c = channels; c != 0;) {
        ...
        vfloat32m1_t i0_f32v = __riscv_vle32_v_f32m1(i0, n);
        i0 += n;
        vfloat32m1_t i1_f32v = __riscv_vle32_v_f32m1(i1, n);
        i1 += n;
        vfloat32m1_t i2_f32v = __riscv_vle32_v_f32m1(i2, n);
        i2 += n;
        vfloat32m1_t i3_f32v = __riscv_vle32_v_f32m1(i3, n);
        i3 += n;
        vfloat32m1_t i4_f32v = __riscv_vle32_v_f32m1(i4, n);
        i4 += n;
        vfloat32m1_t i5_f32v = __riscv_vle32_v_f32m1(i5, n);
        i5 += n;
        vfloat32m1_t i6_f32v = __riscv_vle32_v_f32m1(i6, n);
        i6 += n;
        vfloat32m1_t i7_f32v = __riscv_vle32_v_f32m1(i7, n);
        i7 += n;
        vfloat32m1_t i8_f32v = __riscv_vle32_v_f32m1(i8, n);
        i8 += n;
        ...
        if (ab) {
          max_f32v = __riscv_vle32_v_f32m1(ab, n);
          ab += n;
          idx_f32v = __riscv_vle32_v_u32m1(ib, n);
          ib += n;
        ...
        __riscv_vse32_v_f32m1(o, max_f32v, n);
        o += n;
        __riscv_vse32_v_u32m1(i, idx_f32v, n);
        i += n;
      }
      idx0 += 9;
      ab = output;

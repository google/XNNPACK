...
void xnn_x24_transposec_ukernel__4x4_ssse3(const void* input, void* output,
                                           size_t input_stride,
                                           size_t output_stride,
                                           size_t block_width,
                                           size_t block_height) XNN_OOB_READS {
  XNN_ALIGN(16)
  static const uint8_t pos0[16] = {0, 4, 8, 2,  6,  10, 1,  5,
                                   9, 3, 7, 11, -1, -1, -1, -1};
  XNN_ALIGN(16)
  static const uint8_t pos1[16] = {4,  8, 12, 6,  10, 14, 5,  9,
                                   13, 7, 11, 15, -1, -1, -1, -1};
  XNN_ALIGN(16)
  static const uint8_t pos2[16] = {12, -1, -1, 14, -1, -1, 13, -1,
                                   -1, 15, -1, -1, -1, -1, -1, -1};
  XNN_ALIGN(16)
  static const uint8_t pos3[16] = {-1, 0,  4, -1, 2,  6,  -1, 1,
                                   5,  -1, 3, 7,  -1, -1, -1, -1};
  XNN_ALIGN(16)
  static const uint8_t pos4[16] = {8,  12, -1, 10, 14, -1, 9,  13,
                                   -1, 11, 15, -1, -1, -1, -1, -1};
  XNN_ALIGN(16)
  static const uint8_t pos5[16] = {-1, -1, 0,  -1, -1, 2,  -1, -1,
                                   1,  -1, -1, 3,  -1, -1, -1, -1};
  ...
  do {
    ...
    for (; bh >= 4; bh -= 4) {
      ...
      __m128i v4_1 = _mm_or_si128(_mm_shuffle_epi8(v3_0, vperm2),
                                  _mm_shuffle_epi8(v3_1, vperm3));
      __m128i v4_2 = _mm_or_si128(_mm_shuffle_epi8(v3_1, vperm4),
                                  _mm_shuffle_epi8(v3_2, vperm5));

...
void xnn_qu8_rsum_ukernel__wasmsimd_u32_acc4(
    size_t batch,
    const uint8_t* input,
    uint32_t* output,
    const struct xnn_qs8_rsum_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 8192; batch -= 8192) {
    ...
    v128_t vacc16_3 = wasm_i16x8_const_splat(0);
    for (size_t current_batch = 8192; current_batch > 0; current_batch -= 32) {
      ...
      vacc16_3 = wasm_i16x8_add(vacc16_3, vt3);
    }
    ...
    vacc2 = wasm_i32x4_add(vacc2, wasm_u32x4_extend_low_u16x8(vacc16_2));
    vacc2 = wasm_i32x4_add(vacc2, wasm_u32x4_extend_high_u16x8(vacc16_2));
    vacc3 = wasm_i32x4_add(vacc3, wasm_u32x4_extend_low_u16x8(vacc16_3));
    vacc3 = wasm_i32x4_add(vacc3, wasm_u32x4_extend_high_u16x8(vacc16_3));
  }
  ...
  if (XNN_UNLIKELY(batch != 0)) {
    ...
    v128_t vacc16_3 = wasm_i8x16_const_splat(0);

    ...
    /**************************** F32 micro-kernels ****************************/
      ...
      xnn_params.f32.vmulcaddc = (struct vmulcaddc_parameters) {
        ...
        xnn_params.f32.dwconv2d_chw_3x3s2 = (struct dwconv2d_chw_parameters) {
          .ukernel = (xnn_dwconv2d_chw_ukernel_function) xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__scalar_1x1,
          .input_width_tile = 1,
          .output_width_tile = 1,
          .output_height_tile = 1,
        };
  ...
  /**************************** F32 micro-kernels ****************************/
    ...
    if (is_wasm_x86) {
      ...
      if (is_wasm_x86) {
        ...
        xnn_params.f32.dwconv2d_chw_3x3s2 = (struct dwconv2d_chw_parameters) {
          .ukernel = (xnn_dwconv2d_chw_ukernel_function) xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__wasmsimd_x86_1x4_acc2,
          .input_width_tile = 4,
          .output_width_tile = 4,
          .output_height_tile = 1,
        };
        ...
        xnn_params.f32.dwconv2d_chw_3x3s2 = (struct dwconv2d_chw_parameters) {
          .ukernel = (xnn_dwconv2d_chw_ukernel_function) xnn_f32_dwconv2d_chw_ukernel_3x3s2p1__wasmsimd_arm_1x4_acc4,
          .input_width_tile = 4,
          .output_width_tile = 4,
          .output_height_tile = 1,
        };

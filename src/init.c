...
static void init(void) {
  ...
  if (cpuinfo_has_arm_neon()) {
    ...
    /*************************** QU8 micro-kernels ***************************/
      ...
      xnn_params.qu8.dwconv[0].minmax.unipass = (xnn_dwconv_unipass_ukernel_function) xnn_qu8_dwconv_minmax_rndnu_ukernel_up16x9__neon_mul16;
  ...
  /**************************** QU8 micro-kernels ****************************/
    ...
    init_flags |= XNN_INIT_FLAG_QU8;
      ...
      if (cpuinfo_has_arm_neon_dot()) {
        switch (cpuinfo_get_core(0)->uarch) {
          case cpuinfo_uarch_cortex_a55:
            xnn_params.qu8.gemm.minmax.gemm = xnn_init_hmp_gemm_ukernel((xnn_gemm_ukernel_function) xnn_qu8_gemm_minmax_rndnu_ukernel_4x8c4__aarch64_neondot_cortex_a55);
            xnn_params.qu8.gemm.minmax.igemm = xnn_init_hmp_igemm_ukernel((xnn_igemm_ukernel_function) xnn_qu8_igemm_minmax_rndnu_ukernel_4x8c4__aarch64_neondot_cortex_a55);

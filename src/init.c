...
static void init(void) {
  ...
  if (hardware_config->use_arm_neon) {
    /**************************** QC8 AArch32 micro-kernels ****************************/
      ...
      if (hardware_config->use_arm_neon_v8) {
        xnn_params.qc8.dwconv[0].minmax.unipass = (xnn_dwconv_unipass_ukernel_fn) xnn_qc8_dwconv_minmax_fp32_ukernel_3p16c__aarch32_neonv8_mla8_cortex_a35;
        ...
        if (hardware_config->use_arm_neon_fp16_arith) {
          ...
          xnn_params.f16.sqrt = (struct vunary_parameters) {
            ...
            xnn_params.f16.dwconv2d_chw_3x3 = (struct dwconv2d_chw_parameters) {
              ...
              .init.f16 = xnn_init_f16_chw_neonfp16arith_params,
              .update.f16 = xnn_update_f16_chw_neonfp16arith_params,
              .output_height_tile = 2,
              .output_width_tile = 8,
            };
    ...
    /**************************** F32 AArch32 micro-kernels ****************************/
      ...
      xnn_params.f32.vmulcaddc = (struct vmulcaddc_parameters) {
        ...
        xnn_params.f32.dwconv2d_chw_3x3 = (struct dwconv2d_chw_parameters) {
          ...
          .init.f32 = xnn_init_f32_chw_neon_params,
          .update.f32 = xnn_update_f32_chw_neon_params,
          .output_height_tile = 2,
          .output_width_tile = 4,
        };
    ...
    xnn_params.f32.vmulcaddc = (struct vmulcaddc_parameters) {
      ...
      if (hardware_config->use_x86_ssse3) {
        xnn_params.f32.dwconv2d_chw_3x3 = (struct dwconv2d_chw_parameters) {
          ...
          .init.f32 = xnn_init_f32_chw_sse_params,
          .update.f32 = xnn_update_f32_chw_sse_params,
          .output_height_tile = 2,
          .output_width_tile = 4,
        };
      } else {
    ...
    if (hardware_config->is_x86) {
      ...
      if (hardware_config->is_x86) {
        xnn_params.f32.dwconv2d_chw_3x3 = (struct dwconv2d_chw_parameters) {
          ...
          .init.f32 = xnn_init_f32_chw_wasmsimd_params,
          .update.f32 = xnn_update_f32_chw_wasmsimd_params,
          .output_height_tile = 2,
          .output_width_tile = 4,
        };
        xnn_params.f32.dwconv2d_chw_3x3s2 = (struct dwconv2d_chw_parameters) {

...
static void init(void) {
  ...
  /**************************** F32 micro-kernels ****************************/
      ...
      switch (cpuinfo_get_core(0)->uarch) {
        case cpuinfo_uarch_kryo:
          xnn_params.f32.gemm = (struct gemm_parameters) {
            ...
            .gemm_little = (xnn_gemm_ukernel_function) xnn_f32_gemm_ukernel_4x8__aarch64_neonfma_cortex_a53,
            .igemm_little = (xnn_igemm_ukernel_function) xnn_f32_igemm_ukernel_4x8__aarch64_neonfma_cortex_a53,
            .mr = 4,
            .nr = 8,
          };
          break;
        case cpuinfo_uarch_cortex_a57:
          xnn_params.f32.gemm = (struct gemm_parameters) {
            ...
            .gemm_little = (xnn_gemm_ukernel_function) xnn_f32_gemm_ukernel_6x8__aarch64_neonfma_cortex_a53,
            .igemm_little = (xnn_igemm_ukernel_function) xnn_f32_igemm_ukernel_6x8__aarch64_neonfma_cortex_a53,
            .mr = 6,
            .nr = 8,
          };
          break;
        case cpuinfo_uarch_cortex_a72:
        case cpuinfo_uarch_cortex_a76:  // TODO: use a55 kernel for little
          xnn_params.f32.gemm = (struct gemm_parameters) {
        ...
        case (cpuinfo_uarch_meerkat_m3 + 1):  // TODO: use a55 kernel for little
          xnn_params.f32.gemm = (struct gemm_parameters) {
        ...
        case cpuinfo_uarch_cortex_a55:
          xnn_params.f32.gemm = (struct gemm_parameters) {
            ...
            .gemm_little = (xnn_gemm_ukernel_function) xnn_f32_gemm_ukernel_4x12__aarch64_neonfma_cortex_a53,
            .igemm_little = (xnn_igemm_ukernel_function) xnn_f32_igemm_ukernel_4x12__aarch64_neonfma_cortex_a53,
            .mr = 4,
            .nr = 12,
          };
          break;
      ...
      xnn_params.f32.gemm = (struct gemm_parameters) {
        ...
        .gemm_little = (xnn_gemm_ukernel_function) xnn_f32_gemm_ukernel_6x8__neonfma_ld64,
        .igemm_little = (xnn_igemm_ukernel_function) xnn_f32_igemm_ukernel_6x8__neonfma_ld64,
        .mr = 6,
        .nr = 8,
      };
    #endif

...
void xnn_s32_vclz_ukernel__scalar_u1(
    size_t batch,
    const int32_t* input,
    int32_t* output,
...
void xnn_s32_vclz_ukernel__scalar_u2(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_vclz_ukernel__scalar_u4(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_vclz_ukernel__scalar_u8(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int32_t); batch -= 8 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_2 = xnn_clz_s32(vin_2);
    xnn_simd_s32_t vy_3 = xnn_clz_s32(vin_3);
    xnn_simd_s32_t vy_4 = xnn_clz_s32(vin_4);
    xnn_simd_s32_t vy_5 = xnn_clz_s32(vin_5);
    xnn_simd_s32_t vy_6 = xnn_clz_s32(vin_6);
    xnn_simd_s32_t vy_7 = xnn_clz_s32(vin_7);

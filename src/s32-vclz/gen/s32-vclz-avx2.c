...
//   Template: src/s32-vclz/s32-vclz.c.in
...
void xnn_s32_vclz_ukernel__avx2_u8(
    size_t batch,
    const int32_t* input,
    int32_t* output,
...
void xnn_s32_vclz_ukernel__avx2_u16(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_vclz_ukernel__avx2_u24(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 24 * sizeof(int32_t); batch -= 24 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_clz_s32(vin_0);
    xnn_simd_s32_t vy_1 = xnn_clz_s32(vin_1);
    xnn_simd_s32_t vy_2 = xnn_clz_s32(vin_2);
...
void xnn_s32_vclz_ukernel__avx2_u32(
    size_t batch,
    const int32_t* input,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_1 = xnn_clz_s32(vin_1);
    xnn_simd_s32_t vy_2 = xnn_clz_s32(vin_2);
    xnn_simd_s32_t vy_3 = xnn_clz_s32(vin_3);

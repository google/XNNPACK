...
void xnn_f16_dwconv_minmax_ukernel_9p32c__neonfp16arith(
    size_t channels,
    size_t output_width,
    ...
    const union xnn_f16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (size_t co = 0; co < channels; co += 480) {
    size_t channel_supertile = 480;
    ...
    do {
      ...
      const uint16_t* w = (const uint16_t*) weights + co * 10;
      for (; c >= 32; c -= 32) {

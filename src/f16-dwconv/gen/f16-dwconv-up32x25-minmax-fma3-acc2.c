    ...
    const union xnn_f16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 32; c -= 32) {
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi9x89ABCDEF, vk9x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi9xGHIJKLMN, vk9xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi9xOPQRSTUV, vk9xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi11x89ABCDEF, vk11x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi11xGHIJKLMN, vk11xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi11xOPQRSTUV, vk11xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi13x89ABCDEF, vk13x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi13xGHIJKLMN, vk13xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi13xOPQRSTUV, vk13xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi15x89ABCDEF, vk15x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi15xGHIJKLMN, vk15xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi15xOPQRSTUV, vk15xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi17x89ABCDEF, vk17x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi17xGHIJKLMN, vk17xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi17xOPQRSTUV, vk17xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi19x89ABCDEF, vk19x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi19xGHIJKLMN, vk19xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi19xOPQRSTUV, vk19xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi21x89ABCDEF, vk21x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi21xGHIJKLMN, vk21xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi21xOPQRSTUV, vk21xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
      ...
      vacc89ABCDEFp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi23x89ABCDEF, vk23x89ABCDEF, vacc89ABCDEFp1), _MM_FROUND_TO_NEAREST_INT));
      vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi23xGHIJKLMN, vk23xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
      vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi23xOPQRSTUV, vk23xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));

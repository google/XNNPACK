...
void xnn_f16_dwconv_minmax_ukernel_8f8m9l32c8s4r__fma3_acc2(
    size_t channels,
    size_t output_width,
  ...
  do {
    ...
    // First pass to process 8 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi5xGHIJKLMN, vk5xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
        vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi5xOPQRSTUV, vk5xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));
        ...
        vaccGHIJKLMNp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi7xGHIJKLMN, vk7xGHIJKLMN, vaccGHIJKLMNp1), _MM_FROUND_TO_NEAREST_INT));
        vaccOPQRSTUVp1 = _mm256_cvtph_ps(_mm256_cvtps_ph(_mm256_fmadd_ps(vi7xOPQRSTUV, vk7xOPQRSTUV, vaccOPQRSTUVp1), _MM_FROUND_TO_NEAREST_INT));

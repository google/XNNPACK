...
void xnn_f16_f32acc_dwconv_minmax_ukernel_25p16c__neonfp16_acc2(
    size_t channels,
    size_t output_width,
    ...
    const struct xnn_f16_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi9x89AB, vk9x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi9xCDEF = xnn_loadu_f16_f32(i9 + 12);
      const xnn_simd_f32_t vk9xCDEF = xnn_loadu_f16_f32(w + 172);
      vaccCDEFp1 = xnn_fmadd_f32(vi9xCDEF, vk9xCDEF, vaccCDEFp1);
      i9 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi11x89AB, vk11x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi11xCDEF = xnn_loadu_f16_f32(i11 + 12);
      const xnn_simd_f32_t vk11xCDEF = xnn_loadu_f16_f32(w + 204);
      vaccCDEFp1 = xnn_fmadd_f32(vi11xCDEF, vk11xCDEF, vaccCDEFp1);
      i11 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi13x89AB, vk13x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi13xCDEF = xnn_loadu_f16_f32(i13 + 12);
      const xnn_simd_f32_t vk13xCDEF = xnn_loadu_f16_f32(w + 236);
      vaccCDEFp1 = xnn_fmadd_f32(vi13xCDEF, vk13xCDEF, vaccCDEFp1);
      i13 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi15x89AB, vk15x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi15xCDEF = xnn_loadu_f16_f32(i15 + 12);
      const xnn_simd_f32_t vk15xCDEF = xnn_loadu_f16_f32(w + 268);
      vaccCDEFp1 = xnn_fmadd_f32(vi15xCDEF, vk15xCDEF, vaccCDEFp1);
      i15 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi17x89AB, vk17x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi17xCDEF = xnn_loadu_f16_f32(i17 + 12);
      const xnn_simd_f32_t vk17xCDEF = xnn_loadu_f16_f32(w + 300);
      vaccCDEFp1 = xnn_fmadd_f32(vi17xCDEF, vk17xCDEF, vaccCDEFp1);
      i17 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi19x89AB, vk19x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi19xCDEF = xnn_loadu_f16_f32(i19 + 12);
      const xnn_simd_f32_t vk19xCDEF = xnn_loadu_f16_f32(w + 332);
      vaccCDEFp1 = xnn_fmadd_f32(vi19xCDEF, vk19xCDEF, vaccCDEFp1);
      i19 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi21x89AB, vk21x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi21xCDEF = xnn_loadu_f16_f32(i21 + 12);
      const xnn_simd_f32_t vk21xCDEF = xnn_loadu_f16_f32(w + 364);
      vaccCDEFp1 = xnn_fmadd_f32(vi21xCDEF, vk21xCDEF, vaccCDEFp1);
      i21 += 16;
      ...
      vacc89ABp1 = xnn_fmadd_f32(vi23x89AB, vk23x89AB, vacc89ABp1);
      const xnn_simd_f32_t vi23xCDEF = xnn_loadu_f16_f32(i23 + 12);
      const xnn_simd_f32_t vk23xCDEF = xnn_loadu_f16_f32(w + 396);
      vaccCDEFp1 = xnn_fmadd_f32(vi23xCDEF, vk23xCDEF, vaccCDEFp1);
      i23 += 16;

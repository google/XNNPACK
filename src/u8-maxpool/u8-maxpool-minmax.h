...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon,
    xnn_u8_maxpool_minmax_ukernel_9p8x__neon_c16,
    /*channel_tile=*/16, /*channel_scaled_tile=*/16,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/64, /*qmax=*/192,
    xnn_init_u8_minmax_params_fn, xnn_init_u8_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(0,
    xnn_u8_maxpool_minmax_ukernel_9p8x__wasmsimd_c16,
    /*channel_tile=*/16, /*channel_scaled_tile=*/16,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/64, /*qmax=*/192,
    xnn_init_u8_minmax_params_fn, xnn_init_u8_minmax_scalar_params)

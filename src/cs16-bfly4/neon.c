    ...
    size_t stride)
{
  ...
  do {
    ...
    // First sample skips twiddle.
    {
      ...
      vout2 = vreinterpret_u32_s16(vsub_s16(vout0, vtmp3));
      vout0 = vreinterpret_u32_s16(vadd_s16(vout0, vtmp3));
      vout1 = vreinterpret_u32_s16(vadd_s16(vtmp5, vrev4));
      vout3 = vreinterpret_u32_s16(vsub_s16(vtmp5, vrev4));

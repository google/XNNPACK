...
void xnn_cs16_bfly4_ukernel__scalar_x4(
  ...
  for (; samples >= 4; samples -= 4) {
    ...
    int32_t vout0x3_r = (int32_t) out0[6];
    int32_t vout0x3_i = (int32_t) out0[7];
    ...
    int32_t vout1x3_r = (int32_t) out1[6];
    int32_t vout1x3_i = (int32_t) out1[7];
    ...
    int32_t vout2x3_r = (int32_t) out2[6];
    int32_t vout2x3_i = (int32_t) out2[7];
    ...
    int32_t vout3x3_r = (int32_t) out3[6];
    int32_t vout3x3_i = (int32_t) out3[7];
    ...
    tw1 += stride * 2;
    const int32_t tw1x3_r = (const int32_t) tw1[0];
    const int32_t tw1x3_i = (const int32_t) tw1[1];
    tw1 += stride * 2;
    ...
    tw2 += stride * 4;
    const int32_t tw2x3_r = (const int32_t) tw2[0];
    const int32_t tw2x3_i = (const int32_t) tw2[1];
    tw2 += stride * 4;
    ...
    tw3 += stride * 6;
    const int32_t tw3x3_r = (const int32_t) tw3[0];
    const int32_t tw3x3_i = (const int32_t) tw3[1];
    tw3 += stride * 6;
    ...
    vout0x3_r = math_asr_s32(vout0x3_r * 8191 + 16384, 15);
    vout0x3_i = math_asr_s32(vout0x3_i * 8191 + 16384, 15);
    ...
    vout1x3_r = math_asr_s32(vout1x3_r * 8191 + 16384, 15);
    vout1x3_i = math_asr_s32(vout1x3_i * 8191 + 16384, 15);
    ...
    vout2x3_r = math_asr_s32(vout2x3_r * 8191 + 16384, 15);
    vout2x3_i = math_asr_s32(vout2x3_i * 8191 + 16384, 15);
    ...
    vout3x3_r = math_asr_s32(vout3x3_r * 8191 + 16384, 15);
    vout3x3_i = math_asr_s32(vout3x3_i * 8191 + 16384, 15);
    ...
    const int32_t vtmp0x3_r = math_asr_s32(vout1x3_r * tw1x3_r - vout1x3_i * tw1x3_i + 16384, 15);
    const int32_t vtmp0x3_i = math_asr_s32(vout1x3_r * tw1x3_i + vout1x3_i * tw1x3_r + 16384, 15);
    ...
    const int32_t vtmp1x3_r = math_asr_s32(vout2x3_r * tw2x3_r - vout2x3_i * tw2x3_i + 16384, 15);
    const int32_t vtmp1x3_i = math_asr_s32(vout2x3_r * tw2x3_i + vout2x3_i * tw2x3_r + 16384, 15);
    ...
    const int32_t vtmp2x3_r = math_asr_s32(vout3x3_r * tw3x3_r - vout3x3_i * tw3x3_i + 16384, 15);
    const int32_t vtmp2x3_i = math_asr_s32(vout3x3_r * tw3x3_i + vout3x3_i * tw3x3_r + 16384, 15);
    ...
    const int32_t vtmp5x3_r = vout0x3_r - vtmp1x3_r;
    const int32_t vtmp5x3_i = vout0x3_i - vtmp1x3_i;
    vout0x0_r  += vtmp1x0_r;
    vout0x0_i  += vtmp1x0_i;
    vout0x1_r  += vtmp1x1_r;
    vout0x1_i  += vtmp1x1_i;
    ...
    const int32_t vtmp3x3_r = vtmp0x3_r + vtmp2x3_r;
    const int32_t vtmp3x3_i = vtmp0x3_i + vtmp2x3_i;
    ...
    const int32_t vtmp4x3_r = vtmp0x3_r - vtmp2x3_r;
    const int32_t vtmp4x3_i = vtmp0x3_i - vtmp2x3_i;
    ...
    vout2x3_r = vout0x3_r - vtmp3x3_r;
    vout2x3_i = vout0x3_i - vtmp3x3_i;
    vout0x0_r += vtmp3x0_r;
    vout0x0_i += vtmp3x0_i;
    vout0x1_r += vtmp3x1_r;
    vout0x1_i += vtmp3x1_i;
    ...
    vout1x3_r = vtmp5x3_r + vtmp4x3_i;
    vout1x3_i = vtmp5x3_i - vtmp4x3_r;
    ...
    vout3x3_r = vtmp5x3_r - vtmp4x3_i;
    vout3x3_i = vtmp5x3_i + vtmp4x3_r;
    ...
    out0[6] = (int16_t) vout0x3_r;
    out0[7] = (int16_t) vout0x3_i;
    out0 += 4 * 2;
    ...
    out1[6] = (int16_t) vout1x3_r;
    out1[7] = (int16_t) vout1x3_i;
    out1 += 4 * 2;
    ...
    out2[6] = (int16_t) vout2x3_r;
    out2[7] = (int16_t) vout2x3_i;
    out2 += 4 * 2;
    ...
    out3[6] = (int16_t) vout3x3_r;
    out3[7] = (int16_t) vout3x3_i;
    out3 += 4 * 2;
  }

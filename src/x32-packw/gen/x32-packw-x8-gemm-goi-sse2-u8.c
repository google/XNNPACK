...
void xnn_x32_packw_gemm_goi_ukernel_x8__sse2_u8(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (; n >= 8; n -= 8) {
      if XNN_LIKELY(b != NULL) {
        ...
        _mm_stream_ps(packed_w, vb0123);
        _mm_stream_ps(packed_w + 4, vb4567);
      } else {
      ...
      for (; k >= 8; k -= 8) {
        ...
        _mm_stream_ps(packed_w, v0123x0);
        _mm_stream_ps(packed_w + 4, v4567x0);
        _mm_stream_ps(packed_w + 8, v0123x1);
        _mm_stream_ps(packed_w + 12, v4567x1);
        _mm_stream_ps(packed_w + 16, v0123x2);
        _mm_stream_ps(packed_w + 20, v4567x2);
        _mm_stream_ps(packed_w + 24, v0123x3);
        _mm_stream_ps(packed_w + 28, v4567x3);
        _mm_stream_ps(packed_w + 32, v0123x4);
        _mm_stream_ps(packed_w + 36, v4567x4);
        _mm_stream_ps(packed_w + 40, v0123x5);
        _mm_stream_ps(packed_w + 44, v4567x5);
        _mm_stream_ps(packed_w + 48, v0123x6);
        _mm_stream_ps(packed_w + 52, v4567x6);
        _mm_stream_ps(packed_w + 56, v0123x7);
        _mm_stream_ps(packed_w + 60, v4567x7);
        packed_w += 64;
      }
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      for (; k >= 8; k -= 8) {
        ...
        const __m128 v45x4_45x5 = _mm_unpacklo_ps(v4x4567, v5x4567);
        const __m128 v67x4_67x5 = _mm_unpacklo_ps(v6x4567, v6x4567);
        const __m128 v45x6_45x7 = _mm_unpackhi_ps(v4x4567, v5x4567);
        const __m128 v67x6_67x7 = _mm_unpackhi_ps(v6x4567, v6x4567);
        const __m128 v0123x0 = _mm_movelh_ps(v01x0_01x1, v23x0_23x1);
        const __m128 v0123x1 = _mm_movehl_ps(v23x0_23x1, v01x0_01x1);
        const __m128 v0123x2 = _mm_movelh_ps(v01x2_01x3, v23x2_23x3);
        const __m128 v0123x3 = _mm_movehl_ps(v23x2_23x3, v01x2_01x3);

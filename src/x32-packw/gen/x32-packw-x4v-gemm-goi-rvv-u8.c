...
void xnn_x32_packw_gemm_goi_ukernel_x4v__rvv_u8(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (;n >= nr; n -= nr) {
      ...
      for (; k >= 8; k -= 8) {
        ...
        do {
          vuint32m1x8_t v_w_m1x8 = __riscv_vlsseg8e32_v_u32m1x8(w_ptr, n_stride_bytes, vlmax);
          w_ptr += n_stride * vlmax;
      ...
      for (; k >= 4; k -= 4) {
        ...
        size_t remaining_n = nr;
        do {
          vuint32m2x4_t v_w_m2x4 = __riscv_vlsseg4e32_v_u32m2x4(w_ptr, n_stride_bytes, vlmax);
          w_ptr += n_stride * vlmax;
      ...
      // Pack nr weights
      for (; k >= 1; k -= 1) {
        vuint32m4_t v_w = __riscv_vlse32_v_u32m4(w0, n_stride_bytes, vlmax);
        __riscv_vse32_v_u32m4(out0, v_w, vlmax);
        out0 += vlmax;
        w0 += 1;
      }
      out = (uint32_t*) ((uintptr_t) out0 + extra_bytes);
      w0 += (nr - 1) * n_stride + n_stride - kc;
    }
    ...
    if (n > 0) {
      ...
      for (; k >= 8; k -= 8) {
        ...
        do {
          ...
          vuint32m1x8_t v_w_m1x8 = __riscv_vlsseg8e32_v_u32m1x8(w_ptr, n_stride_bytes, vl);
          w_ptr += n_stride * vl;
          vuint32m1_t v_w0 = __riscv_vget_v_u32m1x8_u32m1(v_w_m1x8, 0);
      ...
      for (; k >= 4; k -= 4) {
        ...
        do {
          ...
          vuint32m2x4_t v_w_m2x4 = __riscv_vlsseg4e32_v_u32m2x4(w_ptr, n_stride_bytes, vl);
          w_ptr += n_stride * vl;
          vuint32m2_t v_w0 = __riscv_vget_v_u32m2x4_u32m2(v_w_m2x4, 0);
      ...
      // Pack n weights
      for (; k >= 1; k -= 1) {
        vuint32m4_t v_w = __riscv_vlse32_v_u32m4(w0, n_stride_bytes, vl);

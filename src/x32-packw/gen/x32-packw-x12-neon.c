  ...
  const void* params)
{
  ...
  uint32_t* zerobuf = (uint32_t*) alloca(kc * sizeof(uint32_t));
  memset(zerobuf, 0, kc * sizeof(uint32_t));
  ...
  do {
    ...
    do {
      ...
      n -= 12;
        ...
        w0 = w;
        w1 = (n > 1) ? (w0 + kc) : zerobuf;
        w2 = (n > 2) ? (w1 + kc) : zerobuf;
        w3 = (n > 3) ? (w2 + kc) : zerobuf;
        w4 = (n > 4) ? (w3 + kc) : zerobuf;
        w5 = (n > 5) ? (w4 + kc) : zerobuf;
        w6 = (n > 6) ? (w5 + kc) : zerobuf;
        w7 = (n > 7) ? (w6 + kc) : zerobuf;
        w8 = (n > 8) ? (w7 + kc) : zerobuf;
        w9 = (n > 9) ? (w8 + kc) : zerobuf;
        w10 = (n > 10) ? (w9 + kc) : zerobuf;
        w11 = (n > 11) ? (w10 + kc) : zerobuf;

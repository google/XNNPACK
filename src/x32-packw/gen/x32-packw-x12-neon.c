  ...
  do {
    ...
    if XNN_LIKELY(n >= 12) {
      do {
        ...
        // KC remainder
        // Same as main loop but ld1, ld2, ld3 or ld4
        if XNN_UNLIKELY(k != 0) {
          do {
            // KC remainder of 12x4
            if (k >= 4) {
              uint32x4x4_t v0;
              v0.val[0] = vdupq_n_u32(0);
              v0.val[1] = vdupq_n_u32(0);
              v0.val[2] = vdupq_n_u32(0);
              v0.val[3] = vdupq_n_u32(0);
              uint32x4x4_t v4;
              v4.val[0] = vdupq_n_u32(0);
              v4.val[1] = vdupq_n_u32(0);
              v4.val[2] = vdupq_n_u32(0);
              v4.val[3] = vdupq_n_u32(0);
              uint32x4x4_t v8;
              v8.val[0] = vdupq_n_u32(0);
              v8.val[1] = vdupq_n_u32(0);
              v8.val[2] = vdupq_n_u32(0);
              v8.val[3] = vdupq_n_u32(0);

              v0 = vld4q_lane_u32(w0, v0, 0);
              w0 += 4;
              v0 = vld4q_lane_u32(w1, v0, 1);
              w1 += 4;
              v0 = vld4q_lane_u32(w2, v0, 2);
              w2 += 4;
              v0 = vld4q_lane_u32(w3, v0, 3);
              w3 += 4;
              v4 = vld4q_lane_u32(w4, v4, 0);
              w4 += 4;
              v4 = vld4q_lane_u32(w5, v4, 1);
              w5 += 4;
              v4 = vld4q_lane_u32(w6, v4, 2);
              w6 += 4;
              v4 = vld4q_lane_u32(w7, v4, 3);
              w7 += 4;
              v8 = vld4q_lane_u32(w8, v8, 0);
              w8 += 4;
              v8 = vld4q_lane_u32(w9, v8, 1);
              w9 += 4;
              v8 = vld4q_lane_u32(w10, v8, 2);
              w10 += 4;
              v8 = vld4q_lane_u32(w11, v8, 3);
              w11 += 4;
              ...
              vst1q_u32(packed_weights + 36, v0.val[3]);
              vst1q_u32(packed_weights + 40, v4.val[3]);
              vst1q_u32(packed_weights + 44, v8.val[3]);
              packed_weights += 48;
              k -= 4;
            } else

...
void xnn_x32_packw_gemm_goi_ukernel_x8s4__neon_ld4lane_u8_prfm(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (; n >= 8; n -= 8) {
      ...
      for (; k >= 8; k -= 8) {
        ...
        vsrtmp = vtmp4567x0123.val[3];
        vtmp4567x0123.val[3] = vtmp4567x0123.val[2];
        vtmp4567x0123.val[2] = vtmp4567x0123.val[1];
        vtmp4567x0123.val[1] = vtmp4567x0123.val[0];
        vtmp4567x0123.val[0] = vsrtmp;
        ...
        vsrtmp = vtmp4567x4567.val[3];
        vtmp4567x4567.val[3] = vtmp4567x4567.val[2];
        vtmp4567x4567.val[2] = vtmp4567x4567.val[1];
        vtmp4567x4567.val[1] = vtmp4567x4567.val[0];
        vtmp4567x4567.val[0] = vsrtmp;

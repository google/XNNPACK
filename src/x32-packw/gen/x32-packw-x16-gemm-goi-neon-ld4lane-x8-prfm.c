...
void xnn_x32_packw_gemm_goi_ukernel_x16__neon_ld4lane_x8_prfm(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  const void* params)
{
  ...
  uint32x4x4_t vtmp4567x89AB;
  vtmp4567x89AB.val[0] = vdupq_n_u32(0);
  vtmp4567x89AB.val[1] = vdupq_n_u32(0);
  vtmp4567x89AB.val[2] = vdupq_n_u32(0);
  vtmp4567x89AB.val[3] = vdupq_n_u32(0);
  ...
  uint32x4x4_t vtmp4567xCDEF;
  vtmp4567xCDEF.val[0] = vdupq_n_u32(0);
  vtmp4567xCDEF.val[1] = vdupq_n_u32(0);
  vtmp4567xCDEF.val[2] = vdupq_n_u32(0);
  vtmp4567xCDEF.val[3] = vdupq_n_u32(0);
  ...
  do {
    ...
    for (; n >= 16; n -= 16) {
      ...
      for (; k >= 8; k -= 8) {
        ...
        vtmp4567x89AB = vld4q_lane_u32(w8, vtmp4567x89AB, 0); w8 += 4;
        vtmp4567x89AB = vld4q_lane_u32(w9, vtmp4567x89AB, 1); w9 += 4;
        vtmp4567x89AB = vld4q_lane_u32(w10, vtmp4567x89AB, 2); w10 += 4;
        vtmp4567x89AB = vld4q_lane_u32(w11, vtmp4567x89AB, 3); w11 += 4;
        vtmp4567xCDEF = vld4q_lane_u32(w12, vtmp4567xCDEF, 0); w12 += 4;
        vtmp4567xCDEF = vld4q_lane_u32(w13, vtmp4567xCDEF, 1); w13 += 4;
        vtmp4567xCDEF = vld4q_lane_u32(w14, vtmp4567xCDEF, 2); w14 += 4;
        vtmp4567xCDEF = vld4q_lane_u32(w15, vtmp4567xCDEF, 3); w15 += 4;
        ...
        vst1q_u32(packed_weights, vtmp4567x89AB.val[0]); packed_weights += 4;
        vst1q_u32(packed_weights, vtmp4567xCDEF.val[0]); packed_weights += 4;
        ...
        vst1q_u32(packed_weights, vtmp4567x89AB.val[1]); packed_weights += 4;
        vst1q_u32(packed_weights, vtmp4567xCDEF.val[1]); packed_weights += 4;
        ...
        vst1q_u32(packed_weights, vtmp4567x89AB.val[2]); packed_weights += 4;
        vst1q_u32(packed_weights, vtmp4567xCDEF.val[2]); packed_weights += 4;
        ...
        vst1q_u32(packed_weights, vtmp4567x89AB.val[3]); packed_weights += 4;
        vst1q_u32(packed_weights, vtmp4567xCDEF.val[3]); packed_weights += 4;
      }

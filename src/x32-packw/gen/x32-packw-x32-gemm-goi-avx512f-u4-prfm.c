  ...
  const void* params)
{
  ...
  do {
    ...
    for (; n >= 32; n -= 32) {
      ...
      xnn_prefetch_to_l1((const int8_t*) (w20 + stride1));
      xnn_prefetch_to_l1((const int8_t*) (w20 + stride2));
      xnn_prefetch_to_l1((const int8_t*) (w20 + stride3));
      ...
      xnn_prefetch_to_l1((const int8_t*) (w28 + stride1));
      xnn_prefetch_to_l1((const int8_t*) (w28 + stride2));
      xnn_prefetch_to_l1((const int8_t*) (w28 + stride3));
      ...
      for (; k >= 4; k -= 4) {
        ...
        xnn_prefetch_to_l1((const int8_t*) (w16 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w16 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w16 + stride3) + 128);
        xnn_prefetch_to_l1((const int8_t*) w20 + 128);
        xnn_prefetch_to_l1((const int8_t*) (w20 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w20 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w20 + stride3) + 128);
        xnn_prefetch_to_l1((const int8_t*) w24 + 128);
        xnn_prefetch_to_l1((const int8_t*) (w24 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w24 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w24 + stride3) + 128);
        xnn_prefetch_to_l1((const int8_t*) w28 + 128);
        xnn_prefetch_to_l1((const int8_t*) (w28 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w28 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w28 + stride3) + 128);

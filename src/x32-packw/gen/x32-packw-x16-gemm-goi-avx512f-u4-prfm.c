  ...
  const void* params)
{
  ...
  do {
    ...
    for (; n >= 16; n -= 16) {
      ...
      xnn_prefetch_to_l1((const int8_t*) (w4 + stride1));
      xnn_prefetch_to_l1((const int8_t*) (w4 + stride2));
      xnn_prefetch_to_l1((const int8_t*) (w4 + stride3));
      ...
      xnn_prefetch_to_l1((const int8_t*) (w12 + stride1));
      xnn_prefetch_to_l1((const int8_t*) (w12 + stride2));
      xnn_prefetch_to_l1((const int8_t*) (w12 + stride3));
      ...
      for (; k >= 4; k -= 4) {
        ...
        xnn_prefetch_to_l1((const int8_t*) (w0 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w0 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w0 + stride3) + 128);
        xnn_prefetch_to_l1((const int8_t*) w4 + 128);
        xnn_prefetch_to_l1((const int8_t*) (w4 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w4 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w4 + stride3) + 128);
        xnn_prefetch_to_l1((const int8_t*) w8 + 128);
        xnn_prefetch_to_l1((const int8_t*) (w8 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w8 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w8 + stride3) + 128);
        xnn_prefetch_to_l1((const int8_t*) w12 + 128);
        xnn_prefetch_to_l1((const int8_t*) (w12 + stride1) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w12 + stride2) + 128);
        xnn_prefetch_to_l1((const int8_t*) (w12 + stride3) + 128);

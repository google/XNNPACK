...
void xnn_f32_rminmaxsum_ukernel__rvv_u4v(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  vfloat32m4_t t2 = __riscv_vmv_v_v_f32m4(t0, vl);
  ...
  for (avl = N - vl; avl; avl -= vl, input += vl) {
    ...
    t2 = __riscv_vfadd_vv_f32m4_tu(t2, t2, vec, vl);
  }
  ...
  output[2] = __riscv_vfmv_f_s_f32m1_f32(__riscv_vfredosum_vs_f32m4_f32m1(t2, fsum, N));
}

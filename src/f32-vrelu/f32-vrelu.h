...
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrelu_ukernel__sse_u4, 4, false, float, struct xnn_f32_relu_params, NULL)
...
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrelu_ukernel__wasm_u1, 1, false, float, struct xnn_f32_relu_params, NULL)
...
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrelu_ukernel__wasm32_shr_u1, 1, false, float, struct xnn_f32_relu_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrelu_ukernel__wasm32_shr_u2, 2, false, float, struct xnn_f32_relu_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrelu_ukernel__wasm32_shr_u4, 4, false, float, struct xnn_f32_relu_params, NULL)

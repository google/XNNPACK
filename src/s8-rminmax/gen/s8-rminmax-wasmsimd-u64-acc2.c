...
void xnn_s8_rminmax_ukernel__wasmsimd_u64_acc2(
    size_t batch,
    const int8_t* input,
    int8_t* output,
    const void* params)
{
  ...
  for (; batch >= 64 * sizeof(int8_t); batch -= 64 * sizeof(int8_t)) {
    ...
    input += 4 * xnn_simd_size_s8;

    vmin0 = xnn_min_s8(vmin0, vt0);
    vmax0 = xnn_max_s8(vmax0, vt0);
    vmin1 = xnn_min_s8(vmin1, vt1);
    vmax1 = xnn_max_s8(vmax1, vt1);
    vmin0 = xnn_min_s8(vmin0, vt2);
    vmax0 = xnn_max_s8(vmax0, vt2);
    vmin1 = xnn_min_s8(vmin1, vt3);
    vmax1 = xnn_max_s8(vmax1, vt3);
  }

...
void xnn_qs8_to_qu8_qc4uw_packw_gemm_goi_ukernel_x8c8__sse2(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (; n >= 8; n -= 8) {
      ...
      for (; k >= 16; k -= 16) {
        ...
        vout0 = _mm_xor_si128(vout0, vxor_mask_out);
        ...
        vout1 = _mm_xor_si128(vout1, vxor_mask_out);
        ...
        vout2 = _mm_xor_si128(vout2, vxor_mask_out);
        ...
        vout3 = _mm_xor_si128(vout3, vxor_mask_out);
        ...
        vout4 = _mm_xor_si128(vout4, vxor_mask_out);
        ...
        vout5 = _mm_xor_si128(vout5, vxor_mask_out);
        ...
        vout6 = _mm_xor_si128(vout6, vxor_mask_out);
        ...
        vout7 = _mm_xor_si128(vout7, vxor_mask_out);
      ...
      int32_t ksum0 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc0, 4);
      ...
      int32_t ksum1 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc1, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));
      ...
      int32_t ksum2 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc2, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));
      ...
      int32_t ksum3 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc3, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));
      ...
      int32_t ksum4 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc4, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));
      ...
      int32_t ksum5 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc5, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));
      ...
      int32_t ksum6 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc6, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));
      ...
      int32_t ksum7 = 0;
      {
        __m128i vsum = _mm_srai_epi32(vacc7, 4);
        __m128i sum2 = _mm_add_epi32(vsum, _mm_srli_si128(vsum, 8));
        __m128i sum1 = _mm_add_epi32(sum2, _mm_srli_si128(sum2, 4));

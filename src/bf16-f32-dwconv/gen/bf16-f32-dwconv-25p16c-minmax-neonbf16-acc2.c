...
// Apple M2 and later).
void xnn_bf16_f32_dwconv_minmax_ukernel_25p16c__neonbf16_acc2(
    size_t channels,
    size_t output_width,
    ...
    const struct xnn_f32_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      float32x4_t vacc8ep1 = vbfmlalbq_f32(vdupq_n_f32(0.0f), vi1x8, vk1x8);
      float32x4_t vacc8op1 = vbfmlaltq_f32(vdupq_n_f32(0.0f), vi1x8, vk1x8);
      ...
      const bfloat16x8_t vi3x8 = vreinterpretq_bf16_u16(vld1q_u16(i3 + 8));
      i3 += 16;

      const bfloat16x8_t vk3x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 48));
      const bfloat16x8_t vk3x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 56));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi3x0, vk3x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi3x0, vk3x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi3x8, vk3x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi3x8, vk3x8);

      const bfloat16x8_t vi4x0 = vreinterpretq_bf16_u16(vld1q_u16(i4 + 0));
      const bfloat16x8_t vi4x8 = vreinterpretq_bf16_u16(vld1q_u16(i4 + 8));
      i4 += 16;

      const bfloat16x8_t vk4x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 64));
      const bfloat16x8_t vk4x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 72));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi4x0, vk4x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi4x0, vk4x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi4x8, vk4x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi4x8, vk4x8);

      const bfloat16x8_t vi5x0 = vreinterpretq_bf16_u16(vld1q_u16(i5 + 0));
      const bfloat16x8_t vi5x8 = vreinterpretq_bf16_u16(vld1q_u16(i5 + 8));
      i5 += 16;

      const bfloat16x8_t vk5x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 80));
      const bfloat16x8_t vk5x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 88));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi5x0, vk5x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi5x0, vk5x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi5x8, vk5x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi5x8, vk5x8);

      const bfloat16x8_t vi6x0 = vreinterpretq_bf16_u16(vld1q_u16(i6 + 0));
      const bfloat16x8_t vi6x8 = vreinterpretq_bf16_u16(vld1q_u16(i6 + 8));
      i6 += 16;

      const bfloat16x8_t vk6x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 96));
      const bfloat16x8_t vk6x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 104));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi6x0, vk6x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi6x0, vk6x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi6x8, vk6x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi6x8, vk6x8);

      const bfloat16x8_t vi7x0 = vreinterpretq_bf16_u16(vld1q_u16(i7 + 0));
      const bfloat16x8_t vi7x8 = vreinterpretq_bf16_u16(vld1q_u16(i7 + 8));
      i7 += 16;

      const bfloat16x8_t vk7x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 112));
      const bfloat16x8_t vk7x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 120));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi7x0, vk7x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi7x0, vk7x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi7x8, vk7x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi7x8, vk7x8);

      const bfloat16x8_t vi8x0 = vreinterpretq_bf16_u16(vld1q_u16(i8 + 0));
      const bfloat16x8_t vi8x8 = vreinterpretq_bf16_u16(vld1q_u16(i8 + 8));
      i8 += 16;

      const bfloat16x8_t vk8x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 128));
      const bfloat16x8_t vk8x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 136));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi8x0, vk8x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi8x0, vk8x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi8x8, vk8x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi8x8, vk8x8);

      const bfloat16x8_t vi9x0 = vreinterpretq_bf16_u16(vld1q_u16(i9 + 0));
      const bfloat16x8_t vi9x8 = vreinterpretq_bf16_u16(vld1q_u16(i9 + 8));
      i9 += 16;

      const bfloat16x8_t vk9x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 144));
      const bfloat16x8_t vk9x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 152));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi9x0, vk9x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi9x0, vk9x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi9x8, vk9x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi9x8, vk9x8);

      const bfloat16x8_t vi10x0 = vreinterpretq_bf16_u16(vld1q_u16(i10 + 0));
      const bfloat16x8_t vi10x8 = vreinterpretq_bf16_u16(vld1q_u16(i10 + 8));
      i10 += 16;

      const bfloat16x8_t vk10x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 160));
      const bfloat16x8_t vk10x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 168));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi10x0, vk10x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi10x0, vk10x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi10x8, vk10x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi10x8, vk10x8);

      const bfloat16x8_t vi11x0 = vreinterpretq_bf16_u16(vld1q_u16(i11 + 0));
      const bfloat16x8_t vi11x8 = vreinterpretq_bf16_u16(vld1q_u16(i11 + 8));
      i11 += 16;

      const bfloat16x8_t vk11x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 176));
      const bfloat16x8_t vk11x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 184));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi11x0, vk11x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi11x0, vk11x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi11x8, vk11x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi11x8, vk11x8);

      const bfloat16x8_t vi12x0 = vreinterpretq_bf16_u16(vld1q_u16(i12 + 0));
      const bfloat16x8_t vi12x8 = vreinterpretq_bf16_u16(vld1q_u16(i12 + 8));
      i12 += 16;

      const bfloat16x8_t vk12x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 192));
      const bfloat16x8_t vk12x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 200));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi12x0, vk12x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi12x0, vk12x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi12x8, vk12x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi12x8, vk12x8);

      const bfloat16x8_t vi13x0 = vreinterpretq_bf16_u16(vld1q_u16(i13 + 0));
      const bfloat16x8_t vi13x8 = vreinterpretq_bf16_u16(vld1q_u16(i13 + 8));
      i13 += 16;

      const bfloat16x8_t vk13x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 208));
      const bfloat16x8_t vk13x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 216));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi13x0, vk13x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi13x0, vk13x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi13x8, vk13x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi13x8, vk13x8);

      const bfloat16x8_t vi14x0 = vreinterpretq_bf16_u16(vld1q_u16(i14 + 0));
      const bfloat16x8_t vi14x8 = vreinterpretq_bf16_u16(vld1q_u16(i14 + 8));
      i14 += 16;

      const bfloat16x8_t vk14x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 224));
      const bfloat16x8_t vk14x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 232));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi14x0, vk14x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi14x0, vk14x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi14x8, vk14x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi14x8, vk14x8);

      const bfloat16x8_t vi15x0 = vreinterpretq_bf16_u16(vld1q_u16(i15 + 0));
      const bfloat16x8_t vi15x8 = vreinterpretq_bf16_u16(vld1q_u16(i15 + 8));
      i15 += 16;

      const bfloat16x8_t vk15x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 240));
      const bfloat16x8_t vk15x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 248));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi15x0, vk15x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi15x0, vk15x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi15x8, vk15x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi15x8, vk15x8);

      const bfloat16x8_t vi16x0 = vreinterpretq_bf16_u16(vld1q_u16(i16 + 0));
      const bfloat16x8_t vi16x8 = vreinterpretq_bf16_u16(vld1q_u16(i16 + 8));
      i16 += 16;

      const bfloat16x8_t vk16x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 256));
      const bfloat16x8_t vk16x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 264));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi16x0, vk16x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi16x0, vk16x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi16x8, vk16x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi16x8, vk16x8);

      const bfloat16x8_t vi17x0 = vreinterpretq_bf16_u16(vld1q_u16(i17 + 0));
      const bfloat16x8_t vi17x8 = vreinterpretq_bf16_u16(vld1q_u16(i17 + 8));
      i17 += 16;

      const bfloat16x8_t vk17x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 272));
      const bfloat16x8_t vk17x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 280));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi17x0, vk17x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi17x0, vk17x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi17x8, vk17x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi17x8, vk17x8);

      const bfloat16x8_t vi18x0 = vreinterpretq_bf16_u16(vld1q_u16(i18 + 0));
      const bfloat16x8_t vi18x8 = vreinterpretq_bf16_u16(vld1q_u16(i18 + 8));
      i18 += 16;

      const bfloat16x8_t vk18x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 288));
      const bfloat16x8_t vk18x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 296));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi18x0, vk18x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi18x0, vk18x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi18x8, vk18x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi18x8, vk18x8);

      const bfloat16x8_t vi19x0 = vreinterpretq_bf16_u16(vld1q_u16(i19 + 0));
      const bfloat16x8_t vi19x8 = vreinterpretq_bf16_u16(vld1q_u16(i19 + 8));
      i19 += 16;

      const bfloat16x8_t vk19x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 304));
      const bfloat16x8_t vk19x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 312));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi19x0, vk19x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi19x0, vk19x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi19x8, vk19x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi19x8, vk19x8);

      const bfloat16x8_t vi20x0 = vreinterpretq_bf16_u16(vld1q_u16(i20 + 0));
      const bfloat16x8_t vi20x8 = vreinterpretq_bf16_u16(vld1q_u16(i20 + 8));
      i20 += 16;

      const bfloat16x8_t vk20x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 320));
      const bfloat16x8_t vk20x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 328));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi20x0, vk20x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi20x0, vk20x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi20x8, vk20x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi20x8, vk20x8);

      const bfloat16x8_t vi21x0 = vreinterpretq_bf16_u16(vld1q_u16(i21 + 0));
      const bfloat16x8_t vi21x8 = vreinterpretq_bf16_u16(vld1q_u16(i21 + 8));
      i21 += 16;

      const bfloat16x8_t vk21x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 336));
      const bfloat16x8_t vk21x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 344));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi21x0, vk21x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi21x0, vk21x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi21x8, vk21x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi21x8, vk21x8);

      const bfloat16x8_t vi22x0 = vreinterpretq_bf16_u16(vld1q_u16(i22 + 0));
      const bfloat16x8_t vi22x8 = vreinterpretq_bf16_u16(vld1q_u16(i22 + 8));
      i22 += 16;

      const bfloat16x8_t vk22x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 352));
      const bfloat16x8_t vk22x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 360));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi22x0, vk22x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi22x0, vk22x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi22x8, vk22x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi22x8, vk22x8);

      const bfloat16x8_t vi23x0 = vreinterpretq_bf16_u16(vld1q_u16(i23 + 0));
      const bfloat16x8_t vi23x8 = vreinterpretq_bf16_u16(vld1q_u16(i23 + 8));
      i23 += 16;

      const bfloat16x8_t vk23x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 368));
      const bfloat16x8_t vk23x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 376));
      vacc0ep1 = vbfmlalbq_f32(vacc0ep1, vi23x0, vk23x0);
      vacc0op1 = vbfmlaltq_f32(vacc0op1, vi23x0, vk23x0);
      vacc8ep1 = vbfmlalbq_f32(vacc8ep1, vi23x8, vk23x8);
      vacc8op1 = vbfmlaltq_f32(vacc8op1, vi23x8, vk23x8);

      const bfloat16x8_t vi24x0 = vreinterpretq_bf16_u16(vld1q_u16(i24 + 0));
      const bfloat16x8_t vi24x8 = vreinterpretq_bf16_u16(vld1q_u16(i24 + 8));
      i24 += 16;

      const bfloat16x8_t vk24x0 = vreinterpretq_bf16_u16(vld1q_u16(wk + 384));
      const bfloat16x8_t vk24x8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 392));
      vacc0ep0 = vbfmlalbq_f32(vacc0ep0, vi24x0, vk24x0);
      vacc0op0 = vbfmlaltq_f32(vacc0op0, vi24x0, vk24x0);
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi24x8, vk24x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi24x8, vk24x8);

      wb = (const float*) (wk + 400);

      vacc0ep0 = vaddq_f32(vacc0ep0, vacc0ep1);
      vacc0op0 = vaddq_f32(vacc0op0, vacc0op1);
      vacc8ep0 = vaddq_f32(vacc8ep0, vacc8ep1);
      vacc8op0 = vaddq_f32(vacc8op0, vacc8op1);
    ...
    if XNN_UNLIKELY(c != 0) {
      ...
      do {
        ...
        i3 += 8;
        const bfloat16x8_t vk3 = vreinterpretq_bf16_u16(vld1q_u16(wk + 48));
        ...
        i4 += 8;
        const bfloat16x8_t vk4 = vreinterpretq_bf16_u16(vld1q_u16(wk + 64));
        ...
        i5 += 8;
        const bfloat16x8_t vk5 = vreinterpretq_bf16_u16(vld1q_u16(wk + 80));
        ...
        i6 += 8;
        const bfloat16x8_t vk6 = vreinterpretq_bf16_u16(vld1q_u16(wk + 96));
        ...
        i7 += 8;
        const bfloat16x8_t vk7 = vreinterpretq_bf16_u16(vld1q_u16(wk + 112));
        ...
        i8 += 8;
        const bfloat16x8_t vk8 = vreinterpretq_bf16_u16(vld1q_u16(wk + 128));
        ...
        i9 += 8;
        const bfloat16x8_t vk9 = vreinterpretq_bf16_u16(vld1q_u16(wk + 144));
        ...
        i10 += 8;
        const bfloat16x8_t vk10 = vreinterpretq_bf16_u16(vld1q_u16(wk + 160));
        ...
        i11 += 8;
        const bfloat16x8_t vk11 = vreinterpretq_bf16_u16(vld1q_u16(wk + 176));
        ...
        i12 += 8;
        const bfloat16x8_t vk12 = vreinterpretq_bf16_u16(vld1q_u16(wk + 192));
        ...
        i13 += 8;
        const bfloat16x8_t vk13 = vreinterpretq_bf16_u16(vld1q_u16(wk + 208));
        ...
        i14 += 8;
        const bfloat16x8_t vk14 = vreinterpretq_bf16_u16(vld1q_u16(wk + 224));
        ...
        i15 += 8;
        const bfloat16x8_t vk15 = vreinterpretq_bf16_u16(vld1q_u16(wk + 240));
        ...
        i16 += 8;
        const bfloat16x8_t vk16 = vreinterpretq_bf16_u16(vld1q_u16(wk + 256));
        ...
        i17 += 8;
        const bfloat16x8_t vk17 = vreinterpretq_bf16_u16(vld1q_u16(wk + 272));
        ...
        i18 += 8;
        const bfloat16x8_t vk18 = vreinterpretq_bf16_u16(vld1q_u16(wk + 288));
        ...
        i19 += 8;
        const bfloat16x8_t vk19 = vreinterpretq_bf16_u16(vld1q_u16(wk + 304));
        ...
        i20 += 8;
        const bfloat16x8_t vk20 = vreinterpretq_bf16_u16(vld1q_u16(wk + 320));
        ...
        i21 += 8;
        const bfloat16x8_t vk21 = vreinterpretq_bf16_u16(vld1q_u16(wk + 336));
        ...
        i22 += 8;
        const bfloat16x8_t vk22 = vreinterpretq_bf16_u16(vld1q_u16(wk + 352));
        ...
        i23 += 8;
        const bfloat16x8_t vk23 = vreinterpretq_bf16_u16(vld1q_u16(wk + 368));
        ...
        i24 += 8;
        const bfloat16x8_t vk24 = vreinterpretq_bf16_u16(vld1q_u16(wk + 384));

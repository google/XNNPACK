...
//   float bias[32];
//   uint16_t kernel[9][32];  // bf16
void xnn_bf16_f32_dwconv_minmax_ukernel_9p32c__avx512skx(
    size_t channels,
    size_t output_width,
    ...
    const struct xnn_f32_minmax_params* restrict params)
{
  ...
  do {
    ...
    for (; c >= 32; c -= 32) {
      ...
      vacc16p0 = _mm512_fmadd_ps(vi3x16, vk3x16, vacc16p0);
      ...
      vacc16p0 = _mm512_fmadd_ps(vi5x16, vk5x16, vacc16p0);
      ...
      vacc16p0 = _mm512_fmadd_ps(vi7x16, vk7x16, vacc16p0);

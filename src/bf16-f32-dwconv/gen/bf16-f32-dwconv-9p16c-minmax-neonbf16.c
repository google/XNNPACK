...
// Apple M2 and later).
void xnn_bf16_f32_dwconv_minmax_ukernel_9p16c__neonbf16(
    size_t channels,
    size_t output_width,
    ...
    const struct xnn_f32_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi5x8, vk5x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi5x8, vk5x8);
      ...
      vacc8ep0 = vbfmlalbq_f32(vacc8ep0, vi7x8, vk7x8);
      vacc8op0 = vbfmlaltq_f32(vacc8op0, vi7x8, vk7x8);

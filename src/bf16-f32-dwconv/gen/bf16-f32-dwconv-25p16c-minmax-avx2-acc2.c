...
void xnn_bf16_f32_dwconv_minmax_ukernel_25p16c__avx2_acc2(
    size_t channels,
    size_t output_width,
    ...
    const struct xnn_f32_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      __m256 vacc8p1 = _mm256_mul_ps(vi1x8, vk1x8);
      ...
      vacc8p1 = _mm256_fmadd_ps(vi3x8, vk3x8, vacc8p1);
      ...
      vacc8p1 = _mm256_fmadd_ps(vi5x8, vk5x8, vacc8p1);
      ...
      vacc8p1 = _mm256_fmadd_ps(vi7x8, vk7x8, vacc8p1);
      ...
      const __m256 vi9x8 = load_bf16_as_f32(i9 + 8);
      i9 += 16;

      const __m256 vk9x0 = load_bf16_as_f32(wk + 144);
      const __m256 vk9x8 = load_bf16_as_f32(wk + 152);
      vacc0p1 = _mm256_fmadd_ps(vi9x0, vk9x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi9x8, vk9x8, vacc8p1);

      const __m256 vi10x0 = load_bf16_as_f32(i10 + 0);
      const __m256 vi10x8 = load_bf16_as_f32(i10 + 8);
      i10 += 16;

      const __m256 vk10x0 = load_bf16_as_f32(wk + 160);
      const __m256 vk10x8 = load_bf16_as_f32(wk + 168);
      vacc0p0 = _mm256_fmadd_ps(vi10x0, vk10x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi10x8, vk10x8, vacc8p0);

      const __m256 vi11x0 = load_bf16_as_f32(i11 + 0);
      const __m256 vi11x8 = load_bf16_as_f32(i11 + 8);
      i11 += 16;

      const __m256 vk11x0 = load_bf16_as_f32(wk + 176);
      const __m256 vk11x8 = load_bf16_as_f32(wk + 184);
      vacc0p1 = _mm256_fmadd_ps(vi11x0, vk11x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi11x8, vk11x8, vacc8p1);

      const __m256 vi12x0 = load_bf16_as_f32(i12 + 0);
      const __m256 vi12x8 = load_bf16_as_f32(i12 + 8);
      i12 += 16;

      const __m256 vk12x0 = load_bf16_as_f32(wk + 192);
      const __m256 vk12x8 = load_bf16_as_f32(wk + 200);
      vacc0p0 = _mm256_fmadd_ps(vi12x0, vk12x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi12x8, vk12x8, vacc8p0);

      const __m256 vi13x0 = load_bf16_as_f32(i13 + 0);
      const __m256 vi13x8 = load_bf16_as_f32(i13 + 8);
      i13 += 16;

      const __m256 vk13x0 = load_bf16_as_f32(wk + 208);
      const __m256 vk13x8 = load_bf16_as_f32(wk + 216);
      vacc0p1 = _mm256_fmadd_ps(vi13x0, vk13x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi13x8, vk13x8, vacc8p1);

      const __m256 vi14x0 = load_bf16_as_f32(i14 + 0);
      const __m256 vi14x8 = load_bf16_as_f32(i14 + 8);
      i14 += 16;

      const __m256 vk14x0 = load_bf16_as_f32(wk + 224);
      const __m256 vk14x8 = load_bf16_as_f32(wk + 232);
      vacc0p0 = _mm256_fmadd_ps(vi14x0, vk14x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi14x8, vk14x8, vacc8p0);

      const __m256 vi15x0 = load_bf16_as_f32(i15 + 0);
      const __m256 vi15x8 = load_bf16_as_f32(i15 + 8);
      i15 += 16;

      const __m256 vk15x0 = load_bf16_as_f32(wk + 240);
      const __m256 vk15x8 = load_bf16_as_f32(wk + 248);
      vacc0p1 = _mm256_fmadd_ps(vi15x0, vk15x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi15x8, vk15x8, vacc8p1);

      const __m256 vi16x0 = load_bf16_as_f32(i16 + 0);
      const __m256 vi16x8 = load_bf16_as_f32(i16 + 8);
      i16 += 16;

      const __m256 vk16x0 = load_bf16_as_f32(wk + 256);
      const __m256 vk16x8 = load_bf16_as_f32(wk + 264);
      vacc0p0 = _mm256_fmadd_ps(vi16x0, vk16x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi16x8, vk16x8, vacc8p0);

      const __m256 vi17x0 = load_bf16_as_f32(i17 + 0);
      const __m256 vi17x8 = load_bf16_as_f32(i17 + 8);
      i17 += 16;

      const __m256 vk17x0 = load_bf16_as_f32(wk + 272);
      const __m256 vk17x8 = load_bf16_as_f32(wk + 280);
      vacc0p1 = _mm256_fmadd_ps(vi17x0, vk17x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi17x8, vk17x8, vacc8p1);

      const __m256 vi18x0 = load_bf16_as_f32(i18 + 0);
      const __m256 vi18x8 = load_bf16_as_f32(i18 + 8);
      i18 += 16;

      const __m256 vk18x0 = load_bf16_as_f32(wk + 288);
      const __m256 vk18x8 = load_bf16_as_f32(wk + 296);
      vacc0p0 = _mm256_fmadd_ps(vi18x0, vk18x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi18x8, vk18x8, vacc8p0);

      const __m256 vi19x0 = load_bf16_as_f32(i19 + 0);
      const __m256 vi19x8 = load_bf16_as_f32(i19 + 8);
      i19 += 16;

      const __m256 vk19x0 = load_bf16_as_f32(wk + 304);
      const __m256 vk19x8 = load_bf16_as_f32(wk + 312);
      vacc0p1 = _mm256_fmadd_ps(vi19x0, vk19x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi19x8, vk19x8, vacc8p1);

      const __m256 vi20x0 = load_bf16_as_f32(i20 + 0);
      const __m256 vi20x8 = load_bf16_as_f32(i20 + 8);
      i20 += 16;

      const __m256 vk20x0 = load_bf16_as_f32(wk + 320);
      const __m256 vk20x8 = load_bf16_as_f32(wk + 328);
      vacc0p0 = _mm256_fmadd_ps(vi20x0, vk20x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi20x8, vk20x8, vacc8p0);

      const __m256 vi21x0 = load_bf16_as_f32(i21 + 0);
      const __m256 vi21x8 = load_bf16_as_f32(i21 + 8);
      i21 += 16;

      const __m256 vk21x0 = load_bf16_as_f32(wk + 336);
      const __m256 vk21x8 = load_bf16_as_f32(wk + 344);
      vacc0p1 = _mm256_fmadd_ps(vi21x0, vk21x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi21x8, vk21x8, vacc8p1);

      const __m256 vi22x0 = load_bf16_as_f32(i22 + 0);
      const __m256 vi22x8 = load_bf16_as_f32(i22 + 8);
      i22 += 16;

      const __m256 vk22x0 = load_bf16_as_f32(wk + 352);
      const __m256 vk22x8 = load_bf16_as_f32(wk + 360);
      vacc0p0 = _mm256_fmadd_ps(vi22x0, vk22x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi22x8, vk22x8, vacc8p0);

      const __m256 vi23x0 = load_bf16_as_f32(i23 + 0);
      const __m256 vi23x8 = load_bf16_as_f32(i23 + 8);
      i23 += 16;

      const __m256 vk23x0 = load_bf16_as_f32(wk + 368);
      const __m256 vk23x8 = load_bf16_as_f32(wk + 376);
      vacc0p1 = _mm256_fmadd_ps(vi23x0, vk23x0, vacc0p1);
      vacc8p1 = _mm256_fmadd_ps(vi23x8, vk23x8, vacc8p1);

      const __m256 vi24x0 = load_bf16_as_f32(i24 + 0);
      const __m256 vi24x8 = load_bf16_as_f32(i24 + 8);
      i24 += 16;

      const __m256 vk24x0 = load_bf16_as_f32(wk + 384);
      const __m256 vk24x8 = load_bf16_as_f32(wk + 392);
      vacc0p0 = _mm256_fmadd_ps(vi24x0, vk24x0, vacc0p0);
      vacc8p0 = _mm256_fmadd_ps(vi24x8, vk24x8, vacc8p0);

      wb = (const float*) (wk + 400);

      vacc0p0 = _mm256_add_ps(vacc0p0, vacc0p1);
      vacc8p0 = _mm256_add_ps(vacc8p0, vacc8p1);

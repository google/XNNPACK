...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon_fp16_arith, xnn_f16_vlrelu_ukernel__neonfp16arith_u8, 8, false, uint16_t, xnn_f16_lrelu_params, xnn_init_f16_lrelu_fp16arith_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon_fp16_arith, xnn_f16_vlrelu_ukernel__neonfp16arith_u16, 16, false, uint16_t, xnn_f16_lrelu_params, xnn_init_f16_lrelu_fp16arith_params)

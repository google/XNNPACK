    ...
    const struct xnn_f32_qu8_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  const vfloat32m1_t magic_bias_f32v = __riscv_vfmv_v_f_f32m1(12582912.0f, __riscv_vsetvl_e32m1(batch));
  ...
  for (; batch > 0; ) {
    ...
    y_i32v = __riscv_vmax_vx_i32m1(y_i32v, output_min, n);
    y_i32v = __riscv_vmin_vx_i32m1(y_i32v, output_max, n);

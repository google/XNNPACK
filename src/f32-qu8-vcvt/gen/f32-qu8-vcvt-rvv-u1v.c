    ...
    const union xnn_f32_qu8_cvt_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const vfloat32m1_t magic_bias_f32v = __riscv_vfmv_v_f_f32m1(params->rvv.magic_bias, __riscv_vsetvl_e32m1(batch));
  ...
  for (; batch > 0; ) {
    ...
    x_f32v = __riscv_vfmadd_vf_f32m1(x_f32v, scale, magic_bias_f32v, n);

    vint32m1_t y_i32v = __riscv_vreinterpret_v_f32m1_i32m1(x_f32v);
    y_i32v = __riscv_vmax_vx_i32m1(y_i32v, magic_min, n);
    y_i32v = __riscv_vmin_vx_i32m1(y_i32v, magic_max, n);
    y_i32v = __riscv_vssub_vx_i32m1(y_i32v, magic_bias_less_zero_point, n);

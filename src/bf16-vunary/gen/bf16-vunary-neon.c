...
static XNN_INTRINSIC float32x4_t load_bf16_as_f32(const uint16_t* input) {
  return vreinterpretq_f32_u32(vshll_n_u16(vld1_u16(input), 16));
}
...
static XNN_INTRINSIC void store_f32_as_bf16(uint16_t* output, float32x4_t value) {
  vst1_u16(output, convert_f32_to_bf16(value));
}

static XNN_INTRINSIC void store_tail_f32_as_bf16(

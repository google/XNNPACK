...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon,
    ...
    /*qmin=*/-64, /*qmax=*/64,
    xnn_init_s8_minmax_params_fn, xnn_init_s8_minmax_scalar_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon,
    xnn_s8_maxpool_minmax_ukernel_4p3x__neon_c16,
    /*channel_tile=*/16, /*channel_scaled_tile=*/16,
...
XNN_UKERNEL_WITH_PARAMS(0,
    xnn_s8_maxpool_minmax_ukernel_9p8x__sse2_c16,
    /*channel_tile=*/16, /*channel_scaled_tile=*/16,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-64, /*qmax=*/64,
    xnn_init_s8_minmax_params_fn, xnn_init_s8_minmax_scalar_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_sse4_1,
    xnn_s8_maxpool_minmax_ukernel_9p8x__sse41_c16,
    /*channel_tile=*/16, /*channel_scaled_tile=*/16,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-64, /*qmax=*/64,
    xnn_init_s8_minmax_params_fn, xnn_init_s8_minmax_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(0,
    xnn_s8_maxpool_minmax_ukernel_9p8x__wasmsimd_c16,
    /*channel_tile=*/16, /*channel_scaled_tile=*/16,
    /*primary_tile=*/9, /*incremental_tile=*/8,
    /*qmin=*/-64, /*qmax=*/64,
    xnn_init_s8_minmax_params_fn, xnn_init_s8_minmax_scalar_params)

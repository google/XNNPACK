...
//   Template: src/f16-f32acc-rsum2/rvv.c.in
...
void xnn_f16_f32acc_rsum2_ukernel__rvvfp16arith_u2v(
    size_t batch,
    ...
    const struct xnn_f16_f32acc_scale_params* restrict params)
{
  ...
  vfloat32m4_t vsum2 = __riscv_vfmv_v_f_f32m4(0.f, vlmax);

  do {
    size_t vl = __riscv_vsetvl_e16m2(batch); batch -= vl;

    vfloat16m2_t vinput = __riscv_vle16_v_f16m2(input, vl); input += vl;

    vsum2 = __riscv_vfwmacc(vsum2, vinput, vinput, vl);

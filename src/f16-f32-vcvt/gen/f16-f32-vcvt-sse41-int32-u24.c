...
void xnn_f16_f32_vcvt_ukernel__sse41_int32_u24(
    size_t batch,
    const void* input,
    float* output,
    const void* params) XNN_OOB_READS
{
  ...
  const __m128i vmagic_bias = _mm_set1_epi32(0x3F000000);
  const __m128i vdenorm_cutoff = _mm_set1_epi32(0x08000000);

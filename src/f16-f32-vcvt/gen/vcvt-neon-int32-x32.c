...
void xnn_f16_f32_vcvt_ukernel__neon_int32_x32(
    size_t n,
    const void* input,
    float* output,
    const void* params)
{
  ...
  for (; n >= 32 * sizeof(float); n -= 32 * sizeof(float)) {
    ...
    const float32x4_t vdenorm6 = vsubq_f32(vreinterpretq_f32_u32(vsriq_n_u32(vmagic_mask, vnonsign6, 16)), vmagic_bias);
    const float32x4_t vdenorm7 = vsubq_f32(vreinterpretq_f32_u32(vsriq_n_u32(vmagic_mask, vnonsign7, 16)), vmagic_bias);

...
void xnn_f16_f32_vcvt_ukernel__wasmrelaxedsimd_int16_u32(
    size_t batch,
    const void* input,
    float* output,
    const void* params) XNN_OOB_READS
{
  ...
  for (; batch >= 32 * sizeof(uint16_t); batch -= 32 * sizeof(uint16_t)) {
    ...
    const v128_t vabsf6 = wasm_i32x4_relaxed_laneselect(vnorm6, vdenorm6, vxmask6);
    const v128_t vsignf6 = wasm_v16x8_shuffle(vzero, vsign3, 0,  8, 1,  9, 2, 10, 3, 11);
    const v128_t vabsf7 = wasm_i32x4_relaxed_laneselect(vnorm7, vdenorm7, vxmask7);

    ...
    const void* params)
{
  ...
  for (; n >= 32 * sizeof(float); n -= 32 * sizeof(float)) {
    ...
    const float32x4_t vdenorm4 = vsubq_f32(vreinterpretq_f32_u32(vaddw_u16(vmagic_mask, vget_low_u16(vnonsign2))), vmagic_bias);
    const float32x4_t vdenorm5 = vsubq_f32(vreinterpretq_f32_u32(vaddw_u16(vmagic_mask, vget_high_u16(vnonsign2))), vmagic_bias);
    const float32x4_t vdenorm6 = vsubq_f32(vreinterpretq_f32_u32(vaddw_u16(vmagic_mask, vget_low_u16(vnonsign3))), vmagic_bias);
    const float32x4_t vdenorm7 = vsubq_f32(vreinterpretq_f32_u32(vaddw_u16(vmagic_mask, vget_high_u16(vnonsign3))), vmagic_bias);

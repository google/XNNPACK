    ...
    const union xnn_f32_output_params params[restrict static 1])
{
  ...
  do {
    ...
    for (; c >= 8 * sizeof(float); c -= 8 * sizeof(float)) {
      ...
      const int32x4_t vm0x4567 = vcltq_s32(vreinterpretq_s32_f32(vi0x4567), vmovq_n_s32(0));
      ...
      const int32x4_t vm1x4567 = vcltq_s32(vreinterpretq_s32_f32(vi1x4567), vmovq_n_s32(0));

      vacc0x0123 = vbslq_f32(vreinterpretq_u32_s32(vm0x0123), vacc0x0123, vi0x0123);
      vacc0x4567 = vbslq_f32(vreinterpretq_u32_s32(vm0x4567), vacc0x4567, vi0x4567);
      vacc1x0123 = vbslq_f32(vreinterpretq_u32_s32(vm1x0123), vacc1x0123, vi1x0123);
      vacc1x4567 = vbslq_f32(vreinterpretq_u32_s32(vm1x4567), vacc1x4567, vi1x4567);

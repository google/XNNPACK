    ...
    size_t output_stride) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c > 0;) {
      ...
      vbool32_t mask0_f32v = __riscv_vmflt_vf_f32m1_b32(in0_f32v, zero, n);
      vbool32_t mask1_f32v = __riscv_vmflt_vf_f32m1_b32(in1_f32v, zero, n);
      vbool32_t mask2_f32v = __riscv_vmflt_vf_f32m1_b32(in2_f32v, zero, n);
      vbool32_t mask3_f32v = __riscv_vmflt_vf_f32m1_b32(in3_f32v, zero, n);

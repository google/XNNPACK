...
void xnn_f32_prelu_ukernel__psimd_2x8(
    size_t rows,
    size_t channels,
    ...
    size_t output_stride)
{
  ...
  do {
    ...
    for (; c >= 8 * sizeof(float); c -= 8 * sizeof(float)) {
      ...
      const psimd_f32 vw4567 = psimd_load_f32(w + 4);
      w += 8;
      ...
      psimd_f32 vacc0x4567 = psimd_mul_f32(vi0x4567, vw4567);
      psimd_f32 vacc1x0123 = psimd_mul_f32(vi1x0123, vw0123);
      psimd_f32 vacc1x4567 = psimd_mul_f32(vi1x4567, vw4567);

      vacc0x0123 = psimd_signblend_f32(vi0x0123, vacc0x0123, vi0x0123);
      vacc0x4567 = psimd_signblend_f32(vi0x4567, vacc0x4567, vi0x4567);

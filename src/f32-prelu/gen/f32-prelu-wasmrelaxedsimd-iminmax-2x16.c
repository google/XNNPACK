    ...
    size_t output_stride) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16 * sizeof(float); c -= 16 * sizeof(float)) {
      ...
      vacc0x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc0x0123, vi0x0123, vw0123);
      vacc0x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc0x4567, vi0x4567, vw4567);
      vacc0x89AB = __builtin_wasm_relaxed_madd_f32x4(vacc0x89AB, vi0x89AB, vw89AB);
      vacc0xCDEF = __builtin_wasm_relaxed_madd_f32x4(vacc0xCDEF, vi0xCDEF, vwCDEF);
      vacc1x0123 = __builtin_wasm_relaxed_madd_f32x4(vacc1x0123, vi1x0123, vw0123);
      vacc1x4567 = __builtin_wasm_relaxed_madd_f32x4(vacc1x4567, vi1x4567, vw4567);
      vacc1x89AB = __builtin_wasm_relaxed_madd_f32x4(vacc1x89AB, vi1x89AB, vw89AB);
      vacc1xCDEF = __builtin_wasm_relaxed_madd_f32x4(vacc1xCDEF, vi1xCDEF, vwCDEF);

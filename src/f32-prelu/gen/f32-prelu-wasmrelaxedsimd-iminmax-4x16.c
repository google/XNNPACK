    ...
    size_t output_stride) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16 * sizeof(float); c -= 16 * sizeof(float)) {
      ...
      vacc2x89AB = __builtin_wasm_relaxed_madd_f32x4(vacc2x89AB, vi2x89AB, vw89AB);
      vacc2xCDEF = __builtin_wasm_relaxed_madd_f32x4(vacc2xCDEF, vi2xCDEF, vwCDEF);
      ...
      vacc3x89AB = __builtin_wasm_relaxed_madd_f32x4(vacc3x89AB, vi3x89AB, vw89AB);
      vacc3xCDEF = __builtin_wasm_relaxed_madd_f32x4(vacc3xCDEF, vi3xCDEF, vwCDEF);

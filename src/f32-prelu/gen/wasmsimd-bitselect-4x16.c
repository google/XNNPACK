...
void xnn_f32_prelu_ukernel__wasmsimd_bitselect_4x16(
    size_t rows,
    size_t channels,
    ...
    size_t output_stride) XNN_DISABLE_TSAN
{
  ...
  do {
    ...
    for (; c >= 16 * sizeof(float); c -= 16 * sizeof(float)) {
      ...
      const v128_t vmask1x4567 = wasm_i32x4_lt(vi1x4567, vzero);
      v128_t vacc1x89AB = wasm_f32x4_mul(vi1x89AB, vw89AB);
      const v128_t vmask1x89AB = wasm_i32x4_lt(vi1x89AB, vzero);
      v128_t vacc1xCDEF = wasm_f32x4_mul(vi1xCDEF, vwCDEF);
      const v128_t vmask1xCDEF = wasm_i32x4_lt(vi1xCDEF, vzero);
      ...
      const v128_t vmask2x4567 = wasm_i32x4_lt(vi2x4567, vzero);
      v128_t vacc2x89AB = wasm_f32x4_mul(vi2x89AB, vw89AB);
      const v128_t vmask2x89AB = wasm_i32x4_lt(vi2x89AB, vzero);
      v128_t vacc2xCDEF = wasm_f32x4_mul(vi2xCDEF, vwCDEF);
      const v128_t vmask2xCDEF = wasm_i32x4_lt(vi2xCDEF, vzero);
      ...
      const v128_t vmask3x4567 = wasm_i32x4_lt(vi3x4567, vzero);
      v128_t vacc3x89AB = wasm_f32x4_mul(vi3x89AB, vw89AB);
      const v128_t vmask3x89AB = wasm_i32x4_lt(vi3x89AB, vzero);
      v128_t vacc3xCDEF = wasm_f32x4_mul(vi3xCDEF, vwCDEF);
      const v128_t vmask3xCDEF = wasm_i32x4_lt(vi3xCDEF, vzero);

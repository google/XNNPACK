...
void xnn_qu8_dwconv_minmax_fp32_ukernel_6f6m7l16c8s8r__wasmsimd_mul16(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 6 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        v128_t vk5x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 16 * sizeof(int32_t) + 80 * sizeof(uint8_t)));
        const v128_t vi5x89ABCDEF = wasm_u16x8_load8x8(i5 + 8);
        v128_t vk5x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 16 * sizeof(int32_t) + 88 * sizeof(uint8_t)));
    ...
    for (size_t ks = kernel_size - 6; ks > 7; ks -= 6) {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const v128_t vi5x01234567 = wasm_u16x8_load8x8(i5);
        v128_t vk5x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 80 * sizeof(uint8_t)));
        const v128_t vi5x89ABCDEF = wasm_u16x8_load8x8(i5 + 8);
        v128_t vk5x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 88 * sizeof(uint8_t)));
        vsumx01234567 = wasm_i16x8_add(vsumx01234567, vi5x01234567);
        vsumx89ABCDEF = wasm_i16x8_add(vsumx89ABCDEF, vi5x89ABCDEF);
        i5 += 16;
    ...
    // Last pass to process up to 7 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        v128_t vk6x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 96 * sizeof(uint8_t)));
        const v128_t vi6x89ABCDEF = wasm_u16x8_load8x8(i6 + 8);
        v128_t vk6x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 104 * sizeof(uint8_t)));

    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (size_t co = 0; co < channels; co += 352) {
    ...
    do {
      ...
      input_co = (const uint8_t**) ((uintptr_t) input_co + input_stride);
      ...
      for (; c >= 32; c -= 32) {
        ...
        vst1q_u8(o, vout0123456789ABCDEF); o += 16;
        vst1q_u8(o, voutGHIJKLMNOPQRSTUV); o += 16;
      }
      if XNN_UNLIKELY(c != 0) {
        ...
        do {
          ...
          if XNN_LIKELY(c >= 8) {
            vst1_u8(o, vout01234567); o += 8;
            c -= 8;
          } else {
            if (c & 4) {
              vst1_lane_u32((void*) o, vreinterpret_u32_u8(vout01234567), 0); o += 4;
              vout01234567 = vext_u8(vout01234567, vout01234567, 4);
            }
            if (c & 2) {
              vst1_lane_u16((void*) o, vreinterpret_u16_u8(vout01234567), 0); o += 2;
              vout01234567 = vext_u8(vout01234567, vout01234567, 2);
            }
            if (c & 1) {
              vst1_lane_u8(o, vout01234567, 0); o += 1;
            }
            c = 0;
          }
        } while (c != 0);

...
void xnn_qu8_dwconv_minmax_fp32_ukernel_6f6m7l32c8s8r__avx2_mul32(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 6 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 32 * sizeof(int32_t) + 192 * sizeof(uint8_t));
    ...
    for (size_t ks = kernel_size - 6; ks > 7; ks -= 6) {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 192 * sizeof(uint8_t));
    ...
    // Last pass to process up to 7 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 224 * sizeof(uint8_t));
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          w = (void*) ((uintptr_t) w + 56 * sizeof(uint8_t));

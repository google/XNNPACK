...
void xnn_qu8_dwconv_minmax_fp32_ukernel_8f8m9l16c8s8r__sse2_mul16(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 8 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const __m128i vxk0x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk0x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxk1x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk1x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxk2x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk2x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxk3x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk3x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxk4x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk4x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxk5x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk5x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxk6x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk6x89ABCDEF, vzero), vk_zero_point);
        ...
        const __m128i vxi7x89ABCDEF = _mm_unpacklo_epi8(vi7x89ABCDEF, vzero);
        const __m128i vxk7x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk7x89ABCDEF, vzero), vk_zero_point);
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const __m128i vi0x01234567 = _mm_loadl_epi64((const __m128i*) i0);
          const __m128i vk0x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 * sizeof(uint8_t)));
          i0 += 8;
          ...
          const __m128i vi1x01234567 = _mm_loadl_epi64((const __m128i*) i1);
          const __m128i vk1x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 8 * sizeof(uint8_t)));
          i1 += 8;
          ...
          const __m128i vi2x01234567 = _mm_loadl_epi64((const __m128i*) i2);
          const __m128i vk2x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 16 * sizeof(uint8_t)));
          i2 += 8;
          ...
          const __m128i vi3x01234567 = _mm_loadl_epi64((const __m128i*) i3);
          const __m128i vk3x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 24 * sizeof(uint8_t)));
          i3 += 8;
          ...
          const __m128i vi4x01234567 = _mm_loadl_epi64((const __m128i*) i4);
          const __m128i vk4x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 32 * sizeof(uint8_t)));
          i4 += 8;
          ...
          const __m128i vi5x01234567 = _mm_loadl_epi64((const __m128i*) i5);
          const __m128i vk5x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 40 * sizeof(uint8_t)));
          i5 += 8;
          ...
          const __m128i vi6x01234567 = _mm_loadl_epi64((const __m128i*) i6);
          const __m128i vk6x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 48 * sizeof(uint8_t)));
          i6 += 8;
          ...
          const __m128i vi7x01234567 = _mm_loadl_epi64((const __m128i*) i7);
          const __m128i vk7x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + sizeof(int32_t) * 8 + 56 * sizeof(uint8_t)));
          i7 += 8;
    ...
    for (size_t ks = kernel_size - 8; ks > 9; ks -= 8) {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const __m128i vi0x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i0 + 8));
        const __m128i vk0x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 8 * sizeof(uint8_t)));
        i0 += 16;
        ...
        const __m128i vi1x01234567 = _mm_loadl_epi64((const __m128i*) i1);
        const __m128i vk1x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 16 * sizeof(uint8_t)));
        const __m128i vi1x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i1 + 8));
        const __m128i vk1x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 24 * sizeof(uint8_t)));
        i1 += 16;
        ...
        const __m128i vi2x01234567 = _mm_loadl_epi64((const __m128i*) i2);
        const __m128i vk2x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 32 * sizeof(uint8_t)));
        const __m128i vi2x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i2 + 8));
        const __m128i vk2x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 40 * sizeof(uint8_t)));
        i2 += 16;
        ...
        const __m128i vi3x01234567 = _mm_loadl_epi64((const __m128i*) i3);
        const __m128i vk3x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 48 * sizeof(uint8_t)));
        const __m128i vi3x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i3 + 8));
        const __m128i vk3x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 56 * sizeof(uint8_t)));
        i3 += 16;
        ...
        const __m128i vi4x01234567 = _mm_loadl_epi64((const __m128i*) i4);
        const __m128i vk4x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 64 * sizeof(uint8_t)));
        const __m128i vi4x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i4 + 8));
        const __m128i vk4x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 72 * sizeof(uint8_t)));
        i4 += 16;
        ...
        const __m128i vi5x01234567 = _mm_loadl_epi64((const __m128i*) i5);
        const __m128i vk5x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 80 * sizeof(uint8_t)));
        const __m128i vi5x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i5 + 8));
        const __m128i vk5x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 88 * sizeof(uint8_t)));
        i5 += 16;
        ...
        const __m128i vi6x01234567 = _mm_loadl_epi64((const __m128i*) i6);
        const __m128i vk6x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 96 * sizeof(uint8_t)));
        const __m128i vi6x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i6 + 8));
        const __m128i vk6x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 104 * sizeof(uint8_t)));
        i6 += 16;
        ...
        const __m128i vi7x01234567 = _mm_loadl_epi64((const __m128i*) i7);
        const __m128i vk7x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 112 * sizeof(uint8_t)));
        const __m128i vi7x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i7 + 8));
        const __m128i vk7x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 120 * sizeof(uint8_t)));
        i7 += 16;
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const __m128i vi5x01234567 = _mm_loadl_epi64((const __m128i*) i5);
          const __m128i vk5x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 40 * sizeof(uint8_t)));
          i5 += 8;
          ...
          const __m128i vi6x01234567 = _mm_loadl_epi64((const __m128i*) i6);
          const __m128i vk6x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 48 * sizeof(uint8_t)));
          i6 += 8;
          ...
          const __m128i vi7x01234567 = _mm_loadl_epi64((const __m128i*) i7);
          const __m128i vk7x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 56 * sizeof(uint8_t)));
          i7 += 8;
    ...
    // Last pass to process up to 9 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const __m128i vk8x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 128 * sizeof(uint8_t)));
        const __m128i vi8x89ABCDEF = _mm_loadl_epi64((const __m128i*) (i8 + 8));
        const __m128i vk8x89ABCDEF = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 136 * sizeof(uint8_t)));
        i8 += 16;
        ...
        const __m128i vxi8x89ABCDEF = _mm_unpacklo_epi8(vi8x89ABCDEF, vzero);
        const __m128i vxk8x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk8x89ABCDEF, vzero), vk_zero_point);
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const __m128i vi8x01234567 = _mm_loadl_epi64((const __m128i*) i8);
          const __m128i vk8x01234567 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 64 * sizeof(uint8_t)));
          i8 += 8;

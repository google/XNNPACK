...
void xnn_qu8_dwconv_minmax_fp32_ukernel_25p16c__sse2_mul16(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      const __m128i vxi9x89ABCDEF = _mm_unpacklo_epi8(vi9x89ABCDEF, vzero);
      const __m128i vxk9x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk9x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi10x89ABCDEF = _mm_unpacklo_epi8(vi10x89ABCDEF, vzero);
      const __m128i vxk10x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk10x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi11x89ABCDEF = _mm_unpacklo_epi8(vi11x89ABCDEF, vzero);
      const __m128i vxk11x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk11x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi12x89ABCDEF = _mm_unpacklo_epi8(vi12x89ABCDEF, vzero);
      const __m128i vxk12x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk12x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi13x89ABCDEF = _mm_unpacklo_epi8(vi13x89ABCDEF, vzero);
      const __m128i vxk13x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk13x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi14x89ABCDEF = _mm_unpacklo_epi8(vi14x89ABCDEF, vzero);
      const __m128i vxk14x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk14x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi15x89ABCDEF = _mm_unpacklo_epi8(vi15x89ABCDEF, vzero);
      const __m128i vxk15x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk15x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi16x89ABCDEF = _mm_unpacklo_epi8(vi16x89ABCDEF, vzero);
      const __m128i vxk16x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk16x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi17x89ABCDEF = _mm_unpacklo_epi8(vi17x89ABCDEF, vzero);
      const __m128i vxk17x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk17x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi18x89ABCDEF = _mm_unpacklo_epi8(vi18x89ABCDEF, vzero);
      const __m128i vxk18x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk18x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi19x89ABCDEF = _mm_unpacklo_epi8(vi19x89ABCDEF, vzero);
      const __m128i vxk19x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk19x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi20x89ABCDEF = _mm_unpacklo_epi8(vi20x89ABCDEF, vzero);
      const __m128i vxk20x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk20x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi21x89ABCDEF = _mm_unpacklo_epi8(vi21x89ABCDEF, vzero);
      const __m128i vxk21x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk21x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi22x89ABCDEF = _mm_unpacklo_epi8(vi22x89ABCDEF, vzero);
      const __m128i vxk22x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk22x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi23x89ABCDEF = _mm_unpacklo_epi8(vi23x89ABCDEF, vzero);
      const __m128i vxk23x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk23x89ABCDEF, vzero), vk_zero_point);
      ...
      const __m128i vxi24x89ABCDEF = _mm_unpacklo_epi8(vi24x89ABCDEF, vzero);
      const __m128i vxk24x89ABCDEF = _mm_sub_epi16(_mm_unpacklo_epi8(vk24x89ABCDEF, vzero), vk_zero_point);

...
void xnn_qu8_dwconv_minmax_fp32_ukernel_8f8m9l4c1s1r__scalar_fmagic(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    for (size_t ks = kernel_size - 8; ks > 9; ks -= 8) {
      ...
      for (; c >= 4; c -= 4) {
        ...
        const int32_t vk7x0 = (int32_t) (uint32_t) ((const uint8_t*) w)[28] - vkernel_zero_point;
        const int32_t vk7x1 = (int32_t) (uint32_t) ((const uint8_t*) w)[29] - vkernel_zero_point;
        const int32_t vk7x2 = (int32_t) (uint32_t) ((const uint8_t*) w)[30] - vkernel_zero_point;
        const int32_t vk7x3 = (int32_t) (uint32_t) ((const uint8_t*) w)[31] - vkernel_zero_point;
    ...
    // Last pass to process up to 9 inputs.
    {
      ...
      for (; c >= 4; c -= 4) {
        ...
        const int32_t vk8x0 = (int32_t) (uint32_t) ((const uint8_t*) w)[32] - vkernel_zero_point;
        const int32_t vk8x1 = (int32_t) (uint32_t) ((const uint8_t*) w)[33] - vkernel_zero_point;
        const int32_t vk8x2 = (int32_t) (uint32_t) ((const uint8_t*) w)[34] - vkernel_zero_point;
        const int32_t vk8x3 = (int32_t) (uint32_t) ((const uint8_t*) w)[35] - vkernel_zero_point;
        ...
        w = (const void*) ((uintptr_t) w + 36 * sizeof(uint8_t));

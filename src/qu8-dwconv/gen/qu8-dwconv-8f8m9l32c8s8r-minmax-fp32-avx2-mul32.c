...
void xnn_qu8_dwconv_minmax_fp32_ukernel_8f8m9l32c8s8r__avx2_mul32(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 8 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        w = (const void*) ((uintptr_t) w + 32 * sizeof(int32_t) + 256 * sizeof(uint8_t));
    ...
    for (size_t ks = kernel_size - 8; ks > 9; ks -= 8) {
      ...
      for (; c >= 32; c -= 32) {
        ...
        const __m256i vi5x01234567 = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) i5));
        const __m256i vk5x01234567 = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 160 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi5x89ABCDEF = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i5 + 8)));
        const __m256i vk5x89ABCDEF = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 168 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi5xGHIJKLMN = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i5 + 16)));
        const __m256i vk5xGHIJKLMN = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 176 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi5xOPQRSTUV = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i5 + 24)));
        const __m256i vk5xOPQRSTUV = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 184 * sizeof(uint8_t)))), vk_zero_point);
        i5 += 32;
        ...
        const __m256i vi6x01234567 = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) i6));
        const __m256i vk6x01234567 = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 192 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi6x89ABCDEF = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i6 + 8)));
        const __m256i vk6x89ABCDEF = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 200 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi6xGHIJKLMN = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i6 + 16)));
        const __m256i vk6xGHIJKLMN = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 208 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi6xOPQRSTUV = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i6 + 24)));
        const __m256i vk6xOPQRSTUV = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 216 * sizeof(uint8_t)))), vk_zero_point);
        i6 += 32;
        ...
        const __m256i vi7x01234567 = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) i7));
        const __m256i vk7x01234567 = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 224 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi7x89ABCDEF = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i7 + 8)));
        const __m256i vk7x89ABCDEF = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 232 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi7xGHIJKLMN = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i7 + 16)));
        const __m256i vk7xGHIJKLMN = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 240 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi7xOPQRSTUV = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i7 + 24)));
        const __m256i vk7xOPQRSTUV = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 248 * sizeof(uint8_t)))), vk_zero_point);
        i7 += 32;
        ...
        w = (const void*) ((uintptr_t) w + 256 * sizeof(uint8_t));
    ...
    // Last pass to process up to 9 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        const __m256i vk8x01234567 = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 256 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi8x89ABCDEF = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i8 + 8)));
        const __m256i vk8x89ABCDEF = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 264 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi8xGHIJKLMN = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i8 + 16)));
        const __m256i vk8xGHIJKLMN = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 272 * sizeof(uint8_t)))), vk_zero_point);
        const __m256i vi8xOPQRSTUV = _mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) (i8 + 24)));
        const __m256i vk8xOPQRSTUV = _mm256_sub_epi32(_mm256_cvtepu8_epi32(_mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 280 * sizeof(uint8_t)))), vk_zero_point);
        i8 += 32;
        ...
        w = (const void*) ((uintptr_t) w + 288 * sizeof(uint8_t));

...
void xnn_qu8_dwconv_minmax_fp32_ukernel_8f8m9l16c8s8r__wasmsimd_mul16(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 8 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        v128_t vk6x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 16 * sizeof(int32_t) + 96 * sizeof(uint8_t)));
        const v128_t vi6x89ABCDEF = wasm_u16x8_load8x8(i6 + 8);
        v128_t vk6x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 16 * sizeof(int32_t) + 104 * sizeof(uint8_t)));
        ...
        v128_t vk7x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 16 * sizeof(int32_t) + 112 * sizeof(uint8_t)));
        const v128_t vi7x89ABCDEF = wasm_u16x8_load8x8(i7 + 8);
        v128_t vk7x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 16 * sizeof(int32_t) + 120 * sizeof(uint8_t)));
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const v128_t vi6x01234567 = wasm_u16x8_load8x8(i6);
          v128_t vk6x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 8 * sizeof(int32_t) + 48 * sizeof(uint8_t)));
          vsumx01234567 = wasm_i16x8_add(vsumx01234567, vi6x01234567);
          i6 += 8;
          ...
          const v128_t vi7x01234567 = wasm_u16x8_load8x8(i7);
          v128_t vk7x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 8 * sizeof(int32_t) + 56 * sizeof(uint8_t)));
          vsumx01234567 = wasm_i16x8_add(vsumx01234567, vi7x01234567);
          i7 += 8;
    ...
    for (size_t ks = kernel_size - 8; ks > 9; ks -= 8) {
      ...
      for (; c >= 16; c -= 16) {
        ...
        const v128_t vi7x01234567 = wasm_u16x8_load8x8(i7);
        v128_t vk7x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 112 * sizeof(uint8_t)));
        const v128_t vi7x89ABCDEF = wasm_u16x8_load8x8(i7 + 8);
        v128_t vk7x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 120 * sizeof(uint8_t)));
        vsumx01234567 = wasm_i16x8_add(vsumx01234567, vi7x01234567);
        vsumx89ABCDEF = wasm_i16x8_add(vsumx89ABCDEF, vi7x89ABCDEF);
        i7 += 16;
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const v128_t vi7x01234567 = wasm_u16x8_load8x8(i7);
          v128_t vk7x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 56 * sizeof(uint8_t)));
          vsumx01234567 = wasm_i16x8_add(vsumx01234567, vi7x01234567);
          i7 += 8;
    ...
    // Last pass to process up to 9 inputs.
    {
      ...
      for (; c >= 16; c -= 16) {
        ...
        v128_t vk8x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 128 * sizeof(uint8_t)));
        const v128_t vi8x89ABCDEF = wasm_u16x8_load8x8(i8 + 8);
        v128_t vk8x89ABCDEF = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 136 * sizeof(uint8_t)));
      ...
      if XNN_UNLIKELY(c != 0) {
        do {
          ...
          const v128_t vi8x01234567 = wasm_u16x8_load8x8(i8);
          v128_t vk8x01234567 = wasm_u16x8_load8x8((const void*) ((uintptr_t) w + 64 * sizeof(uint8_t)));
          vsumx01234567 = wasm_i16x8_add(vsumx01234567, vi8x01234567);
          i8 += 8;

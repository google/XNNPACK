...
static XNN_INLINE xnn_simd_f32_t xnn_signed_getexp_f32(xnn_simd_f32_t a) {
  ...
  const xnn_simd_f32_t exp =
      xnn_shift_right_signed_f32(xnn_and_f32(a, sign_and_exp_mask), 8);
...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_div_u8(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_div_u24(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_div_u32(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])

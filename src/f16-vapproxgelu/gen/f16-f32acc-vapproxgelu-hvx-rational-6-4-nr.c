...
void xnn_f16_f32acc_vapproxgelu_ukernel__hvx_rational_6_4_nr_u32(
    size_t batch,
...
void xnn_f16_f32acc_vapproxgelu_ukernel__hvx_rational_6_4_nr_u64(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_f32acc_vapproxgelu_ukernel__hvx_rational_6_4_nr_u128(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)

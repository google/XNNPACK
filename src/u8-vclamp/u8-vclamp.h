...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_u8_vclamp_ukernel__neon_u64, 64, false, XNN_QUANTIZED(uint8_t), struct xnn_u8_minmax_params, xnn_init_qu8_clamp_scalar_params)
#endif  // XNN_ARCH_ARM || XNN_ARCH_ARM64

#if XNN_ARCH_X86 || XNN_ARCH_X86_64
XNN_UKERNEL_WITH_PARAMS(0, xnn_u8_vclamp_ukernel__sse2_u64, 64, false, XNN_QUANTIZED(uint8_t), struct xnn_u8_minmax_params, xnn_init_qu8_clamp_scalar_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_avx2, xnn_u8_vclamp_ukernel__avx2_u128, 128, false, XNN_QUANTIZED(uint8_t), struct xnn_u8_minmax_params, xnn_init_qu8_clamp_scalar_params)
...
XNN_UKERNEL_WITH_PARAMS(0, xnn_u8_vclamp_ukernel__scalar_u4, 4, false, XNN_QUANTIZED(uint8_t), struct xnn_u8_minmax_params, xnn_init_qu8_clamp_scalar_params)

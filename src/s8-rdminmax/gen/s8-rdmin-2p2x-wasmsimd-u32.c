...
void xnn_s8_rdmin_ukernel_2p2x__wasmsimd_u32(
    size_t rows,
    size_t channels,
    const int8_t* input,
    size_t input_stride,
    ...
    const void* params)
{
  ...
  for (; channels >= 32; channels -= 32) {
    ...
    xnn_simd_s8_t vmin16 = xnn_loadu_s8(output + 16 * sizeof(int8_t));;
    ...
    for (int r = rows; r > 0; r -= 2) {
      ...
      vmin16 = xnn_min_s8(vmin16, vin_0_16);
      vmin0 = xnn_min_s8(vmin0, vin_1_0);
      vmin16 = xnn_min_s8(vmin16, vin_1_16);

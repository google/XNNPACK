...
void xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_16x32c4__avx512amx_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
...
// AMX is only available for __x86_64__
  ...
  do {
    ...
    while (k >= 64 * sizeof(int8_t)) {
      ...
      const __m512i vb1x0 = _mm512_load_epi32((const int8_t*) w + 128);
      const __m512i vb2x0 = _mm512_load_epi32((const int8_t*) w + 256);
      const __m512i vb3x0 = _mm512_load_epi32((const int8_t*) w + 384);
      const __m512i vb4x0 = _mm512_load_epi32((const int8_t*) w + 512);
      const __m512i vb5x0 = _mm512_load_epi32((const int8_t*) w + 640);
      const __m512i vb6x0 = _mm512_load_epi32((const int8_t*) w + 768);
      const __m512i vb7x0 = _mm512_load_epi32((const int8_t*) w + 896);
      ...
      const __m512i vb1x1 = _mm512_load_epi32((const int8_t*) w + 192);
      const __m512i vb2x1 = _mm512_load_epi32((const int8_t*) w + 320);
      const __m512i vb3x1 = _mm512_load_epi32((const int8_t*) w + 448);
      const __m512i vb4x1 = _mm512_load_epi32((const int8_t*) w + 576);
      const __m512i vb5x1 = _mm512_load_epi32((const int8_t*) w + 704);
      const __m512i vb6x1 = _mm512_load_epi32((const int8_t*) w + 832);
      const __m512i vb7x1 = _mm512_load_epi32((const int8_t*) w + 960);
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      for (size_t k = 0; k < ((kremainder + 7) >> 3); ++k) {
        const __m512i vb0 = _mm512_load_epi32((const int8_t*) w + 0 + 128 * k);
      ...
      _tile_dpbssd(0, 6, 7);
      for (size_t k = 0; k < ((kremainder + 7) >> 3); ++k) {
        const __m512i vb1 = _mm512_load_epi32((const int8_t*) w + 64 + 128 * k);

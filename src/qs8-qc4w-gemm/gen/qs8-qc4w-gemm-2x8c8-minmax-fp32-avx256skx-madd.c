    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x1x0123 = _mm256_dpbusd_epi32_madd(vacc1x1x0123, va1x89ABCDEF, vb01234567x4567);
      vacc1x1x4567 = _mm256_dpbusd_epi32_madd(vacc1x1x4567, va1x89ABCDEF, vb89ABCDEFx4567);

...
void xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_4x4__scalar_fmagic(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    float vfpacc0x2 = (float) math_asr_s32(vacc0x2, 4);
    float vfpacc0x3 = (float) math_asr_s32(vacc0x3, 4);
    float vfpacc1x0 = (float) math_asr_s32(vacc1x0, 4);
    float vfpacc1x1 = (float) math_asr_s32(vacc1x1, 4);
    float vfpacc1x2 = (float) math_asr_s32(vacc1x2, 4);
    float vfpacc1x3 = (float) math_asr_s32(vacc1x3, 4);
    float vfpacc2x0 = (float) math_asr_s32(vacc2x0, 4);
    float vfpacc2x1 = (float) math_asr_s32(vacc2x1, 4);
    float vfpacc2x2 = (float) math_asr_s32(vacc2x2, 4);
    float vfpacc2x3 = (float) math_asr_s32(vacc2x3, 4);
    float vfpacc3x0 = (float) math_asr_s32(vacc3x0, 4);
    float vfpacc3x1 = (float) math_asr_s32(vacc3x1, 4);
    float vfpacc3x2 = (float) math_asr_s32(vacc3x2, 4);
    float vfpacc3x3 = (float) math_asr_s32(vacc3x3, 4);

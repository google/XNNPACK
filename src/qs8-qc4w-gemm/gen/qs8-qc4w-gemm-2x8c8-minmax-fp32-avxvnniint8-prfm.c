...
void xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_2x8c8__avxvnniint8_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc1x1x0123 = _mm256_dpbssd_epi32(vacc1x1x0123, va1x89ABCDEF, vb01234567x4567);
      vacc1x1x4567 = _mm256_dpbssd_epi32(vacc1x1x4567, va1x89ABCDEF, vb89ABCDEFx4567);

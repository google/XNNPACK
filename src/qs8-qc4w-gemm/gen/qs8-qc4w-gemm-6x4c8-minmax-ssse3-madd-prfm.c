...
void xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_6x4c8__ssse3_madd_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    __m128i vacc4x01 = vacc0x01;
    __m128i vacc4x23 = vacc0x23;
    __m128i vacc5x01 = vacc0x01;
    __m128i vacc5x23 = vacc0x23;
    w = (const int32_t*) w + 4;
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      a3 += 16;
      const __m128i va4x01234567 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a4)), vsign_mask);
      const __m128i va4x89ABCDEF = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a4 + 8)), vsign_mask);
      a4 += 16;
      const __m128i va5x01234567 = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5)), vsign_mask);
      const __m128i va5x89ABCDEF = _mm_xor_si128(_mm_set1_epi64x((int64_t) unaligned_load_u64(a5 + 8)), vsign_mask);
      a5 += 16;
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd(vacc5x01, va5x01234567, vb01234567x01);
      vacc5x23 = _mm_dpbusd_epi32_madd(vacc5x23, va5x01234567, vb89ABCDEFx01);
      ...
      vacc5x01 = _mm_dpbusd_epi32_madd(vacc5x01, va5x89ABCDEF, vb01234567x23);
      vacc5x23 = _mm_dpbusd_epi32_madd(vacc5x23, va5x89ABCDEF, vb89ABCDEFx23);
    ...
    __m128i vacc5x0123 = _mm_hadd_epi32(vacc5x01, vacc5x23);
    ...
    __m128 vout5x0123 = _mm_cvtepi32_ps(vacc5x0123);
    ...
    vout4x0123 = _mm_mul_ps(vout4x0123, vscale0123);
    vout5x0123 = _mm_mul_ps(vout5x0123, vscale0123);
    ...
    vout4x0123 = _mm_min_ps(vout4x0123, voutput_max_less_zero_point);
    vout5x0123 = _mm_min_ps(vout5x0123, voutput_max_less_zero_point);
    ...
    vacc4x0123 = _mm_cvtps_epi32(vout4x0123);
    vacc5x0123 = _mm_cvtps_epi32(vout5x0123);
    ...
    vacc4x0123 = _mm_add_epi32(vacc4x0123, voutput_zero_point);
    vacc5x0123 = _mm_add_epi32(vacc5x0123, voutput_zero_point);
    ...
    vacc4x0123 = _mm_packs_epi32(vacc4x0123, vacc4x0123);
    vacc5x0123 = _mm_packs_epi32(vacc5x0123, vacc5x0123);
    ...
    vacc4x0123 = _mm_max_epi16(vacc4x0123, voutput_min);
    vacc5x0123 = _mm_max_epi16(vacc5x0123, voutput_min);
    ...
    __m128i voutb4x0123 = _mm_packs_epi16(vacc4x0123, vacc4x0123);
    __m128i voutb5x0123 = _mm_packs_epi16(vacc5x0123, vacc5x0123);
    ...
    if (nc >= 4) {
      ...
      _mm_storeu_si32(c4, voutb4x0123);
      c4 = (int8_t*) ((uintptr_t) c4 + cn_stride);
      a4 = (const int8_t*) ((uintptr_t) a4 - kc);
      _mm_storeu_si32(c5, voutb5x0123);
      ...
      if (nc & 2) {
        ...
        c3 += 2;
        unaligned_store_u16(c4, (uint16_t) _mm_extract_epi16(voutb4x0123, 0));
        c4 += 2;
        unaligned_store_u16(c5, (uint16_t) _mm_extract_epi16(voutb5x0123, 0));
        c5 += 2;
        ...
        voutb4x0123 = _mm_srli_epi32(voutb4x0123, 16);
        voutb5x0123 = _mm_srli_epi32(voutb5x0123, 16);
      }
      if (nc & 1) {
        ...
        *c4 = (int8_t) _mm_extract_epi16(voutb4x0123, 0);
        *c5 = (int8_t) _mm_extract_epi16(voutb5x0123, 0);
      }
      nc = 0;
    }
  } while (nc != 0);

...
void xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_8x128c4__hvx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    vacc5x0 = Q6_Vw_vasr_VwR(vacc5x0, 4);
    vacc5x1 = Q6_Vw_vasr_VwR(vacc5x1, 4);
    vacc5x2 = Q6_Vw_vasr_VwR(vacc5x2, 4);
    vacc5x3 = Q6_Vw_vasr_VwR(vacc5x3, 4);
    vacc6x0 = Q6_Vw_vasr_VwR(vacc6x0, 4);
    vacc6x1 = Q6_Vw_vasr_VwR(vacc6x1, 4);
    vacc6x2 = Q6_Vw_vasr_VwR(vacc6x2, 4);
    vacc6x3 = Q6_Vw_vasr_VwR(vacc6x3, 4);
    vacc7x0 = Q6_Vw_vasr_VwR(vacc7x0, 4);
    vacc7x1 = Q6_Vw_vasr_VwR(vacc7x1, 4);
    vacc7x2 = Q6_Vw_vasr_VwR(vacc7x2, 4);
    vacc7x3 = Q6_Vw_vasr_VwR(vacc7x3, 4);

...
void xnn_qs8_qc4w_gemm_minmax_fp32_ukernel_14x16c8__avx512skx_madd(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      vacc12x01234567 = _mm512_dpbusd_epi32_madd(vacc12x01234567, va12x01234567, vb01234567x01234567);
      vacc12x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc12x89ABCDEF, va12x01234567, vb89ABCDEFx01234567);
      vacc13x01234567 = _mm512_dpbusd_epi32_madd(vacc13x01234567, va13x01234567, vb01234567x01234567);
      vacc13x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc13x89ABCDEF, va13x01234567, vb89ABCDEFx01234567);
      ...
      vacc12x01234567 = _mm512_dpbusd_epi32_madd(vacc12x01234567, va12x89ABCDEF, vb01234567x89ABCDEF);
      vacc12x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc12x89ABCDEF, va12x89ABCDEF, vb89ABCDEFx89ABCDEF);
      vacc13x01234567 = _mm512_dpbusd_epi32_madd(vacc13x01234567, va13x89ABCDEF, vb01234567x89ABCDEF);
      vacc13x89ABCDEF = _mm512_dpbusd_epi32_madd(vacc13x89ABCDEF, va13x89ABCDEF, vb89ABCDEFx89ABCDEF);

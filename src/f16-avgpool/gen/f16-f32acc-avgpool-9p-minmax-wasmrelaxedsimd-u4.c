...
void xnn_f16_f32acc_avgpool_minmax_ukernel_9p__wasmrelaxedsimd_u4(
    ...
    const struct xnn_f16_scaleminmax_params* restrict params)
{
  ...
  do {
    ...
    for (; k > 9; k -= 9) {
      ...
      size_t c = channels;
      for (; c >= 4; c -= 4) {
        const xnn_simd_f32_t vi0 = xnn_loadu_f16_f32(i0); i0 += 4;
        const xnn_simd_f32_t vi1 = xnn_loadu_f16_f32(i1); i1 += 4;
        const xnn_simd_f32_t vi2 = xnn_loadu_f16_f32(i2); i2 += 4;
        const xnn_simd_f32_t vi3 = xnn_loadu_f16_f32(i3); i3 += 4;
        const xnn_simd_f32_t vi4 = xnn_loadu_f16_f32(i4); i4 += 4;
        const xnn_simd_f32_t vi5 = xnn_loadu_f16_f32(i5); i5 += 4;
        const xnn_simd_f32_t vi6 = xnn_loadu_f16_f32(i6); i6 += 4;
        const xnn_simd_f32_t vi7 = xnn_loadu_f16_f32(i7); i7 += 4;
        const xnn_simd_f32_t vi8 = xnn_loadu_f16_f32(i8); i8 += 4;
        const xnn_simd_f32_t vprev = xnn_loadu_f16_f32(prev_output); prev_output += 4;
        ...
        xnn_store_f32_f16(o, vacc); o += 4;
      }
      if (c > 0) {
        const xnn_simd_f32_t vi0 = xnn_load_tail_f16_f32(i0, c);
        const xnn_simd_f32_t vi1 = xnn_load_tail_f16_f32(i1, c);
        const xnn_simd_f32_t vi2 = xnn_load_tail_f16_f32(i2, c);
        const xnn_simd_f32_t vi3 = xnn_load_tail_f16_f32(i3, c);
        const xnn_simd_f32_t vi4 = xnn_load_tail_f16_f32(i4, c);
        const xnn_simd_f32_t vi5 = xnn_load_tail_f16_f32(i5, c);
        const xnn_simd_f32_t vi6 = xnn_load_tail_f16_f32(i6, c);
        const xnn_simd_f32_t vi7 = xnn_load_tail_f16_f32(i7, c);
        const xnn_simd_f32_t vi8 = xnn_load_tail_f16_f32(i8, c);

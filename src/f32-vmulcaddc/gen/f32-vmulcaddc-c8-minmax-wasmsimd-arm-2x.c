    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; c >= 8 * sizeof(float); c -= 8 * sizeof(float)) {
      ...
      vacc0x0123 = wasm_f32x4_add(wasm_f32x4_mul(vacc0x0123, vscale0123), vbias0123);
      vacc0x4567 = wasm_f32x4_add(wasm_f32x4_mul(vacc0x4567, vscale4567), vbias4567);
      vacc1x0123 = wasm_f32x4_add(wasm_f32x4_mul(vacc1x0123, vscale0123), vbias0123);
      vacc1x4567 = wasm_f32x4_add(wasm_f32x4_mul(vacc1x4567, vscale4567), vbias4567);
    ...
    for (; c >= 4 * sizeof(float); c -= 4 * sizeof(float)) {
      ...
      vacc0 = wasm_f32x4_add(wasm_f32x4_mul(vacc0, vscale), vbias);
      vacc1 = wasm_f32x4_add(wasm_f32x4_mul(vacc1, vscale), vbias);

...
void xnn_f16_f32acc_vsin_ukernel__avx512f_poly_3_u16(
    size_t batch,
...
void xnn_f16_f32acc_vsin_ukernel__avx512f_poly_3_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 32 * sizeof(xnn_float16); batch -= 32 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 16, vy_res_0);
    xnn_store_f32_f16(output + 1 * 16, vy_res_1);
    output += 32;
  }
...
void xnn_f16_f32acc_vsin_ukernel__avx512f_poly_3_u64(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 64 * sizeof(xnn_float16); batch -= 64 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 16, vy_res_0);
    xnn_store_f32_f16(output + 1 * 16, vy_res_1);
    xnn_store_f32_f16(output + 2 * 16, vy_res_2);
    xnn_store_f32_f16(output + 3 * 16, vy_res_3);
    output += 64;
  }

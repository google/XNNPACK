...
void xnn_f16_f32acc_vsin_ukernel__scalar_poly_3_u1(
    size_t batch,
...
void xnn_f16_f32acc_vsin_ukernel__scalar_poly_3_u2(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 2 * sizeof(xnn_float16); batch -= 2 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 1, vy_res_0);
    xnn_store_f32_f16(output + 1 * 1, vy_res_1);
    output += 2;
  }
...
void xnn_f16_f32acc_vsin_ukernel__scalar_poly_3_u4(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 4 * sizeof(xnn_float16); batch -= 4 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 1, vy_res_0);
    xnn_store_f32_f16(output + 1 * 1, vy_res_1);
    xnn_store_f32_f16(output + 2 * 1, vy_res_2);
    xnn_store_f32_f16(output + 3 * 1, vy_res_3);
    output += 4;
  }

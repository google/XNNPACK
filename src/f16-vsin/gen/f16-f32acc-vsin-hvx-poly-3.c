...
void xnn_f16_f32acc_vsin_ukernel__hvx_poly_3_u32(
    size_t batch,
...
void xnn_f16_f32acc_vsin_ukernel__hvx_poly_3_u64(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 64 * sizeof(xnn_float16); batch -= 64 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 32, vy_res_0);
    xnn_store_f32_f16(output + 1 * 32, vy_res_1);
    output += 64;
  }
...
void xnn_f16_f32acc_vsin_ukernel__hvx_poly_3_u128(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 128 * sizeof(xnn_float16); batch -= 128 * sizeof(xnn_float16)) {
    ...
    xnn_store_f32_f16(output + 0 * 32, vy_res_0);
    xnn_store_f32_f16(output + 1 * 32, vy_res_1);
    xnn_store_f32_f16(output + 2 * 32, vy_res_2);
    xnn_store_f32_f16(output + 3 * 32, vy_res_3);
    output += 128;
  }

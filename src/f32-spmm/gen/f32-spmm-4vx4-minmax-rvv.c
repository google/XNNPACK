...
void xnn_f32_spmm_minmax_ukernel_4vx4__rvv(
    size_t mc,
    size_t nc,
    const float* input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  while (mc > 0) {
    ...
    while (n >= 4) {
      ...
      vfloat32m4_t acc2_f32v = __riscv_vfmv_v_f_f32m4(0.0f, vl);
      vfloat32m4_t acc3_f32v = __riscv_vfmv_v_f_f32m4(0.0f, vl);
      acc0_f32v = __riscv_vfadd_vf_f32m4(acc0_f32v, *w++, vl);
      acc1_f32v = __riscv_vfadd_vf_f32m4(acc1_f32v, *w++, vl);
      acc2_f32v = __riscv_vfadd_vf_f32m4(acc2_f32v, *w++, vl);
      acc3_f32v = __riscv_vfadd_vf_f32m4(acc3_f32v, *w++, vl);
      ...
      if XNN_LIKELY(nnz != 0) {
        do {
          ...
          acc2_f32v = __riscv_vfmacc_vf_f32m4(acc2_f32v, *w++, input_f32v, vl);
          acc3_f32v = __riscv_vfmacc_vf_f32m4(acc3_f32v, *w++, input_f32v, vl);
      ...
      acc2_f32v = __riscv_vfmin_vf_f32m4(acc2_f32v, max, vl);
      acc3_f32v = __riscv_vfmin_vf_f32m4(acc3_f32v, max, vl);
      acc0_f32v = __riscv_vfmax_vf_f32m4(acc0_f32v, min, vl);
      acc1_f32v = __riscv_vfmax_vf_f32m4(acc1_f32v, min, vl);
      acc2_f32v = __riscv_vfmax_vf_f32m4(acc2_f32v, min, vl);
      acc3_f32v = __riscv_vfmax_vf_f32m4(acc3_f32v, min, vl);
      __riscv_vse32_v_f32m4(output, acc0_f32v, vl);
      output = (float*restrict) ((uintptr_t) output + output_stride);
      __riscv_vse32_v_f32m4(output, acc1_f32v, vl);
      output = (float*restrict) ((uintptr_t) output + output_stride);
      __riscv_vse32_v_f32m4(output, acc2_f32v, vl);
      output = (float*restrict) ((uintptr_t) output + output_stride);
      __riscv_vse32_v_f32m4(output, acc3_f32v, vl);
      output = (float*restrict) ((uintptr_t) output + output_stride);

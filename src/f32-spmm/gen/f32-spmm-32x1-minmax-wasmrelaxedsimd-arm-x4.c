...
void xnn_f32_spmm_minmax_ukernel_32x1__wasmrelaxedsimd_arm_x4(
    size_t mc,
    size_t nc,
    const float* input,
    const float* weights,
  ...
  while XNN_LIKELY(mc >= 32 * sizeof(float)) {
    ...
    do {
      ...
      for (; nnz >= 4; nnz -= 4) {
        ...
        vaccGHIJx2 = wasm_f32x4_relaxed_madd(viGHIJx2, vw2, vaccGHIJx2);
        vaccKLMNx2 = wasm_f32x4_relaxed_madd(viKLMNx2, vw2, vaccKLMNx2);
        vaccOPQRx2 = wasm_f32x4_relaxed_madd(viOPQRx2, vw2, vaccOPQRx2);
        vaccSTUVx2 = wasm_f32x4_relaxed_madd(viSTUVx2, vw2, vaccSTUVx2);
        ...
        vaccGHIJx3 = wasm_f32x4_relaxed_madd(viGHIJx3, vw3, vaccGHIJx3);
        vaccKLMNx3 = wasm_f32x4_relaxed_madd(viKLMNx3, vw3, vaccKLMNx3);
        vaccOPQRx3 = wasm_f32x4_relaxed_madd(viOPQRx3, vw3, vaccOPQRx3);
        vaccSTUVx3 = wasm_f32x4_relaxed_madd(viSTUVx3, vw3, vaccSTUVx3);
      }

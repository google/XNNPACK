...
void xnn_f32_spmm_minmax_ukernel_16x1__wasmrelaxedsimd_x86_x4(
    size_t mc,
    size_t nc,
    const float* input,
    const float* weights,
  ...
  while XNN_LIKELY(mc >= 16 * sizeof(float)) {
    ...
    do {
      ...
      for (; nnz >= 4; nnz -= 4) {
        ...
        vacc4567x2 = wasm_f32x4_relaxed_madd(vi4567x2, vw2, vacc4567x2);
        vacc89ABx2 = wasm_f32x4_relaxed_madd(vi89ABx2, vw2, vacc89ABx2);
        vaccCDEFx2 = wasm_f32x4_relaxed_madd(viCDEFx2, vw2, vaccCDEFx2);
        ...
        vacc4567x3 = wasm_f32x4_relaxed_madd(vi4567x3, vw3, vacc4567x3);
        vacc89ABx3 = wasm_f32x4_relaxed_madd(vi89ABx3, vw3, vacc89ABx3);
        vaccCDEFx3 = wasm_f32x4_relaxed_madd(viCDEFx3, vw3, vaccCDEFx3);
      }

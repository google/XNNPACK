...
void xnn_f32_spmm_minmax_ukernel_16x1__wasmsimd_x86_unroll4(
    uint32_t batch_size,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  while XNN_LIKELY(n >= 16) {
    ...
    do {
      ...
      v128_t vacc89ABx2 = wasm_f32x4_splat(0.0f);
      v128_t vacc89ABx3 = wasm_f32x4_splat(0.0f);
      v128_t vaccCDEFx0 = vacc0123x0;
      v128_t vaccCDEFx1 = wasm_f32x4_splat(0.0f);
      v128_t vaccCDEFx2 = wasm_f32x4_splat(0.0f);
      v128_t vaccCDEFx3 = wasm_f32x4_splat(0.0f);
      for (; nnz >= 4; nnz -= 4) {

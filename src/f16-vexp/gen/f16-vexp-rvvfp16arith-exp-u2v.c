...
forceinline vfloat16m2_t calc_polynom_deg_1_f16m2(vfloat16m2_t x, FLOAT16_T a0, FLOAT16_T a1, size_t vl)
{ 
    return __riscv_vfmadd_vf_f16m2(x, a1, __riscv_vfmv_v_f_f16m2(a0, vl), vl);
}

forceinline void fast_2_sum_vv_f16m2(vfloat16m2_t a, vfloat16m2_t b, vfloat16m2_t* sh, vfloat16m2_t* sl, size_t vl)
{
    *sh = __riscv_vfadd_vv_f16m2(a, b, vl);
    *sl = __riscv_vfsub_vv_f16m2(b, __riscv_vfsub_vv_f16m2(*sh, a, vl), vl);
}
    
forceinline void fast_2_sum_fv_f16m2(FLOAT16_T a, vfloat16m2_t b, vfloat16m2_t* sh, vfloat16m2_t* sl, size_t vl)
{
    *sh = __riscv_vfadd_vf_f16m2(b, a, vl);
    *sl = __riscv_vfsub_vv_f16m2(b, __riscv_vfsub_vf_f16m2(*sh, a, vl), vl);
}
        
forceinline void mul21_vv_f16m2(vfloat16m2_t ah, vfloat16m2_t al, vfloat16m2_t bh, vfloat16m2_t bl, vfloat16m2_t* rh, size_t vl)
{
    vfloat16m2_t zh, zl;
    zh = __riscv_vfmul_vv_f16m2(ah, bh, vl);
    zl = __riscv_vfmsub_vv_f16m2(ah, bh, zh, vl);
    zl = __riscv_vfadd_vv_f16m2(zl, __riscv_vfmadd_vv_f16m2(ah, bl, __riscv_vfmul_vv_f16m2(al, bh, vl), vl), vl);
    *rh = __riscv_vfadd_vv_f16m2(zh, zl, vl);
}

forceinline void fma12_vv_f16m2(vfloat16m2_t ah, vfloat16m2_t bh, vfloat16m2_t ch, vfloat16m2_t* zh, vfloat16m2_t* zl, size_t vl)
{ 
    *zh = __riscv_vfmadd_vv_f16m2(ah, bh, ch, vl);
    *zl = __riscv_vfmadd_vv_f16m2(ah, bh, __riscv_vfsub_vv_f16m2(ch, *zh, vl), vl);
}

forceinline void fma12_ver2p2_vf_f16m2(vfloat16m2_t ah, FLOAT16_T bh, vfloat16m2_t ch, vfloat16m2_t* zh, vfloat16m2_t* zl, size_t vl)
{
    vfloat16m2_t sh, sl;
    *zh = __riscv_vfmadd_vf_f16m2(ah, bh, ch, vl);
    fast_2_sum_vv_f16m2(ch, __riscv_vfneg_v_f16m2(*zh, vl), &sh, &sl, vl);
    
    *zl = __riscv_vfmadd_vf_f16m2(ah, bh, sh, vl);
    *zl = __riscv_vfadd_vv_f16m2(*zl, sl, vl);
}
...
#if 2 == 1
forceinline void check_special_cases_f16m2(vfloat16m2_t* x, vfloat16m2_t* special, RVV_BOOL* specialMask,
    FLOAT16_T overflowThreshold, size_t vl)
{
    uint16_t pinf = 0x7c00;    
    RVV_BOOL mask;
    // check +inf
    *specialMask = __riscv_vmfeq_vf_f16m2_b16(*x, RVVMF_EXP_AS_FP16(pinf), vl);
    *special = __riscv_vfmerge_vfm_f16m2(*x, RVVMF_EXP_AS_FP16(pinf), *specialMask, vl);
    // check overflow
    mask = __riscv_vmand_mm_b16(__riscv_vmfgt_vf_f16m2_b16(*x, overflowThreshold, vl),
        __riscv_vmflt_vf_f16m2_b16(*x, RVVMF_EXP_AS_FP16(pinf), vl), vl);
    ...
    *x = __riscv_vfmerge_vfm_f16m2(*x, RVVMF_EXP_AS_FP16(ZERO_F16), *specialMask, vl);
}
#endif
    ...
    FLOAT16_T overflowThreshold, size_t vl)
{
    ...
    *special = __riscv_vfmerge_vfm_f16m2(*x, RVVMF_EXP_AS_FP16(pinf), *specialMask, vl);
    // check overflow
    mask = __riscv_vmand_mm_b8(__riscv_vmfgt_vf_f16m2_b8(*x, overflowThreshold, vl),
    ...
    FLOAT16_T overflowThreshold, size_t vl)
{
    ...
    RVV_BOOL mask;
    // check +inf
    *specialMask = __riscv_vmfeq_vf_f16m2_b4(*x, RVVMF_EXP_AS_FP16(pinf), vl);
    *special = __riscv_vfmerge_vfm_f16m2(*x, RVVMF_EXP_AS_FP16(pinf), *specialMask, vl);
    // check overflow
    mask = __riscv_vmand_mm_b4(__riscv_vmfgt_vf_f16m2_b4(*x, overflowThreshold, vl),
        __riscv_vmflt_vf_f16m2_b4(*x, RVVMF_EXP_AS_FP16(pinf), vl), vl);
    *special = __riscv_vfmerge_vfm_f16m2(*special, RVVMF_EXP_AS_FP16(pinf), mask, vl);
    ...
    FLOAT16_T overflowThreshold, size_t vl)
{
    ...
    RVV_BOOL mask;
    // check +inf
    *specialMask = __riscv_vmfeq_vf_f16m2_b2(*x, RVVMF_EXP_AS_FP16(pinf), vl);
    *special = __riscv_vfmerge_vfm_f16m2(*x, RVVMF_EXP_AS_FP16(pinf), *specialMask, vl);
    // check overflow
    mask = __riscv_vmand_mm_b2(__riscv_vmfgt_vf_f16m2_b2(*x, overflowThreshold, vl),
        __riscv_vmflt_vf_f16m2_b2(*x, RVVMF_EXP_AS_FP16(pinf), vl), vl);
    *special = __riscv_vfmerge_vfm_f16m2(*special, RVVMF_EXP_AS_FP16(pinf), mask, vl);
...
forceinline void do_exp_argument_reduction_hl_f16m2(vfloat16m2_t x,
    vfloat16m2_t* yh, vfloat16m2_t* yl, vuint16m2_t* ei, vuint16m2_t* fi, size_t vl)
{
    vfloat16m2_t vmagicConst1 = __riscv_vfmv_v_f_f16m2(RVVMF_EXP_AS_FP16(MAGIC_CONST_1_F16), vl);
    vfloat16m2_t h = __riscv_vfmadd_vf_f16m2(x, RVVMF_EXP_AS_FP16(INV_LOG2_2K_F16), vmagicConst1, vl);
    ...
    *ei = __riscv_vsrl_vx_u16m2(hi, TABLE_SIZE_DEG_F16, vl);
    ...
    fma12_ver2p2_vf_f16m2(h, RVVMF_EXP_AS_FP16(M_LOG2_2K_L_F16),
        __riscv_vfmadd_vf_f16m2(h, RVVMF_EXP_AS_FP16(M_LOG2_2K_H_F16), x, vl), yh, yl, vl);
    *yl = __riscv_vfmadd_vf_f16m2(h, RVVMF_EXP_AS_FP16(M_LOG2_2K_LL_F16), *yl, vl);
    ...
    vuint16m2_t* index, vfloat16m2_t* th, vfloat16m2_t* tl, size_t vl)
{
    ...
    *th = __riscv_vloxei16_v_f16m2((FLOAT16_T*)RVVMF_EXP_LOOK_UP_TABLE_HIGH_F16, *index, vl);
    *tl = __riscv_vloxei16_v_f16m2((FLOAT16_T*)RVVMF_EXP_LOOK_UP_TABLE_LOW_F16, *index, vl);
}

forceinline void calculate_exp_polynom_hl_f16m2(vfloat16m2_t yh, vfloat16m2_t yl, vfloat16m2_t* ph, vfloat16m2_t* pl, size_t vl)
{
    vfloat16m2_t sqryh = __riscv_vfmul_vv_f16m2(yh, yh, vl);
    vfloat16m2_t r = calc_polynom_deg_1_f16m2(yh, RVVMF_EXP_AS_FP16(EXP_POL_COEFF_2_F16),
        RVVMF_EXP_AS_FP16(EXP_POL_COEFF_3_F16), vl); 
    fma12_vv_f16m2(sqryh, r, yh, ph, pl, vl);
    *pl = __riscv_vfadd_vv_f16m2(*pl, yl, vl);
}

forceinline void update_exponent_f16m2(vuint16m2_t ei, vfloat16m2_t* res, size_t vl)
{
...
forceinline void update_exponent_with_subnormal_f16m2(FLOAT16_T subnormalThreshold, vfloat16m2_t x,
    vuint16m2_t ei, vfloat16m2_t* res, size_t vl)
{
    ...
    RVV_BOOL subnormalMask = __riscv_vmand_mm_b16(__riscv_vmfgt_vf_f16m1_b16(x, RVVMF_EXP_AS_FP16(ninf), vl),
        __riscv_vmflt_vf_f16m2_b16(x, subnormalThreshold, vl), vl);
#endif
#if 2 == 2
    ...
    subnormalRes = __riscv_vfadd_vv_f16m2(*res, __riscv_vreinterpret_v_u16m2_f16m2(shiftNum), vl);
...
forceinline void reconstruct_exp_hl_hl_f16m2(vfloat16m2_t x, vuint16m2_t ei, vfloat16m2_t th, vfloat16m2_t tl,
    vfloat16m2_t pm2h, vfloat16m2_t pm2l, vfloat16m2_t* res, FLOAT16_T subnormalThreshold, size_t vl)
{
    vfloat16m2_t sh, sl;
    fast_2_sum_fv_f16m2(RVVMF_EXP_AS_FP16(ONE_F16), pm2h, &sh, &sl, vl);
...
forceinline void update_underflow_f16m2(vfloat16m2_t x, vfloat16m2_t* res,
...
vfloat16m2_t __riscv_vexp_f16m2(vfloat16m2_t x, size_t avl)
{
    ...
    vfloat16m2_t res, yh, yl, th, tl, pm2h, pm2l;
    vuint16m2_t ei, fi;
    ...
    check_special_cases_f16m2(&x, &special, &specialMask, RVVMF_EXP_AS_FP16(EXP_EXPM1_OVERFLOW_THRESHOLD_F16), vl);
#else
    ...
    calculate_exp_polynom_hl_f16m2(yh, yl, &pm2h, &pm2l, vl);
    reconstruct_exp_hl_hl_f16m2(x, ei, th, tl, pm2h, pm2l, &res, RVVMF_EXP_AS_FP16(EXP_SUBNORMAL_THRESHOLD_F16), vl);
    update_underflow_f16m2(x, &res, zeroThreshold, RVVMF_EXP_AS_FP16(EXP_UNDERFLOW_VALUE_F16), vl);
...
void xnn_f16_vexp_ukernel__rvvfp16arith_exp_u2v(
    size_t batch,
    ...
    const struct xnn_f16_default_params* unused_params)
{
  ...
  do {
    ...
    vfloat16m2_t vx = __riscv_vle16_v_f16m2((FLOAT16_T*)input, n);
    input += n;
    vfloat16m2_t vacc = __riscv_vexp_f16m2(vx, n);
    __riscv_vse16_v_f16m2((FLOAT16_T*)output, vacc, n);
    output += n;

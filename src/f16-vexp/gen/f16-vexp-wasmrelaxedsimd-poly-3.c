...
void xnn_f16_vexp_ukernel__wasmrelaxedsimd_poly_3_u8(
    size_t batch,
...
void xnn_f16_vexp_ukernel__wasmrelaxedsimd_poly_3_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vexp_ukernel__wasmrelaxedsimd_poly_3_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)

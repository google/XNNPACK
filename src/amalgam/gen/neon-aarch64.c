...
{
  const uint8_t pos0[16] = {0, 1, 2, 16, 17, 18, 32, 33, 34, 48, 49, 50, 0, 0, 0, 0};
  const uint8_t pos1[16] = {3, 4, 5, 19, 20, 21, 35, 36, 37, 51, 52, 53, 0, 0, 0, 0};
  const uint8_t pos2[16] = {6, 7, 8, 22, 23, 24, 38, 39, 40, 54, 55, 56, 0, 0, 0, 0};
  const uint8_t pos3[16] = {9, 10, 11, 25, 26, 27, 41, 42, 43, 57, 58, 59, 0, 0, 0, 0};
...
void xnn_x32_transposec_ukernel__4x4_aarch64_neon_tbl128(
    ...
    size_t block_height) XNN_OOB_READS
{  
  const uint8_t pos0[16] = {0, 1, 2, 3, 16, 17, 18, 19, 32, 33, 34, 35, 48, 49, 50, 51};
  const uint8_t pos1[16] = {4, 5, 6, 7, 20, 21, 22, 23, 36, 37, 38, 39, 52, 53, 54, 55};
  const uint8_t pos2[16] = {8, 9, 10, 11, 24, 25, 26, 27, 40, 41, 42, 43, 56, 57, 58, 59};
  const uint8_t pos3[16] = {12, 13, 14, 15, 28, 29, 30, 31, 44, 45, 46, 47, 60, 61, 62, 63};

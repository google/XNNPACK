...
void xnn_qs16_vmul_minmax_fp32_ukernel__sse41_u8(
    size_t batch,
...
void xnn_qs16_vmulc_minmax_fp32_ukernel__sse41_u8(
    size_t batch,
    const int16_t* input_a,
    const int16_t* input_b,
    int16_t* output,
...
void xnn_s32_vmax_ukernel__sse41_u8(
    size_t batch,
...
void xnn_s32_vmaxc_ukernel__sse41_u8(
    size_t batch,
    ...
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int32_t); batch -= 8 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_max_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_max_s32(vin1_1, vin2);

...
void xnn_s32_vand_ukernel__avx512f_u32(
    size_t batch,
    ...
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_and_s32(vin1_0, vin2_0);
    xnn_simd_s32_t vy_1 = xnn_and_s32(vin1_1, vin2_1);
  ...
  for (; batch >= xnn_simd_bytes_s32; batch -= xnn_simd_bytes_s32) {
    ...
    xnn_simd_s32_t vy = xnn_and_s32(vin1, vin2);
...
void xnn_s32_vandc_ukernel__avx512f_u32(
    size_t batch,
    ...
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_and_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_and_s32(vin1_1, vin2);
...
void xnn_s32_vxor_ukernel__avx512f_u32(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_xor_s32(vin1_0, vin2_0);
    xnn_simd_s32_t vy_1 = xnn_xor_s32(vin1_1, vin2_1);
  ...
  for (; batch >= xnn_simd_bytes_s32; batch -= xnn_simd_bytes_s32) {
    ...
    xnn_simd_s32_t vy = xnn_xor_s32(vin1, vin2);
...
void xnn_s32_vxorc_ukernel__avx512f_u32(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_xor_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_xor_s32(vin1_1, vin2);

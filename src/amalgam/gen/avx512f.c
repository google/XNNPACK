...
void xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u112(
  ...
  for (; batch >= 112 * sizeof(float); batch -= 112 * sizeof(float)) {
    ...
    const __m512 vt5_6 = _mm512_mul_ps(vt3_6, vt4_6);
    ...
    const __mmask16 vmask6 = _mm512_cmp_ps_mask(vt5_6, vt5_6, _CMP_EQ_OQ);
    ...
    const __m512 vt6_6 = _mm512_mask_blend_ps(vmask6, _mm512_setzero_ps(), vt5_6);
    ...
    const __m512 vy6 = _mm512_mul_ps(va6, vt6_6);

    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vout2x0 = math_muladd_f32(vout2x0, vascale2 * vbscale0, vbias0);
    vout2x1 = math_muladd_f32(vout2x1, vascale2 * vbscale1, vbias1);
    vout2x2 = math_muladd_f32(vout2x2, vascale2 * vbscale2, vbias2);
    vout2x3 = math_muladd_f32(vout2x3, vascale2 * vbscale3, vbias3);
    const float vascale3 = quantization_params[3].inv_scale;
    vout3x0 = math_muladd_f32(vout3x0, vascale3 * vbscale0, vbias0);
    vout3x1 = math_muladd_f32(vout3x1, vascale3 * vbscale1, vbias1);
    vout3x2 = math_muladd_f32(vout3x2, vascale3 * vbscale2, vbias2);
    vout3x3 = math_muladd_f32(vout3x3, vascale3 * vbscale3, vbias3);

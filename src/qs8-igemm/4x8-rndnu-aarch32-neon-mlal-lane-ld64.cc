...
// void xnn_qs8_igemm_minmax_rndnu_ukernel_4x8__aarch32_neon_mlal_lane_prfm_ld64
//     size_t mr,                                      r0
//     size_t nc,                                      r1
...
//     xnn_qs8_conv_minmax_params*params); sp + 108 -> (r5)
...
xnn_status xnn_generate_qs8_igemm_rndnu_ukernel_4x8__aarch32_neon_mlal_lane_ld64(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, size_t ks, const void* params) {
...
xnn_status xnn_generate_qs8_igemm_rndnu_ukernel_4x8__aarch32_neon_mlal_lane_prfm_ld64(xnn_code_buffer* code, size_t nc_mod_nr, size_t kc, size_t ks, const void* params) {
  using namespace xnnpack::aarch32;
  Generator g(code);

...
xnn_status xnn_generate_qs8_igemm_rndnu_ukernel_4x8__aarch32_neon_mlal_lane_ld64(xnn_code_buffer* code, size_t nc, size_t kc, void* params) {
...
xnn_status xnn_generate_qs8_igemm_rndnu_ukernel_4x8__aarch32_neon_mlal_lane_prfm_ld64(xnn_code_buffer* code, size_t nc, size_t kc, void* params) {
  using namespace xnnpack::aarch32;
  Generator g(code);

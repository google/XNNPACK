  ...
  do {
    ...
    do {
      ...
      while (k < kc) {
        ...
        int8x16_t vb0123x89AB = vld1q_s8((const int8_t*)w); w = (const void*)((const int8_t*)w + 16);
        int8x16_t vb0123xCDEF = vld1q_s8((const int8_t*)w); w = (const void*)((const int8_t*)w + 16);

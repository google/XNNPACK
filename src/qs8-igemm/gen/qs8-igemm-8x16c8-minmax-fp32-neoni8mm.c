...
void xnn_qs8_igemm_minmax_fp32_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    int32x4_t vacc67x01 = vreinterpretq_s32_u64(vbias01x0123.val[0]);
    int32x4_t vacc67x23 = vreinterpretq_s32_u64(vbias01x0123.val[1]);
    int32x4_t vacc67x45 = vreinterpretq_s32_u64(vbias01x4567.val[0]);
    int32x4_t vacc67x67 = vreinterpretq_s32_u64(vbias01x4567.val[1]);
    int32x4_t vacc67x89 = vreinterpretq_s32_u64(vbias01x89AB.val[0]);
    int32x4_t vacc67xAB = vreinterpretq_s32_u64(vbias01x89AB.val[1]);
    int32x4_t vacc67xCD = vreinterpretq_s32_u64(vbias01xCDEF.val[0]);
    int32x4_t vacc67xEF = vreinterpretq_s32_u64(vbias01xCDEF.val[1]);
    ...
    do {
      ...
      while (k >= 16 * sizeof(int8_t)) {
        ...
        vacc01xAB = vmmlaq_s32(vacc01xAB, vreinterpretq_s8_u64(va01x0123456789ABCDEF.val[0]), vb1011x01234567);
        vacc01xCD = vmmlaq_s32(vacc01xCD, vreinterpretq_s8_u64(va01x0123456789ABCDEF.val[0]), vb1213x01234567);
        vacc01xEF = vmmlaq_s32(vacc01xEF, vreinterpretq_s8_u64(va01x0123456789ABCDEF.val[0]), vb1415x01234567);
        ...
        vacc23xAB = vmmlaq_s32(vacc23xAB, vreinterpretq_s8_u64(va23x0123456789ABCDEF.val[0]), vb1011x01234567);
        vacc23xCD = vmmlaq_s32(vacc23xCD, vreinterpretq_s8_u64(va23x0123456789ABCDEF.val[0]), vb1213x01234567);
        vacc23xEF = vmmlaq_s32(vacc23xEF, vreinterpretq_s8_u64(va23x0123456789ABCDEF.val[0]), vb1415x01234567);
        ...
        vacc45xAB = vmmlaq_s32(vacc45xAB, vreinterpretq_s8_u64(va45x0123456789ABCDEF.val[0]), vb1011x01234567);
        vacc45xCD = vmmlaq_s32(vacc45xCD, vreinterpretq_s8_u64(va45x0123456789ABCDEF.val[0]), vb1213x01234567);
        vacc45xEF = vmmlaq_s32(vacc45xEF, vreinterpretq_s8_u64(va45x0123456789ABCDEF.val[0]), vb1415x01234567);
        ...
        vacc67xAB = vmmlaq_s32(vacc67xAB, vreinterpretq_s8_u64(va67x0123456789ABCDEF.val[0]), vb1011x01234567);
        vacc67xCD = vmmlaq_s32(vacc67xCD, vreinterpretq_s8_u64(va67x0123456789ABCDEF.val[0]), vb1213x01234567);
        vacc67xEF = vmmlaq_s32(vacc67xEF, vreinterpretq_s8_u64(va67x0123456789ABCDEF.val[0]), vb1415x01234567);
        ...
        vacc01xAB = vmmlaq_s32(vacc01xAB, vreinterpretq_s8_u64(va01x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
        vacc01xCD = vmmlaq_s32(vacc01xCD, vreinterpretq_s8_u64(va01x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
        vacc01xEF = vmmlaq_s32(vacc01xEF, vreinterpretq_s8_u64(va01x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
        ...
        vacc23xAB = vmmlaq_s32(vacc23xAB, vreinterpretq_s8_u64(va23x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
        vacc23xCD = vmmlaq_s32(vacc23xCD, vreinterpretq_s8_u64(va23x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
        vacc23xEF = vmmlaq_s32(vacc23xEF, vreinterpretq_s8_u64(va23x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
        ...
        vacc45xAB = vmmlaq_s32(vacc45xAB, vreinterpretq_s8_u64(va45x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
        vacc45xCD = vmmlaq_s32(vacc45xCD, vreinterpretq_s8_u64(va45x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
        vacc45xEF = vmmlaq_s32(vacc45xEF, vreinterpretq_s8_u64(va45x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
        ...
        vacc67xAB = vmmlaq_s32(vacc67xAB, vreinterpretq_s8_u64(va67x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
        vacc67xCD = vmmlaq_s32(vacc67xCD, vreinterpretq_s8_u64(va67x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
        vacc67xEF = vmmlaq_s32(vacc67xEF, vreinterpretq_s8_u64(va67x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
    ...
    vfpacc6x89AB = vmulq_f32(vfpacc6x89AB, vscale);
    vfpacc6xCDEF = vmulq_f32(vfpacc6xCDEF, vscale);
    vfpacc7x0123 = vmulq_f32(vfpacc7x0123, vscale);
    vfpacc7x4567 = vmulq_f32(vfpacc7x4567, vscale);
    vfpacc7x89AB = vmulq_f32(vfpacc7x89AB, vscale);
    vfpacc7xCDEF = vmulq_f32(vfpacc7xCDEF, vscale);
    ...
    if (nc >= 16) {
      vst1q_s8(c7, vout7x0123456789ABCDEF);
      vst1q_s8(c6, vout6x0123456789ABCDEF);
      vst1q_s8(c5, vout5x0123456789ABCDEF);
      vst1q_s8(c4, vout4x0123456789ABCDEF);

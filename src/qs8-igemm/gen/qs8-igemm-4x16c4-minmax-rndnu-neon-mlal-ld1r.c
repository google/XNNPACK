...
void xnn_qs8_igemm_minmax_rndnu_ukernel_4x16c4__neon_mlal_ld1r(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      while (k >= 16 * sizeof(int8_t)) {
        ...
        const int32x2_t va10x0 = vld1_dup_s32((const void*)a1);
        const int32x2_t va11x0 = vld1_dup_s32((const void*)(a1 + 4)); a1 += 8;
        const int32x2_t va10x1 = vld1_dup_s32((const void*)a1);
        const int32x2_t va11x1 = vld1_dup_s32((const void*)(a1 + 4)); a1 += 8;
        const int32x2_t va20x0 = vld1_dup_s32((const void*)a2);
        const int32x2_t va21x0 = vld1_dup_s32((const void*)(a2 + 4)); a2 += 8;
        const int32x2_t va20x1 = vld1_dup_s32((const void*)a2);
        const int32x2_t va21x1 = vld1_dup_s32((const void*)(a2 + 4)); a2 += 8;
        const int32x2_t va30x0 = vld1_dup_s32((const void*)a3);
        const int32x2_t va31x0 = vld1_dup_s32((const void*)(a3 + 4)); a3 += 8;
        const int32x2_t va30x1 = vld1_dup_s32((const void*)a3);
        const int32x2_t va31x1 = vld1_dup_s32((const void*)(a3 + 4)); a3 += 8;
        ...
        const int8x8_t va1c0x0 = vreinterpret_s8_s32(va10x0);
        const int8x8_t va1c0x1 = vreinterpret_s8_s32(va10x1);
        const int8x8_t va2c0x0 = vreinterpret_s8_s32(va20x0);
        const int8x8_t va2c0x1 = vreinterpret_s8_s32(va20x1);
        const int8x8_t va3c0x0 = vreinterpret_s8_s32(va30x0);
        const int8x8_t va3c0x1 = vreinterpret_s8_s32(va30x1);
        ...
        int16x8_t vprod3x89c0 = vmull_s8(vb89c0x0, va3c0x0);
        ...
        vprod3x89c0 = vmlal_s8(vprod3x89c0, vb89c0x1, va3c0x1);
        ...
        int16x8_t vprod3xABc0 = vmull_s8(vbABc0x0, va3c0x0);
        ...
        vprod3xABc0 = vmlal_s8(vprod3xABc0, vbABc0x1, va3c0x1);
        ...
        int16x8_t vprod3xCDc0 = vmull_s8(vbCDc0x0, va3c0x0);
        ...
        vprod3xCDc0 = vmlal_s8(vprod3xCDc0, vbCDc0x1, va3c0x1);
        ...
        int16x8_t vprod3xEFc0 = vmull_s8(vbEFc0x0, va3c0x0);
        ...
        vprod3xEFc0 = vmlal_s8(vprod3xEFc0, vbEFc0x1, va3c0x1);
        ...
        const int8x8_t va1c1x0 = vreinterpret_s8_s32(va11x0);
        const int8x8_t va1c1x1 = vreinterpret_s8_s32(va11x1);
        const int8x8_t va2c1x0 = vreinterpret_s8_s32(va21x0);
        const int8x8_t va2c1x1 = vreinterpret_s8_s32(va21x1);
        const int8x8_t va3c1x0 = vreinterpret_s8_s32(va31x0);
        const int8x8_t va3c1x1 = vreinterpret_s8_s32(va31x1);
        ...
        int16x8_t vprod3x89c1 = vmull_s8(vb89c1x0, va3c1x0);
        ...
        vprod3x89c1 = vmlal_s8(vprod3x89c1, vb89c1x1, va3c1x1);
        ...
        int16x8_t vprod3xABc1 = vmull_s8(vbABc1x0, va3c1x0);
        ...
        vprod3xABc1 = vmlal_s8(vprod3xABc1, vbABc1x1, va3c1x1);
        ...
        int16x8_t vprod3xCDc1 = vmull_s8(vbCDc1x0, va3c1x0);
        ...
        vprod3xCDc1 = vmlal_s8(vprod3xCDc1, vbCDc1x1, va3c1x1);
        ...
        int16x8_t vprod3xEFc1 = vmull_s8(vbEFc1x0, va3c1x0);
        ...
        vprod3xEFc1 = vmlal_s8(vprod3xEFc1, vbEFc1x1, va3c1x1);

...
void xnn_qs8_igemm_minmax_fp32_ukernel_6x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN XNN_DISABLE_MSAN
{
  ...
  do {
    ...
    float32x4_t vproduct4x89AB = vcvtq_f32_s32(vacc4x89AB);
    float32x4_t vproduct4xCDEF = vcvtq_f32_s32(vacc4xCDEF);
    float32x4_t vproduct5x0123 = vcvtq_f32_s32(vacc5x0123);
    float32x4_t vproduct5x4567 = vcvtq_f32_s32(vacc5x4567);
    float32x4_t vproduct5x89AB = vcvtq_f32_s32(vacc5x89AB);
    float32x4_t vproduct5xCDEF = vcvtq_f32_s32(vacc5xCDEF);
    ...
    vproduct4x89AB = vmulq_f32(vproduct4x89AB, vscale);
    vproduct4xCDEF = vmulq_f32(vproduct4xCDEF, vscale);
    vproduct5x0123 = vmulq_f32(vproduct5x0123, vscale);
    vproduct5x4567 = vmulq_f32(vproduct5x4567, vscale);
    vproduct5x89AB = vmulq_f32(vproduct5x89AB, vscale);
    vproduct5xCDEF = vmulq_f32(vproduct5xCDEF, vscale);

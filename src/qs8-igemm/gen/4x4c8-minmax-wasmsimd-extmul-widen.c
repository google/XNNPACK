...
void xnn_qs8_igemm_minmax_ukernel_4x4c8__wasmsimd_extmul_widen(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      while (k < kc) {
        ...
        vacc3x0 = wasm_i32x4_add(vacc3x0, wasm_i32x4_widen_low_i16x8(vprod3x0));
        vacc3x0 = wasm_i32x4_add(vacc3x0, wasm_i32x4_widen_high_i16x8(vprod3x0));
        ...
        vacc3x1 = wasm_i32x4_add(vacc3x1, wasm_i32x4_widen_low_i16x8(vprod3x1));
        vacc3x1 = wasm_i32x4_add(vacc3x1, wasm_i32x4_widen_high_i16x8(vprod3x1));
        ...
        vacc3x2 = wasm_i32x4_add(vacc3x2, wasm_i32x4_widen_low_i16x8(vprod3x2));
        vacc3x2 = wasm_i32x4_add(vacc3x2, wasm_i32x4_widen_high_i16x8(vprod3x2));
        ...
        vacc3x3 = wasm_i32x4_add(vacc3x3, wasm_i32x4_widen_low_i16x8(vprod3x3));
        vacc3x3 = wasm_i32x4_add(vacc3x3, wasm_i32x4_widen_high_i16x8(vprod3x3));

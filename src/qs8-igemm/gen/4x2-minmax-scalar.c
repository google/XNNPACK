    ...
    const union xnn_qs8_gemm_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vout3x0 = XNN_UNPREDICTABLE(vout3x0 < vout_min) ? vout_min : vout3x0;
    vout3x1 = XNN_UNPREDICTABLE(vout3x1 < vout_min) ? vout_min : vout3x1;
    ...
    vout3x0 = XNN_UNPREDICTABLE(vout3x0 > vout_max) ? vout_max : vout3x0;
    vout3x1 = XNN_UNPREDICTABLE(vout3x1 > vout_max) ? vout_max : vout3x1;

    ...
    const union xnn_qs8_gemm_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vout3x2 = XNN_UNPREDICTABLE(vout3x2 < vout_min) ? vout_min : vout3x2;
    vout3x3 = XNN_UNPREDICTABLE(vout3x3 < vout_min) ? vout_min : vout3x3;
    ...
    vout3x2 = XNN_UNPREDICTABLE(vout3x2 > vout_max) ? vout_max : vout3x2;
    vout3x3 = XNN_UNPREDICTABLE(vout3x3 > vout_max) ? vout_max : vout3x3;

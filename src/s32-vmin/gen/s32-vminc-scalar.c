...
//   Template: src/s32-vmin/s32-vminc.c.in
...
void xnn_s32_vminc_ukernel__scalar_u1(
    size_t batch,
...
void xnn_s32_vminc_ukernel__scalar_u2(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(int32_t); batch -= 2 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_min_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_min_s32(vin1_1, vin2);
...
void xnn_s32_vminc_ukernel__scalar_u4(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int32_t); batch -= 4 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_min_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_min_s32(vin1_1, vin2);
    xnn_simd_s32_t vy_2 = xnn_min_s32(vin1_2, vin2);
    xnn_simd_s32_t vy_3 = xnn_min_s32(vin1_3, vin2);
...
void xnn_s32_vminc_ukernel__scalar_u8(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int32_t); batch -= 8 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_2 = xnn_min_s32(vin1_2, vin2);
    xnn_simd_s32_t vy_3 = xnn_min_s32(vin1_3, vin2);
    xnn_simd_s32_t vy_4 = xnn_min_s32(vin1_4, vin2);
    xnn_simd_s32_t vy_5 = xnn_min_s32(vin1_5, vin2);
    xnn_simd_s32_t vy_6 = xnn_min_s32(vin1_6, vin2);
    xnn_simd_s32_t vy_7 = xnn_min_s32(vin1_7, vin2);

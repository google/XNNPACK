  ...
  for (size_t output_y = output_y_start; output_y < output_y_end; output_y += 2) {
    ...
    do {
      ...
      if (iw & 2) {
        ...
        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk00c0x0123, vi0x0, 1);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk00c0x0123, vi2x0, 1);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk00c0x4567, vi0x0, 1);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk00c0x4567, vi2x0, 1);

        const float32x4_t vk10c0x0123 = vld1q_f32(w + 16);
        const float32x4_t vk10c0x4567 = vld1q_f32(w + 20);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk10c0x0123, vi1x0, 1);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk10c0x0123, vi3x0, 1);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk10c0x4567, vi1x0, 1);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk10c0x4567, vi3x0, 1);

        const float32x4_t vk20c0x0123 = vld1q_f32(w + 24);
        const float32x4_t vk20c0x4567 = vld1q_f32(w + 28);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk20c0x0123, vi2x0, 1);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk20c0x0123, vi4x0, 1);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk20c0x4567, vi2x0, 1);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk20c0x4567, vi4x0, 1);

        const float32x4_t vk00c1x0123 = vld1q_f32(w + 32);
        const float32x4_t vk00c1x4567 = vld1q_f32(w + 36);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk00c1x0123, vi0x0, 2);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk00c1x0123, vi2x0, 2);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk00c1x4567, vi0x0, 2);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk00c1x4567, vi2x0, 2);

        const float32x4_t vk10c1x0123 = vld1q_f32(w + 40);
        const float32x4_t vk10c1x4567 = vld1q_f32(w + 44);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk10c1x0123, vi1x0, 2);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk10c1x0123, vi3x0, 2);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk10c1x4567, vi1x0, 2);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk10c1x4567, vi3x0, 2);

        const float32x4_t vk20c1x0123 = vld1q_f32(w + 48);
        const float32x4_t vk20c1x4567 = vld1q_f32(w + 52);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk20c1x0123, vi2x0, 2);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk20c1x0123, vi4x0, 2);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk20c1x4567, vi2x0, 2);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk20c1x4567, vi4x0, 2);

        const float32x4_t vk00c2x0123 = vld1q_f32(w + 56);
        const float32x4_t vk00c2x4567 = vld1q_f32(w + 60);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk00c2x0123, vi0x0, 3);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk00c2x0123, vi2x0, 3);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk00c2x4567, vi0x0, 3);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk00c2x4567, vi2x0, 3);

        const float32x4_t vk10c2x0123 = vld1q_f32(w + 64);
        const float32x4_t vk10c2x4567 = vld1q_f32(w + 68);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk10c2x0123, vi1x0, 3);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk10c2x0123, vi3x0, 3);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk10c2x4567, vi1x0, 3);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk10c2x4567, vi3x0, 3);

        const float32x4_t vk20c2x0123 = vld1q_f32(w + 72);
        const float32x4_t vk20c2x4567 = vld1q_f32(w + 76);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk20c2x0123, vi2x0, 3);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk20c2x0123, vi4x0, 3);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk20c2x4567, vi2x0, 3);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk20c2x4567, vi4x0, 3);
        ...
        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk01c0x0123, vi0x1, 0);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk01c0x0123, vi2x1, 0);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk01c0x4567, vi0x1, 0);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk01c0x4567, vi2x1, 0);

        const float32x4_t vk11c0x0123 = vld1q_f32(w + 88);
        const float32x4_t vk11c0x4567 = vld1q_f32(w + 92);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk11c0x0123, vi1x1, 0);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk11c0x0123, vi3x1, 0);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk11c0x4567, vi1x1, 0);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk11c0x4567, vi3x1, 0);

        const float32x4_t vk21c0x0123 = vld1q_f32(w + 96);
        const float32x4_t vk21c0x4567 = vld1q_f32(w + 100);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk21c0x0123, vi2x1, 0);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk21c0x0123, vi4x1, 0);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk21c0x4567, vi2x1, 0);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk21c0x4567, vi4x1, 0);

        const float32x4_t vk01c1x0123 = vld1q_f32(w + 104);
        const float32x4_t vk01c1x4567 = vld1q_f32(w + 108);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk01c1x0123, vi0x1, 1);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk01c1x0123, vi2x1, 1);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk01c1x4567, vi0x1, 1);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk01c1x4567, vi2x1, 1);

        const float32x4_t vk11c1x0123 = vld1q_f32(w + 112);
        const float32x4_t vk11c1x4567 = vld1q_f32(w + 116);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk11c1x0123, vi1x1, 1);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk11c1x0123, vi3x1, 1);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk11c1x4567, vi1x1, 1);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk11c1x4567, vi3x1, 1);

        const float32x4_t vk21c1x0123 = vld1q_f32(w + 120);
        const float32x4_t vk21c1x4567 = vld1q_f32(w + 124);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk21c1x0123, vi2x1, 1);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk21c1x0123, vi4x1, 1);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk21c1x4567, vi2x1, 1);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk21c1x4567, vi4x1, 1);

        const float32x4_t vk01c2x0123 = vld1q_f32(w + 128);
        const float32x4_t vk01c2x4567 = vld1q_f32(w + 132);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk01c2x0123, vi0x1, 2);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk01c2x0123, vi2x1, 2);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk01c2x4567, vi0x1, 2);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk01c2x4567, vi2x1, 2);

        const float32x4_t vk11c2x0123 = vld1q_f32(w + 136);
        const float32x4_t vk11c2x4567 = vld1q_f32(w + 140);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk11c2x0123, vi1x1, 2);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk11c2x0123, vi3x1, 2);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk11c2x4567, vi1x1, 2);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk11c2x4567, vi3x1, 2);

        const float32x4_t vk21c2x0123 = vld1q_f32(w + 144);
        const float32x4_t vk21c2x4567 = vld1q_f32(w + 148);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk21c2x0123, vi2x1, 2);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk21c2x0123, vi4x1, 2);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk21c2x4567, vi2x1, 2);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk21c2x4567, vi4x1, 2);

        const float32x4_t vk02c0x0123 = vld1q_f32(w + 152);
        const float32x4_t vk02c0x4567 = vld1q_f32(w + 156);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk02c0x0123, vi0x1, 3);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk02c0x0123, vi2x1, 3);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk02c0x4567, vi0x1, 3);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk02c0x4567, vi2x1, 3);

        const float32x4_t vk12c0x0123 = vld1q_f32(w + 160);
        const float32x4_t vk12c0x4567 = vld1q_f32(w + 164);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk12c0x0123, vi1x1, 3);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk12c0x0123, vi3x1, 3);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk12c0x4567, vi1x1, 3);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk12c0x4567, vi3x1, 3);

        const float32x4_t vk22c0x0123 = vld1q_f32(w + 168);
        const float32x4_t vk22c0x4567 = vld1q_f32(w + 172);

        vo0c0123 = vfmaq_laneq_f32(vo0c0123, vk22c0x0123, vi2x1, 3);
        vo1c0123 = vfmaq_laneq_f32(vo1c0123, vk22c0x0123, vi4x1, 3);
        vo0c4567 = vfmaq_laneq_f32(vo0c4567, vk22c0x4567, vi2x1, 3);
        vo1c4567 = vfmaq_laneq_f32(vo1c4567, vk22c0x4567, vi4x1, 3);

    ...
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int32_t); batch -= 8 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_2 = xnn_xor_s32(vin1_2, vin2_2);
    xnn_simd_s32_t vy_3 = xnn_xor_s32(vin1_3, vin2_3);
    xnn_simd_s32_t vy_4 = xnn_xor_s32(vin1_4, vin2_4);
    xnn_simd_s32_t vy_5 = xnn_xor_s32(vin1_5, vin2_5);
    xnn_simd_s32_t vy_6 = xnn_xor_s32(vin1_6, vin2_6);
    xnn_simd_s32_t vy_7 = xnn_xor_s32(vin1_7, vin2_7);

...
void xnn_s32_vandc_ukernel__avx512f_u16(
    size_t batch,
...
void xnn_s32_vandc_ukernel__avx512f_u48(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 48 * sizeof(int32_t); batch -= 48 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_and_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_and_s32(vin1_1, vin2);
    xnn_simd_s32_t vy_2 = xnn_and_s32(vin1_2, vin2);
...
void xnn_s32_vandc_ukernel__avx512f_u64(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(int32_t); batch -= 64 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_1 = xnn_and_s32(vin1_1, vin2);
    xnn_simd_s32_t vy_2 = xnn_and_s32(vin1_2, vin2);
    xnn_simd_s32_t vy_3 = xnn_and_s32(vin1_3, vin2);

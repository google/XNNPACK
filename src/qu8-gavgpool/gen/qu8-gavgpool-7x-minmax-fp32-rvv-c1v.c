...
void xnn_qu8_gavgpool_minmax_fp32_ukernel_7x__rvv_c1v(
    size_t rows,
    size_t channels,
    const uint8_t* input,
    size_t input_stride,
    ...
    const union xnn_qu8_avgpool_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  vint32m4_t init_bias_i32v = __riscv_vmv_v_x_i32m4(init_bias, __riscv_vsetvl_e8m1(channels));
  ...
  do {
    ...
    acc_i32v = __riscv_vadd_vv_i32m4(acc_i32v, init_bias_i32v, n);

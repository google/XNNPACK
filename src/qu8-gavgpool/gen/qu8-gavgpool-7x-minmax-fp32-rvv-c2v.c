...
void xnn_qu8_gavgpool_minmax_fp32_ukernel_7x__rvv_c2v(
    size_t rows,
    size_t channels,
    const uint8_t* input,
    size_t input_stride,
    ...
    const union xnn_qu8_avgpool_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vuint8m2_t i0_u8v = __riscv_vle8_v_u8m2(i0, n); i0 += n;
    vuint8m2_t i1_u8v = __riscv_vle8_v_u8m2(i1, n); i1 += n;
    vuint16m4_t acc_u16v = __riscv_vwaddu_vv_u16m4(i0_u8v, i1_u8v, n);
    i0_u8v = __riscv_vle8_v_u8m2(i2, n); i2 += n;
    acc_u16v = __riscv_vwaddu_wv_u16m4(acc_u16v, i0_u8v, n);
    i0_u8v = __riscv_vle8_v_u8m2(i3, n); i3 += n;
    acc_u16v = __riscv_vwaddu_wv_u16m4(acc_u16v, i0_u8v, n);
    i0_u8v = __riscv_vle8_v_u8m2(i4, n); i4 += n;
    acc_u16v = __riscv_vwaddu_wv_u16m4(acc_u16v, i0_u8v, n);
    i0_u8v = __riscv_vle8_v_u8m2(i5, n); i5 += n;
    acc_u16v = __riscv_vwaddu_wv_u16m4(acc_u16v, i0_u8v, n);
    i0_u8v = __riscv_vle8_v_u8m2(i6, n); i6 += n;
    acc_u16v = __riscv_vwaddu_wv_u16m4(acc_u16v, i0_u8v, n);
    ...
    out_u16v = __riscv_vsub_vx_u16m4(out_u16v, magic_bias_less_output_zero_point, n);

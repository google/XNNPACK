...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vrndd_ukernel__rvv_u1v, 1, true, float, struct xnn_f32_rnd_params, ((xnn_init_f32_rnd_params_fn) NULL))
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vrndd_ukernel__rvv_u2v, 2, true, float, struct xnn_f32_rnd_params, ((xnn_init_f32_rnd_params_fn) NULL))
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vrndd_ukernel__rvv_u4v, 4, true, float, struct xnn_f32_rnd_params, ((xnn_init_f32_rnd_params_fn) NULL))
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vrndd_ukernel__rvv_u8v, 8, true, float, struct xnn_f32_rnd_params, ((xnn_init_f32_rnd_params_fn) NULL))

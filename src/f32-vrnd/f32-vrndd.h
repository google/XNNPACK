...
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrndd_ukernel__hvx_u32, 32, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrndd_ukernel__hvx_u64, 64, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vrndd_ukernel__hvx_u128, 128, false, float, struct xnn_f32_default_params, NULL)

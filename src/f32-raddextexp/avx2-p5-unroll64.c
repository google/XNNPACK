...
void xnn_f32_raddextexp_ukernel__avx2_p5_unroll64(
    size_t n,
    const float* x,
    float* sum)
{
  ...
  for (; n >= 64 * sizeof(float); n -= 64 * sizeof(float)) {
    ...
    const __m256 vmax_e0 = _mm256_max_ps(_mm256_max_ps(vacce0, vn0), vn4);
    const __m256 vmax_e1 = _mm256_max_ps(_mm256_max_ps(vacce1, vn1), vn5);
    const __m256 vmax_e2 = _mm256_max_ps(_mm256_max_ps(vacce2, vn2), vn6);
    const __m256 vmax_e3 = _mm256_max_ps(_mm256_max_ps(vacce3, vn3), vn7);
  ...
  const __m256 vmax_acce0123 = _mm256_max_ps(_mm256_max_ps(vacce0, vacce1), _mm256_max_ps(vacce2, vacce3));
  ...
  if XNN_UNLIKELY(n != 0) {
    ...
    // Correct reduced argument n for masked out elements.

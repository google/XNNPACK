...
void xnn_f32_raddextexp_ukernel__avx512f_p5_scalef_unroll128(
    size_t n,
    const float* x,
    float* sum)
{
  ...
  for (; n >= 128 * sizeof(float); n -= 128 * sizeof(float)) {
    ...
    const __m512 vmax_e0 = _mm512_max_ps(_mm512_max_ps(vacce0, vn0), vn4);
    const __m512 vmax_e1 = _mm512_max_ps(_mm512_max_ps(vacce1, vn1), vn5);
    const __m512 vmax_e2 = _mm512_max_ps(_mm512_max_ps(vacce2, vn2), vn6);
    const __m512 vmax_e3 = _mm512_max_ps(_mm512_max_ps(vacce3, vn3), vn7);
  ...
  const __m512 vmax_acce0123 = _mm512_max_ps(_mm512_max_ps(vacce0, vacce1), _mm512_max_ps(vacce2, vacce3));
  ...
  __m512 vaccv = _mm512_add_ps(
    _mm512_add_ps(_mm512_scalef_ps(vaccv0, vdelta_acce0), _mm512_scalef_ps(vaccv1, vdelta_acce1)),
    _mm512_add_ps(_mm512_scalef_ps(vaccv2, vdelta_acce2), _mm512_scalef_ps(vaccv3, vdelta_acce3)));

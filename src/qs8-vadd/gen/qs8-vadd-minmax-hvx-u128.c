    ...
    const union xnn_qs8_add_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 128 * sizeof(int8_t); batch -= 128 * sizeof(int8_t)) {
    ...
    HVX_Vector vb2 = *((HVX_UVector*)(input_b + 64));
    HVX_Vector va3 = *((HVX_UVector*)(input_a + 96));
    HVX_Vector vb3 = *((HVX_UVector*)(input_b + 96));
    input_a += 128;
    input_b += 128;
    ...
    HVX_Vector va3_i16_lo = Q6_V_lo_W(Q6_Wh_vunpack_Vb(va3));
    HVX_Vector vb3_i16_lo = Q6_V_lo_W(Q6_Wh_vunpack_Vb(vb3));
    ...
    HVX_Vector va3_mul_e = Q6_Vw_vmpyio_VwVh(va_multiplier, Q6_Vh_vshuffe_VhVh(va3_i16_lo, va3_i16_lo));
    HVX_Vector vb3_mul_e = Q6_Vw_vmpyio_VwVh(vb_multiplier, Q6_Vh_vshuffe_VhVh(vb3_i16_lo, vb3_i16_lo));
    HVX_Vector va3_mul_o = Q6_Vw_vmpyio_VwVh(va_multiplier, va3_i16_lo);
    HVX_Vector vb3_mul_o = Q6_Vw_vmpyio_VwVh(vb_multiplier, vb3_i16_lo);
    HVX_VectorPair va3_mul = Q6_W_vshuff_VVR(va3_mul_o, va3_mul_e, -4);
    HVX_VectorPair vb3_mul = Q6_W_vshuff_VVR(vb3_mul_o, vb3_mul_e, -4);
    HVX_Vector vacc3 = Q6_Vw_vadd_VwVw(vbias, Q6_V_lo_W(va3_mul));
    vacc3 = Q6_Vw_vadd_VwVw(vacc3, Q6_V_lo_W(vb3_mul));

    // right shift
    vacc0 = Q6_Vw_vasr_VwR(vacc0, vshift);
    vacc1 = Q6_Vw_vasr_VwR(vacc1, vshift);
    vacc2 = Q6_Vw_vasr_VwR(vacc2, vshift);
    vacc3 = Q6_Vw_vasr_VwR(vacc3, vshift);
    ...
    HVX_Vector vout3 = Q6_Vh_vadd_VhVh(voutput_zero_point, Q6_Vh_vpack_VwVw_sat(vacc3, vacc3));
    ...
    vout3 = Q6_Vb_vpack_VhVh_sat(vout3, vout3);
    ...
    vout3 = Q6_Vb_vmax_VbVb(voutput_min, vout3);
    vout3 = Q6_Vb_vmin_VbVb(voutput_max, vout3);
    ...
    Q6_V_vstu_variable(ptr_o, 32, vout3); ptr_o += 32;
  }

...
void xnn_qd8_f16_qb4w_gemm_minmax_ukernel_3x16__neonfp16arith_mlal_lane_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const float32x4_t vzp2 = vcvtq_f32_s32(vld1q_dup_s32(&quantization_params[2].zero_point));
    float32x4_t vout2x0123 = vmulq_f32(vksum0123, vzp2);
    float32x4_t vout2x4567 = vmulq_f32(vksum4567, vzp2);

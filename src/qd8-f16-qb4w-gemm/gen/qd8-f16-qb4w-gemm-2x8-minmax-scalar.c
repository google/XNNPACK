    ...
    const struct xnn_qd8_quantization_params quantization_params[XNN_MIN_ELEMENTS(2)])
{
  ...
  do {
    ...
    float vout1x2 = vinput_zero_point1 * vksum2;
    float vout1x3 = vinput_zero_point1 * vksum3;
    float vout1x4 = vinput_zero_point1 * vksum4;
    float vout1x5 = vinput_zero_point1 * vksum5;
    float vout1x6 = vinput_zero_point1 * vksum6;
    float vout1x7 = vinput_zero_point1 * vksum7;

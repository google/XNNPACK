    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_DISABLE_UBSAN
{
  ...
  do {
    ...
    // accumulate in float
      ...
      float vf0x2 = vacc0x2;
      const float vfilter_output_scale2 = math_cvt_fp32_bf16(unaligned_indexed_load_u16(w, 2));
      float vf0x3 = vacc0x3;
      const float vfilter_output_scale3 = math_cvt_fp32_bf16(unaligned_indexed_load_u16(w, 3));
      float vf0x4 = vacc0x4;
      const float vfilter_output_scale4 = math_cvt_fp32_bf16(unaligned_indexed_load_u16(w, 4));
      float vf0x5 = vacc0x5;
      const float vfilter_output_scale5 = math_cvt_fp32_bf16(unaligned_indexed_load_u16(w, 5));
      float vf0x6 = vacc0x6;
      const float vfilter_output_scale6 = math_cvt_fp32_bf16(unaligned_indexed_load_u16(w, 6));
      float vf0x7 = vacc0x7;
      const float vfilter_output_scale7 = math_cvt_fp32_bf16(unaligned_indexed_load_u16(w, 7));
      float vf1x0 = vacc1x0;
      float vf1x1 = vacc1x1;
      float vf1x2 = vacc1x2;
      float vf1x3 = vacc1x3;
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      c0[4] = xnn_float16_from_float(vout0x4);
      c0[5] = xnn_float16_from_float(vout0x5);
      c0[6] = xnn_float16_from_float(vout0x6);
      c0[7] = xnn_float16_from_float(vout0x7);
      ...
      c1[4] = xnn_float16_from_float(vout1x4);
      c1[5] = xnn_float16_from_float(vout1x5);
      c1[6] = xnn_float16_from_float(vout1x6);
      c1[7] = xnn_float16_from_float(vout1x7);

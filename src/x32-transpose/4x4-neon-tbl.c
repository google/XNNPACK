    ...
    size_t block_height)
{
  ...
  do{
    ...
    for (; bh >= 4; bh -= 4){
      uint8x8x4_t v0, v1;
      v0.val[0] = vld1_u8(i0);
      i0 = (uint8_t*) ((uintptr_t) i0 + load_bytes);
      v0.val[1] = vld1_u8(i1);
      i1 = (uint8_t*) ((uintptr_t) i1 + load_bytes);
      v0.val[2] = vld1_u8(i2);
      i2 = (uint8_t*) ((uintptr_t) i2 + load_bytes);
      v0.val[3] = vld1_u8(i3);
      i3 = (uint8_t*) ((uintptr_t) i3 + load_bytes);
      v1.val[0] = vld1_u8(i0);

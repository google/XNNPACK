...
void xnn_qs8_vcvt_ukernel__rvv_u2v(
    size_t batch,
    const int8_t* input,
    int8_t* output,
    const struct xnn_qs8_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vint8m2_t acc_i8v = __riscv_vle8_v_i8m2(input, n); input += n;
    vint16m4_t acc_i16v = __riscv_vwcvt_x_x_v_i16m4(acc_i8v, n);
    vint32m8_t acc_i32v = __riscv_vwmacc_vx_i32m8(bias_i32v, multiplier, acc_i16v, n);

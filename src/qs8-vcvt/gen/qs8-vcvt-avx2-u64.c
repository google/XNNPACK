...
void xnn_qs8_vcvt_ukernel__avx2_u64(
    size_t batch,
    const int8_t* input,
    int8_t* output,
    const struct xnn_qs8_cvt_params* restrict params) XNN_OOB_READS
{
  ...
  for (; batch >= 64 * sizeof(int8_t); batch -= 64 * sizeof(int8_t)) {
    ...
    const __m128i vx2 = _mm_loadu_si128((const __m128i*) (input + 32));
    __m256i vacc_lo2 = _mm256_cvtepi8_epi32(vx2);
    __m256i vacc_hi2 = _mm256_cvtepi8_epi32(_mm_srli_si128(vx2, 8));
    const __m128i vx3 = _mm_loadu_si128((const __m128i*) (input + 48));
    __m256i vacc_lo3 = _mm256_cvtepi8_epi32(vx3);
    __m256i vacc_hi3 = _mm256_cvtepi8_epi32(_mm_srli_si128(vx3, 8));
    input += 64;
    ...
    vacc_lo2 = _mm256_add_epi32(_mm256_mullo_epi32(vacc_lo2, vmultiplier), vbias);
    vacc_hi2 = _mm256_add_epi32(_mm256_mullo_epi32(vacc_hi2, vmultiplier), vbias);
    vacc_lo3 = _mm256_add_epi32(_mm256_mullo_epi32(vacc_lo3, vmultiplier), vbias);
    vacc_hi3 = _mm256_add_epi32(_mm256_mullo_epi32(vacc_hi3, vmultiplier), vbias);
    ...
    vacc_lo2 = _mm256_srai_epi32(vacc_lo2, 16);
    vacc_hi2 = _mm256_srai_epi32(vacc_hi2, 16);
    vacc_lo3 = _mm256_srai_epi32(vacc_lo3, 16);
    vacc_hi3 = _mm256_srai_epi32(vacc_hi3, 16);
    ...
    __m256i vacc2 = _mm256_packs_epi32(vacc_lo2, vacc_hi2);
    vacc2 = _mm256_permute4x64_epi64(vacc2, _MM_SHUFFLE(3, 1, 2, 0));
    __m256i vacc3 = _mm256_packs_epi32(vacc_lo3, vacc_hi3);
    vacc3 = _mm256_permute4x64_epi64(vacc3, _MM_SHUFFLE(3, 1, 2, 0));

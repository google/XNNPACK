    ...
    const struct xnn_qs8_cvt_params* restrict params) XNN_OOB_READS
{
  ...
  for (; batch >= 32 * sizeof(int8_t); batch -= 32 * sizeof(int8_t)) {
    ...
    __m128i vacc_lo2 = _mm_cvtepi16_epi32(vacc2);
    __m128i vacc_hi2 = _mm_cvtepi16_epi32(_mm_srli_si128(vacc2, 8));
    __m128i vacc_lo3 = _mm_cvtepi16_epi32(vacc3);
    __m128i vacc_hi3 = _mm_cvtepi16_epi32(_mm_srli_si128(vacc3, 8));
    ...
    vacc_lo2 = _mm_add_epi32(_mm_mullo_epi32(vacc_lo2, vmultiplier), vbias);
    vacc_hi2 = _mm_add_epi32(_mm_mullo_epi32(vacc_hi2, vmultiplier), vbias);
    vacc_lo3 = _mm_add_epi32(_mm_mullo_epi32(vacc_lo3, vmultiplier), vbias);
    vacc_hi3 = _mm_add_epi32(_mm_mullo_epi32(vacc_hi3, vmultiplier), vbias);

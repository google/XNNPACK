    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k != 0) {
      ...
      vacc5x01234567 = _mm256_dpbusd_avx_epi32(vacc5x01234567, va5x0123, vb01234567);
      vacc6x01234567 = _mm256_dpbusd_avx_epi32(vacc6x01234567, va6x0123, vb01234567);
      vacc7x01234567 = _mm256_dpbusd_avx_epi32(vacc7x01234567, va7x0123, vb01234567);

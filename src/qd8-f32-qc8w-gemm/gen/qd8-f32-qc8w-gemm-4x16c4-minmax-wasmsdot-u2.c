...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x16c4__wasmsdot_u2(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params* restrict quantization_params) XNN_OOB_READS
{
  ...
  do {
    ...
    v128_t vacc0x0x0123 = wasm_i32x4_mul(vksum0123, vinput_zero_point0);
    v128_t vacc0x0x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point0);
    v128_t vacc0x0x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point0);
    v128_t vacc0x0xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point0);
    const v128_t vinput_zero_point1 = wasm_v128_load32_splat(&quantization_params[1].zero_point);
    v128_t vacc1x0x0123 = wasm_i32x4_mul(vksum0123, vinput_zero_point1);
    v128_t vacc1x0x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point1);
    v128_t vacc1x0x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point1);
    v128_t vacc1x0xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point1);
    const v128_t vinput_zero_point2 = wasm_v128_load32_splat(&quantization_params[2].zero_point);
    v128_t vacc2x0x0123 = wasm_i32x4_mul(vksum0123, vinput_zero_point2);
    v128_t vacc2x0x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point2);
    v128_t vacc2x0x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point2);
    v128_t vacc2x0xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point2);
    const v128_t vinput_zero_point3 = wasm_v128_load32_splat(&quantization_params[3].zero_point);
    v128_t vacc3x0x0123 = wasm_i32x4_mul(vksum0123, vinput_zero_point3);
    v128_t vacc3x0x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point3);
    v128_t vacc3x0x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point3);
    v128_t vacc3x0xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point3);
    ...
    vacc0x0x0123 = wasm_f32x4_mul(vacc0x0x0123, vinput_scale0);
    vacc0x0x4567 = wasm_f32x4_mul(vacc0x0x4567, vinput_scale0);
    vacc0x0x89AB = wasm_f32x4_mul(vacc0x0x89AB, vinput_scale0);
    vacc0x0xCDEF = wasm_f32x4_mul(vacc0x0xCDEF, vinput_scale0);
    vacc1x0x0123 = wasm_f32x4_mul(vacc1x0x0123, vinput_scale1);
    vacc1x0x4567 = wasm_f32x4_mul(vacc1x0x4567, vinput_scale1);
    vacc1x0x89AB = wasm_f32x4_mul(vacc1x0x89AB, vinput_scale1);
    vacc1x0xCDEF = wasm_f32x4_mul(vacc1x0xCDEF, vinput_scale1);
    vacc2x0x0123 = wasm_f32x4_mul(vacc2x0x0123, vinput_scale2);
    vacc2x0x4567 = wasm_f32x4_mul(vacc2x0x4567, vinput_scale2);
    vacc2x0x89AB = wasm_f32x4_mul(vacc2x0x89AB, vinput_scale2);
    vacc2x0xCDEF = wasm_f32x4_mul(vacc2x0xCDEF, vinput_scale2);
    vacc3x0x0123 = wasm_f32x4_mul(vacc3x0x0123, vinput_scale3);
    vacc3x0x4567 = wasm_f32x4_mul(vacc3x0x4567, vinput_scale3);
    vacc3x0x89AB = wasm_f32x4_mul(vacc3x0x89AB, vinput_scale3);
    vacc3x0xCDEF = wasm_f32x4_mul(vacc3x0xCDEF, vinput_scale3);

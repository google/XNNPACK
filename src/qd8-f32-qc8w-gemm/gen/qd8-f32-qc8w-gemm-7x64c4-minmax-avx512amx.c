...
// Update if amxintrin changes
  ...
  do {
    ...
    __m512i vacc1xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[1].zero_point));
    ...
    __m512i vacc2xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[2].zero_point));
    ...
    __m512i vacc3xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[3].zero_point));
    ...
    __m512i vacc4xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[4].zero_point));
    ...
    __m512i vacc5xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[5].zero_point));
    ...
    __m512i vacc6xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[6].zero_point));
    ...
    vacc1xmnopqrstuvwxyz = _mm512_add_epi32(vacc1xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 16));
    ...
    vacc2xmnopqrstuvwxyz = _mm512_add_epi32(vacc2xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 32));
    ...
    vacc3xmnopqrstuvwxyz = _mm512_add_epi32(vacc3xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 48));
    ...
    vacc4xmnopqrstuvwxyz = _mm512_add_epi32(vacc4xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 64));
    ...
    vacc5xmnopqrstuvwxyz = _mm512_add_epi32(vacc5xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 80));
    ...
    vacc6xmnopqrstuvwxyz = _mm512_add_epi32(vacc6xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 96));
    ...
    __m512 vscaled1xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc1xmnopqrstuvwxyz);
    ...
    __m512 vscaled2xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc2xmnopqrstuvwxyz);
    ...
    __m512 vscaled3xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc3xmnopqrstuvwxyz);
    ...
    __m512 vscaled4xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc4xmnopqrstuvwxyz);
    ...
    __m512 vscaled5xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc5xmnopqrstuvwxyz);
    ...
    __m512 vscaled6xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc6xmnopqrstuvwxyz);
    ...
    vscaled1xmnopqrstuvwxyz = _mm512_mul_ps(vscaled1xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[1].inv_scale));
    ...
    vscaled2xmnopqrstuvwxyz = _mm512_mul_ps(vscaled2xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[2].inv_scale));
    ...
    vscaled3xmnopqrstuvwxyz = _mm512_mul_ps(vscaled3xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[3].inv_scale));
    ...
    vscaled4xmnopqrstuvwxyz = _mm512_mul_ps(vscaled4xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[4].inv_scale));
    ...
    vscaled5xmnopqrstuvwxyz = _mm512_mul_ps(vscaled5xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[5].inv_scale));
    ...
    vscaled6xmnopqrstuvwxyz = _mm512_mul_ps(vscaled6xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[6].inv_scale));
    ...
    vscaled1xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled1xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled2xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled2xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled3xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled3xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled4xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled4xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled5xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled5xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled6xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled6xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled1xmnopqrstuvwxyz = _mm512_max_ps(vscaled1xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled2xmnopqrstuvwxyz = _mm512_max_ps(vscaled2xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled3xmnopqrstuvwxyz = _mm512_max_ps(vscaled3xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled4xmnopqrstuvwxyz = _mm512_max_ps(vscaled4xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled5xmnopqrstuvwxyz = _mm512_max_ps(vscaled5xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled6xmnopqrstuvwxyz = _mm512_max_ps(vscaled6xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled1xmnopqrstuvwxyz = _mm512_min_ps(vscaled1xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled2xmnopqrstuvwxyz = _mm512_min_ps(vscaled2xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled3xmnopqrstuvwxyz = _mm512_min_ps(vscaled3xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled4xmnopqrstuvwxyz = _mm512_min_ps(vscaled4xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled5xmnopqrstuvwxyz = _mm512_min_ps(vscaled5xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled6xmnopqrstuvwxyz = _mm512_min_ps(vscaled6xmnopqrstuvwxyz, voutput_max);
    ...
    if XNN_LIKELY(nc >= 64) {
      ...
      _mm512_storeu_ps(c6 + 48, vscaled6xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c5 + 48, vscaled5xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c4 + 48, vscaled4xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c3 + 48, vscaled3xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c2 + 48, vscaled2xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c1 + 48, vscaled1xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c6 + 48, vmask3, vscaled6xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c5 + 48, vmask3, vscaled5xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c4 + 48, vmask3, vscaled4xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c3 + 48, vmask3, vscaled3xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c2 + 48, vmask3, vscaled2xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c1 + 48, vmask3, vscaled1xmnopqrstuvwxyz);

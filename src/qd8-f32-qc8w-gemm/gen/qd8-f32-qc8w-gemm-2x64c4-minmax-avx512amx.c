...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_2x64c4__avx512amx(
    size_t mr,
    size_t nc,
    size_t kc,
...
// Update if amxintrin changes
  ...
  __attribute__((aligned(64))) int32_t res1[2 * 16];
  __attribute__((aligned(64))) int32_t res2[2 * 16];
  __attribute__((aligned(64))) int32_t res3[2 * 16];

    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    vacc0x7x0123456789ABCDEF = _mm512_add_epi32(vacc0x7x0123456789ABCDEF, vacc1x7x0123456789ABCDEF);
    ...
    if (k != 0) {
      ...
      vacc0x7x0123456789ABCDEF = _mm512_dpbusd_epi32(vacc0x7x0123456789ABCDEF, va7x0123, vb0123456789ABCDEF);
    ...
    __m512 vscaled7x0123456789ABCDEF = _mm512_cvtepi32_ps(vacc0x7x0123456789ABCDEF);

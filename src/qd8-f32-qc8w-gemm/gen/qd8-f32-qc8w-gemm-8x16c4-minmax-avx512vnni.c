...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_8x16c4__avx512vnni(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m512i vacc0x7x0123456789ABCDEF = _mm512_mullo_epi32(vksum0123456789ABCDEF, vinput_zero_point7);
    ...
    while (k >= 8 * sizeof(int8_t)) {
      ...
      vacc0x7x0123456789ABCDEF = _mm512_dpbusd_epi32(vacc0x7x0123456789ABCDEF, va7x0123, vb0123456789ABCDEFx0123);
    ...
    __m512i vacc6x0123456789ABCDEF = _mm512_add_epi32(vacc0x6x0123456789ABCDEF, vacc1x6x0123456789ABCDEF);
    __m512i vacc7x0123456789ABCDEF = _mm512_add_epi32(vacc0x7x0123456789ABCDEF, vacc1x7x0123456789ABCDEF);

...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_11x64c4__avx512amx(
    size_t mr,
    size_t nc,
    size_t kc,
...
// Update if amxintrin changes
  ...
  __attribute__((aligned(64))) int32_t res0[11 * 16];
  __attribute__((aligned(64))) int32_t res1[11 * 16];
  __attribute__((aligned(64))) int32_t res2[11 * 16];
  __attribute__((aligned(64))) int32_t res3[11 * 16];

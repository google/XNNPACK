...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_7x8c8__avx512skx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const __m256i vinput_zero_point3 = _mm256_set1_epi32((int) qp3->zero_point);
    ...
    const __m256i vinput_zero_point4 = _mm256_set1_epi32((int) qp4->zero_point);
    ...
    const __m256i vinput_zero_point5 = _mm256_set1_epi32((int) qp5->zero_point);
    ...
    const __m256i vinput_zero_point6 = _mm256_set1_epi32((int) qp6->zero_point);
    ...
    const __m256 vinput_scale3 = _mm256_broadcast_ss(&qp3->inv_scale);
    __m256 vout4x01234567 = _mm256_cvtepi32_ps(vacc4x01234567);
    const __m256 vinput_scale4 = _mm256_broadcast_ss(&qp4->inv_scale);
    __m256 vout5x01234567 = _mm256_cvtepi32_ps(vacc5x01234567);
    const __m256 vinput_scale5 = _mm256_broadcast_ss(&qp5->inv_scale);
    __m256 vout6x01234567 = _mm256_cvtepi32_ps(vacc6x01234567);
    const __m256 vinput_scale6 = _mm256_broadcast_ss(&qp6->inv_scale);

...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x16c4__wasmusdot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    v128_t vacc0x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point0);
    v128_t vacc0xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point0);
    ...
    v128_t vacc1x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point1);
    v128_t vacc1x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point1);
    v128_t vacc1xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point1);
    ...
    v128_t vacc2x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point2);
    v128_t vacc2x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point2);
    v128_t vacc2xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point2);
    ...
    v128_t vacc3x4567 = wasm_i32x4_mul(vksum4567, vinput_zero_point3);
    v128_t vacc3x89AB = wasm_i32x4_mul(vksum89AB, vinput_zero_point3);
    v128_t vacc3xCDEF = wasm_i32x4_mul(vksumCDEF, vinput_zero_point3);
    ...
    vacc0x89AB = wasm_f32x4_mul(vacc0x89AB, vinput_scale0);
    vacc0xCDEF = wasm_f32x4_mul(vacc0xCDEF, vinput_scale0);
    vacc1x0123 = wasm_f32x4_mul(vacc1x0123, vinput_scale1);
    vacc1x4567 = wasm_f32x4_mul(vacc1x4567, vinput_scale1);
    vacc1x89AB = wasm_f32x4_mul(vacc1x89AB, vinput_scale1);
    vacc1xCDEF = wasm_f32x4_mul(vacc1xCDEF, vinput_scale1);
    vacc2x0123 = wasm_f32x4_mul(vacc2x0123, vinput_scale2);
    vacc2x4567 = wasm_f32x4_mul(vacc2x4567, vinput_scale2);
    vacc2x89AB = wasm_f32x4_mul(vacc2x89AB, vinput_scale2);
    vacc2xCDEF = wasm_f32x4_mul(vacc2xCDEF, vinput_scale2);
    vacc3x0123 = wasm_f32x4_mul(vacc3x0123, vinput_scale3);
    vacc3x4567 = wasm_f32x4_mul(vacc3x4567, vinput_scale3);
    vacc3x89AB = wasm_f32x4_mul(vacc3x89AB, vinput_scale3);
    vacc3xCDEF = wasm_f32x4_mul(vacc3xCDEF, vinput_scale3);

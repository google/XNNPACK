...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_3x4c8__wasmsimd_dot16x2_ld128(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const v128_t vinit2x02 = wasm_i64x2_shl(vinit2x0123, 32);
    const v128_t vinit2x13 = wasm_u64x2_shr(vinit2x0123, 32);
    ...
    v128_t vacc2x0 = wasm_v64x2_shuffle(vinit2x02, vzero, 0, 2);
    v128_t vacc2x1 = wasm_v64x2_shuffle(vinit2x13, vzero, 0, 2);
    v128_t vacc2x2 = wasm_v64x2_shuffle(vinit2x02, vzero, 1, 3);
    v128_t vacc2x3 = wasm_v64x2_shuffle(vinit2x13, vzero, 1, 3);
    w = (const int32_t*) w + 4;

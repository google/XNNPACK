    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    const float vbscale4 = ((const float*) w)[4];
    const float vbscale5 = ((const float*) w)[5];
    const float vbscale6 = ((const float*) w)[6];
    const float vbscale7 = ((const float*) w)[7];
    ...
    vout0x2 = math_muladd_f32(vout0x2, vascale0 * vbscale2, vbias2);
    const float vbias3 = ((const float*) w)[11];
    vout0x3 = math_muladd_f32(vout0x3, vascale0 * vbscale3, vbias3);
    const float vbias4 = ((const float*) w)[12];
    vout0x4 = math_muladd_f32(vout0x4, vascale0 * vbscale4, vbias4);
    const float vbias5 = ((const float*) w)[13];
    vout0x5 = math_muladd_f32(vout0x5, vascale0 * vbscale5, vbias5);
    const float vbias6 = ((const float*) w)[14];
    vout0x6 = math_muladd_f32(vout0x6, vascale0 * vbscale6, vbias6);
    const float vbias7 = ((const float*) w)[15];
    vout0x7 = math_muladd_f32(vout0x7, vascale0 * vbscale7, vbias7);

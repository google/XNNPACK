    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vout1x4 = math_muladd_f32(vout1x4, vascale1 * vbscale4, vbias4);
    vout1x5 = math_muladd_f32(vout1x5, vascale1 * vbscale5, vbias5);
    vout1x6 = math_muladd_f32(vout1x6, vascale1 * vbscale6, vbias6);
    vout1x7 = math_muladd_f32(vout1x7, vascale1 * vbscale7, vbias7);

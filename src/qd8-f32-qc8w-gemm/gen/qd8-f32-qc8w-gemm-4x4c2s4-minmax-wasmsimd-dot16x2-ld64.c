...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x4c2s4__wasmsimd_dot16x2_ld64(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const v128_t vinput_zero_point3 = wasm_v128_load32_splat(&qp3->zero_point);
    ...
    const v128_t vinput_scale3 = wasm_v128_load32_splat(&qp3->inv_scale);

...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_5x8c4__avxvnni_u1(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256i vacc4x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point4);
    w = (const int32_t*) w + 8;
    ...
    while (k != 0) {
      ...
      vacc4x01234567 = _mm256_dpbusd_avx_epi32(vacc4x01234567, va4x0123, vb01234567);

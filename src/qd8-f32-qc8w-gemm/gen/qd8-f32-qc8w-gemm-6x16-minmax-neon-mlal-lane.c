...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_6x16__neon_mlal_lane(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const float32x4_t vscale2x89AB = vmulq_lane_f32(vbscale89AB, vget_low_f32(vinput_scale23), 1);
    const float32x4_t vscale3x89AB = vmulq_lane_f32(vbscale89AB, vget_high_f32(vinput_scale23), 1);
    const float32x4_t vscale2xCDEF = vmulq_lane_f32(vbscaleCDEF, vget_low_f32(vinput_scale23), 1);
    const float32x4_t vscale3xCDEF = vmulq_lane_f32(vbscaleCDEF, vget_high_f32(vinput_scale23), 1);
    const float32x4_t vinput_scale45 = vreinterpretq_f32_s32(vld1q_s32(&quantization_params[4].zero_point));
    const float32x4_t vscale4x0123 = vmulq_lane_f32(vbscale0123, vget_low_f32(vinput_scale45), 1);
    const float32x4_t vscale5x0123 = vmulq_lane_f32(vbscale0123, vget_high_f32(vinput_scale45), 1);
    const float32x4_t vscale4x4567 = vmulq_lane_f32(vbscale4567, vget_low_f32(vinput_scale45), 1);
    const float32x4_t vscale5x4567 = vmulq_lane_f32(vbscale4567, vget_high_f32(vinput_scale45), 1);
    const float32x4_t vscale4x89AB = vmulq_lane_f32(vbscale89AB, vget_low_f32(vinput_scale45), 1);
    const float32x4_t vscale5x89AB = vmulq_lane_f32(vbscale89AB, vget_high_f32(vinput_scale45), 1);
    const float32x4_t vscale4xCDEF = vmulq_lane_f32(vbscaleCDEF, vget_low_f32(vinput_scale45), 1);
    const float32x4_t vscale5xCDEF = vmulq_lane_f32(vbscaleCDEF, vget_high_f32(vinput_scale45), 1);
    ...
    const float32x4_t vbiasCDEF = vld1q_f32(w); w = (const float*) w + 4;
      ...
      vout3x89AB = vfmaq_f32(vbias89AB, vout3x89AB, vscale3x89AB);
      vout2xCDEF = vfmaq_f32(vbiasCDEF, vout2xCDEF, vscale2xCDEF);
      vout3xCDEF = vfmaq_f32(vbiasCDEF, vout3xCDEF, vscale3xCDEF);
    #else
      ...
      vout3x89AB = vmlaq_f32(vbias89AB, vout3x89AB, vscale3x89AB);
      vout2xCDEF = vmlaq_f32(vbiasCDEF, vout2xCDEF, vscale2xCDEF);
      vout3xCDEF = vmlaq_f32(vbiasCDEF, vout3xCDEF, vscale3xCDEF);
    #endif
    #if XNN_ARCH_ARM64
      vout4x0123 = vfmaq_f32(vbias0123, vout4x0123, vscale4x0123);
      vout5x0123 = vfmaq_f32(vbias0123, vout5x0123, vscale5x0123);
      vout4x4567 = vfmaq_f32(vbias4567, vout4x4567, vscale4x4567);
      vout5x4567 = vfmaq_f32(vbias4567, vout5x4567, vscale5x4567);
      vout4x89AB = vfmaq_f32(vbias89AB, vout4x89AB, vscale4x89AB);
      vout5x89AB = vfmaq_f32(vbias89AB, vout5x89AB, vscale5x89AB);
      vout4xCDEF = vfmaq_f32(vbiasCDEF, vout4xCDEF, vscale4xCDEF);
      vout5xCDEF = vfmaq_f32(vbiasCDEF, vout5xCDEF, vscale5xCDEF);
    #else
      vout4x0123 = vmlaq_f32(vbias0123, vout4x0123, vscale4x0123);
      vout5x0123 = vmlaq_f32(vbias0123, vout5x0123, vscale5x0123);
      vout4x4567 = vmlaq_f32(vbias4567, vout4x4567, vscale4x4567);
      vout5x4567 = vmlaq_f32(vbias4567, vout5x4567, vscale5x4567);
      vout4x89AB = vmlaq_f32(vbias89AB, vout4x89AB, vscale4x89AB);
      vout5x89AB = vmlaq_f32(vbias89AB, vout5x89AB, vscale5x89AB);
      vout4xCDEF = vmlaq_f32(vbiasCDEF, vout4xCDEF, vscale4xCDEF);
      vout5xCDEF = vmlaq_f32(vbiasCDEF, vout5xCDEF, vscale5xCDEF);
    #endif

...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x4c8__wasmsimd_dot16x2_ld128(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const v128_t vinit3x02 = wasm_i64x2_shl(vinit3x0123, 32);
    const v128_t vinit3x13 = wasm_u64x2_shr(vinit3x0123, 32);
    ...
    v128_t vacc3x0 = wasm_v64x2_shuffle(vinit3x02, vzero, 0, 2);
    v128_t vacc3x1 = wasm_v64x2_shuffle(vinit3x13, vzero, 0, 2);
    v128_t vacc3x2 = wasm_v64x2_shuffle(vinit3x02, vzero, 1, 3);
    v128_t vacc3x3 = wasm_v64x2_shuffle(vinit3x13, vzero, 1, 3);
    w = (const int32_t*) w + 4;

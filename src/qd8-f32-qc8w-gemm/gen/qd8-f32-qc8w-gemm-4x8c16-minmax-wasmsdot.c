...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x8c16__wasmsdot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    v128_t vacc2x4 = wasm_i32x4_mul(vksum4, vinput_zero_point2);
    v128_t vacc2x5 = wasm_i32x4_mul(vksum5, vinput_zero_point2);
    v128_t vacc2x6 = wasm_i32x4_mul(vksum6, vinput_zero_point2);
    v128_t vacc2x7 = wasm_i32x4_mul(vksum7, vinput_zero_point2);
    ...
    v128_t vacc3x4 = wasm_i32x4_mul(vksum4, vinput_zero_point3);
    v128_t vacc3x5 = wasm_i32x4_mul(vksum5, vinput_zero_point3);
    v128_t vacc3x6 = wasm_i32x4_mul(vksum6, vinput_zero_point3);
    v128_t vacc3x7 = wasm_i32x4_mul(vksum7, vinput_zero_point3);
    w = (const int32_t*) w + 8;

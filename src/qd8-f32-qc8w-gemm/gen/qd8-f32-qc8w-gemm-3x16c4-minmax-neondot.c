    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    const float32x4_t vscale2x0123 = vmulq_f32(vinput_scale2, vbscale0123);
    const float32x4_t vscale2x4567 = vmulq_f32(vinput_scale2, vbscale4567);
    const float32x4_t vscale2x89AB = vmulq_f32(vinput_scale2, vbscale89AB);
    const float32x4_t vscale2xCDEF = vmulq_f32(vinput_scale2, vbscaleCDEF);
    #if XNN_ARCH_ARM64

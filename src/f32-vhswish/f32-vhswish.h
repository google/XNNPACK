...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f32_vhswish_ukernel__neon_u4, 4, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f32_vhswish_ukernel__neon_u8, 8, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f32_vhswish_ukernel__neon_u16, 16, false, float, struct xnn_f32_default_params, NULL)
#endif  // XNN_ARCH_ARM || XNN_ARCH_ARM64

#if XNN_ARCH_RISCV && XNN_ENABLE_RISCV_VECTOR
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vhswish_ukernel__rvv_u1v, 1, true, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vhswish_ukernel__rvv_u2v, 2, true, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vhswish_ukernel__rvv_u4v, 4, true, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_f32_vhswish_ukernel__rvv_u8v, 8, true, float, struct xnn_f32_default_params, NULL)
...
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vhswish_ukernel__wasmsimd_u4, 4, false, float, struct xnn_f32_default_params, NULL)
...
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vhswish_ukernel__hvx_u64, 64, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vhswish_ukernel__hvx_u128, 128, false, float, struct xnn_f32_default_params, NULL)
#endif  // XNN_ENABLE_HVX && XNN_ARCH_HEXAGON

XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vhswish_ukernel__scalar_u1, 1, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vhswish_ukernel__scalar_u2, 2, false, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_vhswish_ukernel__scalar_u4, 4, false, float, struct xnn_f32_default_params, NULL)

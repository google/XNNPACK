...
void xnn_qs8_qc8w_dwconv_minmax_fp32_ukernel_3p16c__neon_mla8_ld64(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (size_t co = 0; co < channels; co += 2736) {
    size_t channel_supertile = 2736;
    ...
    do {
      ...
      const void* w = (const void*) ((uintptr_t) weights + co * (3 * sizeof(int32_t)));
      for (; c >= 16; c -= 16) {

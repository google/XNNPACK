...
void xnn_qs8_qc8w_dwconv_minmax_fp32_ukernel_5f5m5l8c8s8r__wasmsimd_mul16(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
      ...
      if XNN_UNLIKELY(c != 0) {
        {
          ...
          const v128_t vscale0123 = wasm_v128_load((const float*) ((uintptr_t) w + 40 * sizeof(int8_t)));
          const v128_t vscale4567 = wasm_v128_load((const float*) ((uintptr_t) w + 40 * sizeof(int8_t) + 4 * sizeof(float)));

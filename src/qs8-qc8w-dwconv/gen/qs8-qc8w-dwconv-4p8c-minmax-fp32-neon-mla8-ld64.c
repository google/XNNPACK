...
void xnn_qs8_qc8w_dwconv_minmax_fp32_ukernel_4p8c__neon_mla8_ld64(
    size_t channels,
    size_t output_width,
    const int8_t** input,
    const void* weights,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (size_t co = 0; co < channels; co += 2048) {
    size_t channel_supertile = 2048;
    ...
    do {
      ...
      const void* w = (const void*) ((uintptr_t) weights + co * (4 * sizeof(int32_t)));
      for (; c >= 8; c -= 8) {
      ...
      if XNN_UNLIKELY(c != 0) {
        {
          ...
          const float32x4_t vscale0123 = vld1q_f32((const float*) ((uintptr_t) w + 0 * sizeof(int32_t) + 32 * sizeof(int8_t)));
          const float32x4_t vscale4567 = vld1q_f32((const float*) ((uintptr_t) w + 0 * sizeof(int32_t) + 32 * sizeof(int8_t) + 4 * sizeof(float)));
          vfpacc0123 = vmulq_f32(vfpacc0123, vscale0123);
          vfpacc4567 = vmulq_f32(vfpacc4567, vscale4567);

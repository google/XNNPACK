...
### C8 micro-kernels
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=1 -D NR=8  -o src/qs8-gemm/gen/1x8c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=2 -D NR=8  -o src/qs8-gemm/gen/2x8c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=3 -D NR=8  -o src/qs8-gemm/gen/3x8c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=4 -D NR=8  -o src/qs8-gemm/gen/4x8c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=1 -D NR=16 -o src/qs8-gemm/gen/1x16c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=2 -D NR=16 -o src/qs8-gemm/gen/2x16c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=3 -D NR=16 -o src/qs8-gemm/gen/3x16c8-minmax-neon-mull-addlv.c
tools/xngen src/qs8-gemm/c8-neon-mull-addlv.c.in -D MR=4 -D NR=16 -o src/qs8-gemm/gen/4x16c8-minmax-neon-mull-addlv.c

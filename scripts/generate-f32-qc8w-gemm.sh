...
################################### x86 SSE ###################################
### LOAD1+BROADCAST micro-kernels
tools/xngen src/f32-gemm/sse-load1.c.in -D MR=1 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-1x8-minmax-sse-load1.c &
tools/xngen src/f32-gemm/sse-load1.c.in -D MR=3 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-3x8-minmax-sse-load1.c &
tools/xngen src/f32-gemm/sse-load1.c.in -D MR=4 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-4x8-minmax-sse-load1.c &
tools/xngen src/f32-gemm/sse-load1.c.in -D MR=5 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-5x8-minmax-sse-load1.c &

### LOAD4+DUPLICATE micro-kernels
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=1 -D NR=8 -D INC=0 -D SSE=1 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-1x8-minmax-sse-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=3 -D NR=8 -D INC=0 -D SSE=1 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-3x8-minmax-sse-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=4 -D NR=8 -D INC=0 -D SSE=1 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-4x8-minmax-sse-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=5 -D NR=8 -D INC=0 -D SSE=1 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-5x8-minmax-sse-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=1 -D NR=8 -D INC=0 -D SSE=2 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-1x8-minmax-sse2-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=3 -D NR=8 -D INC=0 -D SSE=2 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-3x8-minmax-sse2-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=4 -D NR=8 -D INC=0 -D SSE=2 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-4x8-minmax-sse2-dup.c &
tools/xngen src/f32-gemm/sse-dup.c.in -D MR=5 -D NR=8 -D INC=0 -D SSE=2 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-5x8-minmax-sse2-dup.c &

### LOAD4+PERMUTE micro-kernels
tools/xngen src/f32-gemm/sse-shuffle.c.in -D MR=1 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-1x8s4-minmax-sse.c &
tools/xngen src/f32-gemm/sse-shuffle.c.in -D MR=3 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-3x8s4-minmax-sse.c &
tools/xngen src/f32-gemm/sse-shuffle.c.in -D MR=4 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-4x8s4-minmax-sse.c &
tools/xngen src/f32-gemm/sse-shuffle.c.in -D MR=5 -D NR=8 -D INC=0 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-5x8s4-minmax-sse.c &

### MRx2 micro-kernels
tools/xngen src/f32-gemm/MRx2c4-sse.c.in -D MR=4 -D NR=2 -D DATATYPE=QC8 -o src/f32-gemm/gen/f32-qc8w-gemm-4x2c4-minmax-sse.c &

...
################################## RISC-V RVV #################################
tools/xngen src/f32-vmulcaddc/rvv.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -o src/f32-vmulcaddc/gen/f32-vmulcaddc-c4-minmax-rvv-2x.c &
tools/xngen src/f32-vmulcaddc/rvv.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -o src/f32-vmulcaddc/gen/f32-vmulcaddc-c8-minmax-rvv-2x.c &

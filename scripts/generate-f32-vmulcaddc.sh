...
################################## WAsm SIMD ##################################
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=ARM     -D FMA=0 -o src/f32-vmulcaddc/gen/c4-minmax-wasmsimd-arm-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=ARM     -D FMA=0 -o src/f32-vmulcaddc/gen/c8-minmax-wasmsimd-arm-2x.c &

tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=X86     -D FMA=0 -o src/f32-vmulcaddc/gen/c4-minmax-wasmsimd-x86-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=X86     -D FMA=0 -o src/f32-vmulcaddc/gen/c8-minmax-wasmsimd-x86-2x.c &

tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=RELAXED -D FMA=0 -o src/f32-vmulcaddc/gen/c4-minmax-wasmrelaxedsimd-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=RELAXED -D FMA=0 -o src/f32-vmulcaddc/gen/c8-minmax-wasmrelaxedsimd-2x.c &

tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=RELAXED -D FMA=1 -o src/f32-vmulcaddc/gen/c4-minmax-wasmrelaxedsimd-fma-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=RELAXED -D FMA=1 -o src/f32-vmulcaddc/gen/c8-minmax-wasmrelaxedsimd-fma-2x.c &

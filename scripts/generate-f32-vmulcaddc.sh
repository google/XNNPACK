...
################################## WAsm SIMD ##################################
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=ARM     -o src/f32-vmulcaddc/gen/c4-minmax-wasmsimd-arm-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=ARM     -o src/f32-vmulcaddc/gen/c8-minmax-wasmsimd-arm-2x.c &

tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=X86     -o src/f32-vmulcaddc/gen/c4-minmax-wasmsimd-x86-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=X86     -o src/f32-vmulcaddc/gen/c8-minmax-wasmsimd-x86-2x.c &

tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=4 -D ROW_TILE=2 -D ARCH=RELAXED -o src/f32-vmulcaddc/gen/c4-minmax-wasmrelaxedsimd-2x.c &
tools/xngen src/f32-vmulcaddc/wasmsimd.c.in -D CHANNEL_TILE=8 -D ROW_TILE=2 -D ARCH=RELAXED -o src/f32-vmulcaddc/gen/c8-minmax-wasmrelaxedsimd-2x.c &

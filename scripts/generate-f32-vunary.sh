...
tools/xngen src/f32-vunary/simd.c.in -D OP=ABS -D ARCH=fma3 -D BATCH_TILES="8,16,24" -o src/f32-vunary/gen/f32-vabs-fma3.c
tools/xngen src/f32-vunary/simd.c.in -D OP=NEG -D ARCH=fma3 -D BATCH_TILES="8,16,24" -o src/f32-vunary/gen/f32-vneg-fma3.c
tools/xngen src/f32-vunary/simd.c.in -D OP=SQR -D ARCH=fma3 -D BATCH_TILES="8,16,24" -o src/f32-vunary/gen/f32-vsqr-fma3.c

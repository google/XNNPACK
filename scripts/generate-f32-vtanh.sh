...
tools/xngen src/f32-vtanh/rational-9-8.c.in -D ARCH=hvx      -D BATCH_TILES=32,64,96,128 -D DIV=DIV -o src/f32-vtanh/gen/f32-vtanh-hvx-rational-9-8-div.c &
...
################################### RISC-V Vector #############################
tools/xngen src/f32-vtanh/rvv-rational-9-8.c.in -D LMUL=1 -o src/f32-vtanh/gen/f32-vtanh-rvv-rational-9-8-div-u1v.c &
tools/xngen src/f32-vtanh/rvv-rational-9-8.c.in -D LMUL=2 -o src/f32-vtanh/gen/f32-vtanh-rvv-rational-9-8-div-u2v.c &
tools/xngen src/f32-vtanh/rvv-rational-9-8.c.in -D LMUL=4 -o src/f32-vtanh/gen/f32-vtanh-rvv-rational-9-8-div-u4v.c &
tools/xngen src/f32-vtanh/rvv-rational-9-8.c.in -D LMUL=8 -o src/f32-vtanh/gen/f32-vtanh-rvv-rational-9-8-div-u8v.c &

...
################################### RISC-V Vector #############################
tools/xngen src/s8-rminmax/rvv.c.in -D LMUL=8 -D DATATYPE=U8 -D OP=MAX    -o src/u8-rminmax/gen/u8-rmax-rvv-u8v.c &
tools/xngen src/s8-rminmax/rvv.c.in -D LMUL=8 -D DATATYPE=U8 -D OP=MIN    -o src/u8-rminmax/gen/u8-rmin-rvv-u8v.c &
tools/xngen src/s8-rminmax/rvv.c.in -D LMUL=8 -D DATATYPE=U8 -D OP=MINMAX -o src/u8-rminmax/gen/u8-rminmax-rvv-u8v.c &

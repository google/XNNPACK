...
tools/xngen src/x32-packw/scalar.c.in -D NR=2  -D KBLOCK=4 -D TYPE=uint32_t -o src/x32-packw/gen/x32-packw-x2-scalar-int-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=3  -D KBLOCK=4 -D TYPE=uint32_t -o src/x32-packw/gen/x32-packw-x3-scalar-int-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=4  -D KBLOCK=4 -D TYPE=uint32_t -o src/x32-packw/gen/x32-packw-x4-scalar-int-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=8  -D KBLOCK=4 -D TYPE=uint32_t -o src/x32-packw/gen/x32-packw-x8-scalar-int-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=16 -D KBLOCK=4 -D TYPE=uint32_t -o src/x32-packw/gen/x32-packw-x16-scalar-int-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=2  -D KBLOCK=4 -D TYPE=float    -o src/x32-packw/gen/x32-packw-x2-scalar-float-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=3  -D KBLOCK=4 -D TYPE=float    -o src/x32-packw/gen/x32-packw-x3-scalar-float-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=4  -D KBLOCK=4 -D TYPE=float    -o src/x32-packw/gen/x32-packw-x4-scalar-float-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=8  -D KBLOCK=4 -D TYPE=float    -o src/x32-packw/gen/x32-packw-x8-scalar-float-x4.c &
tools/xngen src/x32-packw/scalar.c.in -D NR=16 -D KBLOCK=4 -D TYPE=float    -o src/x32-packw/gen/x32-packw-x16-scalar-float-x4.c &
...
################################### x86 SSE ###################################
### NR multiple of 4
tools/xngen src/x32-packw/sse2.c.in -D NR=8  -D PREFETCH=0 -D KBLOCK=4 -D AVX=0 -o src/x32-packw/gen/x32-packw-x8-sse2-x4.c &
...
################################## Wasm SIMD ##################################
### NR multiple of 4
tools/xngen src/x32-packw/wasmsimd.c.in -D NR=8 -D KBLOCK=4 -o src/x32-packw/gen/x32-packw-x8-wasmsimd-x4.c &

### SR 4
tools/xngen src/x32-packw/s4-wasmsimd.c.in -D NR=8 -D KBLOCK=4 -o src/x32-packw/gen/x32-packw-x8s4-wasmsimd-x1.c &

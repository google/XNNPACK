...
tools/xngen src/x32-packw/sse2.c.in -D NR=8  -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x8-sse2-x8.c &
tools/xngen src/x32-packw/sse2.c.in -D NR=16 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x16-sse2-x8.c &
...
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=8  -D SR=4 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x8s4-sse2-x8.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=16 -D SR=4 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x16s4-sse2-x8.c &

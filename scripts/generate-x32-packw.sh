...
### SR 4
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=8  -D PREFETCH=0 -D SR=4 -D KUNROLL=4  -D AVX=0 -o src/x32-packw/gen/x32-packw-x8s4-sse2-x4.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=16 -D PREFETCH=0 -D SR=4 -D KUNROLL=4  -D AVX=0 -o src/x32-packw/gen/x32-packw-x16s4-sse2-x4.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=8  -D PREFETCH=0 -D SR=4 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x8s4-sse2-x8.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=16 -D PREFETCH=0 -D SR=4 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x16s4-sse2-x8.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=8  -D PREFETCH=1 -D SR=4 -D KUNROLL=4  -D AVX=0 -o src/x32-packw/gen/x32-packw-x8s4-sse2-prfm-x4.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=16 -D PREFETCH=1 -D SR=4 -D KUNROLL=4  -D AVX=0 -o src/x32-packw/gen/x32-packw-x16s4-sse2-prfm-x4.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=8  -D PREFETCH=1 -D SR=4 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x8s4-sse2-prfm-x8.c &
tools/xngen src/x32-packw/s4-sse2.c.in -D NR=16 -D PREFETCH=1 -D SR=4 -D KUNROLL=8  -D AVX=0 -o src/x32-packw/gen/x32-packw-x16s4-sse2-prfm-x8.c &

### KR 4
tools/xngen src/x32-packw/c4-sse2.c.in -D NR=2  -D KR=4 -o src/x32-packw/gen/x32-packw-x2c4-sse2-x4.c &
...
################################### x86 AVX512 ##################################
### NR multiple of 16
tools/xngen src/x32-packw/avx512.c.in -D NR=16 -D KUNROLL=4 -o src/x32-packw/gen/x32-packw-x16-avx512f-x4.c &

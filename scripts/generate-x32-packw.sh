...
tools/xngen src/x32-packw/scalar.c.in -D NR=3  -D KUNROLL=4 -D TYPE=uint32_t -o src/x32-packw/gen/x32-packw-x3-scalar-int-x4.c &
...
tools/xngen src/x32-packw/scalar.c.in -D NR=3  -D KUNROLL=4 -D TYPE=float    -o src/x32-packw/gen/x32-packw-x3-scalar-float-x4.c &

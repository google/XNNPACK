...
tools/xngen src/qs8-gavgpool/unipass-neon.c.in -D ROW_TILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D REQUANTIZATION=FP32 -D ARMV8=0 -o src/qs8-gavgpool/gen/7x-minmax-fp32-neon-c16-acc2.c &
...
tools/xngen src/qs8-gavgpool/unipass-wasmsimd.c.in -D ROW_TILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-wasmsimd-c16-acc2.c &
tools/xngen src/qs8-gavgpool/unipass-wasmsimd.c.in -D ROW_TILE=7 -D CHANNEL_TILE=24 -D ACCUMULATORS=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-wasmsimd-c24-acc2.c &

tools/xngen src/qs8-gavgpool/multipass-wasmsimd.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=8  -D ACCUMULATORS=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-wasmsimd-c8-acc2.c &
tools/xngen src/qs8-gavgpool/multipass-wasmsimd.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-wasmsimd-c16-acc2.c &
tools/xngen src/qs8-gavgpool/multipass-wasmsimd.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=24 -D ACCUMULATORS=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-wasmsimd-c24-acc2.c &

################################### x86 SSE ###################################
tools/xngen src/qs8-gavgpool/unipass-sse.c.in -D ROW_TILE=7 -D CHANNEL_TILE=8  -D ACCUMULATORS=2 -D SSE=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-sse2-c8-acc2.c &
tools/xngen src/qs8-gavgpool/unipass-sse.c.in -D ROW_TILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D SSE=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-sse2-c16-acc2.c &
tools/xngen src/qs8-gavgpool/unipass-sse.c.in -D ROW_TILE=7 -D CHANNEL_TILE=24 -D ACCUMULATORS=2 -D SSE=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-sse2-c24-acc2.c &

tools/xngen src/qs8-gavgpool/unipass-sse.c.in -D ROW_TILE=7 -D CHANNEL_TILE=8  -D ACCUMULATORS=2 -D SSE=4 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-sse41-c8-acc2.c &
tools/xngen src/qs8-gavgpool/unipass-sse.c.in -D ROW_TILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D SSE=4 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-sse41-c16-acc2.c &
tools/xngen src/qs8-gavgpool/unipass-sse.c.in -D ROW_TILE=7 -D CHANNEL_TILE=24 -D ACCUMULATORS=2 -D SSE=4 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7x-minmax-fp32-sse41-c24-acc2.c &

tools/xngen src/qs8-gavgpool/multipass-sse.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=8  -D ACCUMULATORS=2 -D SSE=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-sse2-c8-acc2.c &
tools/xngen src/qs8-gavgpool/multipass-sse.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D SSE=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-sse2-c16-acc2.c &
tools/xngen src/qs8-gavgpool/multipass-sse.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=24 -D ACCUMULATORS=2 -D SSE=2 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-sse2-c24-acc2.c &

tools/xngen src/qs8-gavgpool/multipass-sse.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=8  -D ACCUMULATORS=2 -D SSE=4 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-sse41-c8-acc2.c &
tools/xngen src/qs8-gavgpool/multipass-sse.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=16 -D ACCUMULATORS=2 -D SSE=4 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-sse41-c16-acc2.c &
tools/xngen src/qs8-gavgpool/multipass-sse.c.in -D ROW_TILE=7 -D ROW_SUBTILE=7 -D CHANNEL_TILE=24 -D ACCUMULATORS=2 -D SSE=4 -D REQUANTIZATION=FP32 -o src/qs8-gavgpool/gen/7p7x-minmax-fp32-sse41-c24-acc2.c &

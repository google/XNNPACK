...
tools/xngen src/f32-sigmoid/sse2-p5-div.c.in -D BATCH_TILE=8 -o src/f32-sigmoid/sse2-p5-div-x8.c
tools/xngen src/f32-sigmoid/sse2-p5-div.c.in -D BATCH_TILE=16 -o src/f32-sigmoid/sse2-p5-div-x16.c

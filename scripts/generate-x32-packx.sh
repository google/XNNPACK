...
tools/xngen src/x32-packx/neon.c.in -D MR=4 -D PREFETCH=1 -D KBLOCK=4 -o src/x32-packx/gen/x32-packx-4x-neon-st4-prfm-x4.c &
tools/xngen src/x32-packx/neon.c.in -D MR=8 -D PREFETCH=0 -D KBLOCK=4 -o src/x32-packx/gen/x32-packx-8x-neon-st4-x4.c &
tools/xngen src/x32-packx/neon.c.in -D MR=8 -D PREFETCH=1 -D KBLOCK=4 -o src/x32-packx/gen/x32-packx-8x-neon-st4-prfm-x4.c &
tools/xngen src/x32-packx/neon.c.in -D MR=4 -D PREFETCH=0 -D KBLOCK=8 -o src/x32-packx/gen/x32-packx-4x-neon-st4-x8.c &
tools/xngen src/x32-packx/neon.c.in -D MR=4 -D PREFETCH=1 -D KBLOCK=8 -o src/x32-packx/gen/x32-packx-4x-neon-st4-prfm-x8.c &
tools/xngen src/x32-packx/neon.c.in -D MR=8 -D PREFETCH=0 -D KBLOCK=8 -o src/x32-packx/gen/x32-packx-8x-neon-st4-x8.c &
tools/xngen src/x32-packx/neon.c.in -D MR=8 -D PREFETCH=1 -D KBLOCK=8 -o src/x32-packx/gen/x32-packx-8x-neon-st4-prfm-x8.c &

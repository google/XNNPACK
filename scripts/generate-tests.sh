...
tools/generate-gemm-test.py --spec test/qd8-bf16-qb4w-gemm-minmax.yaml --output-test test/qd8-bf16-qb4w-gemm-minmax.cc --output-bench bench/qd8-bf16-qb4w-gemm.cc &

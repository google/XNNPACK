...
tools/generate-vbinary-test.py --tester VBinaryMicrokernelTester  --spec test/s32-vmin.yaml   --output test/s32-vmin.cc &
tools/generate-vbinary-test.py --tester VBinaryCMicrokernelTester --spec test/s32-vminc.yaml    --output test/s32-vminc.cc &

...
tools/generate-gemm-test.py --spec test/pqs8-qc4w-gemm-minmax.yaml     --output-test test/pqs8-qc4w-gemm-minmax.cc --output-bench bench/pqs8-qc4w-gemm-minmax.cc &

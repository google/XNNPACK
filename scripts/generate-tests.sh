...
tools/generate-vunary-test.py --ukernel qs8-vhswish --output test/qs8-vhswish.cc &
tools/generate-vunary-test.py --ukernel qu8-vhswish --output test/qu8-vhswish.cc &

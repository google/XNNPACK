...
### S4C2 micro-kernels
tools/xngen src/qs8-igemm/c2-neon-mull-padal-shuffle.c.in -D MR=1 -D NR=8  -D MLA=0 -D REQUANTIZATION=RNDNU    -D CHANNELWISE=0 -D ARMV8=0 -o src/qs8-igemm/gen/1x8s4c2-minmax-rndnu-neon-mull-padal.c &
tools/xngen src/qs8-igemm/c2-neon-mull-padal-shuffle.c.in -D MR=2 -D NR=8  -D MLA=0 -D REQUANTIZATION=RNDNU    -D CHANNELWISE=0 -D ARMV8=0 -o src/qs8-igemm/gen/2x8s4c2-minmax-rndnu-neon-mull-padal.c &
tools/xngen src/qs8-igemm/c2-neon-mull-padal-shuffle.c.in -D MR=1 -D NR=8  -D MLA=1 -D REQUANTIZATION=RNDNU    -D CHANNELWISE=0 -D ARMV8=0 -o src/qs8-igemm/gen/1x8s4c2-minmax-rndnu-neon-mlal-padal.c &
tools/xngen src/qs8-igemm/c2-neon-mull-padal-shuffle.c.in -D MR=2 -D NR=8  -D MLA=1 -D REQUANTIZATION=RNDNU    -D CHANNELWISE=0 -D ARMV8=0 -o src/qs8-igemm/gen/2x8s4c2-minmax-rndnu-neon-mlal-padal.c &

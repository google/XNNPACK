...
#################################### Scalar ###################################
### C4 micro-kernels
tools/xngen src/qs8-igemm/MRxNRc4-scalar.c.in -D MR=8  -D NR=8 -o src/qs8-igemm/gen/8x8c4-minmax-scalar.c
tools/xngen src/qs8-igemm/MRxNRc4-scalar.c.in -D MR=12 -D NR=4 -o src/qs8-igemm/gen/12x4c4-minmax-scalar.c

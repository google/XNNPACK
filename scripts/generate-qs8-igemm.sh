...
tools/xngen src/qs8-igemm/MRx8c8-avxvnni.c.in -D VARIANT=AVXVNNIINT8 -D MR=1 -D DATATYPE=QC8    -D AVX=2  -D GFNI=0 -D PREFETCH=1 -D REQUANTIZATION=FP32 -o src/qs8-qc8w-igemm/gen/qs8-qc8w-igemm-1x8c8-minmax-fp32-avxvnniint8-prfm.c &
tools/xngen src/qs8-igemm/MRx8c8-avxvnni.c.in -D VARIANT=AVXVNNIINT8 -D MR=5 -D DATATYPE=QC8    -D AVX=2  -D GFNI=0 -D PREFETCH=1 -D REQUANTIZATION=FP32 -o src/qs8-qc8w-igemm/gen/qs8-qc8w-igemm-5x8c8-minmax-fp32-avxvnniint8-prfm.c &

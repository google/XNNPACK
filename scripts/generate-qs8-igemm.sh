...
tools/xngen src/qs8-igemm/MRx16c4-avx512vnni.c.in -D MR=16 -D DATATYPE=QD8 -D PREFETCH=1 -D REQUANTIZATION=     -o src/qd8-f32-qc8w-igemm/gen/qd8-f32-qc8w-igemm-16x16c4-minmax-avx512vnni-prfm.c &

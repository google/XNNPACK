...
tools/xngen src/qs8-igemm/MRx8c8-avxvnni.c.in -D VARIANT= -D VARIANT=AVXVNNIINT8 -D MR=1 -D DATATYPE=QD8_F32    -D AVX=2    -D PREFETCH=1 -D REQUANTIZATION= -o src/qs8-qc8w-igemm/gen/qd8-f32-qc8w-igemm-1x8c8-minmax-avxvnniint8-prfm.c &
tools/xngen src/qs8-igemm/MRx8c8-avxvnni.c.in -D VARIANT= -D VARIANT=AVXVNNIINT8 -D MR=5 -D DATATYPE=QD8_F32    -D AVX=2    -D PREFETCH=1 -D REQUANTIZATION= -o src/qs8-qc8w-igemm/gen/qd8-f32-qc8w-igemm-5x8c8-minmax-avxvnniint8-prfm.c &

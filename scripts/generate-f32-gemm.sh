...
tools/xngen src/f32-gemm/avx-broadcast.c.in -D MR=6 -D NR=16 -D FMA=0 -D INC=0 -D DATATYPE=F32 -o src/f32-gemm/gen/f32-gemm-6x16-minmax-avx-broadcast.c &
tools/xngen src/f32-gemm/avx-broadcast.c.in -D MR=6 -D NR=16 -D FMA=0 -D INC=1 -D DATATYPE=F32 -o src/f32-gemminc/gen/f32-gemminc-6x16-minmax-avx-broadcast.c &
...
tools/xngen src/f32-gemm/avx-broadcast.c.in -D MR=6 -D NR=16 -D FMA=3 -D INC=0 -D DATATYPE=F32 -o src/f32-gemm/gen/f32-gemm-6x16-minmax-fma3-broadcast.c &
tools/xngen src/f32-gemm/avx-broadcast.c.in -D MR=6 -D NR=16 -D FMA=3 -D INC=1 -D DATATYPE=F32 -o src/f32-gemminc/gen/f32-gemminc-6x16-minmax-fma3-broadcast.c &

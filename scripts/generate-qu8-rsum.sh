...
tools/xngen src/qu8-rsum/sse2.c.in   -D CHANNEL_TILE=32 -D ACCUMULATORS=1 -D DATATYPE=QU8 -o src/qu8-rsum/gen/qu8-rsum-sse2-u32.c &
...
tools/xngen src/qu8-rsum/sse2.c.in   -D CHANNEL_TILE=64 -D ACCUMULATORS=1 -D DATATYPE=QU8 -o src/qu8-rsum/gen/qu8-rsum-sse2-u64.c &
...
tools/xngen src/qu8-rsum/avx2.c.in   -D CHANNEL_TILE=64  -D ACCUMULATORS=1 -D DATATYPE=QU8 -o src/qu8-rsum/gen/qu8-rsum-avx2-u64.c &
...
tools/xngen src/qu8-rsum/avx2.c.in   -D CHANNEL_TILE=128 -D ACCUMULATORS=1 -D DATATYPE=QU8 -o src/qu8-rsum/gen/qu8-rsum-avx2-u128.c &

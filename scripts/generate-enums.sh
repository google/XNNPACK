...
tools/generate-enum.py --debug --enum xnn_allocation_type --spec src/enums/allocation-type.yaml --output_src src/enums/allocation-type.c --output_hdr src/xnnpack/allocation-type.h &

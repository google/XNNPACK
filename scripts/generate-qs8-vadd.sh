...
################################## Hexagon HVX #################################
tools/xngen src/qs8-vadd/hvx.c.in  -D BATCH_TILE=32  -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vadd/gen/qs8-vadd-minmax-hvx-u32.c &
tools/xngen src/qs8-vadd/hvx.c.in  -D BATCH_TILE=64  -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vadd/gen/qs8-vadd-minmax-hvx-u64.c &
tools/xngen src/qs8-vadd/hvx.c.in  -D BATCH_TILE=96  -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vadd/gen/qs8-vadd-minmax-hvx-u96.c &
tools/xngen src/qs8-vadd/hvx.c.in  -D BATCH_TILE=128 -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vadd/gen/qs8-vadd-minmax-hvx-u128.c &

tools/xngen src/qs8-vaddc/hvx.c.in -D BATCH_TILE=32  -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vaddc/gen/qs8-vaddc-minmax-hvx-u32.c &
tools/xngen src/qs8-vaddc/hvx.c.in -D BATCH_TILE=64  -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vaddc/gen/qs8-vaddc-minmax-hvx-u64.c &
tools/xngen src/qs8-vaddc/hvx.c.in -D BATCH_TILE=96  -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vaddc/gen/qs8-vaddc-minmax-hvx-u96.c &
tools/xngen src/qs8-vaddc/hvx.c.in -D BATCH_TILE=128 -D DATATYPE=QS8 -D ARCH=hvx -o src/qs8-vaddc/gen/qs8-vaddc-minmax-hvx-u128.c &

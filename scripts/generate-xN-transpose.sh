...
#################################### HEXAGON HVX ###############################
tools/xngen src/x32-transposec/hvx.c.in -D SIZE=32 IN_PTRS=MULTI OUT_PTRS=MULTI TILE_HEIGHT=32 -D ARCH=hvx -o src/x32-transposec/gen/x32-transposec-32x32-multi-multi-hvx.c &

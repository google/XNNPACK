...
# QS4/QU4 in QS4 out
tools/xngen src/x8-packw/kr-avxvnni.c.in -D NR=8  -D KR=8 -D DATATYPE=QS4 -D TYPE=int8_t -D IZP=0   -D AVX=2 -D PREFETCH=0 -o src/qs4-packw/gen/qs4-packw-x8c8-gemm-goi-avxvnni.c &

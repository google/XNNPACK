...
tools/xngen src/x8-packw/kr-scalar.c.in -D NR=96  -D KR=4 -D TYPE=int8_t -D IZP=0 -o src/qs8-packw/gen/qs8-packw-x96c4-gemm-goi-scalar.c &
tools/xngen src/x8-packw/kr-scalar.c.in -D NR=128 -D KR=4 -D TYPE=int8_t -D IZP=0 -o src/qs8-packw/gen/qs8-packw-x128c4-gemm-goi-scalar.c &
...
tools/xngen src/x8-packw/kr-gio-scalar.c.in -D NR=96  -D KR=4 -D DATATYPE=QS8 -D TYPE=int8_t -D IZP=0   -o src/qs8-packw/gen/qs8-packw-x96c4-gemm-gio-scalar.c &
tools/xngen src/x8-packw/kr-gio-scalar.c.in -D NR=128 -D KR=4 -D DATATYPE=QS8 -D TYPE=int8_t -D IZP=0   -o src/qs8-packw/gen/qs8-packw-x128c4-gemm-gio-scalar.c &
...
### C4 packing for AMX
tools/xngen src/x8-packw/c4-avxvnni.c.in -D NR=64 -D KR=4 -D DATATYPE=QS8 -D TYPE=int8_t -D IZP=0   -D AVX=10 -D VARIANT=     -D PREFETCH=0 -o src/qs8-packw/gen/qs8-packw-x64c4-gemm-goi-avx256vnni.c &
tools/xngen src/x8-packw/c4-avxvnni.c.in -D NR=64 -D KR=4 -D DATATYPE=QS8 -D TYPE=int8_t -D IZP=0   -D AVX=10 -D VARIANT=     -D PREFETCH=1 -o src/qs8-packw/gen/qs8-packw-x64c4-gemm-goi-avx256vnni-prfm.c &

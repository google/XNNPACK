...
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/1x8-minmax-wasmsimd-arm-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/3x8-minmax-wasmsimd-arm-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/4x8-minmax-wasmsimd-arm-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/5x8-minmax-wasmsimd-arm-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/6x8-minmax-wasmsimd-arm-loadsplat.c &

tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/1x8-minmax-wasmsimd-x86-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/3x8-minmax-wasmsimd-x86-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/4x8-minmax-wasmsimd-x86-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/5x8-minmax-wasmsimd-x86-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/6x8-minmax-wasmsimd-x86-loadsplat.c &

tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/1x8-minmax-wasmrelaxedsimd-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/3x8-minmax-wasmrelaxedsimd-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x8-minmax-wasmrelaxedsimd-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/5x8-minmax-wasmrelaxedsimd-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/6x8-minmax-wasmrelaxedsimd-loadsplat.c &

tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=1 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/1x8-minmax-wasmrelaxedsimd-fma-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=3 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/3x8-minmax-wasmrelaxedsimd-fma-loadsplat.c &
tools/xngen src/f32-igemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x8-minmax-wasmrelaxedsimd-fma-loadsplat.c &
...
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/4x8-minmax-wasmsimd-arm-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/5x8-minmax-wasmsimd-arm-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/6x8-minmax-wasmsimd-arm-splat.c &

tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/1x8-minmax-wasmsimd-x86-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/3x8-minmax-wasmsimd-x86-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/4x8-minmax-wasmsimd-x86-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/5x8-minmax-wasmsimd-x86-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/6x8-minmax-wasmsimd-x86-splat.c &

tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/1x8-minmax-wasmrelaxedsimd-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/3x8-minmax-wasmrelaxedsimd-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x8-minmax-wasmrelaxedsimd-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/5x8-minmax-wasmrelaxedsimd-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/6x8-minmax-wasmrelaxedsimd-splat.c &

tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=1 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/1x8-minmax-wasmrelaxedsimd-fma-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=3 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/3x8-minmax-wasmrelaxedsimd-fma-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=4 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x8-minmax-wasmrelaxedsimd-fma-splat.c &
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=5 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/5x8-minmax-wasmrelaxedsimd-fma-splat.c &
...
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/3x8s4-minmax-wasmsimd-arm.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/4x8s4-minmax-wasmsimd-arm.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/5x8s4-minmax-wasmsimd-arm.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=ARM     -o src/f32-igemm/gen/6x8s4-minmax-wasmsimd-arm.c &

tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/1x8s4-minmax-wasmsimd-x86.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/3x8s4-minmax-wasmsimd-x86.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/4x8s4-minmax-wasmsimd-x86.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/5x8s4-minmax-wasmsimd-x86.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/6x8s4-minmax-wasmsimd-x86.c &

tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=1 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/1x8s4-minmax-wasmrelaxedsimd.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=3 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/3x8s4-minmax-wasmrelaxedsimd.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=4 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x8s4-minmax-wasmrelaxedsimd.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=5 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/5x8s4-minmax-wasmrelaxedsimd.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=6 -D NR=8 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/6x8s4-minmax-wasmrelaxedsimd.c &

tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=1 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/1x8s4-minmax-wasmrelaxedsimd-fma.c &
tools/xngen src/f32-igemm/wasmsimd-s4.c.in -D MR=3 -D NR=8 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/3x8s4-minmax-wasmrelaxedsimd-fma.c &
...
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=X86     -o src/f32-igemm/gen/4x2c4-minmax-wasmsimd-x86.c &
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=0 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x2c4-minmax-wasmrelaxedsimd.c &
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=1 -D ACTIVATION=MINMAX -D ARCH=RELAXED -o src/f32-igemm/gen/4x2c4-minmax-wasmrelaxedsimd-fma.c &
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=0 -D ACTIVATION=RELU                   -o src/f32-igemm/gen/4x2c4-relu-wasmsimd.c &
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=1 -D ACTIVATION=RELU   -D ARCH=RELAXED -o src/f32-igemm/gen/4x2c4-relu-wasmrelaxedsimd-fma.c &
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=0 -D ACTIVATION=LINEAR                 -o src/f32-igemm/gen/4x2c4-wasmsimd.c &
tools/xngen src/f32-igemm/MRx2c4-wasmsimd.c.in -D MR=4 -D NR=2 -D FMA=1 -D ACTIVATION=LINEAR -D ARCH=RELAXED -o src/f32-igemm/gen/4x2c4-wasmrelaxedsimd-fma.c &
...
tools/xngen src/f32-igemm/4x2-aarch64-neonfma-cortex-a75.S.in -D PREFETCH=0 -o src/f32-igemm/gen/4x2-minmax-aarch64-neonfma-cortex-a75.S &
tools/xngen src/f32-igemm/4x2-aarch64-neonfma-cortex-a75.S.in -D PREFETCH=1 -o src/f32-igemm/gen/4x2-minmax-aarch64-neonfma-prfm-cortex-a75.S &

### Cortex A53 micro-kernels
tools/xngen src/f32-igemm/1x8-aarch64-neonfma-cortex-a53.S.in -D PREFETCH=0 -o src/f32-igemm/gen/1x8-minmax-aarch64-neonfma-cortex-a53.S &
tools/xngen src/f32-igemm/1x8-aarch64-neonfma-cortex-a53.S.in -D PREFETCH=1 -o src/f32-igemm/gen/1x8-minmax-aarch64-neonfma-prfm-cortex-a53.S &
...
tools/xngen src/f32-igemm/6x8-aarch64-neonfma-cortex-a53.S.in -D PREFETCH=0 -o src/f32-igemm/gen/6x8-minmax-aarch64-neonfma-cortex-a53.S &
tools/xngen src/f32-igemm/6x8-aarch64-neonfma-cortex-a53.S.in -D PREFETCH=1 -o src/f32-igemm/gen/6x8-minmax-aarch64-neonfma-prfm-cortex-a53.S &
...
############################### AArch32 assembly ##############################
tools/xngen src/f32-igemm/4x8-aarch32-neon-cortex-a53.S.in       -D PREFETCH=0 -o src/f32-igemm/gen/4x8-minmax-aarch32-neon-cortex-a53.S &
tools/xngen src/f32-igemm/4x8-aarch32-neon-cortex-a53.S.in       -D PREFETCH=1 -o src/f32-igemm/gen/4x8-minmax-aarch32-neon-prfm-cortex-a53.S &
...
tools/xngen src/f32-igemm/4x8-aarch32-neon-cortex-a75.S.in       -D PREFETCH=1 -o src/f32-igemm/gen/4x8-minmax-aarch32-neon-prfm-cortex-a75.S &
...
tools/xngen src/f32-igemm/MRx2-neon-ld64.c.in -D MR=6 -D NR=2 -D FMA=0 -D DUP=0 -o src/f32-igemm/gen/6x2-minmax-neon-lane-ld64.c &
tools/xngen src/f32-igemm/MRx2-neon-ld64.c.in -D MR=6 -D NR=2 -D FMA=1 -D DUP=0 -o src/f32-igemm/gen/6x2-minmax-neonfma-lane-ld64.c &

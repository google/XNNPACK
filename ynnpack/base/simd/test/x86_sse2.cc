...
TEST_SATURATING_ADD(x86_sse2, u8, 16);
TEST_SATURATING_ADD(x86_sse2, s8, 16);
TEST_SATURATING_ADD(x86_sse2, u16, 8);
TEST_SATURATING_ADD(x86_sse2, s16, 8);

TEST_SATURATING_SUB(x86_sse2, u8, 16);
TEST_SATURATING_SUB(x86_sse2, s8, 16);
TEST_SATURATING_SUB(x86_sse2, u16, 8);
TEST_SATURATING_SUB(x86_sse2, s16, 8);

...
TEST_UNARY(x86_avx2_fma3, sin, f32, 8, std::sin, 2);
TEST_UNARY(x86_avx2_fma3, sin, f64, 4, std::sin, 2);
TEST_UNARY(x86_avx2_fma3, cos, f32, 8, std::cos, 2);
TEST_UNARY(x86_avx2_fma3, cos, f64, 4, std::cos, 2);

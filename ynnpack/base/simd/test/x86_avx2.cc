...
TEST_SATURATING_ADD(x86_avx2, u8, 32);
TEST_SATURATING_ADD(x86_avx2, s8, 32);
TEST_SATURATING_ADD(x86_avx2, u16, 16);
TEST_SATURATING_ADD(x86_avx2, s16, 16);

TEST_SATURATING_SUB(x86_avx2, u8, 32);
TEST_SATURATING_SUB(x86_avx2, s8, 32);
TEST_SATURATING_SUB(x86_avx2, u16, 16);
TEST_SATURATING_SUB(x86_avx2, s16, 16);
...
TEST_CONVERT(x86_avx2, bf16, f32x16);

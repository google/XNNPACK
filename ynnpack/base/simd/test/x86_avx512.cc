...
TEST_SATURATING_ADD(x86_avx512, u8, 64);
TEST_SATURATING_ADD(x86_avx512, s8, 64);
TEST_SATURATING_ADD(x86_avx512, u16, 32);
TEST_SATURATING_ADD(x86_avx512, s16, 32);

TEST_SATURATING_SUB(x86_avx512, u8, 64);
TEST_SATURATING_SUB(x86_avx512, s8, 64);
TEST_SATURATING_SUB(x86_avx512, u16, 32);
TEST_SATURATING_SUB(x86_avx512, s16, 32);

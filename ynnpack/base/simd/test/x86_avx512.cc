...
TEST_UNARY(x86_avx512, sin, f32, 16, std::sin, 2);
TEST_UNARY(x86_avx512, sin, f64, 8, std::sin, 2);
TEST_UNARY(x86_avx512, cos, f32, 16, std::cos, 2);
TEST_UNARY(x86_avx512, cos, f64, 8, std::cos, 2);

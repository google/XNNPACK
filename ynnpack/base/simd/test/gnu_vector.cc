...
TEST_UNARY(gnu_vector, sin, f32, 4, std::sin, 3);
TEST_UNARY(gnu_vector, sin, f64, 2, std::sin, 2);
TEST_UNARY(gnu_vector, cos, f32, 4, std::cos, 3);
TEST_UNARY(gnu_vector, cos, f64, 2, std::cos, 2);

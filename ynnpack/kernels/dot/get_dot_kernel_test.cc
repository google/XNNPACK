...
TEST(get_dot_kernel, small_n) {
  ...
  ASSERT_EQ(fp32_x1(arch_flags_avx512), "dot_fp32_8x1x16_1x1x16_avx512");
  ...
  ASSERT_EQ(fp32_x2(arch_flags_avx512), "dot_fp32_8x1x16_1x1x16_avx512");
  ...
  ASSERT_EQ(fp32_x3(arch_flags_avx512), "dot_fp32_8x1x16_1x1x16_avx512");

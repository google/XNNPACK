...
class packer {
 public:
  ...
  // Return a copy of this packer configured for `new_tile_n` columns without
  // re-querying architecture dispatch tables when `tile_m > 1`.
  packer with_tile_n(size_t new_tile_n) const;

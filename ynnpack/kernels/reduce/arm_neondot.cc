...
SUM_K1_KERNEL(sum_int8_int32_k1_neondot, int8_t, int32_t, 4, 4, identity);
SUM_KN_KERNEL(sum_int8_int32_kn_neondot, int8_t, int32_t, 16, identity);

SUM_K1_KERNEL(sum_uint8_int32_k1_neondot, uint8_t, int32_t, 4, 4, identity);
SUM_KN_KERNEL(sum_uint8_int32_kn_neondot, uint8_t, int32_t, 16, identity);

SUM_K1_KERNEL(sum_squared_int8_int32_k1_neondot, int8_t, int32_t, 4, 4, square);
SUM_KN_KERNEL(sum_squared_int8_int32_kn_neondot, int8_t, int32_t, 16, square);

SUM_K1_KERNEL(sum_squared_uint8_int32_k1_neondot, uint8_t, int32_t, 4, 4,
              square);
SUM_KN_KERNEL(sum_squared_uint8_int32_kn_neondot, uint8_t, int32_t, 16, square);

...
SUM_KERNEL(sum_int8_int32_neondot, s32x4, int8_t, int32_t, 16);
SUM_KERNEL(sum_uint8_int32_neondot, s32x4, uint8_t, int32_t, 16);

SUM_SQUARED_KERNEL(sum_squared_int8_int32_neondot, s32x4, int8_t, int32_t, 16);
SUM_SQUARED_KERNEL(sum_squared_uint8_int32_neondot, s32x4, uint8_t, int32_t,
                   16);

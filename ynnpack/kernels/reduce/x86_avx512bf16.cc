...
SUM_K1_KERNEL(sum_bf16_fp32_k1_avx512bf16, bfloat16, float,
              consistent_tile_k_fp32, 2, identity);
SUM_KN_KERNEL(sum_bf16_fp32_kn_avx512bf16, bfloat16, float, 32, identity);

SUM_K1_KERNEL(sum_squared_bf16_fp32_k1_avx512bf16, bfloat16, float,
              consistent_tile_k_fp32, 2, square);
SUM_KN_KERNEL(sum_squared_bf16_fp32_kn_avx512bf16, bfloat16, float, 32, square);

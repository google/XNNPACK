...
MIN_MAX_K1_KERNEL(min_max_int8_k1_sse41, s8x16, s8x16, int8_t, 16);
MIN_MAX_KN_KERNEL(min_max_int8_kn_sse41, s8x16, s8x16, int8_t, 16);
MIN_MAX_K1_KERNEL(min_int8_k1_sse41, s8x16, dummy_t, int8_t, 16);
MIN_MAX_KN_KERNEL(min_int8_kn_sse41, s8x16, dummy_t, int8_t, 16);
MIN_MAX_K1_KERNEL(max_int8_k1_sse41, dummy_t, s8x16, int8_t, 16);
MIN_MAX_KN_KERNEL(max_int8_kn_sse41, dummy_t, s8x16, int8_t, 16);

SUM_KN_KERNEL(sum_int8_int32_kn_sse41, int8_t, int32_t, 16, identity);
SUM_KN_KERNEL(sum_uint8_int32_kn_sse41, uint8_t, int32_t, 16, identity);

SUM_K1_KERNEL(sum_squared_int8_int32_k1_sse41, int8_t, int32_t, 4, 4, square);
SUM_KN_KERNEL(sum_squared_int8_int32_kn_sse41, int8_t, int32_t, 16, square);

SUM_K1_KERNEL(sum_squared_uint8_int32_k1_sse41, uint8_t, int32_t, 4, 4, square);
SUM_KN_KERNEL(sum_squared_uint8_int32_kn_sse41, uint8_t, int32_t, 16, square);

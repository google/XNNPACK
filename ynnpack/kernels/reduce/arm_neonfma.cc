...
SUM_K1_KERNEL(sum_squared_bf16_fp32_k1_neonfma, bfloat16, float, 8, 1, square);
SUM_KN_KERNEL(sum_squared_bf16_fp32_kn_neonfma, bfloat16, float, 8, square);

SUM_K1_KERNEL(sum_squared_fp32_k1_neonfma, float, float, 4, 1, square);
SUM_KN_KERNEL(sum_squared_fp32_kn_neonfma, float, float, 4, square);

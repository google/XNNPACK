...
using xf16x8_rvar = sign_magnitude<s16x8>;
...
MIN_MAX_K1_KERNEL(min_max_k1_xf16_neon, xf16x8_rvar, xf16x8_rvar, int16_t, 8);
MIN_MAX_KN_KERNEL(min_max_kn_xf16_neon, xf16x8_rvar, xf16x8_rvar, int16_t, 8);
MIN_MAX_K1_KERNEL(min_max_k1_xf8_neon, xf8x16_rvar, xf8x16_rvar, int8_t, 16);
MIN_MAX_KN_KERNEL(min_max_kn_xf8_neon, xf8x16_rvar, xf8x16_rvar, int8_t, 16);
...
MIN_MAX_K1_KERNEL(min_k1_xf16_neon, xf16x8_rvar, dummy_t, int16_t, 8);
MIN_MAX_KN_KERNEL(min_kn_xf16_neon, xf16x8_rvar, dummy_t, int16_t, 8);
MIN_MAX_K1_KERNEL(min_k1_xf8_neon, xf8x16_rvar, dummy_t, int8_t, 16);
MIN_MAX_KN_KERNEL(min_kn_xf8_neon, xf8x16_rvar, dummy_t, int8_t, 16);
...
MIN_MAX_K1_KERNEL(max_k1_xf16_neon, dummy_t, xf16x8_rvar, int16_t, 8);
MIN_MAX_KN_KERNEL(max_kn_xf16_neon, dummy_t, xf16x8_rvar, int16_t, 8);
MIN_MAX_K1_KERNEL(max_k1_xf8_neon, dummy_t, xf8x16_rvar, int8_t, 16);
MIN_MAX_KN_KERNEL(max_kn_xf8_neon, dummy_t, xf8x16_rvar, int8_t, 16);

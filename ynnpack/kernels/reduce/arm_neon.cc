...
MIN_MAX_K1_KERNEL(min_max_k1_bf16_neon, bf16x8_rvar, bf16x8_rvar, bfloat16, 8);
MIN_MAX_KN_KERNEL(min_max_kn_bf16_neon, bf16x8_rvar, bf16x8_rvar, bfloat16, 8);
MIN_MAX_K1_KERNEL(min_max_k1_fp16_neon, f16x8_rvar, f16x8_rvar, half, 8);
MIN_MAX_KN_KERNEL(min_max_kn_fp16_neon, f16x8_rvar, f16x8_rvar, half, 8);
...
MIN_MAX_K1_KERNEL(min_k1_bf16_neon, bf16x8_rvar, dummy_t, bfloat16, 8);
MIN_MAX_KN_KERNEL(min_kn_bf16_neon, bf16x8_rvar, dummy_t, bfloat16, 8);
MIN_MAX_K1_KERNEL(min_k1_fp16_neon, f16x8_rvar, dummy_t, half, 8);
MIN_MAX_KN_KERNEL(min_kn_fp16_neon, f16x8_rvar, dummy_t, half, 8);
...
MIN_MAX_K1_KERNEL(max_k1_bf16_neon, dummy_t, bf16x8_rvar, bfloat16, 8);
MIN_MAX_KN_KERNEL(max_kn_bf16_neon, dummy_t, bf16x8_rvar, bfloat16, 8);
MIN_MAX_K1_KERNEL(max_k1_fp16_neon, dummy_t, f16x8_rvar, half, 8);
MIN_MAX_KN_KERNEL(max_kn_fp16_neon, dummy_t, f16x8_rvar, half, 8);

...
SUM_K1_KERNEL(sum_bf16_fp32_k1_neonbf16, bfloat16, float, 4, 2, identity);
SUM_KN_KERNEL(sum_bf16_fp32_kn_neonbf16, bfloat16, float, 8, identity);

SUM_K1_KERNEL(sum_squared_bf16_fp32_k1_neonbf16, bfloat16, float, 4, 2, square);
SUM_KN_KERNEL(sum_squared_bf16_fp32_kn_neonbf16, bfloat16, float, 8, square);

...
SUM_KERNEL(sum_fp32_sse2, f32x16, float, float, 16);
SUM_KERNEL(sum_bf16_fp32_sse2, f32x16, bfloat16, float, 32);
SUM_KERNEL(sum_uint8_int32_sse2, s32x4, uint8_t, int32_t, 16);
SUM_KERNEL(sum_int32_sse2, s32x4, int32_t, int32_t, 4);

SUM_SQUARED_KERNEL(sum_squared_fp32_sse2, f32x16, float, float, 16);
SUM_SQUARED_KERNEL(sum_squared_bf16_fp32_sse2, f32x16, bfloat16, float, 32);

...
BENCHMARK_FLOAT_REFERENCE(sqrt);
BENCHMARK_FLOAT_REFERENCE(cbrt);
BENCHMARK_FLOAT_REFERENCE(rsqrt);
...
BENCHMARK_FLOAT_REFERENCE(sin);
BENCHMARK_FLOAT_REFERENCE(cos);
BENCHMARK_FLOAT_REFERENCE(tan);

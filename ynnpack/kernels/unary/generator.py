...
from ynnpack.kernels.unary.trig import *  # pylint: disable=wildcard-import
...
def main(argv: Sequence[str]) -> None:
  ...
  kernels = {
      "x86_sse2": [
          ...
          (cos_fp32, (8, 1)),
          (cos_fp64, (4, 1), consistent),
          (erf_fp32, (16, 1)),
          (erf_fp64, (16, 1), consistent),
          (exp_fp32, (16, 1)),
          ...
          (rsqrt_fp32, (8, 1)),
          (rsqrt_fp64, (4, 1), consistent),
          (sigmoid_fp32, (32, 1)),
          (sigmoid_fp64, (8, 1), consistent),
          (sin_fp32, (8, 1)),
          (sin_fp64, (4, 1), consistent),
          (sqrt_fp32, (8, 1)),
          (sqrt_fp64, (4, 1), consistent),
          (square_fp32, (8, 1), consistent),
          (square_fp64, (4, 1), consistent),
          (tan_fp32, (16, 1)),
          (tan_fp64, (8, 1), consistent),
          (tanh_fp32, (16, 1)),
      ...
      "x86_sse2_fma": [
          ...
          (rsqrt_fp32, (8, 1), consistent),
          (sigmoid_fp32, (32, 1), consistent),
          (sin_fp32, (8, 1), consistent),
          (sqrt_fp32, (8, 1), consistent),
          (tan_fp32, (16, 1), consistent),
      ...
      "x86_avx": [
          ...
          (cos_fp32, (32, 1)),
          (cos_fp64, (16, 1), consistent),
          (erf_fp32, (16, 1)),
          (erf_fp64, (8, 1), consistent),
          (exp_fp32, (16, 1)),
          (exp_fp64, (8, 1), consistent),
          (expm1_fp32, (16, 1)),
          (expm1_fp64, (8, 1), consistent),
          ...
          (rsqrt_fp32, (16, 1)),
          (rsqrt_fp64, (8, 1), consistent),
          (sigmoid_fp32, (16, 1)),
          (sigmoid_fp64, (8, 1), consistent),
          (sin_fp32, (32, 1)),
          (sin_fp64, (16, 1), consistent),
          (sqrt_fp32, (16, 1)),
          (sqrt_fp64, (8, 1), consistent),
      ...
      "x86_avx2": [
          ...
          (log_fp32, (32, 1)),
          (log_fp64, (16, 1), consistent),
          (requantize_to_uint8, (32, 1), consistent),
      ...
      "x86_fma3": [
          ...
          (approx_tanh_fp32, (32, 1)),
          (cos_fp32, (32, 1), consistent),
          (cos_fp64, (16, 1)),
          ...
          (sigmoid_fp32, (32, 1), consistent),
          (sigmoid_fp64, (8, 1)),
          (sin_fp32, (32, 1), consistent),
          (sin_fp64, (16, 1)),
          (tan_fp32, (32, 1), consistent),
          (tan_fp64, (16, 1)),
      ...
      "x86_avx512": [
          ...
          (convert_fp16_to_fp32, (64, 1), consistent),
          (convert_fp32_to_bf16, (64, 1), consistent),
          (convert_fp32_to_fp16, (64, 1), consistent),
          ...
          (poly3_fp64, (32, 1)),
          (requantize_to_uint8, (64, 1), consistent),
          (round_fp32, (32, 1), consistent),
          (round_fp64, (16, 1), consistent),
          (round_to_bf16_fp32, (32, 1), consistent),
          (rsqrt_fp32, (32, 1), consistent),
          (rsqrt_fp64, (32, 1)),
          (sigmoid_fp32, (32, 1), consistent),
          (sigmoid_fp64, (16, 1)),
          (sin_fp32, (32, 1), consistent),
          (sin_fp64, (16, 1)),
          (sqrt_fp32, (32, 1), consistent),
          (sqrt_fp64, (16, 1)),

...
ExecutionPlan FP16SparseMobileNetV3Large(float sparsity, pthreadpool_t threadpool) {
  ...
  std::generate(w118.begin(), w118.end() - size_t(sparsity * w118.size()), f32rng);
  ...
  std::generate(w124.begin(), w124.end() - size_t(sparsity * w124.size()), f32rng);
  ...
  std::generate(w174.begin(), w174.end() - size_t(sparsity * w174.size()), f32rng);
  ...
  std::generate(w184.begin(), w184.end() - size_t(sparsity * w184.size()), f32rng);
  ...
  std::generate(w194.begin(), w194.end() - size_t(sparsity * w194.size()), f32rng);
  ...
  std::generate(w206.begin(), w206.end() - size_t(sparsity * w206.size()), f32rng);
